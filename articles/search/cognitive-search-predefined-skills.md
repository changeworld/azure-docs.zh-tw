...
>
> 累加[擴充（預覽）](cognitive-search-incremental-indexing-conceptual.md)功能可讓您提供快取，讓索引子更有效率地執行您未來修改技能集時所需的認知技能，節省時間和金錢。
...
| [Microsoft.Skills.Text.PIIDetectionSkill](cognitive-search-skill-pii-detection.md)  | 這項技能會使用預先定型模型，從指定的文字中解壓縮個人識別資訊。 此技能也提供各種選項，以遮罩文字中偵測到之個人識別資訊的實體。  |
...
| [AmlSkill 的 Microsoft 技術。](cognitive-search-aml-skill.md) | 允許具有 Azure Machine Learning 模型的 AI 擴充管線擴充性 |
