---
title: 索引期間的內置文本和影像處理
titleSuffix: Azure Cognitive Search
description: 資料提取、自然語言、影像處理認知技能為 Azure 認知搜索管道中的原始內容添加語義和結構。
manager: nitinme
author: luiscabrer
ms.author: luisca
...
ms.locfileid: "76933374"
---
# <a name="built-in-cognitive-skills-for-text-and-image-processing-during-indexing-azure-cognitive-search"></a>索引期間文本和影像處理的內置認知技能（Azure 認知搜索）
...
| 技能 | 描述 |
|-------|-------------|
|[微軟.技能.文本.自訂實體查找技能](cognitive-search-skill-custom-entity-lookup.md)| 從自訂的、使用者定義的單詞和片語清單中查找文本。|
...
| [Microsoft.Skills.Text.PIIDetectionSkill](cognitive-search-skill-pii-detection.md)  | 此技能使用預先訓練的模型從給定文本中提取個人識別資訊。 該技能還提供了在文本中遮罩檢測到的 PII 實體的各種選項。  |
...
| [Microsoft.Skills.Text.TranslationSkill](cognitive-search-skill-text-translation.md) | 此技能使用預先訓練的模型將輸入文本轉換為各種語言，以便正常化或當地語系化用例。 |
...
| [Microsoft.Skills.Util.ConditionalSkill](cognitive-search-skill-conditional.md) | 允許篩選、分配預設值以及基於條件合併資料。|
...
| [Microsoft.Skills.Custom.WebApiSkill](cognitive-search-custom-skill-web-api.md) | 通過將 HTTP 調用到自訂 Web API 中，允許擴展 AI 擴充管道 |


有關創建[自訂技能](cognitive-search-custom-skill-web-api.md)的指導，請參閱[如何定義自訂介面](cognitive-search-custom-skill-interface.md)和[示例：為 AI 充實創建自訂技能](cognitive-search-create-custom-skill-example.md)。
