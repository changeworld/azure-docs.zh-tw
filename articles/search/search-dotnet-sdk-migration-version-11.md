...
1. 更新索引、索引子、同義字對應和分析器物件的用戶端參考。 [SearchServiceClient](https://docs.microsoft.com/dotnet/api/microsoft.azure.search.searchserviceclient)的實例應該變更為[SearchIndexClient](https://docs.microsoft.com/dotnet/api/microsoft.azure.search.searchindexclient)。 
