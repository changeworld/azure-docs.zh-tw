...
下表列出支援 Data Lake Storage Gen2 的開放原始碼平臺。
...
| 平台 |  支援的版本 | 相關資訊 |
| --- | --- | --- |
| [HDInsight](https://azure.microsoft.com/services/hdinsight/) | 3.6+ | [可以搭配 HDInsight 使用的 Apache Hadoop 元件和版本有哪些？](../../hdinsight/hdinsight-component-versioning.md?bc=%2f2Fazure%2fbread%2ftoc.json&toc=%2fazure%2fhdinsight%2fstorm%2fTOC.json)
