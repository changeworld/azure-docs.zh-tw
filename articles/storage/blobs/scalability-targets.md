---
title: Blob 儲存體的延展性和效能目標
titleSuffix: Azure Storage
description: 瞭解 Blob 儲存體的擴充性和效能目標。
services: storage
author: tamram
ms.service: storage
ms.topic: conceptual
...
ms.locfileid: "86528711"
---
# <a name="scalability-and-performance-targets-for-blob-storage"></a>Blob 儲存體的延展性和效能目標

[!INCLUDE [storage-scalability-intro-include](../../../includes/storage-scalability-intro-include.md)]

## <a name="scale-targets-for-blob-storage"></a>Blob 儲存體的調整目標
...
- [Premium 區塊 blob 儲存體帳戶的擴充性目標](scalability-targets-premium-block-blobs.md)
