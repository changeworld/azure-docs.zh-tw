...
| [在 Windows 上使用 AzCopy 在儲存體帳戶間移轉 Blob](/previous-versions/azure/storage/storage-common-transfer-between-storage-accounts?toc=%2fpowershell%2fmodule%2ftoc.json)| 在 Windows 上使用 AzCopy 在 Azure 儲存體帳戶間移轉 Blob。 |
|**Blob 儲存體**||
