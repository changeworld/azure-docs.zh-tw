...
description: 使用 Azure Blob 儲存體來儲存大量的非結構化物件資料，例如文字或二進位資料。 Azure Blob 儲存體具有高度擴充性與可用性。
services: storage
author: tamram
ms.service: storage
ms.topic: overview
...
- [建立儲存體帳戶](../common/storage-account-create.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json)
