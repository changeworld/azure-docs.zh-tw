...
您可以藉由參考共用快照集的 **日期時間** 值，來下載特定版本的檔案或目錄。 若要深入瞭解共用快照集，請參閱 [Azure 檔案儲存體的共用快照集總覽](../files/storage-snapshots-files.md)。 
...
您也可以藉由參考共用快照集的 **日期時間** 值，複製檔案的特定版本。 若要深入瞭解共用快照集，請參閱 [Azure 檔案儲存體的共用快照集總覽](../files/storage-snapshots-files.md)。 
