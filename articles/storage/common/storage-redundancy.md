...
|    BlockBlobStorage<sup>1</sup>    | 東南亞<br /> 西歐<br /> 美國東部    |    僅限區塊 blob    |
|    FileStorage    | 東南亞<br /> 西歐<br /> 美國東部    |    僅限 Azure 檔案    |
...
| :------------------------------------------------------------------------------------------------------- | :------------------------------ | :------------------------------- | :----------------------------------- | :----------------------------------- |
| 資料中心內的節點無法使用                                                                 | 是                             | Yes                              | Yes                                  | 是                                 |
| 整個資料中心 (區域或非區域) 變成無法供使用                                           | No                              | 是                              | 是<sup>1</sup>                                  | 是                                  |
