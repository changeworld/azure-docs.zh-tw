...
如需支援取得權杖的案例清單，請參閱[Microsoft 驗證程式庫 (MSAL) ](/azure/active-directory/develop/msal-overview)檔中的「[驗證流程](/en-us/azure/active-directory/develop/msal-authentication-flows)」一節。
