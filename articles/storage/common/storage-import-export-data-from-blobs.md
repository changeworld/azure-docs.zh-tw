...
6. 在 [寄返資訊]**** 中：
    ...
    - 輸入您在該貨運公司中建立的有效貨運帳戶號碼。 匯出作業完成後，Microsoft 使用此帳戶將磁碟機運回您。
...
2. 從清單中選取並按一下您的匯出作業。 轉到**加密**並複製金鑰。
...
## <a name="step-5-unlock-the-disks"></a>第 5 步：解鎖磁片

如果使用 WAImportExport 工具的版本 1.4.0.300，請使用以下命令解鎖磁碟機：

    `WAImportExport Unlock /externalKey:<BitLocker key (base 64 string) copied from journal (*.jrn*) file>`  

如果使用該工具的早期版本，請使用 BitLocker 對話方塊解鎖磁碟機。

此時，您可以刪除作業或離開它。 作業在 90 天后自動刪除。
