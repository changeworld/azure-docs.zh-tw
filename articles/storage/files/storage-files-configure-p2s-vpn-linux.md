...
- 最新版本的 Azure CLI。 如需如何安裝 Azure CLI 的詳細資訊，請參閱[安裝 Azure PowerShell CLI](/cli/azure/install-azure-cli)，並選取您的作業系統。 您也可以在 Linux 上使用 Azure PowerShell 模組，但以下顯示的是適用於 Azure CLI 的指示。
