...
若要更新共用層級許可權，請參閱[將存取權限指派](https://docs.microsoft.com/azure/storage/files/storage-files-identity-auth-active-directory-domain-service-enable#assign-access-permissions-to-an-identity)給身分識別。
