...
Azure 檔案儲存體提供三個在 Azure 檔案共用中使用檔案和資料夾的方法：業界標準[伺服器訊息區 (SMB) 通訊協定](/windows/win32/fileio/microsoft-smb-protocol-and-cifs-protocol-overview)、網路檔案系統 (NFS) 通訊協定 (預覽) 和[檔案 REST 通訊協定](/rest/api/storageservices/file-service-rest-api)。 
