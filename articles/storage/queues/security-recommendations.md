...
| 在您所有的儲存體帳戶上啟用「 **需要安全傳輸** 」選項 | 當您啟用「 **需要安全傳輸** 」選項時，對儲存體帳戶提出的所有要求都必須透過安全連線進行。 透過 HTTP 提出的任何要求都會失敗。 如需詳細資訊，請參閱 [Azure 儲存體中的「需要安全傳輸](../common/storage-require-secure-transfer.md?toc=%2fazure%2fstorage%2fqueues%2ftoc.json)」。 | [是](../../security-center/security-center-sql-service-recommendations.md) |
