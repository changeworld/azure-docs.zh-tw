---
title: Apache Spark 版本支援
description: 支援的 Spark 版本, Scala, Python
...
Azure Synapse Analytics 服務中的 Apache Spark 支援數種不同的執行階段和服務，本文件會將版本列出。
...
Azure Synapse 中的 Apache Spark 包含 Java 版本 1.8.0_222
...
Azure Synapse 中的 Apache Spark 包含 .NET Core 3.0

## <a name="net-support-for-apache-spark"></a>Apache Spark 的 .NET 支援

Azure Synapse 包含適用於 Apache Spark 0.11.0 的 .NET 支援

## <a name="delta-lake"></a>Delta Lake

Synapse Analytics 包含 Delta Lake 0.6.0 的支援

## <a name="python-version"></a>Python 版本

Azure Synapse 中的 Apache Spark 包含 Python 3.6.1 版的安裝
...
azure-管理-network = = 10.2。0

azure-mgmt-resource==5.1.0

azure-mgmt-storage==4.2.0

azure-儲存體-blob = = 2.1。0

azure-儲存體-通用 = = 2.1。0

azureml-automl-核心 = = 1.6。0

azureml-automl-runtime = = 1.6.0. post1

azureml-核心 = = 1.6。0

azureml-dataprep = = 1.6.3 版
...
azureml-定型-automl = = 1.6。0

azureml-定型-automl-client = = 1.6.0. post1

azureml-定型-automl-runtime = = 1.6。0

azureml-定型-核心 = = 1.6。0

azureml-定型-restclients-hyperdrive = = 1.6。0

Babel = = 2.4。0

backcall = = 0.2。0

反向移植. shutil-get-terminal-size = = 1.0。0
