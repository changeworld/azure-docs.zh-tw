---
title: 什麼是 Azure Synapse Analytics 中的 Apache Spark？
...
| 容易建立 |您可以使用 Azure 入口網站、Azure PowerShell 或 Synapse Analytics .NET SDK，在幾分鐘內就能於 Azure Synapse 中建立新的 Spark 集區。 請參閱[開始使用 Synapse Analytics 中的 Spark 集區](apache-spark-notebook-create-spark-use-sql.md)。 |
...
- [Spark Core](https://spark.apache.org/docs/latest/)。 包括 Spark Core、Spark SQL、GraphX 及 MLlib。
...
- [快速入門：在 Azure Synapse 中建立 Spark 集區](./apache-spark-notebook-create-spark-use-sql.md)
...
- [在 Azure Synapse 中建立 Spark 集區](./apache-spark-notebook-create-spark-use-sql.md)
