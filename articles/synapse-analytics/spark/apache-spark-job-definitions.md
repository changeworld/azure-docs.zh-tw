---
title: 教學課程 - Azure Synapse Analytics：適用於 Synapse 的 Spark 作業定義
description: 教學課程 - 使用 Azure Synapse Analytics 來建立 Spark 作業定義，並將其提交至 Synapse Spark 集區。
