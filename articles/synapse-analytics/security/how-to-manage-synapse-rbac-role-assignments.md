...
>- 為協助您在沒有任何 Synapse 系統管理員指派或可供使用的情況下，重新取得工作區的存取權，在工作區上具有管理 **AZURE rbac** 角色指派許可權的使用者也可以管理 **Synapse rbac** 角色指派，以允許新增 Synapse 系統管理員或 Synapse RBAC 中的其他角色指派。
...
>- 如果您要藉由修改安全性群組的成員資格來管理 Synapse RBAC 許可權，則會使用 Azure Active Directory 來管理成員資格的變更。  對群組成員資格所做的變更可能需要幾分鐘的時間才會生效。
