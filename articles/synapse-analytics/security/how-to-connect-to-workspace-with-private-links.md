...
如果您尚未這樣做，請註冊網路資源提供者。 註冊資源提供者可將您的訂用帳戶設定為可搭配資源提供者使用。 當您[註冊](https://docs.microsoft.com/azure/azure-resource-manager/management/resource-providers-and-types) \(部分機器翻譯\) 時，請從資源提供者清單中選擇 [Microsoft.Network]。 如果網路資源提供者已註冊，請繼續進行步驟 2。
