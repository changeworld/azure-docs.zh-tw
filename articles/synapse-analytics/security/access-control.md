...
description: 了解如何在 Azure Synapse Analytics 中管理對工作區、資料和管線的存取控制。
...
### <a name="step-4-configure-sql-admin-access-for-the-workspace"></a>步驟 4：設定工作區的 SQL 管理員存取權
...
### <a name="step-5-add-and-remove-users-and-admins-to-security-groups"></a>步驟 5：在安全性群組中新增和移除使用者與管理員
...
## <a name="access-control-to-sql-databases"></a>SQL 資料庫的存取控制
