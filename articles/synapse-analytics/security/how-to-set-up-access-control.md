...
| Task | 工作區管理員 | Spark 管理員 | SQL 系統管理員 |
| --- | --- | --- | --- |
...
| 監視中樞/協調流程/觸發程式執行  | YES | 否 | 否 |
| 監視中樞/協調流程/整合執行時間  | YES | YES | YES |
...
> [!NOTE]
> [1] 存取容器中的資料取決於 ADLSGen2 中的存取控制。 </br>
> [2] SQL OD 資料表和 Spark 資料表會將其資料儲存在 ADLSGen2 中，而 access 需要 ADLSGen2 的適當許可權。
