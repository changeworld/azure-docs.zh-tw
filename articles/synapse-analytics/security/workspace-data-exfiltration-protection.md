...
建立工作區並啟用資料遭到外泄之後，工作區資源的擁有者就可以管理工作區的已核准 Azure AD 租使用者清單。 在工作區上具有 [適當許可權](./synapse-workspace-access-control-overview.md) 的使用者可以使用 Synapse Studio，為工作區的已核准 Azure AD 租使用者中的資源建立受控私人端點連接要求。 如果使用者嘗試在未核准的租使用者中建立與資源的私人端點連線，將會封鎖受控私人端點建立。
