...
ms.locfileid: "96458936"
---
# <a name="interact-with-azure-cosmos-db-using-apache-spark-in-azure-synapse-link"></a>使用 Azure Synapse Link 中的 Apache Spark 與 Azure Cosmos DB 互動
