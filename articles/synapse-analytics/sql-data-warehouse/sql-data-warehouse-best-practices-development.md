...
另請參考[表索引](sql-data-warehouse-tables-index.md)、[欄位索引指南](https://msdn.microsoft.com/library/gg492088.aspx)與[重建欄位 。](sql-data-warehouse-tables-index.md#rebuilding-indexes-to-improve-segment-quality)
