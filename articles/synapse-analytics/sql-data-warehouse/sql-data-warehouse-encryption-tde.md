---
title: '透明資料加密 (入口網站) '
description: 透明資料加密 (TDE) Azure Synapse Analytics
...
---
# <a name="get-started-with-transparent-data-encryption-tde-in-azure-synapse-analytics"></a>透明資料加密中的 (TDE) 開始使用 Azure Synapse Analytics
