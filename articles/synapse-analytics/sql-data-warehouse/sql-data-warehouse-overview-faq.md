...
A. 是。 大多數可用於 SQL 資料庫的 REST 功能也可用於 Synapse SQL 池。 您可以在 REST 文件頁面或 [MSDN](https://msdn.microsoft.com/library/azure/mt163685.aspx) 內找到 API 資訊。
