...
| 外部資料來源       | 前置詞 | 儲存體帳戶路徑                                 |
| -------------------------- | ------ | ---------------------------------------------------- |
| Azure Blob 儲存體         | https  | \<storage_account>.blob.core.windows.net/path/file   |
| Azure Blob 儲存體         | wasb   | \<container>@\<storage_account>.blob.core.windows.net/path/file |
