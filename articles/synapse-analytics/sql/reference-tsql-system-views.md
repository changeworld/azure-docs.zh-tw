...
> [!NOTE]
> Synapse 無伺服器 SQL 集區僅支援 SQL Server 目錄檢視。  

## <a name="dedicated-sql-pool-and-serverless-sql-pool-catalog-views"></a>專用的 SQL 集區和無伺服器的 SQL 集區類別目錄檢視
...
SQL 集區公開許多 SQL Server 動態管理檢視 (DMV)。 這些視圖在專用的 SQL 集區中查詢時，會報告散發上執行的 SQL 資料庫狀態。
...
如需更多的參考資訊，請參閱 [SYNAPSE sql 中的 t-sql 語句](../sql-data-warehouse/sql-data-warehouse-reference-tsql-language-elements.md)，以及 [Synapse Sql 中的 t-sql 語言元素](../sql-data-warehouse/sql-data-warehouse-reference-tsql-statements.md)。
