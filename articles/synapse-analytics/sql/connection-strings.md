...
ms.locfileid: "98120915"
---
# <a name="connection-strings-for-synapse-sql"></a>Synapse SQL 的連接字串

您可以使用數個不同的應用程式通訊協定 (例如 [ADO.NET](/dotnet/framework/data/adonet/)、[ODBC](/sql/connect/odbc/windows/microsoft-odbc-driver-for-sql-server-on-windows)、[PHP](/sql/connect/php/overview-of-the-php-sql-driver?f=255&MSPPError=-2147217396) 及 [JDBC](/sql/connect/jdbc/microsoft-jdbc-driver-for-sql-server)) 連線至 Synapse SQL。 以下是每個通訊協定連接字串的一些範例。 
