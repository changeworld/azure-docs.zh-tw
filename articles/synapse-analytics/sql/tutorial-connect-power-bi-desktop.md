---
title: 教學課程：將 SQL 隨選 (預覽) 連線到 Power BI Desktop 並建立報告
description: 在本教學課程中，您將了解如何將 Azure Synapse Analytics 中的 SQL 隨選 (預覽) 連線到 Power BI Desktop，並根據檢視建立示範報告。
