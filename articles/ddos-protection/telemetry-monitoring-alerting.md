...
ms.locfileid: "92905282"
---
# <a name="view-and-configure-ddos-protection-telemetry"></a>查看及設定 DDoS 保護遙測
...
若要模擬 DDoS 攻擊來驗證遙測，請參閱[驗證 DDoS 偵測](test-through-simulations.md)。
