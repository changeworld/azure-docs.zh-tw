...
| 相應縮小              | 3、4、5、10            | ***2***、6、9、11      | 1、7、8                | 即使區域3具有最舊的 VM，還是可以選擇區域1和2。 從區域2刪除 VM2，因為它是該區域中最舊的 VM。   |
...
|-----------------------|------------------------|------------------------|------------------------|----------------------------------------------------------------------------------------------------------------------------------|
| Initial               | 3、4、5、10            | 2、6、9、11            | 1、7、8                |                                                                                                                                  |
| 相應縮小              | 3、4、5、10            | 2、6、9、 ***11***      | 1、7、8                | 在區域1和2之間選擇。 從區域2刪除 VM11，因為這是兩個區域中最新的 VM。                                |
| 相應縮小              | 3、4、5、 ***10***      | 2、6、9                | 1、7、8                | 選擇區域1，因為它有比其他兩個區域更多的 Vm。 從區域1刪除 VM10，因為它是該區域中最新的 VM。          |
| 相應縮小              | 3、4、5                | 2、6、 ***9***          | 1、7、8                | 區域已平衡。 刪除區域2中的且 PG2，因為它是擴展集中的最新 VM。                                                |
| 相應縮小              | 3、4、5                | 2，6                   | 1、7、 ***8***          | 選擇區域1和區域3。 刪除區域3中的 VM8，因為它是該區域中最新的 VM。                                      |
| 相應縮小              | 3、4、 ***5***          | 2，6                   | 1, 7                   | 即使區域3具有最新的 VM，還是選擇區域1。 刪除區域1中的 VM5，因為它是該區域中最新的 VM。                    |
