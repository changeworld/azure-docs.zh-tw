...
`properties.platformFaultDomainCount`如果未指定) ，您可以將屬性設定為1、2或 3 (預設值為3。 請參考[這裡](/rest/api/compute/virtualmachinescalesets/createorupdate)的 REST API 文件。

## <a name="azure-cli"></a>Azure CLI
`--platform-fault-domain-count`如果未指定) ，您可以將參數設定為1、2或 3 (預設值為3。 請參考[這裡](/cli/azure/vmss?view=azure-cli-latest#az-vmss-create)的 Azure CLI 文件。
