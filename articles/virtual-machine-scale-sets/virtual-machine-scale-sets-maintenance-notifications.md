...
- 如果維護需要重新開機，您會在規劃維護時收到通知。 在這些情況下，您將獲得一個時間視窗，通常是 35 天的時間視窗，您可以在維護工作時自行啟動維護。
...
- 隨著通知會提供一個「自助時段」**。 在此視窗通常為 35 天，您可以找到波中包含哪些 VM。 您可以根據自己的排程需求，主動啟動維護。
...
**問：在門戶、PowerShell 或 CLI 中，我沒有看到任何計畫維護的跡象。怎麼了？**
