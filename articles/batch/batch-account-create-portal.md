...
1. 選取 [**所有服務** > ] [訂用帳戶]，然後選取您想要用於 Batch 帳戶**的訂閱。**
...
> 
> ![強制 Key Vault 存取原則](./media/batch-account-create-portal/key-vault-access-policy.png) ：在 Azure 入口網站中建立 Batch 帳戶時，這不是必要的。 預設會選取此選項。
