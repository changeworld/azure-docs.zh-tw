---
title: 建立工作以在計算節點上準備 & 完成作業-Azure Batch
...
在執行作業的工作之前，Batch 會在排定要執行工作的每個計算節點上執行作業準備工作。 根據預設，Batch 會等待作業準備工作完成，然後再執行排程在節點上執行的工作。 不過，您可以設定服務不要等待。 如果節點重新開機，作業準備工作會再次執行。 您也可以停用此行為。 如果您的作業已設定作業準備工作和作業管理員工作，則作業準備工作會在作業管理員工作之前執行，就如同所有其他工作一樣。 作業準備工作一律會先執行。
