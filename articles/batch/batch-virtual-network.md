...
* Batch 服務需要與集區的計算節點通訊，以便安排工作。 若要啟用此通訊，請在 Batch 帳戶所在的區域中，為 Batch 服務所使用的每個 IP 位址新增使用者定義的路由。 要瞭解如何獲取 Batch 服務的 IP 位址清單，請參閱[本地中的服務標記](../virtual-network/service-tags-overview.md)
