---
title: Azure API 管理原則範例-使用 OAuth2 在閘道與後端之間進行授權
...
若要設定或編輯原則程式碼，請依照[設定或編輯原則](../set-edit-policies.md)中所述的步驟執行。 若要查看其他範例，請參閱[原則範例](../policy-reference.md)。
