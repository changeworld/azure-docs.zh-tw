...
|HashSet\<T> 的|全部|
|> 的 system.object\<T|全部|
|<TKey，TValue> 的一般 IDictionary|全部|
|> 的 system.object\<T|全部|
|> 的 system.object\<T|全部|
|> 的 system.object\<T|全部|
|Ireadonlycollection t>\<T> 的|全部|
|..Ireadonlydictionary<string<TKey，TValue>|全部|
|Iset<t>\<T> 的|全部|
|KeyValuePair<TKey，TValue>|全部|
|System.servicemodel. List\<T>|全部|
|> 的集合\<。|全部|
|> 中的 system.object\<T|全部|
|System.Convert|全部|
