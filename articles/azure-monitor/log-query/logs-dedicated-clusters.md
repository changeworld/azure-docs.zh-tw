...
- **keyVaultProperties**：用來設定用來布 [建 Azure 監視器客戶管理金鑰](../platform/customer-managed-keys.md#customer-managed-key-provisioning-procedure)的 Azure Key Vault。 它包含下列參數：  *KeyVaultUri*、 *KeyName*、 *KeyVersion*。 
