...
深入瞭解活頁簿設計來支援的案例、如何撰寫新的報表及自訂現有的報告，以及如何[使用 Azure 監視器活頁簿來建立互動式報表](https://docs.microsoft.com/azure/azure-monitor/platform/workbooks-overview)。