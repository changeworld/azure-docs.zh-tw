...
1. 使用 Azure CLI 執行下列命令。 使用 AKS 叢集的**AKS [總覽**] 頁面上的值，編輯**subscriptionId**、 **resourceGroupName**和**clusterName**的值。  若要取得**clientIdOfSPN**的值，請在執行命令`az aks show`時傳回，如下列範例所示。
