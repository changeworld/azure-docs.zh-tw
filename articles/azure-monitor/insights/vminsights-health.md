...
| Logical Disk % Free Inodes | 5 | 15 | < | 5% | 重大 | Sev1 | Linux | 
| Logical Disk % Free Space | 5 | 15 | < | 5% | 重大 | Sev1 | Linux | 
| 網路介面卡狀態 | 5 | 15 | <> | 1（true） | 警告 | Sev2 | Linux | 
| 作業系統 Available Megabytes Memory | 5 | 10 | < | 2.5 MB | 重大 | Sev1 | Linux | 
...
| 作業系統 Total Percent Processor Time | 5 | 10 | >= | 95% | 重大 | Sev1 | Linux | 
| CPU 總使用率百分比 | 5 | 10 | >= | 95% | 重大 | Sev1 | Windows | 
| 檔案系統錯誤或損毀 | 60 | 60 | <> | 4 | 重大 | Sev1 | Windows | 
| 每次邏輯磁碟讀取的平均秒數 | 1 | 15 | > | 0.04 秒 | 警告 | Sev2 | Windows | 
| 每次邏輯磁碟傳輸的平均秒數 | 1 | 15 | > | 0.04 秒 | 警告 | Sev2 | Windows | 
...
| 使用的讀取頻寬百分比 | 5 | 60 | >= | 60% | 警告 | Sev2 | Windows | 
| 使用的頻寬百分比總計 | 5 | 60 | >= | 75% | 警告 | Sev2 | Windows | 
| 使用的寫入頻寬百分比 | 5 | 60 | >= | 60% | 警告 | Sev2 | Windows | 
| DHCP 用戶端服務健全狀況 | 5 | 12 | <> | 4（正在執行） | 重大 | Sev1 | Windows | 
| DNS 用戶端服務健全狀況 | 5 | 12 | <> | 4（正在執行） | 重大 | Sev1 | Windows | 
| Windows 事件記錄服務健全狀況 | 5 | 12 | <> | 4（正在執行） | 重大 | Sev1 | Windows | 
| Windows 防火牆服務健康狀態 | 5 | 12 | <> | 4（正在執行） | 重大 | Sev1 | Windows | 
| RPC 服務健全狀況 | 5 | 12 | <> | 4（正在執行） | 重大 | Sev1 | Windows | 
| 伺服器服務健全狀況 | 5 | 12 | <> | 4（正在執行） | 重大 | Sev1 | Windows | 
| Windows 遠端管理服務健康狀態 | 5 | 12 | <> | 4（正在執行） | 重大 | Sev1 | Windows | 
| 記憶體可用 MB | 5 | 10 | < | 100 MB | 重大 | Sev1 | Windows | 
| 可用系統分頁表項目 | 5 | 10 | <= | 5000 | 重大 | Sev1 | Windows | 
| 記憶體每秒頁面數 | 5 | 10 | >= | 5000/秒 | 警告 | Sev1 | Windows | 
| 使用中的認可記憶體百分比 | 5 | 10 | > | 80% | 重大 | Sev1 | Windows | 
| 每次磁碟傳輸的平均秒數 | 1 | 15 | > | 0.04 秒 | 警告 | Sev2 | Windows | 
...
您無法從 Azure 入口網站管理特定的警示管理工作。 這些工作必須使用[Azure 監視器 REST API](https://docs.microsoft.com/rest/api/monitor/microsoft.workloadmonitor/components)來執行。 具體來說：
