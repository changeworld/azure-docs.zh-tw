...
AKS 在2020年1月發行這個新的角色系結，因此在2020年1月之前建立的叢集都沒有該系結。 如果您有在2020年1月之前建立的叢集，您可以在叢集上執行 PUT 作業，或在叢集上執行任何其他作業，以將新的 **clusterMonitoringUser** 新增至現有的叢集，以在叢集上執行 put 操作，例如更新叢集版本。
