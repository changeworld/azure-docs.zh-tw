...
使用以 Linux 為基礎的節點來監視網路的功能目前為預覽狀態。 在 [這裡](../../virtual-machines/extensions/oms-linux.md)存取代理程式。 若要深入了解，請連絡您的帳戶管理員。 Linux 代理程式的監控能力僅限於 NPM 的效能監控功能，不適用於「服務連線能力監視」和「ExpressRoute 監視」功能
