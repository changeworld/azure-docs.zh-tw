...
## <a name="number-of-results-alert-rule"></a>結果數目警示規則
下列範例會建立[結果數目警示規則](../platform/alerts-unified-log.md#metric-measurement-alert-rules)。
...
## <a name="metric-measurement-alert"></a>計量測量警示
下列範例會建立[計量測量警示規則](../platform/alerts-unified-log.md#metric-measurement-alert-rules)。
