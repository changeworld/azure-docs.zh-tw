...
下列範例會建立[傳統 Application Insights 資源](https://docs.microsoft.com/azure/azure-monitor/app/create-new-resource)。 
...
下列範例會建立[工作區型 Application Insights 資源](https://docs.microsoft.com/azure/azure-monitor/app/create-workspace-resource)。 工作區型 Application Insights 目前為**預覽**狀態。 
