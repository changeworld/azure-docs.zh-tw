...
接下來的步驟是[從您的應用程式中查看計量](../platform/metrics-charts.md)，[流量分析查詢您的資料](../log-query/log-query-overview.md)。 
...
1. 在 Visual Studio 方案總管的 [角色] 底下， **\<YourCloudService>**  >  **Roles**開啟每個角色的屬性。
