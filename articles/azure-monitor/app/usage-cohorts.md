...
3. 選取 [參與的使用者 -- 依使用天數]****。
    ...
    * **Period**，月份的定義。
    * **使用"最小自訂"，** 使用者需要在一個時間段內使用某種東西以計數為參與的次數。

4. 將 **"已使用"至少自訂更改為** **5 天以上**，並在預設值 28 天時保留**期限**。
...
這些篩選可支援更複雜的問題，也就是那些無法透過查詢產生器陳述的問題。 例如 _，在過去 28 天中從事工作的人員。在過去60天裡，這些人是怎樣的？_
...
3. 選取 [執行查詢]****。 如果表中未顯示使用者指示，請更改為應用程式具有使用者的國家/地區。

4. 儲存世代並為其命名。

## <a name="frequently-asked-questions"></a>常見問題集

_我定義了來自某個國家/地區的使用者佇列。當我比較"使用者"工具中的此佇列只是在該國家/地區設置篩選器時，我看到的結果不同。為什麼？_
