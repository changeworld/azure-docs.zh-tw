...
例如，我們可以在名為 "myLA" 的 Log Analytics 工作區中，將實驗室清查和位置內嵌至名為 "LabLocations_CL" 的資料表。 如果我們接著想要檢查在名為 "myAI" 的 Application Insights 應用程式中追蹤的要求，並將提供要求的電腦名稱稱與先前提到的自訂資料表中儲存的這些機器位置相互關聯，我們可以從執行下列查詢Application Insights 或 Azure 監視器內容：
