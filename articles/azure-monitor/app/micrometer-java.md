...
>
> Application Insights 不需要檢測的 [JAVA 3.0 代理程式](https://docs.microsoft.com/azure/azure-monitor/app/java-on-premises) 都支援 Webflux 和 Micrometer。 
...
2. 將檔案放 `ApplicationInsights.xml` 在 [資源] 資料夾中：
