---
title: 跟蹤嚴重性比下降 - Azure 應用程式見解
description: 使用 Azure 應用程式見解監視應用程式跟蹤，瞭解使用智慧檢測跟蹤遙測中的異常模式。
ms.topic: conceptual
ms.date: 11/27/2017
...
如果"良好"跟蹤（使用*資訊*級別或*詳細級別*記錄的跟蹤）與"壞"跟蹤（使用*警告*、*錯誤*或*致命*級別記錄的跟蹤）之間的比率與過去七天計算的基線相比，您可能會收到這種類型的通知。
