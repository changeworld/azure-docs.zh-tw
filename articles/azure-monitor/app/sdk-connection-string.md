...
- `Authorization` （例如： ikey）（這是選擇性設定，因為今天我們只支援 ikey 授權）。
...
- 區域服務 Uri 是以[SDK 預設值](https://github.com/microsoft/ApplicationInsights-dotnet/blob/e50d569cebf485e72e98f4a08a0bc0e30cdf42bc/BASE/src/Microsoft.ApplicationInsights/Extensibility/Implementation/Endpoints/Constants.cs#L6)為基礎，並會連線到公用全域 Azure：
   - 內嵌： https://dc.services.visualstudio.com/
...
### <a name="java-sdk-example"></a>JAVA SDK 範例
...
### <a name="javascript-sdk-example"></a>JAVAscript SDK 範例
...
### <a name="node-sdk-example"></a>Node SDK 範例
...
### <a name="python-sdk-example"></a>Python SDK 範例
