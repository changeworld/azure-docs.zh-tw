...
- 作業**名稱**：用於 Role-Based 存取控制的[Azure Resource Manager 操作](../../role-based-access-control/resource-provider-operations.md)名稱。 未向 Azure Resource Manager 註冊的作業不能在活動記錄警示規則中使用。
