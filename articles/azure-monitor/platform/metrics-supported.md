...
|sqlserver_process_core_percent|SQL 伺服器行程核心百分比|百分比|最大值|CPU 使用率作為 SQL DB 進程的百分比。 不適用於數據倉庫。|None|
|sqlserver_process_memory_percent|SQL 伺服器行程記憶體百分比|百分比|最大值|記憶體使用方式作為 SQL DB 進程的百分比。 不適用於數據倉庫。|None|
...
|sqlserver_process_core_percent|SQL 伺服器行程核心百分比|百分比|最大值|CPU 使用率作為 SQL DB 進程的百分比。 適用於彈性池。|None|
|sqlserver_process_memory_percent|SQL 伺服器行程記憶體百分比|百分比|最大值|記憶體使用方式作為 SQL DB 進程的百分比。 適用於彈性池。|None|
