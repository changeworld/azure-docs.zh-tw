...
> [!NOTE]
>
> 我們建議您選擇大於*評估頻率的**匯總資料細微性 (期間) * ，以降低在下列情況中遺漏新增時間序列之第一個評估的可能性：
> - 監視多個維度的度量警示規則–新增新的維度值組合時
> - 監視多個資源的計量警示規則–將新的資源新增至範圍時
> - 監視不會持續發出之計量的計量警示規則 (稀疏計量) –當計量在未發出超過24小時的期間內發出時
