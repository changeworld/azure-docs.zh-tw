...
> - 為了將自訂 [範本](https://docs.microsoft.com/azure/azure-monitor/platform/itsmc-overview#template-definitions) 作為動作的一部分，SCSM 範本中的參數 "ProjectionType" 應該對應至 "IncidentManagement！ProjectionType "（系統）
