...
| 可透過診斷設定匯出嗎？  | 發出 Null |  ResourceType  |  計量  |  MetricDisplayName  |  單位  |  AggregationType | 
|---|---| ---- | ----- | ------ | ---- | ---- | 
...
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubDroppedEvents  |  已卸載 EventHub 事件  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubRejectedEvents  |  已拒絕 EventHub 事件  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubTimedoutEvents  |  已超時的 EventHub 事件  |  Count  |  總計 | 
...
| **是**  | 否 |  AppPlatform/春季  |  GCPauseTotalCount  |  GC 暫停計數  |  Count  |  總計 | 
...
| **是**  | 否 |  AppPlatform/春季  |  TomcatErrorCount  |  Tomcat 全域錯誤  |  Count  |  總計 | 
...
| **是**  | 否 |  AppPlatform/春季  |  TomcatRequestTotalCount  |  Tomcat 要求總計數  |  Count  |  總計 | 
...
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionActiveCurrentCount  |  Tomcat 會話的生存計數  |  Count  |  總計 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionActiveMaxCount  |  Tomcat 會話最大使用中計數  |  Count  |  總計 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionAliveMaxTime  |  Tomcat 會話最大的存留時間  |  毫秒  |  最大值 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionCreatedCount  |  Tomcat 會話已建立計數  |  Count  |  總計 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionExpiredCount  |  Tomcat 會話過期計數  |  Count  |  總計 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionRejectedCount  |  Tomcat 會話已拒絕計數  |  Count  |  總計 | 
...
| **是**  | 否 |  Microsoft.Automation/automationAccounts  |  TotalUpdateDeploymentMachineRuns  |  更新部署電腦的執行總計  |  Count  |  總計 | 
...
| **是**  | 否 |  BatchAI/工作區  |  現用核心  |  現用核心  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  現用節點  |  現用節點  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  閒置核心  |  閒置核心  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  閒置節點  |  閒置節點  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  工作已完成  |  工作已完成  |  Count  |  總計 | 
| **是**  | 否 |  BatchAI/工作區  |  已提交作業  |  已提交作業  |  Count  |  總計 | 
| **是**  | 否 |  BatchAI/工作區  |  離開核心  |  離開核心  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  離開節點  |  離開節點  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  搶先核心  |  搶先核心  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  搶先節點  |  搶先節點  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  配額使用量百分比  |  配額使用量百分比  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  核心總數  |  核心總數  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  節點總計  |  節點總計  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  無法使用的核心  |  無法使用的核心  |  Count  |  Average | 
| **是**  | 否 |  BatchAI/工作區  |  無法使用的節點  |  無法使用的節點  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  ConnectionAccepted  |  接受的連接  |  Count  |  總計 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  ConnectionActive  |  作用中的連線  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  ConnectionHandled  |  已處理的連接  |  Count  |  總計 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  CpuUsagePercentageInDouble  |  CPU 使用量百分比  |  百分比  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  擱置交易  |  暫止交易  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  QueuedTransactions  |  佇列交易  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  資料磁片佇列深度  |  資料磁片佇列深度（預覽）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  OS 磁片佇列深度  |  OS 磁片佇列深度（預覽）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  OS 每一磁碟 QD  |  OS 磁片 QD （已淘汰）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  輸出流程  |  輸出流程  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  輸出流量最大建立速率  |  輸出流量最大建立速率（預覽）  |  每秒計數  |  Average | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  每一磁碟 QD  |  資料磁片 QD （已淘汰）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  資料磁片佇列深度  |  資料磁片佇列深度（預覽）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  OS 磁片佇列深度  |  OS 磁片佇列深度（預覽）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  OS 每一磁碟 QD  |  OS 磁片 QD （已淘汰）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  輸出流程  |  輸出流程  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  輸出流量最大建立速率  |  輸出流量最大建立速率（預覽）  |  每秒計數  |  Average | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  每一磁碟 QD  |  資料磁片 QD （已淘汰）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  資料磁片佇列深度  |  資料磁片佇列深度（預覽）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  OS 磁片佇列深度  |  OS 磁片佇列深度（預覽）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  OS 每一磁碟 QD  |  OS 磁片 QD （已淘汰）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  輸出流程  |  輸出流程  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  輸出流量最大建立速率  |  輸出流量最大建立速率（預覽）  |  每秒計數  |  Average | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  每一磁碟 QD  |  資料磁片 QD （已淘汰）  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.ContainerRegistry/registries  |  SuccessfulPullCount  |  成功的提取計數  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.ContainerRegistry/registries  |  SuccessfulPushCount  |  成功推送計數  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.ContainerRegistry/registries  |  TotalPullCount  |  總提取計數  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.ContainerRegistry/registries  |  TotalPushCount  |  總推送計數  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  FactorySizeInGbUnits  |  總廠大小（GB 單位）  |  Count  |  最大值 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  IntegrationRuntimeQueueLength  |  整合執行時間佇列長度  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  MaxAllowedFactorySizeInGbUnits  |  允許的 factory 大小上限（GB 單位）  |  Count  |  最大值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  MaxAllowedResourceCount  |  允許的實體數目上限  |  Count  |  最大值 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  ResourceCount  |  總實體數  |  Count  |  最大值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  TriggerCancelledRuns  |  已取消的觸發程式會執行計量  |  Count  |  總計 | 
...
| **是**  | 否 |  DBforPostgreSQL/serversv2  |  active_connections  |  作用中的連線  |  Count  |  Average | 
| **是**  | 否 |  DBforPostgreSQL/serversv2  |  cpu_percent  |  CPU 百分比  |  百分比  |  Average | 
| **是**  | 否 |  DBforPostgreSQL/serversv2  |  功耗  |  IOPS  |  Count  |  Average | 
...
| **是**  | **是** |  Microsoft. 裝置/帳戶  |  選取。節點  |  數位 Twins 節點遙測預留位置  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.abandon.success  |  已放棄的 C2D 訊息  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.complete.success  |  已完成 C2D 訊息傳遞  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.reject.success  |  拒絕的 C2D 訊息  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  C2DMessagesExpired  |  C2D 郵件已過期（預覽）  |  Count  |  總計 | 
...
| 否  | 否 |  EnterpriseKnowledgeGraph/服務  |  FailureCount  |  失敗計數  |  Count  |  Count | 
| 否  | 否 |  EnterpriseKnowledgeGraph/服務  |  SuccessCount  |  成功計數  |  Count  |  Count | 
| 否  | 否 |  EnterpriseKnowledgeGraph/服務  |  SuccessLatency  |  成功延遲  |  毫秒  |  Average | 
| 否  | 否 |  EnterpriseKnowledgeGraph/服務  |  TransactionCount  |  交易計數  |  Count  |  Count | 
...
| **是**  | **是** |  Microsoft.EventGrid/domains  |  PublishSuccessLatencyInMs  |  發佈成功延遲  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  PublishSuccessLatencyInMs  |  發佈成功延遲  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.EventGrid/topics  |  PublishSuccessLatencyInMs  |  發佈成功延遲  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHABL  |  封存待處理專案訊息（已淘汰）  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INMSGS  |  傳入訊息（已過時）（已淘汰）  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INREQS  |  傳入要求（已淘汰）  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  OUTMSGS  |  外寄訊息（已過時）（已被取代）  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  SVRBSY  |  伺服器忙碌錯誤（已淘汰）  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.HDInsight/clusters  |  NumActiveWorkers  |  作用中背景工作角色的數目  |  Count  |  最大值 | 
...
| 否  | 否 |  Microsoft.Insights/Components  |  availabilityResults/計數  |  可用性集合  |  Count  |  Count | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportNumOfRecordsExported  |  連續匯出-匯出記錄的 num  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportPendingCount  |  連續匯出暫止計數  |  Count  |  最大值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportResult  |  連續匯出結果  |  Count  |  Count | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  CPU  |  CPU  |  百分比  |  Average | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  EventsProcessedForEventHubs  |  已處理的事件（適用于事件/IoT 中樞）  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  IngestionResult  |  內嵌結果  |  Count  |  Count | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  IngestionUtilization  |  內嵌使用率  |  百分比  |  Average | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  IngestionVolumeInMB  |  內嵌磁片區（以 MB 為單位）  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  KeepAlive  |  保持運作  |  Count  |  Average | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  QueryDuration  |  查詢持續時間  |  毫秒  |  Average | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  SteamingIngestRequestRate  |  串流內嵌要求速率  |  Count  |  RateRequestsPerSecond | 
...
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsCompleted  |  完成的動作   |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsFailed  |  動作的失敗   |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsSkipped  |  略過的動作   |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsStarted  |  啟動的動作   |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsSucceeded  |  成功的動作   |  Count  |  總計 | 
| **是**  | 否 |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionSuccessLatency  |  動作成功延遲   |  秒  |  Average | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionThrottledEvents  |  動作節流的事件  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsCancelled  |  已取消執行  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsCompleted  |  完成的執行  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsFailed  |  失敗的執行  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsStarted  |  執行已啟動  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsSucceeded  |  已成功的執行  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunStartThrottledEvents  |  執行啟動節流事件  |  Count  |  總計 | 
| **是**  | 否 |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunSuccessLatency  |  執行成功的延遲  |  秒  |  Average | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunThrottledEvents  |  執行節流的事件  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersCompleted  |  完成的觸發程序   |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersFailed  |  失敗的觸發程序   |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersFired  |  引發的觸發程序   |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersSkipped  |  略過的觸發程序  |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersStarted  |  啟動的觸發程序   |  Count  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersSucceeded  |  成功的觸發程序   |  Count  |  總計 | 
| **是**  | 否 |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggerSuccessLatency  |  觸發程序成功延遲   |  秒  |  Average | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggerThrottledEvents  |  觸發程序節流的事件  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsCancelled  |  已取消執行  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunStartThrottledEvents  |  執行啟動節流事件  |  Count  |  總計 | 
...
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  現用核心  |  現用核心  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  現用節點  |  現用節點  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型部署已開始  |  模型部署已開始  |  Count  |  總計 | 
...
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  搶先核心  |  搶先核心  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  搶先節點  |  搶先節點  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  配額使用量百分比  |  配額使用量百分比  |  Count  |  Average | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  開始執行  |  開始執行  |  Count  |  總計 | 
...
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions  |  AssetCount  |  資產計數  |  Count  |  Average | 
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions  |  AssetQuota  |  資產配額  |  Count  |  Average | 
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions  |  AssetQuotaUsedPercentage  |  已使用的資產配額百分比  |  百分比  |  Average | 
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions  |  ContentKeyPolicyCount  |  內容金鑰原則計數  |  Count  |  Average | 
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions  |  ContentKeyPolicyQuota  |  內容金鑰原則配額  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions  |  StreamingPolicyCount  |  串流原則計數  |  Count  |  Average | 
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions  |  StreamingPolicyQuota  |  串流原則配額  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint  |  Requests  |  Requests  |  Count  |  總計 | 
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint  |  SuccessE2ELatency  |  成功的端對端延遲  |  毫秒  |  Average | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  GCPauseTotalCount  |  GC 暫停計數  |  Count  |  總計 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatErrorCount  |  Tomcat 全域錯誤  |  Count  |  總計 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatRequestTotalCount  |  Tomcat 要求總計數  |  Count  |  總計 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionActiveCurrentCount  |  Tomcat 會話的生存計數  |  Count  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionActiveMaxCount  |  Tomcat 會話最大使用中計數  |  Count  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionAliveMaxTime  |  Tomcat 會話最大的存留時間  |  毫秒  |  最大值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionCreatedCount  |  Tomcat 會話已建立計數  |  Count  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionExpiredCount  |  Tomcat 會話過期計數  |  Count  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionRejectedCount  |  Tomcat 會話已拒絕計數  |  Count  |  總計 | 
...
| 否  | 否 |  Microsoft.Network/applicationGateways  |  AvgRequestCountPerHealthyHost  |  每部狀況良好主機的每分鐘要求數  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  BlockedCount  |  Web 應用程式防火牆封鎖要求規則散發  |  Count  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  MatchedCount  |  Web 應用程式防火牆的規則散發總數  |  Count  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  ApplicationRuleHit  |  應用程式規則計數  |  Count  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  NetworkRuleHit  |  網路規則計數  |  Count  |  總計 | 
...
| **是**  | 否 |  Microsoft 網路/expressRoutePorts  |  AdminState  |  AdminState  |  Count  |  Average | 
| **是**  | 否 |  Microsoft 網路/expressRoutePorts  |  LineProtocol  |  LineProtocol  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft 網路/expressRoutePorts  |  RxLightLevel  |  RxLightLevel  |  Count  |  Average | 
| **是**  | 否 |  Microsoft 網路/expressRoutePorts  |  TxLightLevel  |  TxLightLevel  |  Count  |  Average | 
...
| **是**  | 否 |  Microsoft.PowerBIDedicated/capacities  |  QueryPoolJobQueueLength  |  查詢集區作業佇列長度（資料集）  |  Count  |  Average | 
...
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  DeadletteredMessages  |  佇列/主題中的無效字母訊息計數。  |  Count  |  Average | 
...
| 否  | 否 |  ServiceFabricMesh/應用程式  |  ActualCpu  |  ActualCpu  |  Count  |  Average | 
| 否  | 否 |  ServiceFabricMesh/應用程式  |  ActualMemory  |  ActualMemory  |  位元組  |  Average | 
| 否  | 否 |  ServiceFabricMesh/應用程式  |  AllocatedCpu  |  AllocatedCpu  |  Count  |  Average | 
| 否  | 否 |  ServiceFabricMesh/應用程式  |  AllocatedMemory  |  AllocatedMemory  |  位元組  |  Average | 
| 否  | 否 |  ServiceFabricMesh/應用程式  |  ApplicationStatus  |  ApplicationStatus  |  Count  |  Average | 
| 否  | 否 |  ServiceFabricMesh/應用程式  |  ContainerStatus  |  ContainerStatus  |  Count  |  Average | 
...
| 否  | 否 |  ServiceFabricMesh/應用程式  |  RestartCount  |  RestartCount  |  Count  |  Average | 
| 否  | 否 |  ServiceFabricMesh/應用程式  |  ServiceReplicaStatus  |  ServiceReplicaStatus  |  Count  |  Average | 
| 否  | 否 |  ServiceFabricMesh/應用程式  |  ServiceStatus  |  ServiceStatus  |  Count  |  Average | 
...
| **是**  | 否 |  StorageCache/快取  |  ClientIOPS  |  用戶端 IOPS 總計  |  Count  |  Average | 
...
| **是**  | 否 |  StorageCache/快取  |  StorageTargetHealth  |  儲存體目標健全狀況  |  Count  |  Average | 
| **是**  | 否 |  StorageCache/快取  |  StorageTargetIOPS  |  總 StorageTarget IOPS  |  Count  |  Average | 
...
| **是**  | 否 |  StorageCache/快取  |  StorageTargetWriteIOPS  |  StorageTarget 寫入 IOPS  |  Count  |  Average | 
| **是**  | 否 |  StorageCache/快取  |  Uptime  |  Uptime  |  Count  |  Average | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  ServerSyncSessionResult  |  同步會話結果  |  Count  |  Average | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncSyncSessionAppliedFilesCount  |  檔案已同步  |  Count  |  總計 | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups  |  SyncGroupSyncSessionAppliedFilesCount  |  檔案已同步  |  Count  |  總計 | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups/serverEndpoints  |  ServerEndpointSyncSessionAppliedFilesCount  |  檔案已同步  |  Count  |  總計 | 
...
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  DiskReadOperations  |  磁片讀取作業  |  Count  |  總計 | 
...
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  DiskWriteOperations  |  磁片寫入作業  |  Count  |  總計 | 
...
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpCloseWait  |  TCP 關閉等候  |  Count  |  Average | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpClosing  |  TCP 關閉  |  Count  |  Average | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpEstablished  |  TCP 已建立  |  Count  |  Average | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpFinWait1  |  TCP Fin 等候1  |  Count  |  Average | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpFinWait2  |  TCP Fin 等待2  |  Count  |  Average | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpLastAck  |  TCP 最後 Ack  |  Count  |  Average | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpSynReceived  |  已接收 TCP Syn  |  Count  |  Average | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpSynSent  |  TCP Syn 已傳送  |  Count  |  Average | 
...
| **是**  | **是** |  Microsoft.Web/sites  |  HealthCheckStatus  |  健全狀況檢查狀態  |  Count  |  Average | 
...
| **是**  | **是** |  Microsoft.Web/sites/slots  |  HealthCheckStatus  |  健全狀況檢查狀態  |  Count  |  Average | 
