...
| 可透過診斷設定匯出嗎？  | 已發出 Null |  ResourceType  |  計量  |  MetricDisplayName  |  單位  |  AggregationType | 
|---|---| ---- | ----- | ------ | ---- | ---- | 
...
| **是**  | 否 |  Microsoft.Batch/batchAccounts  |  PoolResizeStartEvent  |  調整集區大小啟動事件  |  計數  |  總計 | 
...
| **是**  | 否 |  區塊鏈/blockchainMembers  |  MemoryUsagePercentageInDouble  |  記憶體使用量百分比  |  百分比  |  Average | 
...
| **是**  | 否 |  Microsoft.Cache/redis  |  evictedkeys9  |  收回的金鑰 (分區 9)  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Cache/redis  |  totalcommandsprocessed6  |  總作業數 (分區 6)  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.CognitiveServices/accounts  |  TotalTokenCalls  |  呼叫權杖總計  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  ActivityFailedRuns  |  失敗的活動執行計量  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  PipelineCancelledRuns  |  已取消的管線執行計量  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  PipelineFailedRuns  |  失敗的管線執行計量  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  PipelineSucceededRuns  |  成功的管線執行計量  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  ResourceCount  |  總實體數  |  計數  |  最大值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  TriggerCancelledRuns  |  已取消的觸發程式會執行計量  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  TriggerFailedRuns  |  失敗的觸發程序執行計量  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  TriggerSucceededRuns  |  成功的觸發程序執行計量  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.DataLakeAnalytics/accounts  |  JobEndedCancelled  |  取消的作業  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataLakeAnalytics/accounts  |  JobEndedFailure  |  失敗的作業  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataLakeAnalytics/accounts  |  JobEndedSuccess  |  成功的作業  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  DataRead  |  讀取的資料  |  位元組  |  總計 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  DataWritten  |  寫入的資料  |  位元組  |  總計 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  ReadRequests  |  讀取要求  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  TotalStorage  |  儲存體總計  |  位元組  |  最大值 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  WriteRequests  |  寫入要求  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.DBforMariaDB/servers  |  connections_failed  |  失敗的連線  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.DBforMariaDB/servers  |  seconds_behind_master  |  複寫延遲 (秒)  |  計數  |  最大值 | 
...
| **是**  | **是** |  Microsoft.DBforMySQL/servers  |  connections_failed  |  失敗的連線  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.DBforMySQL/servers  |  seconds_behind_master  |  複寫延遲 (秒)  |  計數  |  最大值 | 
...
| **是**  | 否 |  Microsoft.DBforPostgreSQL/servers  |  connections_failed  |  失敗的連線  |  計數  |  總計 | 
...
| **是**  | 否 |  DBforPostgreSQL/serversv2  |  network_bytes_egress  |  Network Out  |  位元組  |  總計 | 
| **是**  | 否 |  DBforPostgreSQL/serversv2  |  network_bytes_ingress  |  Network In  |  位元組  |  總計 | 
...
| **是**  | **是** |  Microsoft. 裝置/帳戶  |  選取。節點  |  數位 Twins 節點遙測預留位置  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.abandon.success  |  已放棄的 C2D 訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.complete.success  |  已完成 C2D 訊息傳遞  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.reject.success  |  拒絕的 C2D 訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.methods.failure  |  失敗直接方法叫用  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.methods.success  |  成功直接方法叫用  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.failure  |  後端的失敗對應項讀取  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.size  |  後端的對應項讀取回應大小  |  位元組  |  Average | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.success  |  後端的成功對應項讀取  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.failure  |  後端的失敗對應項更新  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.size  |  後端的對應項更新大小  |  位元組  |  Average | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.success  |  後端的成功對應項更新  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  C2DMessagesExpired  |  C2D 郵件已過期（預覽）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  組態  |  設定計量  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Devices/IotHubs  |  connectedDeviceCount  |  連接的裝置 (預覽)  |  計數  |  Average | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.builtIn.events  |  路由：傳遞至訊息/事件的訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.eventHubs  |  路由：傳遞至事件中樞的訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.serviceBusQueues  |  路由：傳遞至服務匯流排佇列的訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.serviceBusTopics  |  路由：傳遞至服務匯流排主題的訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.storage  |  路由：傳遞至儲存體的訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.storage.blobs  |  路由：傳遞至儲存體的 BLOB  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.dropped  |  路由：已捨棄的遙測訊息   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.fallback  |  路由：傳遞至後援的訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.invalid  |  路由：不相容的遙測訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.orphaned  |  路由：已遺棄的遙測訊息   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.success  |  路由：已傳遞的遙測訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.ingress.allProtocol  |  遙測訊息傳送嘗試  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.ingress.sendThrottle  |  節流錯誤數目  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.ingress.success  |  已傳送的遙測訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.failure  |  裝置的失敗對應項讀取  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.size  |  裝置的對應項讀取回應大小  |  位元組  |  Average | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.success  |  裝置的成功對應項讀取  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.failure  |  裝置的失敗對應項更新  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.size  |  裝置的對應項更新大小  |  位元組  |  Average | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.success  |  裝置的成功對應項更新  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  devices.connectedDevices.allProtocol  |  連接的裝置 (已淘汰)   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  devices.totalDevices  |  裝置總計 (已淘汰)  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  EventGridDeliveries  |  事件方格傳遞（預覽）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  EventGridLatency  |  事件方格延遲（預覽）  |  毫秒  |  Average | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.cancelJob.failure  |  取消作業失敗  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.cancelJob.success  |  成功取消作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.completed  |  已完成的工作  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createDirectMethodJob.failure  |  建立失敗的方法叫用作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createDirectMethodJob.success  |  成功建立的方法叫用作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createTwinUpdateJob.failure  |  建立失敗的對應項更新作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createTwinUpdateJob.success  |  成功建立的對應項更新作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.failed  |  失敗作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.listJobs.failure  |  呼叫列出作業失敗  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.listJobs.success  |  成功呼叫列出作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.queryJobs.failure  |  失敗作業查詢  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.queryJobs.success  |  成功作業查詢  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Devices/IotHubs  |  totalDeviceCount  |  裝置總計 (預覽)  |  計數  |  Average | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.failure  |  失敗對應項查詢  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.resultSize  |  對應項查詢結果大小  |  位元組  |  Average | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.success  |  成功對應項查詢  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/provisioningServices  |  AttestationAttempts  |  證明嘗試數  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/provisioningServices  |  DeviceAssignments  |  已指派的裝置數  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Devices/provisioningServices  |  RegistrationAttempts  |  註冊嘗試數  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  AvailableStorage  |  可用的儲存體  |  位元組  |  總計 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  CassandraConnectionClosures  |  Cassandra 連線終止  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  CassandraRequestCharges  |  Cassandra 要求費用  |  計數  |  總計 | 
...
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  DocumentCount  |  文件計數  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.DocumentDB/databaseAccounts  |  MongoRequestCharge  |  Mongo 要求收費  |  計數  |  總計 | 
...
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  ProvisionedThroughput  |  佈建的輸送量  |  計數  |  最大值 | 
...
| **是**  | **是** |  Microsoft.DocumentDB/databaseAccounts  |  TotalRequestUnits  |  要求單位總計  |  計數  |  總計 | 
...
| **是**  | **是** |  EventGrid/網域  |  DeadLetteredCount  |  失效信件事件  |  計數  |  總計 | 
| 否  | 否 |  EventGrid/網域  |  DeliveryAttemptFailCount  |  傳遞失敗的事件  |  計數  |  總計 | 
| **是**  | **是** |  EventGrid/網域  |  DeliverySuccessCount  |  已傳遞的事件  |  計數  |  總計 | 
| 否  | 否 |  EventGrid/網域  |  DestinationProcessingDurationInMs  |  目的端處理持續期間  |  毫秒  |  Average | 
| **是**  | **是** |  EventGrid/網域  |  DroppedEventCount  |  卸除的事件  |  計數  |  總計 | 
| **是**  | **是** |  EventGrid/網域  |  MatchedEventCount  |  相符的事件  |  計數  |  總計 | 
| **是**  | **是** |  EventGrid/網域  |  PublishFailCount  |  發行失敗的事件  |  計數  |  總計 | 
| **是**  | **是** |  EventGrid/網域  |  PublishSuccessCount  |  已發佈的事件  |  計數  |  總計 | 
| **是**  | **是** |  EventGrid/網域  |  PublishSuccessLatencyInMs  |  發佈成功延遲  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/eventSubscriptions  |  DeadLetteredCount  |  失效信件事件  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventGrid/eventSubscriptions  |  DeliveryAttemptFailCount  |  傳遞失敗的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/eventSubscriptions  |  DeliverySuccessCount  |  已傳遞的事件  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventGrid/eventSubscriptions  |  DestinationProcessingDurationInMs  |  目的端處理持續期間  |  毫秒  |  Average | 
| **是**  | **是** |  Microsoft.EventGrid/eventSubscriptions  |  DroppedEventCount  |  卸除的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/eventSubscriptions  |  MatchedEventCount  |  相符的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  PublishFailCount  |  發行失敗的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  PublishSuccessCount  |  已發佈的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  PublishSuccessLatencyInMs  |  發佈成功延遲  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  UnmatchedEventCount  |  不相符的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/topics  |  PublishFailCount  |  發行失敗的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/topics  |  PublishSuccessCount  |  已發佈的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/topics  |  PublishSuccessLatencyInMs  |  發佈成功延遲  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventGrid/topics  |  UnmatchedEventCount  |  不相符的事件  |  計數  |  總計 | 
...
| 否  | 否 |  Microsoft.EventHub/clusters  |  CaptureBacklog  |  擷取待辦項目。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  CapturedBytes  |  已擷取的位元組。  |  位元組  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  CapturedMessages  |  已擷取的訊息。  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.EventHub/clusters  |  IncomingMessages  |  傳入訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/clusters  |  IncomingRequests  |  傳入的要求  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/clusters  |  OutgoingBytes  |  傳出位元組數。  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/clusters  |  OutgoingMessages  |  外送訊息  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  QuotaExceededErrors  |  超出配額的錯誤。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  ServerErrors  |  伺服器錯誤。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  SuccessfulRequests  |  成功的要求  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  ThrottledRequests  |  節流的要求。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  UserErrors  |  使用者錯誤。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  ActiveConnections  |  ActiveConnections  |  計數  |  Average | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  CaptureBacklog  |  擷取待辦項目。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  CapturedBytes  |  已擷取的位元組。  |  位元組  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  CapturedMessages  |  已擷取的訊息。  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHABL  |  封存待處理專案訊息（已淘汰）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHAMBS  |  封存訊息輸送量（已淘汰）  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHAMSGS  |  封存訊息（已淘汰）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINBYTES  |  傳入位元組數 (已過時)  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINMBS  |  傳入位元組數（已過時）（已被取代）  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINMSGS  |  連入訊息數 (已過時)  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHOUTBYTES  |  傳出位元組數 (已過時)  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHOUTMBS  |  傳出位元組數（已過時）（已被取代）  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHOUTMSGS  |  傳出訊息數 (已過時)  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  FAILREQ  |  失敗的要求（已淘汰）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  IncomingBytes  |  傳入位元組數。  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  IncomingMessages  |  傳入訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  IncomingRequests  |  傳入的要求  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INMSGS  |  傳入訊息（已過時）（已淘汰）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INREQS  |  傳入要求（已淘汰）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INTERR  |  內部伺服器錯誤（已淘汰）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  MISCERR  |  其他錯誤（已淘汰）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  OutgoingBytes  |  傳出位元組數。  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  OutgoingMessages  |  外送訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  OUTMSGS  |  外寄訊息（已過時）（已被取代）  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  QuotaExceededErrors  |  超出配額的錯誤。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  ServerErrors  |  伺服器錯誤。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  Size  |  Size  |  位元組  |  Average | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  SuccessfulRequests  |  成功的要求  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  SUCCREQ  |  成功的要求（已淘汰）  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  SVRBSY  |  伺服器忙碌錯誤（已淘汰）  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  ThrottledRequests  |  節流的要求。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  UserErrors  |  使用者錯誤。  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.HDInsight/clusters  |  CategorizedGatewayRequests  |  已分類的閘道要求數  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.HDInsight/clusters  |  GatewayRequests  |  閘道要求數  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.HDInsight/clusters  |  NumActiveWorkers  |  作用中背景工作角色的數目  |  計數  |  最大值 | 
| **是**  | 否 |  Microsoft.HDInsight/clusters  |  ScalingRequests  |  調整要求  |  計數  |  最大值 | 
...
| **是**  | **是** |  Microsoft.Insights/AutoscaleSettings  |  ScaleActionsInitiated  |  已起始的調整規模動作數  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportMaxLatenessMinutes  |  連續匯出最大延遲分鐘數  |  計數  |  最大值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportNumOfRecordsExported  |  連續匯出-匯出記錄的 num  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportPendingCount  |  連續匯出暫止計數  |  計數  |  最大值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportResult  |  連續匯出結果  |  計數  |  計數 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  CPU  |  CPU  |  百分比  |  Average | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  EventsProcessedForEventHubs  |  已處理的事件（適用于事件/IoT 中樞）  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  IngestionVolumeInMB  |  內嵌磁片區（以 MB 為單位）  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsCompleted  |  完成的動作   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsFailed  |  動作的失敗   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsSkipped  |  略過的動作   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsStarted  |  啟動的動作   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionsSucceeded  |  成功的動作   |  計數  |  總計 | 
| **是**  | 否 |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionSuccessLatency  |  動作成功延遲   |  秒  |  Average | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  ActionThrottledEvents  |  動作節流的事件  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunFailurePercentage  |  執行失敗百分比  |  百分比  |  總計 | 
| **是**  | 否 |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunLatency  |  執行延遲  |  秒  |  Average | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsCancelled  |  已取消執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsCompleted  |  完成的執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsFailed  |  失敗的執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsStarted  |  執行已啟動  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunsSucceeded  |  已成功的執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunStartThrottledEvents  |  執行啟動節流事件  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunSuccessLatency  |  執行成功的延遲  |  秒  |  Average | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  RunThrottledEvents  |  執行節流的事件  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersCompleted  |  完成的觸發程序   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersFailed  |  失敗的觸發程序   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersFired  |  引發的觸發程序   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersSkipped  |  略過的觸發程序  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersStarted  |  啟動的觸發程序   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggersSucceeded  |  成功的觸發程序   |  計數  |  總計 | 
| **是**  | 否 |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggerSuccessLatency  |  觸發程序成功延遲   |  秒  |  Average | 
| **是**  | **是** |  Microsoft. 邏輯/integrationServiceEnvironments  |  TriggerThrottledEvents  |  觸發程序節流的事件  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  ActionLatency  |  動作延遲   |  秒  |  Average | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsCompleted  |  完成的動作   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsFailed  |  動作的失敗   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsSkipped  |  略過的動作   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsStarted  |  啟動的動作   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsSucceeded  |  成功的動作   |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  ActionSuccessLatency  |  動作成功延遲   |  秒  |  Average | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionThrottledEvents  |  動作節流的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillableActionExecutions  |  可計費的動作執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillableTriggerExecutions  |  可計費的觸發程序執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageNativeOperation  |  為使用原生作業執行計費  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageNativeOperation  |  為使用原生作業執行計費  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageStandardConnector  |  為使用標準連接器執行計費  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageStandardConnector  |  為使用標準連接器執行計費  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageStorageConsumption  |  為使用儲存體使用量執行計費  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageStorageConsumption  |  為使用儲存體使用量執行計費  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunFailurePercentage  |  執行失敗百分比  |  百分比  |  總計 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  RunLatency  |  執行延遲  |  秒  |  Average | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsCancelled  |  已取消執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsCompleted  |  完成的執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsFailed  |  失敗的執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsStarted  |  執行已啟動  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsSucceeded  |  已成功的執行  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunStartThrottledEvents  |  執行啟動節流事件  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  RunSuccessLatency  |  執行成功的延遲  |  秒  |  Average | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunThrottledEvents  |  執行節流的事件  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TotalBillableExecutions  |  可計費的總執行次數  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersCompleted  |  完成的觸發程序   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersFailed  |  失敗的觸發程序   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersFired  |  引發的觸發程序   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersSkipped  |  略過的觸發程序  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersStarted  |  啟動的觸發程序   |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersSucceeded  |  成功的觸發程序   |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  TriggerSuccessLatency  |  觸發程序成功延遲   |  秒  |  Average | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggerThrottledEvents  |  觸發程序節流的事件  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  已完成的執行  |  已完成的執行  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  失敗的執行  |  失敗的執行  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型部署失敗  |  模型部署失敗  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型部署已開始  |  模型部署已開始  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型部署成功  |  模型部署成功  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型註冊失敗  |  模型註冊失敗  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型註冊成功  |  模型註冊成功  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  開始執行  |  開始執行  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint  |  輸出  |  輸出  |  位元組  |  總計 | 
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint  |  Requests  |  Requests  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint  |  SuccessE2ELatency  |  成功的端對端延遲  |  毫秒  |  Average | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  GCPauseTotalCount  |  GC 暫停計數  |  計數  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  GCPauseTotalTime  |  GC 暫停總時間  |  毫秒  |  總計 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  OldGenPromotedBytes  |  升級為舊的產生資料大小  |  位元組  |  最大值 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  ServiceMemoryMax  |  服務記憶體最大值  |  位元組  |  最大值 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatErrorCount  |  Tomcat 全域錯誤  |  計數  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatReceivedBytes  |  Tomcat 接收的位元組總數  |  位元組  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatRequestMaxTime  |  Tomcat 要求最大時間  |  毫秒  |  最大值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatRequestTotalCount  |  Tomcat 要求總計數  |  計數  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatRequestTotalTime  |  Tomcat 要求總次數  |  毫秒  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatResponseAvgTime  |  Tomcat 要求平均時間  |  毫秒  |  Average | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSentBytes  |  Tomcat 總傳送位元組數  |  位元組  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionActiveCurrentCount  |  Tomcat 會話的生存計數  |  計數  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionActiveMaxCount  |  Tomcat 會話最大使用中計數  |  計數  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionAliveMaxTime  |  Tomcat 會話最大的存留時間  |  毫秒  |  最大值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionCreatedCount  |  Tomcat 會話已建立計數  |  計數  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionExpiredCount  |  Tomcat 會話過期計數  |  計數  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionRejectedCount  |  Tomcat 會話已拒絕計數  |  計數  |  總計 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  YoungGenPromotedBytes  |  升階為年輕產生資料大小  |  位元組  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  BackendResponseStatus  |  後端回應狀態  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  BlockedCount  |  Web 應用程式防火牆封鎖要求規則散發  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  BlockedReqCount  |  Web 應用程式防火牆封鎖的要求計數  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  CurrentConnections  |  目前的連線數  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  FailedRequests  |  失敗的要求  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  HealthyHostCount  |  狀況良好的主機計數  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  MatchedCount  |  Web 應用程式防火牆的規則散發總數  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  ResponseStatus  |  回應狀態  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  Throughput  |  Throughput  |  每秒位元組  |  Average | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  TlsProtocol  |  用戶端 TLS 通訊協定  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  TotalRequests  |  要求總數  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  UnhealthyHostCount  |  狀況不良的主機計數  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  ApplicationRuleHit  |  應用程式規則計數  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  NetworkRuleHit  |  網路規則計數  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/dnszones  |  QueryVolume  |  查詢磁碟區  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Network/dnszones  |  RecordSetCapacityUtilization  |  記錄集容量使用率  |  百分比  |  最大值 | 
| **是**  | 否 |  Microsoft.Network/dnszones  |  RecordSetCount  |  記錄集計數  |  計數  |  最大值 | 
...
| **是**  | **是** |  Microsoft.Network/frontdoors  |  BackendRequestCount  |  後端要求計數  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Network/frontdoors  |  BackendRequestLatency  |  後端要求延遲  |  毫秒  |  Average | 
| **是**  | **是** |  Microsoft.Network/frontdoors  |  BillableResponseSize  |  可計費回應大小  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.Network/frontdoors  |  RequestCount  |  要求計數  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Network/frontdoors  |  WebApplicationFirewallRequestCount  |  Web 應用程式防火牆要求計數  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Network/loadBalancers  |  AllocatedSnatPorts  |  配置的 SNAT 連接埠 (預覽)  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  ByteCount  |  位元組計數  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  DipAvailability  |  健全狀況探查狀態  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  PacketCount  |  封包計數  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  SnatConnectionCount  |  SNAT 連線計數  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  SYNCount  |  SYN 計數  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Network/loadBalancers  |  UsedSnatPorts  |  使用的 SNAT 連接埠 (預覽)  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/networkInterfaces  |  PacketsReceivedRate  |  接收的封包  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/networkInterfaces  |  PacketsSentRate  |  傳送的封包  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  ByteCount  |  位元組計數  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  IfUnderDDoSAttack  |  是否正遭受 DDoS 攻擊  |  計數  |  最大值 | 
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  PacketCount  |  封包計數  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  SynCount  |  SYN 計數  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/trafficManagerProfiles  |  ProbeAgentCurrentEndpointStateByProfileResourceId  |  依端點的端點狀態  |  計數  |  最大值 | 
| **是**  | **是** |  Microsoft.Network/trafficManagerProfiles  |  QpsByEndpoint  |  傳回的依端點查詢數  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  P2SConnectionCount  |  P2S 連線計數  |  計數  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelEgressPacketDropTSMismatch  |  通道輸出 TS 不相符封包捨棄  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelEgressPackets  |  通道輸出封包數  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelIngressBytes  |  通道輸入位元組數  |  位元組  |  總計 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelIngressPacketDropTSMismatch  |  通道輸入 TS 不符合封包捨棄  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelIngressPackets  |  通道輸入封包數  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming  |  傳入訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming.all.failedrequests  |  所有傳入的失敗要求  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming.all.requests  |  所有傳入要求  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming.scheduled  |  傳送已排程的推播通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming.scheduled.cancel  |  取消已排程的推播通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.all  |  安裝管理作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.delete  |  刪除安裝作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.get  |  取得安裝作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.patch  |  修補安裝作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.upsert  |  建立或更新安裝作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  notificationhub.pushes  |  所有外寄通知  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.badorexpiredchannel  |  錯誤或過期的通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.channelerror  |  通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.invalidpayload  |  承載錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.pnserror  |  外部通知系統錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.success  |  成功通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.badchannel  |  APNS 不正確的通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.expiredchannel  |  APNS 過期通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.invalidcredentials  |  APNS 授權錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.invalidnotificationsize  |  APNS 無效通知大小錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.pnserror  |  APNS 錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.success  |  APNS 成功通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.authenticationerror  |  GCM 驗證錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.badchannel  |  GCM 不正確的通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.expiredchannel  |  GCM 過期通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.invalidcredentials  |  GCM 授權錯誤 (無效認證)  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.invalidnotificationformat  |  GCM 無效通知格式  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.invalidnotificationsize  |  GCM 無效通知大小錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.pnserror  |  GCM 錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.success  |  GCM 成功通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.throttled  |  GCM 已將通知節流處理  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.wrongchannel  |  GCM 不正確的通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.authenticationerror  |  MPNS 驗證錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.badchannel  |  MPNS 不正確的通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.channeldisconnected  |  MPNS 通道已中斷連線  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.dropped  |  MPNS 已捨棄通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.invalidcredentials  |  MPNS 無效認證  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.invalidnotificationformat  |  MPNS 無效通知格式  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.pnserror  |  MPNS 錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.success  |  MPNS 成功通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.throttled  |  MPNS 已將通知節流處理  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.authenticationerror  |  WNS 驗證錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.badchannel  |  WNS 不正確的通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.channeldisconnected  |  WNS 通道已中斷連線  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.channelthrottled  |  WNS 通道已節流處理  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.dropped  |  WNS 已捨棄通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.expiredchannel  |  WNS 過期通道錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.invalidcredentials  |  WNS 授權錯誤 (無效認證)  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.invalidnotificationformat  |  WNS 無效通知格式  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.invalidnotificationsize  |  WNS 無效通知大小錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.invalidtoken  |  WNS 授權錯誤 (無效權杖)  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.pnserror  |  WNS 錯誤  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.success  |  WNS 成功通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.throttled  |  WNS 節流通知  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.tokenproviderunreachable  |  WNS 授權錯誤 (無法連線)  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.wrongtoken  |  WNS 授權錯誤 (錯誤權杖)  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.all  |  註冊作業數  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.create  |  註冊建立作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.delete  |  註冊刪除作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.get  |  註冊讀取作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.update  |  註冊更新作業  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  scheduled.pending  |  暫止已排程的通知  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Free Space  |  % Free Space  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Free Space  |  % Free Space  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Idle Time  |  % Idle Time  |  計數  |  Average | 
...
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Processor Time  |  % Processor Time  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Processor Time  |  % Processor Time  |  計數  |  Average | 
...
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. Disk sec/Read  |  Avg. Disk sec/Read  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. Disk sec/Read  |  Avg. Disk sec/Read  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. Disk sec/Transfer  |  Avg. Disk sec/Transfer  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. Disk sec/Write  |  Avg. Disk sec/Write  |  計數  |  Average | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. Disk sec/Write  |  Avg. Disk sec/Write  |  計數  |  Average | 
...
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Bytes  |  Total Bytes  |  計數  |  Average | 
...
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Uptime  |  Uptime  |  計數  |  Average | 
...
| **是**  | **是** |  Microsoft.OperationalInsights/workspaces  |  Heartbeat  |  Heartbeat  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.PowerBIDedicated/capacities  |  qpu_high_utilization_metric  |  QPU 高使用率  |  計數  |  總計 | 
...
| 否  | 否 |  Microsoft.Relay/namespaces  |  ActiveConnections  |  ActiveConnections  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ActiveListeners  |  ActiveListeners  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Relay/namespaces  |  BytesTransferred  |  BytesTransferred  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerConnections-ClientError  |  ListenerConnections-ClientError  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerConnections-ServerError  |  ListenerConnections-ServerError  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerConnections-Success  |  ListenerConnections-Success  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerConnections-TotalRequests  |  ListenerConnections-TotalRequests  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerDisconnects  |  ListenerDisconnects  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderConnections-ClientError  |  SenderConnections-ClientError  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderConnections-ServerError  |  SenderConnections-ServerError  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderConnections-Success  |  SenderConnections-Success  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderConnections-TotalRequests  |  SenderConnections-TotalRequests  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderDisconnects  |  SenderDisconnects  |  計數  |  總計 | 
...
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ActiveConnections  |  ActiveConnections  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.ServiceBus/namespaces  |  IncomingMessages  |  傳入訊息  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.ServiceBus/namespaces  |  IncomingRequests  |  傳入的要求  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.ServiceBus/namespaces  |  OutgoingMessages  |  外送訊息  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ScheduledMessages  |  佇列/主題中已排程的訊息計數。  |  計數  |  Average | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ServerErrors  |  伺服器錯誤。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  Size  |  Size  |  位元組  |  Average | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  SuccessfulRequests  |  成功的要求  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ThrottledRequests  |  節流的要求。  |  計數  |  總計 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  UserErrors  |  使用者錯誤。  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.SignalRService/SignalR  |  ConnectionCount  |  連線計數  |  計數  |  最大值 | 
| **是**  | **是** |  Microsoft.SignalRService/SignalR  |  InboundTraffic  |  輸入流量  |  位元組  |  總計 | 
| **是**  | **是** |  Microsoft.SignalRService/SignalR  |  MessageCount  |  訊息計數  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  app_cpu_billed  |  應用程式 CPU 計費  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  blocked_by_firewall  |  遭到防火牆封鎖  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  connection_failed  |  失敗的連線  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  connection_successful  |  成功的連線  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  deadlock  |  死結  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  dwu_limit  |  DWU 限制  |  計數  |  最大值 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  dwu_used  |  已使用 DWU  |  計數  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  tempdb_data_size  |  Tempdb 資料檔案大小 Kb  |  計數  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  tempdb_log_size  |  Tempdb 記錄檔大小 Kb  |  計數  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  tempdb_log_used_percent  |  使用的 Tempdb 百分比記錄  |  百分比  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  tempdb_data_size  |  Tempdb 資料檔案大小 Kb  |  計數  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  tempdb_log_size  |  Tempdb 記錄檔大小 Kb  |  計數  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  tempdb_log_used_percent  |  使用的 Tempdb 百分比記錄  |  百分比  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts  |  交易  |  交易  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/blobServices  |  交易  |  交易  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/fileServices  |  交易  |  交易  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/queueServices  |  交易  |  交易  |  計數  |  總計 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/tableServices  |  交易  |  交易  |  計數  |  總計 | 
...
| **是**  | 否 |  StorageCache/快取  |  Uptime  |  Uptime  |  計數  |  Average | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecalledNetworkBytesByApplication  |  雲端階層處理重新叫用應用程式的大小  |  位元組  |  總計 | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncServerHeartbeat  |  伺服器線上狀態  |  計數  |  最大值 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncSyncSessionAppliedFilesCount  |  檔案已同步  |  計數  |  總計 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncSyncSessionPerItemErrorsCount  |  檔案無法同步  |  計數  |  總計 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/registeredServers  |  ServerHeartbeat  |  伺服器線上狀態  |  計數  |  最大值 | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups  |  SyncGroupSyncSessionAppliedFilesCount  |  檔案已同步  |  計數  |  總計 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups  |  SyncGroupSyncSessionPerItemErrorsCount  |  檔案無法同步  |  計數  |  總計 | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups/serverEndpoints  |  ServerEndpointSyncSessionAppliedFilesCount  |  檔案已同步  |  計數  |  總計 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups/serverEndpoints  |  ServerEndpointSyncSessionPerItemErrorsCount  |  檔案無法同步  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  AMLCalloutFailedRequests  |  失敗的函式要求  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  AMLCalloutInputEvents  |  函式事件  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  AMLCalloutRequests  |  函式要求  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  ConversionErrors  |  資料轉換錯誤  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  DeserializationError  |  輸入還原序列化錯誤  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  DroppedOrAdjustedEvents  |  次序錯誤事件  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  EarlyInputEvents  |  早期輸入事件  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  Errors  |  執行階段錯誤  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  InputEventBytes  |  輸入事件位元組  |  位元組  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  InputEvents  |  輸入事件  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  InputEventsSourcesBacklogged  |  待處理輸入事件數  |  計數  |  最大值 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  InputEventsSourcesPerSecond  |  收到的輸入來源數  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  LateInputEvents  |  延遲輸入事件  |  計數  |  總計 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  OutputEvents  |  輸出事件  |  計數  |  總計 | 
...
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  Disk Read Bytes  |  Disk Read Bytes  |  位元組  |  總計 | 
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  Disk Read Operations/Sec  |  Disk Read Operations/Sec  |  每秒計數  |  Average | 
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  Disk Write Bytes  |  Disk Write Bytes  |  位元組  |  總計 | 
...
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  DiskReadOperations  |  磁片讀取作業  |  計數  |  總計 | 
...
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  DiskWriteOperations  |  磁片寫入作業  |  計數  |  總計 | 
...
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  Network In  |  Network In  |  位元組  |  總計 | 
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  Network Out  |  Network Out  |  位元組  |  總計 | 
...
| **是**  | 否 |  VMwareCloudSimple/virtualMachines  |  PercentageCpuReady  |  CPU 已就緒百分比  |  毫秒  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  ActiveRequests  |  使用中的要求  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  DiskQueueLength  |  磁碟佇列長度  |  計數  |  Average | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http101  |  Http 101  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http2xx  |  Http 2xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http3xx  |  Http 3xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http401  |  Http 401  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http403  |  Http 403  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http404  |  Http 404  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http406  |  Http 406  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http4xx  |  Http 4xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http5xx  |  Http 伺服器錯誤  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Requests  |  Requests  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Web/serverfarms  |  DiskQueueLength  |  磁碟佇列長度  |  計數  |  Average | 
...
| **是**  | **是** |  Microsoft.Web/sites  |  FunctionExecutionCount  |  函式執行計數  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  FunctionExecutionUnits  |  函式執行單位  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Gen0Collections  |  Gen 0 記憶體回收  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Gen1Collections  |  Gen 1 記憶體回收  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Gen2Collections  |  Gen 2 記憶體回收  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  處理  |  控制代碼計數  |  計數  |  Average | 
| **是**  | **是** |  Microsoft.Web/sites  |  HealthCheckStatus  |  健全狀況檢查狀態  |  計數  |  Average | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http101  |  Http 101  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http2xx  |  Http 2xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http3xx  |  Http 3xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http401  |  Http 401  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http403  |  Http 403  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http404  |  Http 404  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http406  |  Http 406  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http4xx  |  Http 4xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http5xx  |  Http 伺服器錯誤  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Web/sites  |  Requests  |  Requests  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Web/sites/slots  |  FunctionExecutionCount  |  函式執行計數  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  FunctionExecutionUnits  |  函式執行單位  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Gen0Collections  |  Gen 0 記憶體回收  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Gen1Collections  |  Gen 1 記憶體回收  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Gen2Collections  |  Gen 2 記憶體回收  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  處理  |  控制代碼計數  |  計數  |  Average | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  HealthCheckStatus  |  健全狀況檢查狀態  |  計數  |  Average | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http101  |  Http 101  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http2xx  |  Http 2xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http3xx  |  Http 3xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http401  |  Http 401  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http403  |  Http 403  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http404  |  Http 404  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http406  |  Http 406  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http4xx  |  Http 4xx  |  計數  |  總計 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http5xx  |  Http 伺服器錯誤  |  計數  |  總計 | 
...
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Requests  |  Requests  |  計數  |  總計 | 
