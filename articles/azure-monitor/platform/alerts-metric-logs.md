...
- [更新管理](../../automation/update-management/overview.md)記錄
...
3. **已安裝支援的 Log analytics** 解決方案：應設定 log analytics 解決方案，並將資料傳送至 log analytics 工作區支援的解決方案，包括 [Windows & Linux 的效能計數器](./data-sources-performance-counters.md)、 [代理程式健全狀況的心跳記錄](../insights/solution-agenthealth.md)、 [更新管理](../../automation/update-management/overview.md)和 [事件資料](./data-sources-windows-events.md)。
