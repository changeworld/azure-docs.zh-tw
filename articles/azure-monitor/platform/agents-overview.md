...
* 使用 [Azure 自動化的更新管理](../../automation/update-management/update-mgmt-overview.md)、 [Azure 自動化狀態設定](../../automation/automation-dsc-overview.md)或 [Azure 自動化變更追蹤和清查](../../automation/change-tracking/overview.md) ，以提供 Azure vm 的全方位管理
