...
* 請流覽 Log Analytics 意見反應頁面，以查看已提交[https://aka.ms/opinsightsfeedback](https://aka.ms/opinsightsfeedback)的想法和 bug，或提出新的問題。 
...
- 依**事件來源** - *健全狀況服務模組*]、[ *HealthService*] 和 [*服務連接器*] 篩選*Operations Manager*事件記錄檔，並依**事件層級***警告*和*錯誤*篩選，以確認它是否已寫入下表中的事件。 如果是，請檢查每個可能事件所包含的解決步驟。
