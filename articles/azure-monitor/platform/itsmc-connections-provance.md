---
title: 將 Provance 與 IT 服務管理連接器連線
description: 本文提供有關如何使用 IT 服務管理連接器 Provance 的資訊， (ITSMC) 在 Azure 監視器中，以集中監視及管理 ITSM 工作專案。
ms.subservice: logs
ms.topic: conceptual
author: nolavime
ms.author: v-jysur
...
ms.locfileid: "97729631"
---
# <a name="connect-provance-with-it-service-management-connector"></a>將 Provance 與 IT 服務管理連接器連線

本文提供有關如何設定 Provance 實例與 IT 服務管理連接器之間的連線 (ITSMC) Log Analytics 中的連線，以集中管理您的工作專案。
