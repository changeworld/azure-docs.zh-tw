...
1. 如**System Center Operations Manager**警示，請[將您的 Operations Manager 管理群組連接到 Log Analytics 工作區](./om-agents.md)。 在此之後，從 Azure 解決方案市集部署[警示管理](./alert-management-solution.md)解決方案。 完成後，在 System Center Operations Manager 中建立的任何警示會匯入至記錄分析。
