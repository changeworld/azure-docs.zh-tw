...
![Azure 監視器 View Designer 中的查詢視覺化部分清單螢幕擷取畫面。](media/view-designer-parts/view-list-queries.png)
...
![Azure 監視器視圖設計工具中的數位和清單視覺效果元件的螢幕擷取畫面。](media/view-designer-parts/view-number-list.png)
