...
您還可以對存儲在日誌分析工作區中作為指標提取的常用日誌資料使用較新的指標警報。 如需詳細資訊，請檢視[記錄的計量警示](../../azure-monitor/platform/alerts-metric-logs.md)。
...
|Microsoft.Cache/Redis|是| 否 |[用於雷瑞斯的 Azure 緩存](../../azure-monitor/platform/metrics-supported.md#microsoftcacheredis)|
|微軟.經典存儲/存儲帳戶/mmx 經典|否|是|
|微軟.經典存儲/存儲帳戶/mmx經典/blob服務|否|是|
|微軟.經典存儲/存儲帳戶/mmx經典/檔服務|否|是|
...
|Microsoft.Compute/virtualMachineScaleSets |N/A | 是 |[虛擬機器縮放集](../../azure-monitor/platform/metrics-supported.md#microsoftcomputevirtualmachinescalesets)|
...
|微軟.事件網格/域|否|是| |
|Microsoft.EventGrid/topics |是 | 否 |[事件網格主題](../../azure-monitor/platform/metrics-supported.md#microsofteventgridtopics)|
...
|Microsoft.Network/loadBalancers (僅適用於標準 SKU)| 是| 否 | [負載等化器](../../azure-monitor/platform/metrics-supported.md#microsoftnetworkloadbalancers) |
...
|Microsoft.Web/hostingEnvironments/multiRolePools | 是 | 否 | [應用服務環境多角色池](../../azure-monitor/platform/metrics-supported.md#microsoftwebhostingenvironmentsmultirolepools)|
|Microsoft.Web/hostingEnvironments/workerPools | 是 | 否 | [應用服務環境輔助池](../../azure-monitor/platform/metrics-supported.md#microsoftwebhostingenvironmentsworkerpools)|
...
* 瞭解[Azure 中的警報](../../azure-monitor/platform/alerts-overview.md)。
