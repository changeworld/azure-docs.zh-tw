...
| | [使用 Azure Stack Resource Manager 範本](https://github.com/Azure/AzureStack-QuickStart-Templates/tree/master/MicrosoftMonitoringAgent-ext-win) | 如果您已在資料中心內部署 Microsoft Azure Stack，請使用 Azure Resource Manager 範本。| 
