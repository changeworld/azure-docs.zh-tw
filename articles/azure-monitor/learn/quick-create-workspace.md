...
1. 在 [Azure 入口網站中，按一下 [**所有服務**]。 在資源清單中，輸入**Log Analytics**。 當您開始輸入時，清單會根據您輸入的文字進行篩選。 選取 [Log Analytics 工作區]****。
...
* [新增 System Center Operations Manager 做為資料來源](../platform/om-agents.md)，以從報告您 Operations Manager 管理群組的代理程式收集資料，並將其儲存在 Log Analytics 工作區中。 
