...
1. 新增訂用帳戶層級的角色指派：
   ...
   :::image type="content" source="./media/create-blueprint-portal/add-role-assignment.png" alt-text="[藍圖定義] 頁面上 [建立藍圖] 按鈕的螢幕擷取畫面。" border="false":::
...
1. 在資源群組下新增範本：
   ...
   :::image type="content" source="./media/create-blueprint-portal/add-resource-manager-template.png" alt-text="[藍圖定義] 頁面上 [建立藍圖] 按鈕的螢幕擷取畫面。" border="false":::

1. 完成的藍圖應該如下所示： 請注意，每個成品的 [參數]**** 資料行中都會出現**已填入 _x_ 個參數，共 _y_ 個**。 在每次指派藍圖時都會設定動態參數。

   :::image type="content" source="./media/create-blueprint-portal/completed-blueprint.png" alt-text="[藍圖定義] 頁面上 [建立藍圖] 按鈕的螢幕擷取畫面。" border="false":::
...
1. 在資源群組下新增角色指派：
   ...
   :::image type="content" source="./media/create-blueprint-portal/add-role-assignment-2.png" alt-text="[藍圖定義] 頁面上 [建立藍圖] 按鈕的螢幕擷取畫面。" border="false":::

1. 完成的藍圖應該如下所示： 請注意，新增的角色指派會顯示**已填入 1 個參數，共 1 個**。 這表示它是靜態參數。

   :::image type="content" source="./media/create-blueprint-portal/completed-blueprint-2.png" alt-text="[藍圖定義] 頁面上 [建立藍圖] 按鈕的螢幕擷取畫面。" border="false":::
...
1. 在 [指派藍圖]**** 頁面的 [訂用帳戶]**** 下拉式清單中，選取要部署此藍圖的訂用帳戶。
   ...
   1. 選取頁面底部的 [建立]****。
      ...
      :::image type="content" source="./media/create-blueprint-portal/assignment-create-subscription.png" alt-text="[藍圖定義] 頁面上 [建立藍圖] 按鈕的螢幕擷取畫面。" border="false":::
...
1. [鎖定指派]**** 請保留 [不要鎖定]**** 的預設值。 如需詳細資訊，請參閱[藍圖資源鎖定](./concepts/resource-locking.md)。
   ...
   :::image type="content" source="./media/create-blueprint-portal/assignment-locking-mi.png" alt-text="[藍圖定義] 頁面上 [建立藍圖] 按鈕的螢幕擷取畫面。" border="false":::
...
1. 在藍圖清單中，以滑鼠右鍵按一下您先前指派的藍圖，然後選取 [檢視指派詳細資料]****。
   ...
   :::image type="content" source="./media/create-blueprint-portal/view-assignment-details.png" alt-text="[藍圖定義] 頁面上 [建立藍圖] 按鈕的螢幕擷取畫面。" border="false":::
