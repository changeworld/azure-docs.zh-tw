...
1. 在左側的 [快速入門]**** 頁面上，選取 [建立藍圖]__ **下方的 [建立]** 按鈕。

1. 在 [其他範例]__ 下方尋找 **CIS Microsoft Azure 基礎基準測試 v1.1.0** 藍圖範例，然後選取 [使用此範例]****。
...
1. 在頁面頂端選取 [成品]__ 索引標籤，或在頁面底部選取 **[下一步：成品]** 。
