---
title: 部署 Azure 安全性效能評定藍圖範例
description: Azure 安全性效能評定藍圖範例的部署步驟，其中包括藍圖成品參數的詳細資料。
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82702669"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>部署 Azure 安全性效能評定藍圖範例
...
1. 在「其他範例」  下，尋找 **Azure 安全性效能評定**藍圖範例，然後按一下名稱以選取此範例。
...
|成品名稱|成品類型|參數名稱|描述|
|-|-|-|-|
|稽核 Azure 安全性效能評定建議，以及部署特定的受支援 VM 延伸模組|原則指派|
從 Windows VM 系統管理員群組排除的使用者清單|應從系統管理員本機群組中排除之成員的分號分隔清單。 例如：Administrator; myUser1; myUser2|
...
您已檢閱過部署 Azure 安全性效能評定藍圖範例的步驟，接下來請瀏覽下列文章，以了解藍圖和控制項對應：

> [!div class="nextstepaction"]
> [Azure 安全性效能評定藍圖 - 概觀](./index.md)
> [Azure 安全性效能評定藍圖 - 控制項對應](./control-mapping.md)
