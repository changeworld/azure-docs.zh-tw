...
[Azure 原則控制項對應](../../policy/samples/nist-sp-800-53-r4.md)提供此藍圖中所包含原則定義的相關詳細資料，以及這些原則定義如何對應至 NIST SP 800-53 R4 中的**合規性網域**和**控制項**。 將資源指派給架構時，Azure 原則會評估不符合已指派原則定義的資源。 如需詳細資訊，請參閱 [Azure 原則](../../policy/overview.md)。
