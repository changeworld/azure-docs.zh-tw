...
[Azure 角色型存取控制 (Azure RBAC)](../../../../role-based-access-control/overview.md) 可協助管理有權存取 Azure 資源的人員。 此藍圖指派了七項 [Azure 原則](../../../policy/overview.md)定義以協助您控制對 Azure 資源的存取。 這些原則會稽核資源類型和組態的使用方式是否可能會允許更寬鬆資源存取。
