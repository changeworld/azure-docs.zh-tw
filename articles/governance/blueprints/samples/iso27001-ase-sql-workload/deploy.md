...
|虛擬網路與路由表範本|Resource Manager 範本|Azure 防火牆私人 IP|設定 [Azure 防火牆](../../../../firewall/overview.md)的私人 IP。 應是 CIDR 標記法的一部份，定義於 _ISO 27001：共用服務_ 成品參數 **Azure 防火牆子網路位址首碼** 。 預設值為 10.0.4.4。|
