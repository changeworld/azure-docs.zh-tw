...
description: 控制 DoD 影響等級 4 藍圖範例的對應。 每個控制措施都會對應至一或多個可協助評量的 Azure 原則定義。
ms.date: 10/26/2020
ms.topic: sample
