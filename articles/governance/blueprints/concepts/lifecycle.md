...
處於**草稿**模式且未曾發佈的藍圖會在 [藍圖定義]**** 頁面上，顯示與**已發佈**藍圖不同的圖示。 **最新版本**顯示為這些從未發佈的藍圖的**草稿**。
...
1. 從左側的頁面中選擇**藍圖定義**，並使用篩選器選項查找要刪除 的藍圖。 選擇它以打開編輯頁面。

1. 選擇 **"已發佈版本**"選項卡，然後找到要刪除的版本。

1. 按右鍵要刪除的版本，然後選擇 **"刪除此版本**"。
