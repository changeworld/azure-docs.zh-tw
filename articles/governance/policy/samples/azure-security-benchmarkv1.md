...
如需此合規性標準的詳細資訊，請參閱 [Azure 安全性基準測試 v1](../../../security/benchmarks/overview.md)。 若要了解 _所有權_，請參閱 [Azure 原則原則定義](../concepts/definition-structure.md#type)與 [雲端中共同承擔的責任](../../../security/fundamentals/shared-responsibility.md)。
