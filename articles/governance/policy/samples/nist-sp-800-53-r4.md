...
ms.locfileid: "84219275"
---
# <a name="details-of-the-nist-sp-800-53-r4-regulatory-compliance-built-in-initiative"></a>NIST SP 800-53 R4 法規合規性內建方案的詳細資料

下列文章詳細說明 Azure 原則法規合規性內建方案定義如何將**合規性領域**與**控制措施**對應至 NIST SP 800-53 R4。
如需此合規性標準的詳細資訊，請參閱 [NIST SP 800-53 R4](https://nvd.nist.gov/800-53)。 若要了解_所有權_，請參閱 [Azure 原則原則定義](../concepts/definition-structure.md#type)與[雲端中共同承擔的責任](../../../security/fundamentals/shared-responsibility.md)。
...
然後，找出並選取 **[預覽]：稽核 NIST SP 800-53 R4 控制措施並部署特定的 VM 延伸模組，以支援稽核需求** 法規合規性內建方案定義。

> [!IMPORTANT]
> 下列每個控制措施都與一或多個 [Azure 原則](../overview.md)定義相關聯。
> 這些原則可協助您使用工具[存取合規性](../how-to/get-compliance-data.md)；不過，控制措施和一或多個原則之間，通常不是 1：1 或完整對應。 因此，Azure 原則中的**符合規範**只是指原則定義本身，這不保證您完全符合所有控制措施需求的規範。 此外，合規性標準包含目前未由任何 Azure 原則定義解決的控制措施。 因此，Azure 原則中的合規性只是整體合規性狀態的部分觀點。 此合規性標準的合規性領域、控制措施與 Azure 原則定義之間的關聯，可能會隨著時間而改變。 若要檢視變更歷程記錄，請參閱 [GitHub 認可歷程記錄](https://github.com/Azure/azure-policy/commits/master/built-in-policies/policySetDefinitions/Regulatory%20Compliance/NIST80053_audit.json) \(英文\)。
...
|名稱<br /><sub>(Azure 入口網站)</sup> |描述 |效果 |版本<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
...
|[部署必要條件，以稽核 Administrators 群組包含任何指定成員的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F144f1397-32f9-4598-8c88-118decc3ccba) |此原則會建立客體設定指派，以稽核 Administrators 群組包含任何指定成員的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembersToExclude_Deploy.json) |
|[部署必要條件以稽核 Administrators 群組不包含任何指定成員的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F93507a81-10a4-4af0-9ee2-34cf25a96e98) |此原則會建立客體設定指派，以稽核 Administrators 群組不包含所有指定成員的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembersToInclude_Deploy.json) |
...
|名稱<br /><sub>(Azure 入口網站)</sup> |描述 |效果 |版本<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[部署必要條件以稽核允許不使用密碼從帳戶遠端連線的 Linux VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fec49586f-4939-402d-a29e-6ff502b20592) |此原則會建立客體設定指派，以稽核允許帳戶無需密碼便可從遠端連線的 Linux 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword110_Deploy.json) |
...
|[從允許不使用密碼從帳戶遠端連線的 Linux VM 顯示稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d67222d-05fd-4526-a171-2ee132ad9e83) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理稽核 Linux 虛擬機器的結果，以允許不使用密碼從帳戶進行遠端連線。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword110_Audit.json) |
...
|名稱<br /><sub>(Azure 入口網站)</sup> |描述 |效果 |版本<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[部署必要條件，以稽核密碼檔權限未設為 0644 的 Linux VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff19aa1c1-6b91-4c27-ae6a-970279f03db9) |此原則會建立客體設定指派，以稽核未將密碼檔權限設為 0644 的 Linux 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Deploy.json) |
|[部署必要條件，以稽核有不具密碼帳戶的 Linux VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F3470477a-b35a-49db-aca5-1073d04524fe) |此原則會建立客體設定指派，以稽核有不具密碼帳戶的 Linux VM。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.2.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Deploy.json) |
|[部署必要條件以稽核未使用可逆加密來儲存密碼的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F8ff0b18b-262e-4512-857a-48ad0aeb9a78) |此原則會建立客體設定指派，以稽核未使用可逆加密來儲存密碼的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Deploy.json) |
...
|[從密碼檔權限未設為 0644 的 Linux VM 顯示稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb18175dd-c599-4c64-83ba-bb018a06d35b) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理密碼檔權限未設為 0644 的 Linux 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Audit.json) |
|[從帳戶沒有密碼的 Linux VM 顯示稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc40c9087-1981-4e73-9f53-39743eda9d05) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理帳戶沒有密碼的 Linux 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Audit.json) |
|[從未使用可逆加密來儲存密碼的 Windows VM 顯示結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理未使用可逆加密來儲存密碼的 Windows 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|名稱<br /><sub>(Azure 入口網站)</sup> |描述 |效果 |版本<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[部署必要條件以稽核允許重複使用前 24 個舊密碼的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F726671ac-c4de-4908-8c7d-6043ae62e3b6) |此原則會建立客體設定指派，以稽核允許重複使用前 24 個舊密碼的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Deploy.json) |
|[部署必要條件以稽核最大密碼存留期不是 70 天的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F356a906e-05e5-4625-8729-90771e0ee934) |此原則會建立客體設定指派，以稽核最大密碼存留期不是 70 天的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Deploy.json) |
|[部署必要條件以稽核最小密碼存留期不是 1 天的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F16390df4-2f73-4b42-af13-c801066763df) |此原則會建立客體設定指派，以稽核最小密碼存留期不是 1 天的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Deploy.json) |
|[部署必要條件以稽核未啟用密碼複雜度設定的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F7ed40801-8a0f-4ceb-85c0-9fd25c1d61a8) |此原則會建立客體設定指派，以稽核未啟用密碼複雜度設定的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Deploy.json) |
|[部署必要條件以稽核最小密碼長度未限制為 14 個字元的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F23020aa6-1135-4be2-bae2-149982b06eca) |此原則會建立客體設定指派，以稽核最小密碼長度未限制為 14 個字元的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Deploy.json) |
|[部署必要條件以稽核未使用可逆加密來儲存密碼的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F8ff0b18b-262e-4512-857a-48ad0aeb9a78) |此原則會建立客體設定指派，以稽核未使用可逆加密來儲存密碼的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Deploy.json) |
...
|[從允許重複使用前 24 個舊密碼的 Windows VM 顯示稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fcdbf72d9-ac9c-4026-8a3a-491a5ac59293) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理允許重複使用前 24 個舊密碼的 Windows 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Audit.json) |
|[從最大密碼存留期不是 70 天的 Windows VM 顯示稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F24dde96d-f0b1-425e-884f-4a1421e2dcdc) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理最大密碼存留期不是 70 天的 Windows 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Audit.json) |
|[從最小密碼存留期不是 1 天的 Windows VM 顯示稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aa11bbc-5c76-4302-80e5-aba46a4282e7) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理最小密碼存留期不是 1 天的 Windows 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Audit.json) |
|[從未啟用密碼複雜度設定的 Windows VM 顯示稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff48b2913-1dc5-4834-8c72-ccc1dfd819bb) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理未啟用密碼複雜度設定的 Windows 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Audit.json) |
|[從最小密碼長度未限制為 14 個字元的 Windows VM 顯示稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aebc8d1-020d-4037-89a0-02043a7524ec) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理最小密碼長度未限制為 14 個字元的 Windows 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Audit.json) |
|[從未使用可逆加密來儲存密碼的 Windows VM 顯示結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理未使用可逆加密來儲存密碼的 Windows 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|[部署必要條件以稽核未使用安全通訊協定的 Windows 網頁伺服器](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb2fc8f91-866d-4434-9089-5ebfe38d6fd8) |此原則會建立客體設定指派，以稽核未使用安全通訊協定 (TLS 1.1 或 TLS 1.2) 的 Windows 網頁伺服器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsTLS_Deploy.json) |
