...
然後，找出並選取 [稽核 Azure Security Benchmark 建議，以及部署特定的受支援 VM 延伸模組] 法規合規性內建方案定義。
...
### <a name="encrypt-all-sensitive-information-in-transit"></a>加密所有傳輸中的敏感性資訊
...
### <a name="maintain-an-inventory-of-sensitive-information"></a>維護敏感性資訊的詳細目錄
...
### <a name="ensure-protection-of-backups-and-customer-managed-keys"></a>確保備份和客戶管理金鑰受到保護
...
### <a name="log-and-alert-on-suspicious-activity-from-administrative-accounts"></a>針對來自系統管理帳戶的可疑活動留下記錄和發出警示

**識別碼**：Azure Security Benchmark 3.7 **擁有權**：客戶
...
### <a name="maintain-an-inventory-of-administrative-accounts"></a>維護系統管理帳戶的詳細目錄
...
|[部署必要條件以稽核 Administrators 群組不只包含指定成員的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb821191b-3a12-44bc-9c38-212138a29ff3) |此原則會建立客體設定指派，以稽核 Administrators 群組不只包含指定成員的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministratorsGroupMembers_Deploy.json) |
...
### <a name="create-an-incident-scoring-and-prioritization-procedure"></a>建立事件評分和優先順序程序

**識別碼**：Azure Security Benchmark 10.2 **擁有權**：客戶
...
|[應在 SQL 受控執行個體進階資料安全性設定中，啟用傳給系統管理員和訂用帳戶擁有者的電子郵件通知](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Faeb23562-188d-47cb-80b8-551f16ef9fff) |稽核 SQL 受控執行個體進階威脅防護設定中是否已啟用 [以電子郵件傳送通知給系統管理員和訂用帳戶擁有者]。 這可確保在 SQL 受控執行個體上偵測到的異常活動都會盡快回報給系統管理員。 |AuditIfNotExists, Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurityEmailAdmins_Audit.json) |
...
|[部署必要條件，以稽核 Log Analytics 代理程式未如預期連線的 Windows VM](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F68511db2-bd02-41c4-ae6b-1900a012968a) |此原則會建立客體設定指派，以稽核其 Log Analytics 代理程式未連線到指定工作區的 Windows 虛擬機器。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsLogAnalyticsAgentConnection_Deploy.json) |
|[顯示 Log Analytics 代理程式未如預期連線的 Windows VM 稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fa030a57e-4639-4e8f-ade9-a92f33afe7ee) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理 Log Analytics 代理程式未連線到指定工作區的 Windows 虛擬機器稽核結果。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsLogAnalyticsAgentConnection_Audit.json) |
...
### <a name="ensure-anti-malware-software-and-signatures-are-updated"></a>確保會更新反惡意程式碼軟體與特徵碼
...
### <a name="pre-scan-files-to-be-uploaded-to-non-compute-azure-resources"></a>預先掃描要上傳至非計算 Azure 資源的檔案

**識別碼**：Azure Security Benchmark 8.2 **擁有權**：客戶
...
### <a name="deny-communications-with-known-malicious-ip-addresses"></a>拒絕與已知惡意 IP 位址的通訊
...
|名稱<br /><sub>(Azure 入口網站)</sup> |描述 |效果 |版本<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[部署必要條件，以稽核 [系統管理範本 - 網路] 中的 Windows VM 設定](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F985285b7-b97a-419c-8d48-c88cc934c8d8) |此原則會建立客體設定指派，以稽核下列群組原則類別中設定不符合規範的 Windows 虛擬機器：[系統管理範本 - 網路]。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministrativeTemplatesNetwork_Deploy.json) |
|[部署必要條件，以稽核 [安全性選項 - Microsoft 網路伺服器] 中的 Windows VM 設定](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F86880e5c-df35-43c5-95ad-7e120635775e) |此原則會建立客體設定指派，以稽核下列群組原則類別中設定不符合規範的 Windows 虛擬機器：[安全性選項 - Microsoft 網路伺服器]。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_SecurityOptionsMicrosoftNetworkServer_Deploy.json) |
|[部署必要條件，以稽核 [安全性選項 - 網路存取] 中的 Windows VM 設定](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff56a3ab2-89d1-44de-ac0d-2ada5962e22a) |此原則會建立客體設定指派，以稽核下列群組原則類別中設定不符合規範的 Windows 虛擬機器：[安全性選項 - 網路存取]。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_SecurityOptionsNetworkAccess_Deploy.json) |
|[部署必要條件，以稽核 [安全性選項 - 網路安全性] 中的 Windows VM 設定](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F36e17963-7202-494a-80c3-f508211c826b) |此原則會建立客體設定指派，以稽核下列群組原則類別中設定不符合規範的 Windows 虛擬機器：[安全性選項 - 網路安全性]。 其也會建立系統指派的受控識別，並部署客體設定的 VM 擴充功能。 此原則應只搭配計畫中的對應稽核原則使用。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |deployIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_SecurityOptionsNetworkSecurity_Deploy.json) |
|[顯示 [系統管理範本 - 網路] 中的 Windows VM 設定稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F7229bd6a-693d-478a-87f0-1dc1af06f3b8) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理下列群組原則類別中設定不符合規範的 Windows 虛擬機器稽核結果：[系統管理範本 - 網路]。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_AdministrativeTemplatesNetwork_Audit.json) |
|[顯示 [安全性選項 - Microsoft 網路用戶端] 中的 Windows VM 設定稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ffcbc55c9-f25a-4e55-a6cb-33acb3be778b) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理下列群組原則類別中設定不符合規範的 Windows 虛擬機器稽核結果：[安全性選項 - Microsoft 網路用戶端]。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_SecurityOptionsMicrosoftNetworkClient_Audit.json) |
|[顯示 [安全性選項 - Microsoft 網路伺服器] 中的 Windows VM 設定稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F6fe4ef56-7576-4dc4-8e9c-26bad4b087ce) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理下列群組原則類別中設定不符合規範的 Windows 虛擬機器稽核結果：[安全性選項 - Microsoft 網路伺服器]。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_SecurityOptionsMicrosoftNetworkServer_Audit.json) |
|[顯示 [安全性選項 - 網路安全性] 中的 Windows VM 設定稽核結果](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5c028d2a-1889-45f6-b821-31f42711ced8) |此原則應只搭配計畫中的對應部署原則使用。 此定義可讓 Azure 原則處理下列群組原則類別中設定不符合規範的 Windows 虛擬機器稽核結果：[安全性選項 - 網路安全性]。 如需有關客體設定原則的詳細資訊，請造訪 [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_SecurityOptionsNetworkSecurity_Audit.json) |
