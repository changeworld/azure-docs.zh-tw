---
title: Windows 虛擬桌面環境（秋季2019）-Azure
description: 瞭解 Windows 虛擬桌面（2019版）環境（例如租使用者和主機集區）的基本元素。
...
ms.locfileid: "87082642"
---
# <a name="windows-virtual-desktop-environment-fall-2019-release"></a>Windows 虛擬桌面環境（秋季2019版）
