...
description: 如何使用 PowerShell Cmdlet 在 Windows 虛擬桌面中建立主機集區 (傳統) 。
author: Heidilohr
ms.topic: how-to
ms.date: 03/30/2020
ms.author: helohr
...
---
# <a name="create-a-host-pool-in-windows-virtual-desktop-classic-with-powershell"></a>使用 PowerShell 在 Windows 虛擬桌面中建立主機集區 (傳統) 
