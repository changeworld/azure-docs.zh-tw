---
title: 連線到 Windows 虛擬桌面 (傳統) Windows 10 或 7-Azure
...
---
# <a name="connect-with-the-windows-desktop-classic-client"></a> (傳統) 用戶端連線到 Windows 桌面
...
您可以使用 windows 桌面用戶端，在具有 Windows 7、Windows 10 和 Windows 10 IoT 企業版的裝置上存取 Windows 虛擬桌面資源。 用戶端不支援 Windows 8 或 Windows 8.1。
