...
>[!IMPORTANT]
>此內容適用於具有 Azure Resource Manager Windows 虛擬桌面物件的 Windows 虛擬桌面。 如果您使用不含 Azure Resource Manager 物件的 Windows 虛擬桌面 (傳統)，請參閱[此文章](./virtual-desktop-fall-2019/deploy-windows-7-virtual-machine.md)。
...
7. 在 [選用類別] 中安裝所有 Windows 更新， (排除語言套件) 。 此程式會安裝您完成這些指示所需的遠端桌面通訊協定8.0 更新 ([KB2592687](https://www.microsoft.com/download/details.aspx?id=35387)) 。
