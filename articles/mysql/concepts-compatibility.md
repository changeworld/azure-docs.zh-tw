...
| **程式設計語言** | **驅動程式** | **連結** | **相容的版本** | **不相容的版本** | **注意** |
| :----------------------- | :--------- | :-------- | :---------------------- | :------------------------ | :-------- |
...
| 移至 | Go MySQL 驅動程式 | https://github.com/go-sql-driver/mysql/releases | 1.3、1。4 | 1.2 及更舊版本 | 在1.3 版的連接字串中使用 `allowNativePasswords=true`。 1\.4 版包含修正程式，不再需要 `allowNativePasswords=true`。 |
