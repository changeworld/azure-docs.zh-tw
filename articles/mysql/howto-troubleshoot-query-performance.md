---
title: 故障排除查詢性能 - MySQL 的 Azure 資料庫
description: 瞭解如何使用 EXPLAIN 在 MySQL 的 Azure 資料庫中對查詢性能進行故障排除。
author: ajlam
ms.author: andrela
ms.service: mysql
...
 
使用 EXPLAIN 和不同類型的索引可大幅提升效能。 在表上設置索引並不一定意味著 MySQL 能夠將其用於查詢。 請務必使用 EXPLAIN 驗證您的假設，並使用索引將查詢最佳化。
