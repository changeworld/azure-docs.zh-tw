...
>[使用 MySQL 在 Linux 上建立 PHP 應用程式](../../app-service/containers/tutorial-php-mysql-app.md)<br/>
>[使用 MySQL 建立以 JAVA 為基礎的彈簧應用程式](https://docs.microsoft.com/azure/developer/java/spring-framework/spring-app-service-e2e?tabs=bash)<br/>
