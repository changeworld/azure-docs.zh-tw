...
| C | Windows、Linux、Mac OS X | [MySQL 連接器/C 開發人員指南](https://dev.mysql.com/doc/refman/8.0/en/c-api.html) | [下載](https://dev.mysql.com/downloads/connector/c/)
...
[PHP](./connect-php.md) | [JAVA](./connect-java.md) |  [.NET （C#）](./connect-csharp.md) | [Python](./connect-python.md) | [節點.JS](./connect-nodejs.md) | [Ruby](./connect-ruby.md) | [C++](connect-cpp.md) | [去](./connect-go.md)
