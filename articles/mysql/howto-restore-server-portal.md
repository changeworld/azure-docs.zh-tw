---
title: 備份和還原 - Azure 門戶 - MySQL 的 Azure 資料庫
...
若要完成本操作說明指南，您需要：
- [MySQL 伺服器和資料庫的 Azure 資料庫](quickstart-create-mysql-server-database-using-azure-portal.md)
...
1. 選擇門戶左上角的 **"創建資源**按鈕 （+）。 為**MySQL**選擇**資料庫** > Azure 資料庫。
