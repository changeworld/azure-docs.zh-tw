...
:::image type="content" source="./media/manage/backend.png" alt-text="建立後端集區頁面。" border="true":::
...
| Port | 健康情況探查的目的地埠。 </br> 這項設定是健康情況探查將用來判斷實例健康情況的後端實例上的埠。 |
...
:::image type="content" source="./media/manage/health-probe.png" alt-text="新增健康情況探查。" border="true":::
...
| Port | 這項設定是與前端 IP 相關聯的埠，您想要根據此負載平衡規則來散發流量。 |
...
:::image type="content" source="./media/manage/load-balancing-rule.png" alt-text="新增負載平衡規則。" border="true":::
