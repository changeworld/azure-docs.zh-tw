...
如需 Azure 容器實例的詳細資訊，請參閱[關於 Azure 容器實例](../container-instances/container-instances-overview.md)。
...
4. 針對服務主體整合，選取 [**自動（MSI）** ]，讓[Azure 資源的受控](../active-directory/managed-identities-azure-resources/overview.md)識別自動為 Jenkins 實例建立驗證身分識別。 選取 [手動] 以提供您自己的服務主體認證。
