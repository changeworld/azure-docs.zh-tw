...
* [FXT 叢集建立指南](<https://azure.github.io/Avere/#fxt_cluster>)是針對由實體硬體節點所組成的叢集而設計，但文件中的某些資訊也與 vFXT 叢集相關。 特別是，新的 vFXT 叢集系統管理員可以從閱讀以下幾節受益：
  ...
  * [添加後端存儲](<https://azure.github.io/Avere/legacy/create_cluster/4_8/html/config_core_filer.html#add-core-filer>)文檔如何添加核心檔程式。
...
在 GitHub：vfxt.py 的[雲群集管理](https://github.com/Azure/AvereSDK/blob/master/docs/README.md)中提供了使用 vfxt.py的完整指南，該指南是基於腳本的雲群集創建和管理實用程式。
