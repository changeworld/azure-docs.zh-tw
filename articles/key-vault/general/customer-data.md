...
- [Azure Key Vault 祕密作業](/rest/api/keyvault/secret-operations)

- [Azure Key Vault 憑證和原則](/rest/api/keyvault/certificates-and-policies)

- [Azure Key Vault 儲存體帳戶作業](/rest/api/keyvault/storage-account-key-operations)