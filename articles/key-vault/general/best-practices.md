...
控制保存庫存取時的建議如下：
1.  (Azure RBAC) ，鎖定訂用帳戶、資源群組和金鑰保存庫的存取權
2. 建立每個保存庫的存取原則
3. 使用最低許可權存取主體來授與存取權
...
* [備份憑證](/powershell/module/azurerm.keyvault/Backup-AzureKeyVaultCertificate?view=azurermps-6.13.0)
* [備份金鑰](/powershell/module/azurerm.keyvault/Backup-AzureKeyVaultKey?view=azurermps-6.13.0)
* [備份密碼](/powershell/module/azurerm.keyvault/Backup-AzureKeyVaultSecret?view=azurermps-6.13.0)

### <a name="azure-cli-backup-commands"></a>Azure CLI 備份命令

* [備份憑證](/cli/azure/keyvault/certificate?view=azure-cli-latest#az-keyvault-certificate-backup)
* [備份金鑰](/cli/azure/keyvault/key?view=azure-cli-latest#az-keyvault-key-backup)
* [備份密碼](/cli/azure/keyvault/secret?view=azure-cli-latest#az-keyvault-secret-backup)
