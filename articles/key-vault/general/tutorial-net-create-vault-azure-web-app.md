...
您現在可以使用 [az keyvault secret set](/cli/azure/keyvault/secret?view=azure-cli-latest#az-keyvault-secret-set) 命令將秘密放在金鑰保存庫中。 將祕密的名稱設定為 "MySecret"，並將其值設定為 "Success!"。
