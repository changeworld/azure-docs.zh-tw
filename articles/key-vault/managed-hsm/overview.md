...
- 產生 (或使用 [BYOK](hsm-protected-keys-byok.md) 匯入) 金鑰，並使用這些金鑰將 Azure 服務中的待用資料加密，例如 [Azure 儲存體](../../storage/common/encryption-customer-managed-keys.md)、[Azure SQL](../../azure-sql/database/transparent-data-encryption-byok-overview.md) 和 [Azure 資訊保護](/azure/information-protection/byok-price-restrictions)等服務。
