...
如需如何使用從 Key Vault SAS 權杖擷取來存取 Azure 儲存體服務的指南，請參閱[使用帳戶 SAS 存取 Blob 服務](../../storage/common/storage-account-sas-create-dotnet.md#use-an-account-sas-from-a-client)
