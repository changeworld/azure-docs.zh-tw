---
title: 具有 Azure SQL 資料庫和 SQL 伺服器的火花連接器
...
您可以使用 Azure Active Directory (AAD) 驗證以連線到 SQL Database。 使用 AAD 驗證集中管理資料庫使用者的身分識別，並作為 SQL Server 的替代驗證。
