...
本文說明如何使用[SQL Server Management Studio （SSMS）](https://msdn.microsoft.com/library/hh213248.aspx)中的[Always Encrypted Wizard](https://msdn.microsoft.com/library/mt459280.aspx) ，透過資料庫加密來保護 SQL database 中的機密資料。 它也會說明如何將您的加密金鑰儲存在 Windows 憑證存放區中。
...
1. 按一下 **[SQL 資料庫** > **Clinic** > ] [實務] [**顯示資料庫連接字串**]。
2. 複製 **ADO.NET**的連接字串。
...
1. 開啟 SSMS。 （如果未開啟，請按一下 **[連接** > **資料庫引擎**] 以開啟 [**連接到伺服器**] 視窗）。
...
您 > 可以前往 [實務] [**安全性** > ]**Always Encrypted [金鑰**] **，確認**在 SSMS 中建立金鑰。 您現在可以看到精靈為您產生的新金鑰。
...
* [Always Encrypted 的 Blog](https://blogs.msdn.com/b/sqlsecurity/archive/tags/always-encrypted/)