...
|服務層|基本，標準，Premium，一般用途，超大規模資料庫，業務關鍵|針對 vCore 模型中的服務層級，請參閱[單一資料庫和彈性集](sql-database-service-tiers-vcore.md#service-tiers)區與[受控實例](sql-database-managed-instance.md#managed-instance-service-tiers)。 如需 DTU 模型中的服務層級，請參閱[dtu 模型](sql-database-service-tiers-dtu.md#compare-the-dtu-based-service-tiers)。|
