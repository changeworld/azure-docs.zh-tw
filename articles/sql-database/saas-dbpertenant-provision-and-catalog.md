...
1. 在 PowerShell ISE 中，開啟 .。。\\學習模組\\會\\ProvisionAndCatalog_Demo-ProvisionAndCatalog_ ，並設定下列參數：
...
* **租用戶資料庫是使用 New-TenantDatabase 來佈建。** 請使用 F11 來逐步執行，並使用 [Azure Resource Manager 範本](../azure-resource-manager/resource-manager-template-walkthrough.md)來了解資料庫的佈建方式。
    ...
    Resource Manager 範本位於.. ..\Learning Modules\Common\ 資料夾中： *tenantdatabasecopytemplate.json. json*
