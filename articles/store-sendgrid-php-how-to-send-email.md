...
涵蓋的案例包括**建構電子郵件**、**傳送電子郵件**和**新增附件**。 有關 SendGrid 和發送電子郵件的詳細資訊，請參閱[後續步驟](#next-steps)部分。
...
SendGrid 通過使用*篩選器*提供了其他電子郵件功能。 這些設定可新增到電子郵件以啟用特定功能，例如啟用點擊追蹤、Google 分析、訂閱追蹤等。
