...
如需詳細資訊和後續步驟，請參閱[定義多階段的持續部署 (CD) 管線](/azure/devops/pipelines/release/define-multistage-release-process?view=azure-devops&viewFallbackFrom=vsts)。