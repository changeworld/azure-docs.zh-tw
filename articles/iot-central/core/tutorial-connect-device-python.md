...
ms.locfileid: "80891589"
---
# <a name="tutorial-create-and-connect-a-python-client-application-to-your-azure-iot-central-application-python"></a>教學課程：建立並將 Python 用戶端應用程式連線到您的 Azure IoT Central 應用程式 (Python)
