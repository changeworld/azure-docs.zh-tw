...
開始之前，請先完成[建立 Azure IoT Central 應用程式](./quick-deploy-iot-central.md)和[將模擬裝置新增至 IoT Central 應用程式](./quick-create-pnp-device.md)這兩個先前的快速入門，以建立要使用的 [MXChip IoT DevKit]  裝置範本。
