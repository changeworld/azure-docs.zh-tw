...
1. 幾秒鐘後，您可以看到新的裝置範本：
    ...
    ![MXChip IoT DevKit 裝置範本](./media/quick-create-pnp-device/devkit-template.png)
...
1. 選取 [客戶名稱]  和 [上次服務日期]  雲端屬性，以及 [風扇速度]  屬性。 然後選取 [新增區段]  ：
    ...
    ![建立新表單](media/quick-create-pnp-device/new-form.png)
...
1. 若要新增模擬的 DevKit 裝置，請選取 **+** 。 請使用建議的**裝置識別碼**，或輸入您自己的小寫**裝置識別碼**。 您也可以輸入新裝置的名稱。 確定 [模擬]  切換開關已切換為 [開啟]  ，然後選取 [建立]  。
...
1. [概觀]  檢視會顯示模擬遙測的繪圖：
    ...
    ![概觀檢視](./media/quick-create-pnp-device/simulated-telemetry.png)
