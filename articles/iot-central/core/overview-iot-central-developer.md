...
description: Azure IoT Central 是 IoT 應用程式平台，可簡化 IoT 解決方案的建立流程。 本文概述如何開發裝置，以連線到您的 IoT Central 應用程式。
author: dominicbetts
ms.author: dobett
ms.date: 05/05/2020
ms.topic: overview
...
- _屬性_是裝置向 IoT Central 報告的狀態值。 例如，裝置目前的韌體版本。 您也可擁有 IoT Central 可在裝置上更新的可寫入屬性。
