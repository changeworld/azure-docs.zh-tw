...
*如需詳細資料，請參閱 [Azure 安全性效能評定：稽核與威脅偵測](../security/benchmarks/security-controls-v2-logging-threat-detection.md)。*
...
- [Azure 安全性效能評定 - 態勢和弱點管理](../security/benchmarks/security-controls-v2-posture-vulnerability-management.md)
...
- [Azure 安全性效能評定 - 記錄和威脅偵測](../security/benchmarks/security-controls-v2-logging-threat-detection.md)
