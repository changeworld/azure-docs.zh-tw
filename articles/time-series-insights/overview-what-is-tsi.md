...
| 近乎即時的資料探索 | 藉由 [Azure 時間序列深入解析 Gen2 總管](./time-series-insights-update-explorer.md)的使用者體驗，您可以為透過擷取管線串流的所有資料提供視覺效果。 連線事件來源後，您可以檢視、探索及查詢事件資料。 如此一來，您可以驗證裝置是否如預期般發出資料。 您也可以監視 IoT 資產的健康情況、生產力和整體效率。 | 
...
> [!div class="nextstepaction"]
> [Azure 時間序列深入解析 Gen2 使用案例](./time-series-insights-update-use-cases.md)