...
ms.locfileid: "86495307"
---
# <a name="connect-azure-time-series-insights-gen-2-to-power-bi"></a>將 Azure 時間序列深入解析 Gen 2 連線到 Power BI  
...
* 使用強大的進階編輯器，修改 Power BI 內的 Azure 時間序列深入解析資料。

## <a name="native-connector"></a>原生連接器

連接您的資料所需的時間不到一分鐘。 藉由將您的視圖從 Azure 時間序列深入解析 Explorer 快速匯出至 Power BI，貴組織中的任何人都可以直覺地存取並以視覺化方式轉換資料。
...
如需逐步解說的詳細資訊，請參閱[如何將 Azure 時間序列深入解析連接到 Power BI](./how-to-connect-power-bi.md) 。

## <a name="flexible-workflow"></a>彈性工作流程
 
在工作流程中的任何位置使用連接器：

* 如果您在 Azure 時間序列深入解析 Explorer 中，可以快速地將您的視圖匯出至 Power BI。 
* 如果您已經在 Power BI，請使用 Azure 時間序列深入解析來查詢資料，以擴充現有的視覺效果案例。
