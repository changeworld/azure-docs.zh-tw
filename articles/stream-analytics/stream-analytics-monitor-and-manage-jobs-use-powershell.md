---
title: 使用 PowerShell 監視及管理 Azure 串流分析作業
...
> [!NOTE]
> 以程式控制方式建立的串流分析工作預設不會啟用監視功能。  您可以通過導航到作業的「監視器」頁並按下「啟用」按鈕在 Azure 門戶中手動啟用監視,也可以按照[Azure 流分析 - 以程式設計方式監視流分析作業的步驟](stream-analytics-monitor-jobs.md)以程式設計方式執行此操作。
> 
> 
...
### <a name="get-azurestreamanalyticsjob--get-azstreamanalyticsjob"></a>取得 Azure 串流分析作業 |取得阿茲特線上分析工作
...
### <a name="get-azurestreamanalyticsinput--get-azstreamanalyticsinput"></a>取得 Azure 串流分析輸入 |獲取-阿茲特流分析輸入
...
### <a name="get-azurestreamanalyticsoutput--get-azstreamanalyticsoutput"></a>取得 Azure 串流分析輸出 |取得阿茲特流分析輸出
...
### <a name="get-azurestreamanalyticsquota--get-azstreamanalyticsquota"></a>取得 Azure 串流分析配額 |取得阿茲特線上分析配額
...
### <a name="get-azurestreamanalyticstransformation--get-azstreamanalyticstransformation"></a>取得 Azure 串流分析轉換 |獲取阿茲特流分析轉型
...
### <a name="new-azurestreamanalyticsjob--new-azstreamanalyticsjob"></a>新 Azure 流分析作業 |新-阿茲特在線分析工作
...
如果指定 -Force 參數並指定現有作業名稱,則作業定義將在未確認的情況下替換。
...
### <a name="new-azurestreamanalyticsoutput--new-azstreamanalyticsoutput"></a>新 Azure 串流分析輸出 |新-阿茲特流分析輸出
...
### <a name="remove-azurestreamanalyticsinput--remove-azstreamanalyticsinput"></a>刪除 Azure 串流分析輸入 |刪除-阿茲特流分析輸入
以非同步方式從 Microsoft Azure 中的 Stream Analytics 作業刪除特定的輸入。  
如果指定 -Force 參數,則輸入將被刪除,恕不確認。
...
### <a name="remove-azurestreamanalyticsjob--remove-azstreamanalyticsjob"></a>刪除 Azure 串流分析作業 |刪除-阿茲特線上分析作業
...
### <a name="remove-azurestreamanalyticsoutput--remove-azstreamanalyticsoutput"></a>刪除 Azure 串流分析輸出 |刪除-阿茲特流分析輸出
...
### <a name="start-azurestreamanalyticsjob--start-azstreamanalyticsjob"></a>啟動-AzureStream分析作業 |啟動-阿茲特在線分析工作
...
### <a name="test-azurestreamanalyticsoutput--test-azstreamanalyticsoutput"></a>測試-Azure 串流分析輸出 |測試-阿茲特流分析輸出
