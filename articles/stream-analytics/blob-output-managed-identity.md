...
使用 Azure Resource Manager 可讓您將串流分析作業的部署作業完全自動化。 您可以使用 Azure PowerShell 或 [Azure CLI](https://docs.microsoft.com/cli/azure/?view=azure-cli-latest)來部署 Resource Manager 範本。 下列範例會使用 Azure CLI。
