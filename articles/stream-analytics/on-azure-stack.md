...
建立 Azure Stack Hub 訂用帳戶。 如需詳細資訊，請參閱[建立 Azure Stack Hub 訂](https://docs.microsoft.com/azure-stack/user/azure-stack-subscribe-services/)用帳戶的教學課程。

如果您想要在自己的伺服器上評估 Azure Stack Hub，您可以使用 Azure Stack 開發套件 (ASDK) 。  如需 ASDK 的詳細資訊，請參閱 [ASDK 總覽](https://docs.microsoft.com/azure-stack/asdk/)。
...
* [在 Windows 上安裝 Azure IoT Edge 執行階段](../iot-edge/how-to-install-iot-edge-windows.md)
...
2. 提供下列值以建立您的儲存體帳戶：
   ...
   | 資源群組 | 建議您在 [IoT Edge 快速入門](https://docs.microsoft.com/azure/iot-edge/quickstart) 和教學課程期間建立的所有測試資源，使用相同的資源群組。 例如 **IoTEdgeResources**。 |
...
- [Azure IoT Edge 串流分析](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-edge)
- [開發串流分析 Edge 作業](https://docs.microsoft.com/stream-analytics-query/stream-analytics-query-language-reference)
