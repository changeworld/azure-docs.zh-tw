...
4. 將 Webhook 的 [名稱]  設定成 **Optional**。 [Enabled]  屬性必須為 [Yes]  。 [Expires]  值不需要變更。 如需 Webhook 屬性的詳細資訊，請參閱 [Webhook 屬性](../../automation/automation-webhooks.md#webhook-properties)。
