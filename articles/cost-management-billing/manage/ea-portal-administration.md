...
如需使用者角色的詳細資訊，請參閱[企業使用者角色](./ea-portal-get-started.md#enterprise-user-roles)。
...
如需有關 Azure 帳戶的詳細資訊，請參閱[新增帳戶](./ea-portal-get-started.md#add-an-account)。
