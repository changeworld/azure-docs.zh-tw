---
title: 使用 Blob 儲存體作為 Azure Stack Hub 上的檢查點存放區
description: 本文說明如何在 Azure Stack Hub 的事件中樞中，使用 Blob 儲存體作為檢查點存放區。
ms.topic: how-to
ms.date: 12/09/2020
...
ms.locfileid: "97007818"
---
# <a name="use-blob-storage-as-checkpoint-store---event-hubs-on-azure-stack-hub"></a>使用 Blob 儲存體作為檢查點存放區-Azure Stack Hub 上的事件中樞
