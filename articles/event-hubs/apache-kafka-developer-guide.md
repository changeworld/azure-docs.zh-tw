...
| [Go](https://github.com/Azure/azure-event-hubs-for-kafka/tree/master/quickstart/go) | <p>此快速入門將演示如何使用 Go 編寫的範例生成器和使用者創建和連接到事件中心 Kafka 終結點。</p><p>此示例基於[康因的阿帕奇卡夫卡戈朗用戶端](https://github.com/confluentinc/confluent-kafka-go),修改用於卡夫卡的事件中心。</p>| 
