...
![顯示在哪裡選取與 AD FS 同盟的螢幕擷取畫面。](media/tutorial-federation/fed1.png)
...
![此螢幕擷取畫面顯示在哪裡選取您所建立的憑證檔案。](media/tutorial-federation/fed2.png)
