 ...
 * 設定 Azure AD Connect 將 userCertificate 屬性排除，而不要匯出至 Azure AD。 一般而言，我們不建議這個選項，因為 Microsoft Online Services 可能使用此屬性來啟用特定案例。 尤其是：
    * Exchange Online 和 Outlook 用戶端會使用 User 物件的 userCertificate 屬性，將郵件簽署和加密。 若要深入了解此功能，請參閱[為郵件簽章和加密的 S/MIME](/microsoft-365/security/office-365-security/s-mime-for-message-signing-and-encryption?view=o365-worldwide) 一文。
