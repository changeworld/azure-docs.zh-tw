...
在這種情況下 **，smtp：abbie.spencerfabrikam.com\@** 已被刪除，因為該域尚未驗證。 但交易所也添加了**SIP：abbie.spencerfabrikamonline.com。\@ ** Fabrikam 不曾使用 Lync/Skype 內部部署，但是 Azure AD 和 Exchange Online 為它進行準備。
