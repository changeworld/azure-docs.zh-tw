...
> [!NOTE]
> 變更您的驗證方法需要規劃及測試，而且可能造成停機。 [分段推出](how-to-connect-staged-rollout.md)提供了一種替代方式，可以使用傳遞驗證來測試同盟，並逐漸從同盟遷移至雲端驗證。
> 
...
3. 在 [其他工作] **> [管理同盟**] 底下，滾動到**Active Directory 同盟服務（AD FS）**。<br />
