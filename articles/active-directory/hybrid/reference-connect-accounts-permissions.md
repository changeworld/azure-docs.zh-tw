...
| 功能 | 權限 |
| --- | --- |
| ms-DS-ConsistencyGuid 功能 |ConsistencyGuid 屬性的寫入權限記載于[設計概念-使用 ms-ds-ConsistencyGuid 作為 sourceAnchor](plan-connect-design-concepts.md#using-ms-ds-consistencyguid-as-sourceanchor)。 | 
