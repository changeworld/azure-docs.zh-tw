---
title: Azure AD 將運行狀況與 AD FS 風險 IP 報告連接 |微軟文檔
description: 描述 Azure AD 連接運行狀況 AD FS 風險 IP 報告。
...
---
# <a name="risky-ip-report-public-preview"></a>風險 IP 報告（公共預覽版）
...
## <a name="what-is-in-the-report"></a>報告中有什麼？
失敗的登錄活動用戶端 IP 位址通過 Web 應用程式代理伺服器聚合。 「具風險的 IP 報告」中的每個項目會顯示有關已超過指定閾值之失敗 AD FS 登入活動的彙總資訊。 此報告可提供下列資訊：![Azure AD Connect Health 入口網站](./media/how-to-connect-health-adfs/report4a.png)
...
## <a name="load-balancer-ip-addresses-in-the-list"></a>清單中的負載等化器 IP 位址
...
## <a name="download-risky-ip-report"></a>下載有風險的 IP 報告 
...
## <a name="configure-notification-settings"></a>配置通知設置
...
## <a name="configure-threshold-settings"></a>配置閾值設置
