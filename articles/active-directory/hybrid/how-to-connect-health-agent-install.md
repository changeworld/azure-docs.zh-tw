...
| 已篩選或停用輸出流量的 TLS 檢查 | 如果網路層有輸出流量的 TLS 檢查或終止，則代理程式註冊步驟或資料上傳作業可能會失敗。 深入瞭解 [如何設定 TLS 檢查](https://technet.microsoft.com/library/ee796230.aspx) |
