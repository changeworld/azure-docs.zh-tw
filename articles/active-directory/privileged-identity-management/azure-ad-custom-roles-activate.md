---
title: 啟動 Azure AD 自訂角色 - 特權標識管理 （PIM）
...
如果需要啟動 Azure AD 自訂角色，請在"特權標識管理"中選擇"我的角色導航"選項來請求啟動。
...
> [!Note] 
>  在分配角色之前，必須創建/配置角色。 有關配置 AAD 自訂角色的詳細資訊，請參閱 [此處] （https://docs.microsoft.com/azure/active-directory/privileged-identity-management/azure-ad-custom-roles-configure)
