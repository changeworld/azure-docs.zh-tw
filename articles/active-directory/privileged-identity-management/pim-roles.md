...
我們支援 Azure AD 角色和系統管理員入口網站體驗中的所有 Office365 角色，例如 Exchange 系統管理員和 SharePoint 系統管理員，但我們不支援 Exchange RBAC 或 SharePoint RBAC 內的特定角色。 如需有關這些 Office 365 服務的詳細資訊，請參閱 [Office 365 管理員角色](/office365/admin/add-users/about-admin-roles)。
