---
title: 更新或刪除 Azure AD 自訂角色 - 特權標識管理 （PIM）
...
> [!NOTE]
> 在預覽期間，Azure AD 自訂角色不會與內建目錄角色整合。 在功能正式推出後，角色管理就會在內建角色體驗中進行。 如果您看到以下橫幅，這些角色應在[內置角色體驗中](pim-how-to-add-role-to-user.md)管理，本文不適用：
>
