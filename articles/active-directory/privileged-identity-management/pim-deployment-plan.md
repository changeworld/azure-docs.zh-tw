...
1. 列出組織中具有特殊權限角色的人員。 您可以使用 Privileged Identity Management[探索和深入解析 (預覽) ](pim-security-wizard.md)來取得如下所示的頁面。

    ![探索和深入解析 (預覽) 頁面，以減少透過特殊許可權角色的風險](./media/pim-deployment-plan/new-preview-page.png)
