...
> [!WARNING]
> 請務必至少有一個全域管理員，以及一個以上具有工作或學校帳戶（而非 Microsoft 帳戶）的特殊權限角色管理員。 如果只有一個特殊權限角色管理員，組織就無法管理該帳戶刪除的 Privileged Identity Management。
