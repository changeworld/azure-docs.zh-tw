---
title: Windows 身份驗證和 Azure MFA 伺服器 - Azure 活動目錄
...
## <a name="to-secure-an-application-with-windows-authentication-use-the-following-procedure"></a>要使用 Windows 身份驗證保護應用程式，請使用以下步驟

1. 在 Azure Multi-Factor Authentication Server 中，按一下 [Windows 驗證] 圖示。
   ![MFA 伺服器中的 Windows 身份驗證](./media/howto-mfaserver-windows/windowsauth.png)
...
10. 如果要使用子網標記法指定 IP 範圍，請選擇**子網**。 輸入子網路的起始 IP，並從下拉式清單中挑選適當的網路遮罩。
11. 按一下 [確定]****。
