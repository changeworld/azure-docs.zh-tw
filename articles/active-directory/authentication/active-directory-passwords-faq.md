...
* [有關密碼重設註冊的問題](#password-reset-registration)
* [有關密碼重設的問題](#password-reset)
* [有關密碼更改的問題](#password-change)
...
* **問：註冊入口網站如何判斷要對我的使用者顯示哪些選項？**
  ...
  > **答：** 密碼重設註冊入口網站只會顯示您已為使用者啟用的選項。 這些選項位於目錄的 **"配置"** 選項卡的 **"使用者密碼重設策略"** 部分下。例如，如果您不啟用安全問題，則使用者無法註冊該選項。
  >
  >
* **問：使用者何時註冊？**
...
* **問：您是否禁止使用者在短時間內多次嘗試密碼重設？**
  ...
  >
  >
* **問：我應該等待多長時間才能收到來自密碼重設的電子郵件、短信或電話？**
...
* **問：電子郵件和 SMS 單次密碼的有效期限是多久？**
  ...
  > **答：** 密碼重設的工作階段存留期為 15 分鐘。 從密碼重設作業開頭算起，使用者有 15 分鐘可以重設其密碼。 電子郵件和 SMS 一次性密碼在密碼重設會話期間有效期為 5 分鐘。
  >
  >
* **問：是否可以防止使用者重設其密碼？**
...
* **問：密碼回寫如何在幕後運作？**
  ...
  >
  >
* **問：密碼寫回需要多長時間才能工作？是否有同步延遲，就像密碼雜湊同步一樣？**
