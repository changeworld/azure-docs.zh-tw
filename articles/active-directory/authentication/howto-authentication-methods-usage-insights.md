...
使用量 & 見解可讓您瞭解 Azure Multi-Factor Authentication 和自助式密碼重設等功能的驗證方法如何在您的組織中工作。 這項報告功能可讓您的組織瞭解哪些方法已註冊，以及其使用方式。
...
不需要額外的授權即可存取使用量和深入解析。 您可以在 [Azure Active Directory 定價網站](https://azure.microsoft.com/pricing/details/active-directory/)上找到 Azure Multi-Factor Authentication 和自助式密碼重設 (SSPR) 授權資訊。
...
使用量和深入解析資料不會取代 Azure Multi-Factor Authentication 活動報告或 Azure AD 登入報告中所包含的資訊。
