...
6. 按一下 [**新增您自己的應用**程式] 區段中的 [不在資源**庫**內]。
...
#### <a name="configure-the-application-for-password-single-sign-on"></a><a name="configure-the-application-for-password-single-sign-on-1"></a>設定應用程式的密碼單一登入
...
[將新的使用者新增至 Azure Active Directory](./../fundamentals/add-users-azure-active-directory.md)
