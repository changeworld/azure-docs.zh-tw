...
* 從 Azure AD 目錄以外的屬性存放區宣告，除非該資料已同步處理到 Azure AD。 如需詳細資訊，請參閱 [Azure AD 同步處理 API 總覽](https://docs.microsoft.com/graph/api/resources/synchronization-overview?view=graph-rest-beta)。
