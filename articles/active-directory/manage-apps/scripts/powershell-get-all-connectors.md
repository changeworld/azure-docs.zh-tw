...
| [Get-AzureADApplicationProxyConnectorGroupMembers](/powershell/module/azuread/get-azureadapplicationproxyconnectorgroupmembers?view=azureadps-2.0) | 取得與每個連接器群組相關聯的所有應用程式 Proxy 連接器。|
