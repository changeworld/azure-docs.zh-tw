---
title: PowerShell 範例 - 列出使用萬用字元的應用程式 Proxy 應用程式
...
ms.locfileid: "94652853"
---
# <a name="get-all-application-proxy-apps-using-wildcard-publishing"></a>取得使用萬用字元發佈的所有應用程式 Proxy 應用程式

此 PowerShell 指令碼範例列出所有使用萬用字元發佈的 Azure Active Directory (Azure AD) 應用程式 Proxy 應用程式。
