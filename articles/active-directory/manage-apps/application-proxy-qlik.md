...
**步驟 #5**：「內部 URL」現在應該是 QlikSense URL 搭配應用程式所使用的驗證連接埠。 HTTPS 的預設值為**4244，2018**年 4 月之前 QlikSense 版本的 HTTP 為**4248。** 2018 年 4 月之後 QlikSense 版本的預設值為 HTTPS 為**443，HTTP**為**80。**  例如：**https&#58;//demo.qlik.com:4244**</br></br>
**步驟#10：** 不要設置 SSO，並且禁用**單一登入**
...
有關使用應用程式代理髮布 Qlik 感知的更多資訊，請參閱以下 Qlik 社區文章： 
- [使用具有 Qlik 感知的 Kerberos 限制委派的集成 Windows 身份驗證的 Azure AD](https://community.qlik.com/docs/DOC-20183)
- [Qlik 感知與 Azure AD 應用程式代理的集成](https://community.qlik.com/t5/Technology-Partners-Ecosystem/Azure-AD-Application-Proxy/ta-p/1528396)
