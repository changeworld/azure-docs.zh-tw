...
description: 瞭解如何建立基本 AD 和 Azure AD 環境。
author: billmath
manager: daveba
...
![顯示基本 Azure AD 環境的圖表。](media/tutorial-single-forest/diagram-2.png)
...
4. 選取 [建立]。</br>
![顯示 Azure 入口網站中 Azure Active Directory 頁面的螢幕擷取畫面。](media/tutorial-single-forest/create-1.png)</br>
...
1.  在 [管理] 底下選取 [使用者]。</br>
![此螢幕擷取畫面顯示已選取 [使用者] 的 [概觀] 功能表。](media/tutorial-single-forest/administrator-1.png)</br>
2.  選取 [所有使用者 ]，然後選取 [+ 新增使用者]。
3.  提供此使用者的名稱與使用者名稱。 這將成為您租用戶的全域系統管理員。 建議您將 [目錄角色]  變更為 [全域系統管理員]  。 您也可以顯示暫時密碼。 完成之後，請選取 [建立]  。</br>
![建立](media/tutorial-single-forest/administrator-2.png)</br>
...
以下是選用區段，提供建立額外伺服器和/或樹系的步驟。  這可用於一些更高階的教學課程，例如 [Azure AD Connect 到雲端同步的試驗](tutorial-pilot-aadc-aadccp.md)。
...
現在您有一個可用於現有教學課程的環境，並測試雲端同步所提供的其他功能。
