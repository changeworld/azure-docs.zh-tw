...
Azure AD 會使用調適性機器學習服務演算法和啟發學習法，來偵測與您使用者帳戶相關的可疑動作。 每個偵測到的可疑動作都會儲存在稱為 **風險偵測**的記錄中。
...
* [Azure Active Directory 風險偵測](../identity-protection/overview-identity-protection.md)