---
title: 使用多重要素驗證遷移條件式存取原則-Azure Active Directory
...
![需要 Salesforce 應用程式之 MFA 的傳統原則詳細資料](./media/policy-migration/33.png)
...
1. 在傳統原則清單中，選取您要遷移的原則。 記錄設定，讓您可以使用新的條件式存取原則重新建立。
