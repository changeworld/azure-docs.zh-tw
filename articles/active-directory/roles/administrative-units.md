...
例如，委派給地區支援專家的[服務台管理員](permissions-reference.md#helpdesk-administrator)角色，受限於僅只管理其所支援區域中的使用者。
...
- [在管理單位中建立、移除、填入和新增角色](admin-units-manage.md)：完成操作程序
...
- [在 AU 中管理使用者](admin-units-add-manage-users.md)
- [在 AU 中管理群組](admin-units-add-manage-groups.md)
- [將限域角色指派給 AU](admin-units-assign-roles.md)
