...
>[!NOTE]
> 如需可用來授與儲存體權限的各種角色詳細資訊，請檢閱[使用 Azure Active Directory 授權存取 Blob 和佇列](../../storage/common/storage-auth-aad.md#assign-azure-roles-for-access-rights)
