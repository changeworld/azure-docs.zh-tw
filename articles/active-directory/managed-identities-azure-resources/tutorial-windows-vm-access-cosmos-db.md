...
>[!NOTE]
> 請記住，如果無法執行作業，您可能沒有正確的權限。 如果想要金鑰的寫入權，您必須使用 RBAC 角色 (例如 DocumentDB 帳戶參與者) 或建立自訂角色。 如需詳細資訊，請檢閱 [Azure Cosmos DB 中的角色型存取控制](../../cosmos-db/role-based-access-control.md)
