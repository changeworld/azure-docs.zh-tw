...
在某些情況下，如果設定 Azure AD Multi-Factor Authentication，企業狀態漫遊可能無法同步資料。 如需這些徵兆的詳細資訊，請參閱支援檔 [>kb3193683](https://support.microsoft.com/kb/3193683)。 
