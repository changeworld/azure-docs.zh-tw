...
如需其他安裝和組態指示，請移至 [Strata 網站](https://strata.io/docs)。
...
若要開始使用 Maverics Identity Orchestrator 安裝，請參閱[安裝指示](https://strata.io/docs)。
...
1. [建立新金鑰保存庫](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal#create-a-vault)。
1. [將祕密新增至金鑰保存庫](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal#add-a-secret-to-key-vault)。
1. [向 Azure AD 註冊應用程式](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal#create-an-azure-active-directory-application)。
1. [授權應用程式使用祕密](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal#add-a-secret-to-key-vault)。

**使用 Azure CLI**

1. 開啟 [Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest)，接著輸入下列命令：
