...
2. 移至 [管理]  。
    ...
    ![醒目提示導覽面板中系統管理的螢幕擷取畫面。](./media/adaptivesuite-tutorial/ic805644.png "管理")
...
當您在存取面板中按一下 [Adaptive Insights] 圖格時，應該會自動登入您已設定 SSO 的 Adaptive Insights。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
