...
1. **[設定 Dropbox for Business SSO](#configure-dropbox-for-business-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 Dropbox for Business 測試使用者](#create-dropbox-for-business-test-user)** - 使 Dropbox for Business 中對應的 Britta Simon 連結到該使用者在 Azure AD 中的代表項目。
...
- [什麼是 Azure Active Directory 中的條件式存取？](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [如何使用進階可見性和控制項保護 Dropbox](https://docs.microsoft.com/cloud-app-security/protect-dropbox)