...
當您在 [存取面板] 中按一下 [Imagineer WebVision] 磚時，應該會自動登入您已設定 SSO 的 Imagineer WebVision。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
