...
當您按一下 [存取面板] 中的 [SAML SSO for Bamboo by resolution GmbH] 圖格時，應該會自動登入您已設定 SSO 的 SAML SSO for Bamboo by resolution GmbH。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
