---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 WhosOnLocation 整合 | Microsoft Docs
description: 了解如何設定 Azure Active Directory 與 WhosOnLocation 之間的單一登入。
...
在本教學課程中，您將了解如何整合 WhosOnLocation 與 Azure Active Directory (Azure AD)。 在整合 WhosOnLocation 與 Azure AD 時，您可以︰

* 在 Azure AD 中控制可存取 WhosOnLocation 的人員。
...
* 已啟用 WhosOnLocation 單一登入 (SSO) 的訂用帳戶。
...
若要設定 WhosOnLocation 與 Azure AD 整合，您需要從資源庫將 WhosOnLocation 新增到受控 SaaS App 清單。
...
## <a name="configure-and-test-azure-ad-sso-for-whosonlocation"></a>設定和測試 WhosOnLocation 的 Azure AD SSO

以名為 **B.Simon** 的測試使用者，設定及測試與 WhosOnLocation 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 WhosOnLocation 中相關使用者之間的連結關聯性。

若要設定及測試與 WhosOnLocation 搭配運作的 Azure AD SSO，請完成下列建置組塊：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 WhosOnLocation SSO](#configure-whosonlocation-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 WhosOnLocation 測試使用者](#create-whosonlocation-test-user)** - 使 WhosOnLocation 中對應的 B.Simon 連結到該使用者在 Azure AD 中的代表項目。
...
1. 在 [基本 SAML 組態] 區段上，輸入下列欄位的值：
    ...
    a. 在 [登入 URL] 文字方塊中，使用下列模式輸入 URL：`https://login.whosonlocation.com/saml/login/<CUSTOM_ID>`

    b. 在 [識別碼 (實體識別碼)] 文字方塊中，使用下列模式輸入 URL：`https://login.whosonlocation.com/saml/metadata/<CUSTOM_ID>`
...
1. 在 [設定 WhosOnLocation] 區段上，依據您的需求複製適當的 URL。
...
在本節中，您會將 WhosOnLocation 的存取權授與 B.Simon，讓其能夠使用 Azure 單一登入。

1. 在 Azure 入口網站中，選取 [企業應用程式]，然後選取 [所有應用程式]。
1. 在應用程式清單中，選取 [WhosOnLocation]。
...
## <a name="configure-whosonlocation-sso"></a>設定 WhosOnLocation SSO

1. 在不同的瀏覽器視窗中，以系統管理員身分登入您的 WhosOnLocation 公司網站。
