...
> [!TIP]
> 您也可以選擇啟用 SAP Cloud Platform Identity Authentication 的 SAML 型單一登入，請遵循 [Sap Cloud Platform Identity Authentication 單一登入教學](./sap-hana-cloud-platform-identity-authentication-tutorial.md)課程中提供的指示。 您可以獨立設定自動使用者布建的單一登入，雖然這兩個功能彼此補充
