...
2. 在頂端的功能表中，按一下 [系統設定]  。 
    ...
    ![此螢幕擷取畫面顯示從您的 Questetra BPM Suite 公司網站選取的 [系統設定]。][10]

3. 若要開啟 [SingleSignOnSAML]  頁面，按一下 [SSO (SAML)]  。 
   
    ![此螢幕擷取畫面顯示選取的 SSO (SAML)。][11]
...
當您在存取面板中按一下 Questetra BPM Suite 圖格時，應該會自動登入您設定 SSO 的 Questetra BPM Suite。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
