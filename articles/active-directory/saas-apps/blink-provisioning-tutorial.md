...
1. 記錄 support@joinblink.com 的[支援案例](https://help.joinblink.com/hc/requests/new)或電子郵件**閃爍支援**以要求 SCIM token。 。
...
5. 在 [**管理員認證**] 區段下，于 [**租使用者 URL**] 中輸入 `https://api.joinblink.com/scim`。 輸入稍早在**秘密權杖**中所取得的**SCIM Authentication Token**值。 按一下 [**測試連接**]，以確保 Azure AD 可以連接至閃爍。 如果連線失敗，請確定您的閃爍帳戶具有系統管理員許可權，然後再試一次。
