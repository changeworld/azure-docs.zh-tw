...
> [!TIP]
> 您也可以選擇啟用 Soloinsight-CloudGate SSO 的 SAML 型單一登入，請遵循 [>soloinsight-cloudgate-CLOUDGATE SSO 單一登入教學](./soloinsight-cloudgate-sso-tutorial.md)課程中提供的指示。 您可以獨立設定自動使用者布建的單一登入，雖然這兩個功能彼此補充
