...
1. 移至 [使用者詳細資料] \> [新增使用者]。
    ...
    ![螢幕擷取畫面：顯示 Zoho Mail 網站，其中已選取 [使用者詳細資料] 和 [新增使用者]。](./media/zoho-mail-tutorial/ic789611.png "新增使用者")

1. 在 [新增使用者]  對話方塊上，執行下列步驟：
   
    ![此螢幕擷取畫面顯示 [新增使用者] 對話方塊，您可以在其中輸入所述的值。](./media/zoho-mail-tutorial/ic789612.png "新增使用者")
...
當您在存取面板中按一下 [Zoho] 圖格時，應該會自動登入您已設定 SSO 的 Zoho。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
