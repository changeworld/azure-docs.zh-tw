...
3. 在 [Web 入口網站]  索引標籤的 [使用者驗證]  區段中，按一下 [編輯]  ，以開啟 [編輯使用者驗證]  對話頁面。
    ...
    ![Web 入口網站索引標籤](./media/uservoice-tutorial/ic777520.png "入口網站")
...
當您在存取面板中按一下 [UserVoice] 圖格時，應該會自動登入您設定 SSO 的 UserVoice。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
