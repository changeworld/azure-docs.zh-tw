...
- 應該在 Windows 64 位元版本上安裝及設定 JIRA Core 和 JIRA Software 6.4 到 8.8.0 或 JIRA Service Desk 3.0 到 4.8.0
- JIRA 伺服器已啟用 HTTPS
...
* JIRA 核心和軟體：6.4 至 8.8.0
* JIRA Service Desk 3.0.0 至 4.8.0
