...
5. 在 [**管理員認證**] 區段下，輸入 [ `https://openmobile.ipass.com/moservices/scim/v1` **租使用者 URL**]。 在 [**秘密權杖**] 中，輸入先前抓取的持有人權杖。 按一下 [**測試連接**] 以確保 Azure AD 可以連接到 iPass SmartConnect。 如果連線失敗，請確定您的 iPass SmartConnect 帳戶具有系統管理員許可權，然後再試一次。
