...
## <a name="configure-and-test-azure-ad-single-sign-on-for-salesforce-sandbox"></a>設定及測試 Salesforce Sandbox 的 Azure AD 單一登入
...
若要設定及測試與 Salesforce Sandbox 搭配運作的 Azure AD SSO，請完成下列建置組塊：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    * **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    * **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 Salesforce Sandbox SSO](#configure-salesforce-sandbox-sso)** - 在應用程式端設定單一登入設定。
    * **[建立 Salesforce Sandbox 測試使用者](#create-salesforce-sandbox-test-user)** - 使 Salesforce Sandbox 中對應的 B.Simon 連結到該使用者在 Azure AD 中的代表項目。
