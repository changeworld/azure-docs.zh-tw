...
description: 了解如何設定 Azure Active Directory 與 Lenses.io 之間的單一登入。
...
* Lenses.io 支援由 **SP** 起始的 SSO

* 設定 Lenses.io 後，您可以強制執行工作階段控制項，以即時防止組織的敏感資料遭到外洩和滲透。 工作階段控制項會從條件式存取延伸。 [了解如何使用 Microsoft Cloud App Security 來強制執行工作階段控制項](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)。

## <a name="adding-lensesio-from-the-gallery"></a>從資源庫新增 Lenses.io

若要設定將 Lenses.io 整合到 Azure AD 中，您需要從資源庫將 Lenses.io 新增到受控 SaaS app 清單。
...
1. 在 [Azure 入口網站](https://portal.azure.com/)的 [Lenses.io] 應用程式整合頁面上，尋找 [管理] 區段並選取 [單一登入]。
