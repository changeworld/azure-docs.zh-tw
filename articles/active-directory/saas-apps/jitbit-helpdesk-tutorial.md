...
1. 在頂端的工具列中，按一下 [系統管理]  。
    ...
    ![管理](./media/jitbit-helpdesk-tutorial/ic777681.png "系統管理")
...
當您在存取面板中按一下 Jitbit Helpdesk 圖格時，應該會自動登入您已設定 SSO 的 Jitbit Helpdesk。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
