...
在設定並啟用佈建服務之前，您必須決定 Azure AD 中的哪些使用者或群組需要 Salesforce 沙箱應用程式的存取權。 完成決定後，可以遵循[將使用者或群組指派給企業應用程式](../manage-apps/assign-user-or-group-access-portal.md)中的指示，將這些使用者指派給 Salesforce 沙箱應用程式
...
* [設定單一登入](./salesforce-sandbox-tutorial.md)