...
5. 在 [**管理員認證**] 區段下`https://mingle-t20b-scim.mingle.awsdev.infor.com/INFORSTS_TST/v2/scim` ，輸入 [**租使用者 URL**]。 輸入稍早在**秘密權杖**中所取得的持有人權杖值。 按一下 [**測試連接**] 以確保 Azure AD 可以連接到 Infor CloudSuite。 如果連線失敗，請確定您的 Infor CloudSuite 帳戶具有系統管理員許可權，然後再試一次。
