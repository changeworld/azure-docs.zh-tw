---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 Foodee 整合 | Microsoft Docs
...
ms.locfileid: "72373193"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-foodee"></a>教學課程：Azure Active Directory 單一登入 (SSO) 與 Foodee 整合
...
* Foodee 支援由 **SP 和 IDP** 起始的 SSO
* Foodee 支援 **Just In Time** 使用者佈建
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-foodee"></a>設定及測試 Foodee 的 Azure AD 單一登入
...
1. **[設定 Foodee SSO](#configure-foodee-sso)** - 在應用程式端設定單一登入設定。
...
### <a name="configure-foodee-sso"></a>設定 Foodee SSO

1. 若要自動執行 Foodee 內的設定，您必須按一下 [安裝擴充功能]  來安裝「我的應用程式安全登入瀏覽器擴充功能」  。

    ![我的應用程式擴充功能](common/install-myappssecure-extension.png)

2. 將擴充功能新增至瀏覽器之後，按一下 [設定 Foodee]  便會將您導向到 Foodee 應用程式。 請從該處提供用以登入 Foodee 的管理員認證。 瀏覽器擴充功能會自動為您設定應用程式，並自動執行步驟 3 到 4。

    ![設定組態](common/setup-sso.png)

3. 如果您想要手動設定 Foodee，請開啟新的網頁瀏覽器視窗，並以系統管理員身分登入 Foodee 公司網站，然後執行下列步驟：

4. 按一下頁面右上角的 [設定檔標誌]  ，然後瀏覽至 [單一登入]  並執行下列步驟：
...
當您在存取面板中按一下 [Foodee] 圖格時，應該會自動登入您已設定 SSO 的 Foodee。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
...
- [嘗試搭配 Azure AD 使用 Foodee](https://aad.portal.azure.com/)
