...
2. 在頂端的功能表中，按一下 [系統管理]  。
    ...
    ![此螢幕擷取畫面顯示 [M S S O 測試] 頁面頂端的功能表，其中已選取 [管理] 動作。](./media/onit-tutorial/IC791174.png "系統管理")
...
2. 按一下 [新增使用者]  。
    ...
    ![管理](./media/onit-tutorial/IC791180.png "系統管理")
...
當您在存取面板中按一下 Onit 圖格時，應該會自動登入您已設定 SSO 的 Onit。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
