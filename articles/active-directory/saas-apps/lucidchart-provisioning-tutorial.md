...
> * Lucidchart (的[單一登入](https://docs.microsoft.com/azure/active-directory/saas-apps/lucidchart-tutorial)建議) 
...
從 Azure AD 應用程式庫新增 Lucidchart，以開始管理布建至 Lucidchart。 如果您先前已設定 SSO 的 Lucidchart，您可以使用相同的應用程式。 不過，建議您在一開始測試整合時，建立個別的應用程式。 [在此](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app)深入了解從資源庫新增應用程式。 
...
* 06/15/2020-已啟用使用者的虛刪除功能 (支援[active](https://tools.ietf.org/html/rfc7643) attribute) 。
