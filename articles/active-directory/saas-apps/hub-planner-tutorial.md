---
title: 教學課程：Azure Active Directory 單一登入 (SSO) 與 Hub Planner 整合 | Microsoft Docs
description: 了解如何設定 Azure Active Directory 與 Hub Planner 之間的單一登入。
...
在本教學課程中，您將了解如何整合 Hub Planner 與 Azure Active Directory (Azure AD)。 在整合 Hub Planner 與 Azure AD 時，您可以：

* 在 Azure AD 中控制可存取 Hub Planner 的人員。
* 讓使用者使用其 Azure AD 帳戶自動登入 Hub Planner。
...
* 已啟用 Hub Planner 單一登入 (SSO) 的訂用帳戶。
...
* 設定 Hub Planner 後，您可以強制執行工作階段控制項，以即時防止組織的敏感資料遭到外洩和滲透。 工作階段控制項會從條件式存取延伸。 [了解如何使用 Microsoft Cloud App Security 來強制執行工作階段控制項](/cloud-app-security/proxy-deployment-any-app)。
...
以名為 **B.Simon** 的測試使用者，設定及測試與 Hub Planner 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 Hub Planner 中相關使用者之間的連結關聯性。

若要設定及測試與 Hub Planner 搭配運作的 Azure AD SSO，請完成下列建置組塊：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 Hub Planner SSO](#configure-hub-planner-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 Hub Planner 測試使用者](#create-hub-planner-test-user)** - 使 Hub Planner 中對應的 B.Simon 連結到該使用者在 Azure AD 中的代表項目。
...
當您在存取面板中按一下 [Hub Planner] 圖格時，應該會自動登入您設定 SSO 的 Hub Planner。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
...
- [利用 Azure AD 試用 Hub Planner](https://aad.portal.azure.com/)

- [什麼是 Microsoft Cloud App Security 中的工作階段控制項？](/cloud-app-security/proxy-intro-aad)

- [如何使用進階可見性和控制項保護 Hub Planner](/cloud-app-security/proxy-intro-aad)