...
如要設定將 Cequence Application Security Platform 整合到 Azure AD 中，您需要從資源庫將 Cequence Application Security Platform 新增到受控 SaaS 應用程式清單。
...
2. 直接移至 Cequence Application Security Platform 登入 URL，然後從該處起始登入流程。
