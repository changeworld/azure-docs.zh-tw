...
| :--- | :--- | :--- |
| ![logo-Atlassian Cloud](./media/tutorial-list/active-directory-saas-atlassian-cloud-tutorial.png)| [Atlassian Cloud](atlassian-cloud-tutorial.md)| [Atlassian Cloud - 使用者佈建](atlassian-cloud-provisioning-tutorial.md)|
| ![logo-ServiceNow](./media/tutorial-list/active-directory-saas-servicenow-tutorial.png)| [ServiceNow](servicenow-tutorial.md)|[ServiceNow - 使用者佈建](servicenow-provisioning-tutorial.md)|
| ![logo-Slack](./media/tutorial-list/active-directory-saas-slack-tutorial.png)| [Slack](slack-tutorial.md)|[Slack - 使用者佈建](slack-provisioning-tutorial.md)|
| ![logo-SuccessFactors](./media/tutorial-list/active-directory-saas-successfactors-tutorial.png)| [SuccessFactors](successfactors-tutorial.md)| [SuccessFactors - 使用者佈建](./sap-successfactors-inbound-provisioning-tutorial.md) |
| ![logo-Workday](./media/tutorial-list/active-directory-saas-workday-tutorial.png)| [Workday](workday-tutorial.md)| [Workday - 使用者佈建](workday-inbound-tutorial.md)|
...
| 標誌 | 單一登入的應用程式教學課程 | 使用者佈建的應用程式教學課程 |
| :--- | :--- | :--- |
| ![logo-Amazon Web Services (AWS) 主控台](./media/tutorial-list/active-directory-saas-amazon-web-service-tutorial.png)| [Amazon Web Services (AWS) 主控台](amazon-web-service-tutorial.md)| [Amazon Web Services (AWS) 主控台 - 角色佈建](amazon-web-service-tutorial.md#configure-azure-ad-sso) |
| ![logo-Alibaba Cloud Service (角色型 SSO)](./media/tutorial-list/active-directory-saas-alibaba-tutorial.png)| [Alibaba Cloud Service (角色型 SSO)](alibaba-cloud-service-role-based-sso-tutorial.md)| |
| ![logo-Google Cloud Platform](./media/tutorial-list/active-directory-saas-google-apps-tutorial.png)| [Google Cloud Platform](google-apps-tutorial.md)| [Google Cloud Platform - 使用者佈建](g-suite-provisioning-tutorial.md) |
| ![logo-Salesforce](./media/tutorial-list/active-directory-saas-salesforce-tutorial.png)| [Salesforce](salesforce-tutorial.md)| [Salesforce - 使用者佈建](salesforce-provisioning-tutorial.md) |
| ![logo-SAP 雲端身分識別平台](./media/tutorial-list/active-directory-saas-sapboc-tutorial.png)| [SAP 雲端身分識別平台](saphana-tutorial.md)|[SAP 雲端身分識別平台 - 佈建](./sap-cloud-platform-identity-authentication-provisioning-tutorial.md) |
...
| ![標誌-Adobe 身分識別管理](./media/tutorial-list/active-directory-saas-adobe-identity-management-tutorial.png)| [Adobe Identity Management](adobe-identity-management-tutorial.md)|
...
| ![logo-Concur 旅遊和支出](./media/tutorial-list/active-directory-saas-concur-travel-and-expense-tutorial.png)| [Concur 旅遊和支出](concur-travel-and-expense-tutorial.md)|
...
| ![適用於 Bamboo 的 logo-EasySSO](./media/tutorial-list/active-directory-saas-easy-sso-for-bamboo-tutorial.png)| [適用於 Bamboo 的 EasySSO](easysso-for-bamboo-tutorial.md)|
| ![適用於 BitBucket 的 logo-EasySSO](./media/tutorial-list/active-directory-saas-easy-sso-for-bitbucket-tutorial.png)| [適用於 Bitbucket 的 Kantega SSO](easysso-for-bitbucket-tutorial.md)|
| ![適用於 Confluence 的 logo-EasySSO](./media/tutorial-list/active-directory-saas-easy-sso-for-confluence-tutorial.png)| [適用於 Confluence 的 EasySSO](easysso-for-confluence-tutorial.md)|
...
| ![標誌-Marketo](./media/tutorial-list/active-directory-saas-marketo-tutorial.png)| [Marketo](marketo-tutorial.md)|
| ![logo-Meraki 儀表板](./media/tutorial-list/active-directory-saas-meraki-dashboard-tutorial.png)| [Meraki 儀表板](meraki-dashboard-tutorial.md)|
...
| ![logo-People](./media/tutorial-list/active-directory-saas-people-tutorial.png)| [人員](people-tutorial.md)|
...
| ![logo-Zoom](./media/tutorial-list/active-directory-saas-zoom-tutorial.png)| [縮放](zoom-tutorial.md)|
