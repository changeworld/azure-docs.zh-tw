...
5. 在 [**管理員認證**] 區段下`ttps://webapi.teamviewer.com/scim/v2` ，于 [ **Tentant URL** ] 欄位中輸入，並輸入稍早在**秘密權杖**中建立的腳本標記。 按一下 [**測試連接**] 以確保 Azure AD 可以連接到 TeamViewer。 如果連線失敗，請確定您的 TeamViewer 帳戶具有系統管理員許可權，然後再試一次。
