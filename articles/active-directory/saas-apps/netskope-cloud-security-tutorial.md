...
1. 在 [基本 SAML 設定]  區段上，如果您想要以 **IDP** 起始模式設定應用程式，請輸入下列欄位的值：
    ...
    a. 在 [識別碼]  文字方塊中，使用下列模式來輸入 URL：`<OrgKey>`
...
當您在存取面板中按一下 [Netskope 系統管理員主控台] 圖格時，應該會自動登入您已設定 SSO 的 Netskope 系統管理員主控台。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](../user-help/my-apps-portal-end-user-access.md)。
