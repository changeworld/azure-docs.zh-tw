...
* 在 Azure AD 中控制可存取 EasySSO for Jira 的人員。
* 讓使用者使用其 Azure AD 帳戶自動登入 EasySSO for Jira。
...
當您在存取面板中按一下 [EasySSO for Jira] 圖格時，應該會自動登入您已設定 SSO 的 EasySSO for Jira。 如需「存取面板」的詳細資訊，請參閱[存取面板簡介](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)。
