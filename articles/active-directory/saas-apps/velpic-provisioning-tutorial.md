...
description: 瞭解如何設定 Azure Active Directory，以將使用者帳戶自動布建和取消布建至 Velpic。
...
本教學課程旨在說明您需要在 Velpic 和 Azure AD 中執行的步驟，以將使用者帳戶從 Azure AD 自動布建和解除布建至 Velpic。
...
* 已啟用 [企業方案](https://www.velpic.com/pricing.html) 或更好方案的 Velpic 租使用者
...
在設定並啟用布建服務之前，您必須決定 Azure AD 中的哪些使用者及/或群組代表需要 Velpic 應用程式存取權的使用者。 一旦決定後，您可以遵循此處的指示，將這些使用者指派給您的 Velpic 應用程式：

[將使用者或群組指派給企業應用程式](../manage-apps/assign-user-or-group-access-portal.md)

### <a name="important-tips-for-assigning-users-to-velpic"></a>將使用者指派給 Velpic 的重要秘訣

* 建議將單一 Azure AD 使用者指派給 Velpic，以測試布建設定。 其他使用者及/或群組可能會稍後再指派。

* 將使用者指派給 Velpic 時，您必須在 [指派] 對話方塊中選取 [ **使用者** 角色] 或另一個有效的應用程式特定角色 (如果有) 的話）。 請注意， **預設存取** 角色不適用於布建，而且會略過這些使用者。
