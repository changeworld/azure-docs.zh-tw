...
description: 瞭解如何從 Azure AD 將使用者帳戶自動布建和取消布建至 Mixpanel。
...
2. 之後，您必須在組織設定的 [存取安全性] 區段的 [SCIM] 索引標籤中，產生 SCIM token。
...
### <a name="to-configure-automatic-user-provisioning-for-mixpanel-in-azure-ad"></a>若要在 Azure AD 中為 Mixpanel 設定自動使用者布建：
