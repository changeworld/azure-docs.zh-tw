...
當您在存取面板中選取 [Proxyclick] 圖格時，應該會自動登入您已設定 SSO 的 Proxyclick 執行個體。 如需存取面板的詳細資訊，請參閱[在 My Apps 入口網站上存取和使用應用程式](../user-help/my-apps-portal-end-user-access.md)。
