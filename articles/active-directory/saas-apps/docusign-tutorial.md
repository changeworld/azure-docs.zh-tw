...
description: 了解如何設定 Azure Active Directory 與 DocuSign 之間的單一登入 (SSO)。
...
若要設定及測試與 DocuSign 搭配運作的 Azure AD SSO，請執行下列步驟：
...
1. 在 Azure 入口網站中按一下 [測試此應用程式]。 這會重新導向您可以在其中起始登入流程的 DocuSign 登入 URL。 
