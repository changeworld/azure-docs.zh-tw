...
在本教學課程中，您將了解如何整合 Zscaler Two 與 Azure Active Directory (Azure AD)。 在整合 Zscaler Two 與 Azure AD 後，您可以︰

* 在 Azure AD 中控制可存取 Zscaler Two 的人員。
* 讓使用者使用其 Azure AD 帳戶自動登入 Zscaler Two。
...
1. 在 [從資源庫新增] 區段的搜尋方塊中輸入 **Zscaler Two**。
1. 從結果面板選取 [Zscaler Two]，然後新增應用程式。 當應用程式新增至您的租用戶時，請等候幾秒鐘。

## <a name="configure-and-test-azure-ad-sso-for-zscaler-two"></a>設定和測試 Zscaler Two 的 Azure AD SSO

以名為 **B.Simon** 的測試使用者，設定及測試與 Zscaler Two 搭配運作的 Azure AD SSO。 若要讓 SSO 能夠運作，您必須建立 Azure AD 使用者與 Zscaler Two 中相關使用者之間的連結關聯性。

若要設定及測試與 Zscaler Two 搭配運作的 Azure AD SSO，請執行下列步驟：

1. **[設定 Azure AD SSO](#configure-azure-ad-sso)** - 讓您的使用者能夠使用此功能。
    1. **[建立 Azure AD 測試使用者](#create-an-azure-ad-test-user)** - 使用 B.Simon 測試 Azure AD 單一登入。
    1. **[指派 Azure AD 測試使用者](#assign-the-azure-ad-test-user)** - 讓 B.Simon 能夠使用 Azure AD 單一登入。
1. **[設定 Zscaler Two SSO](#configure-zscaler-two-sso)** - 在應用程式端設定單一登入設定。
    1. **[建立 Zscaler Two 測試使用者](#create-zscaler-two-test-user)** - 使 Zscaler Two 中 B.Simon 的對應使用者連結到該使用者在 Azure AD 中的代表身分。
...
## <a name="configure-zscaler-two-sso"></a>設定 Zscaler Two SSO
...
3. 按一下 [連線]  索引標籤。   
     ...
     ![連線](./media/zscaler-two-tutorial/ic769493.png "連接")
...
* 在 Azure 入口網站中按一下 [測試此應用程式]。 這會重新導向您可以在其中起始登入流程的 Zscaler Two 登入 URL。 
...
設定 Zscaler Two 後，您可以強制執行工作階段控制項，以即時防止組織的敏感資料遭到外洩和滲透。 工作階段控制項會從條件式存取延伸。 [了解如何使用 Microsoft Cloud App Security 來強制執行工作階段控制項](/cloud-app-security/proxy-deployment-any-app)。
