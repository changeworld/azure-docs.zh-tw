...
6. 在另一個視窗中打開[Microsoft 圖形資源管理器](https://developer.microsoft.com/graph/graph-explorer)，並採取以下步驟：
...
9. 在 **"使用者屬性**"對話方塊上的 **"使用者聲明"** 部分中，執行以下步驟以添加 SAML 權杖屬性，如下表所示：
...
1. 打開[微軟圖形資源管理器](https://developer.microsoft.com/graph/graph-explorer)。
...
1. 在另一個視窗中打開[Microsoft 圖形資源管理器](https://developer.microsoft.com/graph/graph-explorer)。
