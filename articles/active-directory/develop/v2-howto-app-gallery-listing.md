---
title: 將您的應用程式新增至 Azure AD 應用程式庫 |Microsoft Docs
...
ms.locfileid: "88118836"
---
# <a name="add-your-application-to-the-azure-active-directory-application-gallery"></a>將您的應用程式新增至 Azure Active Directory 應用程式庫
...
- **OpenID connect**：若要使用 Open ID Connect 通訊協定將您的應用程式與 Azure AD 整合，請遵循[開發人員的指示](../azuread-dev/v1-authentication-scenarios.md)。
