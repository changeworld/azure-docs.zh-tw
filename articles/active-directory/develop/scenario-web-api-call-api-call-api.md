...
- [呼叫 Microsoft Graph](#call-microsoft-graph)
- [呼叫 Microsoft Graph 以外的 web API](#call-web-api-other-than-microsoft-graph)
- [手動取得權杖](#acquire-a-token-manually)
...
#### <a name="call-web-api-other-than-microsoft-graph"></a>呼叫 Microsoft Graph 以外的 web API
...
#### <a name="acquire-a-token-manually"></a>手動取得權杖
