...
如果您目前有 Xamarin Android 應用程式正在使用適用于 .NET 的 Azure Active Directory Authentication Library (ADAL.NET) 以及 [驗證訊息代理](msal-android-single-sign-on.md)程式，現在可以遷移至 [適用于 .Net 的 Microsoft 驗證程式庫 ](msal-overview.md) (MSAL.NET) 。
