...
要開始使用 Azure 活動目錄圖形 API，請參閱[Azure AD 圖形 API 快速入門手冊](active-directory-graph-api-quickstart.md)，或查看互動式 Azure AD 圖形 API[參考文檔](https://msdn.microsoft.com/Library/Azure/Ad/Graph/api/api-catalog)。
