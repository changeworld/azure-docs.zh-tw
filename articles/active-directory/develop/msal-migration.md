...
- [遷移至 MSAL。面向](migrate-android-adal-msal.md)
- [遷移至 MSAL iOS/macOS](migrate-objc-adal-msal.md)
- [遷移至 MSAL Python](migrate-python-adal-msal.md)
- [遷移至 MSAL for JAVA](migrate-adal-msal-java.md)
- [使用代理程式將 Xamarin 應用程式遷移至 MSAL.NET](msal-net-migration-ios-broker.md)
