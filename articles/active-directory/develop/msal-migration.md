...
__問： ADAL 是否已被取代？__  
A：是。 自2020年6月30日起，我們將不再將新功能新增至 ADAL。 我們會繼續在2022年6月30日前新增 ADAL 的重大安全性修正。 在此日期之後，使用 ADAL 的應用程式仍可繼續使用，但我們建議您升級至 MSAL，以利用最新功能並保持安全。

__問：我現有的 ADAL 應用程式會停止運作嗎？__  
答：否。 您現有的應用程式將繼續運作而不進行修改。 如果您打算將其保留在2022年6月30日以外，您應該考慮將應用程式更新為 MSAL，以確保其安全，但不需要遷移至 MSAL 來維護現有的功能。

__問：如何? 知道哪些應用程式使用 ADAL？__  
答：如果您有應用程式的原始程式碼，您可以參考上述的「遷移指南」，以協助判斷應用程式所使用的程式庫，以及如何將它遷移至 MSAL。 如果您與 ISV 合作，建議您直接與您聯繫，以瞭解其 MSAL 的遷移旅程。
