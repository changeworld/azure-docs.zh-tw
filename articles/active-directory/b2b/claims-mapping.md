---
title: B2B 協作使用者宣告對應 - Azure 活動目錄
...
在 [Azure 入口網站](https://portal.azure.com)中，您可以檢視或編輯在 SAML 權杖中傳送給應用程式的宣告。 要訪問這些設置，請選擇**Azure 活動目錄** > **企業版應用程式**>為單一登入>**單一登入**的應用程式佈建。 請參閱 [使用者屬性]**** 區段中的 SAML 權杖設定。
