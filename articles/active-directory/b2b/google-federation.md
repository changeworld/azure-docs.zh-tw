...
小組完全支援所有裝置上的 Google 來賓使用者。 Google 使用者可以從一般端點（例如）登入小組 `https://teams.microsoft.com` 。
...
其他應用程式的通用端點可能不支援 Google 使用者。 Google 來賓使用者必須使用包含租使用者資訊的連結來登入。 範例如下所示：
  ...
  * `https://myapps.microsoft.com/<your verified domain>.onmicrosoft.com`
   ...
   如果 Google 來賓使用者嘗試使用或之類的連結 `https://myapps.microsoft.com` `https://portal.azure.com` ，他們會收到錯誤。
