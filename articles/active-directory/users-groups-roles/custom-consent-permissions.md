...
> [!NOTE]
> Azure AD 管理入口網站尚未支援將本文所列的權限新增至自訂目錄角色定義。 您必須[使用 Azure AD PowerShell 來建立自訂目錄角色](roles-create-custom.md#create-a-role-using-powershell)，其具有本文所列的權限。
...
- [使用 Azure 入口網站、Azure AD PowerShell 和圖形 API 建立自訂角色](roles-create-custom.md)
