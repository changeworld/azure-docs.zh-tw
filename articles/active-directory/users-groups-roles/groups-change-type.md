---
title: 將靜態組成員身份更改為動態 - Azure AD |微軟文檔
...
1. 使用屬於全域管理員或租戶中的使用者管理員的帳戶登錄到[Azure AD 管理中心](https://aad.portal.azure.com)。
2. 選取 [群組]****。
...
2. 選取 [新增動態查詢]****，然後提供規則。
   ...
   ![輸入動態組的規則](./media/groups-change-type/enter-rule.png)
