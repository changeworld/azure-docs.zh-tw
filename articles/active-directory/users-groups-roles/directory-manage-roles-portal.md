...
![顯示 [全域管理員-描述] 頁面的螢幕擷取畫面。](./media/directory-manage-roles-portal/role-description.png)
...
1. 選取角色以查看其指派。
    ...
    ![顯示 [使用者系統管理員-指派] 頁面的螢幕擷取畫面，其中已選取 [在 PIM 中管理] 動作。](./media/directory-manage-roles-portal/member-list.png)
