...
如果您在 Powershell 中收到一則訊息，指出已_達到允許的群組計數上限_，這表示您已達到組織中動態群組的最大限制。 每個組織的動態群組數目上限為5000。
...
如果一切良好，請等候一段時間，以填入群組。 視 Azure AD 組織的大小而定，群組最多可能需要24小時才能首次填入，或在規則變更之後。
