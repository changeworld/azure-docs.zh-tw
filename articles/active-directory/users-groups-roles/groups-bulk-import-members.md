...
ms.locfileid: "82203505"
---
# <a name="bulk-import-group-members-in-azure-active-directory"></a>Azure Active Directory 中的大量匯入群組成員
...
![用於上傳和呼叫的試算表，說明每個資料列和資料行的目的和值](./media/groups-bulk-import-members/template-with-callouts.png)
...
1. 在 [**大量匯入群組成員**] 頁面上，于 [**上傳您的 csv**檔案] 下，流覽至檔案。 當您選取檔案時，CSV 檔案的驗證就會啟動。
