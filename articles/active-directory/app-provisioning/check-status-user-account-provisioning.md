...
Azure Active Directory （Azure AD）包含[使用者帳戶](user-provisioning.md)布建服務，可協助您在 SaaS 應用程式和其他系統中自動布建使用者帳戶，以進行端對端身分識別生命週期管理。 Azure AD 在這裡針對具有使用者布建教學[課程](https://docs.microsoft.com/azure/active-directory/saas-apps/tutorial-list)的所有應用程式和系統，支援預先整合的使用者布建連接器。
