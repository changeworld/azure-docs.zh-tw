---
title: 使用 Microsoft Graph API 匯出或匯入您的布建設定 |Microsoft Docs
description: 瞭解如何使用 Microsoft Graph API 匯出和匯入布建設定。
...
ms.locfileid: "77367788"
---
# <a name="export-or-import-your-provisioning-configuration-by-using-the-microsoft-graph-api"></a>使用 Microsoft Graph API 匯出或匯入您的布建設定
