...
* [IDENTITYRISKEVENTS API](/graph/api/resources/identityriskevent?view=graph-rest-beta) *將于2020年1月10日淘汰*
...
1. 在 [建立]**** 頁面上，執行下列步驟：
   ...
   1. 在 [登**入 URL** ] 文字方塊中， `http://localhost`輸入。
