...
| 系統管理員會建立群組 D 的存取權審查，其中包含6個成員使用者和108個來賓使用者。 讓它成為自我審查。 | 6每位使用者的授權為自我審核者 + 16 個額外的授權，以所需的1:5 比例涵蓋所有108來賓使用者。 6個授權，涵蓋 6\*5 = 30 個來賓使用者。 針對剩餘的（108-6\*5） = 78 個來賓使用者，需要 78/5 = 16 個額外的授權。 因此，總共需要 6 + 16 = 22 個授權。 | 22 |
