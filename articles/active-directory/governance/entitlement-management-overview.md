...
您也可以針對依賴 Azure AD 安全性群組或 Office 365 群組的其他資源控制其存取權。  例如：

- 您可以使用存取套件中的 Azure AD 安全性群組，以及為該群組設定[群組型授權](../users-groups-roles/licensing-groups-assign.md)，而為使用者提供 Microsoft Office 365 的授權
