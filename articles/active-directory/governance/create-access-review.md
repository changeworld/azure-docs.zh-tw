...
- Azure AD Premium P2
- 全域管理員或使用者管理員
-  (預覽版) Microsoft 365 群組的資源擁有者可以在他們擁有的 Microsoft 365 群組上建立評論
-  (預覽版) Azure AD 安全性群組的資源擁有者可以在他們擁有的 Azure AD 安全性群組上建立評論
...
|失敗 | 無法進行評論。 此錯誤可能與刪除租使用者、授權變更或其他內部租使用者變更相關。 |
