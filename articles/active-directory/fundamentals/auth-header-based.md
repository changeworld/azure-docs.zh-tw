...
* [使用應用程式 Proxy 與 PingAccess 的單一登入之標頭式驗證](https://docs.microsoft.com/azure/active-directory/manage-apps/application-proxy-configure-single-sign-on-with-ping-access) 

* [使用應用程式傳遞控制器和網路保護舊版應用程式](https://docs.microsoft.com/azure/active-directory/manage-apps/secure-hybrid-access)
