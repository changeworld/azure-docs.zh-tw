---
title: 澳大利亞和紐西蘭客戶的標識資料存儲 - Azure AD
...
對於在澳大利亞或紐西蘭提供位址的客戶，Azure AD 將這些服務的身份資料保存在澳大利亞資料中心內： 
- Azure AD 目錄管理 
- 驗證

所有其他 Azure AD 服務將客戶資料存儲在全球資料中心中。 要查找服務的資料中心，請參閱[Azure 活動目錄 – 資料位於何處？](https://www.microsoft.com/trustcenter/privacy/where-your-data-is-located)

## <a name="microsoft-azure-multi-factor-authentication-mfa"></a>微軟 Azure 多重要素驗證 （MFA）

MFA 將身份客戶資料存儲在全球資料中心中。 要瞭解有關基於雲的 Azure MFA 和 Azure MFA 伺服器收集和存儲的使用者資訊的詳細資訊，請參閱[Azure 多重要素驗證使用者資料收集](https://docs.microsoft.com/azure/active-directory/authentication/concept-mfa-data-residency)。
