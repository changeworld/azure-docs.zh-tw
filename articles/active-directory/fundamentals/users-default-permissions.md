...
**地區** | **成員使用者權限** | **來賓使用者權限**
------------ | --------- | ----------
使用者和連絡人 | 讀取使用者和連絡人的所有公用屬性<br>邀請來賓<br>變更自己的密碼<br>管理自己的行動電話號碼<br>管理自己的相片<br>使自己的重新整理權杖失效 | 讀取自己的屬性<br>讀取其他使用者和連絡人的顯示名稱、電子郵件、登錄名稱、照片、使用者主體名稱以及使用者類型屬性<br>變更自己的密碼
