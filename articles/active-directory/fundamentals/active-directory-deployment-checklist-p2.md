...
| [使用條件式存取封鎖舊版驗證 Azure AD](../conditional-access/block-legacy-authentication.md) | 封鎖無法強制執行 Multi-Factor Authentication 的舊版驗證通訊協定，例如 POP、SMTP、IMAP 和 MAPI，使其成為敵人的慣用進入點。 | Azure AD Premium P1 |
...
## <a name="phase-4-audit-privileged-identities-complete-an-access-review-and-manage-user-lifecycle"></a>第4階段：審核特殊許可權身分識別、完成存取權檢查，以及管理使用者生命週期
...
[常見的建議身分識別和裝置存取原則](/microsoft-365/enterprise/identity-access-policies)