...
### <a name="new-provisioning-connectors-in-the-azure-ad-application-gallery---december-2020"></a>Azure AD 應用程式資源庫中的新布建連接器-2020 年12月
...
### <a name="public-preview---azure-ad-application-proxy-natively-supports-single-sign-on-access-to-applications-that-use-headers-for-authentication"></a>公開預覽-Azure AD 應用程式 Proxy 原生支援對使用標頭進行驗證的應用程式進行單一登入存取
