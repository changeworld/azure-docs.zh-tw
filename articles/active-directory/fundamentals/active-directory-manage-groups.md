...
>[!NOTE]
> 在 Azure 入口網站中，您可以在入口網站中看到無法管理其成員資格和群組詳細資料的某些群組：
>
> - 從內部部署同步處理的群組 Active Directory 只能在內部部署 Active Directory 中進行管理。
> - 其他群組類型（例如通訊群組清單和擁有郵件功能的安全性群組）只會在 Exchange 系統管理中心或 Microsoft 365 系統管理中心中進行管理。 您必須登入 Exchange 系統管理中心或 Microsoft 365 系統管理中心才能管理這些群組。

## <a name="how-access-management-in-azure-ad-works"></a>Azure AD 中的存取管理如何運作
