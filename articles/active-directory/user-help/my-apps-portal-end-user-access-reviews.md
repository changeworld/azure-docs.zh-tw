...
## <a name="using-myappsmicrosoftcom"></a>使用 myapps.microsoft.com
...
## <a name="using-myapplicationsmicrosoftcom"></a>使用 myapplications.microsoft.com
...
>[!Note]
>如果您看不到 [**存取評論**] 磚，可能表示您沒有執行存取權審查的許可權，或者您沒有任何擱置中的評論正在等待您的核准。 如果您認為您應該有磚的存取權，請洽詢服務台尋求協助。

## <a name="to-perform-access-reviews"></a>執行存取權審查
