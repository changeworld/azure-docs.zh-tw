...
>[!Important]
>本文適用於嘗試更新現有公司或學校帳戶已知密碼的使用者。 如果您正嘗試進入個人帳戶 (例如 Xbox、Hotmail 或 Outlook.com)，請試試[當您無法登入 Microsoft 帳戶時](https://support.microsoft.com/help/12429/microsoft-account-sign-in-cant)一文中所提供的建議。 如果您是系統管理員，而且想知道更多如何為員工或其他使用者測試自助式密碼重設的資訊，請參閱[自助式密碼重設](https://docs.microsoft.com/azure/active-directory/authentication/quickstart-sspr)。
