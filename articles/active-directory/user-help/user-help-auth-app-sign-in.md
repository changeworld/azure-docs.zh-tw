...
| 如果我為帳戶開啟雙步驟驗證，是否必須核准兩個通知？ | 否。 使用手機登入您的 Microsoft 帳戶，也會被視為雙步驟驗證，因此不需要第二個核准。 |
...
| 為什麼我無法使用一個以上的工作或學校帳戶來進行手機登入？ | 一支手機必須向單一公司或學校帳戶進行註冊。 如果您想要針對不同的公司或學校帳戶開啟手機登入，您必須透過 [**設定**] 頁面，將您的帳戶從這個裝置取消註冊。 |
