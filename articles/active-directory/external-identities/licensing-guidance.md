...
ms.locfileid: "87908224"
---
# <a name="azure-active-directory-b2b-collaboration-licensing-guidance"></a>Azure Active Directory B2B 共同作業授權指引

使用 Azure Active Directory (Azure AD) 企業對企業 (B2B) 共同作業時，您可以邀請「外部使用者」(或「來賓使用者」) 來使用您的付費 Azure AD 服務。 有些功能是免費的，但針對任何付費的 Azure AD 功能，您可以為您租使用者中員工或非來賓使用者所擁有的每個 Azure AD edition 授權，最多邀請五位來賓使用者。

> [!NOTE]
> 如需 Azure AD 定價與 B2B 共同作業功能的詳細資訊，請參閱 [Azure Active Directory 定價](https://azure.microsoft.com/pricing/details/active-directory/) 。
...
- 您想要將100來賓使用者邀請到您的 Azure AD 應用程式或服務，並提供存取管理和布建。 針對這些來賓使用者的50，您也想要要求 MFA 和條件式存取，因此對於這些功能，您將需要 10 Azure AD Premium P1 授權。 如果您打算對來賓使用者使用「身分識別保護」功能，則需要同樣 1:5 比例的 Azure AD Premium P2 授權，才能這些使用者。
