...
| 將您的隱私權聲明新增至 B2B 來賓使用者兌換體驗 | 您可以將組織隱私權聲明的 URL 新增到第一次邀請兌換程式，讓受邀的使用者必須同意您的隱私權條款才能繼續。 請參閱 [如何：在 Azure Active Directory 中新增貴組織的隱私權資訊](https://aka.ms/adprivacystatement)。 |
