...
行動裝置 (iOS)           | ![此圖顯示 iOS/目標 C 或 Swift](media/sample-v2-code/logo-ios.png) | 互動式 |   [nativeClient-iOS](https://github.com/azureadquickstarts/nativeclient-ios) |
