...
description: 使用 Azure CLI 指令碼範例，篩選輸入和輸出虛擬機器 (VM) 網路流量。
...
ms.locfileid: "87281628"
---
# <a name="filter-inbound-and-outbound-vm-network-traffic-using-an-azure-cli-script-sample"></a>使用 Azure CLI 指令碼範例，篩選輸入和輸出 VM 網路流量
