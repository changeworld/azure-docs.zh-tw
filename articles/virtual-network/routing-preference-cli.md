...
使用命令 [az network Public-IP create](/cli/azure/network/public-ip?view=azure-cli-latest#az-network-public-ip-create)，以 **網際網路** 類型的路由喜好設定建立公用 ip 位址，如下所示。
