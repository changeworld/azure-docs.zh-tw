...
部署後，如果希望在目標中重新開始或捨棄公用 IP，請刪除在目標中建立的資源群組，這將會刪除已移動的公用 IP。  若要移除資源群組，請使用 [Remove-AzResourceGroup](https://docs.microsoft.com/powershell/module/az.resources/remove-azresourcegroup?view=azps-2.6.0)：
...
若要認可變更並完成移動虛擬網路、刪除來源虛擬網路或資源群組，請使用 [Remove-AzResourceGroup](https://docs.microsoft.com/powershell/module/az.resources/remove-azresourcegroup?view=azps-2.6.0) 或 [Remove-AzPublicIPAddress](https://docs.microsoft.com/powershell/module/az.network/remove-azpublicipaddress?view=azps-2.6.0)：
