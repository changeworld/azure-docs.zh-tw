...
* 如果虛擬網路連結至[Azure DNS 私人區域](../dns/private-dns-overview.md)作為註冊虛擬網路，反向 DNS 查詢會傳回兩個記錄。 其中一筆記錄的格式會是 \[ vmname \] 。 [privatednszonename] 和其他的格式為 \[ vmname \] . internal.cloudapp.net
