...
* 針對 Azure Resource Manager 部署模型中的虛擬網路，可透過 [網路介面 REST API](https://docs.microsoft.com/rest/api/virtualnetwork/networkinterfaces)、 [get-aznetworkinterface](/powershell/module/az.network/get-aznetworkinterface) PowerShell Cmdlet 和 [az network nic show](/cli/azure/network/nic#az-network-nic-show) Azure CLI 命令來取得尾碼。
