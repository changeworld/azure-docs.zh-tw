---
title: 在 Azure 虛擬網路中部署具有基本 Load Balancer 的 IPv6 雙重堆疊應用程式-Resource manager 範本
...
---
# <a name="deploy-an-ipv6-dual-stack-application-with-basic-load-balancer-in-azure---template"></a>使用 Azure 中的基本 Load Balancer 部署 IPv6 雙重堆疊應用程式-範本

本文提供 IPv6 設定工作的清單，其中包含適用于的 Azure Resource Manager VM 範本部分。 使用本文所述的範本來部署具有基本 Load Balancer 的雙重堆疊（IPv4 + IPv6）應用程式，其中包含具有 IPv4 和 IPv6 子網的雙重堆疊虛擬網路、具有雙重（IPv4 + IPv6）前端設定的基本 Load Balancer、具有雙重 IP 設定的 Vm、網路安全性群組和公用 Ip。
