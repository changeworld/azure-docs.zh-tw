...
本文說明如何使用 Azure 中的 Standard Load Balancer 部署雙重堆疊（IPv4 + IPv6）應用程式，其中包括雙重堆疊虛擬網路和子網、具有雙重（IPv4 + IPv6）前端設定的 Standard Load Balancer、具有雙 IP 設定的 Vm、網路安全性群組和公用 Ip。
