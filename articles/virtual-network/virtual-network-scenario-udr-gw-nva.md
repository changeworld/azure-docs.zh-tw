...
這是標準的周邊網路 (也會以 dmz 和受保護的網路 knowns 為 DMZ) 案例。 您可以使用 Nsg、防火牆虛擬裝置或兩者的組合，在 Azure 中建立這類案例。 下表會顯示 NSG 和防火牆虛擬設備之間的優缺點。
...
5. 布建所有資源之後，請登入 **>onpremvm2** 並偵測10.0.3.101，以測試 **>onpremsn2** 和 **>azsn3**之間的連線能力。
