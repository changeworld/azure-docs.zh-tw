...
## <a name="current-fqdn-tags"></a>當前 FQDN 標籤
...
|Azure HDInsight|允許對 HDInsight 平臺流量進行出站訪問。 此標記不包括 HDInsight 的客戶特定存儲或 SQL 流量。 使用[服務終結點](../virtual-network/tutorial-restrict-network-access-to-resources.md)啟用這些終結點或手動添加它們。|
