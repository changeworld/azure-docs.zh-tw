...
![作為容器執行時間的 Moby 引擎](./media/support/only-moby-for-production.png)
</center>

## <a name="operating-systems"></a>作業系統

Azure IoT Edge 會在大部分可執行容器的作業系統上執行;不過，並非所有這些系統都同樣受到支援。 以下將作業系統分組為各種階層，代表使用者可預期的支援程度。

* 支援第1層系統。 針對第1層系統，Microsoft：
  * 在自動化的測試中有此作業系統
  * 有為它們提供安裝套件
* 第2層系統與 Azure IoT Edge 相容，而且可以相當輕鬆地使用。 第2層系統：
  * Microsoft 已在平臺上完成非正式測試，或瞭解合作夥伴已成功在平臺上執行 Azure IoT Edge
...
您可以在[azure iotedge 版本](https://github.com/Azure/azure-iotedge/releases)頁面上取得 IoT Edge 版本資產和版本資訊。 本節會反映這些版本資訊中的資訊，以協助您更輕鬆地將每個版本的元件視覺化。

您可以個別安裝或更新 IoT Edge 元件，並回溯相容于較舊版本的元件。 下表列出每個版本中所包含的元件：

| 版本   | 安全性 daemon  | Edge 中樞<br>Edge 代理程式 | Libiothsm | Moby  |
| --------- | ---------------- | ---------------------- | --------- | ----- |
| **1.0.9** | 1.0.9            | 1.0.9                  | 1.0.9     |       |
| **1.0.8** | 1.0.8            | 1.0.8.5<br>1.0.8.4<br>1.0.8.3<br>1.0.8.2<br>1.0.8.1<br>1.0.8 | 1.0.8 | 3.0.6 版 |
| **1.0.7** | 1.0.7.1<br>1.0.7 | 1.0.7.1<br>1.0.7       | 1.0.7.1<br>1.0.7 | 3.0.5<br>3.0.4 （ARMv7hl，CentOS） |
| **1.0.6** | 1.0.6.1<br>1.0.6 | 1.0.6.1<br>1.0.6       | 1.0.6.1<br>1.0.6 |  |
| **1.0.5** | 1.0.5            | 1.0.5                  | 1.0.5     | 3.0.2 |

IoT Edge 使用 Microsoft. Azure. 用戶端 SDK。 如需詳細資訊，請參閱[Azure IoT c # SDK GitHub](https://github.com/Azure/azure-iot-sdk-csharp)存放庫或[適用于 .NET 的 azure SDK 參考內容](https://docs.microsoft.com/dotnet/api/overview/azure/iot/client?view=azure-dotnet)。 下列清單顯示測試每個版本的用戶端 SDK 版本：
