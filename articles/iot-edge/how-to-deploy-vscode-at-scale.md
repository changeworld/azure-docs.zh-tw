...
使用[Azure 入口網站](how-to-monitor-iot-edge-deployments.md#monitor-a-deployment-in-the-azure-portal)或[Azure CLI](how-to-monitor-iot-edge-deployments.md#monitor-a-deployment-with-azure-cli)來監視、修改和刪除部署。 兩者都會提供您部署的計量。
