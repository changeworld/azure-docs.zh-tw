...
如果您在本機建置，請下載並安裝 [Azure CLI](/cli/azure/install-azure-cli?view=azure-cli-latest) (如果您還沒有這麼做)。

若要執行雲端建置 (例如搭配 Azure DevOps)，請確定 [Azure CLI](/cli/azure/install-azure-cli?view=azure-cli-latest) 已安裝在您的建置系統中。
