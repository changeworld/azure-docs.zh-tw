...
使用下列命令或[Azure 入口網站](/azure/storage/common/storage-auth-aad-rbac-portal#assign-azure-roles-using-the-azure-portal)，將 Azure 函數應用程式存取權的受控識別授與儲存體佇列。 
