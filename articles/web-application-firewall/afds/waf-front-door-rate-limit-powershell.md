...
下列範例會使用資源組名 *myResourceGroupFD1* ，並假設您已使用 [快速入門：建立 Front Door](../../frontdoor/quickstart-create-front-door.md) 文章中提供的指示來建立 Front Door 設定檔。

 使用 [New-AzFrontDoorWafPolicy](/powershell/module/az.frontdoor/new-azfrontdoorwafpolicy)。
