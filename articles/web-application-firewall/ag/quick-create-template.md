...
在本快速入門中，您會使用 Azure Resource Manager 範本 (ARM 範本) 在應用程式閘道上建立 Web 應用程式防火牆 v2。
...
本快速入門中使用的範本是來自 [Azure 快速入門範本](https://azure.microsoft.com/resources/templates/ag-docs-wafv2/)。
