...
若要取得天氣資料，請確定您已 [安裝 FarmBeats](https://aka.ms/farmbeatsinstalldocumentation)。 1.2.11 和更高版本支援氣象整合。 
