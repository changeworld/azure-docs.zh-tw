...
如需 PowerShell Core 6 新功能的詳細資訊，請參考 [PowerShell 文件](/powershell/scripting/whats-new/what-s-new-in-powershell-70?view=powershell-7.1)和[開始使用 PowerShell Core](https://blogs.msdn.microsoft.com/powershell/2017/06/09/getting-started-with-powershell-core-on-windows-mac-and-linux/) 的部落格文章。