...
2. 在您的私人雲端中建立使用者，以進行 vSphere 複寫和 SRM 安裝。 以下在[VCENTER UI 中說明：在私人雲端中建立用於 vRA &AMP; SRM 安裝的使用者](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation)。
...
5. 設定 vRA 的防火牆規則。 下列在[CloudSimple 入口網站中說明：設定 vRA 的防火牆規則](#cloudsimple-portal-configure-firewall-rules-for-vra)。
