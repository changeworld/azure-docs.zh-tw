---
title: 依 CloudSimple 的 Azure VMware 解決方案-保護私人雲端
description: 說明如何藉由 CloudSimple 私用雲端來保護 Azure VMware 解決方案
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/19/2019
ms.topic: article
...
1. 在私人雲端上提升**CloudOwner\@cloudsimple**的[許可權](escalate-private-cloud-privileges.md)。本機使用者。
