...
| **狀態追蹤** | 追蹤可以是無狀態的 (私用雲端、網際網路或 VPN) 或具狀態 (公用 IP) 。  |
...
|優先順序|名稱|狀態追蹤|方向|流量類型|通訊協定|來源|來源連接埠|Destination|目的地連接埠|動作|
|--------|----|--------------|---------|------------|--------|------|-----------|-----------|----------------|------|
|65000|允許-全至網際網路|具狀態|輸出|公用 IP 或網際網路流量|全部|任意|任意|任意|任意|Allow|
|65001|拒絕-全部從網際網路|具狀態|輸入|公用 IP 或網際網路流量|全部|任意|任意|任意|任意|拒絕|
