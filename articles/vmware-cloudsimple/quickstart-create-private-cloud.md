...
雲簡單為您提供了專用雲的 ExpressRoute 電路。 您可以將 Azure 上的虛擬網路連接到 ExpressRoute 電路。 有關設定連線的完整詳細資訊,[請依照 Azure 虛擬網路連線中的步驟使用 ExpressRoute](https://docs.azure.cloudsimple.com/cloudsimple-azure-network-connection/)。
