...
------------ | ------------- | ------------ | ------------ | ------------- |
| 磁碟失敗 | YES | 快速取代失敗的節點 | [關於 vSAN 預設儲存體原則](https://docs.vmware.com/en/VMware-vSphere/6.7/com.vmware.vsphere.virtualsan.doc/GUID-C228168F-6807-4C2A-9D74-E584CAF49A2A.html) |
