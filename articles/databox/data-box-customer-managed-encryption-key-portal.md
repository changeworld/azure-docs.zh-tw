...
8. 在 Azure Key Vault 的 [ **選取金鑰**] 中，您可以選取現有金鑰保存庫中的金鑰。
    ...
    ![在 Azure Key Vault 3 中建立新的金鑰](./media/data-box-customer-managed-encryption-key-portal/customer-managed-key-6.png)

9. 如果您想要建立新的金鑰，請選取 [ **建立新** 的] 來建立金鑰。 RSA 金鑰大小可以是2048或更高的版本。

    ![在 Azure Key Vault 4 中建立新的金鑰](./media/data-box-customer-managed-encryption-key-portal/customer-managed-key-61.png)
...
11. 系統會通知您金鑰保存庫中已建立金鑰。 選取 **版本** ，然後選擇 [ **選取**]。

    ![在 key vault 中建立的新金鑰](./media/data-box-customer-managed-encryption-key-portal/customer-managed-key-8.png)
