...
ms.locfileid: "80064960"
---
# <a name="open-a-support-ticket-for-azure-data-box"></a>開啟 Azure 資料箱的支援票證 

本文適用于 Azure 資料框、Azure 資料框重和 Azure 資料框磁片，所有這些磁片都由 Azure 資料框服務管理。 如果您在 Azure 資料箱服務上遇到任何問題，便可以建立技術支援服務要求。 本文將引導您：
...
瞭解如何[解決與資料盒 Blob 存儲相關的問題](data-box-troubleshoot-rest.md)。
