...
ms.locfileid: "91744146"
---
# <a name="open-a-support-ticket-for-azure-data-box"></a>開啟 Azure 資料箱的支援票證

本文適用於 Azure 資料箱、Azure Data Box Heavy 和 Azure 資料箱磁碟，其全部都是由 Azure 資料箱服務所管理。 如果您在 Azure 資料箱服務上遇到任何問題，便可以建立技術支援服務要求。 本文將引導您：
...
2. 在 [新增支援要求] 中，選取 [基本]。 在 [基本] 中，執行下列步驟：
    ...
    2. 選擇您的**訂用帳戶**。
    3. 在 [服務] 底下，勾選 [所有服務]。 從下拉式清單中選取 [資料箱]。 
    4. 指定您的**支援方案**。
    5. 按 [下一步] 。
...
4. 在 [新增支援要求] 中，按一下 [步驟 3 連絡人資訊]。 在 [連絡人資訊] 中，執行下列步驟：
   ...
   2. 在 [連絡人資訊] 中，提供姓名、電子郵件、選用連絡方法、國家/地區。 選取 [儲存連絡人變更，以供後續支援要求使用]。
   3. 按一下 [建立]。
...
2. [說明 + 支援] 中會以表格式清單列出 [最近的支援要求]。
    ...
    ![管理支援要求2](./media/data-box-disk-contact-microsoft-support/data-box-disk-manage-support-ticket2.png)
...
了解如何[針對資料箱的相關問題進行疑難排解](data-box-troubleshoot.md)。
了解[如何針對 Data Box Blob 儲存體的相關問題進行疑難排解](data-box-troubleshoot-rest.md)。
