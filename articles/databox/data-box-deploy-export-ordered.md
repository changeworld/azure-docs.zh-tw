...
* 您的資料中心必須有高速網路。 強烈建議您具有至少一個 10 GbE 的連線。 如果沒有 10 GbE 連線，則可以使用 1 GbE 資料連結，但是複製速度會受到影響。
...
若要取消此順序，請在 Azure 入口網站中，移至 **[總覽**]，然後從命令列選取 [**取消**]。

下訂單之後，您可以在訂單開始處理前的任何時間點取消它。

若要刪除已取消的訂單，請移至 **[總覽**]，然後從命令列中選取 [**刪除**]。
