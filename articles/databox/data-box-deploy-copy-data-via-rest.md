...
### <a name="verify-connection-and-configure-partner-software"></a>驗證連線並設定合作夥伴軟體
...
請遵循相關步驟，以[在透過 http 連線時設定所使用的合作夥伴軟體](#verify-connection-and-configure-partner-software)。 唯一的差別是您應該使 [使用 http 選項] 保持未核取狀態。
