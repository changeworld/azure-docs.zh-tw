...
|**弱點評定應於您的 SQL 伺服器上啟用**|弱點評估可發現、追蹤並協助您補救資料庫的潛在弱點。<br>（相關原則：弱點評估應在您的 SQL 伺服器上啟用）|高|**Y**|SQL|
|**SQL 受控執行個體上應啟用弱點評定**|弱點評估可發現、追蹤並協助您補救資料庫的潛在弱點。<br>（相關原則：弱點評估應在您的 SQL 受控實例上啟用）|高|**Y**|SQL|
