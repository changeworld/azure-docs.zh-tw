...
本文說明資訊安全中心如何使用 Azure RBAC，將權限指派給使用者，並識別每個角色允許的動作。 現在，您已熟悉監視您的訂用帳戶的安全性狀態所需的角色指派，編輯安全性原則和套用建議，接著了解如何︰
...
- [監視合作夥伴安全性解決方案](./security-center-partner-integration.md)