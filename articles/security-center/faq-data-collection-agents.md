...
若要監視安全性弱點和威脅，Azure 資訊安全中心取決於 [Log Analytics 代理](../azure-monitor/platform/log-analytics-agent.md) 程式-這是 Azure 監視器服務所使用的相同代理程式。 
...
- 虛擬機器處於執行狀態。
- 已安裝 Windows 或 Linux [Azure 虛擬機器代理程式](../virtual-machines/extensions/agent-windows.md)。
