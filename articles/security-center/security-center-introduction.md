...
適用於 IoT (物聯網) 的 Defender 可藉由在邊緣、內部、在 Azure 及其他雲端中執行的工作負載，提供統一的可見性和控制、調適型威脅防護，以及智慧型威脅防護和回應，以簡化混合式工作負載保護。 如需相關資訊，請參閱[適用於 IoT 的 Defender](../defender-for-iot/index.yml)。
