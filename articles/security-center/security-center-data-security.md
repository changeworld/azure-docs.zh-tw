...
* **Azure 活動**：所有安全性警示、已核准的資訊安全中心 [Just-In-Time](security-center-just-in-time.md) 要求，以及[自適性應用程式控制](security-center-adaptive-application.md)產生的所有警示。
* **Azure 監視器記錄**：所有安全性警示。
