---
title: Java 中的粗略重新定位
description: 深入說明如何在 Java 中使用粗略重新定位建立和尋找錨點。
author: bucurb
manager: dacoghl
...
ms.locfileid: "87319026"
---
# <a name="how-to-create-and-locate-anchors-using-coarse-relocalization-in-java"></a>如何在 Java 中使用粗略重新定位建立和尋找錨點
