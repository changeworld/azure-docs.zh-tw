...
2. 在您的程式碼中：
    ...
    3.  在您的權杖要求上，將**資源**設定https://sts.mixedreality.azure.com為 ""。 此「資源」會指出 Azure AD 您的應用程式要求 Azure 空間錨點服務的權杖。
...
2.  在您的程式碼中（注意：您可以使用 GitHub 上所包含的服務範例）：
    ...
    3.  在您的權杖要求上，將**資源**設定https://sts.mixedreality.azure.com為 ""
