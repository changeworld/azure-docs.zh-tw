---
title: 如何在 Azure VPN 閘道上配置 OpenVPN：PowerShell
...
---
# <a name="configure-openvpn-for-azure-point-to-site-vpn-gateway"></a>為 Azure 點對點 VPN 閘道配置 OpenVPN

本文可説明您在 Azure VPN 閘道上設置**OpenVPN® 協定**。 本文假設您已具有可用的點對站環境。 如果還沒有，請使用步驟 1 中的指示來建立點對站 VPN。



## <a name="1-create-a-point-to-site-vpn"></a><a name="vnet"></a>1. 創建點對點 VPN
