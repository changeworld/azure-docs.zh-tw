...
## <a name="2-create-the-vpn-gateway"></a><a name="VNetGateway"></a>2. 建立 VPN 閘道
...
## <a name="6-verify-the-vpn-connection"></a><a name="VerifyConnection"></a>6. 驗證 VPN 連線
