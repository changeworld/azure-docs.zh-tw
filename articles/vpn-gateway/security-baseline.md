...
- [使用 Azure 入口網站建立路由型 VPN 閘道](./tutorial-create-gateway-portal.md)
...
- [適用于 VPN 閘道的 Azure CLI](/cli/azure/network/vnet-gateway?view=azure-cli-latest)
...
- [適用于虛擬網路的 Azure 原則範例內建](../virtual-network/policy-reference.md)
