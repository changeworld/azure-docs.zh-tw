...
## <a name="1-sign-in-and-set-variables"></a><a name="declare"></a>1. 登入和設定變數
...
## <a name="2-configure-a-vnet"></a><a name="ConfigureVNet"></a>2. 設定 VNet
...
## <a name="3-create-the-vpn-gateway"></a><a name="creategateway"></a>3. 建立 VPN 閘道
...
## <a name="4-add-the-vpn-client-address-pool"></a><a name="addresspool"></a>4. 新增 VPN 用戶端位址集區
...
## <a name="5-generate-certificates"></a><a name="Certificates"></a>5. 產生憑證
...
### <a name="1-obtain-the-cer-file-for-the-root-certificate"></a><a name="cer"></a>1. 取得根憑證的 .cer 檔案

[!INCLUDE [vpn-gateway-basic-vnet-rm-portal](../../includes/vpn-gateway-p2s-rootcert-include.md)]


### <a name="2-generate-a-client-certificate"></a><a name="generate"></a>2. 產生用戶端憑證
...
## <a name="8-configure-the-native-vpn-client"></a><a name="clientconfig"></a>8. 設定原生 VPN 用戶端
...
1. 若要連接至您的 VNet，在用戶端電腦上瀏覽到 VPN 連線，然後找出所建立的 VPN 連線。 其名稱會與虛擬網路相同。 按一下 [ **連接** ]。 可能會出現與使用憑證有關的快顯訊息。 按一下 [繼續]  可使用較高的權限。 
