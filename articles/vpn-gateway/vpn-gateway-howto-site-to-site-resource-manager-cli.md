...
* *--Gateway-ip 位址*是內部部署 VPN 裝置的 ip 位址。
...
## <a name="8-configure-your-vpn-device"></a><a name="VPNDevice"></a>8. 設定 VPN 裝置
...
## <a name="9-create-the-vpn-connection"></a><a name="CreateConnection"></a>9. 建立 VPN 連線
