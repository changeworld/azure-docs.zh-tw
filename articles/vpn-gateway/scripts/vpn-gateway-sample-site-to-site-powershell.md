...
description: 使用 PowerShell 建立路由型 VPN 閘道，並設定 VPN 裝置以新增站對站連線能力。
...
| [New-AzLocalNetworkGateway](/powershell/module/az.network/new-azlocalnetworkgateway) | 建立區域網路閘道。 |
