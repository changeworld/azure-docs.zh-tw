...
## 2. <a name="vnet"></a>建立資源群組、VNet 和公用 IP 位址
...
## 3. <a name="radius"></a>設定 RADIUS 伺服器
...
## 5. <a name="addradius"></a>新增 RADIUS 伺服器和用戶端位址集區
...
## 6. <a name="vpnclient"></a>下載 vpn 用戶端設定套件並設定 vpn 用戶端
