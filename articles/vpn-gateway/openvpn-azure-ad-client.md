...
### <a name="is-the-azure-vpn-client-supported-with-windows-fips-mode"></a>Windows FIPS 模式支援 Azure VPN Client 嗎？

是，使用 [KB4577063](https://support.microsoft.com/help/4577063/windows-10-update-kb4577063) 的修正程式。
