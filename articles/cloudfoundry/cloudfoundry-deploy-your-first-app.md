...
> [!IMPORTANT] 
> 如果您正在從 Azure Marketplace 部署 PCF，請記下存取 Pivotal Apps Manager 所需的 SYSTEMDOMAINURL 和管理員認證，這兩個項目都在市集部署指南中提及。 需要這兩個項目才能完成本教學課程。 針對 marketplace 部署，SYSTEMDOMAINURL 的格式為 `https://system.*ip-address*.cf.pcfazure.com` 。
