...
description: 本文可説明您創建、禁用、啟用和刪除 Azure 流量管理器設定檔。
...
1. 從瀏覽器登入 [Azure 入口網站](https://portal.azure.com)。 如果您還沒有帳戶，您可以註冊一[個月的免費試用](https://azure.microsoft.com/free/)。 
2. 按一下 **"創建資源** > **網路** > **流量管理器"設定檔** > **創建**。
...
2. 在門戶的搜索欄中，搜索要修改的**流量管理器設定檔**名稱，然後按一下顯示結果中的流量管理器設定檔。
3. 按一下 **"概述** > **禁用**"。
4. 確認停用流量管理員設定檔。
