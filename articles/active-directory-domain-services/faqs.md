...
* [我可以將 Azure AD Domain Services 作為企業行動套件 (EMS) 的一部分嗎？我是否需要 Azure AD Premium 才能使用 Azure AD Domain Services？](#can-i-failover-azure-ad-domain-services-to-another-region-for-a-dr-event)
