...
本文說明如何使用 Azure Resource Manager 範本建立受控網域。 支援的資源是使用 Azure PowerShell 建立的。
...
>
> 在此範例和操作說明文章中，會使用 aadds.contoso.com 的自訂網域作為簡短的範例。 在所有命令中，指定您自己的網域名稱。
