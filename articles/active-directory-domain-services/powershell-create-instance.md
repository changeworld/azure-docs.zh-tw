...
現在建立名為 *AAD DC 管理員*的 Azure AD 群組。 系統會授與新增至此群組的使用者權限，以在 Azure AD DS 受控網域上執行管理工作。
...
現在來建立 Azure AD DS 受控網域。 設定您的 Azure 訂用帳戶識別碼，然後提供受控網域的名稱，例如 aaddscontoso.com  。 您可以使用 [Get-AzSubscriptionn][Get-AzSubscription] Cmdlet 取得訂用帳戶識別碼。
