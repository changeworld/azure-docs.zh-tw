...
description: 瞭解如何建立連線，以使用 Azure 入口網站將虛擬網路連結至 Azure ExpressRoute 線路。
...
6. 輸入**授權金鑰**和**對等線路 URI**，並提供連線名稱。 按一下 [確定]。 **對等線路 URI**是 expressroute 線路的資源識別碼， (您可以在 expressroute 線路) 的 [屬性] 設定窗格中找到。
