...
如果您的虛擬網路閘道為 Ultra 效能或 ErGw3AZ，您可以啟用 [ExpressRoute FastPath](expressroute-about-virtual-network-gateways.md) 。 FastPath 可改善資料路徑效能，例如在內部部署網路與虛擬網路之間的每秒封包數和每秒連線數。 
