...
* 在某些情況下，需要由 Microsoft 對您網路中裝載的服務端點起始連線。 案例的常見範例是從 Microsoft 365 連接到網路中裝載的 ADFS 伺服器。 在這種情況下，必須將您網路中適當的首碼透露給 Microsoft 對等。 
...
![如何設定 NAT 以 Snat 轉譯至有效公用 IPv4 位址的高階圖表，然後再進入 Microsoft 網路。](./media/expressroute-nat/expressroute-nat-azure-public.png) 
