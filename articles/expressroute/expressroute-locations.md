...
| **歐洲** | 法國中部、法國南部、德國北部、德國中西部、北歐、挪威東部、挪威西部、瑞士北部、瑞士西部、英國西部、英國南部、西歐 |阿姆斯特丹、阿姆斯特丹2、哥本哈根、都柏林、法蘭克福、日內瓦、倫敦、倫敦2、馬賽、米蘭、慕尼克、紐波特（威爾士）、奧斯陸、巴黎、斯塔萬格、斯德哥爾摩、蘇黎世 |
...
| **杜德梅納** |支援 |支援 | 迪拜2 |
| **eir** |支援 |支援 |都柏林|
| **[埃蒲賽隆全球通信](https://www.epsilontel.com/solutions/direct-cloud-connect)** |支援 |支援 |新加坡、新加坡 2 |
...
| **[NTT 通信](https://www.ntt.com/en/services/network/virtual-private-network.html)** |支援 |支援 |阿姆斯特丹、香港特別行政區、倫敦、洛杉磯、大阪、新加坡、悉尼、東京、華盛頓特區 |
| **[NTT EAST](https://flets.com/cloudgateway/crossconnect/)** |支援 |支援 |東京 |
| **[NTT 智慧連接](https://cloud.nttsmc.com/cxc/azure.html)** |支援 |支援 |大阪 |
...
| **[資料包交換](https://www.packetfabric.com/cloud-connectivity/microsoft-azure)** |支援 |支援 |芝加哥、矽谷、華盛頓特區 |
...
## <a name="connectivity-through-exchange-providers"></a>通過 Exchange 供應商連接
...
## <a name="connectivity-through-additional-service-providers"></a>通過其他服務提供者進行連接
...
| **[阿特裡亞網路公司](https://www.arteria-net.com/business/service/cloud/sca/)** |Equinix |東京 |
| **[Axtel](https://alestra.mx/landing/expressrouteazure/)** |Equinix |達拉斯|
| **[豆場地鐵連接](https://www.beanfield.com/business/cloud-connect)** |Megaport |Toronto|
...
| **[巴林卡拉姆電信 B.S.C](http://www.kalaam-telecom.com/en/inbusiness/expressroute.html)**| Level 3 Communications |阿姆斯特丹 |
...
## <a name="connectivity-through-datacenter-providers"></a>通過資料中心供應商進行連接

| **供應商** | **裝置** |
| --- | --- |
| **[CyrusOne](https://cyrusone.com/enterprise-data-center-services/connectivity-and-interconnection/cloud-connectivity-reaching-amazon-microsoft-google-and-more/microsoft-azure-expressroute/?doing_wp_cron=1498512235.6733090877532958984375)** | 巨型埠，資料包交換 |
| **[Cyxtera](https://www.cyxtera.com/data-center-services/interconnection)** | 巨型埠，資料包交換 |
...
| **[Digital Realty](https://www.digitalrealty.com/services/interconnection/service-exchange/)** | IX 到達，兆埠資料包交換 |
| **[EdgeConnex](https://www.edgeconnex.com/services/edge-data-centers-proximity-matters/)** | 巨型埠，資料包交換 |
| **[彈性](https://www.flexential.com/connectivity/cloud-connect-microsoft-azure-expressroute)** | IX 到達， 兆埠， 資料包交換 |
| **[QTS 資料中心](https://www.qtsdatacenters.com/hybrid-solutions/connectivity/azure-cloud )** | 巨型埠，資料包交換 |
