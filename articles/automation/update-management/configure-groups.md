...
您可以從 Azure 入口網站中的 [更新管理]，定義 Azure 或非 Azure 機器的動態群組。 請參閱 [管理 vm 的更新](manage-updates-for-vm.md)。
...
![螢幕擷取畫面顯示非 Azure (預覽) 的 [選取群組] 頁面，以及右邊的預覽窗格。](./media/configure-groups/select-groups-2.png)
