...
唯一的選擇是重複註冊過程。
對於 Azure 節點,可以更正從 Azure 門戶或使用 Az 模組 cmdlet 的漂移。 有關此過程的詳細資訊記錄在[載入電腦中,供 Azure 自動化狀態設定進行管理](automation-dsc-onboarding.md#onboard-a-vm-using-azure-portal)。
