...
description: 使用變更追蹤的 [檔案內容變更] 功能來查看已變更之檔案的內容。
services: automation
...
* 您的自動化帳戶中已啟用[變更追蹤](automation-change-tracking.md)。
...
1. 在**變更追蹤**的 [編輯設定] 頁面上，選取 [ **Windows**檔案] 或 [ **Linux**檔案] 索引標籤，然後按一下 [**新增**]
...
1. 在 [變更詳細資料] 窗格中，您會看到檔案資訊前後的標準。 選取 [**查看檔案內容變更**] 以查看檔案的內容。
