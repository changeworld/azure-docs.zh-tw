...
這項功能會使用[update-azvm](https://docs.microsoft.com/powershell/module/az.compute/start-azvm) Cmdlet 來啟動 vm。 它會使用[停止 update-azvm](https://docs.microsoft.com/powershell/module/az.compute/stop-azvm)來停止 vm。
