...
* [Runbook 執行環境](https://docs.microsoft.com/azure/automation/automation-runbook-execution#runbook-execution-environment)
...
* [將 Azure 自動化作業資料轉送至 Azure 監視器記錄](https://docs.microsoft.com/azure/automation/automation-manage-send-joblogs-log-analytics)

* [將 DSC 與 Azure 監視器記錄整合](https://docs.microsoft.com/azure/automation/automation-dsc-diagnostics)

* [已連結 Log Analytics 工作區的支援區域](https://docs.microsoft.com/azure/automation/how-to/region-mappings)

* [查詢更新管理記錄](https://docs.microsoft.com/azure/automation/automation-update-management-query-logs)
...
* [在 Azure 資訊安全中心中設定資料收集層](https://docs.microsoft.com/azure/security-center/security-center-enable-data-collection#data-collection-tier)
...
* [自動化帳戶的資料保留詳細資料](https://docs.microsoft.com/azure/automation/automation-managing-data#data-retention)
...
* [瞭解 Azure 監視器中的記錄查詢](https://docs.microsoft.com/azure/azure-monitor/log-query/get-started-portal)
...
* [如何針對 Azure 監視器記錄資料發出警示](https://docs.microsoft.com/azure/azure-monitor/learn/tutorial-response)
...
* [刪除執行身分或傳統執行身分帳戶](https://docs.microsoft.com/azure/automation/manage-runas-account#delete-a-run-as-or-classic-run-as-account)

* [管理 Azure 自動化執行身分帳戶](https://docs.microsoft.com/azure/automation/manage-runas-account)
...
* [使用 Azure AD 向 Azure 進行驗證](https://docs.microsoft.com/azure/automation/automation-use-azure-ad)
...
* [使用 runbook 驗證搭配受控識別](https://docs.microsoft.com/azure/automation/automation-hrw-run-runbooks#runbook-auth-managed-identities)
...
* [混合式 Runbook 背景工作角色的 Runbook 權限](https://docs.microsoft.com/azure/automation/automation-hybrid-runbook-worker#runbook-permissions-for-a-hybrid-runbook-worker)

* [管理角色權限與安全性](https://docs.microsoft.com/azure/automation/automation-role-based-access-control)
...
* [針對自動化帳戶使用客戶管理的金鑰](https://docs.microsoft.com/azure/automation/automation-secure-asset-encryption#use-of-customer-managed-keys-for-an-automation-account)

* [Azure 自動化中的 Managed 變數](https://docs.microsoft.com/azure/automation/shared-resources/variables)
...
* [適用於網路安全性群組的診斷記錄](https://docs.microsoft.com/azure/private-link/private-link-overview#logging-and-monitoring)
...
* [Azure 資訊安全中心的安全性建議](https://docs.microsoft.com/azure/security-center/security-center-recommendations)

* [資訊安全中心建議參考](https://docs.microsoft.com/azure/security-center/recommendations-reference)
...
* [Azure 中的更新管理](https://docs.microsoft.com/azure/automation/automation-update-management)
...
* [Azure 自動化的 Azure 原則內建範例](https://docs.microsoft.com/azure/automation/policy-samples)
...
* [管理 Azure 自動化中的模組](https://docs.microsoft.com/azure/automation/shared-resources/modules)
...
* [Azure 防火牆總覽](https://docs.microsoft.com/azure/firewall/overview)

* [Azure Web 應用程式防火牆總覽](https://docs.microsoft.com/azure/web-application-firewall/overview)
...
* [使用原始檔控制整合](https://docs.microsoft.com/azure/automation/source-control-integration)

* [建立 Azure Resource Manager 範本的資訊](https://docs.microsoft.com/azure/azure-resource-manager/templates/quickstart-create-templates-use-the-portal)

* [如何設定和管理 Azure 原則](https://docs.microsoft.com/azure/governance/policy/tutorials/create-and-manage)

* [了解 Azure 原則效果](https://docs.microsoft.com/azure/governance/policy/concepts/effects)

* [使用 Azure Resource Manager 範本部署自動化帳戶](https://docs.microsoft.com/azure/automation/automation-create-account-template#deploy-the-template)
...
* [如何設定認證掃描器](https://secdevtools.azurewebsites.net/helpcredscan.htm)
...
* [Azure 自動化資源的 Azure Resource Manager 範本參考](https://docs.microsoft.com/azure/templates/microsoft.automation/allversions)

* [使用 Azure Resource Manager 範本建立自動化帳戶](https://docs.microsoft.com/azure/automation/automation-create-account-template)
...
* [適用于自動化帳戶的 Azure 資料備份](https://docs.microsoft.com/azure/automation/automation-managing-data#data-backup)
