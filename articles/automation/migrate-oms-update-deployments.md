...
* 您在 OMS 中現有的所有功能也都存在於 Azure 中。 若要深入了解更新管理，請參閱[更新管理概觀](./update-management/overview.md)。
...
若要深入了解 Azure 自動化中的更新管理，請參閱[更新管理概觀](./update-management/overview.md)。