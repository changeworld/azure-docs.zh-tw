...
1. 捲動回到右側，檢視 [MyFirstRunbook-Python]**** 的窗格。
   頂部的選項允許我們啟動 Runbook、查看 Runbook 或計畫它在未來某個時間啟動。
...
您還可以使用以下約定從 Python runbook 檢索各種流，包括**警告**、**錯誤**和**DEBUG**流。
...
- 要瞭解如何使用 Python 為 Azure 開發，請參閱[Python 開發人員的 Azure](/azure/python/)
- 要查看示例 Python 2 手冊，請參閱[Azure 自動化 GitHub](https://github.com/azureautomation/runbooks/tree/master/Utility/Python)
