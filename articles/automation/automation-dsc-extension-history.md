...
- **環境**
  ...
  - Azure 中國
  - Azure Government
- **備註：** 此版本會使用 Windows Server 2016 內附的 DSC；針對其他 Windows OS，則會安裝 [Windows Management Framework 5.1](https://devblogs.microsoft.com/powershell/wmf-5-1-releasing-january-2017/) (安裝 WMF 需要重新開機)。 針對 Nano 伺服器，DSC 角色會安裝到 VM 上。
- **新功能：**
...
> [!WARNING]
> 版本2.4 至2.13 使用 WMF 5.0 公開預覽，其簽署憑證于8月到期
...
- **環境：** Azure
- **備註：** 此版本會使用 Windows Server 2016 內附的 DSC；針對其他 Windows OS，則會安裝 [Windows Management Framework 5.0 RTM](https://devblogs.microsoft.com/powershell/windows-management-framework-wmf-5-0-rtm-is-now-available-via-the-microsoft-update-catalog/) (安裝 WMF 需要重新開機)。 針對 Nano 伺服器，DSC 角色會安裝到 VM 上。
- **新功能：**
...
- **WMF 支援：** WMF 5.1 Preview、WMF 5.0 RTM、WMF 4.0 Update、WMF 4.0
- **環境：** Azure
- **備註：** 此版本會使用 Windows Server 2016 Technical Preview 內附的 DSC；針對其他 Windows OS，則會安裝 [Windows Management Framework 5.0 RTM](https://devblogs.microsoft.com/powershell/windows-management-framework-wmf-5-0-rtm-is-now-available-via-the-microsoft-update-catalog/) (安裝 WMF 需要重新開機)。
- **新功能：**
  - WMF 5.1 Preview 的支援。 在首次發佈時，此版本是選用升級，且您必須在資源管理員範本中指定 Wmfversion = '5.1PP' 才能安裝 WMF 5.1 Preview。
    Wmfversion = ' 最新的版本仍會安裝[WMF 5.0 RTM](https://devblogs.microsoft.com/powershell/windows-management-framework-wmf-5-0-rtm-is-now-available-via-the-microsoft-update-catalog/)。
