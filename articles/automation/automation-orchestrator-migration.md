...
移轉的第一個步驟是下載 [System Center Orchestrator 移轉工具組](https://www.microsoft.com/download/details.aspx?id=47323&WT.mc_id=rss_alldownloads_all)。 此工具組包含的工具可協助您將 Runbook 從 Orchestrator 轉換成 Azure 自動化。  
