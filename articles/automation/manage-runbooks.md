...
在所選自動化帳戶的右邊，您可以在 [**作業統計資料]** 圖格底下看到所有 runbook 作業的摘要。 Azure 自動化中工作處理的詳細資料會在[Azure 自動化的 Runbook 執行](automation-runbook-execution.md#jobs)中提供。
...
* 若要深入瞭解 runbook 的執行，請參閱[Azure 自動化中的 runbook 執行](automation-runbook-execution.md)。
