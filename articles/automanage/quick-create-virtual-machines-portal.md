...
> [!IMPORTANT]
> 您必須在包含 VM 的資源群組中具有 **參與者** 角色，才能使用現有的 Automanage 帳戶來啟用 Automanage。 如果您要使用新的 Automanage 帳戶來啟用 Automanage，則需要下列權限：您訂用帳戶中的 **擁有者** 角色或 **參與者** 以及 **使用者存取管理員** 角色。
