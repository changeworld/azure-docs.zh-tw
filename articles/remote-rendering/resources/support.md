---
title: Azure 遠端轉譯支援選項
description: 列出如何取得 Azure 遠端轉譯支援的方法
author: jakrams
ms.author: jakras
ms.date: 04/22/2020
...
若要在 Azure 遠端轉譯的 Azure 入口網站中開啟技術支援票證：

1. 開啟 [Azure 入口網站](https://ms.portal.azure.com)

1. 從功能表列選取問號圖示，然後按一下 [說明 **+ 支援**]。

    ![Azure 入口網站說明和支援](media/portal-help.png)
...
如需使用者群體的支援，請參閱 [Stack Overflow 上的 Azure 遠端轉譯](https://stackoverflow.com/questions/tagged/azure-remote-rendering)。

## <a name="provide-documentation-feedback"></a>提供檔意見反應

您可以在每個檔文章的底部開啟 GitHub 問題，以提供該頁面的意見反應。

## <a name="provide-product-feedback"></a>提供產品意見反應

若要提供意見反應、分享 Azure 遠端轉譯的想法或建議，或針對他人提交的想法進行投票，請造訪 [Azure 遠端轉譯意見反應論壇](https://feedback.azure.com/forums/928696-azure-remote-rendering)。
