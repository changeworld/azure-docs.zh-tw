...
1. 建立名為 **RemoteRaycaster** 的新指令碼，並以下列程式碼取代其內容：
    ...
    > [!NOTE]
    > Unity 具有名為 [**RaycastHit**](https://docs.unity3d.com/ScriptReference/RaycastHit.html) 的類別，而 Azure 遠端轉譯具有名為 [**RayCastHit**](/dotnet/api/microsoft.azure.remoterendering.raycasthit) 的類別。 大寫 **C** 是避免編譯錯誤的重要差異。
