...
* [C # HierarchicalStateOverrideComponent 類別](/dotnet/api/microsoft.azure.remoterendering.hierarchicalstateoverridecomponent)
* [C + + HierarchicalStateOverrideComponent 類別](/cpp/api/remote-rendering/hierarchicalstateoverridecomponent)
