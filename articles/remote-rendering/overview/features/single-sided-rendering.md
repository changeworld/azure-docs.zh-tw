...
* [C # RemoteManager. SingleSidedSettings 屬性](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.remotemanager.singlesidedsettings)
