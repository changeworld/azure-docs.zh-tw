---
title: 重新開機伺服器 - Azure CLI - MariaDB 的 Azure 資料庫
description: 本文介紹如何使用 Azure CLI 重新開機 MariaDB 伺服器的 Azure 資料庫。
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
ms.locfileid: "79530643"
---
# <a name="restart-azure-database-for-mariadb-server-using-the-azure-cli"></a>使用 Azure CLI 重新開機 MariaDB 伺服器的 Azure 資料庫
...
瞭解如何[在 MariaDB 的 Azure 資料庫中設置參數](howto-configure-server-parameters-cli.md)