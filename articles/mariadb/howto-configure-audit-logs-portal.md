---
title: 訪問稽核記錄 - Azure 門戶 - MariaDB 的 Azure 資料庫
description: 本文介紹如何從 Azure 門戶配置和訪問 MariaDB Azure 資料庫中的稽核記錄。
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
ms.locfileid: "79528926"
---
# <a name="configure-and-access-audit-logs-in-the-azure-portal"></a>在 Azure 門戶中配置和訪問稽核記錄

可以從 Azure 門戶[為 MariaDB 稽核記錄](concepts-audit-logs.md)和診斷設置配置 Azure 資料庫。
...
- 詳細瞭解 MariaDB Azure 資料庫中的[稽核記錄](concepts-audit-logs.md)。