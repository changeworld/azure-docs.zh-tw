...
如需教學課程，其中包含使用 Azure 通知中樞和 Google Firebase 雲端通訊將通知傳送至 Android 裝置的逐步指示，請參閱[使用通知中樞和 GOOGLE FCM 將推播通知傳送至 android 裝置](notification-hubs-android-push-notification-google-fcm-get-started.md)。
