---
title: 透過後端服務使用 Azure 通知中樞將推播通知傳送至 React Native 應用程式 | Microsoft Docs
description: 了解如何將通知推送至透過後端服務使用 Azure 通知中樞的 React Native 應用程式。
author: alexeystrakh
...
ms.locfileid: "86060417"
---
# <a name="tutorial-send-push-notifications-to-react-native-apps-using-azure-notification-hubs-via-a-backend-service"></a>教學課程：透過後端服務使用 Azure 通知中樞將推播通知傳送至 React Native 應用程式  

[![下載範例](./media/notification-hubs-backend-service-react-native/download.png) 下載範例](https://github.com/xamcat/mobcat-samples/tree/master/notification_hub_backend_service)  
...
在本教學課程中，您將使用 [Azure 通知中樞](https://docs.microsoft.com/azure/notification-hubs/notification-hubs-push-notification-overview)將通知推送至以 **Android** 和 **iOS** 為目標的 [React Native](https://reactnative.dev/) 應用程式。  
...
> * [建立跨平台的 React Native 應用程式。](#create-a-cross-platform-react-native-application)
...
* [Microsoft Azure](https://portal.azure.com) 和[使用 Azure 通知中樞將推播通知傳送至 iOS 應用程式](ios-sdk-get-started.md)。
* [React Native](https://reactnative.dev/docs/getting-started)。

提供的步驟適用於 [Visual Studio for Mac](https://visualstudio.microsoft.com/vs/mac/) 和 [Visual Studio Code](https://code.visualstudio.com/download)，但可以使用 [Visual Studio 2019](https://visualstudio.microsoft.com/vs) 來繼續。
...
在本節中，您會建立 [ASP.NET Core Web API](https://dotnet.microsoft.com/apps/aspnet/apis) 後端，以處理[裝置註冊](https://docs.microsoft.com/azure/notification-hubs/notification-hubs-push-notification-registration-management#what-is-device-registration)並將通知傳送至 React Native 行動應用程式。

[!INCLUDE [Create an ASP.NET Core Web API backend application](../../includes/notification-hubs-backend-service-web-api.md)]

## <a name="create-a-cross-platform-react-native-application"></a>建立跨平台的 React Native 應用程式

在本節中，您會建立以跨平台方式執行推播通知的 [React Native](https://reactnative.dev/) 行動應用程式。
...
您現在應該已有基本的 React Native 應用程式，可透過後端服務連線到通知中樞，並且可以傳送和接收通知。
...
* [設定 React Native 開發環境](https://reactnative.dev/docs/environment-setup)
