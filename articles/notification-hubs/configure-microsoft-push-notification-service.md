...
---
# <a name="configure-microsoft-push-notification-service-mpns-settings-in-the-azure-portal"></a>設定 Azure 入口網站中 Microsoft 推播通知服務 (MPNS) 設定

本文說明如何使用 Azure 入口網站設定 Azure 通知中樞的 Microsoft 推播通知服務 (MPNS) 設定。
...
下列程式說明如何設定通知中樞的 Microsoft 推播通知服務 (MPNS) 設定：
...
如需使用 Azure 通知中樞將通知推送至 Windows Phone 裝置，並 Microsoft 推播通知服務 (MPNS) 的逐步解說教學課程，請參閱 [使用通知中樞將推播通知傳送至 Windows Phone 應用程式](notification-hubs-windows-mobile-push-notifications-mpns.md)。
