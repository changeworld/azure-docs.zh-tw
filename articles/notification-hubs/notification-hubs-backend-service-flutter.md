---
title: 透過後端服務使用 Azure 通知中樞將推播通知傳送至 Flutter 應用程式 | Microsoft Docs
description: 了解如何將通知推送至透過後端服務使用 Azure 通知中樞的 Flutter 應用程式。
...
ms.locfileid: "86171001"
---
# <a name="tutorial-send-push-notifications-to-flutter-apps-using-azure-notification-hubs-via-a-backend-service"></a>教學課程：透過後端服務使用 Azure 通知中樞將推播通知傳送至 Flutter 應用程式  

[![下載範例](./media/notification-hubs-backend-service-flutter/download.png) 下載範例](https://github.com/xamcat/mobcat-samples/tree/master/notification_hub_backend_service)  
...
在本教學課程中，您將使用 [Azure 通知中樞](https://docs.microsoft.com/azure/notification-hubs/notification-hubs-push-notification-overview)將通知推送至以 **Android** 和 **iOS** 為目標的 [Flutter](https://flutter.dev) 應用程式。  
...
> * [建立跨平台的 Flutter 應用程式。](#create-a-cross-platform-flutter-application)
...
* [Flutter](https://flutter.dev/docs/get-started/install) 工具組 (連同其必要條件)。
* 已安裝 [Flutter 和 Dart 外掛程式](https://flutter.dev/docs/get-started/editor?tab=vscode)的 [Visual Studio Code](https://code.visualstudio.com)。
...
* 已安裝 [CocoaPods](https://guides.cocoapods.org/using/getting-started.html#installation) 來管理程式庫相依性。
...
* 適用於跨平台開發的 [Flutter](https://flutter.dev) 和 [Dart](https://dart.dev)
* 適用於 Android 和 iOS 原生開發的 [Kotlin](https://kotlinlang.org) 和 [Swift](https://developer.apple.com/swift)

所提供的是 [macOS](https://developer.apple.com/macos) 專屬步驟。 藉由略過 **iOS** 方面的步驟，即可在 [Windows](https://www.microsoft.com/windows) 上遵循。
...
在本節中，您會建立 [ASP.NET Core Web API](https://dotnet.microsoft.com/apps/aspnet/apis) 後端，以處理[裝置註冊](https://docs.microsoft.com/azure/notification-hubs/notification-hubs-push-notification-registration-management#what-is-device-registration)並將通知傳送至 Flutter 行動應用程式。

[!INCLUDE [Create an ASP.NET Core Web API backend application](../../includes/notification-hubs-backend-service-web-api.md)]

## <a name="create-a-cross-platform-flutter-application"></a>建立跨平台的 Flutter 應用程式

在本節中，您會建立以跨平台方式執行推播通知的 [Flutter](https://flutter.dev) 行動應用程式。
...
您現在應該已有基本的 Flutter 應用程式，可透過後端服務連線到通知中樞，並且可以傳送和接收通知。
...
* [在 macOS 上安裝 Flutter](https://flutter.dev/docs/get-started/install/macos)
* [在 Windows 上安裝 Flutter](https://flutter.dev/docs/get-started/install/windows)
