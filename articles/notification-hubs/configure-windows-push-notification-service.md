...
如需使用 Azure 通知中樞將推播通知傳送至通用 Windows 平臺應用程式，並 Windows 推播通知服務 (WNS) 的逐步解說教學課程，請參閱 [使用 Azure 通知中樞將通知傳送至 UWP 應用](notification-hubs-windows-store-dotnet-get-started-wns-push-notification.md)程式。
