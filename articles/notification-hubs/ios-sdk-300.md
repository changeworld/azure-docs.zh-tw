...
5. 新增 Azure 通知中樞 SDK 模組。
   ...
   - 透過將二進位檔複製到您的專案來進行整合：
      ...
      您可以藉由將二進位檔複製到專案中來進行整合，如下所示：
        ...
        - 下載以 zip 檔案形式提供的  [Azure 通知中樞 SDK](https://github.com/Azure/azure-notificationhubs-iOS/releases/)  架構，然後將其解壓縮。
...
10. 在專案 **AppDelegate.h** 檔案中，新增下列 `import` 陳述式：
