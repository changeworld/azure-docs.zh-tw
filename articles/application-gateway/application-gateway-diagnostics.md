...
根據預設，Azure 會產生活動記錄。 記錄會在 Azure 的事件記錄存放區中保留 90 天。 若要深入瞭解這些記錄，請參閱 [View events and 活動記錄](../monitoring-and-diagnostics/insights-debugging-with-events.md) 文章。
...
|主機| 要求的主機標頭中所列的位址。 如果重寫，此欄位包含更新的主機名稱|
