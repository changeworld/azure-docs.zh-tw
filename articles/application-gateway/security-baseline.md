...
* [瞭解搭配 Azure 應用程式閘道使用 Nsg 的限制和需求](./configuration-overview.md)
...
* [Azure 應用程式閘道的診斷和記錄常見問題](./application-gateway-faq.yml#what-types-of-logs-does-application-gateway-provide)
...
* [瞭解 Azure 應用程式閘道功能](./features.md)

* [瞭解 Azure WAF](../web-application-firewall/ag/ag-overview.md)
...
* [如何部署應用程式閘道](./quick-create-portal.md)

* [如何將應用程式閘道設定為使用 HTTPS](./create-ssl-portal.md)

* [瞭解 Azure web 應用程式閘道的第7層負載平衡](./overview.md)
...
* [Azure 應用程式閘道設定總覽](./configuration-overview.md)
...
* [如何啟用 Azure 應用程式閘道的診斷設定](./application-gateway-diagnostics.md)

* [如何啟用 Application Insights](../azure-monitor/app/app-insights-overview.md)

* [如何設定連續匯出](../azure-monitor/app/export-telemetry.md)
...
* [如何使用網路的 Azure 監視器](../azure-monitor/insights/network-insights-overview.md)
...
* [如何設定 Azure WAF 的診斷設定](./application-gateway-diagnostics.md)
...
* [如何使用 Azure 應用程式閘道設定端對端 TLS](./end-to-end-ssl-portal.md)
...
* [功能涵蓋範圍 (包括 Azure PaaS 服務的弱點評定) ](../security-center/features-paas.md)
...
* [如何使用 Azure PowerShell 以 Key Vault 憑證設定 SSL 終止](./configure-keyvault-ps.md)
...
* [瞭解 Azure 管理的 WAF 規則集](../web-application-firewall/ag/ag-overview.md#waf-policy-and-rules)
...
* [如何在 Azure 中備份金鑰保存庫憑證](/powershell/module/azurerm.keyvault/backup-azurekeyvaultcertificate)
...
* [如何還原金鑰保存庫憑證](/powershell/module/azurerm.keyvault/restore-azurekeyvaultcertificate)
