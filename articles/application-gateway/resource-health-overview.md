...
若要瞭解如何對應用程式閘道 Web 應用程式防火牆進行疑難排解 (WAF) ，請參閱 [Azure 應用程式閘道疑難排解 Web 應用程式防火牆 (WAF) ](../web-application-firewall/ag/web-application-firewall-troubleshoot.md)。