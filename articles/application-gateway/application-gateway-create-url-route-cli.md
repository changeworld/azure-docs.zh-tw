---
title: 使用 CLI - Azure 應用程式閘道基於 URL 路徑的路由規則
...
將 URL`http://<ip-address>:8080/video/test.html`更改為基本 URL 的末尾，您應該看到類似以下示例的內容：

![在應用程式閘道中測試影像 URL](./media/application-gateway-create-url-route-cli/application-gateway-nginx-images.png)

將 URL`http://<ip-address>:8080/video/test.html`更改為，您應該會看到類似下面的示例。
