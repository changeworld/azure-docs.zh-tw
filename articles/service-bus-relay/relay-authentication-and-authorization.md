...
description: 本文概述了使用 Azure 中繼服務的共用訪問簽名 （SAS） 身份驗證。
...
您可以在轉送命名空間上設定 SAS 的金鑰。 不同於服務匯流排傳訊，[轉送混合式連線](relay-hybrid-connections-protocol.md)支援未經授權或匿名的寄件者。 您可以在創建實體時啟用對實體的匿名存取，如門戶中的以下螢幕截圖所示：
