...
在上圖中，會根據來描述 lambda 架構的基本原則[http://lambda-architecture.net](http://lambda-architecture.net/)。
...
如需完整的程式碼範例，請參閱[azure cosmosdb-spark/lambda/範例](https://github.com/Azure/azure-cosmosdb-spark/tree/master/samples/lambda)，包括：
...
* Lambda 架構重新架構-提供層[HTML](https://github.com/Azure/azure-cosmosdb-spark/blob/master/samples/lambda/Lambda%20Architecture%20Re-architected%20-%20Batch%20to%20Serving%20Layer.html) | [ipynb](https://github.com/Azure/azure-cosmosdb-spark/blob/master/samples/lambda/Lambda%20Architecture%20Re-architected%20-%20Batch%20to%20Serving%20Layer.ipynb)的批次
...
* [Lambda 架構](https://github.com/Azure/azure-cosmosdb-spark/tree/master/samples/lambda)
* [分散式匯總範例](https://github.com/Azure/azure-documentdb-spark/wiki/Aggregations-Examples)
...
您可能也會想要參閱[APACHE SPARK SQL、資料框架和資料集指南](https://spark.apache.org/docs/latest/sql-programming-guide.html)，以及[Azure HDInsight 文章上的 Apache Spark](../hdinsight/spark/apache-spark-jupyter-spark-sql.md) 。
