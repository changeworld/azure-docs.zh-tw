...
7. 如果是第一次連接到此端點，系統會提示您提供帳戶金鑰。 如果是您自己的帳戶，請從 Azure 入口網站 [  方塊中擷取金鑰。 輸入適當的金鑰，然後按一下 [連接]  。
...
:::image type="content" source="./media/powerbi-visualize/power_bi_connector_pbireportview2.png" alt-text="Power BI Desktop 報告檢視 - Power BI 連接器":::
...
當您從 Power BI Desktop發佈報告至 PowerBI.com 時，在您的 PowerBI.com 租用戶中會產生 [報表]  和 [資料集]  。 例如，您將名為  和 [資料集]  區段看到 PowerBITutorial。
