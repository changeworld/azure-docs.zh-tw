---
title: Azure Cosmos DB 查詢語言中的字串函數
description: 瞭解 Azure Cosmos DB 中的字串 SQL 系統函數。
author: ginamr
...
||||  
|-|-|-|  
|[CONCAT](sql-query-concat.md)|[包含](sql-query-contains.md)|[ENDSWITH](sql-query-endswith.md)|  
