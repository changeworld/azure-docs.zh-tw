...
### <a name="high-network-latency"></a>高網路延遲
...
如果沒有任何[超時](#request-timeouts)，而且診斷顯示單一要求，其中的高延遲會明顯影響 `ResponseTime` 和 `RequestStartTime`之間的差異，如下所示（在此範例中為 > 300 毫秒）：
...
### <a name="request-rate-too-large"></a>要求速率太大
