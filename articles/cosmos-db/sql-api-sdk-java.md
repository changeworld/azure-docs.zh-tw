...
> [!WARNING]
> 30 2020 月30日之後，Azure Cosmos DB 將不會再進行錯誤修正、新增功能，以及提供1.x 版的 Azure Cosmos DB JAVA SDK for SQL API 支援。 如果您不想升級，從 1.x 版 SDK 傳送的要求將會繼續由 Azure Cosmos DB 服務提供服務。
>
