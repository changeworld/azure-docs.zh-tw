...
ms.locfileid: "85262815"
---
# <a name="azure-cosmos-db-as-a-key-value-store--cost-overview"></a>Azure Cosmos DB 做為金鑰值存放區–成本總覽

Azure Cosmos DB 是全域散發的多模型資料庫服務，可用來輕鬆建置具高可用性的大規模應用程式。 依預設，Azure Cosmos DB 會自動並有效率地編制其內嵌的所有資料索引。 這可讓您快速且一致地對資料進行 [SQL](how-to-sql-query.md) (和 [JavaScript](stored-procedures-triggers-udfs.md)) 查詢。 
