---
title: Azure Cosmos DB 查詢語言中的空間函數
description: 深入瞭解 Azure Cosmos DB 中的空間 SQL 系統函數。
author: ginamr
...
ms.locfileid: "71349447"
---
# <a name="spatial-functions-azure-cosmos-db"></a>空間函數（Azure Cosmos DB）
