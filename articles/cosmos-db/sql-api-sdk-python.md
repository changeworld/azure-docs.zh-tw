...
> * [同步處理 Java SDK v2](sql-api-sdk-java.md)
...
* 錯誤階層現在繼承自 `azure.core.AzureError`，已移除。
...
> [!WARNING]
> 所有 **1.0.0** 版之前的 Python SDK for SQL API 版本都於 **2016 年 2 月 29 日**淘汰。 而且，所有 1.x 版和 2.x 版的 Python SDK for SQL API 將於 **2020 年 8 月 30 日**淘汰。
