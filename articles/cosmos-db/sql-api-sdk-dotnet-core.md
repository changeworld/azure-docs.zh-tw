---
title: Azure 宇宙資料庫：SQL .NET 核心 API、SDK &資源
...
|**API 文檔**|[.NET API 參考文件](/dotnet/api/overview/azure/cosmosdb?view=azure-dotnet)|
|**樣品**|[.NET 代碼示例](sql-api-dotnet-samples.md)|
|**開始使用**|[開始使用 Azure 宇宙 DB .NET](sql-api-sdk-dotnet.md)|
...
> [!NOTE]
> 如果您使用的是 .NET Core，請參閱[.NET SDK](sql-api-sdk-dotnet-standard.md)的最新版本 3.x，該版本針對 .NET 標準。 
