---
title: Azure Cosmos DB：SQL .NET Standard API、SDK 和資源
description: 全面了解 SQL API 和 .NET SDK，包括發行日期、停用日期，以及 Azure Cosmos DB .NET SDK 每個版本之間所做的變更。
author: anfeldma-ms
...
ms.locfileid: "83660410"
---
# <a name="azure-cosmos-db-net-standard-sdk-for-sql-api-download-and-release-notes"></a>適用於 SQL API 的 Azure Cosmos DB .NET Standard SDK：下載和版本資訊
