...
1. **連線模式：使用 DirectHttps**
   ...
   2. [DirectHttps](https://docs.microsoft.com/java/api/com.microsoft.azure.documentdb.connectionmode)
    ...
    ### <a name="sync-java-sdk-v2-maven-commicrosoftazureazure-documentdb"></a><a id="syncjava2-connectionpolicy"></a>同步 Java SDK V2 (Maven com.microsoft.azure::azure-documentdb)
      ...
      :::image type="content" source="./media/performance-tips-java/connection-policy.png" alt-text="Azure Cosmos DB 連接原則的圖例" border="false":::
