...
description: 瞭解如何將 Azure Cosmos DB 圖形資料與視覺效果解決方案整合 (Linkurious Enterprise、康橋情報) 。
author: SnehaGunda
ms.author: sngun
...
您可以使用各種資料視覺效果解決方案，將 Azure Cosmos DB Gremlin API 中儲存的資料視覺化。 適用于圖形資料視覺效果的 [Apache Tinkerpop 群體](https://tinkerpop.apache.org/#poweredby) 建議使用下列解決方案。
...
[Linkurious Enterprise](https://linkurio.us/product/) 使用圖形技術和資料視覺效果，將複雜的資料集轉換成互動式的視覺網路。 平臺會連接到您的資料來源，並讓調查人員順暢地流覽數十億個實體和關聯性。 結果是一種新的功能，可偵測可疑的關聯性，而不需以使用查詢或資料表。
...
- [重新圖形技術總覽](https://cambridge-intelligence.com/regraph/technology/)
