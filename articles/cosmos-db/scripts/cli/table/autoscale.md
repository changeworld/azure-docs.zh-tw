---
title: 建立具自動調整功能的 Azure Cosmos DB 資料表 API 資料表
description: 建立具有自動調整功能的 Azure Cosmos DB 資料表 API 資料表
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "94566175"
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-with-autoscale-using-azure-cli"></a>使用 Azure CLI 建立具有自動調整功能的 Azure Cosmos 資料表 API 帳戶和資料表
