---
title: 針對 Azure Cosmos DB，建立具有自動調整功能的 Gremlin 資料庫和圖形
description: 針對 Azure Cosmos DB，建立具有自動調整功能的 Gremlin 資料庫和圖形
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "93096184"
---
# <a name="create-an-azure-cosmos-gremlin-api-account-database-and-graph-with-autoscale-using-azure-cli"></a>使用 Azure CLI，建立具有自動調整功能的 Azure Cosmos Gremlin API 帳戶、資料庫和圖表
