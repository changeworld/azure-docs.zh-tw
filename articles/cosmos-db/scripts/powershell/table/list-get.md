...
| [Get-AzCosmosDBTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbtable) | 列出帳戶中資料表 API 的資料表，或在帳戶中取得指定資料表 API 的資料表。 |
|**Azure 資源群組**| |
