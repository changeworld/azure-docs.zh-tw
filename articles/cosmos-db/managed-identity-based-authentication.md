...
您將使用[Microsoft.Azure.Services.App 身份驗證](https://www.nuget.org/packages/Microsoft.Azure.Services.AppAuthentication)庫來獲取系統分配的託管標識權杖。 要瞭解獲取權杖的其他方法以及有關`Microsoft.Azure.Service.AppAuthentication`庫的詳細資訊,請參閱[服務到服務身份驗證](../key-vault/general/service-to-service-authentication.md)一文。
