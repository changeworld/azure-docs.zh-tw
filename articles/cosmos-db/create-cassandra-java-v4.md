---
title: Java 應用程式與使用 Java 4.0 SDK 的 Azure Cosmos DB Cassandra API
description: 本快速入門示範如何使用 Azure Cosmos DB Cassandra API，以使用 Azure 入口網站和 Java 4.0 SDK 建立設定檔應用程式。
