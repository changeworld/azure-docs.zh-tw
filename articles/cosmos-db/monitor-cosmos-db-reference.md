...
Azure Cosmos DB 使用 Azure 監視器記錄檔中的 Kusto 資料表。 您可以使用 Log analytics 查詢這些資料表。 如需 Kusto bales 使用的清單，請參閱 [Azure 監視器記錄資料表參考](/azure-monitor/reference/tables/tables-resourcetype#azure-cosmos-db) 文章。
