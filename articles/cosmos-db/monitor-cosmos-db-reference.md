...
|度量 (計量顯示名稱) |單位 (匯總類型)  |Description|維度| 時間資料粒度| 舊版計量對應 | 使用方式 |
|---|---|---|---| ---| ---| ---|
...
|度量 (計量顯示名稱) |單位 (匯總類型) |Description|維度| 時間資料粒度| 使用方式 |
|---|---|---|---| ---| ---|
...
|度量 (計量顯示名稱)  |單位 (匯總類型) |Description| 時間資料粒度| 舊版計量對應 | 使用方式 |
|---|---|---|---| ---| ---|
