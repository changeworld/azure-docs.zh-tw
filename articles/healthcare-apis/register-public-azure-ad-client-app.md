...
本快速入門提供有關如何 [使用 Microsoft 身分識別平臺來註冊應用程式](../active-directory/develop/quickstart-register-app.md)的一般資訊。
...
若要將您的 [桌面](../active-directory/develop/scenario-desktop-app-registration.md) [、行動](../active-directory/develop/scenario-mobile-app-registration.md) 或 [單一頁面](../active-directory/develop/scenario-spa-app-registration.md) 應用程式設定為公用應用程式：
