...
- [為您的 Azure 訂用帳戶註冊 Azure Cosmos DB 資源提供者](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#register-resource-provider) 
- [設定您的 AKV 執行個體](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#configure-your-azure-key-vault-instance)
-  [將存取原則新增至您的 AKV 執行個體](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#add-an-access-policy-to-your-azure-key-vault-instance)
- [在 AKV 中產生金鑰](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#generate-a-key-in-azure-key-vault)
...
:::image type="content" source="media/bring-your-own-key/bring-your-own-key-keypicker.png" alt-text="建立 Azure API for FHIR":::

對於現有的 FHIR 帳戶，您可以在 [資料庫] 刀鋒視窗中檢視金鑰加密選擇 (服務代控或客戶自控金鑰)，如下所示。 選擇後，便無法修改設定選項。 不過，您可以修改和更新金鑰。

:::image type="content" source="media/bring-your-own-key/bring-your-own-key-database.png" alt-text="建立 Azure API for FHIR":::
