---
title: 向 UWP 應用添加身份驗證
description: 瞭解如何使用 Azure 應用服務移動應用使用 AAD、Google、Facebook、Twitter 和 Microsoft 等身份供應商對通用 Windows 平臺 （UWP） 應用的使用者進行身份驗證。
...
## <a name="store-the-authentication-token-on-the-client"></a><a name="tokens"></a>將驗證權杖儲存在用戶端上
