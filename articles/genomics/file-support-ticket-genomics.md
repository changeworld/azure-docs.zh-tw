...
description: 本文介紹，如果您無法使用故障排除指南或常見問題解答解決問題，如何提交支援請求以聯繫 Microsoft 基因組學。
...
本概觀說明如何提出支援要求以連絡 Microsoft Genomics。 如果您無法使用[故障排除指南](troubleshooting-guide-genomics.md)或[常見問題解答](frequently-asked-questions-genomics.md)來解決問題，這非常有用。 
...
![在 Azure 門戶上聯繫支援人員](./media/file-support-ticket/genomics-contact-support.png "在 Azure 門戶上聯繫支援人員") 



然後，選取 `New support request`。 

![新的支援請求](./media/file-support-ticket/new-support-request.png "新增支援要求") 
...
![支援請求基礎知識](./media/file-support-ticket/support-request-basics.png "支援請求基礎知識")


接下來，新增有關您問題的詳細資料。 要求工具也會連結到可能有助於您的現有實用文件。 在此範例中，問題與 `Genomics keys` 有關，但也提供數個其他選項。

![支援請求問題](./media/file-support-ticket/support-request-problem.png "支援請求問題")

最後，新增您的連絡資訊，然後選取畫面底部的 `Create` 以提交支援要求。

![支援請求連絡人](./media/file-support-ticket/support-request-contact.png "支援請求連絡人")
