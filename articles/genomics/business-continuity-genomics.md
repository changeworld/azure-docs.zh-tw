...
如果發生區域資料中心中斷，您可以根據個別的資料主權和商務持續性需求，選擇在次要地區中提交 Microsoft Genomics 工作流程。 若要手動容錯移轉 Microsoft Genomics 工作流程，您要使用不同的區域專屬  Genomics 帳戶，並且使用適當的區域專屬 Genomics 和儲存體帳戶認證來提交作業。
