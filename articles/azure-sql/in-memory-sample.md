...
- [瞭解仲裁如何使重要資料庫的工作負載加倍，同時減少70% 與 Azure SQL Database 中記憶體內部 OLTP 的 DTU](https://customers.microsoft.com/story/quorum-doubles-key-databases-workload-while-lowering-dtu-with-sql-database)
