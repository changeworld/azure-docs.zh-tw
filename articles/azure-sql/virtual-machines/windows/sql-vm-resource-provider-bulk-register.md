...
- 用來註冊虛擬機器的用戶端認證存在於下列任何一個 RBAC 角色中：**虛擬機器參與者**、**參與者**，或 **擁有者**。 
...
## <a name="resister-all-vms-in-a-resource-group"></a>註冊所有資源群組中的 VM
...
## <a name="register-specific-vms-in-single-resource-group"></a>在單一資源群組中註冊特定 VM
