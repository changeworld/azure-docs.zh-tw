...
如需詳細資訊，請參閱 [使用 Azure Blob 儲存體 SQL Server 備份和還原](https://go.microsoft.com/fwlink/?LinkId=271617)。
...
> [!NOTE]
> SQL Server 2016 已更新為支援區塊 blob。 如需詳細資料，請參閱 [教學課程：使用 Microsoft Azure Blob 儲存體搭配 SQL Server 2016 資料庫](https://msdn.microsoft.com/library/dn466438.aspx) 。
> 
> 
...
3. 請參閱從 [SQL Server 備份和還原 Microsoft Azure Blob 儲存體](https://msdn.microsoft.com/library/jj919148.aspx)開始的其他檔。
