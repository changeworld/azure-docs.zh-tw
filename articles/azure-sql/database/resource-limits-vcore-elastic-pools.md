...
|IO 延遲 (大約)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|
|每集區<sup>2</sup>的最大資料 IOPS|5760|6400|7680|10240|11520|12800|
...
|虛擬核心|2|4|6|8|
|記憶體 (GB)|9|18|27|36|
|每個集區的資料庫數目上限 <sup>1</sup>|100|400|400|400|
|資料行存放區支援|是|是|是|是|
|OLTP 記憶體內部儲存體 (GB)|N/A|N/A|N/A|N/A|
|資料大小上限 (GB)|756|1536|2048|2048|
|記錄大小上限 (GB)|227|461|614|614|
|TempDB 資料大小上限 (GB) |64|128|192|256|
|儲存體類型|進階 (遠端) 儲存體|進階 (遠端) 儲存體|進階 (遠端) 儲存體|進階 (遠端) 儲存體|
|IO 延遲 (大約)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|5-7 毫秒 (寫入)<br>5-10 毫秒 (讀取)|
|每集區<sup>2</sup>的最大資料 IOPS|800|1600|2400|3200|
|每個集區的最大記錄速率 (MBps) |9.4|18.8|28.1|32.8|
|每個集區的並行背景工作數上限 (要求) <sup>3</sup>|168|336|504|672|
|每個集區的並行登入數上限 (要求) <sup>3</sup>|168|336|504|672|
|並行工作階段數上限|30,000|30,000|30,000|30,000|
|每個資料庫最小/最大彈性集區虛擬核心選項|2|2 ... 4|2 ... 6|2 ... 8|
|複本數目|1|1|1|1|
...
|虛擬核心|2|4|6|8|
|記憶體 (GB)|9|18|27|36|
|每個集區的資料庫數目上限 <sup>1</sup>|50|100|100|100|
|資料行存放區支援|是|是|是|是|
...
|每集區<sup>2</sup>的最大資料 IOPS|15750|31500|47250|56000|
|每個集區的最大記錄速率 (MBps) |20|60|90|120|
|每個集區的並行背景工作數上限 (要求) <sup>3</sup>|168|336|504|672|
|每個集區的並行登入數上限 (要求) <sup>3</sup>|168|336|504|672|
|並行工作階段數上限|30,000|30,000|30,000|30,000|
|每個資料庫最小/最大彈性集區虛擬核心選項|2|2 ... 4|2 ... 6|2 ... 8|
