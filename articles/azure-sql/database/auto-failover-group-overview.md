...
容錯移轉群組的許可權是透過[角色型存取控制 (RBAC) ](../../role-based-access-control/overview.md)進行管理。 [ [SQL Server 參與者](../../role-based-access-control/built-in-roles.md#sql-server-contributor)] 角色具有管理容錯移轉群組的所有必要許可權。
