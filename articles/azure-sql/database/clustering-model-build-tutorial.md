...
* 本教學課程的第二部分假設您已完成[**第一部分**](clustering-model-prepare-data-tutorial.md)及其必要條件。
...
![肘線圖](./media/clustering-model-build-tutorial/elbow-graph.png)
...
使用[第一部分](clustering-model-prepare-data-tutorial.md#separate-customers)中定義的變數以提供四種叢集平均值：
...
> [教學課程：使用 Azure SQL Database 機器學習服務 (預覽) 在 R 中部署群集模型](clustering-model-deploy-tutorial.md)
