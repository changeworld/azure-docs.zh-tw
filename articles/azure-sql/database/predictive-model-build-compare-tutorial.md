...
* 本教學課程的第二部分假設您已完成[**第一部分**](predictive-model-prepare-data-tutorial.md)及其必要條件。
...
![比較兩個模型](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [教學課程：使用 Azure SQL Database 機器學習服務 (預覽) 在 R 中部署預測模型](predictive-model-deploy-tutorial.md)
