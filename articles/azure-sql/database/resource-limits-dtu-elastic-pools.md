...
| 每個集區的記憶體內部 OLTP 儲存體上限 (GB) | N/A | 不適用 | N/A | 不適用 | N/A | 不適用 | N/A | 不適用 |
...
| 每個集區的記憶體內部 OLTP 儲存體上限 (GB) | 不適用 | N/A | 不適用 | N/A | 不適用 | 不適用 |
...
| 每個集區的記憶體內部 OLTP 儲存體上限 (GB) | 不適用 | 不適用 | 不適用 | 不適用 | N/A |
