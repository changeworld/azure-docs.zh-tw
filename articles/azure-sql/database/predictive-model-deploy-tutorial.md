...
在[第二部分](predictive-model-build-compare-tutorial.md)中，您已了解如何在 R 中建立及定型多個機器學習模型，然後選擇最精確的模型。

## <a name="prerequisites"></a>必要條件

* 本教學課程系列的第三部分假設您已完成[**第一部分**](predictive-model-prepare-data-tutorial.md)和[**第二部分**](predictive-model-build-compare-tutorial.md)。
