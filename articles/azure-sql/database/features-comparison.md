...
| [Polybase](/sql/relational-databases/polybase/polybase-guide) | 否。 您可以使用函數來查詢放在 Azure Blob 儲存體的檔案中的資料 `OPENROWSET` 。 | 否。 您可以使用函數來查詢放在 Azure Blob 儲存體的檔案中的資料 `OPENROWSET` 。 |
