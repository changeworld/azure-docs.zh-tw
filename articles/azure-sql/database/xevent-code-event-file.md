...
![準備好 PowerShell ISE 和安裝的 Azure 模組，以便執行指令碼。](./media/xevent-code-event-file/event-file-powershell-ise-b30.png)
...
> [!NOTE]
> 在上述的 PowerShell 程式碼範例中，SQL 擴充事件與 ADLS Gen2 儲存體帳戶不相容。
