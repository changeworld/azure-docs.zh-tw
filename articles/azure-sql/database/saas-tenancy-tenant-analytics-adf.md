...
![此圖顯示本教學課程中使用的星型結構描述。](./media/saas-tenancy-tenant-analytics-adf/starschematables.JPG)
...
在 [概觀] 頁面中，切換至左側面板的 [建立者] 索引標籤，並觀察有三個 [管線](../../data-factory/concepts-pipelines-activities.md) 和三個已建立的 [資料集](../../data-factory/concepts-datasets-linked-services.md)。
...
本教學課程著重在跨租用戶分析，用以改善軟體供應商對其租用戶的了解。 分析也可以為 _租用戶_ 提供深入見解，協助他們更有效地管理自己的業務。
