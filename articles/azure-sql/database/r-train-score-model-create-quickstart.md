...
![有其他輸出的定型模型](./media/r-train-score-model-create-quickstart/r-train-model-with-additional-output.png)
...
2. 從這些新的速度值，預測煞停距離。
   ...
   **結果**
   ...
   ![預測煞停距離的結果集](./media/r-train-score-model-create-quickstart/r-predict-stopping-distance-resultset.png)
