...
1. 在 [物件總管] 中，展開 [contosoconcethall] > [檢視]：
   ...
   ![螢幕擷取畫面顯示檢視節點的內容，包括場地 d b o 的四種類型。](./media/saas-tenancy-cross-tenant-reporting/views.png)
