...
類別 (category) 屬性會說明可偵測之效能模式的類別。 如需可偵測之效能模式的所有可能類別，請參閱下表。 如需詳細資訊，請參閱[使用 Intelligent Insights 針對資料庫效能問題進行疑難排解](intelligent-insights-troubleshoot-performance.md)。
...
- 瞭解如何 [使用 Azure SQL 分析來監視效能問題](../../azure-monitor/insights/azure-sql.md)。
