...
- **合併以縮減**
  ...
  容量因為業務的季節特性需要縮減。 當業務減緩時，此工具可讓您相應減少至較少的縮放單位。 彈性規模 Split-Merge 服務中的「合併」功能涵蓋了這項需求。
...
一般而言，更好的效能是來自更高、更高效能的服務層級。 越高的服務層級使用越高的 IO、CPU 和記憶體配置，有利於分割合併服務使用的大量複製和刪除作業。 基於這個理由，請只針對這些資料庫，在一段已定義的有限期間內增加服務層級。
