...
深入了解[單一資料庫 Azure CLI API](single-database-manage.md#azure-cli)。
...
深入了解 [SQL 受控執行個體 Azure CLI API](../managed-instance/api-references-create-manage-instance.md#azure-cli-create-and-manage-managed-instances)。
