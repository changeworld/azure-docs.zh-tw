...
為了讓服務主體設定或取消設定 Azure SQL 的 Azure AD 系統管理員，您需要額外的 API 權限。 [Directory.Read.All](/graph/permissions-reference#application-permissions-18) 應用程式 API 權限必須新增至您在 Azure AD 中的應用程式。
