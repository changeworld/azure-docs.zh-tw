...
下表標識了可用於成功規劃資料移轉並完成其各個階段的服務和工具。
...
| --- | --- | --- | --- | --- |
| SQL Server | Azure SQL DB | [對應工具組](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure 遷移](https://azure.microsoft.com/services/azure-migrate/)<br/>[Cloudamize*](https://www.cloudamize.com/) | [DMA](https://docs.microsoft.com/sql/dma/dma-overview?view=sql-server-2017)<br/>[雲端 Atlas*](https://www.unifycloud.com/cloud-migration-tool/)<br/>[Cloudamize*](https://www.cloudamize.com/) | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
 SQL Server | Azure SQL DB MI | [對應工具組](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure 遷移](https://azure.microsoft.com/services/azure-migrate/)<br/>[Cloudamize*](https://www.cloudamize.com/) | [DMA](https://docs.microsoft.com/sql/dma/dma-overview?view=sql-server-2017)<br/>[雲端 Atlas*](https://www.unifycloud.com/cloud-migration-tool/)<br/>[Cloudamize*](https://www.cloudamize.com/) | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
| SQL Server | Azure SQL VM | [對應工具組](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure 遷移](https://azure.microsoft.com/services/azure-migrate/)<br/>[Cloudamize*](https://www.cloudamize.com/) | [雲端 Atlas*](https://www.unifycloud.com/cloud-migration-tool/)<br/>[Cloudamize*](https://www.cloudamize.com/) | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
| SQL Server | SQL DW | [對應工具組](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure 遷移](https://azure.microsoft.com/services/azure-migrate/)<br/>[Cloudamize*](https://www.cloudamize.com/) |  | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
...
| Oracle | Azure SQL DB、MI、VM | [對應工具組](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[MigVisor*](https://www.migvisor.com/) |  |
| Oracle | SQL DW | [對應工具組](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) |  |
| Oracle | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 | [對應工具組](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) |  |  |
| MongoDB | Cosmos DB | [Cloudamize*](https://www.cloudamize.com/) | [Cloudamize*](https://www.cloudamize.com/) |  |
| Cassandra | Cosmos DB |  |  |  |
| MySQL | Azure SQL DB、MI、VM | [Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[雲端 Atlas*](https://www.unifycloud.com/cloud-migration-tool/) | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
| MySQL | 適用於 MySQL 的 Azure DB | [Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) |  | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
| RDS MySQL | 適用於 MySQL 的 Azure DB |  |  | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
| PostgreSQL | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 | [Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) |  | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
| RDS PostgreSQL | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 |  |  | [TCO 計算機](https://azure.microsoft.com/pricing/tco/calculator/) |
| DB2 | Azure SQL DB、MI、VM | [Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) |  |
| 存取 | Azure SQL DB、MI、VM | [Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) |  |
| Sybase - SAP ASE | Azure SQL DB、MI、VM | [Azure 遷移](https://azure.microsoft.com/services/azure-migrate/) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) |  |
...
| SQL Server | SQL DW | [達姆特](https://marketplace.visualstudio.com/items?itemName=ms-databasemigration.data-access-migration-toolkit) |  |  |
...
| Oracle | SQL DW | [DAMT](https://marketplace.visualstudio.com/items?itemName=ms-databasemigration.data-access-migration-toolkit) / [SSMA](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) |  |
| Oracle | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 |  | [奧拉2Pg*](http://ora2pg.darold.net/start.html) |  |
| MongoDB | Cosmos DB |  | [Cloudamize*](https://www.cloudamize.com/) | [Cloudamize*](https://www.cloudamize.com/) |
| Cassandra | Cosmos DB |  |  |  |
...
| PostgreSQL | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 |  |  |  |
| RDS PostgreSQL | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 |  |  |  |
| DB2 | Azure SQL DB、MI、VM | [DAMT](https://marketplace.visualstudio.com/items?itemName=ms-databasemigration.data-access-migration-toolkit) / [SSMA](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) |  |
| 存取 | Azure SQL DB、MI、VM |  | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) |  |
...
| Oracle | Azure SQL DB、MI、VM | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[SharePlex*](https://www.quest.com/products/shareplex/)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[SharePlex*](https://www.quest.com/products/shareplex/)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [DMS](https://azure.microsoft.com/services/database-migration/)<br/>[SharePlex*](https://www.quest.com/products/shareplex/)<br/>[Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
| Oracle | SQL DW | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [DMS](https://azure.microsoft.com/services/database-migration/)<br/>[SharePlex*](https://www.quest.com/products/shareplex/)<br/>[Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
| Oracle | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 | [伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [DMS](https://azure.microsoft.com/services/database-migration/) |
...
| MySQL | Azure SQL DB、MI、VM | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
...
| PostgreSQL | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 | [PG 傾印*](https://www.postgresql.org/docs/11/static/app-pgdump.html) |  | [DMS](https://azure.microsoft.com/services/database-migration/)<br/>[Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
| RDS PostgreSQL | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 | [PG 傾印*](https://www.postgresql.org/docs/11/static/app-pgdump.html) |  | [DMS](https://azure.microsoft.com/services/database-migration/)<br/>[Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
| DB2 | Azure SQL DB、MI、VM | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
| 存取 | Azure SQL DB、MI、VM | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017) |
| Sybase - SAP ASE | Azure SQL DB、MI、VM | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [址](https://docs.microsoft.com/sql/ssma/sql-server-migration-assistant?view=sql-server-2017)<br/>[伊西斯皮爾*](https://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
| Sybase - SAP IQ | Azure SQL DB、MI、VM | [伊西斯皮爾*](http://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | [伊西斯皮爾*](http://www.ispirer.com/solutions/migration-to-the-microsoft-technology-stack) | |
| | | | | |
...
| Oracle | SQL DW |  |
| Oracle | 用於 PostgreSQL 的 Azure DB -<br/>單一伺服器 |  |
