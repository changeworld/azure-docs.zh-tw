...
## <a name="customize-node-surge-upgrade-preview"></a>自訂節點激增升級 (預覽) 
...
### <a name="set-up-the-preview-feature-for-customizing-node-surge-upgrade"></a>設定用於自訂節點激增升級的預覽功能
...
在預覽期間，您需要 *aks-preview* CLI 延伸模組，才能使用最大的激增。 使用 [az extension add][az-extension-add] 命令，然後使用 [az extension update][az-extension-update] 命令檢查是否有任何可用的更新：
