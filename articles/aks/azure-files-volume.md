...
Kubernetes 版本1.9.1 和更新 *版本的預設* 值為0755，而 *dirMode* 為 。 如果使用 Kubernetes 版本1.8.5 版或更高的叢集，並以靜態方式建立永久性磁片區物件，則必須在 *PersistentVolume* 物件上指定掛接選項。 下列範例會設定 0777：
...
更新您的容器規格，以參考您的 *PersistentVolumeClaim* 並更新您的 pod。 例如：
