...
* [AKS 文件](https://docs.microsoft.com/azure/aks/)中所列項目以外的網路自訂。
  > [!NOTE]
...
AKS 是一種受控服務，具有特定的網路和連線能力需求。 這些需求與一般 IaaS 元件的需求相比，較不具彈性。 在 AKS 中，像是自訂 NSG 規則、封鎖特定連接埠 (例如，使用封鎖輸出連接埠 443 的防火牆規則) 和白名單 URL 等作業，都可以讓您的叢集不受支援。
