...
ms.locfileid: "86122270"
---
# <a name="use-azure-rbac-for-kubernetes-authorization-preview"></a>使用 Azure RBAC 進行 Kubernetes 授權（預覽）
...
若要建立使用 Azure RBAC 的 AKS 叢集，您需要*AKS-preview* CLI 擴充功能版本0.4.55 或更高版本。 請使用 [az extension add][az-extension-add] 命令安裝 aks-preview Azure CLI 擴充功能，然後使用 [az extension update][az-extension-update] 命令檢查是否有任何可用的更新：
...
> [!IMPORTANT]
> 您需要 Azure Kubernetes Service 叢集[使用者](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#azure-kubernetes-service-cluster-user-role)內建角色，才能執行上述步驟。
...
- 深入瞭解您可以在[這裡](../role-based-access-control/resource-provider-operations.md#microsoftcontainerservice)用來細微定義自訂 Azure RBAC 角色以進行 Kubernetes 授權的所有動作。
