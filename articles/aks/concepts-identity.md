...
2. Kubernetes API 的存取權。 這項存取是透過[KUBERNETES RBAC](#kubernetes-role-based-access-control-rbac) (傳統) 或藉由[整合 AZURE RBAC 與 AKS 進行 Kubernetes 授權](#azure-rbac-for-kubernetes-authorization-preview)來控制
