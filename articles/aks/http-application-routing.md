...
將網頁瀏覽器開啟至*aks-helloworld \<CLUSTER_SPECIFIC_DNS_ZONE\> 。* 例如*aks-helloworld.9f9c1fe7-21a1-416d-99cd-3543bb92e4c3.eastus.aksapp.io*並確認您看到示範應用程式。 應用程式可能需要幾分鐘的時間才會出現。
