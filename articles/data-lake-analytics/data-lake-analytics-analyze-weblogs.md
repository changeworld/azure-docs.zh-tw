...
### <a name="to-connect-to-data-lake-analytics"></a>連接到資料湖分析
...
### <a name="to-create-and-submit-a-data-lake-analytics-job"></a>建立並提交資料湖分析工作
...
### <a name="to-see-the-job-output"></a>查看作業輸出
