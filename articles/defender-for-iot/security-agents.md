...
1. 若要在 Azure 模擬裝置上安裝代理程式，而不是安裝在實際的裝置上，請在可用區域中 [啟動新的 Azure 虛擬機器 (VM) ](https://docs.microsoft.com/azure/virtual-machines/linux/quick-create-portal) 。
