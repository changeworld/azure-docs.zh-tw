...
如果您想要在另一個平臺上執行命令列工具，請從下載 Azure Cache for Redis [https://redis.io/download](https://redis.io/download) 。
...
1. 在 Azure CLI 使用[az redis list-keys](/cli/azure/redis?view=azure-cli-latest#az-redis-list-keys)
2. 在 Azure PowerShell 使用 [Get-AzRedisCacheKey](/powershell/module/az.rediscache/Get-AzRedisCacheKey)
3. 使用 Azure 入口網站。
