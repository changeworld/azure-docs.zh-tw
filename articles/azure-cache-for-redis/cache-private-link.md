...
11. （選擇性）在 [ **標記** ] 索引標籤中，如果您想要分類資源，請輸入名稱和值。
...
若要深入瞭解 Azure Private Link，請參閱 [Azure Private Link 檔](https://docs.microsoft.com/azure/private-link/private-link-overview)。 
