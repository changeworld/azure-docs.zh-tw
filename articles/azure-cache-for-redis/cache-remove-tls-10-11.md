...
根據作業系統版本和已套用的任何修補程式，有效的預設 TLS 版本可能會有所不同。 雖然有一項資訊來源， [以下](https://docs.microsoft.com/dotnet/framework/network-programming/tls#support-for-tls-12) 是 Windows 的文章。 
