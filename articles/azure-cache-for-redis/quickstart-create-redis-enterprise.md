...
在開始之前，您需要有 Azure 訂用帳戶。 如果您沒有訂用帳戶，請建立[帳戶](https://azure.microsoft.com/)。 如需詳細資訊，請參閱 [Enterprise 服務層級需求](cache-overview.md#enterprise-tier-requirements)。
