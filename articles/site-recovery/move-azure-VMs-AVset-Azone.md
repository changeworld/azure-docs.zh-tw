...
> [!IMPORTANT]
> Azure Site Recovery 目前支援在不同的區域間移動 VM。 其僅在少數幾個區域中支援跨區域移動。 [深入了解](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-how-to-enable-zone-to-zone-disaster-recovery)。
