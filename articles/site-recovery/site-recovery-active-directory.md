---
title: 使用 Azure 網站恢復設置活動目錄/DNS 災害復原
...
1. 在命令提示符下，運行以下命令以檢查 sysvol 資料夾和 NETLOGON 資料夾是否共用：
...
1. 執行網域控制站的權威復原。 記住下列資訊：
    ...
    * 如果您使用 DFSR 複寫，請完成權威還原的步驟。 該過程在 Force 中描述了[DFSR 複製的 sysvol 資料夾（如 FRS 的"D4/D2"）的權威和非權威同步](https://support.microsoft.com/kb/2218556)。
