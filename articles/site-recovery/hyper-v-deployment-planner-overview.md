---
title: 使用 Azure 網站恢復進行超 V 災害復原的部署規劃器
...
1.  下載最新版本的 Azure[網站恢復部署計畫器](https://aka.ms/asr-deployment-planner)。
...
最新的 Azure 網站恢復部署規劃工具版本為 2.5。
有關在每個更新中添加的修補程式，請參閱[Azure 網站恢復部署規劃器版本歷程記錄](https://social.technet.microsoft.com/wiki/contents/articles/51049.asr-deployment-planner-version-history.aspx)頁。


## <a name="next-steps"></a>後續步驟
* [運行部署計畫器](site-recovery-hyper-v-deployment-planner-run.md)。
