...
2. 在您想要刪除的 VMM 伺服器上，刪除任何由雲端使用的網路對應。 在 [**System Center VMM** > **網路對應** **Site Recovery 基礎結構** > ] 中，以滑鼠右鍵按一下網路對應 > [**刪除**]。
3. 記下 VMM 伺服器的識別碼。
4. 將您想要移除的 VMM 伺服器上取消雲端和複寫原則的關聯。  在 [**System Center VMM** >  **複寫原則**的**Site Recovery 基礎結構** > ] 中，按兩下相關聯的原則。 以滑鼠右鍵按一下雲端 > [取消關聯]****。
5. 刪除 VMM 伺服器或作用中的節點。 在**System Center vmm** > **vmm 伺服器** **Site Recovery 基礎結構** > 中，以滑鼠右鍵按一下伺服器 >**刪除**]。
...
2. 取消關聯 Hyper-V 站台的原則。 在 [**hyper-v 網站** >  **複寫原則**的**Site Recovery 基礎結構** > ] 中，按兩下相關聯的原則。 以滑鼠右鍵按一下站台 > [取消關聯]****。
3. 刪除 Hyper-V 主機。 在 [**hyper-v** > **主機**的**Site Recovery 基礎結構** > ] 中，以滑鼠右鍵按一下伺服器 > [**刪除**]。
4. 從 Hyper-V 站台移除所有主機之後，將 Hyper-V 站台刪除。 在 [**hyper-v 網站** > 的**Site Recovery 基礎結構** > ]**中，以**滑鼠右鍵按一下網站 > [**刪除**]。
