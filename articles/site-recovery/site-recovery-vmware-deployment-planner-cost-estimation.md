...
description: 此文章說明如何在 Azure Site Recovery 部署規劃工具中檢查 VMware 嚴重損壞修復的成本估計。
...
>[!Note]
>部署規劃工具的最新版本，可針對複寫至受控磁碟的 Vm 提供成本估計。
