...
1. 如下列程式所述，將程式碼複製到 Windows 或 Linux 資料夾。 我們假設：
   ...
   - `\\ContosoSecureFS\MobilityServiceInstallers`安全的網路檔案共用。
...
- 將此腳本中的 `[CSIP]` 預留位置取代為設定伺服器 IP 位址的實際值。
