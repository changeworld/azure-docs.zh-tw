...
> [!NOTE]
> 更新彙總套件48的已知問題，為使用 ADE 加密的 Linux 機器啟用複寫。 [深入了解](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-troubleshoot-errors#enable-protection-failed-as-the-installer-is-unable-to-find-the--root-disk-error-code-151137)。
...
**目錄** | 已針對設定為個別磁碟分割的這些目錄，或不在相同系統磁片上的檔案系統新增了支援：<br/><br/> /（root）、/boot、/usr、/usr/local、/var、/etc。
