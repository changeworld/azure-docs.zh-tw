---
title: 使用 Azure 門戶將舊版直接對等互連轉換為 Azure 資源
titleSuffix: Azure
description: 使用 Azure 門戶將舊版直接對等互連轉換為 Azure 資源
...
---
# <a name="convert-a-legacy-direct-peering-to-an-azure-resource-by-using-the-azure-portal"></a>使用 Azure 門戶將舊版直接對等互連轉換為 Azure 資源

本文介紹如何使用 Azure 門戶將現有舊版直接對等互連轉換為 Azure 資源。
