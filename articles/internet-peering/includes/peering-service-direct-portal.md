...
1. 建立前置詞之後，您會在 **已註冊的首碼**清單中看到它。 選取前置詞的 **名稱** ，以查看更多詳細資料。
    > [!div class="mx-imgBorder"]
    > ![註冊的首碼和連接](../media/setup-direct-modify-registered-prefixes.png)
1. 在 [已註冊的首碼] 頁面上，您會看到完整的詳細資料，其中包含每個前置詞的前置詞索引 **鍵** 。 此金鑰必須提供給客戶從其提供者 ISP 配置此前置詞。 然後，客戶可以使用此金鑰在其訂用帳戶內註冊其前置詞。
    > [!div class="mx-imgBorder"]
