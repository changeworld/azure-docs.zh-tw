...
1. **概述頁**顯示高級資訊,如下所示。
    ...
    > [!div class="mx-imgBorder"]
    > ![對等資源概述窗格](../media/setup-direct-get-overview.png)
...
1. 在左邊選擇 **。** 在螢幕頂部,您會看到 ASN 和 Microsoft 之間跨地鐵內不同設施的對等互連連接的摘要。 您還可以透過選擇窗格中心的 **「連接**」來從 **「概述」** 頁存取連接摘要,如圖所示。

    > [!div class="mx-imgBorder"]
    > ![端連線](../media/setup-direct-get-connectionssummary.png)

    * **連接狀態**對應於對等互連連接設置的狀態。 此欄位中顯示的狀態遵循[Direct 對等演練](../walkthrough-direct-all.md)中顯示的狀態圖。
