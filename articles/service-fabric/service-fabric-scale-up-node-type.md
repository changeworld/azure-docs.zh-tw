...
ms.locfileid: "88056477"
---
# <a name="scale-up-a-service-fabric-cluster-primary-node-type-by-adding-a-virtual-machine-scale-set"></a>藉由新增虛擬機器擴展集來相應增加 Service Fabric 叢集主要節點類型
