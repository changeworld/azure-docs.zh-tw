---
title: 開發具狀態服務的單元測試
description: 瞭解 Azure Service Fabric 中適用于具狀態服務的單元測試，以及在開發期間要牢記在心的特殊考慮。
ms.topic: conceptual
ms.date: 09/04/2018
...
*ServiceFabric 模擬並非由 Microsoft 所擁有或維護。不過，這是 Microsoft 建議的資源庫，用於單元測試具狀態服務。*
