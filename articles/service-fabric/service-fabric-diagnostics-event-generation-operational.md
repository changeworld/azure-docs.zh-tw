...
| 61963 | ReliableQueueOpened | LifeCycle | 已開啟可靠的佇列 | DistributedQueue | 資訊 |
| 61964 | ReliableQueueClosed | LifeCycle | 可靠的佇列已關閉 | DistributedQueue | 資訊 |
| 61965 | ReliableQueueCheckpointRecovered | LifeCycle | 可靠佇列已復原其檢查點 | DistributedQueue | 資訊 |
...
| 63648 | ReliableConcurrentQueueOpened | LifeCycle | 已開啟可靠的並行佇列 | ReliableConcurrentQueue | 資訊 |
...
| 61687 | TStoreError | 失敗 | 可靠的集合收到未預期的錯誤 | TStore | 錯誤 |
| 63831 | PrimaryFullCopyInitiated | LifeCycle | 主要複本已起始完整複本 | TReplicator | 資訊 |
| 63832 | PrimaryPartialCopyInitiated | LifeCycle | 主要複本已起始部分複製 | TReplicator | 資訊 |
...
| 16834 | PrimaryReplicationQueueFull | 醫療 | 主要複本的複寫佇列已滿 | 複寫 | 警告 |
| 16835 | PrimaryReplicationQueueWarning | 醫療 | 主要複本的複寫佇列已接近完整 | 複寫 | 警告 |
| 16836 | PrimaryReplicationQueueWarningMitigated | 醫療 | 主要複本的複寫佇列正常 | 複寫 | 資訊 |
| 16837 | SecondaryReplicationQueueFull | 醫療 | 次要複本的複寫佇列已滿 | 複寫 | 警告 |
| 16838 | SecondaryReplicationQueueWarning | 醫療 | 次要複本的複寫佇列已接近完整 | 複寫 | 警告 |
| 16839 | SecondaryReplicationQueueWarningMitigated | 醫療 | 次要複本的複寫佇列正常 | 複寫 | 資訊 |
