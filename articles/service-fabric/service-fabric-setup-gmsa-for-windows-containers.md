---
title: Azure Service Fabric container service 的設定 gMSA
description: 立即瞭解如何針對在 Azure Service Fabric 中執行的容器，設定群組受管理的服務帳戶 (gMSA) 。
ms.topic: conceptual
ms.date: 03/20/2019
