...
|類型|[ServiceTypeHealthPolicyType](#servicetypehealthpolicytype-complextype)|
|minOccurs|0|
...
|類型|[ServiceTemplatesType](#servicetemplatestype-complextype)|
...
|類型|[DefaultServicesType](#defaultservicestype-complextype)|
...
|---|---|
|NAME|Principals|
|類型|[SecurityPrincipalsType](#securityprincipalstype-complextype)|
|minOccurs|0|
...
|---|---|
|NAME|原則|
|類型|[ApplicationPoliciesType](#applicationpoliciestype-complextype)|
|minOccurs|0|
...
|---|---|
|NAME|診斷|
|類型|[DiagnosticsType](#diagnosticstype-complextype)|
|minOccurs|0|
...
|類型|[EnvironmentType](#environmenttype-complextype)|
...
|---|---|
|NAME|HealthPolicy|
|類型|[ApplicationHealthPolicyType](#applicationhealthpolicytype-complextype)|
|minOccurs|0|
...
|類型|[FabricCertificateType](#fabriccertificatetype-complextype)|
|minOccurs|0|
...
|---|---|
|NAME|FabricSettings|
|類型|[SettingsOverridesType](#settingsoverridestype-complextype)|
|minOccurs|0|
...
|---|---|
|NAME|EntryPoint|
|類型|[EntryPointDescriptionType](#entrypointdescriptiontype-complextype)|
|minOccurs|1|
...
|類型|[EnvironmentVariablesType](#environmentvariablestype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|NAME|ConfigPackage|
|類型|[ConfigPackageDescriptionType](#configpackagedescriptiontype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|類型|[RepositoryCredentialsType](#repositorycredentialstype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|NAME|HealthConfig|
|類型|[ContainerHealthConfigType](#containerhealthconfigtype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|NAME|PortBinding|
|類型|[PortBindingType](#portbindingtype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|CertificateRef|
|類型|[ContainerCertificateType](#containercertificatetype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|LogConfig|
|類型|[ContainerLoggingDriverType](#containerloggingdrivertype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|NAME|NetworkConfig|
|類型|[ContainerNetworkConfigType](#containernetworkconfigtype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|NAME|磁碟區|
|類型|[ContainerVolumeType](#containervolumetype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|SecurityOption|
|類型|[SecurityOptionsType](#securityoptionstype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|ImageOverrides|
|類型|[ImageOverridesType](#imageoverridestype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|NAME|標籤|
|類型|[ContainerLabelType](#containerlabeltype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|DriverOption|
|類型|[DriverOptionType](#driveroptiontype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|類型|[ContainerNetworkPolicyEndpointBindingType](#containernetworkpolicyendpointbindingtype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|UnmanagedDll|
|類型|[UnmanagedDllType](#unmanageddlltype-complextype)|
...
|類型|[ManagedAssemblyType](#managedassemblytype-complextype)|
...
這個值會定義屬性值的保護。 它可能是 SecretsStoreRef/加密/純文字。
如果設定為 SecretsStoreRef，此值會參考在叢集的 SecureStore 中以加密方式儲存的秘密，此密碼會在啟用時解除參照並解密。
...
|---|---|
|NAME|DllHost|
|類型|[DllHostEntryPointType](#dllhostentrypointtype-complextype)|
...
|---|---|
|NAME|ContainerHost|
|類型|[ContainerHostEntryPointType](#containerhostentrypointtype-complextype)|
...
|類型|[EnvironmentVariableOverrideType](#environmentvariableoverridetype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
環境變數的類型。 它可以是純文字/加密/SecretsStoreRef。
...
|---|---|
|NAME|EnvironmentVariable|
|類型|[EnvironmentVariableType](#environmentvariabletype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|類型|[InputEndpointType](#inputendpointtype-complextype)|
...
|類型|[InternalEndpointType](#internalendpointtype-complextype)|
...
|---|---|
|NAME|映像|
|類型|[ImageType](#imagetype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|端點|
|類型|[FabricEndpointsType](#fabricendpointstype-complextype)|
|minOccurs|0|
...
|---|---|
|NAME|憑證|
|類型|[CertificatesType](#certificatestype-complextype)|
|minOccurs|0|
...
|類型|[ContainerNetworkPolicyType](#containernetworkpolicytype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|參數|
|類型|[ParameterType](#parametertype-complextype)|
|minOccurs|1|
|maxOccurs|無限制|
...
這個值會定義您在 [密碼] 屬性中指定的密碼類型。 它可以是 SecretsStoreRef/Encrypted/純文字。
如果設定為 SecretsStoreRef，我們會從 SecretStore 中取出參考值。
如果設定為 [已加密]，應用程式開發人員會負責建立憑證，並使用 Invoke-servicefabricencryptsecret Cmdlet 來加密機密資訊。
...
|類型|[StatefulServiceTypeType](#statefulservicetypetype-complextype)|
...
|類型|[StatelessServiceTypeType](#statelessservicetypetype-complextype)|
...
|類型|[StatefulServiceGroupTypeType](#statefulservicegrouptypetype-complextype)|
...
|類型|[StatelessServiceGroupTypeType](#statelessservicegrouptypetype-complextype)|
...
|---|---|
|NAME|RunAsPolicy|
|類型|[RunAsPolicyType](#runaspolicytype-complextype)|
|minOccurs|0|
...
|類型|[SecurityAccessPolicyType](#securityaccesspolicytype-complextype)|
|minOccurs|0|
...
|類型|[PackageSharingPolicyType](#packagesharingpolicytype-complextype)|
|minOccurs|0|
...
|類型|[EndpointBindingPolicyType](#endpointbindingpolicytype-complextype)|
|minOccurs|0|
...
|類型|[ServiceFabricRuntimeAccessPolicyType](#servicefabricruntimeaccesspolicytype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|類型|[ServicePackageResourceGovernancePolicyType](#servicepackageresourcegovernancepolicytype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|類型|[ResourceGovernancePolicyType](#resourcegovernancepolicytype-complextype)|
|minOccurs|0|
...
|類型|[ServicePackageContainerPolicyType](#servicepackagecontainerpolicytype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|類型|[ContainerHostPoliciesType](#containerhostpoliciestype-complextype)|
|minOccurs|0|
...
|類型|[ConfigPackagePoliciesType](#configpackagepoliciestype-complextype)|
|minOccurs|0|
...
|類型|[NetworkPoliciesType](#networkpoliciestype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|NAME|ServiceTypes|
|類型|[ServiceAndServiceGroupTypesType](#serviceandservicegrouptypestype-complextype)|
...
|---|---|
|NAME|CodePackage|
|類型|[CodePackageType](#codepackagetype-complextype)|
|maxOccurs|無限制|
...
|---|---|
|NAME|ConfigPackage|
|類型|[ConfigPackageType](#configpackagetype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|DataPackage|
|類型|[DataPackageType](#datapackagetype-complextype)|
|minOccurs|0|
|maxOccurs|無限制|
...
|---|---|
|NAME|資源|
|類型|[ResourcesType](#resourcestype-complextype)|
|minOccurs|0|
...
|---|---|
|NAME|診斷|
|類型|[ServiceDiagnosticsType](#servicediagnosticstype-complextype)|
|minOccurs|0|
...
|類型|[StatelessServiceType](#statelessservicetype-complextype)|
...
|類型|[StatefulServiceType](#statefulservicetype-complextype)|
...
|類型|[StatelessServiceGroupType](#statelessservicegrouptype-complextype)|
...
|類型|[StatefulServiceGroupType](#statefulservicegrouptype-complextype)|
...
|類型|[WindowsFabricDeploymentInformation](#windowsfabricdeploymentinformation-complextype)|
|minOccurs|0|
