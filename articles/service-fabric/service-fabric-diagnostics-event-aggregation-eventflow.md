...
* `Microsoft.Diagnostics.EventFlow.Inputs.EventSource` 從服務的 EventSource 類別以及從標準 EventSources （例如 *Microsoft ServiceFabric 服務* 和 *microsoft ServiceFabric）* 中捕獲資料) 
