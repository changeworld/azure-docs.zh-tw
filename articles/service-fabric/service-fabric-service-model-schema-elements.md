...
|名稱|AddRemoveIncrementalNamedPartitionScalingMechanism|
|minOccurs|0|
|maxOccurs|1|
...
|名稱|AveragePartitionLoadScalingTrigger|
|minOccurs|0|
|maxOccurs|1|
...
|內容|0 個元素，5 個屬性|
|已定義|在 [ScalingPolicyTriggerGroup 群組](service-fabric-service-model-schema-element-groups.md#scalingpolicytriggergroup-group)區域中|
|名稱|AverageServiceLoadScalingTrigger|
|minOccurs|0|
|maxOccurs|1|
...
|內容|0 個元素，0 個屬性|
|已定義|在 [FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 區域中|
|名稱|CentralSecretServiceReplicatorEndpoint|
|minOccurs|0|
...
|內容|0 個元素，0 個屬性|
|已定義|在 [FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 區域中|
|名稱|EventStoreServiceReplicatorEndpoint|
|minOccurs|0|
...
|內容|0 個元素，0 個屬性|
|已定義|在 [FabricEndpointsType complexType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype) 區域中|
|名稱|GatewayResourceManagerReplicatorEndpoint|
|minOccurs|0|
...
|內容|0 個元素，3 個屬性|
|已定義|在 [ScalingPolicyMechanismGroup 群組](service-fabric-service-model-schema-element-groups.md#scalingpolicymechanismgroup-group)區域中|
|名稱|InstanceCountScalingMechanism|
|minOccurs|0|
|maxOccurs|1|
...
|內容|0 個元素，0 個屬性|
|已定義|在 [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)、[ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype) 區域中|
|名稱|ServiceFabricRuntimeAccessPolicy|
|minOccurs|0|
|maxOccurs|1|
...
|內容|0 個元素，0 個屬性|
|已定義|在 [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)、[ServicePackageType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype) 區域中|
|名稱|ServicePackageContainerPolicy|
|minOccurs|0|
|maxOccurs|1|
