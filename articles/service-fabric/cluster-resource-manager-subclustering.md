...
* 服務 A –具有放置條件約束 "NodeType = = 前端"，報告負載為10
* 服務 B –具有放置條件約束 "NodeType = = 前端"，報告的負載為10
* 服務 C –具有放置條件約束 "NodeType = = 後端"，報告100的負載
* 服務 D –具有放置條件約束 "NodeType = = 後端"，報告100的負載
* 而且我們有四個節點。 其中兩個將 NodeType 設定為「前端」，而其他兩個為「後端」
...
Resource Manager 將會辨識這種情況，並產生健康情況報告，建議您將服務 A 分割成兩個服務–服務 A1 可以放在前端節點和服務 A2 上，這可以放在後端節點上。 這會讓我們回到第一個類別的情況，而這種情況可以達到最佳平衡。
