---
title: Azure 中反向 DNS 概述 - Azure DNS
description: 在此學習路徑中，開始瞭解反向 DNS 的工作原理以及如何在 Azure 中使用
services: dns
...
例如，DNS 記錄 'www.contoso.com' 是使用 DNS 'A' 記錄名稱 'www' 在區域 'contoso.com' 中實作的。  此 A 記錄會指向對應的 IP 位址，在此情況下為 64.4.6.100。  反向對應單獨實現，使用區域"6.4.64.in-addr.arpa"中的名為"100"的"PTR"記錄（請注意，IP 位址在 ARPA 區域中顛倒。 此 PTR 記錄（如果配置正確）指向名稱"www.contoso.com"。
