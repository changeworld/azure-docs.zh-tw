---
title: 在雲端中共同責任-Microsoft Azure
description: 瞭解共用的責任模型，以及由雲端提供者處理哪些安全性工作，以及由您處理哪些工作。
services: security
...
如需在 SaaS、PaaS 及 IaaS 部署中，您與 Microsoft 之間責任劃分的詳細資訊，請參閱 [雲端運算的共同責任](https://gallery.technet.microsoft.com/Shared-Responsibilities-81d0ff91)。
