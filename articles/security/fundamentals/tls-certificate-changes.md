...
- [Azure Cache for Redis](/azure/azure-cache-for-redis) 會保留在巴爾的摩 CYBERTRUST 根 CA，但其中繼 ca 將會變更。 [按一下這裡以取得詳細資訊](../../azure-cache-for-redis/cache-whats-new.md)。
> [!IMPORTANT]
