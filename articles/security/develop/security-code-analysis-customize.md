...
如需有關 Windows Update 錯誤及其緩和措施的詳細資訊，請參閱 [Windows Update 錯誤碼（依元件](https://docs.microsoft.com/windows/deployment/update/windows-update-error-reference) ）和 TechNet 文章 [Windows Update 代理程式錯誤碼](https://social.technet.microsoft.com/wiki/contents/articles/15260.windows-update-agent-error-codes.aspx)。
...
如需 Roslyn 分析器工作的其他資源，請參閱 Microsoft Docs 上以 [Roslyn 為基礎的分析器](https://docs.microsoft.com/dotnet/standard/analyzers/api-analyzer) 。
