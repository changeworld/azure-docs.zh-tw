...
## <a name="ensure-that-audit-and-log-files-have-restricted-access"></a><a id="log-restricted-access"></a>確保稽核和記錄檔有限制存取
...
| **適用的技術** | 泛型 |
| **屬性**              | N/A  |
| **引用**              | [設定登入稽核](https://msdn.microsoft.com/library/ms175850.aspx) |
...
| **適用的技術** | SQL Azure |
| **屬性**              | SQL 版本 - V12 |
| **引用**              | [開始使用 SQL 資料庫威脅檢測](https://azure.microsoft.com/documentation/articles/sql-database-threat-detection-get-started/)|
...
| **適用的技術** | 泛型 |
| **屬性**              | N/A |
| **引用**              | [使用儲存體分析來監視授權類型](https://azure.microsoft.com/documentation/articles/storage-security-guide/#storage-analytics) |
...
| **適用的技術** | .NET Framework |
| **屬性**              | N/A  |
| **引用**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx)、[Fortify Kingdom](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_logging) |
...
| **適用的技術** | .NET Framework |
| **屬性**              | N/A  |
| **引用**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx)、[Fortify Kingdom](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_audit_failure_handling) |
...
| **適用的技術** | 泛型 |
| **屬性**              | N/A  |
| **引用**              | [IoT 中樞作業監視簡介](https://azure.microsoft.com/documentation/articles/iot-hub-operations-monitoring/) |
