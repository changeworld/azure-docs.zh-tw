...
ms.locfileid: "90059158"
---
# <a name="security-control-backup-and-recovery"></a>安全性控制：備份和復原
...
確定您要備份系統和資料，以在發生未預期的事件之後維護商務持續性。 這應該是復原點目標 (RPO) 和復原時間目標 (RTO) 的任何目標的指引。
...
確定您的備份可防止遭受攻擊。 這應該包括備份的加密，以防止機密性遺失。   
...
- [事件準備](/) azure/雲端採用-架構/組織/雲端-安全性-事件-準備
...
- [如何啟用 Key Vault 中的虛刪除和清除保護](/azure/storage/blobs/storage-blob-soft-delete?tabs=azure-portal)
