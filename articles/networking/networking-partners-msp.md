...
description: 瞭解 Azure 網路受控服務提供者合作夥伴方案，並尋找提供雲端和混合式網路服務的夥伴清單。
services: networking
author: skishen525
...
ms.locfileid: "97617335"
---
# <a name="about-azure-networking-msp-partners"></a>關於 Azure 網路 MSP 合作夥伴

[Azure 網路受控服務提供者 (MSP) 合作夥伴方案](https://azure.microsoft.com/blog/enhancing-the-customer-experience-with-the-azure-networking-msp-partner-program/)，可讓以網路服務為焦點的 Msp、電信公司和系統整合者 (SIs) ，以提供以 Azure 的網路產品和服務組合為中心的雲端和混合式網路服務。

Azure 網路 MSP 是一組特製化的受控服務提供者，可解決雲端和混合式網路上所有層面的企業雲端網路需求和挑戰。 受控網路服務包含下列一項或多項服務：網路架構、規劃、部署、操作、維護和最佳化。

:::image type="content" source="./media/networking-partners-msp/msp.jpg" alt-text="合作 夥伴":::
...
| **MSP** | **雲端網路轉換服務** | **受控 ExpressRoute** | **受控虛擬 WAN** | **受控私人 Edge 區域** | **受管理的安全性** |
| ---| ---| ---| ---| ---| ---|
|[ANS 群組 (UK)](https://www.ans.co.uk/)|[Azure 受控服務 + ANS Glass 10wk 實作](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/ans_group.glassms)|[ExpressRoute & 連接：2周評量](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/ans_group.ans_er)|[Azure 虛擬 WAN + Fortinet：2周評量](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/ans_group.ans_vw)|||
|[Aryaka 網路](https://www.aryaka.com/azure-msp-vwan-managed-service-provider-launch-partner-aryaka/)||[Aryaka Azure Connect](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/aryaka.cloudconnect_azure_19?tab=Overview)|[Azure 網路虛擬的受控 SD-WAN aryaka networks](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/aryaka.aryaka_azure_virtual_wan?tab=Overview) | | |
...
|[Equinix](https://www.equinix.com/)|[雲端最佳化的 WAN 工作坊](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/equinix.cloudoptimizedwan?tab=Overview)|[ExpressRoute 連接策略研討會](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/equinix.expressroutestrategy?tab=Overview); [Equinix Cloud Exchange 網狀架構](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/equinix.equinix_ecx_fabric?tab=Overview)||||
...
|[同盟無線](https://www.federatedwireless.com/caas/)||||[同盟無線連線即服務](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/federatedwireless1580839623708.fw_caas?tab=Overview)|
...
|[Liquid Telecom](https://liquidcloud.africa/)|[雲端就緒 - 2 小時評量](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/liquidtelecommunicationsoperationslimited.liquid_cloud_readiness_assessment)|[液體 Azure 專家服務](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/liquidtelecommunicationsoperationslimited.5dab29ab-bb14-4df8-8978-9a8608a41ad7?tab=Overview)||||
|[腔](https://www.lumen.com/en-us/solutions/hybrid-cloud.html)||[ExpressRoute 諮詢 Svcs： 8-周實施](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/centurylink2362604-2362604.centurylink_consultingservicesforexpressroute); [ExpressRoute 1 天的 Lumen 登陸區域](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/centurylinklimited.centurylink_landing_zone_for_azure_expressroute)||||
|[Macquarie Telecom](https://macquariecloudservices.com/azure-managed-services/)|[Macquarie Cloud 的 Azure 受控服務](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/macquariecloudservices.managed_services?tab=Overview); [Azure 透過 Macquarie 雲端服務擴充](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/macquariecloudservices.azure_extend?tab=Overview)||[Macquarie 雲端服務的 Azure 部署](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/macquariecloudservices.azure_deploy_vedge?tab=Overview); [SD-Macquarie Cloud 安裝 WAN 虛擬邊緣](https://azuremarketplace.microsoft.com/marketplace/apps/coevolveptylimited1581027739259.managed-vmware-sdwan-edge?tab=Overview)||[Macquarie 雲端服務的受控安全性](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/macquariecloudservices.managed_security?tab=Overview)|
|[Megaport](https://www.megaport.com/services/microsoft-expressroute/)||[ExpressRoute 的受控路由服務](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/megaport1582290752989.megaport_mcr?tab=Overview)||||
...
|[OpenSystems](https://open-systems.com/solutions/microsoft-azure-virtual-wan)|||[受控安全 SD-利用 Microsoft Azure 的 WAN](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/open_systems_ag.sdwan_0820?tab=Overview)||
|[橙色商務服務](https://www.orange-business.com/en/partners/orange-business-services-become-microsoft-azure-networking-managed-services-provider)||[ExpressRoute 網路研究：3周的執行](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/orangebusinessservicessa1603182943272.expressroute_study_obs_connectivity)|||
...
|[技術 Mahindra](https://www.techmahindra.com/en-in/network-services/)|[技術 Mahindra 端對端受控網路服務](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/techm.techm-network-transformstrategy?tab=Overview)|||[Azure 私人 LTE MSP](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/techm.techm-networking-azureprivate5g?tab=Overview)|
