...
## <a name="august-2020-round-trip-latency-figures"></a>2020年8月的來回延遲圖表

過去31天的 Azure 區域之間的每月平均來回行程 (結束于) 2020 年8月31日，如下所示。 下列測量是由 [ThousandEyes](https://thousandeyes.com)提供技術支援。
