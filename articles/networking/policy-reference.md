---
title: 適用于 Azure 網路服務的內建原則定義
description: 列出適用于 Azure 網路服務的 Azure 原則內建原則定義。 這些內建原則定義提供管理 Azure 資源的常見方法。
ms.date: 01/08/2021
ms.topic: reference
author: KumudD
ms.author: kumud
...
ms.locfileid: "98045866"
---
# <a name="azure-policy-built-in-definitions-for-azure-networking-services"></a>適用于 Azure 網路服務的 Azure 原則內建定義

此頁面是 Azure 網路服務的 [Azure 原則](../governance/policy/overview.md) 內建原則定義的索引。 如需其他服務的其他內建 Azure 原則，請參閱 [Azure 原則內建定義](../governance/policy/samples/built-in-policies.md)。

連結至 Azure 入口網站中原則定義的每個內建原則定義名稱。 使用 [版本] 資料行中的連結來查看 [Azure 原則 GitHub 存放庫](https://github.com/Azure/azure-policy)上的來源。

## <a name="azure-networking-services"></a>Azure 網路服務
