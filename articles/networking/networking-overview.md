...
客戶可以選擇部署 [AZURE WAF 與應用程式閘道](../web-application-firewall/ag/ag-overview.md) ，以針對公用和私人位址空間中的實體提供區域保護。 客戶也可以選擇 [使用 Front Door 部署 AZURE WAF](../web-application-firewall/afds/afds-overview.md) ，以提供網路邊緣的保護給公用端點。
