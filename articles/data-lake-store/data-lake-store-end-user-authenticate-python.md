...
* `azure-datalake-store` 模組，含有 Azure Data Lake Storage Gen1 檔案系統作業。 如需此課程模組的詳細資訊，請參閱 [azure-datalake-Store Filesystem 模組參考](/python/api/azure-datalake-store/azure.datalake.store.core/)。
