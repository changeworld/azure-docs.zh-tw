...
使用者可在資料目錄入口網站中選取 [ **取得擁有權** ] 選項，以取得資料資產的擁有權。 取得無人擁有之資料資產的擁有權無需任何特殊權限。 所有使用者都能取得無人擁有之資料資產的擁有權。
...
以擁有者身分移除本身的資產擁有者無法再管理資產。 如果資產擁有者移除自己的擁有者，而且沒有其他共同擁有者，則資產會還原為無人擁有的狀態。
