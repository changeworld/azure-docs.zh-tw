...
* 分析師知道資料在其支援的商務程式內容中使用的方式。

上述各觀點都具有價值，而資料目錄針對中繼資料使用群眾外包的方使，讓每個觀點都能夠被擷取並用來提供已註冊資料來源的全局。 使用資料目錄入口網站，每個使用者都可以新增和編輯自己的批註，同時能夠查看其他使用者提供的批註。
