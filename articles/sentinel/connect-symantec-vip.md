...
---
# <a name="connect-your-symantec-vip-to-azure-sentinel"></a>將您的 Symantec VIP 連接到 Azure Sentinel

> [!IMPORTANT]
> Azure Sentinel 中的 Symantec VIP 資料連線器目前處於公開預覽狀態。
...
本文說明如何將您的 [SYMANTEC VIP](https://vip.symantec.com/) 設備連線至 Azure Sentinel。 Symantec VIP data connector 可讓您輕鬆地將 Symantec VIP 記錄與 Azure Sentinel 連線、查看儀表板、建立自訂警示，以及改進調查。 Symantec VIP 與 Azure Sentinel 之間的整合會使用 Syslog。
...
設定 Symantec VIP，以透過 Syslog 代理程式將 Syslog 訊息轉送至您的 Azure 工作區。
...
在本檔中，您已瞭解如何將 Symantec VIP 記錄連線至 Azure Sentinel。 若要深入了解 Azure Sentinel，請參閱下列文章：
