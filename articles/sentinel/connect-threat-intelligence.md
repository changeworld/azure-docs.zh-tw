...
您可以使用下一節所列的其中一種整合式威脅情報平臺 (秘訣) 產品來串流威脅指標 Azure Sentinel，連接到 TAXII 伺服器，或使用與 [Microsoft Graph Security TIINDICATORS API](https://aka.ms/graphsecuritytiindicators)的直接整合。
