...
> [!NOTE]
> -   Azure Sentinel 的 CMK 功能只會提供給**新**的客戶，而且這項功能的存取權是由 Azure 功能註冊所控制。您可以透過聯繫azuresentinelCMK@microsoft.com來要求存取權，而且當容量可用時，將會核准擱置中的要求。
...
1.  [開啟修復選項：](../key-vault/general/best-practices.md#turn-on-recovery-options)

    -   請確定已開啟虛[刪除](../key-vault/general/overview-soft-delete.md)。
