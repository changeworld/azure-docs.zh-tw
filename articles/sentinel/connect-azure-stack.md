...
2. 移至 [ **虛擬機器** ] 頁面，選取您要使用 Azure Sentinel 保護的虛擬機器。 如需如何在 Azure Stack Hub 上建立虛擬機器的詳細資訊，請參閱使用 [Azure Stack Hub 入口網站建立 Windows SERVER vm](/azure-stack/user/azure-stack-quick-windows-portal) ，或 [使用 Azure Stack Hub 入口網站建立 Linux 伺服器 vm](/azure-stack/user/azure-stack-quick-linux-portal)。
