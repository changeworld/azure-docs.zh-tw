...
只要按一下，您就可以將 [Microsoft Defender For Identity 的](/azure-advanced-threat-protection/what-is-atp) 記錄串流至 Azure Sentinel。
...
請確定 [您的網路上已啟用](/azure-advanced-threat-protection/install-atp-step1)Microsoft Defender for Identity preview 版本。
