...
>    - 澳大利亞地理位置
>
> - 在所有其他地理位置和區域中，這些功能會保留在 **公開預覽** 階段，並在沒有服務等級協定的情況下提供。 如需詳細資訊，請參閱 [Microsoft Azure 預覽版增補使用條款](https://azure.microsoft.com/support/legal/preview-supplemental-terms/)。
