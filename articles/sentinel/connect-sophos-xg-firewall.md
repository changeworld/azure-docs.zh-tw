...
---
# <a name="connect-your-sophos-xg-firewall-to-azure-sentinel"></a>將您的 Sophos XG 防火牆連線至 Azure Sentinel

> [!IMPORTANT]
> Azure Sentinel 中的 Sophos XG 防火牆資料連線器目前為公開預覽狀態。
...
本文說明如何將您的[SOPHOS XG 防火牆](https://www.sophos.com/products/next-gen-firewall.aspx)應用裝置連線到 Azure Sentinel。 Sophos XG 防火牆資料連線器可讓您輕鬆地將 Sophos XG 防火牆記錄與 Azure Sentinel 連線、查看儀表板、建立自訂警示，以及改善調查。 Sophos XG 防火牆與 Azure Sentinel 之間的整合會使用 Syslog。
...
1. 在 Azure Sentinel 入口網站中，按一下 [**資料連線器**]，然後選取 [ **Sophos XG 防火牆**連接器]。
...
在本檔中，您已瞭解如何將 Sophos XG 防火牆連線至 Azure Sentinel。 若要深入了解 Azure Sentinel，請參閱下列文章：
