...
description: 本文定義 Microsoft Azure 服務匯流排中以 AMQP 要求/回應為基礎的作業清單。
ms.topic: article
ms.date: 06/23/2020
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:renew-lock`|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:peek-message`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
  
要求訊息內文必須包含 **amqp-值** 區段，其中包含含有下列專案的 **對應** ：  
...
回應訊息本文必須由包含**對應**與下列專案的**amqp 值**區段組成：  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:schedule-message`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
回應訊息本文必須由包含對應與下列專案的 **amqp 值** 區段組成：  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:cancel-scheduled-message`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:renew-session-lock`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:set-session-state`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:get-session-state`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:get-message-sessions`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:add-rule`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
**規則描述**的對應必須包含下列專案，其中**sql 篩選**和相互**關聯篩選器**是互斥的：  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:remove-rule`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:enumerate-rules`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:receive-by-sequence-number`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
...
|receiver-settle-mode|ubyte|是|AMQP core v1.0 中指定的收件者**結算**模式。|  
...
|機碼|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|作業|字串|是|`com.microsoft:update-disposition`|  
|`com.microsoft:server-timeout`|uint|否|作業伺服器逾時以毫秒為單位。|  
