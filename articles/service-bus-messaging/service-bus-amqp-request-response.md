...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:renew-lock`|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:peek-message`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:schedule-message`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:cancel-scheduled-message`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:renew-session-lock`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:set-session-state`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:get-session-state`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:get-message-sessions`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:add-rule`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|Content-Type|字串|No||  
|properties|map|No|對應至服務匯流排 [BrokeredMessage.Properties](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage)。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:remove-rule`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:enumerate-rules`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:receive-by-sequence-number`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
...
|receiver-settle-mode|ubyte|Yes|如 AMQP core v1.0 中所指定的**接收者結算**模式。|  
...
|答案|數值類型|必要|值內容|  
|---------|----------------|--------------|--------------------|  
|operation (作業)|字串|Yes|`com.microsoft:update-disposition`|  
|`com.microsoft:server-timeout`|uint|No|作業伺服器逾時以毫秒為單位。|  
