...
![記錄檔的螢幕擷取畫面，其中顯示來源、目的地、來源埠、目的地埠和通訊協定名稱。 在 fiest 資料列中，目的地通訊埠10401（0x28 A 1）會以黑色來概述。][4]
