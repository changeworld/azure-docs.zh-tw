...
|伺服器錯誤|在指定時段內，服務匯流排服務中因錯誤而未處理的要求數目。<br/><br/> 單位：Count <br/> 彙總類型：總計 <br/> 維度：機構名稱|
...
| Size | 實體（佇列或主題）的大小（以位元組為單位）。 <br/><br/>單位：Count <br/>彙總類型：Average <br/>維度：機構名稱 | 
