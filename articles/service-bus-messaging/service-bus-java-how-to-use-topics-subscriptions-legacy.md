...
> [!WARNING]
>  本快速入門使用舊的 azure-servicebus 套件。 如果快速入門使用最新 azure-messaging-servicebus 套件，請參閱[使用 azure-messaging-servicebus 傳送和接收訊息](service-bus-java-how-to-use-topics-subscriptions.md)。
