...
* *輪詢*觸發程式：
  ...
  * [**收到電子郵件時**] 觸發程式可讓您的邏輯應用程式檢查來自 Logic Apps 支援的任何電子郵件提供者的新電子郵件，例如[Office 365 Outlook](../connectors/connectors-create-api-office365-outlook.md)、 [Gmail](https://docs.microsoft.com/connectors/gmail/)、 [Outlook.com](https://docs.microsoft.com/connectors/outlook/)等等。 如需詳細資訊，請參閱下列主題：<p>
