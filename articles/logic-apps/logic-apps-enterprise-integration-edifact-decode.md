...
* 已定義並與 Azure 訂閱關聯的[集成帳戶](logic-apps-enterprise-integration-create-integration-account.md)。 您必須有整合帳戶才能使用解碼 EDIFACT 訊息連接器。 
...
3. 在搜尋方塊中，輸入 "EDIFACT" 做為篩選條件。 選擇**解碼 EDIFACT 消息**。
