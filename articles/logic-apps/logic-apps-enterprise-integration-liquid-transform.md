...
1. 在此範例中，您會建立此步驟中描述的 Liquid 範本範例。 在液體範本中,您可以使用[液體篩檢程式](https://shopify.github.io/liquid/basics/introduction/#filters),使用[DotLiquid](https://github.com/dotliquid/dotliquid)和 C# 命名約定。
