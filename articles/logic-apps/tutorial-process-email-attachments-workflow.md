...
1. 您必須先透過下列設定[建立函式應用程式](../azure-functions/functions-create-function-app-portal.md)，才能建立函式：
   ...
   若要建立函數應用程式，您也可以使用 [Azure CLI](../azure-functions/create-first-function-cli-csharp.md)，或使用 [PowerShell 和 Resource Manager 範本](../azure-resource-manager/templates/deploy-powershell.md)。
