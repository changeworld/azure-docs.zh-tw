...
1. 在搜尋方塊中，尋找並選取您想要的動作。
   ...
   ![顯示邏輯應用程式設計工具中 [選擇動作] 視窗的螢幕擷取畫面。](media/logic-apps-control-flow-branches/find-select-parallel-action.png)
...
1. 在搜尋方塊中，尋找並選取您想要的動作。
   ...
   ![顯示邏輯應用程式設計工具中 [選擇動作] 視窗和搜尋方塊的螢幕擷取畫面。](media/logic-apps-control-flow-branches/find-select-sequential-action.png)
...
* 如有任何問題，請瀏覽 [Azure Logic Apps 的 Microsoft 問與答頁面](/answers/topics/azure-logic-apps.html)。
