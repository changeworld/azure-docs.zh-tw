...
本教學課程說明如何在[虛擬網路](../../virtual-network/virtual-networks-overview.md)中，使用適用於 PostgreSQL 的 Azure 資料庫 - 彈性伺服器 (預覽) 建立 Azure App Service Web 應用程式。
