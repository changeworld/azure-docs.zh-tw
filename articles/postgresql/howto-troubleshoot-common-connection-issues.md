---
title: 容毀毀連線 - Azure 資料庫,用於 PostgreSQL - 單一伺服器
...
ms.locfileid: "81767609"
---
# <a name="troubleshoot-connection-issues-to-azure-database-for-postgresql---single-server"></a>排除與 Azure 資料庫的連線問題,用於 PostgreSQL - 單一伺服器
