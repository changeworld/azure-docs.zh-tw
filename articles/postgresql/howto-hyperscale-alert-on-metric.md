...
* 請考慮增加背景工作節點的[容量](howto-hyperscale-scaling.md#increase-or-decrease-vcores-on-nodes)。 每個背景工作角色最多可以有2個 TiB 的儲存體。 不過，應該先嘗試加入節點，再調整節點大小，因為新增節點的速度會更快完成。
