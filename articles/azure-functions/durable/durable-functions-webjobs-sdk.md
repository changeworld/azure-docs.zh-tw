...
在2.x 版的 Webjob SDK 中，主機是的執行 `IHost` ，而在2.x 版中，您使用 `JobHost` 物件。
...
* 透過 **Azure 開發**工作負載[安裝 Visual Studio 2019](https://docs.microsoft.com/visualstudio/install/)。
