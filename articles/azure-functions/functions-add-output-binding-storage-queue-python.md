...
> [!TIP]
> 在啟動期間，主機會下載並安裝[儲存體繫結延伸模組](functions-bindings-storage-blob.md#add-to-your-functions-app)和其他 Microsoft 繫結延伸模組。 之所以會執行此安裝，是因為具有下列屬性的 *host.json* 檔案依預設會啟用繫結延伸模組：
>
> ```json
> {
>     "version": "2.0",
