...
在本文中，範例目前僅適用于 JavaScript （Node.js）和 c # 類別庫函式。  
...
Visual Studio Code 可讓您遵循一組方便的提示，將系結新增至檔案中的 function.js。 若要建立系結，請在函式資料夾中function.js的檔案**上**按一下滑鼠右鍵（Ctrl + 按一下 [macOS]），然後選取 [**新增**系結]：
...
* 安裝所選語言的特定需求：
    ...
    <sup>*</sup>Active LTS and 維護 LTS 版本（建議使用建議使用8.11.1 和10.14.1）。
