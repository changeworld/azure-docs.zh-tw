...
開始之前，您必須先完成[快速入門：從命令列建立 Azure Functions 專案](create-first-function-cli-node.md)。 如果您已在該文章結束時清除資源，請重新執行這些步驟以在 Azure 中重新建立函式應用程式和相關資源。  
::: zone-end   
::: zone pivot="programming-language-java"  
開始之前，您必須先完成[快速入門：從命令列建立 Azure Functions 專案](create-first-function-cli-java.md)。 如果您已在該文章結束時清除資源，請重新執行這些步驟以在 Azure 中重新建立函式應用程式和相關資源。  
::: zone-end   
::: zone pivot="programming-language-typescript"  
開始之前，您必須先完成[快速入門：從命令列建立 Azure Functions 專案](create-first-function-cli-typescript.md)。 如果您已在該文章結束時清除資源，請重新執行這些步驟以在 Azure 中重新建立函式應用程式和相關資源。  
::: zone-end   
::: zone pivot="programming-language-python"  
開始之前，您必須先完成[快速入門：從命令列建立 Azure Functions 專案](create-first-function-cli-python.md)。 如果您已在該文章結束時清除資源，請重新執行這些步驟以在 Azure 中重新建立函式應用程式和相關資源。  
::: zone-end   
::: zone pivot="programming-language-powershell"  
開始之前，您必須先完成[快速入門：從命令列建立 Azure Functions 專案](create-first-function-cli-powershell.md)。 如果您已在該文章結束時清除資源，請重新執行這些步驟以在 Azure 中重新建立函式應用程式和相關資源。  
::: zone-end   
