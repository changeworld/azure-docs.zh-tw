---
title: Azure 函數觸發器和綁定示例
description: 瞭解如何配置 Azure 函數綁定
...
---
# <a name="azure-functions-trigger-and-binding-example"></a>Azure 函數觸發器和綁定示例

本文演示如何在 Azure 函數中配置[觸發器和綁定](./functions-triggers-bindings.md)。
...
## <a name="class-library-example"></a>類庫示例
...
現在，您有一個工作功能，該函數由 Azure 佇列觸發，並將資料輸出到 Azure 表存儲。

## <a name="next-steps"></a>後續步驟

> [!div class="nextstepaction"]
> [Azure 函數綁定運算式模式](./functions-bindings-expressions-patterns.md)
