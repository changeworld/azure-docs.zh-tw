...
此課程模組使用 sklearn 的 OneVsOneClassifier，您可以在 [此](https://scikit-learn.org/stable/modules/generated/sklearn.multiclass.OneVsOneClassifier.html)深入瞭解詳細資料。
