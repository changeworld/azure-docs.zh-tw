...
description: 瞭解如何使用 Azure Machine learning 服務和/或 MLFlow，從 DSVM 追蹤並記錄實驗。
...
ms.locfileid: "88817512"
---
# <a name="track-experiments-and-deploy-models-in-azureml"></a>在 AzureML 中追蹤實驗及部署模型
