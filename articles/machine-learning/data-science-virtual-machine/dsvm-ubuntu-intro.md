...
1. 輸入下列資訊以設定精靈的每個步驟：
    ...
    1. **基本**：
       ...
       * **映像**：保留預設值。
       * **Size**：此選項應會自動填入適合一般工作負載的大小。 深入了解 [Azure 中的 Linux VM 大小](../../virtual-machines/linux/sizes.md)。
...
>[!NOTE]
> 如果您在這個階段收到 500 錯誤，原因很可能是您的使用者名稱中使用了大寫字母。 這是 Jupyter 中樞與其使用的 PAMAuthenticator 之間的已知互動。 
...
* 了解如何使用 [Team Data Science Process](https://aka.ms/tdsp) 以系統化方式建置分析解決方案。
