...
設定實驗時,可以啟用進階`featurization`設定 。 下表顯示了[AutoMLConfig 類](/python/api/azureml-train-automl-client/azureml.train.automl.automlconfig.automlconfig)中用於進行壯舉的接受設置。
