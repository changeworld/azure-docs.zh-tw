...
提交定型回合之後，會傳回 [執行](https://docs.microsoft.com/python/api/azureml-core/azureml.core.run%28class%29?view=azure-ml-py) 物件。 `properties`此物件的屬性包含已記錄的 git 資訊。 例如，下列程式碼會捕獲認可雜湊：
