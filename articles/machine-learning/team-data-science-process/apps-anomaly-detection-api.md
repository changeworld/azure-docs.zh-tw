...
您可以在[這裡](https://services.azureml.net/plans/)管理您的計費方案。  方案名稱會以您在部署 API 時選擇的資源群組名稱為主，加上您的訂用帳戶中的唯一字串。  在[這裡](../classic/manage-new-webservice.md) (「管理計費方案」一節之下) 可取得有關如何升級方案的指示。
