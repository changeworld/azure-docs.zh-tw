...
## <a name="example-2-creating-features-in-text-mining"></a><a name="example2"></a> 範例 2：在文字採礦中建立特性
...
為了達成此工作，會套用名為特性雜湊**** 的技術，有效地將任意文字特性變成索引。 此方法不會將每個文字特性 (文字/片語) 關聯至特定索引，而是將雜湊函數套用至特性並直接使用其雜湊值作為索引。
