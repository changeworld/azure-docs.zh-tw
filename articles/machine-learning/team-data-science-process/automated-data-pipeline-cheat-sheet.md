...
根據資料是本地、雲還是即時流，可以使用不同的機制將資料移動到 Web 服務終結點進行評分。
...
![微軟 Azure 機器學習工作室（經典）功能概述][op-cheat-sheet]
...
* 有關 Microsoft Azure 機器學習的概述，請參閱[Microsoft Azure 上的機器學習簡介](../studio/what-is-machine-learning.md)。
