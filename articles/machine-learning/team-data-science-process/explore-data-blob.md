...
1. 使用 Blob 服務使用以下 Python 代碼範例從 Azure Blob 下載資料。 使用您的特定值來取代下列程式碼中的變數：
...
## <a name="examples-of-data-exploration-using-pandas"></a><a name="blob-dataexploration"></a>使用貓熊進行資料探索範例
