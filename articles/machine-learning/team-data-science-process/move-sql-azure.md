...
## <a name="file-to-azure-sql-database"></a>將資料從一般檔案來源移動到 Azure SQL Database
...
## <a name="sql-on-prem-to-sazure-sql-database"></a>將資料從內部部署 SQL Server 移至 Azure SQL Database
