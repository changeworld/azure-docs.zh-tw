...
幸運的是，您可以使用 [Azure Machine Learning studio (傳統) ](/azure/machine-learning/studio/retrain-machine-learning-model) 重新定型 API 來完成這項作業，並使用 [Azure Machine Learning Studio (傳統) PowerShell](powershell-module.md)來自動化工作。
