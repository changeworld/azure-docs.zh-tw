---
title: ML Studio (傳統) ： REST API 錯誤碼-Azure
...
ms.locfileid: "91357245"
---
# <a name="azure-machine-learning-studio-classic-rest-api-error-codes"></a>Azure Machine Learning Studio (傳統) REST API 錯誤碼
...
此類錯誤表示某處提供的引數無效。 對於傳遞至 web 服務的項目而言，這可能是 Azure 儲存體的認證或位置。 請查看 [詳細資料] 區段中的「程式碼」欄位，以診斷哪個特定的引數無效。
...
| ModelPackageIdInvalid | 模型封裝識別碼無效。請確認模型封裝識別碼是否正確，然後再試一次。 |
