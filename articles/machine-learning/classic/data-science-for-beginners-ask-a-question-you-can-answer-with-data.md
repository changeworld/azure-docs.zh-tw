---
title: 提出問題資料可回答-ML Studio (傳統) -Azure
...
假設您找到一個神燈，其中的精靈將如實回答您詢問的任何問題。 但這是 mischievous 的瓶精靈，他們會嘗試在不清楚而令人困惑的情況下，讓他們的答案變得更清楚而令人困惑。 您想要使用問題來釘選它們，無懈可擊它們無法提供協助，而是告訴您想要知道什麼。
