...
ms.locfileid: "86206494"
---
# <a name="manage-azure-machine-learning-resources-with-the-vs-code-extension-preview"></a>使用 VS Code 延伸模組 (預覽來管理 Azure Machine Learning 資源) 
...
1. 在提示字元中：
    ...
    1.  (選擇性) 選擇您是否要建立定型回合的資料參考。 這麼做會提示您在執行設定中定義資料集。
