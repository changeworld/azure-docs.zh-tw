...
description: 如何調試 Azure 機器學習工作室中由訓練模型和分數模型模組生成的錯誤（經典）。
...
ms.locfileid: "79218091"
---
# <a name="debug-your-model-in-azure-machine-learning-studio-classic"></a>在 Azure 機器學習工作室中調試模型（經典）
...
1. Azure 機器學習工作室提供的模型集合中的機器學習模型類型（經典）。
