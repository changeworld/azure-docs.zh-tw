...
* **自動產生的儲存體帳戶** – 正如其名，這類型的儲存體帳戶是在初次建立服務時自動產生。 若要深入了解如何建立此儲存體帳戶，請參閱[部署您的內部部署 StorSimple 裝置](storsimple-8000-deployment-walkthrough-u2.md#step-1-create-a-new-service)中的[步驟 1：建立新的服務](storsimple-8000-deployment-walkthrough-u2.md)。 
