...
如需有關如何安裝驅動程式、Storport、Spaceport 及磁碟韌體更新的詳細資訊，請參閱在您的 StorSimple 裝置上 [安裝 Update 2.2](./storsimple-8000-install-update-5.md) 。

## <a name="virtual-device-updates-in-update-22"></a>Update 2.2 中的虛擬裝置更新
這項更新無法套用至虛擬裝置。 將需要建立新的虛擬裝置。 

## <a name="next-step"></a>後續步驟
了解如何在 StorSimple 裝置上 [安裝 Update 2.2](./storsimple-8000-install-update-5.md) 。