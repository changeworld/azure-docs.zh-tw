...
StorSimple 5000-7000 系列和 StorSimple 8000 系列客戶可以選擇遷移到 Panzura 自由 NAS 以將其數據保存在 Azure 中。 Panzura 自由解決方案提供覆蓋資料中心、辦公室、公共雲和私有雲的 NAS 解決方案。 此解決方案可針對 NFS、SMB 和行動用戶端啟用本機、混合式及雲端內資料工作流程。
