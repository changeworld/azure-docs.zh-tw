...
1. 從 StorSimple 服務摘要刀鋒視窗中，從命令列按一下 [+ 新增磁碟區]  。 這會開啟 [新增磁碟區]  刀鋒視窗。
    ...
    ![螢幕擷取畫面顯示 [新增磁片區] 按鈕和 [新增磁片區] 窗格。](./media/storsimple-virtual-array-manage-volumes/add-volume.png)
...
3. 若要新增連接的主機，請按一下 [新增]  ，輸入主機的名稱及其 iSCSI 合格名稱 (IQN)，然後按一下 [新增]  。
    ...
    ![螢幕擷取畫面顯示 [已連線的主機] 窗格，您可以在其中加入新的。](./media/storsimple-virtual-array-manage-volumes/volume-add-acr.png)
...
4. 當 [刪除]  。 現在將刪除磁碟區，[磁碟區]  刀鋒視窗會顯示虛擬陣列內更新的磁碟區清單。
