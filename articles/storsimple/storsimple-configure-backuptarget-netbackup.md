...
description: 瞭解 StorSimple 備份目標設定與 Veritas NetBackup，以及整合這兩種解決方案的最佳作法。
services: storsimple
documentationcenter: ''
author: harshakirank
manager: matd
...
1.  在 NetBackup 管理主控台中，選取 [**媒體和裝置管理**] [裝置] [  >  **Devices**  >  **磁片**集區]。 在 [磁碟集區設定精靈] 中，選取 [AdvancedDisk]**** 儲存體伺服器類型，然後選取 [下一步]****。
...
4.  輸入備份目標的名稱，然後選取 [下一**Next**  >  **步**] 以完成嚮導。
