...
下表提供 StorSimple Virtual Array 的已知問題摘要，並包含舊版所列的問題。 **此版本中注意到的問題版本標有星號。此清單中幾乎所有問題都從 StorSimple 虛擬陣列的 GA 版本中轉移過來。**
...
[在](storsimple-ova-install-update-01.md)StorSimple 虛擬陣列上安裝更新。
