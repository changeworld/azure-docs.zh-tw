...
- 若要先在 Azure 來源上建立系統主題，然後建立該主題的事件訂用帳戶，請參閱下列參考主題：
    - [az eventgrid system-主題 create](/cli/azure/ext/eventgrid/eventgrid/system-topic?view=azure-cli-latest#ext-eventgrid-az-eventgrid-system-topic-create)
    ...
    - [az eventgrid system-主題事件-訂用帳戶建立](/cli/azure/ext/eventgrid/eventgrid/system-topic/event-subscription?view=azure-cli-latest#ext-eventgrid-az-eventgrid-system-topic-event-subscription-create)
        ...
        ```
- 若要建立系統主題 (在建立 Azure 來源的事件訂用帳戶時隱含) ，請使用 [az eventgrid 事件訂](/cli/azure/ext/eventgrid/eventgrid/event-subscription?view=azure-cli-latest#ext-eventgrid-az-eventgrid-event-subscription-create) 用帳戶建立方法。 以下為範例：
...
- [az eventgrid 系統-主題清單](/cli/azure/ext/eventgrid/eventgrid/system-topic?view=azure-cli-latest#ext-eventgrid-az-eventgrid-system-topic-list)

    ```azurecli-interactive
    az eventgrid system-topic list   
     ```
- [az eventgrid system-主題 show](/cli/azure/ext/eventgrid/eventgrid/system-topic?view=azure-cli-latest#ext-eventgrid-az-eventgrid-system-topic-show)
...
- [az eventgrid system-主題 delete](/cli/azure/ext/eventgrid/eventgrid/system-topic?view=azure-cli-latest#ext-eventgrid-az-eventgrid-system-topic-delete)
