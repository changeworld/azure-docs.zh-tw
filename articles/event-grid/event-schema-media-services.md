...
---
# <a name="azure-media-services-as-an-event-grid-source"></a>Azure 媒體服務作為事件網格來源
...
您可以在[即時事件錯誤程式](../media-services/latest/live-event-error-codes.md)碼中找不到錯誤結果代碼。
