---
title: 作為事件方格來源的 Azure 通訊服務
description: 本文說明如何使用 Azure 通訊服務作為事件方格事件來源。
ms.topic: conceptual
ms.date: 07/07/2020
ms.author: mikben
...
> [!IMPORTANT]
> Azure 通訊服務目前處於公開預覽狀態。
> 此預覽版本是在沒有服務等級協定的情況下提供，不建議用於生產工作負載。 可能不支援特定功能，或可能已經限制功能。 如需詳細資訊，請參閱 [Microsoft Azure 預覽版增補使用條款](https://azure.microsoft.com/support/legal/preview-supplemental-terms/)。

本文提供 Azure 通訊服務事件的屬性和架構。 如需事件結構描述的簡介，請參閱 [Azure Event Grid 事件結構描述](event-schema.md)。
