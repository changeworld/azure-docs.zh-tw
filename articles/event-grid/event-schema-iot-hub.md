---
title: Azure IoT 中心作為事件網格源
description: 本文提供 Azure IoT 中樞事件的屬性和結構描述。 它列出了可用的事件類型、範例事件和事件屬性。
services: iot-hub
documentationcenter: ''
author: spelluru
editor: ''
...
---
# <a name="azure-iot-hub-as-an-event-grid-source"></a>Azure IoT 中心作為事件網格源
...
對於**裝置遙測**IoT 中心事件,資料物件包含[IoT 中心訊息格式](../iot-hub/iot-hub-devguide-messages-construct.md)的裝置到雲端訊息,具有以下屬性:
...
| 屬性 | 類型 | 描述 |
| -------- | ---- | ----------- |
| twin | 物件 (object) | 有關設備孿生的資訊,即應用程式設備元數據的雲表示形式。 | 
