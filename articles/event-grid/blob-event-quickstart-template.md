...
* [ **"Microsoft.Storage/storageAccounts/providers/eventSubscriptions**](/azure/templates/microsoft.eventgrid/eventsubscriptions)：建立儲存體帳戶的 Azure 事件方格訂用帳戶。
