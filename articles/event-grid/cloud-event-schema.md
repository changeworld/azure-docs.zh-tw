...
---
# <a name="cloudevents-v10-schema-with-event-grid"></a>雲事件 v1.0 架構與事件網格
...
## <a name="sample-event-using-cloudevents-schema"></a>使用雲端事件架構的範例事件
...
## <a name="event-grid-for-cloudevents"></a>雲事件事件網格
...
請參考[如何使用雲事件 v1.0 架構與事件網格](cloudevents-schema.md)。  
