...
---
# <a name="azure-event-hubs-as-an-event-grid-source"></a>以事件方格來源 Azure 事件中樞
...
| sizeInBytes | 整數 | 檔案大小。 |
| eventCount | 整數 | 檔案中的事件數目。 |
| firstSequenceNumber | 整數 | 來自佇列的最小序號。 |
| lastSequenceNumber | 整數 | 來自佇列的最後一個序號。 |
