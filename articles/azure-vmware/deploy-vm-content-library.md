---
title: 建立內容庫以在 Azure VMware Solution (AVS) 中部署 VM
...
ms.locfileid: "86014210"
---
# <a name="create-a-content-library-to-deploy-vms-in-azure-vmware-solution-avs"></a>建立內容庫以在 Azure VMware Solution (AVS) 中部署 VM
