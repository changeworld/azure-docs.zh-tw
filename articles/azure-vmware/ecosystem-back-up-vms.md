...
Commvault、Veritas 和 Veeam 在 VMware 環境中有領先的備份與還原解決方案。 客戶已廣泛採用這些解決方案來進行內部部署。 這些合作夥伴現在已將其解決方案延伸到 Azure VMware 解決方案，並使用 Azure 來提供備份儲存機制，以及長期保留和封存的儲存體目標。
