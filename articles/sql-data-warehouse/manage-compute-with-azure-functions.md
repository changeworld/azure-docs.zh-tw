...
目前範本中只包含兩個調整函式。 使用這些函式，在一天當中，您只能縮小一次和擴大一次。 您必須新增另一個觸發程序，才能取得更細微的控制，例如每日相應減少多次或在週末有不同的調整行為。
...
3. 替函式命名並設定您的排程。 此影像顯示使用者如何在每個星期六午夜 (星期五深夜) 觸發其函式。
   ...
   ![週六縮小](media/manage-compute-with-azure-functions/scale-down-saturday.png)
...
每天上午 8 點擴大至 DW600，在下午 8 點縮小至 DW200。
...
每天上午 8 點擴大至 DW1000、在下午 4 點一度縮小至 DW600，並在下午 10 點縮小至 DW200。
...
在工作日的上午 8 點擴大至 DW1000，在下午 4 點一度縮小至 DW600。 在星期五晚上 11 點暫停，在星期一上午 7 點繼續。
