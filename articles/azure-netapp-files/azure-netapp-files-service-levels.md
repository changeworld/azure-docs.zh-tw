...
* 在範例1中，自動 QoS 容量集區中的磁片區，具有指派2個配額 TiB 的 Premium 儲存層，將會獲指派 128 MiB/秒的輸送量限制 (2 TiB * 64 MiB/s) 。 無論容量集區大小或實際的磁片區耗用量為何，都適用此案例。

* 在範例2中，自動 QoS 容量集區中的磁片區具有指派 100 GiB 配額的 Premium 儲存層，將會獲指派 6.25 MiB/s 的輸送量限制 (0.09765625 TiB * 64 MiB/s) 。 無論容量集區大小或實際的磁片區耗用量為何，都適用此案例。
...
例如，在 SAP Hana 系統中，此容量集區可用來建立下列磁片區。 每個磁片區都會提供個別大小和輸送量，以符合您的應用程式需求：

* SAP Hana 資料磁片區：大小 4 TiB，最高 704 MiB/秒
* SAP Hana 記錄磁片區：大小 0.5 TiB，最高可達 256 MiB/秒
* SAP Hana 共用磁片區：大小 1 TiB，最高 64 MiB/秒
* SAP Hana 備份磁片區：大小 4.5 TiB，最高可達 256 MiB/秒
...
- [建立容量集區](azure-netapp-files-set-up-capacity-pool.md)
