...
[拒絕指派](deny-assignments.md)會封鎖使用者執行特定的 Azure 資源動作，即使角色指派授予他們存取權也一樣。 本文說明如何使用 Azure PowerShell 列出拒絕指派。
...
- `Microsoft.Authorization/denyAssignments/read` 許可權，其包含在[適用于 Azure 資源的大部分內建角色](built-in-roles.md)中
