...
ms.locfileid: "80283152"
---
# <a name="azure-resource-manager-resource-provider-operations"></a>Azure Resource Manager 資源提供者作業

本文會列出每個 Azure Resource Manager 資源提供者可用的作業。 這些操作可用於 Azure[自訂角色](custom-roles.md)，以便對 Azure 中的資源提供精細的存取控制。 操作字串具有以下格式： `{Company}.{ProviderName}/{resourceType}/{action}`。 有關資來源提供者命名空間如何映射到 Azure 服務的清單，請參閱[將資來源提供者匹配到服務](../azure-resource-manager/management/azure-services-resource-providers.md)。
...
Azure 服務[：Azure 活動目錄域服務](../active-directory-domain-services/index.yml)
...
> |  | **服務/報告** |  |
> | 動作 | 微軟.ADHybridHealthService/服務/報告/生成BlobUri/行動 | 生成有風險的 IP 報告並返回指向它的 URI。 |
> |  | **服務/報告/blobUris** |  |
...
> |  | **服務/服務人員/指標** |  |
> | 動作 | 微軟.ADHybridHealthService/服務/服務人員/指標/讀取 | 獲取給定服務和服務成員的連接器和回合組態檔案名稱的清單。 |
> |  | **服務/服務成員/指標/組** |  |
...
> |  | **警報MetaData** |  |
> | 動作 | 微軟.警報管理/警報中繼資料/讀取 | 獲取輸入參數的警報中繼資料。 |
> |  | **alertsSummary** |  |
...
> | 動作 | 微軟.警報管理/智慧探測器警報規則/寫入 | 在給定訂閱中創建或更新智慧檢測器警報規則 |
> | 動作 | 微軟.警報管理/智慧探測器警報規則/讀取 | 獲取輸入濾波器的所有智慧檢測器警報規則 |
> | 動作 | 微軟.警報管理/智慧探測器警報規則/刪除 | 刪除給定訂閱中的智慧探測器警報規則 |
> |  | **smartGroups** |  |
...
> |  | **服務** |  |
> | 動作 | Microsoft.ApiManagement/service/write | 創建或更新 API 管理服務實例 |
...
> | 動作 | 微軟.Api管理/服務/閘道/操作 | 檢索閘道配置。 或更新閘道活動訊號。 |
> |  | **服務/服務** |  |
> | 動作 | Microsoft.ApiManagement/service/apis/read | 列出 API 管理服務實例的所有 API。 或獲取其識別碼指定的 API 的詳細資訊。 |
> | 動作 | Microsoft.ApiManagement/service/apis/write | 創建 API 管理服務實例的新或更新現有的指定 API。 或更新 API 管理服務實例的指定 API。 |
...
> | 動作 | Microsoft.ApiManagement/service/apis/issues/attachments/delete | 從問題中刪除指定的注釋。 |
> |  | **服務/問題/評論** |  |
> | 動作 | Microsoft.ApiManagement/service/apis/issues/comments/read | 列出與指定 API 關聯的問題的所有注釋。 或獲取由其識別碼指定的 API 的問題注釋的詳細資訊。 |
> | 動作 | Microsoft.ApiManagement/service/apis/issues/comments/write | 在 API 中為問題創建新的注釋或更新現有注釋。 |
> | 動作 | Microsoft.ApiManagement/service/apis/issues/comments/delete | 從問題中刪除指定的注釋。 |
> |  | **服務/服務/服務/操作** |  |
...
> |  | **服務/服務/服務/操作/策略** |  |
> | 動作 | Microsoft.ApiManagement/service/apis/operations/policies/read | 在 API 操作級別獲取策略配置清單。 或在 API 操作級別獲取策略配置。 |
> | 動作 | Microsoft.ApiManagement/service/apis/operations/policies/write | 為 API 操作級別創建或更新策略配置。 |
> | 動作 | Microsoft.ApiManagement/service/apis/operations/policies/delete | 刪除 Api 操作中的策略配置。 |
> |  | **服務/服務/服務/操作/策略** |  |
> | 動作 | Microsoft.ApiManagement/service/apis/operations/policy/read | 在操作級別獲取策略配置 |
> | 動作 | Microsoft.ApiManagement/service/apis/operations/policy/write | 在操作級別創建策略配置 |
> | 動作 | Microsoft.ApiManagement/service/apis/operations/policy/delete | 刪除操作級別的策略配置 |
> |  | **服務/服務/服務/操作/標籤** |  |
...
> |  | **服務/服務/服務/政策** |  |
> | 動作 | Microsoft.ApiManagement/service/apis/policy/read | 在 API 級別獲取策略配置 |
> | 動作 | Microsoft.ApiManagement/service/apis/policy/write | 在 API 級別創建策略配置 |
> | 動作 | Microsoft.ApiManagement/service/apis/policy/delete | 刪除 API 級別的策略配置 |
> |  | **服務/產品/產品** |  |
...
> | 動作 | Microsoft.ApiManagement/service/apis/releases/write | 為 API 創建新版本。 或更新其識別碼指定的 API 發佈的詳細資訊。 |
> |  | **服務/服務/修訂** |  |
...
> |  | **服務/服務/圖片/標籤描述** |  |
> | 動作 | Microsoft.ApiManagement/service/apis/tagDescriptions/read | 在 API 範圍內列出所有標記說明。 模型類似于揮霍 - 標記描述在 API 級別上定義，但標記可以分配給操作或獲取 API 範圍內的標記描述 |
...
> | 動作 | Microsoft.ApiManagement/service/apiVersionSets/write | 創建或更新 Api 版本集。 或更新其識別碼指定的 Api 版本集的詳細資訊。 |
...
> | 動作 | Microsoft.ApiManagement/service/authorizationServers/write | 創建新的授權伺服器或更新現有授權伺服器。 或更新其識別碼指定的授權伺服器的詳細資訊。 |
...
> | 動作 | Microsoft.ApiManagement/service/backends/write | 創建或更新後端。 或更新現有後端。 |
> | 動作 | Microsoft.ApiManagement/service/backends/delete | 刪除指定的後端。 |
> | 動作 | Microsoft.ApiManagement/service/backends/reconnect/action | 通知 APIM 代理在指定超時後創建到後端的新連接。 如果未指定超時，則使用 2 分鐘的超時。 |
> |  | **服務/緩存** |  |
> | 動作 | 微軟.Api管理/服務/緩存/讀取 | 列出指定服務實例中所有外部緩存的集合。 或獲取其識別碼指定的緩存的詳細資訊。 |
> | 動作 | 微軟.Api管理/服務/緩存/寫入 | 創建或更新要在 Api 管理實例中使用的外部緩存。 或更新其識別碼指定的緩存的詳細資訊。 |
> | 動作 | 微軟.Api管理/服務/緩存/刪除 | 刪除特定緩存。 |
> |  | **服務/證書** |  |
> | 動作 | Microsoft.ApiManagement/service/certificates/read | 列出指定服務實例中所有證書的集合。 或獲取其識別碼指定的證書的詳細資訊。 |
> | 動作 | Microsoft.ApiManagement/service/certificates/write | 創建或更新用於後端身份驗證的證書。 |
...
> | 動作 | 微軟.Api管理/服務/閘道/寫入 | 創建或更新要在 Api 管理實例中使用的閘道。 或更新其識別碼指定的閘道的詳細資訊。 |
> | 動作 | 微軟.Api管理/服務/閘道/刪除 | 刪除特定閘道。 |
> | 動作 | 微軟.Api管理/服務/閘道/清單鍵/操作 | 檢索閘道金鑰。 |
> | 動作 | 微軟.Api管理/服務/閘道/再生鍵/操作 | 重新生成指定的閘道金鑰無效，將驗證使用它創建的任何權杖。 |
> | 動作 | 微軟.Api管理/服務/閘道/生成權杖/操作 | 獲取閘道的共用訪問授權權杖。 |
> |  | **服務/閘道/apis** |  |
...
> |  | **服務/閘道/主機名稱配置** |  |
> | 動作 | 微軟.Api管理/服務/閘道/主機名稱配置/讀取 | 列出指定閘道的主機名稱組態集合。 |
> |  | **服務/組** |  |
...
> | 動作 | Microsoft.ApiManagement/service/groups/delete | 刪除 API 管理服務實例的特定組。 |
> |  | **服務/組/使用者** |  |
> | 動作 | Microsoft.ApiManagement/service/groups/users/read | 列出與組關聯的使用者實體的集合。 |
...
> |  | **服務/問題** |  |
> | 動作 | 微軟.Api管理/服務/問題/閱讀 | 列出指定服務實例中的問題集合。 或獲取 API 管理問題詳細資訊 |
> |  | **服務/位置/網路狀態** |  |
...
> | 動作 | 微軟.Api管理/服務/命名值/寫入 | 創建或更新命名值。 或更新特定的命名值。 |
> | 動作 | 微軟.Api管理/服務/命名值/刪除 | 從 API 管理服務實例中刪除特定的命名值。 |
...
> | 動作 | Microsoft.ApiManagement/service/notifications/recipientEmails/write | 將電子郵件地址添加到通知的收件者清單中。 |
...
> |  | **服務/開放連接供應商** |  |
> | 動作 | Microsoft.ApiManagement/service/openidConnectProviders/read | 所有 OpenId 連接提供程式的清單。 或獲取特定的 OpenID 連接提供程式，無機密。 |
> | 動作 | Microsoft.ApiManagement/service/openidConnectProviders/write | 創建或更新 OpenID 連接提供程式。 或更新特定的 OpenID 連接提供程式。 |
> | 動作 | Microsoft.ApiManagement/service/openidConnectProviders/delete | 刪除 API 管理服務實例的特定 OpenID 連接提供程式。 |
> | 動作 | 微軟.Api管理/服務/開放連接供應商/清單秘密/操作 | 獲取特定的 OpenID 連接提供程式機密。 |
> |  | **服務/操作結果** |  |
> | 動作 | Microsoft.ApiManagement/service/operationresults/read | 取得長時間執行之作業的目前狀態 |
> |  | **服務/策略** |  |
> | 動作 | Microsoft.ApiManagement/service/policies/read | 列出 Api 管理服務的所有全域原則定義。 或獲取 Api 管理服務的全域原則定義。 |
> | 動作 | Microsoft.ApiManagement/service/policies/write | 創建或更新 Api 管理服務的全域原則配置。 |
> | 動作 | Microsoft.ApiManagement/service/policies/delete | 刪除 Api 管理服務的全域原則配置。 |
> |  | **服務/政策** |  |
> | 動作 | 微軟.Api管理/服務/策略/讀取 | 在租戶級別獲取策略配置 |
> | 動作 | 微軟.Api管理/服務/策略/寫入 | 在租戶級別創建策略配置 |
> | 動作 | 微軟.Api管理/服務/策略/刪除 | 刪除租戶級別的策略配置 |
> |  | **服務/策略描述** |  |
> | 動作 | 微軟.Api管理/服務/策略描述/閱讀 | 列出所有策略說明。 |
> |  | **服務/策略片段** |  |
> | 動作 | Microsoft.ApiManagement/service/policySnippets/read | 列出所有策略程式碼片段。 |
> |  | **服務/門戶設置** |  |
> | 動作 | Microsoft.ApiManagement/service/portalsettings/read | 列出門戶設置的集合。 或獲取門戶的"登錄設置"或"獲取門戶註冊設置"或"獲取門戶委派設定"。 |
> | 動作 | Microsoft.ApiManagement/service/portalsettings/write | 更新登錄設置。 或創建或更新登錄設置。 或更新註冊設置或更新註冊設置或更新委派設定。 或創建或更新委派設定。 |
> | 動作 | 微軟.Api管理/服務/門戶設置/清單秘密/操作 | 獲取門戶委派設定的驗證金鑰。 |
> |  | **服務/產品** |  |
...
> | 動作 | Microsoft.ApiManagement/service/products/groups/delete | 刪除指定組和產品之間的關聯。 |
> |  | **服務/產品/政策** |  |
...
> |  | **服務/產品/政策** |  |
> | 動作 | Microsoft.ApiManagement/service/products/policy/read | 在產品級別獲取策略配置 |
> | 動作 | Microsoft.ApiManagement/service/products/policy/write | 在產品級別創建策略配置 |
> | 動作 | Microsoft.ApiManagement/service/products/policy/delete | 刪除產品級別的策略配置 |
> |  | **服務/產品/訂閱** |  |
...
> |  | **服務/訂閱** |  |
> | 動作 | Microsoft.ApiManagement/service/subscriptions/read | 列出 API 管理服務實例的所有訂閱。 或獲取指定的訂閱實體（不帶金鑰）。 |
...
> | 動作 | Microsoft.ApiManagement/service/subscriptions/regeneratePrimaryKey/action | 重新生成 API 管理服務實例的現有訂閱的主金鑰。 |
> | 動作 | Microsoft.ApiManagement/service/subscriptions/regenerateSecondaryKey/action | 重新生成 API 管理服務實例的現有訂閱的輔助金鑰。 |
...
> |  | **服務/租戶** |  |
> | 動作 | Microsoft.ApiManagement/service/tenant/read | 獲取 Api 管理服務的全域原則定義。 或獲取租戶訪問資訊詳細資訊 |
...
> |  | **服務/使用者** |  |
> | 動作 | Microsoft.ApiManagement/service/users/read | 列出指定服務實例中的註冊使用者的集合。 或獲取其識別碼指定的使用者的詳細資訊。 |
...
> | 動作 | Microsoft.ApiManagement/service/users/generateSsoUrl/action | 檢索包含用於將給定使用者登錄到開發人員門戶的身份驗證權杖的重定向 URL。 |
> | 動作 | Microsoft.ApiManagement/service/users/token/action | 獲取使用者的共用訪問授權權杖。 |
> |  | **服務/使用者/確認** |  |
...
> |  | **服務/使用者/身份** |  |
> | 動作 | 微軟.Api管理/服務/使用者/身份/讀取 | 所有使用者標識的清單。 |
> |  | **服務/使用者/金鑰** |  |
> | 動作 | Microsoft.ApiManagement/service/users/keys/read | 獲取與使用者關聯的金鑰 |
> |  | **服務/使用者/訂閱** |  |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.應用程式佈建/註冊/操作 | 註冊訂閱以使用 Microsoft 應用配置。 |
> |  | **檢查名稱可用性** |  |
> | 動作 | 微軟.應用程式佈建/檢查名稱可用性/讀取 | 檢查資源名稱是否可用。 |
> |  | **配置存儲** |  |
> | 動作 | 微軟.應用程式佈建/配置存儲/讀取 | 獲取指定配置存儲的屬性或列出指定資源組或訂閱下的所有配置存儲。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/寫入 | 使用指定的參數創建或更新配置存儲。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/刪除 | 刪除配置存儲。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/清單鍵/操作 | 列出指定配置存儲的 API 金鑰。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/再生鍵/操作 | 為指定的配置存儲重新生成 API 金鑰。 |
> | 動作 | 微軟.應用程式佈建/配置商店/清單鍵值/操作 | 列出指定配置存儲的鍵值。 |
> | 動作 | 微軟.應用配置/配置存儲/私有端點連接審批/操作 | 在指定的配置存儲下自動批准專用終結點連接。 |
> |  | **配置存儲/事件網格篩選器** |  |
> | 動作 | 微軟.應用程式佈建/配置商店/事件網格篩檢程式/讀取 | 獲取指定配置存儲事件網格篩選器的屬性，或列出指定配置存儲下的所有配置存儲事件網格篩選器。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/事件網格篩選/寫入 | 使用指定的參數創建或更新配置存儲事件網格篩選器。 |
> | 動作 | 微軟.應用程式佈建/配置商店/事件網格篩檢程式/刪除 | 刪除配置存儲事件網格篩選器。 |
> |  | **配置存儲/私有端接連接 Proxies** |  |
> | 動作 | 微軟.App配置/配置商店/私人終端連接Proxies/驗證/操作 | 在指定的配置存儲下驗證專用終結點連接代理。 |
> | 動作 | 微軟.App配置/配置商店/私人端接連接Proxies/讀取 | 在指定的配置存儲下獲取專用終結點連接代理。 |
> | 動作 | 微軟.應用程式佈建/配置商店/私人端接連接Proxies/寫 | 在指定的配置存儲下創建或更新專用終結點連接代理。 |
> | 動作 | 微軟.App配置/配置商店/私人終端連接Proxies/刪除 | 在指定的配置存儲下刪除專用終結點連接代理。 |
> |  | **配置存儲/專用端點連接** |  |
> | 動作 | 微軟.應用程式佈建/配置存儲/私有端點連接/讀取 | 獲取專用終結點連接或在指定的配置存儲下列出專用終結點連接。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/私有端點連接/寫入 | 在指定的配置存儲下批准或拒絕專用終結點連接。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/專用端點連接/刪除 | 刪除指定配置存儲下的專用終結點連接。 |
> |  | **配置存儲/私有連結資源** |  |
> | 動作 | 微軟.應用程式佈建/配置商店/私有連結資源/讀取 | 列出指定配置存儲下的所有專用連結資源。 |
> |  | **配置商店/供應商/微軟.見解/診斷設置** |  |
...
> |  | **配置存儲/同步任務** |  |
> | 動作 | 微軟.應用程式佈建/配置存儲/同步任務/讀取 | 獲取指定配置存儲同步任務的屬性，或列出指定配置存儲下的所有配置存儲同步任務。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/同步任務/寫入 | 使用指定的參數創建或更新配置存儲同步任務。 |
> | 動作 | 微軟.應用程式佈建/配置存儲/同步任務/刪除 | 刪除配置存儲同步任務。 |
> |  | **位置/操作狀態** |  |
> | 動作 | 微軟.應用程式佈建/位置/操作狀態/讀取 | 獲取操作的狀態。 |
> |  | **操作** |  |
> | 動作 | 微軟.應用程式佈建/操作/讀取 | 列出 Microsoft 應用配置支援的所有操作。 |
> |  | **配置存儲/鍵值** |  |
> | DataAction | 微軟.應用程式佈建/配置存儲/鍵值/讀取 | 從配置存儲讀取鍵值。 |
> | DataAction | 微軟.應用程式佈建/配置存儲/鍵值/寫入 | 在配置存儲中創建或更新鍵值。 |
> | DataAction | 微軟.應用程式佈建/配置存儲/鍵值/刪除 | 從配置存儲中刪除現有鍵值。 |

## <a name="microsoftauthorization"></a>Microsoft.Authorization

Azure 服務[：Azure 資源管理器](../azure-resource-manager/index.yml)
...
> | 動作 | 微軟.授權/策略/部署不存在/操作 | 在評估具有"部署不存在"效果的 Azure 策略時執行的操作 |
> |  | **策略分配** |  |
...
> |  | **自動化帳戶/私有端點連接Proxies** |  |
> | 動作 | 微軟.自動化/自動化帳戶/私人端接連接Proxies/讀取 | 讀取 Azure 自動化專用終結點連接代理 |
> | 動作 | 微軟.自動化/自動化帳戶/私人端接連接Proxies/寫 | 創建 Azure 自動化專用終結點連接代理 |
> | 動作 | 微軟.自動化/自動化帳戶/私人端接連接Proxies/驗證/操作 | 驗證專用終結點連接請求（組 Id 驗證） |
> | 動作 | 微軟.自動化/自動化帳戶/私人端接連接Proxies/刪除 | 刪除 Azure 自動化專用終結點連接代理 |
> |  | **自動化帳目/專用端接策略/操作結果** |  |
> | 動作 | 微軟.自動化/自動化帳戶/私人端接連接Proxies/操作結果/讀取 | 獲取 Azure 自動化專用終結點代理操作結果。 |
> |  | **自動化帳戶/專用端點連接** |  |
> | 動作 | 微軟.自動化/自動化帳戶/專用端點連接/讀取 | 獲取 Azure 自動化專用終結點連接狀態 |
...
> |  | **自動化帳戶/軟體更新配置機器運行** |  |
> | 動作 | 微軟.自動化/自動化帳戶/軟體更新配置機運行/讀取 | 獲取 Azure 自動化軟體更新配置電腦運行 |
> |  | **自動化帳戶/軟體更新配置運行** |  |
> | 動作 | 微軟.自動化/自動化帳戶/軟體更新配置運行/讀取 | 獲取 Azure 自動化軟體更新配置運行 |
...
> |  | **雲清單檔** |  |
> | 動作 | 微軟.AzureStack/雲清單檔/讀取 | 獲取雲清單檔 |
> |  | **作業** |  |
...
> | 動作 | 微軟.AzureStack/註冊/產品/上傳產品日誌/操作 | 記錄 Azure 堆疊應用商店產品操作狀態和時間戳記 |
...
> |  | **批次處理帳戶/私有終結點連接結果** |  |
> | 動作 | 微軟.批量/批次處理帳戶/私有終結點連接結果/讀取 | 獲取長時間運行的 Batch 帳戶專用終結點連接操作的結果 |
> |  | **批次處理帳戶/專用終結點連接** |  |
> | 動作 | 微軟.批次處理/批次處理帳戶/私有終結點連接/寫入 | 更新批次處理帳戶上的現有專用終結點連接 |
> | 動作 | 微軟.批次處理/批次處理帳戶/私有終結點連接/讀取 | 獲取專用終結點連接或列出批次處理帳戶上的專用終結點連接 |
> |  | **批次處理帳戶/私有連結資源** |  |
> | 動作 | 微軟.批量/批次處理帳戶/私有連結資源/讀取 | 獲取專用連結資源的屬性或列出批次處理帳戶上的專用連結資源 |
> |  | **位置** |  |
...
> |  | **批次處理帳戶/作業** |  |
> | DataAction | 微軟.批次/批次帳戶/作業/讀取 | 列出 Batch 帳戶上的作業或獲取作業的屬性 |
> | DataAction | 微軟.批量/批量帳戶/作業/寫入 | 在 Batch 帳戶上創建新作業或更新現有作業 |
> | DataAction | 微軟.批量/批量帳戶/作業/刪除 | 從批次處理帳戶中刪除作業 |
> |  | **批次處理科目/作業計畫** |  |
> | DataAction | 微軟.批量/批次帳戶/作業計畫/讀取 | 列出 Batch 帳戶上的作業計畫或獲取作業計畫的屬性 |
> | DataAction | 微軟.批量/批次帳戶/作業計畫/寫入 | 在 Batch 帳戶上創建新作業計畫或更新現有作業計畫 |
> | DataAction | 微軟.批量/批次帳戶/作業計畫/刪除 | 從批次處理帳戶中刪除作業計畫 |
...
> | 動作 | 微軟.計費/計費帳戶/計費設定檔/寫入 |  |
> | 動作 | 微軟.計費/計費帳戶/計費設定檔/讀取 |  |
> | 動作 | 微軟.計費/計費帳戶/計費設定檔/寫入 |  |
> | 動作 | 微軟.計費/計費帳戶/計費設定檔/寫入 |  |
> |  | **帳單帳戶/帳單設定檔/計費許可權** |  |
> | 動作 | 微軟.計費/計費帳戶/計費設定檔/計費許可權/讀取 |  |
> |  | **帳單帳戶/帳單設定檔/客戶** |  |
> | 動作 | 微軟.計費/計費帳戶/計費設定檔/客戶/閱讀 |  |
> |  | **billingAccounts/billingProfiles/invoices/pricesheet** |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票/價格表/下載/操作 |  |
> |  | **帳單科目/帳單設定檔/發票部分** |  |
> | 動作 | 微軟.計費/計費帳戶/計費設定檔/發票節/寫 |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票節/讀 |  |
> | 動作 | 微軟.計費/計費帳戶/計費設定檔/發票節/寫 |  |
> |  | **帳單科目/帳單設定檔/發票節/計費許可權** |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票節/計費許可權/讀取 |  |
> |  | **帳單科目/帳單設定檔/發票節/計費訂閱** |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票節/計費訂閱/轉移/操作 |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票節/計費訂閱/移動/操作 |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票節/計費訂閱/驗證移動資格/操作 |  |
> |  | **帳單科目/帳單設定檔/發票部分/產品** |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票部分/產品/轉移/操作 |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票節/產品/移動/操作 |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/發票部分/產品/驗證移動資格/操作 |  |
> |  | **billingAccounts/billingProfiles/pricesheet** |  |
> | 動作 | 微軟.計費/計費帳戶/帳單設定檔/價格表/下載/操作 |  |
...
> |  | **發票** |  |
> | 動作 | 微軟.計費/發票/下載/操作 | 使用清單中的下載連結下載發票 |
> | 動作 | 微軟.計費/發票/下載/操作 | 使用清單中的下載連結下載發票 |
> | 動作 | Microsoft.Billing/invoices/read |  |

## <a name="microsoftbingmaps"></a>Microsoft.BingMaps

Azure 服務：[必應地圖](https://docs.microsoft.com/BingMaps/)

> [!div class="mx-tdCol2BreakAll"]
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.BingMaps/更新通信首選項/操作 | 更新 Microsoft 擁有者的通信首選項。 |
...
> | 動作 | 微軟.藍圖/藍圖分配/誰的藍圖/行動 | 獲取 Azure 藍圖服務主體物件識別碼。 |
...
> | 動作 | 微軟.Bot服務/listauth服務提供者/行動 | 列出身份驗證服務提供者 |
> |  | **機器人服務** |  |
...
> | 動作 | Microsoft.BotService/botServices/channels/write | 編寫機器人服務通道 |
> | 動作 | Microsoft.BotService/botServices/channels/delete | 刪除機器人服務管道 |
> | 動作 | 微軟.Bot服務/自動服務/頻道/清單通道與金鑰/操作 | 列出帶機密的自動服務通道 |
> |  | **botServices/connections** |  |
> | 動作 | Microsoft.BotService/botServices/connections/read | 讀取機器人服務連接 |
> | 動作 | Microsoft.BotService/botServices/connections/write | 編寫機器人服務連接 |
> | 動作 | Microsoft.BotService/botServices/connections/delete | 刪除機器人服務連接 |
> |  | **機器人服務/連接/清單與機密** |  |
> | 動作 | 微軟.Bot服務/自動服務/連接/清單與秘密/寫入 | 編寫機器人服務連接清單  |
> |  | **位置/操作結果** |  |
...
> |  | **預留單/合併作業結果** |  |
> | 動作 | 微軟.容量/預訂單/合併作業結果/讀取 | 輪詢任何合併作業 |
> |  | **預訂單/預訂** |  |
...
> |  | **預留單/拆分操作結果** |  |
> | 動作 | 微軟.容量/預訂單/拆分操作結果/讀取 | 輪詢任何拆分操作 |
> |  | **租戶** |  |
...
Azure 服務：[應用服務證書](../app-service/configure-ssl-certificate.md#import-an-app-service-certificate)
...
> |  | **存儲帳戶/blob 服務/供應商/微軟.見解/診斷設置** |  |
> | 動作 | 微軟.經典存儲/存儲帳戶/blob服務/供應商/微軟.見解/診斷設置/讀取 | 取得診斷設定。 |
> | 動作 | 微軟.經典存儲/存儲帳戶/blob服務/供應商/微軟.見解/診斷設置/寫入 | 新增或修改診斷設定。 |
> |  | **存儲帳戶/blob 服務/供應商/微軟.見解/指標定義** |  |
...
> |  | **存儲帳戶/檔服務/供應商/微軟.見解/診斷設置** |  |
> | 動作 | 微軟.經典存儲/存儲帳戶/檔服務/供應商/微軟.見解/診斷設置/讀取 | 取得診斷設定。 |
> | 動作 | 微軟.經典存儲/存儲帳戶/檔服務/供應商/微軟.見解/診斷設置/寫入 | 新增或修改診斷設定。 |
> |  | **存儲帳戶/檔服務/供應商/微軟.見解/指標定義** |  |
> | 動作 | 微軟.經典存儲/存儲帳戶/檔服務/供應商/微軟.見解/指標定義/讀取 | 取得計量定義。 |
> |  | **存儲帳戶/圖像** |  |
...
> |  | **帳戶/電腦視覺** |  |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/分析/行動 | 此操作根據圖像內容提取一組豐富的可視功能。  |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/描述/操作 | 此操作以具有完整句子的人類可讀語言生成圖像的描述。<br> 描述基於內容標記的集合，該標記也會由操作返回。<br>可以為每個圖像生成多個描述。<br> 描述按其置信度分數排序。<br>所有描述都是英文的。 |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/生成縮略圖/操作 | 此操作將生成具有使用者指定的寬度和高度的縮略圖圖像。<br> 根據預設，此服務會分析影像、識別相關區域 (ROI)，並根據 ROI 產生智慧裁剪的座標。<br> 當您指定與輸入圖像不同的縱橫比時，智慧裁剪會有所説明 |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/ocr/行動 | 光學字元辨識 （OCR） 檢測圖像中的文本，並將識別的字元提取到機器可用的字元流中。    |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/識別文本/操作 | 使用此介面可以獲取識別文本操作的結果。 使用"識別文本"介面時，回應包含名為"操作-位置"的欄位。 "操作位置"欄位包含必須用於獲取識別文本操作結果操作的 URL。 |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/標籤/操作 | 此操作將生成與所提供圖像的內容相關的單詞或標記的清單。<br>電腦視覺 API 可以基於圖像中找到的物件、生物、風景或操作返回標記。<br>與類別不同，標記不是根據分層分類系統組織的，而是對應于圖像內容。<br>標籤可能包含提示以避免歧義或提供上下文，例如標籤"大提琴"可能伴隨著提示"樂器"。<br>所有標籤均以英語為名。 |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/興趣領域/行動 | 此操作返回圖像最重要區域周圍的邊界框。 |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/檢測/操作 | 此操作對指定的映射執行物件檢測。  |
> |  | **帳戶/電腦視覺/模型** |  |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/模型/閱讀 | 此操作返回電腦視覺 API 支援的特定于域的模型的清單。  目前，API 支援以下特定于域的模型：名人識別器、地標識別器。 |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/模型/分析/操作 | 此操作通過應用特定于域的模型來識別圖像中的內容。<br> 可以使用 /model GET 請求檢索電腦視覺 API 支援的特定于域的模型清單。<br> 目前，API 提供以下特定于域的模型：名人、地標。 |
> |  | **帳戶/電腦視覺/讀取** |  |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/閱讀/分析/操作 | 使用此介面執行讀取操作，採用針對文本重文檔優化的最先進的光學字元辨識 （OCR） 演算法。<br>它可以處理手寫、列印或混合文檔。<br>使用 Read 介面時，回應包含名為"操作-位置"的標頭。<br>"操作位置"標頭包含必須用於獲取讀取結果操作以訪問 OCR 結果的 URL。 |
> |  | **帳戶/電腦視覺/讀取/分析結果** |  |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/閱讀/分析結果/閱讀 | 使用此介面可以檢索讀取操作的狀態和 OCR 結果。  包含"操作 Id"的 URL 將在讀取操作"操作-位置"回應標頭中返回。 |
> |  | **帳戶/電腦視覺/讀取/核心** |  |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/讀取/核心/非同步批次處理分析/操作 | 使用此介面獲取批次處理讀取檔操作的結果，採用最先進的光學字元 |
> |  | **帳戶/電腦視覺/讀取/操作** |  |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/讀取/操作/讀取 | 此介面用於獲取讀取操作的 OCR 結果。 應從批次處理讀取檔介面返回<b>的"操作-位置"</b>欄位檢索此介面的 URL。 |
> |  | **帳戶/電腦視覺/文本操作** |  |
> | DataAction | 微軟.認知服務/帳戶/電腦視覺/文本操作/讀取 | 此介面用於獲取識別文本操作結果。 應從從"識別文本"介面返回<b>的"操作-位置"</b>欄位中檢索此介面的 URL。 |
> |  | **帳戶/內容管理員** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/圖像清單/操作 | 創建圖像清單。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/行動 | 創建術語清單。 |
> |  | **帳戶/內容管理員/圖像清單** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/圖像清單/閱讀 | 圖像清單 - 獲取詳細資訊 - 圖像清單 - 獲取全部 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/圖像清單/刪除 | 圖像清單 - 刪除 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/圖像清單/刷新索引/操作 | 圖像清單 - 刷新搜索索引 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/圖像清單/寫入 | 圖像清單 - 更新詳細資訊 |
> |  | **帳戶/內容管理員/圖像清單/圖像** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/圖像清單/圖像/寫入 | 將圖像添加到圖像清單中。 使用圖像/匹配 API 時，圖像清單可用於對其他圖像進行模糊比對。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/圖像清單/圖像/刪除 | 從圖像清單中刪除圖像。 使用圖像/匹配 API 時，圖像清單可用於對其他圖像進行模糊比對。 從清單中刪除所有圖像。 使用圖像/匹配 API 時，圖像清單可用於對其他圖像進行模糊比對。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/圖像清單/圖像/閱讀 | 圖像 - 獲取所有圖像 ID |
> |  | **帳戶/內容管理員/流程圖像** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/進程圖像/評估/行動 | 返回包含淫穢內容或成人內容的圖像的概率。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/進程圖像/查找面/操作 | 在圖像中查找人臉。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/進程圖像/匹配/操作 | 模糊地將圖像與自訂圖像清單之一匹配。 您可以使用此 API 創建和管理自訂映射清單。  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/進程圖像/ocr/操作 | 返回圖像中為指定語言找到的任何文本。 如果在輸入中未指定任何語言，則檢測預設為英語。 |
> |  | **帳戶/內容管理員/進程文本** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/進程文本/檢測語言/操作 | 此操作將檢測給定輸入內容的語言。 返回包含提交文本的主要語言的 ISO 639-3 代碼。 支援超過 110 種語言。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/進程文本/螢幕/操作 | 該操作檢測 100 多種語言的褻瀆行為，並匹配自訂和共用黑名單。 |
> |  | **帳戶/內容管理員/團隊** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/工作/行動 | 將為此終結點上發佈的影像內容返回作業 ID。  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/評論/行動 | 創建的評論將顯示給團隊中的檢閱者。 當檢閱者完成審核時，審核結果將在指定的呼叫返回端點上發佈（即 HTTP POST）。 |
> |  | **帳戶/內容管理員/團隊/工作** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/工作/閱讀 | 獲取作業 ID 的工作詳細資訊。 |
> |  | **帳戶/內容管理員/團隊/評論** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/評論/閱讀 | 返回已通過的審核 ID 的審核詳細資訊。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/評論/發佈/行動 | 視頻評論最初創建狀態為未發佈狀態，這意味著團隊中的檢閱者還不能進行審閱。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/評論/成績單/行動 | 此 API 將指令檔（視頻中所有單詞的文本版本）添加到視頻審閱中。 該檔應為有效的 WebVTT 格式。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/評論/成績單/行動 | 此 API 添加用於視頻審閱的腳本螢幕文本結果檔。 腳本螢幕文本結果檔是螢幕文本 API 的結果。 為了生成腳本螢幕文本結果檔，必須使用螢幕文本 API 篩選指令檔以進行褻瀆。 |
> |  | **帳戶/內容管理員/團隊/評論/便捷鍵** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/評論/便捷鍵/閱讀 | 獲取團隊的審閱內容訪問金鑰。 |
> |  | **帳戶/內容管理員/團隊/評論/框架** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/評論/框架/寫入 | 使用此方法可添加視頻審閱的幀。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/評論/框架/閱讀 | *未定義* |
> |  | **帳戶/內容管理員/團隊/設置/範本** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/設置/範本/寫入 | 創建或更新指定的範本 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/設置/範本/刪除 | 刪除團隊中的範本 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/設置/範本/閱讀 | 返回此團隊中預配的審閱範本陣列。 |
> |  | **帳戶/內容管理員/團隊/工作流** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/工作流/寫入 | 創建新工作流或更新現有工作流。 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/團隊/工作流/閱讀 | 獲取團隊中特定工作流的詳細資訊，獲取團隊的所有可用工作流* |
> |  | **帳戶/內容管理員/術語清單** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/批量更新/操作 | 術語清單 - 批量更新 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/刪除 | 術語清單 - 刪除 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/閱讀 | 術語清單 - 獲取所有 - 術語清單 - 獲取詳細資訊 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/刷新索引/操作 | 術語清單 - 刷新搜索索引 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/寫入 | 術語清單 - 更新詳細資訊 |
> |  | **帳戶/內容管理員/術語表/術語** |  |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/術語/寫入 | 術語 - 添加期限 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/術語/刪除 | 期限 - 刪除 - 術語 - 刪除所有條款 |
> | DataAction | 微軟.認知服務/帳戶/內容管理員/術語清單/術語/閱讀 | 術語 - 獲取所有條款 |
> |  | **帳戶/自訂視覺.預測** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/行動 | 建立專案。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/使用者/行動 | *未定義* |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/配額/行動 | *未定義* |
> |  | **帳戶/自訂視覺.預測/分類/反覆運算** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/分類/反覆運算/圖像/操作 | 對圖像進行分類並保存結果。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/分類/反覆運算/url/操作 | 對圖像 URL 進行分類並保存結果。 |
> |  | **帳戶/自訂視覺.預測/分類/反覆運算/圖像** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/分類/反覆運算/圖像/無店/操作 | 在不保存結果的情況下對圖像進行分類。 |
> |  | **帳戶/自訂視覺.預測/分類/反覆運算/url** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/分類/反覆運算/url/無庫/操作 | 在不保存結果的情況下對圖像 URL 進行分類。 |
> |  | **帳戶/自訂視覺.預測/檢測/反覆運算** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/檢測/反覆運算/圖像/操作 | 檢測圖像中的物件並保存結果。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/檢測/反覆運算/url/操作 | 檢測圖像 URL 中的物件並保存結果。 |
> |  | **帳戶/自訂視覺.預測/檢測/反覆運算/圖像** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/檢測/反覆運算/圖像/無商店/操作 | 檢測圖像中的物件，而不保存結果。 |
> |  | **帳戶/自訂視覺.預測/檢測/反覆運算/url** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/檢測/反覆運算/url/無存儲/操作 | 檢測圖像 URL 中的物件，而不保存結果。 |
> |  | **帳戶/自訂視覺.預測/域** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/域/閱讀 | 獲取有關特定域的資訊。 獲取可用域的清單。 |
> |  | **帳戶/自訂視覺.預測/標籤建議** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/標籤建議/設置/操作 | 設置標籤建議的池大小。 |
> |  | **帳戶/自訂視覺.預測/標籤建議/設置** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/標籤建議/設置/閱讀 | 獲取此專案的標籤方案的池大小。 |
> |  | **帳戶/自訂視覺.預測/專案** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/遷移/操作 | *未定義* |
> |  | **帳戶/自訂視覺.預測/專案** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/行動 | 此 API 將接受正文內容為多部分/表單資料和應用程式/八進位流。 使用多部分時 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/標籤/操作 | 為專案創建標記。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/刪除 | 刪除特定專案。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/閱讀 | 獲取特定專案。 獲取您的專案。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/培訓/行動 | 用於培訓的佇列專案。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/寫入 | 更新特定專案。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/導入/操作 | 導入專案。 |
> |  | **帳戶/自訂視覺.預測/專案/匯出** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/匯出/讀取 | 匯出專案。 |
> |  | **帳戶/自訂視覺.預測/專案/圖像** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/區域/行動 | 此 API 接受一批圖像區域和可選標記，以便使用區域資訊更新現有圖像。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/檔/操作 | 此 API 接受一批次檔（可選標記）來創建映射。 其限制為 64 個影像和 20 個標記。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/預測/行動 | 此 API 從指定的預測圖像創建一批圖像。 其限制為 64 個影像和 20 個標記。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/url/行動 | 此 API 接受一批 URL 和可選標記來創建映射。 其限制為 64 個影像和 20 個標記。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/標籤/操作 | 將一組圖像與一組標記相關聯。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/刪除 | 從訓練圖像集中刪除圖像。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/區域建議/行動 | 此 API 將獲得圖像的區域建議以及該區域的置信。 如果未找到任何建議，它將返回一個空陣列。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/建議/操作 | 此 API 將獲取由建議標記 Id 篩選的未標記圖像。 如果未找到圖像，它將返回一個空陣列。 |
> |  | **帳戶/自訂視覺.預測/專案/圖像/id** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/id/讀取 | 此 API 將返回指定標記和可選反覆運算的一組圖像。 如果未指定反覆運算， |
> |  | **帳戶/自訂視覺.預測/專案/圖像/區域** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/區域/刪除 | 刪除一組圖像區域。 |
> |  | **帳戶/自訂視覺.預測/專案/圖像/建議** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/建議/計數/操作 | 此 API 採用 tagIds 來獲取給定閾值每個建議標記的未標記圖像計數。 |
> |  | **帳戶/自訂視覺.預測/專案/圖像/標記** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/標記/閱讀 | 此 API 支援批次處理和範圍選取。 預設情況下，它只會返回前 50 個匹配圖像的圖像。 |
> |  | **帳戶/自訂視覺.預測/專案/圖像/標記/計數** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/標記/計數/閱讀 | 篩選位於 和/或關係上。 例如，如果提供的標記識別項 用於"狗"和 |
> |  | **帳戶/自訂視覺.預測/專案/圖像/標籤** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/標籤/刪除 | 從一組圖像中刪除一組標記。 |
> |  | **帳戶/自訂視覺.預測/專案/圖像/未標記** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/未標記/讀取 | 此 API 支援批次處理和範圍選取。 預設情況下，它只會返回前 50 個匹配圖像的圖像。 |
> |  | **帳戶/自訂視覺.預測/專案/圖像/未標記/計數** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/圖像/未標記/計數/讀取 | 此 API 返回沒有給定專案標記的圖像，並選擇性地返回反覆運算。 如果未指定反覆運算， |
> |  | **帳戶/自訂視覺.預測/專案/反覆運算** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/刪除 | 刪除專案的特定反覆運算。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/匯出/操作 | 匯出經過訓練的反覆運算。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/閱讀 | 獲取特定反覆運算。 獲取專案的反覆運算。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/發佈/操作 | 發佈特定反覆運算。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/寫入 | 更新特定反覆運算。 |
> |  | **帳戶/自訂視覺.預測/專案/反覆運算/匯出** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/匯出/讀取 | 獲取特定反覆運算的匯出清單。 |
> |  | **帳戶/自訂視覺.預測/專案/反覆運算/性能** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/性能/閱讀 | 獲取有關反覆運算的詳細性能資訊。 |
> |  | **帳戶/自訂視覺.預測/專案/反覆運算/性能/圖像** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/性能/圖像/閱讀 | 此 API 支援批次處理和範圍選取。 預設情況下，它只會返回前 50 個匹配圖像的圖像。 |
> |  | **帳戶/自訂視覺.預測/專案/反覆運算/性能/圖像/計數** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/性能/圖像/計數/讀取 | 篩選位於 和/或關係上。 例如，如果提供的標記識別項 用於"狗"和 |
> |  | **帳戶/自訂視覺.預測/專案/反覆運算/發佈** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/反覆運算/發佈/刪除 | 取消發佈特定反覆運算。 |
> |  | **帳戶/自訂視覺.預測/專案/預測** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/預測/刪除 | 刪除一組預測圖像及其關聯的預測結果。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/預測/查詢/操作 | 獲取發送到預測終結點的圖像。 |
> |  | **帳戶/自訂視覺.預測/專案/快速測試** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/快速測試/圖像/操作 | 快速測試圖像。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/快速測試/url/行動 | 快速測試圖像 URL。 |
> |  | **帳戶/自訂視覺.預測/專案/標籤** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/標籤/刪除 | 從專案中刪除標記。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/標籤/讀取 | 獲取有關特定標記的資訊。 獲取給定專案和反覆運算的標記。 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/標籤/寫入 | 更新標記。 |
> |  | **帳戶/自訂視覺.預測/專案/標籤和區域** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/標籤和區域/建議/行動 | 此 API 將獲得陣列/批未標記圖像的建議標記和區域以及標記的置信度。 如果未找到標記，它將返回空陣列。 |
> |  | **帳戶/自訂視覺.預測/專案/培訓** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/專案/培訓/高級/行動 | 使用管道配置和培訓類型進行訓練的佇列專案。 |
> |  | **帳戶/自訂視覺.預測/配額** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/配額/刪除 | *未定義* |
> |  | **帳戶/自訂視覺.預測/配額/刷新** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/配額/刷新/寫入 | *未定義* |
> |  | **帳戶/自訂視覺.預測/使用/預測/使用者** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/使用/預測/使用者/閱讀 | 獲取牛津使用者預測資源的使用方式 |
> |  | **帳戶/自訂視覺.預測/使用/培訓/資源/層** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/使用/培訓/資源/層/閱讀 | 獲取 Azure 使用者訓練資源的使用方式 |
> |  | **帳戶/自訂視覺.預測/使用/培訓/使用者** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/使用/培訓/使用者/閱讀 | 獲取牛津使用者培訓資源的用法 |
> |  | **帳戶/自訂視覺.預測/使用者** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/使用者/刪除 | *未定義* |
> |  | **帳戶/自訂視覺.預測/使用者/狀態** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/使用者/狀態/寫入 | 更新使用者狀態 |
> |  | **帳戶/自訂視覺.預測/使用者/層** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/使用者/層/寫入 | *未定義* |
> |  | **帳戶/自訂視覺.預測/使用者** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/使用者/閱讀 | *未定義* |
> |  | **帳戶/自訂視覺.預測/白名單** |  |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/白名單/刪除 | 刪除具有特定功能的白名單使用者 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/白名單/閱讀 | 獲取具有特定功能的白名單使用者清單 |
> | DataAction | 微軟.認知服務/帳戶/自訂視覺.預測/白名單/寫入 | 更新或創建具有特定功能的白名單中的使用者 |
> |  | **帳戶/實體搜索** |  |
> | DataAction | 微軟.認知服務/帳戶/實體搜索/搜索/操作 | 獲取實體並放置給定查詢的結果。 |
> |  | **帳戶/面** |  |
> | DataAction | 微軟.認知服務/帳戶/人臉/檢測/操作 | 檢測圖像中的人臉、返回面矩形，以及可選使用面 ID、地標和屬性。 |
> | DataAction | 微軟.認知服務/帳戶/臉/查找類似/操作 | 給定查詢面的 faceId，以從 faceId 陣列、面清單或大型面清單中搜索相似外觀的面。 faceId |
...
> |  | **帳戶/面/面清單** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/臉清單/寫 | 使用使用者指定的面清單、名稱和可選使用者資料創建空面清單。 最多允許 64 個面清單 更新人臉清單的資訊，包括姓名和使用者資料。 |
> | DataAction | 微軟.認知服務/帳戶/臉/面清單/刪除 | 刪除指定的面清單。 人臉清單中的相關人臉圖像也將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/臉清單/閱讀 | 檢索人臉清單的人臉清單Id、名稱、使用者資料和人臉清單中的人臉清單。 列出面清單的面清單Id、名稱和使用者資料。 |
> |  | **帳戶/面/面清單/已保留面** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/臉清單/持久面/寫入 | 將面添加到指定的面清單中，最多 1，000 張面。 |
> | DataAction | 微軟.認知服務/帳戶/臉/面清單/持久面/刪除 | 通過指定的面清單 Id 和滲透面 Id 從面清單中刪除面。 相關人臉圖像也將被刪除。 |
> |  | **帳戶/面/大面清單** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/大面表/寫 | 使用使用者指定的大 FaceListId、名稱和可選使用者資料創建一個空的大面清單。 更新大型面清單的資訊，包括名稱和使用者資料。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大面清單/刪除 | 刪除指定的大面清單。 大面清單中的相關人臉圖像也將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大面清單/閱讀 | 檢索大型面清單的大 FaceListId、名稱和使用者資料。 列出大型面清單的大 FaceListId、名稱和使用者資料的資訊。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大面清單/訓練/行動 | 提交大面清單訓練任務。 培訓是只有經過訓練的大臉表才能使用的關鍵步驟。 |
> |  | **帳戶/面/大面清單/持久面** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/大面清單/持久面/寫入 | 將面添加到指定的大面清單中，最多 1，000，000 張面。 通過保留的 FaceId 更新大面清單中指定面的使用者資料欄位。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大面清單/持久面/刪除 | 通過指定的大 FaceListId 和滲透面 Id 從大面清單中刪除面。 相關人臉圖像也將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大面清單/持久面/閱讀 | 通過大 FaceListId 和持久面 Id 在大型面清單中檢索持久面。 清單面的持久存在 FaceId 和使用者資料位於指定的大面清單中。 |
> |  | **帳戶/臉/大面清單/培訓** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/大面表/培訓/閱讀 | 檢查大面清單訓練狀態已完成或仍在進行中。 大型FaceList培訓是非同步作業 |
> |  | **帳戶/臉/大人組** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/寫 | 使用使用者指定的大人組 Id、名稱和可選使用者資料創建新的大型企業組。 更新現有大型人員組的名稱和使用者資料。 如果屬性不在請求正文中，則屬性保持不變。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/刪除 | 刪除具有指定人員 GroupId 的現有大型人員組。 此大型人員組中的持久資料將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/閱讀 | 檢索大型人員組的資訊，包括其名稱和使用者資料。 此 API 返回大型人員組資訊清單所有現有大型人員組的大型 PesonGroupId、名稱和使用者資料。 |
...
> |  | **帳戶/臉/大人組/人** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/人/刪除 | 從大型人員組中刪除現有人員。 所有存儲的人員資料以及人員條目中的人臉圖像都將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/人/閱讀 | 檢索某人的姓名和使用者資料，以及表示註冊人面部圖像的持久化人臉 Id。 列出指定大型人員組中的所有人資訊，包括人員 Id、姓名、使用者資料和持久化 FaceId。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/人/寫 | 更新人員的姓名或使用者資料。 |
> |  | **帳戶/臉/大人組/人/堅持面** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/人/堅持面孔/寫 | 將人臉圖像添加到大型人員組中，以便進行人臉識別或驗證。 要處理"更新"圖像，使用者保留人臉的使用者資料欄位。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/人/堅持臉/刪除 | 從大型人員組中的人員中刪除人臉。 與此人臉條目相關的人臉資料和圖像也將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/人/堅持面孔/閱讀 | 檢索人臉資訊。 堅持者面由其大型 PersonGroupId、人 Id 和持久化 FaceId 指定。 |
> |  | **帳戶/臉/大人組/培訓** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/大人組/培訓/閱讀 | 檢查大型人員組培訓狀態已完成或仍在進行中。 大型PersonGroup培訓是非同步作業 |
> |  | **帳戶/臉/人組** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/寫入 | 使用指定人員 GroupId、名稱和使用者提供的使用者資料創建新的人員組。 更新現有人員組的名稱和使用者資料。 如果屬性不在請求正文中，則屬性保持不變。 |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/刪除 | 刪除具有指定人員 GroupId 的現有人員組。 此人員組中的持久資料將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/閱讀 | 檢索人員組名稱和使用者資料。 要獲取此人組下的人員資訊，請使用清單人員組的 pesonGroupId、名稱和使用者資料。 |
...
> |  | **帳戶/臉/人組/人** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/人/刪除 | 從人員組中刪除現有人員。 所有存儲的人員資料以及人員條目中的人臉圖像都將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/人/閱讀 | 檢索某人的姓名和使用者資料，以及表示註冊人面部圖像的持久化人臉 Id。 列出指定人員組中的所有人資訊，包括已登記的人員 Id、姓名、使用者資料和已保留的 FaceId。 |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/人/寫 | 更新人員的姓名或使用者資料。 |
> |  | **帳戶/臉/人組/人/已保留的面孔** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/人/堅持面孔/寫 | 將人臉圖像添加到人員組中，以便進行人臉識別或驗證。 要處理多個更新的圖像，使用者使用者資料欄位是使用者保留的。 |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/人/堅持面/刪除 | 從人員組中的人員中刪除人臉。 與此人臉條目相關的人臉資料和圖像也將被刪除。 |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/人/堅持面孔/閱讀 | 檢索人臉資訊。 堅持的人臉由其人組Id、人 Id 和持久化 FaceId 指定。 |
> |  | **帳戶/臉/人組/培訓** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/人組/培訓/閱讀 | 檢查人員組培訓狀態已完成或仍在進行中。 人員組培訓是觸發的非同步作業 |
> |  | **帳戶/臉/快照** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/快照/拍攝/行動 | 為物件拍攝快照。 |
> | DataAction | 微軟.認知服務/帳戶/臉/快照/閱讀 | 獲取快照操作的狀態。 |
> | DataAction | 微軟.認知服務/帳戶/臉/快照/應用/操作 | 應用快照，提供使用者指定的物件識別碼。 |
> | DataAction | 微軟.認知服務/帳戶/臉/快照/刪除 | 刪除快照。 |
> | DataAction | 微軟.認知服務/帳戶/臉/快照/寫入 | 更新快照的屬性。 |
> |  | **帳戶/人臉/快照** |  |
> | DataAction | 微軟.認知服務/帳戶/臉/快照/閱讀 | 列出使用者所有可訪問的快照資訊。 |
> |  | **帳戶/表單識別器/自訂** |  |
> | DataAction | 微軟.認知服務/帳戶/表單識別器/自訂/培訓/操作 | 創建並訓練自訂模型。<br>訓練請求必須包括一個源參數，該參數是外部可訪問的 Azure 存儲 Blob 容器 Uri（最好是共用訪問簽名 Uri）或本地裝載磁碟機中資料檔案夾的有效路徑。<br>指定本地路徑時，它們必須遵循 Linux/Unix 路徑格式，並且是植根于輸入裝載配置的絕對路徑 |
> |  | **帳戶/表單識別器/自訂/模型** |  |
> | DataAction | 微軟.認知服務/帳戶/表單識別器/自訂/模型/分析/操作 | 從給定文檔中提取鍵值對。 輸入文檔必須為支援的內容類型之一 - "應用程式/pdf"、"圖像/jpeg"或"圖像/png"。 成功的回應會以 JSON 的形式傳回。 |
> | DataAction | 微軟.認知服務/帳戶/表單識別器/自訂/模型/刪除 | 刪除模型專案。 |
> | DataAction | 微軟.認知服務/帳戶/表單識別器/自訂/模型/讀取 | 獲取有關模型的資訊。 獲取有關所有經過培訓的自訂模型的資訊* |
> |  | **帳戶/表單識別器/自訂/模型/金鑰** |  |
> | DataAction | 微軟.認知服務/帳戶/表單識別器/自訂/型號/金鑰/讀取 | 檢索模型的鍵。 |
> |  | **帳戶/表單識別器/預構建/接收** |  |
> | DataAction | 微軟.認知服務/帳戶/表單識別器/預構建/接收/非同步批次處理分析/操作 | 從給定的接收文檔中提取欄位文本和語義值。 輸入圖像文檔必須是支援的內容類型之一 - JPEG、PNG、BMP、PDF 或 TIFF。 成功回應是包含名為"操作-位置"的欄位的 JSON，其中包含獲取接收結果操作的 URL 以非同步檢索結果。 |
> | DataAction | 微軟.認知服務/帳戶/表單識別器/預構建/接收/操作/操作 | 查詢狀態並檢索分析收貨操作的結果。 此介面的 URL 可以從分析收據回應中的"操作位置"標頭獲取。 |
> |  | **帳戶/圖像搜索** |  |
...
> |  | **帳戶/沉浸式閱讀器** |  |
> | DataAction | 微軟.認知服務/帳戶/ImmersiveReader/獲取讀者/操作內容模型 | 創建沉浸式讀取器會話 |
> |  | **帳戶/墨蹟識別器** |  |
> | DataAction | 微軟.認知服務/帳戶/墨水識別器/識別/操作 | 給定一組描邊資料會分析內容並生成包含已識別文本的可識別實體的清單。 |
> |  | **帳戶/LUIS** |  |
...
> |  | **帳戶/文本分析** |  |
> | DataAction | 微軟.認知服務/帳戶/文本分析/語言/行動 | API 返回檢測到的語言和介於 0 和 1 之間的數值分數。 接近 1 的分數表示 100% 確定已識別的語言為真實。 總共支援 120 種語言。 |
> | DataAction | 微軟.認知服務/帳戶/文本分析/實體/行動 | API 返回給定文檔中已知實體和一般命名實體（\"人員\"、\"位置\"、\"組織\"等）的清單。 |
> | DataAction | 微軟.認知服務/帳戶/文本分析/關鍵字/操作 | API 會傳回輸入文字中代表說話重點的字串清單。 |
...
> |  | **帳戶/視覺搜索** |  |
> | DataAction | 微軟.認知服務/帳戶/視覺搜索/搜索/操作 | 返回與提供的圖像相關的標記清單 |
> |  | **帳戶/網路搜索** |  |
> | DataAction | 微軟.認知服務/帳戶/網路搜索/搜索/操作 | 獲取給定查詢的網路、圖像、新聞、&視頻結果。 |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.商業/註冊/行動 | 註冊 Microsoft 商務使用聚合訂閱 |
> | 動作 | 微軟.商業/取消註冊/行動 | 取消註冊 Microsoft 商務使用聚合訂閱 |
> |  | **RateCard** |  |
...
> | 動作 | 微軟.計算/取消註冊/操作 | 取消註冊 Microsoft 訂閱。計算資來源提供者 |
> |  | **availabilitySets** |  |
...
> |  | **磁片加密集** |  |
> | 動作 | 微軟.計算/磁片加密集/讀取 | 獲取磁片加密集的屬性 |
> | 動作 | 微軟.計算/磁片加密集/寫入 | 創建新的磁片加密集或更新現有磁片加密集 |
> | 動作 | 微軟.計算/磁片加密集/刪除 | 刪除磁片加密集 |
> |  | **磁片** |  |
...
> |  | **畫廊/應用程式** |  |
> | 動作 | 微軟.計算/畫廊/應用程式/讀取 | 獲取庫應用程式的屬性 |
> | 動作 | 微軟.計算/畫廊/應用程式/寫入 | 創建新的庫應用程式或更新現有庫應用程式 |
> | 動作 | 微軟.計算/畫廊/應用程式/刪除 | 刪除庫應用程式 |
> |  | **畫廊/應用程式/版本** |  |
> | 動作 | 微軟.計算/畫廊/應用程式/版本/讀取 | 獲取庫應用程式版本的屬性 |
> | 動作 | 微軟.計算/畫廊/應用程式/版本/寫入 | 創建新的庫應用程式版本或更新現有庫應用程式版本 |
> | 動作 | 微軟.計算/畫廊/應用程式/版本/刪除 | 刪除庫應用程式版本 |
> |  | **galleries/images** |  |
...
> |  | **主機組** |  |
> | 動作 | 微軟.計算/主機組/讀取 | 獲取主機組的屬性 |
> | 動作 | 微軟.計算/主機組/寫入 | 創建新主機組或更新現有主機組 |
> | 動作 | 微軟.計算/主機組/刪除 | 刪除主機組 |
> |  | **主機組/主機** |  |
> | 動作 | 微軟.計算/主機組/主機/讀取 | 獲取主機的屬性 |
> | 動作 | 微軟.計算/主機組/主機/寫入 | 創建新主機或更新現有主機 |
> | 動作 | 微軟.計算/主機組/主機/刪除 | 刪除主機 |
> |  | **圖像** |  |
...
> |  | **位置/vsm 操作** |  |
> | 動作 | 微軟.計算/位置/vsm 操作/讀取 | 使用虛擬機器運行時服務擴展獲取虛擬機器擴展集的非同步作業狀態 |
> |  | **操作** |  |
> | 動作 | Microsoft.Compute/operations/read | 列出 Microsoft.Compute 資源提供者的可用作業 |
> |  | **鄰近放置組** |  |
> | 動作 | 微軟.計算/鄰近放置組/讀取 | 獲取鄰近放置組的屬性 |
> | 動作 | 微軟.計算/鄰近放置組/寫入 | 創建新的鄰近放置組或更新現有 |
> | 動作 | 微軟.計算/鄰近放置組/刪除 | 刪除鄰近放置組 |
...
> | 動作 | 微軟.計算/虛擬機器/評估補丁/操作 | 評估虛擬機器並查找可用的作業系統更新修補程式的清單。 |
> | 動作 | 微軟.計算/虛擬機器/取消補丁安裝/操作 | 取消虛擬機器上正在進行的安裝 OS 更新修補程式操作。 |
> |  | **虛擬機器/擴展** |  |
...
> | 動作 | 微軟.計算/虛擬機器表集/輪流升級/操作 | 取消虛擬機器擴展集的輪流升級 |
...
> |  | **虛擬機器級集/擴展/角色** |  |
> | 動作 | 微軟.計算/虛擬機器表集/擴展/角色/讀取 | 使用虛擬機器運行時服務擴展獲取虛擬機器擴展集中角色的屬性 |
> | 動作 | 微軟.計算/虛擬機器表集/擴展/角色/寫入 | 使用虛擬機器運行時服務擴展更新虛擬機器擴展集中的現有角色的屬性 |
> |  | **虛擬機器級表集/實例視圖** |  |
...
> |  | **虛擬機器級設置/虛擬機器/網路介面/ip 配置/公共 IP 位址** |  |
...
> |  | **虛擬機器級表集/vmSizes** |  |
> | 動作 | 微軟.計算/虛擬機器規模集/vmSizes/讀取 | 列出用於在虛擬機器縮放集中創建或更新虛擬機器的可用大小 |
> |  | **虛擬機器級設置虛擬機器/擴展** |  |
> | 動作 | 微軟.計算/虛擬機器規模設置虛擬機器/擴展/讀取 | 在虛擬機器縮放集中獲取虛擬機器擴展的屬性 |
> | 動作 | 微軟.計算/虛擬機器規模設置虛擬機器/擴展/寫入 | 在虛擬機器縮放集中為虛擬機器創建新擴展，或更新現有擴展 |
> | 動作 | 微軟.計算/虛擬機器規模設置虛擬機器/擴展/刪除 | 刪除虛擬機器縮放集中虛擬機器的擴展 |
> |  | **虛擬機器** |  |
...
> |  | **容器組/操作結果** |  |
> | 動作 | 微軟.容器實例/容器組/操作結果/讀取 | 獲取非同步作業結果 |
> |  | **容器組/供應商/微軟.見解/診斷設置** |  |
...
> |  | **服務關聯連結** |  |
> | 動作 | 微軟.容器實例/服務關聯連結/刪除 | 刪除由子網上的 Azure 容器實例資來源提供者創建的服務關聯連結。 |
...
> |  | **註冊表/中繼資料** |  |
> | 動作 | 微軟.集裝箱註冊/註冊/中繼資料/讀取 | 獲取容器註冊表的特定存儲庫的中繼資料 |
> | 動作 | 微軟.集裝箱註冊/註冊/中繼資料/寫入 | 更新容器註冊表存儲庫的中繼資料 |
> |  | **註冊表/操作狀態** |  |
> | 動作 | Microsoft.ContainerRegistry/registries/operationStatuses/read | 取得登錄非同步作業狀態 |
> |  | **註冊表/私有端接連接 Proxies** |  |
> | 動作 | 微軟.集裝箱註冊/註冊/私人終端連接Proxies/驗證/操作 | 驗證專用終結點連接代理（僅限 NRP） |
> | 動作 | 微軟.集裝箱註冊/註冊/私人端接連接Proxies/讀取 | 獲取專用終結點連接代理（僅限 NRP） |
> | 動作 | 微軟.集裝箱註冊/註冊/私人終端連接Proxies/寫 | 創建專用終結點連接代理（僅限 NRP） |
> | 動作 | 微軟.集裝箱註冊/註冊/私人終端連接Proxies/刪除 | 刪除專用終結點連接代理（僅限 NRP） |
> |  | **註冊表/私有端接連接狀態/操作狀態** |  |
> | 動作 | 微軟.集裝箱註冊/註冊/私人端接連接Proxies/操作狀態/讀取 | 獲取專用終結點連接代理非同步作業狀態 |
> |  | **註冊表/拉取** |  |
...
> |  | **註冊表/範圍映射/操作狀態** |  |
> | 動作 | 微軟.集裝箱註冊/註冊/範圍地圖/操作狀態/讀取 | 獲取範圍映射非同步作業狀態。 |
> |  | **註冊/簽名** |  |
...
> |  | **註冊表/權杖** |  |
> | 動作 | 微軟.集裝箱註冊/註冊/權杖/讀取 | 獲取指定權杖的屬性或列出指定容器註冊表的所有權杖。 |
> | 動作 | 微軟.集裝箱註冊/註冊/權杖/寫入 | 使用指定的參數創建或更新容器註冊表的權杖。 |
> | 動作 | 微軟.集裝箱註冊/註冊/權杖/刪除 | 從容器註冊表中刪除權杖。 |
> |  | **註冊表/權杖/操作狀態** |  |
> | 動作 | 微軟.集裝箱註冊/註冊/權杖/操作狀態/讀取 | 獲取權杖非同步作業狀態。 |
...
> | 動作 | 微軟.容器服務/託管群集/清單群集監視使用者憑據/操作 | 列出託管群集的群集監視使用者憑據 |
...
> | 動作 | 微軟.容器服務/託管群集/旋轉群集證書/操作 | 旋轉託管群集的證書 |
> | 動作 | 微軟.容器服務/託管群集/專用端點連接審批/操作 | 確定是否允許使用者批准專用終結點連接 |
> |  | **託管群集/訪問設定檔** |  |
...
> |  | **託管群集/代理池** |  |
> | 動作 | 微軟.容器服務/託管集群/代理池/讀取 | 獲取代理池 |
> | 動作 | 微軟.容器服務/託管集群/代理池/寫入 | 創建新代理池或更新現有代理池 |
> | 動作 | 微軟.容器服務/託管集群/代理池/刪除 | 刪除代理池 |
> |  | **託管群集/代理池/升級設定檔** |  |
> | 動作 | 微軟.容器服務/託管集群/代理池/升級設定檔/讀取 | 獲取代理池的升級設定檔 |
> |  | **託管群集/可用代理池版本** |  |
> | 動作 | 微軟.容器服務/託管群集/可用代理池版本/讀取 | 獲取群集的可用代理池版本 |
> |  | **託管群集/探測器** |  |
> | 動作 | 微軟.集裝箱服務/託管集群/探測器/讀取 | 獲取託管群集檢測器 |
> |  | **託管群集/診斷狀態** |  |
> | 動作 | 微軟.容器服務/託管群集/診斷狀態/讀取 | 獲取群集的診斷狀態 |
> |  | **託管群集/升級設定檔** |  |
> | 動作 | 微軟.容器服務/託管集群/升級設定檔/讀取 | 取得叢集的升級設定檔 |
> |  | **打開移位群集** |  |
> | 動作 | Microsoft.ContainerService/openShiftClusters/read | 獲取開放式班次群集 |
> | 動作 | Microsoft.ContainerService/openShiftClusters/write | 建立新的或更新現有的 Open Shift 叢集 |
> | 動作 | Microsoft.ContainerService/openShiftClusters/delete | 刪除開放式班次群集 |
> |  | **開放式轉移託管集群** |  |
> | 動作 | Microsoft.ContainerService/openShiftManagedClusters/read | 獲取開放式班次託管群集 |
> | 動作 | Microsoft.ContainerService/openShiftManagedClusters/write | 建立新的或更新現有的 Open Shift 受控叢集 |
> | 動作 | Microsoft.ContainerService/openShiftManagedClusters/delete | 刪除開放式班次託管群集 |
> |  | **操作** |  |
...
> | 動作 | 微軟.成本管理/預測/行動 | 按作用域預測使用方式資料。 |
> |  | **警示** |  |
> | 動作 | 微軟.成本管理/警報/寫入 | 更新警示。 |
> |  | **雲連接器** |  |
> | 動作 | 微軟.成本管理/雲連接器/讀取 | 列出經過身份驗證使用者的雲連接器。 |
> | 動作 | 微軟.成本管理/雲連接器/寫入 | 創建或更新指定的雲連接器。 |
> | 動作 | 微軟.成本管理/雲連接器/刪除 | 刪除指定的雲連接器。 |
> |  | **尺寸** |  |
...
> | 動作 | 微軟.成本管理/外部計費帳戶/查詢/操作 | 查詢外部計費科目的使用資料。 |
> | 動作 | 微軟.成本管理/外部計費帳戶/預測/行動 | 外部計費科目的預測使用方式資料。 |
> |  | **外部計費帳戶/維度** |  |
> | 動作 | 微軟.成本管理/外部計費帳戶/維度/讀取 | 列出外部計費帳戶的所有受支援維度。 |
> |  | **外部計費帳戶/外部訂閱** |  |
> | 動作 | 微軟.成本管理/外部計費帳戶/外部訂閱/讀取 | 列出經過身份驗證的使用者的外部 BillingACCOUNT 中的外部訂閱。 |
> |  | **外部計費帳戶/預測** |  |
> | 動作 | 微軟.成本管理/外部計費帳戶/預測/閱讀 | 外部計費科目的預測使用方式資料。 |
> |  | **外部計費帳戶/查詢** |  |
> | 動作 | 微軟.成本管理/外部計費帳戶/查詢/讀取 | 查詢外部計費科目的使用資料。 |
> |  | **外部訂閱** |  |
> | 動作 | 微軟.成本管理/外部訂閱/讀取 | 列出經過身份驗證的使用者的外部訂閱。 |
> | 動作 | 微軟.成本管理/外部訂閱/寫入 | 更新外部訂閱的關聯管理組 |
> | 動作 | 微軟.成本管理/外部訂閱/查詢/操作 | 查詢外部訂閱的使用資料。 |
> | 動作 | 微軟.成本管理/外部訂閱/預測/行動 | 外部計費科目的預測使用方式資料。 |
> |  | **外部訂閱/維度** |  |
> | 動作 | 微軟.成本管理/外部訂閱/維度/讀取 | 列出外部訂閱的所有受支援維度。 |
> |  | **外部訂閱/預測** |  |
> | 動作 | 微軟.成本管理/外部訂閱/預測/閱讀 | 外部計費科目的預測使用方式資料。 |
> |  | **外部訂閱/查詢** |  |
> | 動作 | 微軟.成本管理/外部訂閱/查詢/讀取 | 查詢外部訂閱的使用資料。 |
> |  | **預測** |  |
> | 動作 | 微軟.成本管理/預測/閱讀 | 按作用域預測使用方式資料。 |
> |  | **操作** |  |
> | 動作 | 微軟.成本管理/操作/讀取 | 列出 Microsoft.CostManagement 資來源提供者支援的所有操作。 |
> |  | **查詢** |  |
...
> |  | **位置/可用** |  |
> | 動作 | 微軟.DataBox/位置/可用Skus/讀 | 列出或獲取可用 Skus |
> |  | **位置/操作結果** |  |
> | 動作 | Microsoft.DataBox/locations/operationResults/read | 列出或取得作業結果 |
> |  | **操作** |  |
> | 動作 | 微軟.DataBox/操作/讀取 | 列出或獲取操作 |
...
> |  | **資料BoxEdge設備/頻寬計畫/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge設備/頻寬計畫/操作結果/閱讀 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/作業** |  |
...
> |  | **資料盒邊緣設備/節點** |  |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/節點/讀取 | 列出或獲取節點 |
> |  | **資料盒邊緣設備/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge 設備/操作結果/讀取 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/操作狀態** |  |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/操作狀態/讀取 | 列出或獲取操作狀態 |
> |  | **資料盒邊緣設備/訂單** |  |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/訂單/閱讀 | 列出或獲取訂單 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/訂單/閱讀 | 列出或獲取訂單 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/訂單/寫 | 創建或更新訂單 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/訂單/刪除 | 刪除訂單 |
> |  | **資料BoxEdge設備/訂單/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/訂單/操作結果/閱讀 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/角色** |  |
> | 動作 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/read | 列出或獲取角色 |
> | 動作 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/read | 列出或獲取角色 |
> | 動作 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/write | 創建或更新角色 |
> | 動作 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/delete | 刪除角色 |
> |  | **資料BoxEdge設備/角色/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge 設備/角色/操作結果/閱讀 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/安全設置** |  |
> | 動作 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/securitySettings/update/action | 更新安全性設定 |
> |  | **資料盒邊緣設備/安全設置/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge 設備/安全設置/操作結果/讀取 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/共用** |  |
...
> | 動作 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/refresh/action | 使用雲中的資料刷新共用中繼資料 |
> | 動作 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/delete | 刪除共用 |
> |  | **資料BoxEdge設備/共用/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge設備/共用/操作結果/閱讀 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/存儲帳戶憑據** |  |
...
> |  | **資料盒邊緣設備/存儲帳戶憑據/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge設備/存儲帳戶憑據/操作結果/讀取 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/存儲帳戶** |  |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/存儲帳戶/讀取 | 列出或獲取存儲帳戶 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/存儲帳戶/讀取 | 列出或獲取存儲帳戶 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/存儲帳戶/寫 | 創建或更新存儲帳戶 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/存儲帳戶/刪除 | 刪除存儲帳戶 |
> |  | **資料盒邊緣設備/存儲帳戶/容器** |  |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/存儲帳戶/容器/讀取 | 列出或獲取容器 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/存儲帳戶/容器/讀取 | 列出或獲取容器 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/存儲帳戶/容器/寫入 | 創建或更新容器 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/存儲帳戶/容器/刪除 | 刪除容器 |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge設備/存儲帳戶/容器/刷新/操作 | 使用雲中的資料刷新容器中繼資料 |
> |  | **資料BoxEdge設備/存儲帳戶/容器/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge設備/存儲帳戶/容器/操作結果/讀取 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/存儲帳戶/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge 設備/存儲帳戶/操作結果/讀取 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/觸發器** |  |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/觸發器/讀取 | 列出或獲取觸發器 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/觸發器/讀取 | 列出或獲取觸發器 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/觸發器/寫入 | 創建或更新觸發器 |
> | 動作 | 微軟.DataBoxEdge/DataBox邊緣設備/觸發器/刪除 | 刪除觸發器 |
> |  | **資料盒邊緣設備/觸發器/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge設備/觸發器/操作結果/閱讀 | 列出或獲取操作結果 |
> |  | **資料盒邊緣設備/更新摘要** |  |
...
> |  | **資料BoxEdge設備/使用者/操作結果** |  |
> | 動作 | 微軟.DataBoxEdge/DataBoxEdge 設備/使用者/操作結果/閱讀 | 列出或獲取操作結果 |
> |  | **斯克庫斯** |  |
> | 動作 | 微軟.DataBoxEdge/skus/讀取 | 列出或獲取 SKU |
...
> |  | **位置** |  |
> | 動作 | 微軟.資料磚/位置/獲取網路原則/操作 | 根據 NRP 使用的位置獲取子網的網路意圖策略 |
> |  | **位置/操作狀態** |  |
...
> | 動作 | 微軟.資料磚/工作區/刷新許可權/操作 | 工作區的刷新許可權 |
> | 動作 | 微軟.資料磚/工作區/更新拒絕分配/操作 | 更新工作區的託管資源組的拒絕分配而不是操作 |
> | 動作 | 微軟.資料磚/工作區/刷新工作區/操作 | 使用 URL 等新詳細資訊刷新工作區 |
> |  | **工作區/資料庫工作區** |  |
> | 動作 | 微軟.資料磚/工作區/db工作區/寫入 | 初始化資料磚塊工作區（僅限內部） |
> |  | **工作區/供應商/微軟.見解/診斷設置** |  |
...
> |  | **工作區/存儲加密** |  |
> | 動作 | 微軟.資料磚/工作空間/存儲加密/寫入 | 在 Databricks 工作區的託管存儲帳戶上啟用客戶託管金鑰加密 |
> | 動作 | 微軟.資料磚/工作區/存儲加密/刪除 | 禁用 Databricks 工作區的託管存儲帳戶上的客戶託管金鑰加密 |
> |  | **workspaces/virtualNetworkPeerings** |  |
> | 動作 | 微軟.資料磚/工作區/虛擬網路對等值/讀取 | 取得虛擬網路對等互連。 |
> | 動作 | 微軟.資料磚/工作區/虛擬網路對等互連/寫入 | 添加或修改虛擬網路對等互連 |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | Microsoft.DataCatalog/register/action | 註冊資料目錄資來源提供者的訂閱 |
> | 動作 | Microsoft.DataCatalog/unregister/action | 取消註冊資料目錄資來源提供者的訂閱 |
> |  | **catalogs** |  |
> | 動作 | Microsoft.DataCatalog/catalogs/read | 讀取資料目錄資來源提供者的目錄資源。 |
> | 動作 | Microsoft.DataCatalog/catalogs/write | 為數據目錄資來源提供者編寫目錄資源。 |
> | 動作 | Microsoft.DataCatalog/catalogs/delete | 刪除資料目錄資來源提供者的目錄資源。 |
> |  | **檢查名稱可用性** |  |
> | 動作 | 微軟.資料目錄/檢查名稱可用性/讀取 | 檢查資料目錄資來源提供者的目錄名稱可用性。 |
> |  | **資料目錄** |  |
> | 動作 | 微軟.資料目錄/資料目錄/讀取 | 讀取資料目錄資來源提供者的資料目錄資源。 |
> | 動作 | 微軟.資料目錄/資料目錄/寫入 | 為數據目錄資來源提供者編寫資料目錄資源。 |
> | 動作 | 微軟.資料目錄/資料目錄/刪除 | 刪除資料目錄資來源提供者的資料目錄資源。 |
> |  | **操作** |  |
> | 動作 | Microsoft.DataCatalog/operations/read | 讀取資料目錄資來源提供者中的所有可用操作。 |
...
> | 動作 | 微軟.資料工廠/工廠/創建資料流程調試會話/操作 | 創建資料流程調試會話。 |
> | 動作 | 微軟.資料工廠/工廠/啟動資料流程調試會話/操作 | 啟動資料流程調試會話。 |
> | 動作 | 微軟.資料工廠/工廠/添加資料流程到調試會話/操作 | 將資料流程添加到調試會話以進行預覽。 |
> | 動作 | 微軟.資料工廠/工廠/執行資料流程調試命令/操作 | 執行資料流程調試命令。 |
> | 動作 | 微軟.資料工廠/工廠/刪除資料流程調試會話/操作 | 刪除資料流程調試會話。 |
> | 動作 | 微軟.資料工廠/工廠/查詢資料流程調試/操作 | 查詢資料流程調試會話。 |
...
> | 動作 | 微軟.資料工廠/工廠/獲取資料平面訪問/操作 | 取得 ADF DataPlane 服務的存取權。 |
...
> |  | **工廠/資料流程** |  |
> | 動作 | 微軟.資料工廠/工廠/資料流程/讀取 | 讀取資料流程。 |
> | 動作 | 微軟.資料工廠/工廠/資料流程/刪除 | 刪除資料流程。 |
> | 動作 | 微軟.資料工廠/工廠/資料流程/寫入 | 創建或更新資料流程 |
> |  | **工廠/資料集** |  |
...
> |  | **工廠/獲取資料平面訪問** |  |
> | 動作 | 微軟.資料工廠/工廠/獲取資料平面訪問/讀取 | 讀取 ADF DataPlane 服務的存取權。 |
> |  | **工廠/獲取功能價值** |  |
...
> | 動作 | 微軟.資料工廠/工廠/管道/沙箱/行動 | 為管道創建調試運行環境。 |
> |  | **工廠/管道/管道運行** |  |
...
> |  | **工廠/沙箱管道運行/沙箱活動運行** |  |
> | 動作 | 微軟.資料工廠/工廠/沙箱管道運行/沙箱活動運行/讀取 | 獲取活動的調試運行資訊。 |
> |  | **工廠/觸發器** |  |
...
Azure 服務[：Azure 資料湖存儲](../storage/blobs/data-lake-storage-introduction.md)
...
> |  | **帳戶/股份** |  |
> | 動作 | 微軟.DataLakeStore/帳戶/共用/讀取 | 獲取有關共用的資訊。 |
...
> | 動作 | 微軟.資料移轉/服務/配置輔助角色/操作 | 將 DMS 工作人員配置為服務的可用工作人員 |
> | 動作 | 微軟.資料移轉/服務/添加輔助角色/操作 | 將 DMS 工作人員添加到服務中可用的工作人員 |
> | 動作 | 微軟.資料移轉/服務/刪除工作人員/操作 | 將 DMS 工作人員刪除給服務可用的工作人員 |
> | 動作 | 微軟.資料移轉/服務/更新代理配置/操作 | 使用提供的值更新 DMS 代理配置。 |
> | 動作 | 微軟.資料移轉/服務/獲取混合下載連結/操作 | 從 RP Blob 存儲獲取 DMS 工作套裝程式下載連結。 |
> |  | **services/projects** |  |
...
> |  | **服務/服務任務** |  |
> | 動作 | 微軟.資料移轉/服務/服務任務/讀取 | 閱讀資源的相關資訊 |
> | 動作 | 微軟.資料移轉/服務/服務任務/寫入 | 執行工作「Azure 資料庫移轉服務」工作 |
> | 動作 | 微軟.資料移轉/服務/服務任務/刪除 | 刪除資源及其所有子系 |
> | 動作 | 微軟.資料移轉/服務/服務任務/取消/操作 | 取消目前正在執行的工作 |
> |  | **服務/插槽** |  |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.DBforMariaDB/註冊/行動 | 註冊 MariaDB 資源供應商 |
> | 動作 | 微軟.DBforMariaDB/檢查名稱可用性/操作 | 確認指定的伺服器名稱是否可用來針對指定的訂用帳戶進行全球佈建。 |
> |  | **位置/azure 同步操作** |  |
> | 動作 | 微軟.DBforMariaDB/位置/azureAsync操作/讀取 | 返回 MariaDB 伺服器操作結果 |
> |  | **位置/操作結果** |  |
> | 動作 | 微軟.DBforMariaDB/位置/操作結果/閱讀 | 返回基於資源組的 MariaDB 伺服器操作結果 |
> | 動作 | 微軟.DBforMariaDB/位置/操作結果/閱讀 | 返回 MariaDB 伺服器操作結果 |
> |  | **位置/性能層** |  |
> | 動作 | Microsoft.DBforMariaDB/locations/performanceTiers/read | 傳回可用的效能層級清單。 |
> |  | **位置/專用端點連接Azure同步操作** |  |
> | 動作 | 微軟.DBforMariaDB/位置/私人端接Azure同步操作/讀取 | 獲取專用終結點連接操作的結果 |
> |  | **位置/專用端點連接操作結果** |  |
> | 動作 | 微軟.DBforMariaDB/位置/私人端點連接操作結果/讀取 | 獲取專用終結點連接操作的結果 |
> |  | **位置/專用端點連接代理Azure同步操作** |  |
> | 動作 | 微軟.DBforMariaDB/位置/專用端接代理Azure同步操作/讀取 | 獲取專用終結點連接代理操作的結果 |
> |  | **位置/專用端接連接操作結果** |  |
> | 動作 | 微軟.DBforMariaDB/位置/私人端接連接操作結果/讀取 | 獲取專用終結點連接代理操作的結果 |
> |  | **位置/安全警報策略Azure同步操作** |  |
> | 動作 | 微軟.DBforMariaDB/位置/安全警報策略Azure同步操作/讀取 | 返回伺服器威脅檢測操作結果的清單。 |
> |  | **位置/安全警報策略操作結果** |  |
> | 動作 | 微軟.DBforMariaDB/位置/安全警報策略操作結果/讀取 | 返回伺服器威脅檢測操作結果的清單。 |
> |  | **位置/伺服器鍵Azure同步操作** |  |
> | 動作 | 微軟.DBforMariaDB/位置/伺服器鍵Azure同步操作/讀取 | 獲取對透明資料加密伺服器金鑰的正在進行的操作 |
> |  | **位置/伺服器鍵操作結果** |  |
> | 動作 | 微軟.DBforMariaDB/位置/伺服器鍵操作結果/讀取 | 獲取對透明資料加密伺服器金鑰的正在進行的操作 |
> |  | **操作** |  |
> | 動作 | 微軟.DBforMariaDB/操作/讀 | 返回 MariaDB 操作的清單。 |
> |  | **性能等級** |  |
> | 動作 | Microsoft.DBforMariaDB/performanceTiers/read | 傳回可用的效能層級清單。 |
> |  | **servers** |  |
> | 動作 | 微軟.DBforMariaDB/伺服器/查詢文本/操作 | 返回查詢清單的文本 |
...
> | 動作 | 微軟.DBforMariaDB/伺服器/顧問/創建推薦行動會話/行動 | 創建新的建議操作會話 |
> |  | **伺服器/顧問/建議的操作** |  |
> | 動作 | 微軟.DBforMariaDB/伺服器/顧問/推薦操作/閱讀 | 傳回建議的動作清單 |
> | 動作 | 微軟.DBforMariaDB/伺服器/顧問/推薦操作/閱讀 | 傳回建議的動作清單 |
> | 動作 | 微軟.DBforMariaDB/伺服器/顧問/推薦操作/閱讀 | 返回建議的操作 |
...
> |  | **伺服器/日誌檔** |  |
> | 動作 | 微軟.DBforMariaDB/伺服器/日誌檔/讀取 | 返回 MariaDB 日誌檔的清單。 |
> |  | **伺服器/專用端接連接Proxies** |  |
> | 動作 | 微軟.DBforMariaDB/伺服器/私人端接連接Proxies/驗證/操作 | 驗證來自 NRP 端的專用終結點連接創建調用 |
...
> | 動作 | 微軟.DBforMariaDB/伺服器/私人端接連接Proxies/刪除 | 刪除現有專用終結點連接代理 |
> |  | **伺服器/專用端點連接** |  |
> | 動作 | 微軟.DBforMariaDB/伺服器/專用端點連接/讀取 | 返回專用終結點連接的清單或獲取指定專用終結點連接的屬性。 |
> | 動作 | 微軟.DBforMariaDB/伺服器/專用端點連接/刪除 | 刪除現有的專用終結點連接 |
> | 動作 | 微軟.DBforMariaDB/伺服器/私有端點連接/寫入 | 批准或拒絕現有專用終結點連接 |
> |  | **伺服器/專用連結資源** |  |
> | 動作 | 微軟.DBforMariaDB/伺服器/私有連結資源/讀取 | 獲取相應 MariaDB 伺服器的專用連結資源 |
> |  | **伺服器/供應商/微軟.見解/診斷設置** |  |
...
> |  | **伺服器/副本** |  |
> | 動作 | 微軟.DBforMariaDB/伺服器/副本/讀取 | 獲取 MariaDB 伺服器的讀取副本 |
...
> | 動作 | 微軟.DBforMariaDB/伺服器/頂級查詢統計/讀取 | 返回查詢統計資訊 |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.DBforMySQL/註冊/操作 | 註冊 MySQL 資來源提供者 |
> | 動作 | 微軟.DBforMySQL/檢查名稱可用性/操作 | 確認指定的伺服器名稱是否可用來針對指定的訂用帳戶進行全球佈建。 |
> |  | **位置/azure 同步操作** |  |
> | 動作 | 微軟.DBforMySQL/位置/azureAsync操作/讀取 | 返回 MySQL 伺服器操作結果 |
> |  | **位置/操作結果** |  |
> | 動作 | 微軟.DBforMySQL/位置/操作結果/讀取 | 返回基於資源組的 MySQL 伺服器操作結果 |
> | 動作 | 微軟.DBforMySQL/位置/操作結果/讀取 | 返回 MySQL 伺服器操作結果 |
> |  | **位置/性能層** |  |
> | 動作 | Microsoft.DBforMySQL/locations/performanceTiers/read | 傳回可用的效能層級清單。 |
> |  | **位置/專用端點連接Azure同步操作** |  |
> | 動作 | 微軟.DBforMySQL/位置/專用端接Azure同步操作/讀取 | 獲取專用終結點連接操作的結果 |
> |  | **位置/專用端點連接操作結果** |  |
> | 動作 | 微軟.DBforMySQL/位置/私人端點連接操作結果/讀取 | 獲取專用終結點連接操作的結果 |
> |  | **位置/專用端點連接代理Azure同步操作** |  |
> | 動作 | 微軟.DBforMySQL/位置/專用端點連接代理Azure同步操作/讀取 | 獲取專用終結點連接代理操作的結果 |
> |  | **位置/專用端接連接操作結果** |  |
> | 動作 | 微軟.DBforMySQL/位置/私有端接連接代理操作結果/讀取 | 獲取專用終結點連接代理操作的結果 |
> |  | **位置/安全警報策略Azure同步操作** |  |
> | 動作 | 微軟.DBforMySQL/位置/安全警報策略Azure同步操作/讀取 | 返回伺服器威脅檢測操作結果的清單。 |
> |  | **位置/安全警報策略操作結果** |  |
> | 動作 | 微軟.DBforMySQL/位置/安全警報策略操作結果/讀取 | 返回伺服器威脅檢測操作結果的清單。 |
> |  | **位置/伺服器鍵Azure同步操作** |  |
> | 動作 | 微軟.DBforMySQL/位置/伺服器鍵Azure同步操作/讀取 | 獲取對透明資料加密伺服器金鑰的正在進行的操作 |
> |  | **位置/伺服器鍵操作結果** |  |
> | 動作 | 微軟.DBforMySQL/位置/伺服器鍵操作結果/讀取 | 獲取對透明資料加密伺服器金鑰的正在進行的操作 |
> |  | **操作** |  |
> | 動作 | 微軟.DBforMySQL/操作/讀取 | 返回 MySQL 操作的清單。 |
> |  | **性能等級** |  |
> | 動作 | Microsoft.DBforMySQL/performanceTiers/read | 傳回可用的效能層級清單。 |
> |  | **servers** |  |
> | 動作 | 微軟.DBforMySQL/伺服器/查詢文本/操作 | 返回查詢清單的文本 |
...
> | 動作 | 微軟.DBforMySQL/伺服器/重新開機/操作 | 重新開機特定伺服器。 |
...
> | 動作 | 微軟.DBforMySQL/伺服器/顧問/創建推薦操作會話/操作 | 創建新的建議操作會話 |
> |  | **伺服器/顧問/建議的操作** |  |
> | 動作 | 微軟.DBforMySQL/伺服器/顧問/建議的操作/讀取 | 傳回建議的動作清單 |
> | 動作 | 微軟.DBforMySQL/伺服器/顧問/建議的操作/讀取 | 傳回建議的動作清單 |
> | 動作 | 微軟.DBforMySQL/伺服器/顧問/建議的操作/讀取 | 返回建議的操作 |
> |  | **servers/configurations** |  |
...
> |  | **伺服器/日誌檔** |  |
> | 動作 | 微軟.DBforMySQL/伺服器/日誌檔/讀取 | 返回 MySQL 日誌檔的清單。 |
> |  | **伺服器/專用端接連接Proxies** |  |
> | 動作 | 微軟.DBforMySQL/伺服器/私人端接連接Proxies/驗證/操作 | 驗證來自 NRP 端的專用終結點連接創建調用 |
...
> | 動作 | 微軟.DBforMySQL/伺服器/私人端接連接Proxies/刪除 | 刪除現有專用終結點連接代理 |
> |  | **伺服器/專用端點連接** |  |
> | 動作 | 微軟.DBforMySQL/伺服器/私有端點連接/讀取 | 返回專用終結點連接的清單或獲取指定專用終結點連接的屬性。 |
> | 動作 | 微軟.DBforMySQL/伺服器/專用端點連接/刪除 | 刪除現有的專用終結點連接 |
> | 動作 | 微軟.DBforMySQL/伺服器/私有端點連接/寫入 | 批准或拒絕現有專用終結點連接 |
> |  | **伺服器/專用連結資源** |  |
> | 動作 | 微軟.DBforMySQL/伺服器/私有連結資源/讀取 | 獲取相應 MySQL 伺服器的專用連結資源 |
> |  | **伺服器/供應商/微軟.見解/診斷設置** |  |
...
> |  | **伺服器/副本** |  |
> | 動作 | 微軟.DBforMySQL/伺服器/副本/讀取 | 獲取 MySQL 伺服器的讀取副本 |
> |  | **servers/securityAlertPolicies** |  |
...
> | 動作 | 微軟.DBforMySQL/伺服器/頂級查詢統計/讀取 | 返回查詢統計資訊 |
> |  | **servers/virtualNetworkRules** |  |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.DBforPostsql/註冊/行動 | 註冊 PostgreSQL 資來源提供者 |
> | 動作 | 微軟.DBforPostgreSQL/檢查名稱可用性/操作 | 確認指定的伺服器名稱是否可用來針對指定的訂用帳戶進行全球佈建。 |
> |  | **位置/azure 同步操作** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/azureAsync操作/讀取 | 返回後格雷SQL伺服器操作結果 |
> |  | **位置/操作結果** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/操作結果/閱讀 | 返回基於資源組的後格雷SQL伺服器操作結果 |
> | 動作 | 微軟.DBforPostgreSQL/位置/操作結果/閱讀 | 返回後格雷SQL伺服器操作結果 |
> |  | **位置/性能層** |  |
> | 動作 | Microsoft.DBforPostgreSQL/locations/performanceTiers/read | 傳回可用的效能層級清單。 |
> |  | **位置/專用端點連接Azure同步操作** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/私人端接Azure同步操作/讀取 | 獲取專用終結點連接操作的結果 |
> |  | **位置/專用端點連接操作結果** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/私人端點連接操作結果/讀取 | 獲取專用終結點連接操作的結果 |
> |  | **位置/專用端點連接代理Azure同步操作** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/私有端點連接代理Azure同步操作/讀取 | 獲取專用終結點連接代理操作的結果 |
> |  | **位置/專用端接連接操作結果** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/私人端接連接代理操作結果/讀取 | 獲取專用終結點連接代理操作的結果 |
> |  | **位置/安全警報策略Azure同步操作** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/安全警報策略Azure同步操作/讀取 | 返回伺服器威脅檢測操作結果的清單。 |
> |  | **位置/安全警報策略操作結果** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/安全警報策略操作結果/讀取 | 返回伺服器威脅檢測操作結果的清單。 |
> |  | **位置/伺服器鍵Azure同步操作** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/伺服器鍵Azure同步操作/讀取 | 獲取對透明資料加密伺服器金鑰的正在進行的操作 |
> |  | **位置/伺服器鍵操作結果** |  |
> | 動作 | 微軟.DBforPostgreSQL/位置/伺服器鍵操作結果/讀取 | 獲取對透明資料加密伺服器金鑰的正在進行的操作 |
> |  | **操作** |  |
> | 動作 | 微軟.DBforPostgreSQL/操作/讀 | 返回 PostgreSQL 操作的清單。 |
> |  | **性能等級** |  |
...
> | 動作 | 微軟.DBforPostgreSQL/伺服器/重新開機/操作 | 重新開機特定伺服器。 |
...
> |  | **servers/databases** |  |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/資料庫/讀取 | 返回 PostgreSQL 資料庫的清單或獲取指定資料庫的屬性。 |
...
> | 動作 | 微軟.DBforPostgreSQL/伺服器/金鑰/刪除 | 刪除現有的伺服器金鑰。 |
> |  | **伺服器/日誌檔** |  |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/日誌檔/讀取 | 返回 PostgreSQL 日誌檔的清單。 |
> |  | **伺服器/專用端接連接Proxies** |  |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/私人端接連接Proxies/驗證/操作 | 驗證來自 NRP 端的專用終結點連接創建調用 |
...
> | 動作 | 微軟.DBforPostgreSQL/伺服器/私人端接連接Proxies/刪除 | 刪除現有專用終結點連接代理 |
> |  | **伺服器/專用端點連接** |  |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/私人端點連接/讀取 | 返回專用終結點連接的清單或獲取指定專用終結點連接的屬性。 |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/私人端點連接/刪除 | 刪除現有的專用終結點連接 |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/私有端點連接/寫入 | 批准或拒絕現有專用終結點連接 |
> |  | **伺服器/專用連結資源** |  |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/私有連結資源/讀取 | 獲取相應 PostgreSQL 伺服器的專用連結資源 |
> |  | **伺服器/供應商/微軟.見解/診斷設置** |  |
...
> |  | **伺服器/供應商/微軟.見解/記錄定義** |  |
> | 動作 | Microsoft.DBforPostgreSQL/servers/providers/Microsoft.Insights/logDefinitions/read | 獲取 PostgreSQL 伺服器的可用日誌 |
> |  | **伺服器/供應商/微軟.見解/指標定義** |  |
> | 動作 | Microsoft.DBforPostgreSQL/servers/providers/Microsoft.Insights/metricDefinitions/read | 傳回可供資料庫使用之計量的類型 |
> |  | **servers/queryTexts** |  |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/查詢文本/閱讀 | 返回查詢清單的文本 |
> |  | **servers/recoverableServers** |  |
> | 動作 | Microsoft.DBforPostgreSQL/servers/recoverableServers/read | 傳回可復原的 PostgreSQL 伺服器資訊 |
> |  | **伺服器/副本** |  |
> | 動作 | 微軟.DBforPostgreSQL/伺服器/副本/讀取 | 獲取 PostgreSQL 伺服器的讀取副本 |
> |  | **servers/securityAlertPolicies** |  |
...
> |  | **伺服器2/提供程式/微軟.Insights/記錄定義** |  |
> | 動作 | 微軟.DBforPostgreSQL/伺服器2/供應商/微軟.見解/記錄定義/讀取 | 獲取 PostgreSQL 伺服器的可用日誌 |
> |  | **伺服器2/供應商/微軟.見解/指標定義** |  |
...
> |  | **單個伺服器/供應商/微軟.見解/記錄定義** |  |
> | 動作 | 微軟.DBforPostgreSQL/單伺服器/供應商/微軟.見解/記錄定義/讀取 | 獲取 PostgreSQL 伺服器的可用日誌 |
> |  | **單伺服器/供應商/微軟.見解/指標定義** |  |
> | 動作 | 微軟.DBforPostgreSQL/單伺服器/供應商/微軟.見解/指標定義/讀取 | 傳回可供資料庫使用之計量的類型 |

## <a name="microsoftdevices"></a>Microsoft.Devices

Azure 服務[：IoT 中心](../iot-hub/index.yml)[，IoT 中心設備預配服務](../iot-dps/index.yml)
...
> |  | **帳戶/記錄定義** |  |
> | 動作 | 微軟.設備/帳戶/記錄定義/讀取 | 取得 IotHub 服務的可用記錄定義 |
> |  | **帳戶/指標定義** |  |
> | 動作 | 微軟.設備/帳戶/指標定義/讀取 | 取得 IotHub 服務的可用計量 |
> |  | **數位雙胞胎** |  |
> | 動作 | 微軟.設備/數位雙胞胎/閱讀 | 獲取與訂閱關聯的數位孿生帳戶的清單 |
> | 動作 | 微軟.設備/數位雙胞胎/寫入 | 創建新的數位孿生帳戶 |
> | 動作 | 微軟.設備/數位雙胞胎/刪除 | 刪除現有的數位孿生帳戶及其所有子帳戶 |
> |  | **數位雙胞胎/操作結果** |  |
> | 動作 | 微軟.設備/數位雙胞胎/操作結果/閱讀 | 獲取針對數位孿生帳戶的操作狀態 |
> |  | **數位雙胞胎/斯克烏斯** |  |
> | 動作 | 微軟.設備/數位雙胞胎/skus/閱讀 | 獲取數位雙胞胎帳戶的有效 SKU 清單 |
> |  | **彈性池/診斷設置** |  |
...
> |  | **彈性池/事件網格篩選器** |  |
> | 動作 | 微軟.設備/彈性池/事件網格篩檢程式/寫入 | 創建新或更新現有彈性池事件網格篩選器 |
> | 動作 | 微軟.設備/彈性池/事件網格篩檢程式/讀取 | 獲取彈性池事件網格篩選器 |
> | 動作 | 微軟.設備/彈性池/事件網格篩檢程式/刪除 | 刪除彈性池事件網格篩選器 |
> |  | **彈性池/iotHub租戶** |  |
...
> |  | **彈性池/iotHub租戶/安全設置** |  |
> | 動作 | 微軟.設備/彈性池/iotHub租戶/安全設置/寫入 | 更新 Iot 租戶中心的 Azure 安全中心設置 |
> | 動作 | 微軟.設備/彈性池/iotHub租戶/安全設置/讀取 | 獲取 Iot 租戶中心的 Azure 安全中心設置 |
> |  | **彈性池/iotHub租戶/安全設置/操作結果** |  |
> | 動作 | 微軟.設備/彈性池/iotHub租戶/安全設置/操作結果/閱讀 | 獲取 Iot 租戶中心安全設置的"非同步放置"操作的結果 |
> |  | **彈性池/指標定義** |  |
...
> | 動作 | 微軟.設備/iotHubs/私人端點連接審批/操作 | 批准或拒絕專用終結點連接 |
> |  | **iotHubs/證書** |  |
...
> | 動作 | 微軟.設備/iotHubs/數位雙星連結/閱讀 |  |
> | 動作 | 微軟.設備/iotHubs/數位雙星連結/刪除 |  |
> |  | **iotHubs/事件網格篩選器** |  |
...
> | 動作 | 微軟.設備/iotHubs/私人終端連接Proxies/驗證/操作 | 在創建期間驗證專用終結點連接代理輸入 |
> | 動作 | 微軟.設備/iotHubs/私人終端連接Proxies/閱讀 | 獲取指定專用終結點連接代理的屬性 |
> | 動作 | 微軟.設備/iotHubs/私人終端連接Proxies/寫 | 創建或更新專用終結點連接代理 |
> | 動作 | 微軟.設備/iotHubs/私人終端連接Proxies/刪除 | 刪除現有專用終結點連接代理 |
> |  | **iotHubs/私有端點連接Proxies/操作結果** |  |
> | 動作 | 微軟.設備/iotHubs/私人終端連接Proxies/操作結果/閱讀 | 獲取私有終結點連接代理上的非同步作業的結果 |
> |  | **iotHubs/私有端點連接** |  |
> | 動作 | 微軟.設備/iotHubs/私人端點連接/讀取 | 獲取指定專用終結點連接的屬性 |
> | 動作 | 微軟.設備/iotHubs/私人端點連接/刪除 | 刪除現有的專用終結點連接 |
> | 動作 | 微軟.設備/iotHubs/私有端點連接/寫入 | 創建或更新專用終結點連接 |
> |  | **iotHubs/專用端點連接/操作結果** |  |
> | 動作 | 微軟.設備/iotHubs/私有端點連接/操作結果/閱讀 | 獲取私有終結點連接上非同步作業的結果 |
> |  | **iotHubs/私有連結資源** |  |
> | 動作 | 微軟.設備/iotHubs/私人連結資源/閱讀 | 獲取 IotHub 的專用連結資源 |
> |  | **iotHubs/配額指標** |  |
...
> |  | **iotHubs/安全設置** |  |
> | 動作 | 微軟.設備/iotHubs/安全設置/寫入 | 更新 Iot 中心上的 Azure 安全中心設置 |
> | 動作 | 微軟.設備/iotHubs/安全設置/閱讀 | 獲取 Iot 中心上的 Azure 安全中心設置 |
> |  | **iotHubs/安全設置/操作結果** |  |
> | 動作 | 微軟.設備/iotHubs/安全設置/操作結果/閱讀 | 獲取 Iot 中心安全設置的"非同步放置"操作的結果 |
> |  | **iotHubs/skus** |  |
...
> |  | **位置** |  |
> | 動作 | 微軟.開發空間/位置/檢查容器主機映射/操作 | 檢查容器主機的現有控制器映射 |
> |  | **位置/檢查容器主機映射** |  |
> | 動作 | 微軟.開發空間/位置/檢查容器主機映射/讀取 | 檢查容器主機的現有控制器映射 |
> |  | **位置/操作結果** |  |
> | 動作 | 微軟.開發空間/位置/操作結果/讀取 | 非同步作業的讀取狀態 |
...
> | 動作 | 微軟.開發測試實驗室/實驗室/確保當前使用者設定檔/操作 | 確保當前使用者在實驗室中具有有效的設定檔。 |
> |  | **實驗室/文物來源** |  |
...
> | 動作 | Microsoft.DevTestLab/labs/artifactSources/artifacts/GenerateArmTemplate/action | 為給定專案生成 Azure 資源管理器範本，將所需檔上載到存儲帳戶，並驗證生成的專案。 |
> |  | **labs/costs** |  |
...
> | 動作 | 微軟.開發測試實驗室/實驗室/虛擬機器/清除結果/操作 | 清除虛擬機器的專案結果。 |
...
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/獲取備份策略/操作 | 獲取資料庫帳戶的備份策略 |
...
> |  | **資料庫帳戶/卡珊多拉關鍵空間** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/寫入 | 創建卡珊多拉鍵空間。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/讀取 | 閱讀卡珊多拉鍵空間或列出所有卡珊多拉鍵空間。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/刪除 | 刪除卡珊多拉鍵空間。 |
> |  | **資料庫帳戶/卡珊多拉關鍵空間/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/卡珊多拉關鍵空間/表** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/表/寫入 | 創建或更新卡珊多拉表。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/表/讀取 | 閱讀卡珊多拉表或列出所有卡珊多拉表。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/表/刪除 | 刪除卡珊多拉表。 |
> |  | **資料庫帳戶/卡珊多拉關鍵空間/表/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/表/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/卡珊多拉關鍵空間/表/輸送量設置** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/表/輸送量設置/寫入 | 更新卡珊多拉表輸送量。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/表/輸送量設置/讀取 | 讀取卡珊多拉表輸送量。 |
> |  | **資料庫帳戶/卡珊多拉關鍵空間/表/輸送量設置/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/表/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/卡珊多拉關鍵空間/輸送量設置** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/輸送量設置/寫入 | 更新卡珊多拉金鑰空間輸送量。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/輸送量設置/讀取 | 讀取卡珊多拉鍵空間輸送量。 |
> |  | **資料庫帳戶/卡珊多拉關鍵空間/輸送量設置/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/卡珊多拉關鍵空間/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/資料庫/集合/指標定義** |  |
...
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/格林林資料庫/圖形/操作結果/讀取 | 讀取非同步作業的狀態。 |
...
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/格林林資料庫/圖形/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/格林林資料庫/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/格林林資料庫/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/格林林資料庫/輸送量設置** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/格林林資料庫/輸送量設置/寫入 | 更新格雷姆林資料庫輸送量。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/格雷姆林資料庫/輸送量設置/讀取 | 讀取格雷姆林資料庫輸送量。 |
> |  | **資料庫帳戶/格林林資料庫/輸送量設置/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/格雷姆林資料庫/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/指標定義** |  |
...
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/蒙戈布資料庫/集合/操作結果/讀取 | 讀取非同步作業的狀態。 |
...
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/蒙戈布資料庫/集合/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/mongodb 資料庫/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/蒙戈布資料庫/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/mongodb 資料庫/輸送量設置** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/蒙戈布資料庫/輸送量設置/寫入 | 更新 MongoDB 資料庫輸送量。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/蒙戈布資料庫/輸送量設置/讀取 | 讀取蒙戈DB資料庫輸送量。 |
> |  | **資料庫帳戶/mongodb 資料庫/輸送量設置/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/蒙戈布資料庫/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/筆記本工作區** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/筆記本工作區/寫入 | 創建或更新筆記本工作區 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/筆記本工作區/讀取 | 閱讀筆記本工作區 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/筆記本工作區/刪除 | 刪除筆記本工作區 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/筆記本工作區/清單連接資訊/操作 | 列出筆記本工作區的連接資訊 |
> |  | **資料庫帳戶/筆記本工作區/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/筆記本工作/操作結果/讀取 | 讀取筆記本工作區上非同步作業的狀態 |
> |  | **資料庫帳戶/操作結果** |  |
...
> |  | **資料庫帳戶/私有端點連接Proxies** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/私有端點連接Proxies/讀取 | 讀取資料庫帳戶的專用終結點連接代理 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/私有端點連接Proxies/寫入 | 創建或更新資料庫帳戶的專用終結點連接代理 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/私人端接連接Proxies/刪除 | 刪除資料庫帳戶的專用終結點連接代理 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/私有端點連接Proxies/驗證/操作 | 驗證資料庫帳戶的專用終結點連接代理 |
> |  | **資料庫帳戶/私有端接連接Proxies/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/私有端點連接Proxies/操作結果/讀取 | 讀取專用終結點連接代理非同步作業的狀態 |
> |  | **資料庫帳戶/專用終結點連接** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/私有端點連接/讀取 | 讀取專用終結點連接或列出資料庫帳戶的所有專用終結點連接 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/私有端點連接/寫入 | 創建或更新資料庫帳戶的專用終結點連接 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/專用端點連接/刪除 | 刪除資料庫帳戶的專用終結點連接 |
> |  | **資料庫帳戶/私有終結點連接/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/私有終結點連接/操作結果/讀取 | 讀取私有終結點進行非同步作業的狀態 |
> |  | **資料庫帳戶/私有連結資源** |  |
...
> |  | **資料庫帳戶/sql資料庫** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/寫入 | 建立 SQL 資料庫。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/讀取 | 讀取 SQL 資料庫或列出所有 SQL 資料庫。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/刪除 | 刪除 SQL 資料庫。 |
> |  | **資料庫帳戶/sql資料庫/容器** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/寫入 | 創建或更新 SQL 容器。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/讀取 | 讀取 SQL 容器或列出所有 SQL 容器。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/刪除 | 刪除 SQL 容器。 |
> |  | **資料庫帳戶/sql資料庫/容器/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/sql資料庫/容器/存儲程式** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/存儲程式/寫入 | 創建或更新 SQL 預存程序。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/存儲程式/讀取 | 讀取 SQL 預存程序或列出所有 SQL 預存程序。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/存儲程式/刪除 | 刪除 SQL 預存程序。 |
> |  | **資料庫帳戶/sql資料庫/容器/存儲程式/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/存儲程式/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/sql資料庫/容器/輸送量設置** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/輸送量設置/寫入 | 更新 SQL 容器輸送量。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/輸送量設置/讀取 | 讀取 SQL 容器輸送量。 |
> |  | **資料庫帳戶/sql資料庫/容器/輸送量設置/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/sql資料庫/容器/觸發器** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/觸發器/寫入 | 創建或更新 SQL 觸發器。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/觸發器/讀取 | 讀取 SQL 觸發器或列出所有 SQL 觸發器。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/觸發器/刪除 | 刪除 SQL 觸發器。 |
> |  | **資料庫帳戶/sql資料庫/容器/觸發器/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/觸發器/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/sql資料庫/容器/使用者定義函數** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/使用者定義功能/寫入 | 創建或更新 SQL 使用者定義的函數。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/使用者定義功能/讀取 | 讀取 SQL 使用者定義的函數或列出所有 SQL 使用者定義的函數。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/容器/使用者定義功能/刪除 | 刪除 SQL 使用者定義的函數。 |
> |  | **資料庫帳戶/sql資料庫/容器/使用者定義的函數/操作結果** |  |
> | 動作 | Microsoft.文檔資料庫/資料庫帳戶/sql資料庫/容器/使用者定義的功能/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/sql資料庫/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/sql資料庫/輸送量設置** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/輸送量設置/寫入 | 更新 SQL 資料庫輸送量。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/輸送量設置/讀取 | 讀取 SQL 資料庫輸送量。 |
> |  | **資料庫帳戶/sql資料庫/輸送量設置/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/sql資料庫/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/表** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/表/寫入 | 創建或更新表。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/表/讀取 | 閱讀一個表或列出所有表。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/表/刪除 | 刪除表。 |
> |  | **資料庫會計/表/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/表/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/表/輸送量設置** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/表/輸送量設置/寫入 | 更新表輸送量。 |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/表/輸送量設置/讀取 | 讀取表輸送量。 |
> |  | **資料庫帳戶/表/輸送量設置/操作結果** |  |
> | 動作 | 微軟.文檔資料庫/資料庫帳戶/表/輸送量設置/操作結果/讀取 | 讀取非同步作業的狀態。 |
> |  | **資料庫帳戶/用法** |  |
...
> |  | **位置/操作狀態** |  |
> | 動作 | 微軟.文檔資料庫/位置/操作狀態/讀取 | 讀取非同步作業的狀態 |
> |  | **操作結果** |  |
...
> |  | **域/專用端接連接 Proxies** |  |
> | 動作 | 微軟.事件網格/域/私人端接連接Proxies/驗證/操作 | 驗證域的專用端接連接 Proxie |
> | 動作 | 微軟.事件網格/域/私人端接連接Proxies/讀取 | 讀取域的專用端接連接 Proxie |
> | 動作 | 微軟.事件網格/域/私人端接連接Proxies/寫入 | 為域編寫專用終結點連接 Proxie |
> | 動作 | 微軟.事件網格/域/私人端接連接Proxies/刪除 | 刪除域的專用終結點連接 Proxie |
> |  | **域/專用端點連接** |  |
> | 動作 | 微軟.事件網格/域/私有端點連接/讀取 | 讀取域的專用終結點連接 |
> | 動作 | 微軟.事件網格/域/私有端點連接/寫入 | 為域寫入專用終結點連接 |
> | 動作 | 微軟.事件網格/域/私人端點連接/刪除 | 刪除域的專用終結點連接 |
> |  | **域/私有連結資源** |  |
> | 動作 | 微軟.事件網格/域/私有連結資源/讀取 | 獲取或列出域的私有連結資源 |
> |  | **域/供應商/微軟.見解/記錄定義** |  |
> | 動作 | 微軟.eventGrid/域/供應商/微軟.見解/記錄定義/讀取 | 允許訪問診斷日誌 |
> |  | **域/供應商/微軟.見解/指標定義** |  |
...
> | 動作 | 微軟.事件網格/域/主題/寫入 | 創建或更新域主題 |
> | 動作 | 微軟.事件網格/域/主題/刪除 | 刪除域主題 |
> |  | **eventSubscriptions** |  |
> | 動作 | Microsoft.EventGrid/eventSubscriptions/write | 創建或更新事件訂閱 |
> | 動作 | Microsoft.EventGrid/eventSubscriptions/read | 閱讀事件訂閱 |
> | 動作 | Microsoft.EventGrid/eventSubscriptions/delete | 刪除事件訂閱 |
...
> |  | **合作夥伴命名空間** |  |
> | 動作 | 微軟.事件網格/合作夥伴命名空間/寫入 | 創建或更新合作夥伴命名空間 |
> | 動作 | 微軟.事件網格/合作夥伴命名空間/讀取 | 讀取合作夥伴命名空間 |
> | 動作 | 微軟.事件網格/合作夥伴命名空間/刪除 | 刪除合作夥伴命名空間 |
> | 動作 | 微軟.事件網格/合作夥伴命名空間/清單鍵/操作 | 列出合作夥伴命名空間的鍵 |
> | 動作 | 微軟.事件網格/合作夥伴命名空間/重新生成鍵/操作 | 重新生成合作夥伴命名空間的鍵 |
> |  | **合作夥伴命名空間/事件通道** |  |
> | 動作 | 微軟.事件網格/合作夥伴命名空間/事件通道/讀取 | 閱讀事件通道 |
> | 動作 | 微軟.事件網格/合作夥伴命名空間/事件通道/寫入 | 創建或更新事件通道 |
> | 動作 | 微軟.事件網格/合作夥伴命名空間/事件通道/刪除 | 刪除事件通道 |
> |  | **合作夥伴註冊** |  |
> | 動作 | 微軟.事件網格/合作夥伴註冊/寫入 | 創建或更新合作夥伴註冊 |
> | 動作 | 微軟.事件網格/合作夥伴註冊/閱讀 | 閱讀合作夥伴註冊 |
> | 動作 | 微軟.事件網格/合作夥伴註冊/刪除 | 刪除合作夥伴註冊 |
> |  | **合作夥伴主題** |  |
> | 動作 | 微軟.事件網格/合作夥伴主題/閱讀 | 閱讀合作夥伴主題 |
> | 動作 | 微軟.事件網格/合作夥伴主題/寫入 | 創建或更新合作夥伴主題 |
> | 動作 | 微軟.事件網格/合作夥伴主題/刪除 | 刪除合作夥伴主題 |
> | 動作 | 微軟.事件網格/合作夥伴主題/啟動/操作 | 啟動合作夥伴主題 |
> | 動作 | 微軟.事件網格/合作夥伴主題/停用/操作 | 停用合作夥伴主題 |
> |  | **Sku** |  |
> | 動作 | 微軟.事件網格/sku/讀取 | 讀取事件網格資源的可用 SKU 定義 |
> |  | **系統主題** |  |
> | 動作 | 微軟.事件網格/系統主題/閱讀 | 閱讀系統主題 |
> | 動作 | 微軟.事件網格/系統主題/寫入 | 創建或更新系統主題 |
> | 動作 | 微軟.事件網格/系統主題/刪除 | 刪除系統主題 |
> |  | **系統主題/供應商/微軟.見解/診斷設置** |  |
> | 動作 | 微軟.事件網格/系統主題/供應商/微軟.見解/診斷設置/讀取 | 獲取系統主題的診斷設置 |
> | 動作 | 微軟.事件網格/系統主題/供應商/微軟.見解/診斷設置/寫入 | 創建或更新系統主題的診斷設置 |
> |  | **系統主題/供應商/微軟.見解/記錄定義** |  |
> | 動作 | 微軟.事件網格/系統主題/供應商/微軟.見解/記錄定義/讀取 | 允許訪問診斷日誌 |
> |  | **系統主題/供應商/微軟.見解/指標定義** |  |
> | 動作 | 微軟.事件網格/系統主題/供應商/微軟.見解/指標定義/讀取 | 獲取系統主題的可用指標 |
> |  | **主題** |  |
...
> |  | **主題/私有端點連接Proxies** |  |
> | 動作 | 微軟.事件網格/主題/私人端接連接Proxies/驗證/操作 | 驗證主題的專用端接連接 Proxie |
> | 動作 | 微軟.事件網格/主題/私人端接連接Proxies/閱讀 | 閱讀私有端點連接 Proxie 主題 |
> | 動作 | 微軟.事件網格/主題/私人端接連接Proxies/寫 | 為主題編寫私有終結點連接 Proxie |
> | 動作 | 微軟.事件網格/主題/私人端接連接Proxies/刪除 | 刪除主題的專用終結點連接 Proxie |
> |  | **主題/專用端點連接** |  |
> | 動作 | 微軟.事件網格/主題/私人端點連接/讀取 | 閱讀主題的專用終結點連接 |
> | 動作 | 微軟.事件網格/主題/私有端點連接/寫入 | 為主題編寫專用終結點連接 |
> | 動作 | 微軟.事件網格/主題/私人端點連接/刪除 | 刪除主題的專用終結點連接 |
> |  | **主題/私有連結資源** |  |
...
> |  | **主題/供應商/微軟.見解/記錄定義** |  |
> | 動作 | 微軟.事件網格/主題/供應商/微軟.見解/記錄定義/閱讀 | 允許訪問診斷日誌 |
> |  | **主題/供應商/微軟.見解/指標定義** |  |
...
> |  | **命名空間/網路規則集** |  |
> | 動作 | 微軟.EventHub/命名空間/網路規則集/讀取 | 獲取網路規則集資源 |
...
> |  | **命名空間/專用端接Proxies** |  |
> | 動作 | 微軟.事件Hub/命名空間/私人端接連接Proxies/驗證/操作 | 驗證專用終結點連接代理 |
> | 動作 | 微軟.事件Hub/命名空間/私人端接連接Proxies/讀取 | 獲取專用終結點連接代理 |
> | 動作 | 微軟.事件Hub/命名空間/私人端接連接Proxies/寫入 | 創建專用終結點連接代理 |
> | 動作 | 微軟.事件Hub/命名空間/私人端接連接Proxies/刪除 | 刪除專用終結點連接代理 |
> |  | **命名空間/供應商/微軟.見解/診斷設置** |  |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.來賓配置/註冊/操作 | 註冊 Microsoft.Guest 配置資來源提供者的訂閱。 |
...
> |  | **操作** |  |
> | 動作 | 微軟.來賓配置/操作/讀取 | 獲取 Microsoft.Guest 配置資來源提供者的操作 |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.HDInsight/註冊/操作 | 註冊訂閱的 HDInsight 資來源提供者 |
> | 動作 | 微軟.HDInsight/取消註冊/操作 | 取消註冊訂閱的 HDInsight 資來源提供者 |
> |  | **集群** |  |
...
> | 動作 | 微軟.HDInsight/集群/獲取閘道設置/操作 | 獲取 HDInsight 群集的閘道設置 |
> | 動作 | 微軟.HDInsight/集群/更新閘道設置/操作 | 更新 HDInsight 群集的閘道設置 |
...
> |  | **群集/擴展** |  |
> | 動作 | 微軟.HDInsight/集群/擴展/寫入 | 為 HDInsight 群集創建群集擴展 |
> | 動作 | 微軟.HDInsight/集群/擴展/讀取 | 獲取 HDInsight 群集的群集擴展 |
> | 動作 | 微軟.HDInsight/集群/擴展/刪除 | 刪除 HDInsight 群集的群集擴展 |
> |  | **群集/供應商/微軟.見解/診斷設置** |  |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.混合計算/註冊/操作 | 註冊 Microsoft.混合計算資來源提供者的訂閱 |
...
> | 動作 | 微軟.混合計算/機器/刪除 | 刪除 Azure 弧形電腦 |
> | 動作 | 微軟.混合計算/機器/重新連接/操作 | 重新連接 Azure 弧形電腦 |
> |  | **機器/擴展** |  |
> | 動作 | 微軟.混合計算/機器/擴展/讀取 | 讀取任何 Azure 電弧擴展 |
> | 動作 | 微軟.混合計算/機器/擴展/寫入 | 安裝或更新 Azure 電弧擴展 |
> | 動作 | 微軟.混合計算/機器/擴展/刪除 | 刪除 Azure 電弧擴展 |
> |  | **操作** |  |
> | 動作 | 微軟.混合計算/操作/讀取 | 讀取伺服器 Azure 弧的所有操作 |

## <a name="microsoftimportexport"></a>Microsoft.ImportExport

Azure 服務[：Azure 導入/匯出](../storage/common/storage-import-export-service.md)
...
> |  | **操作** |  |
> | 動作 | 微軟.進口出口/操作/讀取 | 獲取資來源提供者支援的操作。 |
...
> |  | **元件/提供程式/微軟.見解/記錄定義** |  |
> | 動作 | 微軟.見解/元件/供應商/微軟.見解/記錄定義/閱讀 | 讀取記錄定義 |
> |  | **元件/提供程式/微軟.見解/指標定義** |  |
...
> | 動作 | 微軟.見解/資料收集規則關聯/寫入 | 創建或更新資源與資料收集規則的關聯 |
> | 動作 | 微軟.見解/資料收集規則關聯/刪除 | 刪除資源與資料收集規則的關聯 |
> |  | **資料收集規則** |  |
> | 動作 | 微軟.見解/資料收集規則/閱讀 | 讀取資料收集規則 |
> | 動作 | 微軟.見解/資料收集規則/寫入 | 創建或更新資料收集規則 |
...
> |  | **日誌/表.自訂** |  |
> | 動作 | 微軟.見解/日誌/表格.自訂/閱讀 | 從任何自訂記錄檔讀取資料 |
> |  | **日誌/UAApp** |  |
...
> |  | **myWorkbooks** |  |
> | 動作 | 微軟.見解/我的活頁簿/寫作 | 創建或更新專用活頁簿 |
> | 動作 | 微軟.見解/我的活頁簿/閱讀 | 閱讀私人活頁簿 |
> |  | **作業** |  |
> | 動作 | Microsoft.Insights/Operations/Read | 讀取作業 |
> |  | **私有連結範圍操作狀態** |  |
> | 動作 | 微軟.見解/私人連結範圍操作狀態/閱讀 | 讀取專用連結作用域操作狀態 |
> |  | **私人連結範圍** |  |
> | 動作 | 微軟.見解/私人連結範圍/閱讀 | 讀取專用連結作用域 |
> | 動作 | 微軟.見解/私人連結範圍/寫入 | 創建或更新專用連結作用域 |
> | 動作 | 微軟.見解/私人連結範圍/刪除 | 刪除專用連結範圍 |
> |  | **私有連結範圍/私有端點連接 Proxies** |  |
> | 動作 | 微軟.Insights/私人連結範圍/私人端接連結Proxies/閱讀 | 讀取專用終結點連接代理 |
> | 動作 | 微軟.見解/私人連結範圍/私人端接連結Proxies/寫入 | 創建或更新專用終結點連接代理 |
> | 動作 | 微軟.Insights/私人連結範圍/私人端接連結Proxies/刪除 | 刪除專用終結點連接代理 |
> | 動作 | 微軟.Insights/私人連結範圍/私人端接連結Proxies/驗證/操作 | 驗證專用終結點連接代理 |
> |  | **私有連結範圍/專用端點連接** |  |
> | 動作 | 微軟.Insights/私人連結範圍/私人端點連接/閱讀 | 讀取專用終結點連接 |
> | 動作 | 微軟.Insights/私人連結範圍/私人端點連接/寫入 | 創建或更新專用終結點連接 |
> | 動作 | 微軟.Insights/私人連結範圍/私人端點連接/刪除 | 刪除專用終結點連接 |
> |  | **私有連結範圍/私人連結資源** |  |
> | 動作 | 微軟.見解/私人連結範圍/私人連結資源/閱讀 | 讀取專用連結資源 |
> |  | **私有連結範圍/範圍資源** |  |
> | 動作 | 微軟.見解/私人連結範圍/範圍資源/閱讀 | 讀取專用連結作用域資源 |
> | 動作 | 微軟.見解/私人連結範圍/範圍資源/寫入 | 創建或更新專用連結作用域資源 |
> | 動作 | 微軟.見解/私人連結範圍/範圍資源/刪除 | 刪除專用連結範圍資源 |
> |  | **計畫查詢規則** |  |
...
> |  | **活頁簿** |  |
> | 動作 | 微軟.見解/活頁簿/寫入 | 創建或更新活頁簿 |
> | 動作 | 微軟.見解/活頁簿/刪除 | 刪除活頁簿 |
> | 動作 | 微軟.見解/活頁簿/閱讀 | 閱讀活頁簿 |
> |  | **資料收集規則/資料** |  |
> | DataAction | 微軟.見解/資料收集規則/資料/寫入 | 將資料發送到資料收集規則 |
> |  | **計量** |  |
...
> | 動作 | 微軟.IoTCentral/應用程式範本/操作 | 獲取 Azure IoT 中央的所有可用應用程式範本 |
...
> |  | **保存庫/事件網格篩選器** |  |
> | 動作 | 微軟.金鑰庫/保存庫/事件網格篩選器/讀取 | 通知 Microsoft.KeyVault 正在查看金鑰保存庫的事件網格訂閱 |
> | 動作 | 微軟.金鑰庫/保存庫/事件網格篩選器/寫入 | 通知 Microsoft.KeyVault 正在創建金鑰保存庫的新事件網格訂閱 |
> | 動作 | 微軟.金鑰庫/保存庫/事件網格篩選器/刪除 | 通知 Microsoft.KeyVault 金鑰保存庫的事件網格訂閱正在被刪除 |
> |  | **vaults/secrets** |  |
> | 動作 | Microsoft.KeyVault/vaults/secrets/read | 查看機密的屬性，但不能查看其值。 |
> | 動作 | Microsoft.KeyVault/vaults/secrets/write | 創建新機密或更新現有機密的值。 |
> |  | **保存庫/證書庫** |  |
> | DataAction | 微軟.金鑰庫/保存庫/證書庫/刪除 | 刪除證書 Issuser |
> | DataAction | 微軟.金鑰庫/保存庫/證書庫/讀取 | 讀取證書 Issuser |
> | DataAction | 微軟.金鑰庫/保存庫/證書庫/寫入 | 寫入證書 Issuser |
> |  | **保存庫/證書連絡人** |  |
> | DataAction | 微軟.金鑰庫/保存庫/證書連絡人/寫入 | 管理證書連絡人 |
> |  | **保存庫/證書** |  |
> | DataAction | 微軟.金鑰庫/保存庫/證書/刪除 | 刪除證書。 |
> | DataAction | 微軟.金鑰庫/保存庫/證書/讀取 | 在指定的金鑰保存庫中列出證書，或獲取有關證書的資訊。 |
> | DataAction | 微軟.金鑰庫/保存庫/證書/備份/操作 | 創建證書的備份檔案。 該檔可用於還原同一訂閱的金鑰保存庫中的證書。 可能會施加限制。 |
> | DataAction | 微軟.金鑰庫/保存庫/證書/清除/操作 | 清除證書，使其無法恢復。 |
> | DataAction | 微軟.金鑰庫/保存庫/證書/更新/操作 | 更新與給定證書關聯的指定屬性。 |
> | DataAction | 微軟.金鑰庫/保存庫/證書/創建/操作 | 創建新證書。 |
> | DataAction | 微軟.金鑰庫/保存庫/證書/導入/操作 | 將包含私密金鑰的現有有效證書導入 Azure 金鑰保存庫。 要導入的證書可以是 PFX 或 PEM 格式。 |
> | DataAction | 微軟.金鑰庫/保存庫/證書/恢復/操作 | 恢復已刪除的證書。 該操作執行"刪除"操作的反轉。 該操作適用于啟用虛刪除的保存庫，必須在保留間隔期間頒發。 |
> | DataAction | 微軟.金鑰庫/保存庫/證書/恢復/操作 | 將備份的證書及其所有版本還原到保存庫。 |
> |  | **保存庫/金鑰** |  |
> | DataAction | 微軟.鑰匙庫/保存庫/金鑰/讀取 | 列出指定保存庫中的鍵，或讀取金鑰的屬性和公共材料。<br>對於非對稱金鑰，此操作公開公開金鑰，包括執行公開金鑰演算法（如加密和驗證簽名）的能力。<br>私密金鑰和對稱鍵永遠不會公開。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/更新/操作 | 更新與給定金鑰關聯的指定屬性。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/創建/操作 | 創建新鍵。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/導入/操作 | 匯出外部建立的金鑰、加以儲存，然後將金鑰參數和屬性傳回至用戶端。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/恢復/操作 | 恢復已刪除的金鑰。 該操作執行"刪除"操作的反轉。 該操作適用于啟用虛刪除的保存庫，必須在保留間隔期間頒發。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/恢復/操作 | 將備份的金鑰及其所有版本還原到保存庫。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/刪除 | 刪除金鑰。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/備份/操作 | 創建金鑰的備份檔案。 該檔可用於還原同一訂閱的金鑰保存庫中的金鑰。 可能會施加限制。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/清除/操作 | 清除金鑰，使其無法恢復。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/加密/操作 | 使用金鑰加密純文字。 請注意，如果金鑰是非對稱的，則此操作可以由具有讀取存取許可權的主體執行。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/解密/操作 | 使用金鑰解密密碼文本。 |
> | DataAction | 微軟.鑰匙庫/保存庫/金鑰/包裝/操作 | 使用金鑰保存庫金鑰包裝對稱金鑰。 請注意，如果金鑰保存庫金鑰是不對稱的，則可以使用讀取存取執行此操作。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/解包/操作 | 使用金鑰保存庫金鑰取消包裝對稱金鑰。 |
> | DataAction | 微軟.鑰匙庫/保存庫/鑰匙/簽名/操作 | 用鍵簽名雜湊。 |
> | DataAction | 微軟.金鑰庫/保存庫/金鑰/驗證/操作 | 驗證雜湊。 請注意，如果金鑰是非對稱的，則此操作可以由具有讀取存取許可權的主體執行。 |
> |  | **vaults/secrets** |  |
> | DataAction | 微軟.金鑰庫/保存庫/機密/刪除 | 刪除機密。 |
> | DataAction | 微軟.鑰匙庫/保存庫/機密/備份/操作 | 創建機密的備份檔案。 該檔可用於還原同一訂閱的金鑰保存庫中的機密。 可能會施加限制。 |
> | DataAction | 微軟.鑰匙庫/保存庫/機密/清除/操作 | 清除一個秘密，使其無法恢復。 |
> | DataAction | 微軟.金鑰庫/保存庫/機密/更新/操作 | 更新與給定機密關聯的指定屬性。 |
> | DataAction | 微軟.金鑰庫/保存庫/機密/恢復/操作 | 恢復已刪除的機密。 該操作執行"刪除"操作的反轉。 該操作適用于啟用虛刪除的保存庫，必須在保留間隔期間頒發。 |
> | DataAction | 微軟.金鑰庫/保存庫/機密/恢復/操作 | 將備份的機密及其所有版本還原到保存庫。 |
> | DataAction | 微軟.金鑰庫/保存庫/機密/讀取中繼資料/操作 | 列出或查看機密的屬性，但不列出其值。 |
> | DataAction | 微軟.金鑰庫/保存庫/機密/獲取機密/操作 | 獲取機密的價值。 |
> | DataAction | 微軟.金鑰庫/保存庫/機密/設置機密/操作 | 創建新機密。 |

## <a name="microsoftkusto"></a>Microsoft.Kusto

Azure 服務[：Azure 資料資源管理器](../data-explorer/index.yml)

> [!div class="mx-tdCol2BreakAll"]
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.庫斯托/註冊/行動 | 訂閱註冊操作 |
> | 動作 | 微軟.庫斯托/註冊/行動 | 將訂閱註冊到庫斯托資來源提供者。 |
> | 動作 | 微軟.庫斯托/取消註冊/行動 | 取消註冊庫斯托資來源提供者的訂閱。 |
> |  | **叢集** |  |
...
> | 動作 | 微軟.庫斯特托/集群/資料庫/清單主體/操作 | 列出資料庫主體。 |
> | 動作 | 微軟.庫斯托/集群/資料庫/添加主體/操作 | 添加資料庫主體。 |
> | 動作 | 微軟.庫斯托/集群/資料庫/刪除主體/操作 | 刪除資料庫主體。 |
> | 動作 | 微軟.庫斯托/集群/資料庫/資料連線驗證/操作 | 驗證資料庫資料連線。 |
...
> |  | **群集/資料連線** |  |
> | 動作 | 微軟.庫斯托/集群/資料連線/讀取 | 讀取群集的資料連線資源。 |
> | 動作 | 微軟.庫斯托/集群/資料連線/寫入 | 寫入群集的資料連線資源。 |
> | 動作 | 微軟.庫斯托/集群/資料連線/刪除 | 刪除群集的資料連線資源。 |
> |  | **群集/主體分配** |  |
...
> | 動作 | 微軟.庫斯托/位置/獲取網路原則/操作 | 獲取網路意圖策略 |
> |  | **位置/操作結果** |  |
...
> | 動作 | 微軟.實驗室服務/實驗室帳戶/獲取限制和使用/操作 | 獲取此訂閱的核心限制和使用方式 |
> |  | **實驗室帳戶/庫圖像** |  |
...
> | 動作 | 微軟.實驗室服務/實驗室帳戶/實驗室/環境設置/保存圖像/操作 | 將當前範本映射保存到實驗室帳戶中的共用庫 |
...
> | 動作 | 微軟.實驗室服務/使用者/使用者設置/操作 | 更新並返回個人使用者設置。 |
...
> |  | **集成帳戶/組** |  |
> | 動作 | 微軟.邏輯/集成帳戶/組/讀取 | 在集成帳戶中讀取組。 |
> | 動作 | 微軟.邏輯/集成帳戶/組/寫入 | 在集成帳戶中創建或更新組。 |
> | 動作 | 微軟.邏輯/集成帳戶/組/刪除 | 刪除集成帳戶中的組。 |
> |  | **集成帳戶/地圖** |  |
...
> | 動作 | 微軟.邏輯/集成帳戶/羅塞塔網路流程配置/寫入 | 在集成帳戶中創建或更新羅塞塔網流程配置。 |
> | 動作 | 微軟.邏輯/集成帳戶/羅塞塔NetProcess配置/刪除 | 刪除集成帳戶中的羅塞塔網流程配置。 |
> |  | **集成帳戶/計畫** |  |
> | 動作 | 微軟.邏輯/集成帳戶/計畫/讀取 | 在集成帳戶中讀取計畫。 |
> | 動作 | 微軟.邏輯/集成帳戶/計畫/寫入 | 在集成帳戶中創建或更新計畫。 |
> | 動作 | 微軟.邏輯/集成帳戶/計畫/刪除 | 刪除集成帳戶中的計畫。 |
> |  | **集成帳戶/架構** |  |
...
> | 動作 | 微軟.機器學習服務/工作區/計算/重新開機/操作 | 重新開機機器學習服務工作區中的計算資源 |
> |  | **工作區/事件網格篩選器** |  |
> | 動作 | 微軟.機器學習服務/工作區/事件網格篩選器/讀取 | 獲取特定工作區的事件網格篩選器 |
> |  | **工作區/功能** |  |
> | 動作 | 微軟.機器學習服務/工作空間/功能/閱讀 | 獲取機器學習服務工作區的所有已啟用功能 |
> |  | **工作區/專用端接連接 Proxies** |  |
> | 動作 | 微軟.機器學習服務/工作空間/私有端點連接Proxies/讀取 | 查看連接到 Microsoft.網路供應商專用終結點資源的狀態 |
> | 動作 | 微軟.機器學習服務/工作空間/私有端點連接Proxies/寫入 | 將連接代理的狀態更改為 Microsoft.Network 供應商的專用終結點資源 |
> | 動作 | 微軟.機器學習服務/工作空間/私人端接連接Proxies/刪除 | 刪除與 Microsoft.網路供應商的專用終結點資源的連接代理 |
> | 動作 | 微軟.機器學習服務/工作空間/專用端接連接Proxies/驗證/操作 | 驗證與 Microsoft.網路供應商的專用終結點資源的連接代理 |
> |  | **工作區/專用端點連接** |  |
> | 動作 | 微軟.機器學習服務/工作區/專用端點連接/讀取 | 查看連接到 Microsoft.網路供應商的專用終結點資源的狀態 |
> | 動作 | 微軟.機器學習服務/工作區/私有端點連接/寫入 | 更改連接到 Microsoft.網路供應商的專用終結點資源的狀態 |
> | 動作 | 微軟.機器學習服務/工作區/專用端點連接/刪除 | 刪除與 Microsoft.網路供應商的專用終結點資源的連接 |
> |  | **工作區/私有連結資源** |  |
> | 動作 | 微軟.機器學習服務/工作空間/私有連結資源/讀取 | 獲取機器學習服務工作區指定實例的可用專用連結資源 |
> |  | **工作空間/資料漂移探測器** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料漂移探測器/讀取 | 在機器學習服務工作區中獲取資料漂移檢測器 |
> | DataAction | 微軟.機器學習服務/工作空間/資料漂移探測器/寫入 | 在機器學習服務工作區中創建或更新資料漂移檢測器 |
> |  | **工作區/資料集/已註冊** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/註冊/讀取 | 在機器學習服務工作區中獲取已註冊的資料集 |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/註冊/寫入 | 在機器學習服務工作區中創建或更新已註冊的資料集 |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/註冊/刪除 | 刪除機器學習服務工作區中的已註冊資料集 |
> |  | **工作區/資料集/註冊/預覽** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/註冊/預覽/讀取 | 獲取機器學習服務工作區中已註冊資料集的資料集預覽 |
> |  | **工作區/資料集/註冊/設定檔** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/註冊/設定檔/讀取 | 獲取機器學習服務工作區中已註冊資料集的資料集設定檔 |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/註冊/設定檔/寫入 | 在機器學習服務工作區中創建或更新已註冊資料集的資料集設定檔 |
> |  | **工作區/資料集/註冊/架構** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/註冊/架構/讀取 | 獲取機器學習服務工作區中已註冊資料集的資料集架構 |
> |  | **工作區/資料集/未註冊** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/未註冊/讀取 | 在機器學習服務工作區中獲取未註冊的資料集 |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/未註冊/寫入 | 在機器學習服務工作區中創建或更新未註冊的資料集 |
> | DataAction | 微軟.機器學習服務/工作區/資料集/未註冊/刪除 | 刪除機器學習服務工作區中未註冊的資料集 |
> |  | **工作區/資料集/未註冊/預覽** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/未註冊/預覽/讀取 | 獲取機器學習服務工作區中未註冊資料集的資料集預覽 |
> |  | **工作區/資料集/未註冊/設定檔** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/未註冊/設定檔/讀取 | 獲取機器學習服務工作區中未註冊資料集的資料集設定檔 |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/未註冊/設定檔/寫入 | 在機器學習服務工作區中為未註冊的資料集創建或更新資料集設定檔 |
> |  | **工作區/資料集/未註冊/架構** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料集/未註冊/架構/讀取 | 獲取機器學習服務工作區中未註冊資料集的資料集架構 |
> |  | **工作區/資料存儲** |  |
> | DataAction | 微軟.機器學習服務/工作空間/資料存儲/讀取 | 獲取機器學習服務工作區中的資料存儲 |
> | DataAction | 微軟.機器學習服務/工作空間/資料存儲/寫入 | 在機器學習服務工作區中創建或更新資料存儲 |
> | DataAction | 微軟.機器學習服務/工作區/資料存儲/刪除 | 刪除機器學習服務工作區中的資料存儲 |
> |  | **工作區/終結點/管道** |  |
> | DataAction | 微軟.機器學習服務/工作區/終結點/管道/讀取 | 在機器學習服務工作區中獲取已發佈的管道和管道終結點 |
> | DataAction | 微軟.機器學習服務/工作區/終結點/管道/寫入 | 在機器學習服務工作區中創建或更新已發佈的管道和管道終結點 |
> |  | **工作區/環境** |  |
> | DataAction | 微軟.機器學習服務/工作空間/環境/讀取 | 獲取機器學習服務工作區中的環境 |
> | DataAction | 微軟.機器學習服務/工作空間/環境/讀取秘密/操作 | 獲取機器學習服務工作區中具有機密的環境 |
> | DataAction | 微軟.機器學習服務/工作空間/環境/寫入 | 在機器學習服務工作區中創建或更新環境 |
> | DataAction | 微軟.機器學習服務/工作空間/環境/構建/操作 | 在機器學習服務工作區中構建環境 |
> |  | **workspaces/experiments** |  |
> | DataAction | 微軟.機器學習服務/工作空間/實驗/閱讀 | 獲取機器學習服務工作區中的實驗 |
> | DataAction | 微軟.機器學習服務/工作空間/實驗/寫入 | 在機器學習服務工作區中創建或更新實驗 |
> | DataAction | 微軟.機器學習服務/工作空間/實驗/刪除 | 刪除機器學習服務工作區中的實驗 |
> |  | **工作區/實驗/運行** |  |
> | DataAction | 微軟.機器學習服務/工作空間/實驗/運行/讀取 | 獲取機器學習服務工作區中的運行 |
> | DataAction | 微軟.機器學習服務/工作空間/實驗/運行/寫入 | 在機器學習服務工作區中創建或更新 |
> |  | **工作區/實驗/運行/腳本運行** |  |
> | DataAction | 微軟.機器學習服務/工作空間/實驗/運行/腳本運行/提交/操作 | 在機器學習服務工作區中創建或更新腳本運行 |
> |  | **工作區/標籤** |  |
> | DataAction | 微軟.機器學習服務/工作空間/標籤/匯出/操作 | 機器學習服務工作區中標籤專案的匯出標籤 |
> |  | **工作區/標籤/標籤** |  |
> | DataAction | 微軟.機器學習服務/工作空間/標籤/標籤/讀取 | 獲取機器學習服務工作區中標記專案的標籤 |
> | DataAction | 微軟.機器學習服務/工作空間/標籤/標籤/寫入 | 在機器學習服務工作區中創建標記專案的標籤 |
> | DataAction | 微軟.機器學習服務/工作空間/標籤/標籤/拒絕/操作 | 拒絕機器學習服務工作區中標記專案的標籤 |
> |  | **工作區/標籤/專案** |  |
> | DataAction | 微軟.機器學習服務/工作空間/標籤/專案/讀取 | 獲取機器學習服務工作區中的標籤專案 |
> | DataAction | 微軟.機器學習服務/工作空間/標籤/專案/寫入 | 在機器學習服務工作區中創建或更新標記專案 |
> | DataAction | 微軟.機器學習服務/工作空間/標籤/專案/刪除 | 刪除機器學習服務工作區中的標籤專案 |
> |  | **工作區/標籤/專案/摘要** |  |
> | DataAction | 微軟.機器學習服務/工作空間/標籤/專案/摘要/閱讀 | 獲取機器學習服務工作區中的標籤專案摘要 |
> |  | **工作區/中繼資料/專案** |  |
> | DataAction | 微軟.機器學習服務/工作空間/中繼資料/專案/讀取 | 獲取機器學習服務工作區中的工件 |
> | DataAction | 微軟.機器學習服務/工作空間/中繼資料/專案/寫入 | 在機器學習服務工作區中創建或更新專案 |
> | DataAction | 微軟.機器學習服務/工作區/中繼資料/專案/刪除 | 刪除機器學習服務工作區中的專案 |
> |  | **工作區/中繼資料/機密** |  |
> | DataAction | 微軟.機器學習服務/工作空間/中繼資料/機密/讀取 | 獲取機器學習服務工作區中的秘密 |
> | DataAction | 微軟.機器學習服務/工作空間/中繼資料/機密/寫入 | 在機器學習服務工作區中創建或更新機密 |
> | DataAction | 微軟.機器學習服務/工作區/中繼資料/機密/刪除 | 刪除機器學習服務工作區中的秘密 |
> |  | **工作區/中繼資料/快照** |  |
> | DataAction | 微軟.機器學習服務/工作區/中繼資料/快照/讀取 | 獲取機器學習服務工作區中的快照 |
> | DataAction | 微軟.機器學習服務/工作區/中繼資料/快照/寫入 | 在機器學習服務工作區中創建或更新快照 |
> | DataAction | 微軟.機器學習服務/工作區/中繼資料/快照/刪除 | 刪除機器學習服務工作區中的快照 |
> |  | **工作區/模型** |  |
> | DataAction | 微軟.機器學習服務/工作空間/模型/讀取 | 獲取機器學習服務工作區中的模型 |
> | DataAction | 微軟.機器學習服務/工作空間/模型/寫入 | 在機器學習服務工作區中創建或更新模型 |
> | DataAction | 微軟.機器學習服務/工作空間/模型/刪除 | 刪除機器學習服務工作區中的模型 |
> | DataAction | 微軟.機器學習服務/工作空間/模型/包/操作 | 機器學習服務工作區中的包模型 |
> |  | **工作區/模組** |  |
> | DataAction | 微軟.機器學習服務/工作空間/模組/讀取 | 獲取機器學習服務工作區中的模組 |
> | DataAction | 微軟.機器學習服務/工作空間/模組/寫入 | 在機器學習服務工作區中創建或更新模組 |
> |  | **工作區/管道草稿** |  |
> | DataAction | 微軟.機器學習服務/工作空間/管道草稿/讀取 | 在機器學習服務工作區中獲取管道草稿 |
> | DataAction | 微軟.機器學習服務/工作空間/管道草稿/寫入 | 在機器學習服務工作區中創建或更新管道草稿 |
> | DataAction | 微軟.機器學習服務/工作區/管道草稿/刪除 | 刪除機器學習服務工作區中的管道草稿 |
> |  | **工作空間/服務** |  |
> | DataAction | 微軟.機器學習服務/工作空間/服務/讀取 | 獲取機器學習服務工作區中的服務 |
> |  | **工作空間/服務/服務** |  |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aci/寫入 | 在機器學習服務工作區中創建或更新 ACI 服務 |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aci/清單鍵/操作 | 在機器學習服務工作區中列出 ACI 服務的鍵 |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aci/刪除 | 刪除機器學習服務工作區中的 ACI 服務 |
> |  | **工作空間/服務/aks/devtest** |  |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aks/測試/寫入 | 在機器學習服務工作區中創建或更新開發性 AKS 服務 |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aks/devtest/清單鍵/操作 | 列出機器學習服務工作區中開發 AKS 服務的金鑰 |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aks/devtest/刪除 | 刪除機器學習服務工作區中最開發 AKS 服務 |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aks/devtest/分數/操作 | 在機器學習服務工作區中創建最優 AKS 服務的分數 |
> |  | **工作空間/服務/aks/prod** |  |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aks/prod/write/write | 在機器學習服務工作區中創建或更新 prod AKS 服務 |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aks/prod/listkey/操作 | 在機器學習服務工作區中列出 prod AKS 服務的鍵 |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aks/prod/刪除 | 刪除機器學習服務工作區中的 PROAKS 服務 |
> | DataAction | 微軟.機器學習服務/工作空間/服務/aks/prod/分數/操作 | 機器學習服務工作區中推動 AKS 服務的分數 |

## <a name="microsoftmanagedidentity"></a>Microsoft.ManagedIdentity

Azure 服務[：Azure 資源的託管標識](../active-directory/managed-identities-azure-resources/index.yml)
...
> |  | **身份** |  |
> | 動作 | 微軟.託管身份/身份/讀取 | 獲取現有系統分配的標識 |
> |  | **操作** |  |
> | 動作 | 微軟.託管身份/操作/讀取 | 列出 Microsoft.託管身份資來源提供者上可用的操作 |
...
Azure 服務：[管理組](../governance/management-groups/index.yml)
...
> | 動作 | 微軟.管理/管理組/設置/寫入 | 創建或更新管理組層次結構設置。 |
> | 動作 | 微軟.管理/管理組/設置/刪除 | 刪除管理組層次結構設置。 |
> |  | **管理組/訂閱** |  |
...
Azure 服務[：Azure 映射](../azure-maps/index.yml)
...
Azure 服務[：Azure 遷移](../migrate/migrate-services-overview.md)
...
> |  | **assessmentprojects** |  |
> | 動作 | 微軟.遷移/評估專案/閱讀 | 獲取評估專案的屬性 |
> | 動作 | 微軟.遷移/評估專案/寫入 | 創建新的評估專案或更新現有評估專案 |
> | 動作 | 微軟.遷移/評估專案/刪除 | 刪除評估專案 |
> |  | **評估專案/評估選項** |  |
...
> | 動作 | 微軟.遷移/評估專案/組/更新機器/操作 | 通過添加或刪除電腦更新組 |
> |  | **評估專案/小組/評估** |  |
...
> |  | **評估專案/超收器** |  |
> | 動作 | 微軟.遷移/評估專案/超收器/閱讀 | 獲取超V收集器的屬性 |
> | 動作 | 微軟.遷移/評估專案/超收器/寫入 | 創建新的 HyperV 收集器或更新現有的 HyperV 收集器 |
> | 動作 | 微軟.遷移/評估專案/超收器/刪除 | 刪除超V收集器 |
> |  | **評估專案/進口收集器** |  |
> | 動作 | 微軟.遷移/評估專案/導入者/讀取 | 獲取導入收集器的屬性 |
> | 動作 | 微軟.遷移/評估專案/導入者/寫入 | 創建新的導入收集器或更新現有導入收集器 |
> | 動作 | 微軟.遷移/評估專案/導入者/刪除 | 刪除導入收集器 |
> |  | **評估專案/機器** |  |
> | 動作 | 微軟.遷移/評估專案/機器/讀取 | 取得電腦的屬性 |
> |  | **評估專案/伺服器收集器** |  |
> | 動作 | 微軟.遷移/評估專案/伺服器收集器/讀取 | 獲取伺服器收集器的屬性 |
> | 動作 | 微軟.遷移/評估專案/伺服器收集器/寫入 | 創建新的伺服器收集器或更新現有伺服器收集器 |
> |  | **評估專案/vmware 收集器** |  |
> | 動作 | 微軟.遷移/評估專案/vmware收集器/閱讀 | 獲取 VMware 收集器的屬性 |
> | 動作 | 微軟.遷移/評估專案/vmware收集器/寫入 | 創建新的 VMware 收集器或更新現有的 VMware 收集器 |
> | 動作 | 微軟.遷移/評估專案/vmware收集器/刪除 | 刪除 VMware 收集器 |
> |  | **位置** |  |
...
> |  | **migrateprojects** |  |
> | 動作 | Microsoft.Migrate/migrateprojects/read | 獲取遷移專案的屬性 |
> | 動作 | 微軟.遷移/遷移專案/寫入 | 創建新的遷移專案或更新現有遷移專案 |
> | 動作 | 微軟.遷移/遷移專案/刪除 | 刪除遷移專案 |
> | 動作 | 微軟.遷移/遷移專案/註冊工具/操作 | 將工具註冊到遷移專案 |
> | 動作 | 微軟.遷移/遷移專案/刷新摘要/操作 | 刷新遷移專案摘要 |
> |  | **遷移專案/資料庫實例** |  |
> | 動作 | 微軟.遷移/遷移專案/資料庫實例/讀取 | 獲取資料庫實例的屬性 |
> |  | **遷移專案/資料庫** |  |
> | 動作 | 微軟.遷移/遷移專案/資料庫/讀取 | 獲取資料庫的屬性 |
> |  | **遷移專案/電腦** |  |
> | 動作 | 微軟.遷移/遷移專案/電腦/讀取 | 取得電腦的屬性 |
> |  | **遷移專案/遷移事件** |  |
> | 動作 | 微軟.遷移/遷移專案/遷移事件/讀取 | 獲取遷移事件的屬性。 |
> | 動作 | 微軟.遷移/遷移專案/遷移事件/刪除 | 刪除遷移事件 |
> |  | **遷移專案/解決方案** |  |
> | 動作 | Microsoft.Migrate/migrateprojects/solutions/read | 獲取遷移專案解決方案的屬性 |
> | 動作 | 微軟.遷移/遷移專案/解決方案/寫入 | 創建新的遷移專案解決方案或更新現有遷移專案解決方案 |
> | 動作 | 微軟.遷移/遷移專案/解決方案/刪除 | 刪除遷移專案解決方案 |
> | 動作 | Microsoft.Migrate/migrateprojects/solutions/getconfig/action | 取得遷移專案解決方案組態 |
> | 動作 | 微軟.遷移/遷移專案/解決方案/清理資料/操作 | 清理遷移的專案解決方案資料 |
> |  | **作業** |  |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.混合現實/註冊/行動 | 註冊混合現實資來源提供者的訂閱。 |
...
> |  | **遠端渲染帳戶** |  |
> | DataAction | 微軟.混合現實/遠端呈現帳戶/轉換/操作 | 開始資產轉換 |
> | DataAction | 微軟.混合現實/遠端呈現帳戶/管理會話/操作 | 開始會話 |
> |  | **遠端渲染帳戶/轉換** |  |
> | DataAction | 微軟.混合現實/遠端呈現帳戶/轉換/讀取 | 獲取資產轉換屬性 |
> | DataAction | 微軟.混合現實/遠端呈現帳戶/轉換/刪除 | 停止資產轉換 |
> |  | **遠端渲染帳戶/診斷** |  |
> | DataAction | 微軟.混合現實/遠端呈現帳戶/診斷/讀取 | 連接到遠端渲染檢查器 |
> |  | **遠端渲染帳戶/管理會話** |  |
> | DataAction | 微軟.混合現實/遠端呈現帳戶/管理會話/讀取 | 獲取會話屬性 |
> | DataAction | 微軟.混合現實/遠端呈現帳戶/管理會話/刪除 | 停止會話 |
> |  | **遠端渲染帳戶/渲染** |  |
> | DataAction | 微軟.混合現實/遠端呈現帳戶/渲染/讀取 | 連接到會話 |
> |  | **空間錨點帳戶** |  |
> | DataAction | 微軟.混合現實/空間錨定帳戶/創建/操作 | 創建空間錨點 |
> | DataAction | 微軟.混合現實/空間錨定帳戶/刪除 | 刪除空間錨點 |
> | DataAction | 微軟.混合現實/空間錨定帳戶/寫入 | 更新空間錨點屬性 |
> |  | **空間錨點帳戶/發現** |  |
> | DataAction | 微軟.混合現實/空間錨定帳戶/發現/閱讀 | 發現附近的空間錨點 |
> |  | **空間錨點帳戶/屬性** |  |
> | DataAction | 微軟.混合現實/空間錨定帳戶/屬性/讀取 | 獲取空間錨點的屬性 |
> |  | **空間錨點帳戶/查詢** |  |
...
Azure 服務[：Azure NetApp 檔](../azure-netapp-files/index.yml)

> [!div class="mx-tdCol2BreakAll"]
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.NetApp/註冊/操作 | 訂閱註冊操作 |
> | 動作 | 微軟.NetApp/取消註冊/操作 | 取消註冊訂閱到 Microsoft.NetApp 資源供應商 |
> |  | **位置** |  |
> | 動作 | Microsoft.NetApp/locations/read | 讀取可用性檢查資源。 |
> | 動作 | 微軟.NetApp/位置/校名可用性/操作 | 檢查資源名稱是否可用 |
> | 動作 | 微軟.NetApp/位置/檢查檔路徑可用性/操作 | 檢查檔路徑是否可用 |
> |  | **位置/操作結果** |  |
...
> | 動作 | 微軟.NetApp/NetApp帳戶/容量池/卷/恢復/操作 | 將卷還原到特定快照 |
> | 動作 | 微軟.NetApp/NetApp帳戶/容量池/卷/中斷複製/操作 | 中斷卷複製關係 |
> | 動作 | 微軟.NetApp/NetApp 帳戶/容量池/卷/複製狀態/操作 | 讀取卷複製的狀態。 |
> | 動作 | 微軟.NetApp/NetApp帳戶/容量池/卷/授權複製/操作 | 授權源卷複製 |
> | 動作 | 微軟.NetApp/NetApp帳戶/容量池/卷/重新同步複製/操作 | 在目標卷上重新同步複製 |
> | 動作 | 微軟.NetApp/NetApp 帳戶/容量池/卷/刪除複製/操作 | 刪除目標卷上的複製 |
> |  | **淨應用帳戶/容量池/卷/備份** |  |
...
> | 動作 | 微軟.NetApp/NetApp帳戶/快照策略/清單卷/操作 | 清單連接到快照策略的卷 |
> |  | **淨應用帳戶/保存庫** |  |
> | 動作 | 微軟.NetApp/netApp帳戶/保存庫/讀取 | 讀取保存庫資源。 |
> |  | **作業** |  |
> | 動作 | Microsoft.NetApp/Operations/read | 讀取作業資源。 |

## <a name="microsoftnetwork"></a>Microsoft.Network

Azure 服務：[虛擬網路](../virtual-network/index.yml)，[負載等化器](../load-balancer/index.yml)，[應用程式閘道](../application-gateway/index.yml)， [Azure DNS](../dns/index.yml)，[快速路由](../expressroute/index.yml)， [VPN 閘道](../vpn-gateway/index.yml)，[流量管理器](../traffic-manager/index.yml)，[網路觀察程式](../network-watcher/index.yml)， [Azure 防火牆](../firewall/index.yml)Azure[前門服務](../frontdoor/index.yml)， [Azure 堡壘](../bastion/index.yml)
...
> | 動作 | 微軟.網路/應用程式閘道/獲取後端健康需求/操作 | 按需獲取給定 HTTP 設置和後端池的應用程式閘道後端運行狀況 |
...
> |  | **應用程式閘道/後端位址集區** |  |
> | 動作 | Microsoft.Network/applicationGateways/backendAddressPools/join/action | 加入應用程式閘道後端位址集區。 無法報警。 |
> |  | **應用程式閘道Web應用程式防火牆策略** |  |
> | 動作 | 微軟.網路/應用程式閘道Web應用程式防火牆策略/讀取 | 獲取應用程式閘道 WAF 策略 |
> | 動作 | 微軟.網路/應用程式閘道Web應用程式防火牆策略/寫入 | 創建應用程式閘道 WAF 策略或更新應用程式閘道 WAF 策略 |
> | 動作 | 微軟.網路/應用程式閘道Web應用程式防火牆策略/刪除 | 刪除應用程式閘道 WAF 策略 |
> |  | **應用程式規則集合** |  |
> | 動作 | 微軟.網路/應用程式規則集合/讀取 | 獲取 Azure 防火牆應用程式規則集合 |
> | 動作 | 微軟.網路/應用程式規則集合/寫入 | 創建或更新 Azure 防火牆應用程式規則集合 |
> | 動作 | 微軟.網路/應用程式規則集合/刪除 | 刪除 Azure 防火牆應用程式規則集合 |
...
> | 動作 | 微軟.網路/堡壘主機/獲取可共用連結/操作 | 返回 Bastion 子網中指定 VM 的可共用 URL，前提是其 URL 已創建 |
> | 動作 | 微軟.網路/堡壘主機/創建可共用連結/操作 | 在堡壘下為 VM 創建可共用的 URL 並返回 URL |
> | 動作 | 微軟.網路/堡壘主機/可共用連結/操作 | 刪除堡壘下提供的 VM 的可共用 URL |
...
> | 動作 | 微軟.網路/連接/啟動資料包捕獲/操作 | 啟動虛擬網路閘道連接資料包捕獲。 |
> | 動作 | 微軟.網路/連接/停止資料包捕獲/操作 | 停止虛擬網路閘道連接資料包捕獲。 |
> |  | **連接/共用金鑰** |  |
...
> | 動作 | Microsoft.Network/dnszones/A/write | 在 DNS 區域中創建或更新類型為"A"的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
...
> | 動作 | Microsoft.Network/dnszones/AAAA/write | 在 DNS 區域中創建或更新類型為"AAAA"的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
...
> | 動作 | Microsoft.Network/dnszones/CAA/write | 在 DNS 區域中創建或更新類型為"CAA"的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
...
> | 動作 | Microsoft.Network/dnszones/CNAME/write | 在 DNS 區域中創建或更新類型為"CNAME"的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
...
> | 動作 | Microsoft.Network/dnszones/MX/write | 在 DNS 區域中創建或更新類型為"MX"的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
...
> | 動作 | Microsoft.Network/dnszones/PTR/write | 在 DNS 區域中創建或更新類型為"PTR"的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
...
> | 動作 | Microsoft.Network/dnszones/TXT/write | 在 DNS 區域中創建或更新類型為"TXT"的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
...
> |  | **防火牆策略** |  |
> | 動作 | 微軟.網路/防火牆策略/讀取 | 獲取防火牆策略 |
> | 動作 | 微軟.網路/防火牆策略/寫入 | 創建防火牆策略或更新現有防火牆策略 |
> | 動作 | 微軟.網路/防火牆策略/加入/操作 | 加入防火牆策略。 不可報警。 |
> | 動作 | 微軟.網路/防火牆策略/刪除 | 刪除防火牆策略 |
> |  | **防火牆策略/規則組** |  |
> | 動作 | 微軟.網路/防火牆策略/規則組/讀取 | 獲取防火牆策略規則組 |
> | 動作 | 微軟.網路/防火牆策略/規則組/寫入 | 創建防火牆策略規則組或更新現有的防火牆策略規則組 |
> | 動作 | 微軟.網路/防火牆策略/規則組/刪除 | 刪除防火牆策略規則組 |
> |  | **前門** |  |
...
> |  | **前門Web應用程式防火牆管理規則集** |  |
> | 動作 | 微軟.網路/前門網應用防火牆管理規則集/讀取 | 獲取 Web 應用程式防火牆託管規則集 |
> |  | **前門網應用防火牆策略** |  |
...
> |  | **ip 分配** |  |
> | 動作 | 微軟.網路/ip分配/讀取 | 獲取 Ip 分配 |
> | 動作 | 微軟.網路/ip分配/寫入 | 創建 Ip 分配或更新現有 Ip 分配 |
> | 動作 | 微軟.網路/ip分配/刪除 | 刪除 Ip 分配 |
> |  | **ip組** |  |
> | 動作 | 微軟.網路/ip組/讀 | 獲取 IpGroup |
> | 動作 | 微軟.網路/ip組/寫 | 創建 IpGroup 或更新現有 IpGroup |
> | 動作 | 微軟.網路/ip組/驗證/操作 | 驗證 IpGroup |
> | 動作 | 微軟.網路/ip組/更新參考/操作 | 更新 IpGroup 中的引用 |
> | 動作 | 微軟.網路/ip組/加入/行動 | 加入 IpGroup。 不可報警。 |
> | 動作 | 微軟.網路/ip組/刪除 | 刪除 IpGroup |
> |  | **loadBalancers** |  |
...
> | 動作 | Microsoft.Network/loadBalancers/backendAddressPools/join/action | 加入負載等化器後端位址集區。 無法報警。 |
> |  | **負載平衡器/前端IP配置** |  |
...
> | 動作 | Microsoft.Network/loadBalancers/inboundNatPools/join/action | 加入負載等化器入站 NAT 池。 不可報警。 |
> |  | **負載平衡器/入站Nat規則** |  |
...
> | 動作 | Microsoft.Network/loadBalancers/inboundNatRules/join/action | 加入負載等化器入站 nat 規則。 無法報警。 |
> |  | **負載平衡器/負載平衡規則** |  |
...
> | 動作 | 微軟.網路/位置/檢查私人連結服務可見度/操作 | 檢查專用連結服務可見度 |
> | 動作 | Microsoft.Network/locations/bareMetalTenants/action | 配置或驗證裸機租用戶 |
> |  | **位置/自動批准私人連結服務** |  |
> | 動作 | 微軟.網路/位置/自動批准私人連結服務/讀取 | 獲取自動批准的專用連結服務 |
> |  | **地點/可用代表團** |  |
> | 動作 | Microsoft.Network/locations/availableDelegations/read | 取得可用的委派 |
> |  | **位置/可用的私人終結點類型** |  |
> | 動作 | 微軟.網路/位置/可用私人終結點類型/讀取 | 獲取可用的專用終結點資源 |
> |  | **位置/可用的服務別名** |  |
> | 動作 | 微軟.網路/位置/可用服務別名/讀取 | 獲取可用服務別名 |
> |  | **位置/檢查Dns名稱可用性** |  |
...
> |  | **納特魯爾收集** |  |
> | 動作 | 微軟.網路/natRule集合/讀取 | 獲取 Azure 防火牆 NatRule 集合 |
> | 動作 | 微軟.網路/natRule集合/寫入 | 創建或更新 Azure 防火牆 NatRule 收集 |
> | 動作 | 微軟.網路/natRule集合/刪除 | 刪除 Azure 防火牆 NatRule 集合 |
> |  | **網路實驗設定檔** |  |
> | 動作 | 微軟.網路/網路實驗設定檔/讀取 | 獲取互聯網分析器設定檔 |
> | 動作 | 微軟.網路/網路實驗設定檔/寫入 | 創建或更新互聯網分析器設定檔 |
> | 動作 | 微軟.網路/網路實驗設定檔/刪除 | 刪除互聯網分析器設定檔 |
> |  | **網路實驗設定檔/實驗** |  |
> | 動作 | 微軟.網路/網路實驗設定檔/實驗/閱讀 | 獲取互聯網分析儀測試 |
> | 動作 | 微軟.網路/網路實驗設定檔/實驗/寫入 | 創建或更新互聯網分析器測試 |
> | 動作 | 微軟.網路/網路實驗設定檔/實驗/刪除 | 刪除互聯網分析器測試 |
> | 動作 | 微軟.網路/網路實驗設定檔/實驗/時間序列/操作 | 獲取互聯網分析儀測試的時間序列 |
> | 動作 | 微軟.網路/網路實驗設定檔/實驗/延遲計分卡/操作 | 獲取互聯網分析器測試的延遲計分卡 |
> |  | **網路實驗設定檔/預配置的終結點** |  |
> | 動作 | 微軟.網路/網路實驗設定檔/預配置的終結點/讀取 | 獲取 Internet 分析器設定檔的預配置終結點 |
...
> | 動作 | Microsoft.Network/networkInterfaces/join/action | 將虛擬機器加入網路介面。 無法報警。 |
...
> |  | **網路規則集合** |  |
> | 動作 | 微軟.網路/網路規則集合/讀取 | 獲取 Azure 防火牆網路規則集合 |
> | 動作 | 微軟.網路/網路規則收集/寫入 | 創建或更新 Azure 防火牆網路規則集合 |
> | 動作 | 微軟.網路/網路規則收集/刪除 | 刪除 Azure 防火牆網路規則集合 |
> |  | **networkSecurityGroups** |  |
...
> | 動作 | Microsoft.Network/networkSecurityGroups/join/action | 加入網路安全性群組。 無法報警。 |
> |  | **網路安全性群組/預設安全規則** |  |
...
> |  | **網路觀察器/流日誌** |  |
> | 動作 | 微軟.網路/網路觀察者/流日誌/讀取 | 獲取流日誌詳細資訊 |
> | 動作 | 微軟.網路/網路觀察者/流日誌/寫入 | 創建流日誌 |
> | 動作 | 微軟.網路/網路觀察者/流日誌/刪除 | 刪除流日誌 |
...
> | 動作 | 微軟.網路/p2sVpn閘道/getp2svpn連接健康詳細/操作 | 獲取 P2S Vpn 閘道的詳細 P2S Vpn 連接運行狀況 |
> | 動作 | 微軟.網路/p2sVpn閘道/斷開p2svpn連接/操作 | 斷開 p2s vpn 連接 |
> |  | **私有Dns操作結果** |  |
> | 動作 | 微軟.網路/私人Dns操作結果/讀取 | 獲取專用 DNS 操作的結果 |
> |  | **私有Dns操作狀態** |  |
> | 動作 | 微軟.網路/私人Dns操作狀態/讀取 | 獲取專用 DNS 操作的狀態 |
> |  | **私有 Dns 區** |  |
...
> |  | **私有 Dns 區域/ALL** |  |
> | 動作 | 微軟.網路/專用 Dns 區域/ALL/讀取 | 跨類型獲取專用 DNS 記錄集 |
> |  | **私有 Dns 區域/CNAME** |  |
> | 動作 | 微軟.網路/私人Dns區/CNAME/讀取 | 以 JSON 格式在專用 DNS 區域中獲取類型"CNAME"的記錄集。 |
> | 動作 | 微軟.網路/私人Dns區/CNAME/寫入 | 在專用 DNS 區域中創建或更新類型為"CNAME"的記錄集。 |
...
> | 動作 | 微軟.網路/專用Dns區/PTR/寫入 | 在專用 DNS 區域中創建或更新類型為"PTR"的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | 動作 | 微軟.網路/專用Dns區/PTR/刪除 | 從專用 DNS 區域中刪除給定名稱的記錄集並鍵入"PTR"。 |
> |  | **私有 Dns 區域/記錄集** |  |
> | 動作 | 微軟.網路/專用 Dns 區域/記錄集/讀取 | 跨類型獲取專用 DNS 記錄集 |
> |  | **私有 Dns 區域/SOA** |  |
...
> |  | **專用 Dns 區域/虛擬網路連結** |  |
> | 動作 | 微軟.網路/私人網路絡區/虛擬網路連結/讀取 | 獲取以 JSON 格式連接到虛擬網路屬性的專用 DNS 區域連結。 |
> | 動作 | 微軟.網路/私人網路區/虛擬網路連結/寫入 | 創建或更新專用 DNS 區域連結到虛擬網路。 |
> | 動作 | 微軟.網路/私人Dns區/虛擬網路連結/刪除 | 刪除指向虛擬網路的專用 DNS 區域連結。 |
> |  | **私有端點重定向圖** |  |
> | 動作 | 微軟.網路/私人端點重定向地圖/閱讀 | 獲取專用終結點重定向映射 |
> | 動作 | 微軟.網路/私人端點重定向地圖/寫入 | 創建專用終結點重定向映射或更新現有專用終結點重定向映射 |
> |  | **私有終結點** |  |
> | 動作 | 微軟.網路/私人終端/讀取 | 獲取專用終結點資源。 |
> | 動作 | 微軟.網路/私人終端/寫入 | 創建新的專用終結點，或更新現有專用終結點。 |
> | 動作 | 微軟.網路/私人終結點/刪除 | 刪除專用終結點資源。 |
> |  | **私有終結點/私有 DnsZone 配置** |  |
> | 動作 | 微軟.網路/私人終端/私人DnsZone配置/寫入 | 放置專用 DNS 區域配置 |
> |  | **privateLinkServices** |  |
...
> | 動作 | 微軟.網路/虛擬中心/有效路由/操作 | 獲取在虛擬中心配置的有效路由 |
> |  | **虛擬中心/中心虛擬網路連接** |  |
...
> |  | **虛擬Hubs/路由表** |  |
> | 動作 | 微軟.網路/虛擬中心/路由表/讀取 | 獲取虛擬HubRouteTableV2 |
> | 動作 | 微軟.網路/虛擬中心/路由表/寫入 | 創建或更新虛擬HubRouteTableV2 |
> | 動作 | 微軟.網路/虛擬中心/路由表/刪除 | 刪除虛擬HubRouteTableV2 |
...
> | 動作 | 微軟.網路/虛擬網路閘道/斷開虛擬網路閘道連接/操作 | 斷開虛擬網路閘道 vpn 連接 |
...
> | 動作 | 微軟.網路/虛擬網路閘道/啟動資料包捕獲/操作 | 啟動虛擬網路閘道資料包捕獲。 |
> | 動作 | 微軟.網路/虛擬網路閘道/停止資料包捕獲/操作 | 停止虛擬網路閘道資料包捕獲。 |
> |  | **虛擬網路閘道/連接** |  |
...
> | 動作 | 微軟.網路/虛擬網路/子網/未準備網路原則/操作 | 通過刪除應用的網路原則取消子網準備 |
> |  | **虛擬網路/子網/上下文服務終結點策略** |  |
> | 動作 | 微軟.網路/虛擬網路/子網/上下文服務終結點策略/讀取 | 獲取上下文服務終結點策略 |
> | 動作 | 微軟.網路/虛擬網路/子網/上下文服務終結點策略/寫入 | 創建上下文服務終結點策略或更新現有的上下文服務終結點策略 |
> | 動作 | 微軟.網路/虛擬網路/子網/上下文服務終結點策略/刪除 | 刪除上下文服務終結點策略 |
> |  | **虛擬網路/子網/虛擬機器** |  |
...
> |  | **虛擬路由器** |  |
> | 動作 | 微軟.網路/虛擬路由器/讀取 | 獲取虛擬路由器 |
> | 動作 | 微軟.網路/虛擬路由器/寫入 | 創建虛擬路由器或更新現有虛擬路由器 |
> | 動作 | 微軟.網路/虛擬路由器/刪除 | 刪除虛擬路由器 |
> | 動作 | 微軟.網路/虛擬路由器/加入/操作 | 加入虛擬路由器。 不可報警。 |
> |  | **虛擬路由器/對等互連** |  |
> | 動作 | 微軟.網路/虛擬路由器/對等機/讀取 | 獲取虛擬路由器對等互連 |
> | 動作 | 微軟.網路/虛擬路由器/對等機/寫入 | 創建虛擬路由器對等互連或更新現有虛擬路由器對等 |
> | 動作 | 微軟.網路/虛擬路由器/對等機/刪除 | 刪除虛擬路由器對等互連 |
> |  | **virtualWans** |  |
...
> | 動作 | 微軟.網路/虛擬萬域/vpn伺服器配置/操作 | 獲取虛擬萬Vpn伺服器配置 |
> | 動作 | 微軟.網路/虛擬萬域/生成Vpn設定檔/操作 | 生成虛擬萬Vpn伺服器配置Vpn設定檔 |
> |  | **虛擬萬域/p2sVpn伺服器配置** |  |
...
> |  | **vpn閘道/vpn連接/vpn連結連接** |  |
> | 動作 | 微軟.網路/vpn閘道/vpn連接/vpn連結連接/讀取 | 獲取 Vpn 連結連接 |
> |  | **vpnServer配置** |  |
> | 動作 | 微軟.網路/vpn伺服器配置/讀取 | 獲取 VpnServer 配置 |
> | 動作 | 微軟.網路/vpn伺服器配置/寫入 | 創建或更新 VpnServer 配置 |
> | 動作 | 微軟.網路/vpn伺服器配置/刪除 | 刪除 VpnServer 配置 |
> |  | **vpnsites** |  |
...
> |  | **vpn網站/vpn網站連結** |  |
> | 動作 | 微軟.網路/vpnSites/vpnSite連結/閱讀 | 獲取 Vpn 站台連結 |
...
> | 動作 | Microsoft.OffAzure/HyperVSites/clusters/write | 建立或更新 Hyper-V 叢集 |
> |  | **超V網站/運行狀況摘要** |  |
> | 動作 | 微軟.關閉Azure/超網站/健康摘要/閱讀 | 獲取超 V 資源的運行狀況摘要 |
> | 動作 | 微軟.關閉Azure/超網站/健康摘要/閱讀 | 獲取超 V 資源的運行狀況摘要 |
> | 動作 | 微軟.關閉Azure/超網站/健康摘要/閱讀 | 獲取超 V 資源的運行狀況摘要 |
> | 動作 | 微軟.關閉Azure/超網站/健康摘要/閱讀 | 獲取超 V 資源的運行狀況摘要 |
> |  | **超級網站/主機** |  |
...
> | 動作 | Microsoft.OffAzure/HyperVSites/runasaccounts/read | 取得 Hyper-V 執行身分帳戶的屬性 |
> |  | **超級網站/摘要** |  |
> | 動作 | 微軟.關閉Azure/超網站/摘要/閱讀 | 獲取超 V 網站的摘要 |
> | 動作 | 微軟.關閉Azure/超網站/摘要/閱讀 | 獲取超 V 網站的摘要 |
> | 動作 | 微軟.關閉Azure/超網站/摘要/閱讀 | 獲取超 V 網站的摘要 |
> | 動作 | 微軟.關閉Azure/超網站/摘要/閱讀 | 獲取超 V 網站的摘要 |
> |  | **超級網站/使用** |  |
...
> | 動作 | Microsoft.OffAzure/HyperVSites/usage/read | 取得 Hyper-V 站台的使用情形 |
> |  | **導入網站** |  |
> | 動作 | 微軟.關閉Azure/導入網站/讀取 | 獲取導入網站的屬性 |
> | 動作 | 微軟.關閉Azure/導入網站/寫入 | 創建或更新導入網站 |
> | 動作 | 微軟.關閉Azure/導入網站/刪除 | 刪除導入網站 |
> | 動作 | 微軟.關閉Azure/導入網站/導入/操作 | 獲取用於導入電腦 CSV 檔的 SAS uri。 |
> | 動作 | 微軟.關閉Azure/導入網站/匯出/操作 | 獲取用於匯出電腦 CSV 檔的 SAS uri。 |
> | 動作 | 微軟.關閉Azure/導入網站/讀取 | 獲取導入網站的屬性 |
> | 動作 | 微軟.關閉Azure/導入網站/寫入 | 創建或更新導入網站 |
> | 動作 | 微軟.關閉Azure/導入網站/刪除 | 刪除導入網站 |
> | 動作 | 微軟.關閉Azure/導入網站/導入/操作 | 獲取用於導入電腦 CSV 檔的 SAS uri。 |
...
> | 動作 | 微軟.關閉Azure/導入網站/匯出/操作 | 獲取用於匯出電腦 CSV 檔的 SAS uri。 |
> |  | **導入網站/作業** |  |
> | 動作 | 微軟.關閉Azure/導入網站/作業/讀取 | 獲取導入作業的屬性 |
> | 動作 | 微軟.關閉Azure/導入網站/作業/讀取 | 獲取導入作業的屬性 |
> | 動作 | 微軟.關閉Azure/導入網站/作業/讀取 | 獲取導入作業的屬性 |
> | 動作 | 微軟.關閉Azure/導入網站/作業/讀取 | 獲取導入作業的屬性 |
> |  | **導入網站/電腦** |  |
> | 動作 | 微軟.關閉Azure/導入網站/電腦/讀取 | 獲取導入電腦的屬性 |
> | 動作 | 微軟.關閉Azure/導入網站/電腦/刪除 | 刪除導入電腦 |
> | 動作 | 微軟.關閉Azure/導入網站/電腦/讀取 | 獲取導入電腦的屬性 |
> | 動作 | 微軟.關閉Azure/導入網站/電腦/刪除 | 刪除導入電腦 |
> | 動作 | 微軟.關閉Azure/導入網站/電腦/讀取 | 獲取導入電腦的屬性 |
> | 動作 | 微軟.關閉Azure/導入網站/電腦/刪除 | 刪除導入電腦 |
...
> |  | **伺服器網站** |  |
> | 動作 | 微軟.關閉Azure/伺服器網站/讀取 | 獲取伺服器網站的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/寫入 | 創建或補救伺服器網站 |
> | 動作 | 微軟.關閉Azure/伺服器網站/刪除 | 刪除伺服器網站 |
> | 動作 | 微軟.關閉Azure/伺服器網站/刷新/操作 | 刷新伺服器網站中的物件 |
> | 動作 | 微軟.關閉Azure/伺服器網站/讀取 | 獲取伺服器網站的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/寫入 | 創建或補救伺服器網站 |
> | 動作 | 微軟.關閉Azure/伺服器網站/刪除 | 刪除伺服器網站 |
> | 動作 | 微軟.關閉Azure/伺服器網站/刷新/操作 | 刷新伺服器網站中的物件 |
...
> | 動作 | 微軟.關閉Azure/伺服器網站/刷新/操作 | 刷新伺服器網站中的物件 |
> |  | **伺服器網站/作業** |  |
> | 動作 | 微軟.關閉Azure/伺服器網站/作業/閱讀 | 獲取伺服器作業的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/作業/閱讀 | 獲取伺服器作業的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/作業/閱讀 | 獲取伺服器作業的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/作業/閱讀 | 獲取伺服器作業的屬性 |
> |  | **伺服器網站/電腦** |  |
> | 動作 | 微軟.關閉Azure/伺服器網站/電腦/讀取 | 獲取伺服器電腦的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/電腦/寫入 | 編寫伺服器電腦的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/電腦/讀取 | 獲取伺服器電腦的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/電腦/寫入 | 編寫伺服器電腦的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/電腦/讀取 | 獲取伺服器電腦的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/電腦/寫入 | 編寫伺服器電腦的屬性 |
...
> | 動作 | 微軟.關閉Azure/伺服器網站/電腦/寫入 | 編寫伺服器電腦的屬性 |
> |  | **伺服器網站/操作狀態** |  |
> | 動作 | 微軟.關閉Azure/伺服器網站/操作狀態/讀取 | 獲取伺服器操作狀態的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/操作狀態/讀取 | 獲取伺服器操作狀態的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/操作狀態/讀取 | 獲取伺服器操作狀態的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/操作狀態/讀取 | 獲取伺服器操作狀態的屬性 |
> |  | **伺服器網站/運行帳戶** |  |
> | 動作 | 微軟.關閉Azure/伺服器網站/運行帳戶/讀取 | 獲取伺服器作為帳戶運行的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/運行帳戶/讀取 | 獲取伺服器作為帳戶運行的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/運行帳戶/讀取 | 獲取伺服器作為帳戶運行的屬性 |
> | 動作 | 微軟.關閉Azure/伺服器網站/運行帳戶/讀取 | 獲取伺服器作為帳戶運行的屬性 |
> |  | **伺服器網站/摘要** |  |
> | 動作 | 微軟.關閉Azure/伺服器網站/摘要/閱讀 | 獲取伺服器網站的摘要 |
> | 動作 | 微軟.關閉Azure/伺服器網站/摘要/閱讀 | 獲取伺服器網站的摘要 |
> | 動作 | 微軟.關閉Azure/伺服器網站/摘要/閱讀 | 獲取伺服器網站的摘要 |
> | 動作 | 微軟.關閉Azure/伺服器網站/摘要/閱讀 | 獲取伺服器網站的摘要 |
> |  | **伺服器網站/使用方式** |  |
> | 動作 | 微軟.關閉Azure/伺服器網站/使用/讀取 | 獲取伺服器網站的用法 |
> | 動作 | 微軟.關閉Azure/伺服器網站/使用/讀取 | 獲取伺服器網站的用法 |
> | 動作 | 微軟.關閉Azure/伺服器網站/使用/讀取 | 獲取伺服器網站的用法 |
> | 動作 | 微軟.關閉Azure/伺服器網站/使用/讀取 | 獲取伺服器網站的用法 |
> |  | **VMwareSites** |  |
...
> | 動作 | 微軟.關閉Azure/VMware網站/生成粗糙映射/操作 | 為電腦清單生成粗映射 |
> | 動作 | 微軟.關閉Azure/VMware網站/生成詳細地圖/操作 | 生成詳細的 VMware 粗糙地圖 |
> | 動作 | 微軟.關閉Azure/VMware網站/用戶端組成員/操作 | 列出所選用戶端組的用戶端組成員。 |
> | 動作 | 微軟.關閉Azure/VMware網站/伺服器組成員/操作 | 列出所選伺服器組的伺服器組成員。 |
> | 動作 | 微軟.關閉Azure/VMware網站/獲取應用程式/操作 | 獲取所選電腦的清單應用程式資訊 |
> | 動作 | Microsoft.OffAzure/VMwareSites/read | 取得 VMware 站台的屬性 |
> | 動作 | Microsoft.OffAzure/VMwareSites/write | 建立或更新 VMware 站台 |
> | 動作 | Microsoft.OffAzure/VMwareSites/delete | 刪除 VMware 站台 |
> | 動作 | Microsoft.OffAzure/VMwareSites/refresh/action | 重新整理 VMware 站台內的物件 |
...
> | 動作 | 微軟.關閉Azure/VMware網站/獲取應用程式/操作 | 獲取所選電腦的清單應用程式資訊 |
> |  | **VMwareSites/健康摘要** |  |
> | 動作 | 微軟.關閉Azure/VMwareSites/健康摘要/閱讀 | 獲取 VMware 資源的運行狀況摘要 |
> | 動作 | 微軟.關閉Azure/VMwareSites/健康摘要/閱讀 | 獲取 VMware 資源的運行狀況摘要 |
> | 動作 | 微軟.關閉Azure/VMwareSites/健康摘要/閱讀 | 獲取 VMware 資源的運行狀況摘要 |
> | 動作 | 微軟.關閉Azure/VMwareSites/健康摘要/閱讀 | 獲取 VMware 資源的運行狀況摘要 |
> |  | **VMware 網站/作業** |  |
...
> | 動作 | Microsoft.OffAzure/VMwareSites/machines/start/action | 啟動 VMware 機器 |
> |  | **VMwareSites/機器/應用程式** |  |
> | 動作 | 微軟.關閉Azure/VMwareSites/機器/應用程式/讀取 | 獲取 VMware 電腦應用程式的屬性 |
> | 動作 | 微軟.關閉Azure/VMwareSites/機器/應用程式/讀取 | 獲取 VMware 電腦應用程式的屬性 |
> | 動作 | 微軟.關閉Azure/VMwareSites/機器/應用程式/讀取 | 獲取 VMware 電腦應用程式的屬性 |
> | 動作 | 微軟.關閉Azure/VMwareSites/機器/應用程式/讀取 | 獲取 VMware 電腦應用程式的屬性 |
> |  | **VMware 網站/操作狀態** |  |
...
> | 動作 | Microsoft.OffAzure/VMwareSites/runasaccounts/read | 取得 VMware 執行身分帳戶的屬性 |
> |  | **VMware 網站/摘要** |  |
> | 動作 | 微軟.關閉Azure/VMware網站/摘要/閱讀 | 獲取 VMware 網站的摘要 |
> | 動作 | 微軟.關閉Azure/VMware網站/摘要/閱讀 | 獲取 VMware 網站的摘要 |
> | 動作 | 微軟.關閉Azure/VMware網站/摘要/閱讀 | 獲取 VMware 網站的摘要 |
> | 動作 | 微軟.關閉Azure/VMware網站/摘要/閱讀 | 獲取 VMware 網站的摘要 |
> |  | **VMware 網站/使用方式** |  |
...
> |  | **集群** |  |
> | 動作 | 微軟.操作見解/集群/閱讀 | 獲取群集 |
> | 動作 | 微軟.操作見解/集群/寫入 | 創建或更新群集 |
...
> |  | **位置/操作 狀態** |  |
> | 動作 | 微軟.操作見解/位置/操作 狀態/讀取 | 獲取日誌分析 Azure 非同步作業狀態。 |
> |  | **操作** |  |
...
> |  | **工作區/資料匯出** |  |
> | 動作 | microsoft.運營見解/工作空間/資料匯出/讀取 | 獲取特定資料匯出。 |
> | 動作 | microsoft.運營見解/工作空間/資料匯出/寫入 | 創建或更新資料匯出。 |
> | 動作 | microsoft.運營見解/工作空間/資料匯出/刪除 | 刪除特定資料匯出。 |
> |  | **工作區/資料來源** |  |
...
> |  | **工作區/查詢/AdDomain服務帳戶日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AdDomain服務帳戶登錄/讀取 | 從 AADDomain 服務帳戶日誌表中讀取資料 |
> |  | **工作區/查詢/AAD域服務帳戶管理** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AADDomain服務帳戶管理/讀取 | 從 AADDomain 服務帳戶管理表中讀取資料 |
> |  | **工作區/查詢/AAD域服務目錄服務訪問** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AdDomain服務目錄服務訪問/讀取 | 從 AADDomain服務目錄服務訪問表中讀取資料 |
> |  | **工作區/查詢/AdDomain服務登錄日誌關閉** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AdDomain服務登錄/讀取 | 從 AADDomain 服務日誌表讀取資料 |
> |  | **工作區/查詢/AAD域服務策略更改** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AAD域服務策略更改/讀取 | 從 AADDomain 服務策略更改表中讀取資料 |
> |  | **工作區/查詢/AAD域服務許可權使用** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AAD域服務特權使用/讀取 | 從 AADDomain 服務許可權使用表中讀取資料 |
> |  | **工作區/查詢/AAD域服務系統安全性** |  |
...
> |  | **工作區/查詢/附加Azure備份警報** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/附加Azure備份警報/讀取 | 從"載入項 Azure 備份警報"表中讀取資料 |
> |  | **工作區/查詢/附加Azure備份作業** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/附加Azure備份作業/讀取 | 從"載入項 Azure 備份作業"表中讀取資料 |
> |  | **工作區/查詢/附加Azure備份策略** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/附加Azure備份策略/讀取 | 從載入項 Azure 備份策略表中讀取資料 |
> |  | **工作區/查詢/添加 Azure 備份保護實例** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/添加 Azure 備份保護實例/讀取 | 從載入項 Azure 備份保護實例表中讀取資料 |
> |  | **工作區/查詢/附加Azure備份存儲** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/附加Azure備份存儲/讀取 | 從載入項 Azure 備份存儲表中讀取資料 |
> |  | **工作區/查詢/ADF活動運行** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADF活動運行/讀取 | 從 ADF 活動運行表中讀取資料 |
> |  | **工作區/查詢/ADF 管道運行** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADF管道運行/讀取 | 從 ADFPipelineRun 表中讀取資料 |
> |  | **工作區/查詢/ADFSSIS集成運行時日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADFSSIS集成運行時日誌/讀取 | 從 ADFSIS 集成運行時日誌表中讀取資料 |
> |  | **工作區/查詢/ADFSSIS 包事件消息上下文** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADFSSIS包事件消息上下文/讀取 | 從 ADFSSIS 包事件消息上下文表中讀取資料 |
> |  | **工作區/查詢/ADFSSIS 包事件消息** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADFSSIS包事件消息/讀取 | 從 ADFSSIS 打包事件消息表中讀取資料 |
> |  | **工作區/查詢/ADFSSIS 包可執行統計資訊** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADFSSIS包可執行統計/讀取 | 從 ADFSSIS 包可執行統計資訊表中讀取資料 |
> |  | **工作區/查詢/ADFSSIS 包執行元件階段** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADFSSIS包執行元件階段/讀取 | 從 ADFSSIS 包執行元件階段表中讀取資料 |
> |  | **工作區/查詢/ADFSSIS包執行資料統計** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADFSSIS包執行資料統計/讀取 | 從 ADFSSIS 包執行資料統計資訊表中讀取資料 |
> |  | **工作區/查詢/ADF觸發器運行** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/ADF觸發器運行/讀取 | 從 ADF 觸發器運行表中讀取資料 |
> |  | **工作區/查詢/AD 複製結果** |  |
...
> |  | **工作區/查詢/Aeg交付失敗日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/Aeg交付失敗日誌/讀取 | 從 Aeg交付失敗日誌表中讀取資料 |
> |  | **工作區/查詢/Aeg發佈失敗日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/Aeg發佈失敗日誌/讀取 | 從 AegPublish 失敗日誌表中讀取資料 |
> |  | **工作區/查詢/警報** |  |
...
> |  | **工作區/查詢/Aml 計算群集事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/Aml計算集群事件/讀取 | 從 Aml 計算群集事件表讀取資料 |
> |  | **工作區/查詢/Aml 計算叢集節點事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/Aml計算集群節點事件/讀取 | 從 Aml 計算叢集節點事件表讀取資料 |
> |  | **工作區/查詢/計算作業事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/Aml計算作業事件/讀取 | 從 Aml 計算作業表讀取資料 |
> |  | **工作區/查詢/Api管理閘道日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/Api管理閘道日誌/讀取 | 從 Api管理閘道日誌表中讀取資料 |
> |  | **工作區/查詢/應用可用性結果** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式可用性結果/讀取 | 從應用可用性結果表中讀取資料 |
> |  | **工作區/查詢/應用程式瀏覽器計時** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式瀏覽器計時/閱讀 | 從應用瀏覽器計時表讀取資料 |
> |  | **工作區/查詢/應用中心錯誤** |  |
> | 動作 | Microsoft.OperationalInsights/workspaces/query/AppCenterError/read | 從 AppCenterError 資料表讀取資料 |
> |  | **工作區/查詢/應用程式依賴性** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式依賴性/讀取 | 從應用依賴性表讀取資料 |
> |  | **工作區/查詢/應用程式事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式事件/讀取 | 從應用事件表中讀取資料 |
> |  | **工作區/查詢/應用程式見解** |  |
> | 動作 | Microsoft.OperationalInsights/workspaces/query/ApplicationInsights/read | 從 ApplicationInsights 資料表讀取資料 |
> |  | **工作區/查詢/應用指標** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用指標/閱讀 | 從應用指標表中讀取資料 |
> |  | **工作區/查詢/應用網頁檢視** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式網頁檢視/閱讀 | 從 AppPageViews 表中讀取資料 |
> |  | **工作區/查詢/應用程式效能計數器** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式效能計數器/讀取 | 從應用效能計數器表中讀取資料 |
> |  | **工作區/查詢/應用程式平臺日誌用於春天** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AppPlatformLogs 用於Spring/閱讀 | 從 AppPlatformLogsforSpring 表讀取資料 |
> |  | **工作區/查詢/AppPlatform系統日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AppPlatform系統日誌/閱讀 | 從 AppPlatform系統日誌表中讀取資料 |
> |  | **工作區/查詢/應用程式請求** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式請求/讀取 | 從應用請求表中讀取資料 |
> |  | **工作區/查詢/應用程式應用日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AppServiceAppLogs/閱讀 | 從 AppServiceAppLogs 表中讀取資料 |
> |  | **工作區/查詢/應用程式服務稽核記錄** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式服務稽核記錄/讀取 | 從應用服務稽核記錄表中讀取資料 |
> |  | **工作區/查詢/應用程式服務主控台日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/AppServiceConsoleLogs/閱讀 | 從 AppServiceConsoleLogs 表中讀取資料 |
> |  | **工作區/查詢/應用程式服務環境平臺日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式服務環境平臺日誌/閱讀 | 從應用服務環境平臺日誌表中讀取資料 |
> |  | **工作區/查詢/應用程式服務檔稽核記錄** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式服務檔稽核記錄/讀取 | 從應用服務檔稽核記錄表中讀取資料 |
...
> |  | **工作區/查詢/應用跟蹤** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式跟蹤/閱讀 | 從 AppTraces 表讀取資料 |
> |  | **工作區/查詢/稽核記錄** |  |
> | 動作 | Microsoft.OperationalInsights/workspaces/query/AuditLogs/read | 從 AuditLogs 資料表讀取資料 |
> |  | **工作區/查詢/自動縮放評估日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/自動縮放評估日誌/讀取 | 從自動縮放評估日誌表中讀取資料 |
> |  | **工作區/查詢/自動縮放動作記錄** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/自動縮放動作記錄/讀取 | 從自動縮放動作記錄表中讀取資料 |
...
> | 動作 | 微軟.操作見解/工作空間/查詢/AzureDevOps審核/讀取 | 從 AzureDevOps 審核表中讀取資料 |
> |  | **工作區/查詢/Azure 診斷** |  |
...
> |  | **工作區/查詢/百色節點事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/百家星節點事件/閱讀 | 從白叢集節點事件表讀取資料 |
> |  | **工作區/查詢/白作業事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/白作業事件/閱讀 | 從白作業表讀取資料 |
> |  | **工作區/查詢/區塊鏈應用程式日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/區塊鏈應用程式日誌/閱讀 | 從區塊鏈應用程式日誌表中讀取資料 |
> |  | **工作區/查詢/區塊鏈代理日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/區塊鏈代理日誌/閱讀 | 從區塊鏈代理日誌表中讀取資料 |
> |  | **工作區/查詢/綁定埠** |  |
...
> |  | **工作區/查詢/容器註冊登錄事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/容器註冊登錄事件/讀取 | 從容器註冊登錄事件表中讀取資料 |
> |  | **工作區/查詢/容器註冊表存儲庫事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/容器註冊表庫事件/讀取 | 從容器註冊表存儲庫事件表中讀取資料 |
> |  | **工作區/查詢/容器服務日誌** |  |
...
> |  | **工作區/查詢/資料磚塊帳戶** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚帳戶/讀取 | 從資料磚塊會計表讀取資料 |
> |  | **工作區/查詢/資料磚群集** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚集群/讀取 | 從資料磚塊群集表中讀取資料 |
> |  | **工作區/查詢/資料磚塊DBFS** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚塊DBFS/讀取 | 從資料磚塊 DBFS 表中讀取資料 |
> |  | **工作區/查詢/資料磚實例池** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚實例池/讀取 | 從資料磚塊實例池表中讀取資料 |
> |  | **工作區/查詢/資料磚塊作業** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚作業/讀取 | 從資料磚塊作業表中讀取資料 |
> |  | **工作區/查詢/資料磚塊筆記本** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚筆記本/閱讀 | 從資料磚塊筆記本表中讀取資料 |
> |  | **工作區/查詢/資料磚秘密** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚秘密/讀取 | 從資料磚塊機密表中讀取資料 |
> |  | **工作區/查詢/資料磚塊SQL許可權** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚塊SQL許可權/讀取 | 從資料磚塊 SQL 許可權表中讀取資料 |
> |  | **工作區/查詢/資料磚塊SSH** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚塊SSH/讀取 | 從資料磚塊SSH表中讀取資料 |
> |  | **工作區/查詢/資料磚塊表** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚塊表/讀取 | 從資料磚塊表讀取資料 |
> |  | **工作區/查詢/資料磚工作區** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/資料磚工作空間/讀取 | 從資料磚塊工作區表中讀取資料 |
> |  | **工作區/查詢/依賴項** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/依賴/閱讀 | 從依賴項表中讀取資料 |
> |  | **工作區/查詢/設備AppCrash** |  |
...
> |  | **工作區/查詢/IoTHub 分散式跟蹤** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/IoTHub分散式跟蹤/讀取 | 從 IoTHub 分散式跟蹤表中讀取資料 |
> |  | **工作區/查詢/庫貝事件** |  |
...
> | 動作 | 微軟.操作見解/工作空間/查詢/MAOfficeAddinEntity運行狀況/讀取 | 從 MAOfficeAddinEntity 運行狀況表中讀取資料 |
...
> | 動作 | 微軟.操作見解/工作空間/查詢/MAOfficeApp實例運行狀況/讀取 | 從 MAOfficeApp實例運行狀況表中讀取資料 |
...
> | 動作 | 微軟.操作見解/工作空間/查詢/MAOfficeAppSessionsNRT/讀取 | 從 MAOfficeAppSessionsNRT 表讀取資料 |
> |  | **工作區/查詢/MAOffice 構建資訊** |  |
...
> | 動作 | 微軟.操作見解/工作空間/查詢/MAOfficeMacro錯誤NRT/讀取 | 從 MAOfficeMacro 錯誤 NRT 表讀取資料 |
> |  | **工作區/查詢/MAOfficeMacro 全球運行狀況** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/MAOfficeMacro全球健康/讀取 | 從 MAOfficeMacro 全球運行狀況表中讀取資料 |
...
> |  | **工作區/查詢/微軟Azure堡壘稽核記錄** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/微軟Azure堡壘稽核記錄/讀取 | 從 MicrosoftAzureBastion 稽核記錄表中讀取資料 |
> |  | **工作區/查詢/微軟資料共用接收快照日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/微軟資料共用接收快照日誌/讀取 | 從 Microsoft 資料共用接收快照日誌表中讀取資料 |
> |  | **工作區/查詢/微軟資料共用快照日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/微軟資料共用共用快照日誌/讀取 | 從 Microsoft 資料共用共用快照日誌表中讀取資料 |
> |  | **工作區/查詢/微軟資料共用日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/微軟資料共用日誌/閱讀 | 從 Microsoft 資料共用日誌表中讀取資料 |
> |  | **工作區/查詢/微軟動態遙測性能日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/微軟動態遙測性能日誌/讀取 | 從 Microsoft 動態遙測性能日誌表中讀取資料 |
> |  | **工作區/查詢/微軟動力學遙測系統指標日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/微軟動力學遙測系統指標日誌/讀取 | 從 Microsoft 動態遙測系統指標日誌表中讀取資料 |
> |  | **工作區/查詢/微軟醫療稽核記錄** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/微軟醫療稽核記錄/讀取 | 從 Microsoft 醫療稽核記錄表中讀取資料 |
> |  | **工作區/查詢/網路監控** |  |
...
> |  | **工作區/查詢/請求** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/請求/讀取 | 從請求表中讀取資料 |
> |  | **工作區/查詢/預留公共欄位** |  |
...
> |  | **工作區/查詢/安全IoTRaw事件** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/安全IoTRawEvent/讀取 | 從安全IoTRawEvent表中讀取資料 |
> |  | **工作區/查詢/安全建議** |  |
...
> |  | **工作區/查詢/信號R服務診斷日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/信號R服務診斷日誌/讀取 | 從信號R服務診斷日誌表中讀取資料 |
> |  | **工作區/查詢/登錄日誌** |  |
...
> |  | **工作區/查詢/Sql威脅保護登錄審核** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/SqlThreat保護登錄審核/讀取 | 從 SqlThreat 保護登錄審核表中讀取資料 |
> |  | **工作區/查詢/Sql脆弱評估結果** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/Sql脆弱評估結果/讀取 | 從 SqlVulnerability 評估結果表中讀取資料 |
> |  | **工作區/查詢/存儲BlobLogs** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/存儲BlobLogs/讀取 | 從存儲BlobLogs表讀取資料 |
> |  | **工作區/查詢/存儲檔日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/存儲檔日誌/讀取 | 從存儲檔日誌表中讀取資料 |
> |  | **工作區/查詢/存儲佇列日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/存儲佇列日誌/讀取 | 從存儲佇列日誌表中讀取資料 |
> |  | **工作區/查詢/存儲表日誌** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/存儲表日誌/讀取 | 從存儲表日誌表中讀取資料 |
> |  | **工作區/查詢/成功** |  |
...
> |  | **工作區/查詢/虛擬機器** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/VM電腦/讀取 | 從 VM 電腦表中讀取資料 |
> |  | **工作區/查詢/VM連接** |  |
...
> | 動作 | microsoft.操作見解/工作空間/範圍私人連結普洛西/寫入 | 放置作用域專用連結代理。 |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | Microsoft.PolicyInsights/register/action | 註冊 Microsoft 策略見解資來源提供者，並啟用其操作。 |
> | 動作 | 微軟.政策見解/取消註冊/操作 | 取消註冊 Microsoft 策略見解資來源提供者。 |
> |  | **非同步作業結果** |  |
...
> |  | **策略中繼資料** |  |
> | 動作 | 微軟.政策見解/政策中繼資料/閱讀 | 獲取策略中繼資料資源。 |
> |  | **policyStates** |  |
...
> | DataAction | 微軟.政策見解/檢查資料策略合規性/行動 | 根據資料策略檢查給定元件的符合性狀態。 |
> |  | **policyEvents** |  |
> | DataAction | 微軟.政策見解/策略事件/日誌資料事件/操作 | 記錄資源元件策略事件。 |
...
> |  | **使用者設置** |  |
> | 動作 | Microsoft.Portal/usersettings/delete | 刪除雲殼使用者設置。 |
> | 動作 | Microsoft.Portal/usersettings/write | 創建或更新雲外殼使用者設置。 |
> | 動作 | Microsoft.Portal/usersettings/read | 讀取雲殼使用者設置。 |
...
Azure 服務：[網站恢復](../site-recovery/index.yml)
...
> | 動作 | 微軟.恢復服務/Vault/備份加密配置/寫入 | 更新備份資源加密配置 |
> |  | **保險庫/備用引擎** |  |
...
> |  | **保存庫/複製結構/操作結果** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製結構/操作結果/讀取 | 跟蹤資源結構上的非同步作業的結果 |
> |  | **保存庫/複製結構/複製邏輯網路** |  |
...
> |  | **保存庫/複製結構/禁止複製容器/操作結果** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製結構/禁止複製容器/操作結果/讀取 | 跟蹤資源保護容器上的非同步作業的結果 |
> |  | **保存庫/複製結構/禁止複製容器/複製遷移專案** |  |
...
> | 動作 | Microsoft.恢復服務/保存庫/複製結構/禁止複製容器/複製遷移專案/重新同步/操作 | 重新同步處理 |
...
> |  | **保存庫/複製結構/禁止複製容器/複製遷移專案/操作結果** |  |
> | 動作 | Microsoft.恢復服務/保存庫/複製結構/禁止複製容器/複製遷移專案/操作結果/讀取 | 跟蹤資源遷移項上的非同步作業的結果 |
> |  | **保存庫/複製結構/禁止複製容器/可保護專案** |  |
...
> | 動作 | Microsoft.恢復服務/保存庫/複製結構/禁止複製容器/禁止複製專案/添加磁片/操作 | 新增磁碟 |
> | 動作 | Microsoft.恢復服務/保存庫/複製結構/禁止複製容器/禁止複製專案/刪除磁片/操作 | 刪除磁片 |
> | 動作 | Microsoft.恢復服務/保存庫/複製結構/禁止複製容器/禁止複製專案/解決運行狀況錯誤/操作 |  |
> |  | **保存庫/複製結構/禁止複製容器/禁止複製專案/操作結果** |  |
> | 動作 | Microsoft.恢復服務/保存庫/複製結構/禁止複製容器/禁止複製專案/操作結果/讀取 | 跟蹤資源受保護項上的非同步作業的結果 |
> |  | **保存庫/複製結構/禁止複製容器/禁止複製專案/復原點** |  |
...
> |  | **保存庫/複製結構/禁止複製容器/禁止複製容器映射/操作結果** |  |
> | 動作 | Microsoft.恢復服務/保存庫/複製結構/禁止複製容器/禁止複製容器映射/操作結果/讀取 | 跟蹤資源保護容器映射上的非同步作業的結果 |
> |  | **保存庫/複製結構/複製恢復服務提供程式** |  |
...
> |  | **保存庫/複製結構/複製恢復服務供應商/操作結果** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製結構/複製恢復服務提供程式/操作結果/讀取 | 跟蹤資源恢復服務提供者上的非同步作業的結果 |
> |  | **保存庫/複製結構/複製存儲分類** |  |
> | 動作 | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationStorageClassifications/read | 讀取任何存放裝置分類 |
> |  | **保存庫/複製結構/複製存儲分類/複製存儲分類映射** |  |
...
> |  | **保存庫/複製結構/複製存儲分類/複製存儲分類映射/操作結果** |  |
> | 動作 | Microsoft.恢復服務/保存庫/複製結構/複製存儲分類/複製存儲分類映射/操作結果/讀取 | 跟蹤資源存儲分類映射上的非同步作業的結果 |
> |  | **保存庫/複製結構/複製中心** |  |
...
> |  | **保存庫/複製結構/複製中心/操作結果** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製結構/複製中心/操作結果/讀取 | 跟蹤資源 vCenter 上的非同步作業的結果 |
> |  | **保存庫/複製作業** |  |
...
> |  | **保存庫/複製作業/操作結果** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製作業/操作結果/讀取 | 跟蹤資源作業上的非同步作業的結果 |
> |  | **保存庫/複製遷移專案** |  |
...
> |  | **保存庫/複製操作狀態** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製操作狀態/讀取 | 讀取任何保存庫複製操作狀態 |
> |  | **保存庫/複寫原則** |  |
...
> |  | **保存庫/複寫原則/操作結果** |  |
> | 動作 | 微軟.恢復服務/保存庫/複寫原則/操作結果/讀取 | 跟蹤資源策略上的非同步作業的結果 |
> |  | **保存庫/禁止複製專案** |  |
...
> |  | **保存庫/複製恢復計畫/操作結果** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製恢復計畫/操作結果/讀取 | 跟蹤資源恢復計畫上的非同步作業的結果 |
> |  | **保存庫/複製恢復服務提供程式** |  |
...
> |  | **保存庫/複製Vault運行狀況/操作結果** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製Vault運行狀況/操作結果/讀取 | 跟蹤資源保存庫複製運行狀況上的非同步作業的結果 |
> |  | **保存庫/複製庫設置** |  |
> | 動作 | 微軟.恢復服務/保存庫/複製Vault設置/讀取 | 讀取任何  |
> | 動作 | 微軟.恢復服務/保存庫/複製Vault設置/寫入 | 創建或更新任何  |
> |  | **保存庫/複製中心** |  |
...
> |  | **命名空間/網路規則集** |  |
> | 動作 | 微軟.中繼/命名空間/網路規則集/讀取 | 獲取網路規則集資源 |
...
> |  | **命名空間/專用端接Proxies** |  |
> | 動作 | 微軟.中繼/命名空間/私人端接連接Proxies/驗證/操作 | 驗證專用終結點連接代理 |
> | 動作 | 微軟.中繼/命名空間/私人端接連接Proxies/讀取 | 獲取專用終結點連接代理 |
> | 動作 | 微軟.中繼/命名空間/私人端接連接Proxies/寫入 | 創建專用終結點連接代理 |
> | 動作 | 微軟.中繼/命名空間/私人端接連接Proxies/刪除 | 刪除專用終結點連接代理 |
> |  | **命名空間/供應商/微軟.見解/診斷設置** |  |
> | 動作 | 微軟.中繼/命名空間/供應商/微軟.見解/診斷設置/讀取 | 取得命名空間診斷設定資源描述的清單 |
> | 動作 | 微軟.中繼/命名空間/供應商/微軟.見解/診斷設置/寫入 | 取得命名空間診斷設定資源描述的清單 |
> |  | **命名空間/提供程式/微軟.見解/記錄定義** |  |
> | 動作 | 微軟.中繼/命名空間/供應商/微軟.見解/記錄定義/讀取 | 取得命名空間記錄資源描述的清單 |
> |  | **命名空間/提供程式/微軟.見解/指標定義** |  |
...
Azure 服務[：Azure 服務運行狀況](../service-health/index.yml)
...
> |  | **新興問題** |  |
> | 動作 | 微軟.資源健康/新興問題/閱讀 | 獲取 Azure 服務的新興問題 |
> |  | **事件** |  |
...
> |  | **元** |  |
> | 動作 | 微軟.資源健康/中繼資料/讀取 | 獲取中繼資料 |
> |  | **通知** |  |
> | 動作 | 微軟.資源運行狀況/通知/讀取 | 接收 Azure 資源管理器通知 |
> |  | **作業** |  |
...
> | 動作 | 微軟.資源/部署/匯出範本/操作 | 部署的匯出範本 |
> |  | **部署/操作** |  |
> | 動作 | Microsoft.Resources/deployments/operations/read | 取得或列出部署作業。 |
> |  | **部署/操作狀態** |  |
> | 動作 | Microsoft.資源/部署/操作狀態/讀取 | 取得或列出部署作業狀態。 |
> |  | **部署腳本** |  |
> | 動作 | 微軟.資源/部署腳本/讀取 | 獲取或列出部署腳本 |
> | 動作 | 微軟.資源/部署腳本/寫入 | 創建或更新部署腳本 |
> | 動作 | 微軟.資源/部署腳本/刪除 | 刪除部署腳本 |
> |  | **部署腳本/日誌** |  |
> | 動作 | 微軟.資源/部署腳本/日誌/讀取 | 獲取或列出部署腳本日誌 |
> |  | **連結** |  |
...
Azure 服務：[計畫程式](../scheduler/index.md)
...
Azure 服務[：Azure 搜索](../search/index.yml)
...
> | 動作 | 微軟.搜索/搜索服務/清單查詢鍵/操作 | 傳回指定 Azure 搜尋服務的查詢 API 金鑰清單。 |
...
> |  | **搜索服務/專用端接Proxies** |  |
> | 動作 | 微軟.搜索/搜索服務/私人端接連接Proxies/驗證/操作 | 驗證來自 NRP 端的專用終結點連接創建調用 |
> | 動作 | 微軟.搜索/搜索服務/私人端接連接Proxies/寫入 | 使用指定參數創建專用終結點連接代理或更新指定專用終結點連接代理的屬性或標記 |
> | 動作 | 微軟.搜索/搜索服務/私人端接連接Proxies/讀取 | 返回專用終結點連接代理的清單或獲取指定專用終結點連接代理的屬性 |
> | 動作 | 微軟.搜索/搜索服務/私人終端連接Proxies/刪除 | 刪除現有專用終結點連接代理 |
...
> |  | **自我調整網路強化** |  |
> | 動作 | 微軟.安全/自我調整網路強化/讀取 | 獲取 Azure 受保護資源的自我調整網路強化建議 |
> | 動作 | 微軟.安全/自我調整網路強化/強制執行/操作 | 通過在給定的網路安全性群組上創建匹配的安全規則來強制實施給定的流量強化規則 |
...
> |  | **評估中繼資料** |  |
> | 動作 | 微軟.安全/評估中繼資料/讀取 | 獲取訂閱上的可用安全評估中繼資料 |
> | 動作 | 微軟.安全/評估中繼資料/寫入 | 創建或更新安全評估中繼資料 |
> |  | **評估** |  |
> | 動作 | 微軟.安全/評估/讀取 | 獲取訂閱的安全評估 |
> | 動作 | 微軟.安全/評估/寫入 | 創建或更新訂閱的安全評估 |
> |  | **自動預配設置** |  |
> | 動作 | 微軟.安全/自動預配設置/讀取 | 獲取訂閱的安全自動預配設置 |
> | 動作 | 微軟.安全/自動預配設置/寫入 | 為訂閱創建或更新安全自動預配設置 |
> |  | **合規性結果** |  |
...
> | 動作 | 微軟.安全見解/取消註冊/操作 | 從 Azure 哨兵取消註冊訂閱 |
> |  | **聚合** |  |
> | 動作 | 微軟.安全見解/聚合/閱讀 | 獲取聚合資訊 |
> |  | **警報規則** |  |
> | 動作 | 微軟.安全見解/警報規則/讀取 | 獲取警報規則 |
> | 動作 | 微軟.安全見解/警報規則/寫入 | 更新警報規則 |
> | 動作 | 微軟.安全見解/警報規則/刪除 | 刪除警報規則 |
> |  | **警報規則/操作** |  |
> | 動作 | 微軟.安全見解/警報規則/操作/讀取 | 獲取警報規則的回應操作 |
> | 動作 | 微軟.安全見解/警報規則/操作/寫入 | 更新警報規則的回應操作 |
> | 動作 | 微軟.安全見解/警報規則/操作/刪除 | 刪除警報規則的回應操作 |
> |  | **書籤** |  |
> | 動作 | 微軟.安全見解/書簽/閱讀 | 獲取書簽 |
> | 動作 | 微軟.安全見解/書簽/寫入 | 更新書簽 |
> | 動作 | 微軟.安全見解/書簽/刪除 | 刪除書簽 |
> | 動作 | 微軟.安全見解/書簽/擴展/操作 | 通過特定擴展獲取實體的相關實體 |
> |  | **例** |  |
> | 動作 | 微軟.安全見解/案例/閱讀 | 獲取案例 |
> | 動作 | 微軟.安全見解/案例/寫入 | 更新案例 |
> | 動作 | 微軟.安全見解/案例/刪除 | 刪除案例 |
> |  | **案例/評論** |  |
> | 動作 | 微軟.安全見解/案例/評論/閱讀 | 獲取案例注釋 |
> | 動作 | 微軟.安全見解/案例/評論/寫入 | 創建案例注釋 |
> |  | **案件/調查** |  |
> | 動作 | 微軟.安全見解/案例/調查/閱讀 | 獲取案例調查 |
> | 動作 | 微軟.安全見解/案例/調查/寫入 | 更新案例的中繼資料 |
> |  | **資料連線器** |  |
> | 動作 | 微軟.安全見解/資料連線器/讀取 | 獲取資料連線器 |
> | 動作 | 微軟.安全見解/資料連線器/寫入 | 更新資料連線器 |
> | 動作 | 微軟.安全見解/資料連線器/刪除 | 刪除資料連線器 |
> |  | **事件** |  |
> | 動作 | 微軟.安全見解/事件/讀取 | 獲取事件 |
> | 動作 | 微軟.安全見解/事件/寫入 | 更新事件 |
> | 動作 | 微軟.安全見解/事件/刪除 | 刪除事件 |
> |  | **事件/評論** |  |
> | 動作 | 微軟.安全見解/事件/評論/閱讀 | 獲取事件注釋 |
> | 動作 | 微軟.安全見解/事件/評論/寫入 | 創建事件注釋 |
> |  | **事件/關係** |  |
> | 動作 | 微軟.安全見解/事件/關係/閱讀 | 獲取事件和相關資源之間的關係 |
> | 動作 | 微軟.安全見解/事件/關係/寫入 | 更新事件和相關資源之間的關係 |
> | 動作 | 微軟.安全見解/事件/關係/刪除 | 刪除事件和相關資源之間的關係 |
> |  | **設定** |  |
> | 動作 | 微軟.安全見解/設置/閱讀 | 獲取設置 |
...
> |  | **命名空間/網路規則集** |  |
> | 動作 | 微軟.服務匯流排/命名空間/網路規則集/讀取 | 獲取網路規則集資源 |
> | 動作 | 微軟.服務匯流排/命名空間/網路規則集/寫入 | 建立 VNET 規則資源 |
> | 動作 | 微軟.服務匯流排/命名空間/網路規則集/刪除 | 刪除 VNET 規則資源 |
> |  | **命名空間/網路規則集** |  |
> | 動作 | 微軟.服務匯流排/命名空間/網路規則集/讀取 | 獲取網路規則集資源 |
> | 動作 | 微軟.服務匯流排/命名空間/網路規則集/寫入 | 建立 VNET 規則資源 |
> | 動作 | 微軟.服務匯流排/命名空間/網路規則集/刪除 | 刪除 VNET 規則資源 |
...
> |  | **命名空間/專用端接Proxies** |  |
> | 動作 | 微軟.服務匯流排/命名空間/私人端接連接Proxies/驗證/操作 | 驗證專用終結點連接代理 |
> | 動作 | 微軟.服務匯流排/命名空間/私人端接連接Proxies/讀取 | 獲取專用終結點連接代理 |
> | 動作 | 微軟.服務匯流排/命名空間/私人端接連接Proxies/寫入 | 創建專用終結點連接代理 |
> | 動作 | 微軟.服務匯流排/命名空間/私人端接連接Proxies/刪除 | 刪除專用終結點連接代理 |
> |  | **命名空間/供應商/微軟.見解/診斷設置** |  |
...
> |  | **命名空間/消息** |  |
> | DataAction | 微軟.服務匯流排/命名空間/消息/發送/操作 | 傳送訊息 |
> | DataAction | 微軟.服務匯流排/命名空間/消息/接收/操作 | 接收訊息 |
...
> |  | **位置/操作結果/信號器** |  |
> | 動作 | Microsoft.SignalRService/locations/operationresults/signalr/read | 查詢基於位置的非同步作業的結果 |
> |  | **位置/操作 狀態/操作 Id** |  |
> | 動作 | 微軟.SignalR服務/位置/操作 狀態/操作 Id/讀取 | 查詢基於位置的非同步作業的狀態 |
> |  | **位置/用法** |  |
> | 動作 | Microsoft.SignalRService/locations/usages/read | 取得 Azure SignalR Service 的配額使用量 |
> |  | **操作結果** |  |
> | 動作 | Microsoft.SignalRService/operationresults/read | 查詢提供程式級非同步作業的結果 |
> |  | **操作** |  |
> | 動作 | 微軟.SignalR服務/操作/讀取 | 列出 Azure SignalR 服務的操作。 |
> |  | **操作狀態** |  |
> | 動作 | 微軟.SignalR服務/操作狀態/讀取 | 查詢提供程式級非同步作業的狀態 |
> |  | **SignalR** |  |
...
> |  | **信號R/事件網格濾波器** |  |
> | 動作 | 微軟.SignalR服務/信號R/事件網格篩檢程式/讀取 | 獲取指定事件網格篩選器的屬性或列出指定 SignalR 的所有事件網格篩選器。 |
> | 動作 | 微軟.SignalR服務/信號R/事件網格篩檢程式/寫入 | 使用指定的參數創建或更新 SignalR 的事件網格篩選器。 |
> | 動作 | 微軟.SignalR服務/信號R/事件網格篩檢程式/刪除 | 從信號R中刪除事件網格篩選器。 |
> |  | **信號R/私有端點連接Proxies** |  |
> | 動作 | 微軟.SignalR服務/信號R/私有端點連接Proxies/驗證/操作 | 驗證專用終結點連接代理 |
> | 動作 | 微軟.SignalR服務/信號R/私有端點連接Proxies/寫 | 創建專用終結點連接代理 |
> | 動作 | 微軟.SignalR服務/信號R/私有端點連接Proxies/讀取 | 讀取專用終結點連接代理 |
> | 動作 | 微軟.SignalR服務/信號R/私人端接連接Proxies/刪除 | 刪除專用終結點連接代理 |
> |  | **信號R/私有端點連接** |  |
> | 動作 | 微軟.SignalR服務/信號R/私有端點連接/寫入 | 批准或拒絕專用終結點連接 |
> | 動作 | 微軟.SignalR服務/信號R/私有端點連接/讀取 | 讀取專用終結點連接 |
> |  | **信號R/私有連結資源** |  |
> | 動作 | 微軟.SignalR服務/信號R/私有連結資源/讀取 | 列出所有 SignalR 專用鏈路資源 |
...
> | 動作 | 微軟.解決方案/應用程式/刷新許可權/操作 | 刷新應用程式許可權。 |
> | 動作 | 微軟.解決方案/應用程式/更新訪問/操作 | 更新應用程式訪問。 |
> |  | **應用程式/應用程式工件** |  |
...
> | 動作 | 微軟.Sql/私有端點連接審批/操作 | 確定是否允許使用者批准專用終結點連接 |
> |  | **實例池** |  |
...
> |  | **實例池/用法** |  |
> | 動作 | 微軟.Sql/實例池/用法/讀取 | 獲取實例池的使用資訊 |
> |  | **位置** |  |
...
> |  | **位置/加密保護器Azure同步操作** |  |
> | 動作 | 微軟.Sql/位置/加密保護器Azure同步操作/讀取 | 獲取對透明資料加密加密保護器的正在進行的操作 |
> |  | **位置/加密保護器操作結果** |  |
> | 動作 | 微軟.Sql/位置/加密保護器操作結果/讀取 | 獲取對透明資料加密加密保護器的正在進行的操作 |
> |  | **位置/擴展審核設置Azure同步操作** |  |
...
> | 動作 | Microsoft.Sql/locations/instanceFailoverGroups/write | 使用指定參數創建實例容錯移轉組或更新指定實例容錯移轉組的屬性或標記。 |
...
> |  | **位置/實例池Azure同步操作** |  |
> | 動作 | Microsoft.Sql/locations/instancePoolAzureAsyncOperation/read | 獲取實例池操作的狀態 |
> |  | **位置/實例池操作結果** |  |
> | 動作 | Microsoft.Sql/locations/instancePoolOperationResults/read | 獲取實例池操作的結果 |
...
> |  | **位置/長期保留管理實例備份** |  |
> | 動作 | 微軟.Sql/位置/長期保留管理實例備份/讀取 | 返回特定位置的託管實例 LTR 備份清單  |
> |  | **位置/長期保留管理實例/長期保留資料庫/長期保留管理實例備份** |  |
> | 動作 | Microsoft.Sql/位置/長期保留管理實例/長期保留資料庫/長期保留管理實例備份/讀取 | 返回託管實例資料庫的 LTR 備份清單 |
> | 動作 | Microsoft.Sql/位置/長期保留管理實例/長期保留資料庫/長期保留管理實例備份/刪除 | 刪除託管實例資料庫的 LTR 備份 |
> |  | **位置/長期保留管理實例/長期保留管理實例備份** |  |
> | 動作 | 微軟.Sql/位置/長期保留管理實例/長期保留管理實例備份/讀取 | 返回特定託管實例的託管實例 LTR 備份清單 |
> |  | **位置/長期保留伺服器/長期保留備份** |  |
...
> | 動作 | 微軟.Sql/位置/託管實例加密保護器Azure同步操作/讀取 | 獲取對透明資料加密託管實例加密保護器的正在進行的操作 |
> |  | **位置/託管實例加密保護器操作結果** |  |
> | 動作 | 微軟.Sql/位置/託管實例加密保護器操作結果/讀取 | 獲取對透明資料加密託管實例加密保護器的正在進行的操作 |
> |  | **位置/託管實例鍵 Azure 同步操作** |  |
> | 動作 | 微軟.Sql/位置/託管實例鍵Azure同步操作/讀取 | 獲取對透明資料加密託管實例金鑰的正在進行的操作 |
> |  | **位置/託管實例鍵操作結果** |  |
> | 動作 | 微軟.Sql/位置/託管實例鍵操作結果/讀取 | 獲取對透明資料加密託管實例金鑰的正在進行的操作 |
> |  | **位置/託管實例長期保留原則 Azure 同步操作** |  |
> | 動作 | 微軟.Sql/位置/託管實例長期保留原則Azure同步操作/讀取 | 獲取託管資料庫的長期保留原則操作的狀態 |
> |  | **位置/託管實例長期保留政策操作結果** |  |
> | 動作 | 微軟.Sql/位置/託管實例長期保留原則操作結果/讀取 | 獲取託管資料庫的長期保留原則操作的狀態 |
> |  | **位置/託管短期保留政策操作結果** |  |
> | 動作 | 微軟.Sql/位置/託管短期保留原則操作結果/讀取 | 獲取短期保留原則操作的狀態 |
...
> |  | **位置/專用端點連接Azure同步操作** |  |
> | 動作 | 微軟.Sql/位置/私有端點連接Azure同步操作/讀取 | 獲取專用終結點連接操作的結果 |
> |  | **位置/專用端點連接操作結果** |  |
> | 動作 | 微軟.Sql/位置/私有終結點連接操作結果/讀取 | 獲取專用終結點連接操作的結果 |
> |  | **位置/專用端點連接代理Azure同步操作** |  |
> | 動作 | 微軟.Sql/位置/私有端點連接代理Azure同步操作/讀取 | 獲取專用終結點連接代理操作的結果 |
> |  | **位置/專用端接連接操作結果** |  |
> | 動作 | 微軟.Sql/位置/私有端點連接代理操作結果/讀取 | 獲取專用終結點連接代理操作的結果 |
> |  | **位置/伺服器管理員 Azure 同步操作** |  |
> | 動作 | 微軟.Sql/位置/伺服器管理員Azure同步操作/讀取 | 伺服器 Azure 活動目錄管理員非同步作業結果 |
> |  | **位置/伺服器管理員操作結果** |  |
> | 動作 | 微軟.Sql/位置/伺服器管理員操作結果/讀取 | 伺服器 Azure 活動目錄管理員操作結果 |
> |  | **位置/伺服器鍵Azure同步操作** |  |
> | 動作 | 微軟.Sql/位置/伺服器鍵Azure同步操作/讀取 | 獲取對透明資料加密伺服器金鑰的正在進行的操作 |
> |  | **位置/伺服器鍵操作結果** |  |
> | 動作 | 微軟.Sql/位置/伺服器鍵操作結果/讀取 | 獲取對透明資料加密伺服器金鑰的正在進行的操作 |
> |  | **地點/短期保留政策操作結果** |  |
> | 動作 | 微軟.Sql/位置/短期保留原則操作結果/讀取 | 獲取短期保留原則操作的狀態 |
> |  | **位置/同步操作結果** |  |
...
> |  | **位置/透明資料加密Azure同步操作** |  |
> | 動作 | 微軟.Sql/位置/透明資料加密Azure同步操作/讀取 | 獲取邏輯資料庫透明資料加密的正在進行的操作 |
> |  | **位置/透明資料加密操作結果** |  |
> | 動作 | 微軟.Sql/位置/透明資料加密操作結果/讀取 | 獲取邏輯資料庫透明資料加密的正在進行的操作 |
> |  | **位置/用法** |  |
...
> |  | **託管實例/資料庫/備份長期保留原則** |  |
> | 動作 | 微軟.Sql/託管實例/資料庫/備份長期保留原則/寫入 | 更新託管資料庫的長期保留原則 |
> | 動作 | 微軟.Sql/託管實例/資料庫/備份長期保留原則/讀取 | 獲取託管資料庫的長期保留原則 |
...
> |  | **託管實例/資料庫/列** |  |
> | 動作 | 微軟.Sql/託管實例/資料庫/列/讀取 | 返回託管資料庫的列清單 |
> |  | **託管實例/資料庫/當前敏感標籤** |  |
...
> | 動作 | 微軟.Sql/託管實例/資料庫/推薦敏感標籤/寫入 | 批量更新建議敏感度標籤 |
> |  | **託管實例/資料庫/還原詳細資訊** |  |
> | 動作 | 微軟.Sql/託管實例/資料庫/還原詳細資訊/讀取 | 在還原正在進行時返回託管資料庫還原詳細資訊。 |
> |  | **託管實例/資料庫/架構** |  |
> | 動作 | 微軟.Sql/託管實例/資料庫/架構/讀取 | 獲取託管資料庫架構。 |
> |  | **託管實例/資料庫/架構/表** |  |
> | 動作 | 微軟.Sql/託管實例/資料庫/架構/表/讀取 | 獲取託管資料庫表 |
> |  | **託管實例/資料庫/架構/表/列** |  |
> | 動作 | 微軟.Sql/託管實例/資料庫/架構/表/列/讀取 | 獲取託管資料庫列 |
...
> | 動作 | 微軟.Sql/託管實例/資料庫/架構/表/列/敏感度標籤/禁用/操作 | 禁用給定列上的敏感度建議 |
> | 動作 | 微軟.Sql/託管實例/資料庫/架構/表/列/敏感度標籤/啟用/操作 | 在給定列上啟用敏感性建議 |
> |  | **託管實例/資料庫/安全警報策略** |  |
> | 動作 | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/write | 變更指定受控資料庫的資料庫威脅偵測原則 |
> | 動作 | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/read | 檢索為給定伺服器配置的託管資料庫威脅檢測策略的清單 |
> |  | **託管實例/資料庫/安全事件** |  |
...
> |  | **託管實例/無法訪問的託管資料庫** |  |
> | 動作 | 微軟.Sql/託管實例/無法訪問的託管資料庫/讀取 | 獲取託管實例中無法訪問的託管資料庫的清單 |
...
> |  | **託管實例/操作** |  |
> | 動作 | 微軟.Sql/託管實例/操作/讀取 | 獲取託管實例操作 |
> | 動作 | 微軟.Sql/託管實例/操作/取消/操作 | 取消尚未完成的 Azure SQL 託管實例掛起的非同步作業。 |
...
> | 動作 | Microsoft.Sql/managedInstances/securityAlertPolicies/read | 檢索為給定伺服器配置的託管伺服器威脅檢測策略的清單 |
...
> | 動作 | 微軟.Sql/伺服器/禁用 AzureAD 唯一身份驗證/操作 | 禁用邏輯伺服器上僅禁用 Azure 活動目錄身份驗證 |
...
> | 動作 | 微軟.Sql/伺服器/私有端點連接審批/操作 | 確定是否允許使用者批准專用終結點連接 |
...
> |  | **servers/administrators** |  |
> | 動作 | Microsoft.Sql/servers/administrators/read | 獲取特定的 Azure 活動目錄管理員物件 |
> | 動作 | Microsoft.Sql/servers/administrators/write | 添加或更新特定的 Azure 活動目錄管理員物件 |
> | 動作 | Microsoft.Sql/servers/administrators/delete | 刪除特定的 Azure 活動目錄管理員物件 |
> |  | **servers/advisors** |  |
...
> | 動作 | 微軟.Sql/伺服器/資料庫/容錯移轉/操作 | 客戶啟動的資料庫容錯移轉。 |
...
> | 動作 | 微軟.Sql/伺服器/資料庫/備份短期保留原則/讀取 | 獲取資料庫的短期保留原則 |
> | 動作 | 微軟.Sql/伺服器/資料庫/備份短期保留原則/寫入 | 更新資料庫的短期保留原則 |
> |  | **伺服器/資料庫/列** |  |
> | 動作 | 微軟.Sql/伺服器/資料庫/列/讀取 | 返回資料庫的列清單 |
...
> |  | **伺服器/資料庫/擴展/導入擴展操作結果** |  |
> | 動作 | 微軟.Sql/伺服器/資料庫/擴展/導入擴展操作結果/讀取 | 獲取正在進行的導入操作 |
...
> | 動作 | 微軟.Sql/伺服器/資料庫/推薦敏感標籤/寫入 | 批量更新建議敏感度標籤 |
> |  | **伺服器/資料庫/複製連結** |  |
...
> | 動作 | 微軟.Sql/伺服器/資料庫/架構/表/列/敏感度標籤/啟用/操作 | 在給定列上啟用敏感性建議 |
> | 動作 | 微軟.Sql/伺服器/資料庫/架構/表/列/敏感度標籤/禁用/操作 | 禁用給定列上的敏感度建議 |
...
> | 動作 | Microsoft.Sql/servers/databases/securityAlertPolicies/read | 檢索為給定伺服器配置的資料庫威脅檢測策略的清單 |
> |  | **伺服器/資料庫/安全指標** |  |
...
> | 動作 | Microsoft.Sql/servers/databases/transparentDataEncryption/write | 更改給定邏輯資料庫的資料庫透明資料加密 |
> |  | **伺服器/資料庫/透明資料加密/操作結果** |  |
...
> | 動作 | 微軟.Sql/伺服器/彈性池/容錯移轉/操作 | 客戶啟動的彈性池容錯移轉。 |
> |  | **伺服器/彈性池/顧問** |  |
...
> |  | **伺服器/無法訪問的資料庫** |  |
> | 動作 | 微軟.Sql/伺服器/無法訪問的資料庫/讀取 | 返回邏輯伺服器中無法訪問的資料庫的清單。 |
> |  | **伺服器/介面端點設定檔** |  |
...
> |  | **伺服器/操作** |  |
> | 動作 | 微軟.Sql/伺服器/操作/讀取 | 返回在伺服器上執行的動作清單 |
> |  | **伺服器/專用端接連接Proxies** |  |
> | 動作 | 微軟.Sql/伺服器/私人端接連接Proxies/驗證/操作 | 驗證來自 NRP 端的專用終結點連接創建調用 |
...
> | 動作 | 微軟.Sql/伺服器/私人端接連接Proxies/刪除 | 刪除現有專用終結點連接代理 |
> |  | **伺服器/專用端點連接** |  |
> | 動作 | 微軟.Sql/伺服器/私有端點連接/讀取 | 返回專用終結點連接的清單或獲取指定專用終結點連接的屬性。 |
> | 動作 | 微軟.Sql/伺服器/專用端接連接/刪除 | 刪除現有的專用終結點連接 |
> | 動作 | 微軟.Sql/伺服器/私有端點連接/寫入 | 批准或拒絕現有專用終結點連接 |
> |  | **伺服器/專用連結資源** |  |
> | 動作 | 微軟.Sql/伺服器/私有連結資源/讀取 | 獲取相應 sql 伺服器的專用連結資源 |
> |  | **伺服器/供應商/微軟.見解/指標定義** |  |
...
> | 動作 | Microsoft.Sql/servers/securityAlertPolicies/read | 檢索為給定伺服器配置的伺服器威脅檢測策略清單 |
> |  | **伺服器/安全警報策略/操作結果** |  |
...
> |  | **伺服器/使用方式** |  |
> | 動作 | Microsoft.Sql/servers/usages/read | 返回伺服器 DTU 配額和伺服器內所有資料庫的當前 DTU 使用 |
> |  | **servers/virtualNetworkRules** |  |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.Sql虛擬電腦/註冊/操作 | 向 Microsoft.Sql虛擬電腦資來源提供者註冊訂閱 |
> | 動作 | 微軟.Sql虛擬電腦/取消註冊/操作 | 向 Microsoft.Sql虛擬電腦資來源提供者取消註冊訂閱 |
> |  | **位置** |  |
> | 動作 | 微軟.Sql虛擬電腦/位置/寄存器SqlVm候選/操作 | 註冊 SQL Vm 候選 |
> |  | **位置/可用性組偵聽操作結果** |  |
> | 動作 | 微軟.Sql虛擬電腦/位置/可用性組攔截器操作結果/讀取 | 獲取可用性組攔截器操作的結果 |
> |  | **位置/sql虛擬電腦群組操作結果** |  |
> | 動作 | 微軟.Sql虛擬電腦/位置/sql虛擬電腦群組操作結果/讀取 | 獲取 SQL 虛擬機器組操作的結果 |
> |  | **位置/sql虛擬電腦操作結果** |  |
> | 動作 | 微軟.Sql虛擬電腦/位置/sql虛擬電腦操作結果/讀取 | 獲取 SQL 虛擬機器操作的結果 |
> |  | **操作** |  |
> | 動作 | 微軟.Sql虛擬機器器/操作/讀取 |  |
> |  | **sql 虛擬電腦群組** |  |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦群組/讀取 | 重新介紹 SQL 虛擬機器組的詳細資訊 |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦群組/寫入 | 創建新或更改現有 SQL 虛擬機器組的屬性 |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦群組/刪除 | 刪除現有的 SQL 虛擬機器組 |
> |  | **sql 虛擬電腦群組/可用性組攔截器** |  |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦群組/可用性組攔截器/讀取 | 檢索給定 SQL 虛擬機器組上的 SQL 可用性組攔截器的詳細資訊 |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦群組/可用性組攔截器/寫入 | 創建新的 SQL 可用性組攔截器的屬性或更改屬性 |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦群組/可用性組攔截器/刪除 | 刪除現有可用性組攔截器 |
> |  | **sql 虛擬電腦群組/sql 虛擬電腦** |  |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦群組/sql虛擬電腦/讀取 | 按特定 sql 虛擬虛擬機器組列出 Sql 虛擬機器 |
> |  | **sql 虛擬電腦** |  |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦/讀取 | 檢索 SQL 虛擬機器的詳細資訊 |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦/寫入 | 創建新或更改現有 SQL 虛擬機器的屬性 |
> | 動作 | 微軟.Sql虛擬電腦/sql虛擬電腦/刪除 | 刪除現有 SQL 虛擬機器 |

## <a name="microsoftstorage"></a>Microsoft.Storage

Azure 服務：[存儲](../storage/index.yml)
...
> |  | **位置/檢查名稱可用性** |  |
> | 動作 | 微軟.存儲/位置/檢查名稱可用性/讀取 | 確認帳戶名稱有效，且並非使用中。 |
> |  | **位置/用法** |  |
...
> |  | **storageAccounts** |  |
> | 動作 | 微軟.存儲/存儲帳戶/恢復Blob範圍/操作 | 將 Blob 範圍還原到指定時間的狀態 |
> | 動作 | 微軟.存儲/存儲帳戶/專用端接連接審批/操作 | 批准專用終結點連接 |
> | 動作 | 微軟.存儲/存儲帳戶/容錯移轉/操作 | 客戶能夠在出現可用性問題時控制容錯移轉 |
...
> |  | **存儲帳戶/資料共用策略** |  |
> | 動作 | 微軟.存儲/存儲帳戶/資料共用策略/刪除 |  |
> | 動作 | 微軟.存儲/存儲帳戶/資料共用策略/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/資料共用策略/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/資料共用策略/寫入 |  |
> |  | **存儲帳戶/加密範圍** |  |
> | 動作 | 微軟.存儲/存儲帳戶/加密範圍/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/加密範圍/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/加密範圍/寫入 |  |
> | 動作 | 微軟.存儲/存儲帳戶/加密範圍/寫入 |  |
> |  | **storageAccounts/fileServices** |  |
> | 動作 | 微軟.存儲/存儲帳戶/檔服務/共用/操作 |  |
> | 動作 | 微軟.存儲/存儲帳戶/檔服務/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/檔服務/寫入 |  |
> | 動作 | 微軟.存儲/存儲帳戶/檔服務/讀取 | 獲取檔服務屬性 |
> |  | **存儲帳戶/檔服務/共用** |  |
> | 動作 | 微軟.存儲/存儲帳戶/檔服務/共用/刪除 |  |
> | 動作 | 微軟.存儲/存儲帳戶/檔服務/共用/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/檔服務/共用/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/檔服務/共用/寫入 |  |
> |  | **存儲帳戶/本地使用者** |  |
> | 動作 | 微軟.存儲/存儲帳戶/本地使用者/刪除 |  |
> | 動作 | 微軟.存儲/存儲帳戶/本地使用者/清單鍵/操作 |  |
> | 動作 | 微軟.存儲/存儲帳戶/本地使用者/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/本地使用者/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/本地使用者/寫入 |  |
> |  | **存儲帳戶/管理原則** |  |
> | 動作 | 微軟.存儲/存儲帳戶/管理原則/刪除 | 刪除存儲帳戶管理原則 |
> | 動作 | 微軟.存儲/存儲帳戶/管理原則/讀取 | 獲取存儲管理帳戶原則 |
> | 動作 | 微軟.存儲/存儲帳戶/管理原則/寫入 | 放置存儲帳戶管理原則 |
> |  | **存儲帳戶/物件複寫原則** |  |
> | 動作 | 微軟.存儲/存儲帳戶/物件複寫原則/刪除 |  |
> | 動作 | 微軟.存儲/存儲帳戶/物件複寫原則/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/物件複寫原則/讀取 |  |
> | 動作 | 微軟.存儲/存儲帳戶/物件複寫原則/寫入 |  |
> |  | **存儲帳戶/專用端接連接 Proxies** |  |
> | 動作 | 微軟.存儲/存儲帳戶/私有端接連接Proxies/讀取 | 獲取專用終結點連接代理 |
> | 動作 | 微軟.存儲/存儲帳戶/私人端接連接Proxies/刪除 | 刪除專用終結點連接代理 |
> | 動作 | 微軟.存儲/存儲帳戶/私有端接連接Proxies/寫入 | 放置專用終結點連接代理 |
> |  | **存儲帳戶/專用終結點連接** |  |
> | 動作 | 微軟.存儲/存儲帳戶/專用端點連接/刪除 | 刪除專用終結點連接 |
> | 動作 | 微軟.存儲/存儲帳戶/專用端點連接/讀取 | 獲取專用終結點連接 |
> | 動作 | 微軟.存儲/存儲帳戶/私有端點連接/寫入 | 放置專用終結點連接 |
> |  | **存儲帳戶/私有連結資源** |  |
> | 動作 | 微軟.存儲/存儲帳戶/私有連結資源/讀取 | 獲取存儲帳戶組 ID |
> |  | **storageAccounts/queueServices** |  |
> | 動作 | Microsoft.Storage/storageAccounts/queueServices/read | 獲取佇列服務屬性 |
...
> | DataAction | 微軟.存儲/存儲帳戶/blob服務/容器/blob/刪除 Blob 版本/操作 | 返回刪除 Blob 版本的結果 |
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/add/action | 傳回新增 Blob 內容的結果 |
> | DataAction | 微軟.存儲/存儲帳戶/blob服務/容器/blob/篩檢程式/操作 | 返回具有匹配標記篩選器的帳戶下的 blob 清單 |
> | DataAction | 微軟.存儲/存儲帳戶/blob服務/容器/blob/移動/操作 | 將 Blob 從一個路徑移動到另一個路徑 |
> | DataAction | 微軟.存儲/存儲帳戶/blob服務/容器/blob/管理擁有權/操作 | 更改 Blob 的擁有權 |
> | DataAction | 微軟.存儲/存儲帳戶/blob服務/容器/blob/修改許可權/操作 | 修改 Blob 的許可權 |
> | DataAction | Microsoft.Storage/storageAccounts/blobServices/containers/blobs/runAsSuperUser/action | 傳回 blob 命令的結果 |
> |  | **存儲帳戶/blob 服務/容器/blob/標記** |  |
> | DataAction | 微軟.存儲/存儲帳戶/blob服務/容器/blob/標籤/讀取 | 返回讀取 blob 標記的結果 |
> | DataAction | 微軟.存儲/存儲帳戶/blob服務/容器/blob/標籤/寫入 | 返回寫入 blob 標記的結果 |
> |  | **存儲帳戶/檔服務/檔共用/檔** |  |
> | DataAction | 微軟.存儲/存儲帳戶/檔服務/檔共用/檔/讀取 | 返回檔/資料夾或檔/資料夾清單 |
> | DataAction | 微軟.存儲/存儲帳戶/檔服務/檔共用/檔/寫入 | 返回寫入檔或創建資料夾的結果 |
> | DataAction | 微軟.存儲/存儲帳戶/檔服務/檔共用/檔/刪除 | 返回刪除檔/資料夾的結果 |
> | DataAction | 微軟.存儲/存儲帳戶/檔服務/檔共用/檔/修改許可權/操作 | 返回修改檔/資料夾許可權的結果 |
> | DataAction | 微軟.存儲/存儲帳戶/檔服務/檔共用/檔/行動超級使用者/操作 | 獲取檔管理員許可權 |
> |  | **存儲帳戶/佇列服務/佇列/消息** |  |
...
## <a name="microsoftstoragesync"></a>微軟.存儲同步
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | 微軟.存儲同步/註冊/操作 | 註冊存儲同步提供程式的訂閱 |
> | 動作 | 微軟.存儲同步/取消註冊/操作 | 取消註冊存儲同步提供程式的訂閱 |
> |  | **位置** |  |
...
> |  | **存儲同步服務/同步組/伺服器終結點/供應商/微軟.見解/指標定義** |  |
...
Azure 服務：[流分析](../stream-analytics/index.yml)
...
> | 動作 | 微軟.流分析/流工作/發佈邊緣包/操作 | 發佈流分析作業的邊緣包 |
> | 動作 | Microsoft.StreamAnalytics/streamingjobs/Read | 讀取串流分析作業 |
> | 動作 | 微軟.流分析/流式處理/縮放/操作 | 縮放流分析作業 |
...
> | 動作類型 | 作業 | 描述 |
> | --- | --- | --- |
> | 動作 | Microsoft.Support/register/action | 註冊支援資來源提供者 |
> | 動作 | 微軟.支援/檢查名稱可用性/操作 | 檢查該名稱有效且未用於資源類型 |
> |  | **操作結果** |  |
> | 動作 | 微軟.支援/操作結果/閱讀 | 取得作業結果 |
> |  | **操作** |  |
> | 動作 | 微軟.支援/操作/讀取 | 列出 Microsoft.支援資來源提供者上可用的操作 |
> |  | **操作狀態** |  |
> | 動作 | 微軟.支援/操作狀態/讀取 | 取得作業狀態 |
> |  | **服務** |  |
> | 動作 | 微軟.支援/服務/閱讀 | 獲取可用於支援的 Azure 服務清單 |
> |  | **服務/問題分類** |  |
> | 動作 | 微軟.支援/服務/問題分類/閱讀 | 獲取適用于 Azure 服務的問題分類清單 |
> |  | **支援門票** |  |
> | 動作 | Microsoft.Support/supportTickets/read | 獲取支援票證清單。 |
> | 動作 | Microsoft.Support/supportTickets/write | 非同步創建支援票證或更新它。 您可以建立技術、帳單、配額或訂用帳戶管理相關問題的支援票證。 您可以更新現有支援票證的嚴重性和連絡人詳細資訊。 |
> |  | **支援門票/通信** |  |
> | 動作 | 微軟.支援/支援門票/通信/閱讀 | 獲取支援票證通信清單 |
> | 動作 | 微軟.支援/支援門票/通信/寫入 | 創建支援票證通信 |

## <a name="microsofttimeseriesinsights"></a>Microsoft.TimeSeriesInsights

Azure 服務：[時間序列見解](../time-series-insights/index.yml)
...
> | 動作 | 微軟.Web/託管環境/私有端點連接審批/操作 | 批准專用終結點連接 |
...
> |  | **託管環境/事件網格篩選器** |  |
> | 動作 | 微軟.Web/託管環境/事件網格篩選/刪除 | 刪除託管環境中的事件網格篩選器。 |
> | 動作 | 微軟.Web/託管環境/事件網格篩檢程式/讀取 | 獲取託管環境中的事件網格篩選器。 |
...
> |  | **伺服器場/事件網格篩選器** |  |
> | 動作 | 微軟.Web/伺服器場/事件網格篩檢程式/刪除 | 刪除伺服器場上的事件網格篩選器。 |
> | 動作 | 微軟.Web/伺服器場/事件網格篩檢程式/讀取 | 在伺服器場上獲取事件網格篩選器。 |
> | 動作 | 微軟.Web/伺服器場/事件網格篩檢程式/寫入 | 將事件網格篩選器放在伺服器場上。 |
> |  | **伺服器場/第一方應用/設置** |  |
...
> | 動作 | 微軟.Web/網站/私人端點連接審批/操作 | 批准專用終結點連接 |
...
> |  | **網站/事件網格篩選器** |  |
> | 動作 | 微軟.網站/網站/事件網格篩檢程式/刪除 | 刪除 Web 應用上的事件網格篩選器。 |
> | 動作 | 微軟.網站/網站/事件網格篩檢程式/讀取 | 在 Web 應用上獲取事件網格篩選器。 |
> | 動作 | 微軟.網站/網站/事件網格篩檢程式/寫入 | 將事件網格篩選器放在 Web 應用上。 |
> |  | **網站/擴展** |  |
...
> |  | **網站/網路跟蹤/操作結果** |  |
> | 動作 | 微軟.web/網站/網路跟蹤/操作結果/讀取 | 獲取 Web 應用網路跟蹤操作結果。 |
> |  | **網站/操作結果** |  |
...
> |  | **網站/流程/模組** |  |
> | 動作 | 微軟.web/網站/進程/模組/讀取 | 獲取 Web 應用處理模組。 |
> |  | **網站/進程/執行緒** |  |
> | 動作 | 微軟.web/網站/進程/執行緒/讀取 | 獲取 Web 應用進程執行緒。 |
> |  | **網站/公共證書** |  |
...
- [將資來源提供者與服務匹配](../azure-resource-manager/management/azure-services-resource-providers.md)
- [Azure 自訂角色](custom-roles.md)
- [Azure 內置角色](built-in-roles.md)
