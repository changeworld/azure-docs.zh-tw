...
> | 動作 | Microsoft .Sql/managedInstances/資料庫/架構/讀取 | 取得受控資料庫架構。 （僅限架構） |
> | 動作 | Microsoft .Sql/managedInstances/資料庫/架構/資料表/資料行/讀取 | 取得受管理的資料庫資料行（僅限架構） |
...
> | 動作 | Microsoft .Sql/managedInstances/資料庫/架構/資料表/讀取 | 取得受管理的資料庫資料表（僅限架構） |
...
> | 動作 | Microsoft.Sql/servers/databases/schemas/read | 取得資料庫架構（僅限架構）。 |
> | 動作 | Microsoft.Sql/servers/databases/schemas/tables/columns/read | 取得資料庫資料行（僅限架構）。 |
...
> | 動作 | Microsoft.Sql/servers/databases/schemas/tables/read | 取得資料庫資料表（僅限架構）。 |
