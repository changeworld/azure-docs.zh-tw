...
> | 動作 | BatchAccounts/privateEndpointConnectionResults/read | 取得長時間執行的 Batch 帳戶私用端點連接作業的結果 |
> |  | **batchAccounts/privateEndpointConnections** |  |
> | 動作 | BatchAccounts/privateEndpointConnections/write | 更新 Batch 帳戶上的現有私用端點連線 |
> | 動作 | BatchAccounts/privateEndpointConnections/read | 取得私人端點連線，或列出 Batch 帳戶上的私用端點連接 |
> |  | **batchAccounts/privateLinkResources** |  |
> | 動作 | BatchAccounts/privateLinkResources/read | 取得私人連結資源的屬性，或列出 Batch 帳戶上的私用連結資源 |
> |  | **堆放** |  |
...
> | 動作 | Microsoft.CertificateRegistration/certificateOrders/verifyDomainOwnership/Action | 驗證網域擁有權 |
...
> | DataAction | CognitiveServices/accounts/CustomVision。預測/專案/匯入/動作 | 匯入專案。 |
> |  | **帳戶/CustomVision。預測/專案/匯出** |  |
> | DataAction | CognitiveServices/accounts/CustomVision。預測/專案/匯出/讀取 | 匯出專案。 |
...
> |  | **accounts/CustomVision. 預測/專案/訓練** |  |
> | DataAction | CognitiveServices/accounts/CustomVision。預測/專案/訓練/高級/動作 | 將專案排入佇列，以使用 PipelineConfiguration 和定型類型進行定型。 |
...
> | 動作 | Microsoft。計算/位置/privateEndpointConnectionProxyAzureAsyncOperation/讀取 | 取得非同步私用端點連接 Proxy 作業的狀態 |
> |  | **位置/privateEndpointConnectionProxyOperationResults** |  |
> | 動作 | Microsoft。計算/位置/privateEndpointConnectionProxyOperationResults/讀取 | 取得私人端點連接 Proxy 作業的結果 |
> |  | **位置/發行者** |  |
...
> |  | **sharedVMExtensions** |  |
> | 動作 | Microsoft。計算/sharedVMExtensions/讀取 | 取得共用 VM 擴充功能的屬性 |
> | 動作 | Microsoft。計算/sharedVMExtensions/寫入 | 建立新的共用 VM 擴充功能，或更新現有的 |
> | 動作 | Microsoft。計算/sharedVMExtensions/刪除 | 刪除共用的 VM 擴充功能 |
> |  | **sharedVMExtensions/版本** |  |
> | 動作 | Microsoft。 Compute/sharedVMExtensions/版本/讀取 | 取得共用 VM 擴充功能版本的屬性 |
> | 動作 | Microsoft。 Compute/sharedVMExtensions/版本/寫入 | 建立新的共用 VM 擴充功能版本，或更新現有的 |
> | 動作 | Microsoft。 Compute/sharedVMExtensions/版本/刪除 | 刪除共用的 VM 擴充功能版本 |
> |  | **sharedVMImages** |  |
...
> |  | **sshPublicKeys** |  |
> | 動作 | Microsoft。計算/sshPublicKeys/讀取 | 取得 SSH 公用金鑰的屬性 |
> | 動作 | Microsoft。計算/sshPublicKeys/寫入 | 建立新的 SSH 公開金鑰，或更新現有的 SSH 公用金鑰 |
> | 動作 | Microsoft。計算/sshPublicKeys/刪除 | 刪除 SSH 公開金鑰 |
> |  | **virtualMachines** |  |
...
> |  | **singleservers** |  |
> | 動作 | DBforPostgreSQL/singleservers/read | 傳回伺服器清單，或取得指定伺服器的屬性。 |
> | 動作 | DBforPostgreSQL/singleservers/write | 使用指定參數建立伺服器，或更新指定伺服器的屬性或標記。 |
> | 動作 | DBforPostgreSQL/singleservers/delete | 刪除現有伺服器。 |
> |  | **singleservers/providers/Microsoft Insights/diagnosticSettings** |  |
> | 動作 | DBforPostgreSQL/singleservers/provider/Microsoft Insights/diagnosticSettings/read | 取得資源的診斷設定 |
> | 動作 | DBforPostgreSQL/singleservers/provider/Microsoft Insights/diagnosticSettings/write | 建立或更新資源的診斷設定 |
> |  | **singleservers/providers/Microsoft Insights/logDefinitions** |  |
> | 動作 | DBforPostgreSQL/singleservers/provider/Microsoft Insights/logDefinitions/read | 取得于 postgresql 伺服器的可用記錄 |
> |  | **singleservers/providers/Microsoft Insights/Metricdefinitions.listasync** |  |
> | 動作 | DBforPostgreSQL/singleservers/provider/Microsoft Insights/Metricdefinitions.listasync/read | 傳回可供資料庫使用之計量的類型 |
...
> | 動作 | Microsoft.devtestlab/labs/共用資源庫/read | 讀取共用的資源庫。 |
...
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立資料庫。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取資料庫或列出所有資料庫。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/刪除 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除資料庫。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 |
> |  | **databaseAccounts/api/資料庫/集合** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/集合/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立或更新集合。 僅適用于 API 類型： ' mongodb '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/集合/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取集合或列出所有集合。 僅適用于 API 類型： ' mongodb '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/集合/刪除 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除集合。 僅適用于 API 類型： ' mongodb '。 |
> |  | **databaseAccounts/api/資料庫/集合/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/集合/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' mongodb '。 |
> |  | **databaseAccounts/api/資料庫/集合/設定** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/集合/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新集合輸送量。 僅適用于 API 類型： ' mongodb '。 僅適用于設定類型： [輸送量]。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/集合/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取集合輸送量。 僅適用于 API 類型： ' mongodb '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料庫/集合/設定/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/集合/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' mongodb '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料庫/容器** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/容器/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立或更新容器。 僅適用于 API 類型： ' sql '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/容器/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取容器或列出所有容器。 僅適用于 API 類型： ' sql '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/容器/刪除 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除容器。 僅適用于 API 類型： ' sql '。 |
> |  | **databaseAccounts/api/資料庫/容器/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/容器/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' sql '。 |
> |  | **databaseAccounts/api/資料庫/容器/設定** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/容器/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新容器輸送量。 僅適用于 API 類型： ' sql '。 僅適用于設定類型： [輸送量]。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/容器/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取容器輸送量。 僅適用于 API 類型： ' sql '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料庫/容器/設定/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/容器/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' sql '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料庫/圖形** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/圖形/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立或更新圖形。 僅適用于 API 類型： ' gremlin'。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/圖表/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取圖形或列出所有圖表。 僅適用于 API 類型： ' gremlin'。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/圖形/刪除 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除圖形。 僅適用于 API 類型： ' gremlin'。 |
> |  | **databaseAccounts/api/資料庫/圖形/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/圖形/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' gremlin'。 |
> |  | **databaseAccounts/api/資料庫/圖形/設定** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/圖形/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新圖形輸送量。 僅適用于 API 類型： ' gremlin'。 僅適用于設定類型： [輸送量]。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/圖形/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取圖形輸送量。 僅適用于 API 類型： ' gremlin'。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料庫/圖形/設定/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/圖形/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' gremlin'。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料庫/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/operationResults/read | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 |
> |  | **databaseAccounts/api/資料庫/設定** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新資料庫輸送量。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 僅適用于設定類型： [輸送量]。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取資料庫輸送量。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料庫/設定/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料庫/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/keyspace** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/write | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立 keyspace。 僅適用于 API 類型： ' cassandra '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/read | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取 keyspace 或列出所有 keyspace。 僅適用于 API 類型： ' cassandra '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/delete | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除 keyspace。 僅適用于 API 類型： ' cassandra '。 |
> |  | **databaseAccounts/api/keyspace/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/operationResults/read | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' cassandra '。 |
> |  | **databaseAccounts/api/keyspace/設定** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/settings/write | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新 keyspace 輸送量。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取 keyspace 輸送量。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/keyspace/settings/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/settings/operationResults/read | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/keyspace/tables** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/資料表/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立或更新資料表。 僅適用于 API 類型： ' cassandra '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/資料表/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取資料表或列出所有資料表。 僅適用于 API 類型： ' cassandra '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/資料表/刪除 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除資料表。 僅適用于 API 類型： ' cassandra '。 |
> |  | **databaseAccounts/api/keyspace/tables/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/tables/operationResults/read | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' cassandra '。 |
> |  | **databaseAccounts/api/keyspace/資料表/設定** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/資料表/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新資料表輸送量。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/資料表/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑，以讀取資料表輸送量。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/keyspace/tables/settings/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/keyspace/資料表/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料表** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料表/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立或更新資料表。 僅適用于 API 類型： ' table '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料表/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取資料表或列出所有資料表。 僅適用于 API 類型： ' table '。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料表/刪除 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除資料表。 僅適用于 API 類型： ' table '。 |
> |  | **databaseAccounts/api/資料表/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料表/operationResults/read | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' table '。 |
> |  | **databaseAccounts/api/資料表/設定** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料表/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新資料表輸送量。 僅適用于 API 類型： ' table '。 僅適用于設定類型： [輸送量]。 |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料表/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑，以讀取資料表輸送量。 僅適用于 API 類型： ' table '。 僅適用于設定類型： [輸送量]。 |
> |  | **databaseAccounts/api/資料表/設定/operationResults** |  |
> | 動作 | Microsoft DocumentDB/databaseAccounts/api/資料表/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' table '。 僅適用于設定類型： [輸送量]。 |
...
> | 動作 | Kusto/叢集/ListLanguageExtensions/action | 列出語言延伸模組。 |
> | 動作 | Kusto/叢集/AddLanguageExtensions/action | 新增語言擴充功能。 |
> | 動作 | Kusto/叢集/RemoveLanguageExtensions/action | 移除語言延伸模組。 |
...
> | 動作 | Microsoft.machinelearningservices/workspace/datadriftdetectors/read | 取得 Machine Learning Services 工作區中的資料漂移偵測器 |
> | 動作 | Microsoft.machinelearningservices/workspace/datadriftdetectors/write | 在 Machine Learning Services 工作區中建立或更新資料漂移偵測器 |
> | 動作 | Microsoft.machinelearningservices/workspace/datadriftdetectors/delete | 刪除 Machine Learning Services 工作區中的資料漂移偵測器 |
> |  | **工作區/資料集/已註冊** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/已註冊/已讀取 | 在 Machine Learning Services 工作區中取得已註冊的資料集 |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/已註冊/寫入 | 在 Machine Learning Services 工作區中建立或更新已註冊的資料集 |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/已註冊/刪除 | 刪除 Machine Learning Services 工作區中已註冊的資料集 |
> |  | **工作區/資料集/已註冊/預覽** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/已註冊/預覽/已讀取 | 取得 Machine Learning Services 工作區中已註冊資料集的資料集預覽 |
> |  | **工作區/資料集/已註冊/設定檔** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/已註冊/設定檔/讀取 | 取得 Machine Learning Services 工作區中已註冊資料集的資料集設定檔 |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/已註冊/設定檔/寫入 | 在 Machine Learning Services 工作區中，建立或更新已註冊資料集的資料集設定檔 |
> |  | **工作區/資料集/已註冊/架構** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/已註冊/架構/讀取 | 取得 Machine Learning Services 工作區中已註冊之資料集的資料集架構 |
> |  | **工作區/資料集/已取消註冊** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/未註冊/已讀取 | 在 Machine Learning Services 工作區中取得未註冊的資料集 |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/未註冊/寫入 | 在 Machine Learning Services 工作區中建立或更新未註冊的資料集 |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/未註冊/刪除 | 在 Machine Learning Services 工作區中刪除未註冊的資料集 |
> |  | **工作區/資料集/未註冊/預覽** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/未註冊/預覽/讀取 | 取得 Machine Learning Services 工作區中未註冊資料集的資料集預覽 |
> |  | **工作區/資料集/未註冊/設定檔** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/未註冊/設定檔/讀取 | 取得 Machine Learning Services 工作區中未註冊資料集的資料集設定檔 |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/未註冊/設定檔/寫入 | 在 Machine Learning Services 工作區中，建立或更新未註冊資料集的資料集設定檔 |
> |  | **工作區/資料集/未註冊/架構** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/資料集/未註冊/架構/讀取 | 在 Machine Learning Services 工作區中，取得未註冊資料集的資料集架構 |
> |  | **工作區/資料存放區** |  |
> | 動作 | Microsoft.machinelearningservices/workspace/資料存放區/read | 取得 Machine Learning Services 工作區中的資料存放區 |
> | 動作 | Microsoft.machinelearningservices/workspace/資料存放區/write | 在 Machine Learning Services 工作區中建立或更新資料存放區 |
> | 動作 | Microsoft.machinelearningservices/workspace/資料存放區/delete | 刪除 Machine Learning Services 工作區中的資料存放區 |
> |  | **工作區/端點/管線** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/端點/管線/讀取 | 取得 Machine Learning 服務工作區中的已發佈管線和管線端點 |
> | 動作 | Microsoft.machinelearningservices/工作區/端點/管線/寫入 | 在 Machine Learning Services 工作區中建立或更新已發佈的管線和管線端點 |
> |  | **工作區/環境** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/環境/讀取 | 取得 Machine Learning Services 工作區中的環境 |
> | 動作 | Microsoft.machinelearningservices/工作區/環境/readSecrets/action | 在 Machine Learning Services 工作區中取得具有秘密的環境 |
> | 動作 | Microsoft.machinelearningservices/工作區/環境/寫入 | 在 Machine Learning Services 工作區中建立或更新環境 |
> | 動作 | Microsoft.machinelearningservices/工作區/環境/組建/動作 | 在 Machine Learning Services 工作區中建立環境 |
...
> | 動作 | Microsoft.machinelearningservices/工作區/實驗/讀取 | 取得 Machine Learning Services 工作區中的實驗 |
> | 動作 | Microsoft.machinelearningservices/工作區/實驗/寫入 | 在 Machine Learning Services 工作區中建立或更新實驗 |
> | 動作 | Microsoft.machinelearningservices/工作區/實驗/刪除 | 刪除 Machine Learning Services 工作區中的實驗 |
> |  | **工作區/實驗/執行** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/實驗/執行/提交/動作 | 在 Machine Learning Services 工作區中建立或更新腳本執行 |
> | 動作 | Microsoft.machinelearningservices/工作區/實驗/執行/讀取 | 取得在 Machine Learning Services 工作區中執行 |
> | 動作 | Microsoft.machinelearningservices/工作區/實驗/執行/寫入 | 在 Machine Learning Services 工作區中建立或更新執行 |
> |  | **工作區/標籤** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/標記/匯出/動作 | 在 Machine Learning Services 工作區中匯出標記專案的標籤 |
> |  | **工作區/標記/標籤** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/標記/標籤/讀取 | 取得 Machine Learning Services 工作區中標記專案的標籤 |
> | 動作 | Microsoft.machinelearningservices/工作區/標記/標籤/寫入 | 在 Machine Learning Services 工作區中建立標記專案的標籤 |
> | 動作 | Microsoft.machinelearningservices/工作區/標記/標籤/拒絕/動作 | 拒絕 Machine Learning Services 工作區中標記專案的標籤 |
> |  | **工作區/標籤/專案** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/標籤/專案/讀取 | 在 Machine Learning Services 工作區中取得標籤專案 |
> | 動作 | Microsoft.machinelearningservices/工作區/標籤/專案/寫入 | 在 Machine Learning Services 工作區中建立或更新標籤專案 |
> | 動作 | Microsoft.machinelearningservices/工作區/標籤/專案/刪除 | 刪除 Machine Learning Services 工作區中的標籤專案 |
> |  | **工作區/標記/專案/摘要** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/標記/專案/摘要/讀取 | 在 Machine Learning Services 工作區中取得標籤專案摘要 |
> |  | **工作區/中繼資料/構件** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/構件/讀取 | 取得 Machine Learning Services 工作區中的成品 |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/構件/寫入 | 在 Machine Learning Services 工作區中建立或更新構件 |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/構件/delete | 刪除 Machine Learning Services 工作區中的成品 |
> |  | **工作區/中繼資料/秘密** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/秘密/讀取 | 取得 Machine Learning Services 工作區中的秘密 |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/秘密/寫入 | 在 Machine Learning Services 工作區中建立或更新秘密 |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/秘密/刪除 | 刪除 Machine Learning Services 工作區中的秘密 |
> |  | **工作區/中繼資料/快照集** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/快照/讀取 | 取得 Machine Learning Services 工作區中的快照集 |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/快照/寫入 | 在 Machine Learning Services 工作區中建立或更新快照集 |
> | 動作 | Microsoft.machinelearningservices/工作區/中繼資料/快照/刪除 | 刪除 Machine Learning Services 工作區中的快照集 |
> |  | **工作區/模型** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/模型/讀取 | 取得 Machine Learning Services 工作區中的模型 |
> | 動作 | Microsoft.machinelearningservices/工作區/模型/寫入 | 在 Machine Learning Services 工作區中建立或更新模型 |
> | 動作 | Microsoft.machinelearningservices/工作區/模型/刪除 | 刪除 Machine Learning Services 工作區中的模型 |
> | 動作 | Microsoft.machinelearningservices/工作區/模型/套件/動作 | 封裝 Machine Learning Services 工作區中的模型 |
> |  | **工作區/模組** |  |
...
> | 動作 | Microsoft.machinelearningservices/workspace/pipelinedrafts/delete | 刪除 Machine Learning Services 工作區中的管線草稿 |
...
> |  | **工作區/服務** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/服務/讀取 | 取得 Machine Learning Services 工作區中的服務 |
> |  | **工作區/服務/aci** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/服務/aci/寫入 | 建立或更新 Machine Learning Services 工作區中的 ACI 服務 |
> | 動作 | Microsoft.machinelearningservices/workspace/services/aci/listkeys/action | 列出 Machine Learning Services 工作區中 ACI 服務的索引鍵 |
> | 動作 | Microsoft.machinelearningservices/工作區/服務/aci/刪除 | 刪除 Machine Learning Services 工作區中的 ACI 服務 |
> |  | **工作區/服務/aks** |  |
> | 動作 | Microsoft.machinelearningservices/工作區/服務/aks/write | 在 Machine Learning Services 工作區中建立或更新 AKS 服務 |
> | 動作 | Microsoft.machinelearningservices/workspace/services/aks/listkeys/action | 列出 Machine Learning Services 工作區中 AKS 服務的金鑰 |
> | 動作 | Microsoft.machinelearningservices/workspace/services/aks/delete | 刪除 Machine Learning Services 工作區中的 AKS 服務 |
> | 動作 | Microsoft.machinelearningservices/工作區/服務/aks/分數/動作 | Machine Learning 服務工作區中的分數 AKS services |
...
> |  | **帳戶/privateAtlases** |  |
> | 動作 | Microsoft. Maps/accounts/privateAtlases/delete | 刪除私人的阿特拉斯 |
> | 動作 | Microsoft. Maps/accounts/privateAtlases/read | 取得私用的阿特拉斯 |
> | 動作 | Microsoft. Maps/accounts/privateAtlases/write | 建立或更新私用的阿特拉斯 |
> |  | **業務** |  |
...
> | 動作 | Microsoft Marketplace/privateStores/讀取 | 讀取 PrivateStores。 |
> |  | **privateStores/優惠** |  |
...
> | DataAction | MixedReality/ObjectUnderstandingAccounts/內嵌/動作 | 建立模型內嵌作業 |
> |  | **ObjectUnderstandingAccounts/內嵌** |  |
> | DataAction | MixedReality/ObjectUnderstandingAccounts/內嵌/讀取 | 取得模型內嵌作業狀態 |
...
> | 動作 | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/MountTargets/read | 讀取掛接目標資源。 |
> |  | **netAppAccounts/capacityPools/磁片區/ReplicationStatus** |  |
> | 動作 | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/ReplicationStatus/read | 讀取磁片區複寫的狀態。 |
...
> | 動作 | LoadBalancers/Loadbalancer.backendaddresspools/write | 建立負載平衡器後端位址集區，或更新現有的負載平衡器後端位址集區 |
> | 動作 | Microsoft. Network/loadBalancers/Loadbalancer.backendaddresspools/delete | 刪除負載平衡器後端位址集區 |
...
> |  | **natGateways** |  |
> | 動作 | Microsoft 網路/natGateways/聯結/動作 | 加入 NAT 閘道 |
> |  | **natRuleCollections** |  |
...
> | 動作 | Microsoft 網路/securityPartnerProviders/讀取 | 取得 SecurityPartnerProvider |
> | 動作 | Microsoft 網路/securityPartnerProviders/寫入 | 建立 SecurityPartnerProvider 或更新現有的 SecurityPartnerProvider |
> | 動作 | Microsoft 網路/securityPartnerProviders/驗證/動作 | 驗證 SecurityPartnerProvider |
> | 動作 | Microsoft. Network/securityPartnerProviders/updateReferences/action | 更新 SecurityPartnerProvider 中的參考 |
> | 動作 | Microsoft 網路/securityPartnerProviders/聯結/動作 | 加入 SecurityPartnerProvider。 未打斷。 |
> | 動作 | Microsoft 網路/securityPartnerProviders/刪除 | 刪除 SecurityPartnerProvider |
...
> | 動作 | Microsoft. Network/virtualNetworks/joinLoadBalancer/action | 將負載平衡器加入虛擬網路 |
...
> |  | **叢集** |  |
> | 動作 | Microsoft.operationalinsights/叢集/讀取 | 取得叢集 |
> | 動作 | Microsoft.operationalinsights/叢集/寫入 | 建立或更新叢集 |
> | 動作 | Microsoft.operationalinsights/叢集/刪除 | 刪除叢集 |
> |  | **linkTargets** |  |
...
> |  | **工作區/查詢/AppExceptions** |  |
> | 動作 | Microsoft.operationalinsights/工作區/查詢/AppExceptions/讀取 | 讀取來自 AppExceptions 資料表的資料 |
...
> |  | **工作區/查詢/WVDCheckpoints** |  |
> | 動作 | Microsoft.operationalinsights/工作區/查詢/WVDCheckpoints/讀取 | 讀取來自 WVDCheckpoints 資料表的資料 |
> |  | **工作區/查詢/WVDConnections** |  |
> | 動作 | Microsoft.operationalinsights/工作區/查詢/WVDConnections/讀取 | 讀取來自 WVDConnections 資料表的資料 |
> |  | **工作區/查詢/WVDErrors** |  |
> | 動作 | Microsoft.operationalinsights/工作區/查詢/WVDErrors/讀取 | 讀取來自 WVDErrors 資料表的資料 |
> |  | **工作區/查詢/WVDFeeds** |  |
> | 動作 | Microsoft.operationalinsights/工作區/查詢/WVDFeeds/讀取 | 讀取來自 WVDFeeds 資料表的資料 |
> |  | **工作區/查詢/WVDHostRegistrations** |  |
> | 動作 | Microsoft.operationalinsights/工作區/查詢/WVDHostRegistrations/讀取 | 讀取來自 WVDHostRegistrations 資料表的資料 |
> |  | **工作區/查詢/WVDManagement** |  |
> | 動作 | Microsoft.operationalinsights/工作區/查詢/WVDManagement/讀取 | 讀取來自 WVDManagement 資料表的資料 |
> |  | **工作區/規則** |  |
...
> | 動作 | Azurerm.recoveryservices/vault/privateEndpointConnectionProxies/delete | 等候幾分鐘的時間，然後再次嘗試操作。 如果問題持續發生， 請連絡 Microsoft 支援服務。 |
...
> | 動作 | Azurerm.recoveryservices/vault/privateEndpointConnections/delete | 刪除私人端點要求。 此呼叫是由備份管理員進行。 |
> | 動作 | Azurerm.recoveryservices/vault/privateEndpointConnections/write | 核准或拒絕私用端點要求。 此呼叫是由備份管理員進行。 |
> |  | **保存庫/privateEndpointConnections/operationsStatus** |  |
> | 動作 | Azurerm.recoveryservices/vault/privateEndpointConnections/operationsStatus/read | 傳回私用端點連接的作業狀態。 |
...
> | 動作 | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/resync/action | 重新同步處理 |
...
> | 動作 | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/addDisks/action | 新增磁碟 |
...
> | 動作 | SecurityInsights/dataConnectorsCheckRequirements/action | 查看使用者授權和授權 |
> |  | **聚合** |  |
...
> |  | **位置/時區** |  |
> | 動作 | Microsoft .Sql/位置/時區/讀取 | 依位置傳回受管理的實例時區清單。 |
...
> |  | **堆放** |  |
> | 動作 | Microsoft.sqlvirtualmachine/位置/registerSqlVmCandidate/動作 | 註冊 SQL Vm 候選 |
...
> | 動作 | Microsoft. Storage/storageAccounts/localUsers/delete |  |
> | 動作 | Microsoft. Storage/storageAccounts/localusers/listKeys/action |  |
> | 動作 | Microsoft. Storage/storageAccounts/localusers/read |  |
> | 動作 | Microsoft. Storage/storageAccounts/localusers/read |  |
> | 動作 | Microsoft. Storage/storageAccounts/localusers/write |  |
...
> |  | **operationresults** |  |
> | 動作 | Microsoft 支援/operationresults/讀取 | 取得非同步作業的結果。 |
> |  | **業務** |  |
> | 動作 | Microsoft. 支援/作業/讀取 | 列出 Microsoft 提供的所有作業。支援資源提供者 |
> |  | **operationsstatus** |  |
> | 動作 | Microsoft 支援/operationsstatus/讀取 | 取得非同步作業的狀態。 |
> |  | **services** |  |
> | 動作 | Microsoft 支援/服務/讀取 | 列出一或所有可支援的 Azure 服務 |
> |  | **服務/problemClassifications** |  |
> | 動作 | Microsoft 支援/服務/problemClassifications/讀取 | 列出 Azure 服務的一個或所有問題分類 |
> |  | **supportTickets** |  |
> | 動作 | Microsoft.Support/supportTickets/read | 列出一或所有支援票證 |
> | 動作 | Microsoft.Support/supportTickets/write | 允許建立和更新支援票證 |
> |  | **supportTickets/通訊** |  |
> | 動作 | Microsoft 支援/supportTickets/通訊/讀取 | 列出一或所有支援票證通訊 |
> | 動作 | Microsoft 支援/supportTickets/通訊/寫入 | 將新的通訊新增至支援票證 |
