...
> | Microsoft Marketplace/privateStores/動作 | 更新 PrivateStore。 |
...
> | Microsoft Marketplace/privateStores/write | 建立 PrivateStore。 |
> | Microsoft Marketplace/privateStores/delete | 刪除 PrivateStore。 |
> | Microsoft Marketplace/privateStores/優惠/動作 | PrivateStore 中的更新供應專案。 |
> | Microsoft Marketplace/privateStores/讀取 | 讀取 PrivateStores。 |
> | Microsoft Marketplace/privateStores/提供/寫入 | 在 PrivateStore 中建立供應專案。 |
> | Microsoft Marketplace/privateStores/優惠/刪除 | 從 PrivateStore 中刪除供應專案。 |
> | Microsoft Marketplace/privateStores/優惠/讀取 | 讀取 PrivateStore 供應專案。 |
...
> | MarketplaceOrdering/作業/讀取 | 列出 API 中所有可能的作業 |
...
> | ResourceHealth/emergingissues/read | 取得 Azure 服務的新興問題 |
...
> | Microsoft 支援/checkNameAvailability/動作 | 檢查名稱是否有效，且不會用於資源類型 |
> | Microsoft 支援/operationresults/讀取 | 取得非同步作業的結果。 |
> | Microsoft. 支援/作業/讀取 | 列出 Microsoft 提供的所有作業。支援資源提供者 |
> | Microsoft 支援/operationsstatus/讀取 | 取得非同步作業的狀態。 |
> | Microsoft 支援/服務/讀取 | 列出一或所有可支援的 Azure 服務 |
> | Microsoft 支援/服務/problemClassifications/讀取 | 列出 Azure 服務的一個或所有問題分類 |
> | Microsoft.Support/supportTickets/read | 列出一或所有支援票證 |
> | Microsoft.Support/supportTickets/write | 允許建立和更新支援票證 |
> | Microsoft 支援/supportTickets/通訊/讀取 | 列出一或所有支援票證通訊 |
> | Microsoft 支援/supportTickets/通訊/寫入 | 將新的通訊新增至支援票證 |
...
> | Microsoft。計算/取消註冊/動作 | 向 Microsoft 取消註冊訂用帳戶。計算資源提供者 |
...
> | Microsoft。計算/diskAccesses/讀取 | 取得 DiskAccess 資源的屬性 |
> | Microsoft。計算/diskAccesses/寫入 | 建立新的 DiskAccess 資源，或更新現有資源 |
> | Microsoft。計算/diskAccesses/刪除 | 刪除 DiskAccess 資源 |
> | Microsoft。 Compute/diskAccesses/privateEndpointConnectionsApproval/action | 核准私人端點連接 |
> | Microsoft。 Compute/diskAccesses/privateEndpointConnectionProxies/read | 取得私人端點連接 proxy 的屬性 |
> | DiskAccesses/privateEndpointConnectionProxies/write | 建立新的私人端點連接 Proxy |
> | DiskAccesses/privateEndpointConnectionProxies/delete | 刪除私人端點連接 Proxy |
> | Microsoft。 Compute/diskAccesses/privateEndpointConnectionProxies/validate/action | 驗證私用端點連接 Proxy 物件 |
> | DiskAccesses/privateEndpointConnections/delete | 刪除私人端點連接 |
> | Microsoft。計算/diskEncryptionSets/讀取 | 取得磁片加密集的屬性 |
> | Microsoft。計算/diskEncryptionSets/寫入 | 建立新的磁片加密集或更新現有的 |
> | Microsoft。計算/diskEncryptionSets/刪除 | 刪除磁片加密集 |
...
> | Microsoft。計算/資源庫/應用程式/讀取 | 取得圖庫應用程式的屬性 |
> | Microsoft. 計算/資源庫/應用程式/寫入 | 建立新的資源庫應用程式，或更新現有的 |
> | Microsoft。計算/資源庫/應用程式/刪除 | 刪除資源庫應用程式 |
> | Microsoft。計算/資源庫/應用程式/版本/讀取 | 取得圖庫應用程式版本的屬性 |
> | Microsoft。計算/資源庫/應用程式/版本/寫入 | 建立新的資源庫應用程式版本，或更新現有的 |
> | Microsoft. 計算/資源庫/應用程式/版本/刪除 | 刪除圖庫應用程式版本 |
...
> | Microsoft。計算/hostGroups/讀取 | 取得主機群組的屬性 |
> | Microsoft。計算/hostGroups/寫入 | 建立新的主機群組，或更新現有的主機群組 |
> | Microsoft。計算/hostGroups/刪除 | 刪除主機群組 |
> | Microsoft。計算/hostGroups/主機/讀取 | 取得主機的屬性 |
> | Microsoft。 Compute/hostGroups/hosts/write | 建立新的主機，或更新現有的主機 |
...
> | Microsoft。計算/位置/privateEndpointConnectionProxyAzureAsyncOperation/讀取 | 取得非同步私用端點連接 Proxy 作業的狀態 |
> | Microsoft。計算/位置/privateEndpointConnectionProxyOperationResults/讀取 | 取得私人端點連接 Proxy 作業的結果 |
...
> | Microsoft。計算/proximityPlacementGroups/讀取 | 取得鄰近放置群組的屬性 |
> | Microsoft。計算/proximityPlacementGroups/寫入 | 建立新的鄰近放置群組，或更新現有的 |
> | Microsoft。計算/proximityPlacementGroups/刪除 | 刪除鄰近位置群組 |
...
> | Microsoft。計算/sharedVMExtensions/讀取 | 取得共用 VM 擴充功能的屬性 |
> | Microsoft。計算/sharedVMExtensions/寫入 | 建立新的共用 VM 擴充功能，或更新現有的 |
> | Microsoft。計算/sharedVMExtensions/刪除 | 刪除共用的 VM 擴充功能 |
> | Microsoft。 Compute/sharedVMExtensions/版本/讀取 | 取得共用 VM 擴充功能版本的屬性 |
> | Microsoft。 Compute/sharedVMExtensions/版本/寫入 | 建立新的共用 VM 擴充功能版本，或更新現有的 |
> | Microsoft。 Compute/sharedVMExtensions/版本/刪除 | 刪除共用的 VM 擴充功能版本 |
...
> | Microsoft。計算/sshPublicKeys/讀取 | 取得 SSH 公用金鑰的屬性 |
> | Microsoft。計算/sshPublicKeys/寫入 | 建立新的 SSH 公開金鑰，或更新現有的 SSH 公用金鑰 |
> | Microsoft。計算/sshPublicKeys/刪除 | 刪除 SSH 公開金鑰 |
...
> | Microsoft。 Compute/virtualMachines/重新套用/動作 | 重新套用虛擬機器的目前模型 |
...
> | Microsoft。 Compute/virtualMachines/installPatches/action | 會根據使用者提供的參數，在虛擬機器上安裝可用的 OS 更新修補程式。 包含可用修補程式清單的評量結果也會在此過程中重新整理。 |
> | Microsoft。 Compute/virtualMachines/assessPatches/action | 評估虛擬機器並尋找其可用的 OS 更新修補程式清單。 |
> | Microsoft。 Compute/virtualMachines/cancelPatchInstallation/action | 取消虛擬機器上進行中的安裝 OS 更新修補作業。 |
> | Microsoft。 Compute/virtualMachines/simulateEviction/action | 模擬點虛擬機器的收回 |
...
> | Microsoft。計算/virtualMachineScaleSets/延伸模組/角色/讀取 | 使用虛擬機器執行時間服務延伸模組，取得虛擬機器擴展集中角色的屬性 |
> | Microsoft。計算/virtualMachineScaleSets/延伸模組/角色/寫入 | 使用虛擬機器執行時間服務延伸模組來更新虛擬機器擴展集中現有角色的屬性 |
...
> | VirtualMachineScaleSets/virtualMachines/retrieveBootDiagnosticsData/action | 抓取虛擬機器擴展集中虛擬機器實例的開機診斷記錄 blob Uri |
...
> | VirtualMachineScaleSets/virtualMachines/simulateEviction/action | 模擬虛擬機器擴展集中的點虛擬機器收回 |
> | Microsoft。 Compute/virtualMachineScaleSets/virtualMachines/extensions/read | 取得虛擬機器擴展集中虛擬機器的擴充功能屬性 |
> | Microsoft。 Compute/virtualMachineScaleSets/virtualMachines/extensions/write | 為虛擬機器擴展集中的虛擬機器建立新的擴充功能，或更新現有的延伸模組 |
> | Microsoft。 Compute/virtualMachineScaleSets/virtualMachines/extensions/delete | 刪除虛擬機器擴展集中虛擬機器的擴充功能 |
...
Azure 服務：[應用程式閘道](../application-gateway/index.yml)、 [azure](../bastion/index.yml)防禦、 [Azure DDoS 保護](../virtual-network/ddos-protection-overview.md)、 [Azure DNS](../dns/index.yml)、 [Azure ExpressRoute](../expressroute/index.yml)、 [azure 防火牆](../firewall/index.yml)、 [azure Front 門服務](../frontdoor/index.yml)、 [azure 私人連結](../private-link/index.yml)、 [Load Balancer](../load-balancer/index.yml)、[網路監看員](../network-watcher/index.yml)、[流量管理員](../traffic-manager/index.yml)、[虛擬網路](../virtual-network/index.yml)、[虛擬 WAN](../virtual-wan/index.yml)、 [VPN 閘道](../vpn-gateway/index.yml)
...
> | Microsoft. Network/applicationGateways/getBackendHealthOnDemand/action | 取得給定 HTTP 設定和後端集區的應用程式閘道後端健全狀況需求 |
> | Microsoft.Network/applicationGateways/start/action | 啟動應用程式閘道 |
> | Microsoft.Network/applicationGateways/stop/action | 停止應用程式閘道 |
> | Microsoft 網路/applicationGateways/重新開機/動作 | 重新開機應用程式閘道 |
...
> | ApplicationGateways/privateEndpointConnections/write | 更新 PrivateEndpoint 連接應用程式閘道 |
...
> | Microsoft 網路/ApplicationGatewayWebApplicationFirewallPolicies/讀取 | 取得應用程式閘道 WAF 原則 |
> | Microsoft 網路/ApplicationGatewayWebApplicationFirewallPolicies/寫入 | 建立應用程式閘道 WAF 原則，或更新應用程式閘道 WAF 原則 |
> | Microsoft 網路/ApplicationGatewayWebApplicationFirewallPolicies/刪除 | 刪除應用程式閘道 WAF 原則 |
> | Microsoft 網路/applicationRuleCollections/讀取 | 取得 Azure 防火牆 ApplicationRuleCollection |
> | Microsoft 網路/applicationRuleCollections/寫入 | CreatesOrUpdates Azure 防火牆 ApplicationRuleCollection |
> | Microsoft 網路/applicationRuleCollections/刪除 | 刪除 Azure 防火牆 ApplicationRuleCollection |
...
> | Microsoft. Network/bastionHosts/getactivesessions/action | 取得防禦主機中的作用中會話 |
> | Microsoft. Network/bastionHosts/disconnectactivesessions/action | 將防禦主機中指定的作用中會話中斷連線 |
> | Microsoft. Network/bastionHosts/getShareableLinks/action | 為防禦子網中指定的 Vm 傳回可共用的 url，前提是其 url 已建立 |
...
> | Microsoft. Network/bastionHosts/deleteShareableLinksByToken/action | 刪除防禦下所提供權杖的可共用 url |
...
> | Microsoft 網路/連線/startpacketcapture/動作 | 啟動虛擬網路的閘道連線封包捕獲。 |
> | Microsoft 網路/連線/stoppacketcapture/動作 | 停止虛擬網路的閘道連線封包捕獲。 |
...
> | Microsoft 網路/customIpPrefixes/讀取 | 取得自訂 Ip 首碼定義 |
> | Microsoft 網路/customIpPrefixes/寫入 | 建立自訂 Ip 首碼，或更新現有的自訂 Ip 首碼 |
> | Microsoft 網路/customIpPrefixes/刪除 | 刪除自訂 Ip 首碼 |
...
> | Microsoft.Network/dnszones/A/read | 取得 JSON 格式的 ' A ' 類型記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft.Network/dnszones/A/write | 在 DNS 區域內建立或更新 ' A ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft.Network/dnszones/A/delete | 從 DNS 區域中移除指定名稱和類型 ' A ' 的記錄集。 |
> | Microsoft.Network/dnszones/AAAA/read | 取得 JSON 格式的 ' AAAA ' 類型記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft.Network/dnszones/AAAA/write | 在 DNS 區域內建立或更新 ' AAAA ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft.Network/dnszones/AAAA/delete | 從 DNS 區域中移除指定名稱和類型 ' AAAA ' 的記錄集。 |
> | Microsoft.Network/dnszones/all/read | 取得跨類型的 DNS 記錄集 |
> | Microsoft.Network/dnszones/CAA/read | 取得 JSON 格式的 ' CAA ' 類型記錄集。 記錄集包含 TTL、標記和 etag。 |
...
> | Microsoft.Network/dnszones/CNAME/read | 取得 JSON 格式的 ' CNAME ' 類型記錄集。 記錄集包含 TTL、標記和 etag。 |
> | Microsoft.Network/dnszones/CNAME/write | 在 DNS 區域內建立或更新 ' CNAME ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft.Network/dnszones/CNAME/delete | 從 DNS 區域中移除指定名稱和類型為 ' CNAME ' 的記錄集。 |
> | Microsoft.Network/dnszones/MX/read | 取得 JSON 格式的 ' MX ' 類型記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft.Network/dnszones/MX/write | 在 DNS 區域內建立或更新 ' MX ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft.Network/dnszones/MX/delete | 從 DNS 區域中移除指定名稱和類型 ' MX ' 的記錄集。 |
...
> | Microsoft.Network/dnszones/PTR/read | 取得 JSON 格式的 ' PTR ' 類型記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft.Network/dnszones/PTR/write | 在 DNS 區域內建立或更新 ' PTR ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft.Network/dnszones/PTR/delete | 從 DNS 區域中移除指定名稱和類型 ' PTR ' 的記錄集。 |
...
> | Microsoft.Network/dnszones/SRV/delete | 從 DNS 區域中移除指定名稱和類型為 ' SRV ' 的記錄集。 |
> | Microsoft.Network/dnszones/TXT/read | 取得 JSON 格式的 ' TXT ' 類型記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft.Network/dnszones/TXT/write | 在 DNS 區域內建立或更新 ' TXT ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft.Network/dnszones/TXT/delete | 從 DNS 區域中移除指定名稱和類型 ' TXT ' 的記錄集。 |
...
> | Microsoft.Network/expressRouteCrossConnections/join/action | 加入 Express Route 交叉連線。 不可警示。 |
...
> | Microsoft 網路/firewallPolicies/讀取 | 取得防火牆原則 |
> | Microsoft 網路/firewallPolicies/寫入 | 建立防火牆原則，或更新現有的防火牆原則 |
...
> | FrontDoors/rulesEngines/write | 建立或更新規則引擎 |
> | Microsoft. Network/frontDoors/rulesEngines/delete | 刪除規則引擎 |
> | Microsoft 網路/frontDoorWebApplicationFirewallManagedRuleSets/讀取 | 取得 Web 應用程式防火牆受控規則集 |
...
> | Microsoft 網路/frontDoorWebApplicationFirewallPolicies/聯結/動作 | 加入 Web 應用程式防火牆原則。 不可警示。 |
> | Microsoft 網路/ipAllocations/讀取 | 取得 IpAllocation |
> | Microsoft 網路/ipAllocations/寫入 | 建立 IpAllocation 或更新現有的 IpAllocation |
> | Microsoft 網路/ipAllocations/刪除 | 刪除 IpAllocation |
> | Microsoft 網路/ipGroups/讀取 | 取得 IpGroup |
> | Microsoft 網路/ipGroups/寫入 | 建立 IpGroup 或更新現有的 IpGroups |
> | Microsoft 網路/ipGroups/驗證/動作 | 驗證 IpGroup |
> | Microsoft. Network/ipGroups/updateReferences/action | 更新 IpGroup 中的參考 |
> | Microsoft 網路/ipGroups/聯結/動作 | 加入 IpGroup。 不可警示。 |
> | Microsoft 網路/ipGroups/刪除 | 刪除 IpGroup |
...
> | LoadBalancers/Loadbalancer.backendaddresspools/write | 建立負載平衡器後端位址集區，或更新現有的負載平衡器後端位址集區 |
...
> | Microsoft. 網路/位置/availableServiceAliases/讀取 | 取得可用的服務別名 |
...
> | Microsoft. 網路/位置/serviceTags/讀取 | 取得服務標記 |
...
> | Microsoft 網路/masterCustomIpPrefixes/讀取 | 取得主要自訂 Ip 首碼定義 |
> | Microsoft 網路/masterCustomIpPrefixes/寫入 | 建立主要自訂 Ip 首碼，或更新現有的主要自訂 Ip 首碼 |
> | Microsoft 網路/masterCustomIpPrefixes/刪除 | 刪除主要自訂 Ip 首碼 |
> | Microsoft 網路/natGateways/聯結/動作 | 加入 NAT 閘道 |
> | Microsoft 網路/natRuleCollections/讀取 | 取得 Azure 防火牆 NatRuleCollection |
> | Microsoft 網路/natRuleCollections/寫入 | CreatesOrUpdates Azure 防火牆 NatRuleCollection |
> | Microsoft 網路/natRuleCollections/刪除 | 刪除 Azure 防火牆 NatRuleCollection |
> | Microsoft 網路/networkExperimentProfiles/讀取 | 取得網際網路分析器設定檔 |
> | Microsoft 網路/networkExperimentProfiles/寫入 | 建立或更新網際網路分析器設定檔 |
> | Microsoft 網路/networkExperimentProfiles/刪除 | 刪除網際網路分析器設定檔 |
> | Microsoft. Network/networkExperimentProfiles/實驗/讀取 | 取得網際網路分析器測試 |
> | Microsoft. Network/networkExperimentProfiles/實驗/寫入 | 建立或更新網際網路分析器測試 |
> | Microsoft 網路/networkExperimentProfiles/實驗/刪除 | 刪除網際網路分析器測試 |
> | Microsoft. Network/networkExperimentProfiles/實驗/時間序列/action | 取得網際網路分析器測試的時間序列 |
> | Microsoft. Network/networkExperimentProfiles/實驗/latencyScorecard/action | 取得網際網路分析器測試的延遲計分卡 |
> | Microsoft. Network/networkExperimentProfiles/preconfiguredEndpoints/read | 取得網際網路分析器設定檔的預先設定端點 |
...
> | Microsoft 網路/networkRuleCollections/讀取 | 取得 Azure 防火牆 NetworkRuleCollection |
> | Microsoft 網路/networkRuleCollections/寫入 | CreatesOrUpdates Azure 防火牆 NetworkRuleCollection |
> | Microsoft 網路/networkRuleCollections/刪除 | 刪除 Azure 防火牆 NetworkRuleCollection |
...
> | NetworkWatchers/flowLogs/write | 建立流量記錄 |
...
> | Microsoft. Network/p2sVpnGateways/disconnectp2svpnconnections/action | 中斷 p2s vpn 連線的連線 |
> | Microsoft 網路/privateDnsOperationResults/讀取 | 取得私人 DNS 操作的結果 |
> | Microsoft 網路/privateDnsOperationStatuses/讀取 | 取得私人 DNS 操作的狀態 |
> | Microsoft 網路/privateDnsZones/讀取 | 取得 JSON 格式的私人 DNS 區域屬性。 請注意，此命令不會抓取私人 DNS 區域所連結的虛擬網路，或是包含在該區域內的記錄集。 |
> | Microsoft 網路/privateDnsZones/寫入 | 建立或更新資源群組內的私人 DNS 區域。 請注意，此命令無法用來建立或更新區域內的虛擬網路連結或記錄集。 |
> | Microsoft 網路/privateDnsZones/刪除 | 刪除私人 DNS 區域。 |
> | Microsoft 網路/privateDnsZones/聯結/動作 | 加入私人 DNS 區域 |
> | Microsoft 網路/privateDnsZones/A/read | 以 JSON 格式取得私人 DNS 區域內 ' A ' 類型的記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft 網路/privateDnsZones/A/write | 在私人 DNS 區域內建立或更新 ' A ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft 網路/privateDnsZones/A/delete | 從私人 DNS 區域中移除指定名稱的記錄集，並輸入 ' A '。 |
> | Microsoft. Network/privateDnsZones/AAAA/read | 以 JSON 格式取得私人 DNS 區域內 ' AAAA ' 類型的記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft 網路/privateDnsZones/AAAA/write | 在私人 DNS 區域內建立或更新 ' AAAA ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft 網路/privateDnsZones/AAAA/delete | 從私人 DNS 區域中移除指定名稱的記錄集，並輸入 ' AAAA '。 |
> | Microsoft 網路/privateDnsZones/全部/讀取 | 取得跨類型的私人 DNS 記錄集 |
> | Microsoft. Network/privateDnsZones/CNAME/read | 在私人 DNS 區域內，以 JSON 格式取得 ' CNAME ' 類型的記錄集。 |
> | Microsoft 網路/privateDnsZones/CNAME/write | 在私人 DNS 區域內建立或更新 ' CNAME ' 類型的記錄集。 |
> | Microsoft 網路/privateDnsZones/CNAME/delete | 從私人 DNS 區域中移除指定名稱的記錄集，並輸入 ' CNAME '。 |
> | Microsoft. Network/privateDnsZones/MX/read | 在私人 DNS 區域內，以 JSON 格式取得 ' MX ' 類型的記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft 網路/privateDnsZones/MX/write | 在私人 DNS 區域內建立或更新 ' MX ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft 網路/privateDnsZones/MX/delete | 從私人 DNS 區域中移除指定名稱和類型 ' MX ' 的記錄集。 |
> | Microsoft 網路/privateDnsZones/PTR/讀取 | 以 JSON 格式取得私人 DNS 區域內 ' PTR ' 類型的記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft 網路/privateDnsZones/PTR/寫入 | 在私人 DNS 區域內建立或更新 ' PTR ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft 網路/privateDnsZones/PTR/刪除 | 從私人 DNS 區域中移除指定名稱和類型 ' PTR ' 的記錄集。 |
> | Microsoft. Network/privateDnsZones/recordset/read | 取得跨類型的私人 DNS 記錄集 |
> | Microsoft. Network/privateDnsZones/SOA/read | 在私人 DNS 區域內，以 JSON 格式取得類型 ' SOA ' 的記錄集。 |
> | Microsoft. Network/privateDnsZones/SOA/write | 在私人 DNS 區域內更新 ' SOA ' 類型的記錄集。 |
> | Microsoft. Network/privateDnsZones/SRV/read | 在私人 DNS 區域內，以 JSON 格式取得 ' SRV ' 類型的記錄集。 記錄集包含記錄清單以及 TTL、標記和 etag。 |
> | Microsoft. Network/privateDnsZones/SRV/write | 在私人 DNS 區域內建立或更新 ' SRV ' 類型的記錄集。 指定的記錄將會取代記錄集內的目前記錄。 |
> | Microsoft. Network/privateDnsZones/SRV/delete | 從私人 DNS 區域中，移除指定名稱和類型 ' SRV ' 的記錄集。 |
...
> | Microsoft 網路/privateDnsZones/TXT/delete | 從私人 DNS 區域中移除指定名稱和類型 ' TXT ' 的記錄集。 |
> | Microsoft. Network/privateDnsZones/virtualNetworkLinks/read | 以 JSON 格式取得虛擬網路屬性的私人 DNS 區域連結。 |
> | PrivateDnsZones/virtualNetworkLinks/write | 建立或更新虛擬網路的私人 DNS 區域連結。 |
> | Microsoft. Network/privateDnsZones/virtualNetworkLinks/delete | 刪除虛擬網路的私人 DNS 區域連結。 |
> | Microsoft 網路/privateEndpointRedirectMaps/讀取 | 取得私用端點 RedirectMap |
> | Microsoft 網路/privateEndpointRedirectMaps/寫入 | 建立私用端點 RedirectMap 或更新現有的私用端點 RedirectMap |
> | Microsoft 網路/privateEndpoints/讀取 | 取得私用端點資源。 |
> | Microsoft 網路/privateEndpoints/寫入 | 建立新的私用端點，或更新現有的私用端點。 |
> | Microsoft 網路/privateEndpoints/刪除 | 刪除私用端點資源。 |
> | Microsoft. Network/privateEndpoints/privateDnsZoneGroups/read | 取得私人 DNS 區域群組 |
> | PrivateEndpoints/privateDnsZoneGroups/write | 放置私人 DNS 區域群組 |
...
> | Microsoft. Network/privateLinkServices/privateEndpointConnections/read | 取得私用端點連接定義。 |
> | PrivateLinkServices/privateEndpointConnections/write | 建立新的私用端點連接，或更新現有的私用端點連線。 |
> | Microsoft. Network/privateLinkServices/privateEndpointConnections/delete | 刪除私用端點連接。 |
...
> | Microsoft 網路/securityPartnerProviders/讀取 | 取得 SecurityPartnerProvider |
> | Microsoft 網路/securityPartnerProviders/寫入 | 建立 SecurityPartnerProvider 或更新現有的 SecurityPartnerProvider |
> | Microsoft 網路/securityPartnerProviders/驗證/動作 | 驗證 SecurityPartnerProvider |
> | Microsoft. Network/securityPartnerProviders/updateReferences/action | 更新 SecurityPartnerProvider 中的參考 |
> | Microsoft 網路/securityPartnerProviders/聯結/動作 | 加入 SecurityPartnerProvider。 不可警示。 |
> | Microsoft 網路/securityPartnerProviders/刪除 | 刪除 SecurityPartnerProvider |
...
> | Microsoft.Network/serviceEndpointPolicies/joinSubnet/action | 將子網加入服務端點原則。 不可警示。 |
...
> | VirtualHubs/hubRouteTables/write | 建立或更新虛擬中樞的路由表子資源 |
...
> | VirtualHubs/routeTables/write | 建立或更新 VirtualHubRouteTableV2 |
...
> | microsoft. network/virtualnetworkgateways/disconnectvirtualnetworkgatewayvpnconnections/action | 中斷虛擬網路閘道 vpn 連線的連線 |
...
> | Microsoft 網路/virtualNetworks/聯結/動作 | 加入虛擬網路。 不可警示。 |
> | Microsoft.Network/virtualNetworks/BastionHosts/action | 取得虛擬網路中的堡壘主機參考。 |
> | Microsoft 網路/virtualNetworks/bastionHosts/預設/動作 | 取得虛擬網路中的堡壘主機參考。 |
...
> | Microsoft 網路/virtualNetworks/子網/unprepareNetworkPolicies/action | 藉由移除已套用的網路原則來 Unprepare 子網 |
> | Microsoft 網路/virtualNetworks/子網/coNtextualServiceEndpointPolicies/read | 取得內容相關服務端點原則 |
> | Microsoft 網路/virtualNetworks/子網/coNtextualServiceEndpointPolicies/write | 建立內容相關服務端點原則，或更新現有的內容服務端點原則 |
> | Microsoft 網路/virtualNetworks/子網/coNtextualServiceEndpointPolicies/delete | 刪除內容相關的服務端點原則 |
...
> | Microsoft.Network/virtualNetworkTaps/join/action | 加入虛擬網路點路。 不可警示。 |
...
> | Microsoft 網路/virtualRouters/讀取 | 取得 VirtualRouter |
> | Microsoft 網路/virtualRouters/寫入 | 建立 VirtualRouter 或更新現有的 VirtualRouter |
> | Microsoft 網路/virtualRouters/刪除 | 刪除 VirtualRouter |
> | Microsoft 網路/virtualRouters/聯結/動作 | 加入 VirtualRouter。 不可警示。 |
> | Microsoft. Network/virtualRouters/對等互連/read | 取得 VirtualRouterPeering |
> | VirtualRouters/對等互連/write | 建立 VirtualRouterPeering 或更新現有的 VirtualRouterPeering |
...
> | microsoft. network/vpngateways/startpacketcapture/action | 依據資源啟動 Vpn 閘道封包捕獲 |
...
> | Microsoft 網路/vpnServerConfigurations/刪除 | 刪除 VpnServerConfiguration |
...
> | Microsoft.classicstorage/storageAccounts/blobServices/provider/Microsoft Insights/diagnosticSettings/read | 取得診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/blobServices/provider/Microsoft Insights/diagnosticSettings/write | 新增或修改診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/blobServices/provider/Microsoft Insights/Metricdefinitions.listasync/read | 取得計量定義。 |
...
> | Microsoft.classicstorage/storageAccounts/fileServices/provider/Microsoft Insights/diagnosticSettings/read | 取得診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/fileServices/provider/Microsoft Insights/diagnosticSettings/write | 新增或修改診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/fileServices/provider/Microsoft Insights/Metricdefinitions.listasync/read | 取得計量定義。 |
...
> | Microsoft.classicstorage/storageAccounts/provider/Microsoft Insights/diagnosticSettings/read | 取得診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/provider/Microsoft Insights/diagnosticSettings/write | 新增或修改診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/provider/Microsoft Insights/Metricdefinitions.listasync/read | 取得計量定義。 |
> | Microsoft.classicstorage/storageAccounts/queueServices/provider/Microsoft Insights/diagnosticSettings/read | 取得診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/queueServices/provider/Microsoft Insights/diagnosticSettings/write | 新增或修改診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/queueServices/provider/Microsoft Insights/Metricdefinitions.listasync/read | 取得計量定義。 |
...
> | Microsoft.classicstorage/storageAccounts/tableServices/provider/Microsoft Insights/diagnosticSettings/read | 取得診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/tableServices/provider/Microsoft Insights/diagnosticSettings/write | 新增或修改診斷設定。 |
> | Microsoft.classicstorage/storageAccounts/tableServices/provider/Microsoft Insights/Metricdefinitions.listasync/read | 取得計量定義。 |
...
> | DataBox/取消註冊/動作 | 取消註冊提供者 Databox |
...
> | DataBox/位置/validateInputs/動作 | 此方法會執行所有類型的驗證。 |
...
> | DataBox/位置/regionConfiguration/動作 | 此方法會傳回區域的設定。 |
> | DataBox/位置/availableSkus/讀取 | 列出或取得可用的 Sku |
> | Microsoft.DataBox/locations/operationResults/read | 列出或取得作業結果 |
> | DataBox/作業/讀取 | 列出或取得作業 |
> | DataBox/訂用帳戶/resourceGroups/moveResources/action | 這個方法會執行資源移動。 |
> | DataBox/訂用帳戶/resourceGroups/validateMoveResources/action | 這個方法會驗證是否允許移動資源。 |
...
> | ImportExport/作業/讀取 | 取得資源提供者所支援的作業。 |
...
> | Microsoft。 NetApp/取消註冊/動作 | 向 Microsoft. NetApp 資源提供者取消註冊訂用帳戶 |
...
> | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/還原/動作 | 將磁片區還原到特定快照集 |
> | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/BreakReplication/action | 中斷磁片區複寫關係 |
> | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/ReplicationStatus/action | 讀取磁片區複寫的狀態。 |
> | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/ReInitializeReplication/action | 嘗試重新初始化未初始化的複寫 |
> | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/AuthorizeReplication/action | 授權來源磁片區複寫 |
> | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/ResyncReplication/action | 重新同步處理目的地磁片區上的複寫 |
> | Microsoft NetApp/netAppAccounts/capacityPools/磁片區/DeleteReplication/action | 刪除目的地磁片區上的複寫 |
...
> | Microsoft NetApp/netAppAccounts/snapshotPolicies/ListVolumes/action | 列出已連線至快照集原則的磁片區 |
> | Microsoft NetApp/netAppAccounts/vault/讀取 | 讀取保存庫資源。 |
...
> | Microsoft. Storage/位置/checknameavailability/read | 確認帳戶名稱有效，且並非使用中。 |
...
> | Microsoft. Storage/storageAccounts/PrivateEndpointConnectionsApproval/action | 核准私人端點連接 |
> | Microsoft. Storage/storageAccounts/容錯移轉/動作 | 客戶能夠在發生可用性問題時控制容錯移轉 |
...
> | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/read | 取得私人端點連接 Proxy |
> | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/delete | 刪除私人端點連接 proxy |
> | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/write | 放置私人端點連接 proxy |
> | Microsoft. Storage/storageAccounts/privateEndpointConnections/read | 列出私人端點連接 |
> | Microsoft. Storage/storageAccounts/privateEndpointConnections/delete | 刪除私人端點連接 |
> | Microsoft. Storage/storageAccounts/privateEndpointConnections/read | 取得私人端點連接 |
> | Microsoft. Storage/storageAccounts/privateEndpointConnections/write | Put 私用端點連接 |
...
> | Microsoft. Storage/storageAccounts/blobServices/container/blob/filter/action | 傳回具有相符標記篩選之帳戶底下的 blob 清單 |
...
> | Microsoft 儲存體/storageAccounts/blobServices/容器/blob/標記/讀取 | 傳回讀取 blob 標記的結果 |
> | Microsoft 儲存體/storageAccounts/blobServices/容器/blob/標記/寫入 | 傳回寫入 blob 標記的結果 |
...
> | Microsoft.Storage/storageAccounts/fileServices/fileshares/files/modifypermissions/action | 傳回檔案/資料夾上修改許可權的結果 |
...
> | 動作 | 描述 |
> | --- | --- |
> | microsoft.storagesync/register/action | 為儲存體同步處理提供者註冊訂用帳戶 |
> | microsoft.storagesync/取消註冊/動作 | 取消註冊儲存體同步處理提供者的訂用帳戶 |
...
> | microsoft.storagesync/作業/讀取 | 取得支援的作業清單 |
...
> | microsoft.storagesync/storageSyncServices/privateLinkResources/read | 讀取任何私人連結資源 |
...
> | microsoft.storagesync/storageSyncServices/syncGroups/cloudEndpoints/triggerChangeDetection/action | 呼叫此動作以在雲端端點的檔案共用上觸發變更的偵測 |
...
> | Microsoft.Maps/accounts/listKeys/action | 列出地圖服務帳戶金鑰。 |
> | Microsoft.Maps/accounts/regenerateKey/action | 產生新的 Maps 帳戶主要或次要金鑰。 |
> | Microsoft.Maps/accounts/eventGridFilters/delete | 刪除事件方格篩選準則。 |
> | Microsoft.Maps/accounts/eventGridFilters/read | 取得事件格線篩選 |
> | Microsoft.Maps/accounts/eventGridFilters/write | 建立或更新事件方格篩選準則。 |
> | Microsoft. Maps/accounts/privateAtlases/write | 建立或更新私人的阿特拉斯。 |
...
> | Microsoft。地圖服務/帳戶/服務/地理位置/讀取 | 允許讀取地理位置服務的資料。 |
> | Microsoft。地圖服務/帳戶/服務/行動/讀取 | 允許讀取行動服務的資料。 |
> | Microsoft。地圖服務/帳戶/服務/轉譯/讀取 | 允許讀取呈現服務的資料。 |
> | Microsoft。地圖服務/帳戶/服務/路由/讀取 | 允許讀取路由服務的資料。 |
> | Microsoft。地圖服務/帳戶/服務/搜尋/讀取 | 允許讀取搜尋服務的資料。 |
> | Microsoft。地圖服務/帳戶/服務/空間/讀取 | 允許讀取空間服務的資料。 |
> | Microsoft。地圖服務/帳戶/服務/空間/寫入 | 允許寫入空間服務的資料，例如事件發佈。 |
> | Microsoft。地圖服務/帳戶/服務/時區/讀取 | 允許讀取時區服務的資料。 |
> | Microsoft。地圖服務/帳戶/服務/流量/讀取 | 允許讀取流量服務的資料。 |
> | Microsoft. Maps/accounts/services/turnbyturn/read | 允許讀取 TurnByTurn 服務的資料。 |
> | Microsoft。地圖/帳戶/服務/天氣/讀取 | 允許讀取天氣服務的資料。 |
...
> | Microsoft Media/windowsazure.mediaservices.extensions/regenerateKey/action | 重新產生媒體服務 ACS 金鑰 |
> | Microsoft Media/windowsazure.mediaservices.extensions/listKeys/action | 列出媒體服務帳戶的 ACS 金鑰 |
> | Microsoft.Media/mediaservices/syncStorageKeys/action | 同步處理已連結之 Azure 儲存體帳戶的儲存體金鑰 |
> | Microsoft Media/windowsazure.mediaservices.extensions/listEdgePolicies/action | 列出 edge 裝置的原則。 |
...
> | Microsoft Media/windowsazure.mediaservices.extensions/Liveevent/privateEndpointConnectionProxies/read | 讀取任何即時事件私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/Liveevent/privateEndpointConnectionProxies/write | 建立即時事件私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/Liveevent/privateEndpointConnectionProxies/delete | 刪除即時事件私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/Liveevent/privateEndpointConnectionProxies/validate/action | 驗證即時事件私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/Liveevent/privateEndpointConnections/read | 讀取任何即時事件私人端點連接 |
> | Microsoft Media/windowsazure.mediaservices.extensions/Liveevent/privateEndpointConnections/write | 建立即時事件私人端點連線 |
> | Microsoft Media/windowsazure.mediaservices.extensions/Liveevent/privateEndpointConnections/delete | 刪除即時事件私人端點連接 |
> | Microsoft Media/windowsazure.mediaservices.extensions/Liveevent/privateLinkResources/read | 讀取任何即時事件私人連結資源 |
> | Microsoft.Media/mediaservices/liveOutputOperations/read | 讀取任何即時輸出作業 |
> | Microsoft. Media/windowsazure.mediaservices.extensions/mediaGraphs/read | 讀取任何 Media Graph |
> | Microsoft Media/windowsazure.mediaservices.extensions/mediaGraphs/write | 建立或更新任何 Media Graph |
> | Microsoft Media/windowsazure.mediaservices.extensions/mediaGraphs/delete | 刪除任何媒體圖形 |
> | Microsoft Media/windowsazure.mediaservices.extensions/mediaGraphs/start/action | 啟動任何 Media Graph 作業 |
> | Microsoft Media/windowsazure.mediaservices.extensions/mediaGraphs/stop/action | 停止任何 Media Graph 作業 |
> | Microsoft. Media/windowsazure.mediaservices.extensions/privateEndpointConnectionOperations/read | 讀取任何私人端點連接作業 |
> | Microsoft. Media/windowsazure.mediaservices.extensions/privateEndpointConnectionProxies/read | 讀取任何私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/privateEndpointConnectionProxies/write | 建立私用端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/privateEndpointConnectionProxies/delete | 刪除私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/privateEndpointConnectionProxies/validate/action | 驗證私用端點連接 Proxy |
> | Microsoft. Media/windowsazure.mediaservices.extensions/privateEndpointConnections/read | 讀取任何私人端點連接 |
> | Microsoft Media/windowsazure.mediaservices.extensions/privateEndpointConnections/write | 建立私人端點連接 |
> | Microsoft Media/windowsazure.mediaservices.extensions/privateEndpointConnections/delete | 刪除私人端點連接 |
> | Microsoft. Media/windowsazure.mediaservices.extensions/privateLinkResources/read | 讀取任何私人連結資源 |
...
> | Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint/privateEndpointConnectionProxies/read | 讀取任何串流端點私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint/privateEndpointConnectionProxies/write | 建立串流端點私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint/privateEndpointConnectionProxies/delete | 刪除串流端點私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint/privateEndpointConnectionProxies/validate/action | 驗證串流端點私人端點連接 Proxy |
> | Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint/privateEndpointConnections/read | 讀取任何串流端點私人端點連線 |
> | Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint/privateEndpointConnections/write | 建立串流端點私人端點連線 |
> | Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint/privateEndpointConnections/delete | 刪除串流端點私人端點連線 |
> | Microsoft Media/windowsazure.mediaservices.extensions/Streamingendpoint/privateLinkResources/read | 讀取任何串流端點私人連結資源 |
...
> | Microsoft. Media/windowsazure.mediaservices.extensions/streamingPrivateEndpointConnectionOperations/read | 讀取任何串流私人端點連接作業 |
> | Microsoft. Media/windowsazure.mediaservices.extensions/streamingPrivateEndpointConnectionProxyOperations/read | 讀取任何串流私用端點連接 Proxy 操作 |
...
> | Microsoft 搜尋/searchServices/listQueryKeys/action | 傳回指定 Azure 搜尋服務的查詢 API 金鑰清單。 |
> | Microsoft.Search/searchServices/createQueryKey/action | 建立查詢金鑰。 |
> | Microsoft.Search/searchServices/deleteQueryKey/delete | 刪除查詢金鑰。 |
> | Microsoft 搜尋/searchServices/privateEndpointConnectionProxies/驗證/動作 | 驗證從 NRP 端的私用端點連接建立呼叫 |
> | SearchServices/privateEndpointConnectionProxies/write | 建立具有指定參數的私用端點連接 proxy，或更新指定之私用端點連接 proxy 的屬性或標記 |
> | Microsoft 搜尋/searchServices/privateEndpointConnectionProxies/read | 傳回私用端點連接 proxy 的清單，或取得指定之私用端點連接 proxy 的屬性。 |
> | Microsoft 搜尋/searchServices/privateEndpointConnectionProxies/delete | 刪除現有的私用端點連接 proxy |
...
> | Microsoft.signalrservice/位置/operationStatuses/operationId/讀取 | 查詢以位置為基礎的非同步作業狀態 |
...
> | Microsoft.signalrservice/作業/讀取 | 列出 Azure SignalR 服務的作業。 |
...
> | Microsoft.signalrservice/SignalR/eventGridFilters/read | 取得指定之事件方格篩選器的屬性，或列出指定之 SignalR 的所有事件方格篩選準則。 |
> | Microsoft.signalrservice/SignalR/eventGridFilters/write | 針對具有指定參數的 SignalR，建立或更新事件方格篩選準則。 |
> | Microsoft.signalrservice/SignalR/eventGridFilters/delete | 從 SignalR 中刪除事件方格篩選準則。 |
> | Microsoft.signalrservice/SignalR/privateEndpointConnectionProxies/validate/action | 驗證私用端點連接 Proxy |
> | Microsoft.signalrservice/SignalR/privateEndpointConnectionProxies/write | 建立私用端點連接 Proxy |
> | Microsoft.signalrservice/SignalR/privateEndpointConnectionProxies/read | 讀取私人端點連接 Proxy |
> | Microsoft.signalrservice/SignalR/privateEndpointConnectionProxies/delete | 刪除私人端點連接 Proxy |
...
> | Microsoft Web/hostingEnvironments/PrivateEndpointConnectionsApproval/action | 核准私人端點連接 |
...
> | Microsoft Web/hostingEnvironments/eventGridFilters/delete | 在主控環境中刪除事件方格篩選。 |
> | Microsoft Web/hostingEnvironments/eventGridFilters/read | 取得裝載環境的事件格線篩選。 |
> | Microsoft Web/hostingEnvironments/eventGridFilters/write | 將事件方格篩選放在主控環境中。 |
...
> | Microsoft Web/serverfarms/eventGridFilters/delete | 刪除伺服器陣列上的事件格線篩選。 |
> | Microsoft Web/serverfarms/eventGridFilters/read | 取得伺服器陣列上的事件格線篩選。 |
...
> | Microsoft Web/sites/PrivateEndpointConnectionsApproval/action | 核准私人端點連接 |
...
> | microsoft.web/sites/syncfunctiontriggers/action | 同步處理函數觸發程式。 |
...
> | Microsoft Web/sites/eventGridFilters/delete | 刪除 web 應用程式上的事件格線篩選。 |
> | Microsoft Web/sites/eventGridFilters/read | 取得 web 應用程式的事件格線篩選。 |
> | Microsoft Web/sites/eventGridFilters/write | 將事件方格篩選放在 web 應用程式上。 |
> | microsoft web/sites/extensions/delete | 刪除 Web Apps 的網站擴充功能。 |
> | microsoft 網站/網站/延伸模組/讀取 | 取得 Web Apps 的網站擴充功能。 |
...
> | microsoft web/sites/函數/listkeys/action | 列出功能鍵。 |
> | microsoft.web/sites/functions/read | 取得 Web Apps 函式。 |
> | microsoft.web/sites/functions/write | 更新 Web Apps 函式。 |
> | microsoft web/sites/函數/金鑰/寫入 | 更新功能鍵。 |
> | microsoft web/sites/函數/金鑰/刪除 | 刪除功能鍵。 |
...
> | microsoft web/sites/host/listkeys/action | 列出函式主機金鑰。 |
> | microsoft 網站/網站/主機/同步處理/動作 | 同步處理函數觸發程式。 |
> | microsoft web/sites/host/listsyncstatus/action | 列出同步處理函數觸發程式狀態。 |
> | microsoft 網站/網站/主機/functionkeys/寫入 | Update 函式主控功能鍵。 |
> | microsoft web/sites/host/functionkeys/delete | Delete 函式主機功能鍵。 |
> | microsoft 網站/網站/主機/systemkeys/寫入 | 更新函式主機系統金鑰。 |
> | microsoft web/sites/host/systemkeys/delete | Delete 函數主機系統金鑰。 |
...
> | microsoft web/sites/networktraces/operationresults/read | 取得 Web Apps 網路追蹤作業結果。 |
...
> | microsoft web/sites/進程/模組/讀取 | 取得 Web Apps 處理模組。 |
...
> | microsoft web/sites/位置/restorefromdeletedapp/動作 | 從已刪除的應用程式還原 Web 應用程式位置。 |
...
> | microsoft web/sites/位置/分機/讀取 | 取得 Web Apps 插槽延伸模組。 |
> | microsoft web/sites/位置/擴充功能/寫入 | 更新 Web Apps 位置延伸模組。 |
> | microsoft web/sites/位置/功能/listkeys/動作 | 列出功能鍵。 |
...
> | microsoft web/sites/位置/功能/金鑰/寫入 | 更新功能鍵。 |
> | microsoft web/sites/位置/功能/金鑰/刪除 | 刪除功能鍵。 |
> | microsoft web/sites/插槽/主機/listkeys/動作 | 列出函式主機金鑰。 |
> | microsoft web/sites/插槽/主機/同步處理/動作 | 同步處理函數觸發程式。 |
> | microsoft web/sites/位置/主機/functionkeys/寫入 | Update 函式主控功能鍵。 |
> | microsoft web/sites/位置/主機/functionkeys/刪除 | Delete 函式主機功能鍵。 |
> | microsoft web/sites/位置/主機/systemkeys/寫入 | 更新函式主機系統金鑰。 |
> | microsoft web/sites/位置/主機/systemkeys/刪除 | Delete 函數主機系統金鑰。 |
...
> | microsoft web/sites/位置/networktraces/operationresults/read | 取得 Web Apps 位置的網路追蹤操作結果。 |
...
> | Microsoft Web/staticSites/Write | 建立新的靜態網站或更新現有的 |
> | Microsoft Web/staticSites/Delete | 刪除現有的靜態網站 |
> | Microsoft Web/staticSites/createinvitation/action | 為一組角色的靜態網站使用者建立 invitiation 連結 |
> | Microsoft Web/staticSites/listfunctionappsettings/Action | 列出靜態網站的函數應用程式設定 |
> | Microsoft Web/staticSites/卸離/動作 | 從目前連結的存放庫卸離靜態網站 |
> | Microsoft Web/staticSites/getuser/Action | 取得靜態網站的使用者資訊 |
...
> | Microsoft Web/staticSites/build/listfunctionappsettings/Action | 列出靜態網站組建的函數應用程式設定 |
> | Microsoft Web/staticSites/build/config/Write | 建立或更新靜態網站組建的函數應用程式設定 |
> | Microsoft Web/staticSites/config/Write | 建立或更新靜態網站的函數應用程式設定 |
...
> | Microsoft Web/staticSites/customdomains/validate/Action | 驗證自訂網域可新增至靜態網站 |
> | Microsoft Web/staticSites/函數/讀取 | 列出靜態網站的函式 |
...
> | Microsoft.containerinstance/containerGroups/容器/buildlogs/read | 取得特定容器的組建記錄檔。 |
...
> | Microsoft.containerinstance/作業/讀取 | 列出 Azure 容器實例服務的作業。 |
...
> | ContainerRegistry/registry/generateCredentials/action | 為指定容器登錄的權杖產生金鑰。 |
...
> | ContainerRegistry/registry/agentpools/listQueueStatus/action | 列出容器登錄之 agentpool 的所有佇列狀態。 |
...
> | ContainerRegistry/登錄/中繼資料/讀取 | 取得容器登錄之特定存放庫的中繼資料 |
> | ContainerRegistry/登錄/中繼資料/寫入 | 更新容器登錄庫的中繼資料 |
> | Microsoft.ContainerRegistry/registries/operationStatuses/read | 取得登錄非同步作業狀態 |
> | ContainerRegistry/registry/privateEndpointConnectionProxies/validate/action | 驗證私用端點連接 Proxy （僅限 NRP） |
> | ContainerRegistry/registry/privateEndpointConnectionProxies/read | 取得私人端點連接 Proxy （僅限 NRP） |
> | ContainerRegistry/registry/privateEndpointConnectionProxies/write | 建立私用端點連接 Proxy （僅限 NRP） |
> | ContainerRegistry/registry/privateEndpointConnectionProxies/delete | 刪除私人端點連接 Proxy （僅限 NRP） |
> | ContainerRegistry/registry/privateEndpointConnectionProxies/operationStatuses/read | 取得私用端點連接 Proxy 非同步作業狀態 |
...
> | ContainerRegistry/registry/scopeMaps/read | 取得指定之範圍對應的屬性，或列出指定容器登錄的所有範圍對應。 |
> | ContainerRegistry/registry/scopeMaps/write | 使用指定的參數，建立或更新容器登錄的範圍對應。 |
> | ContainerRegistry/registry/scopeMaps/delete | 從容器登錄中刪除範圍對應。 |
> | ContainerRegistry/registry/scopeMaps/operationStatuses/read | 取得範圍對應非同步作業狀態。 |
> | Microsoft.ContainerRegistry/registries/sign/write | 推送/提取容器登錄的內容信任中繼資料。 |
> | ContainerRegistry/registry/taskruns/listDetails/action | 列出容器登錄之/tr u n 的所有詳細資料。 |
...
> | ContainerRegistry/登錄/權杖/讀取 | 取得指定之權杖的屬性，或列出指定容器登錄的所有權杖。 |
> | ContainerRegistry/登錄/權杖/寫入 | 使用指定的參數，建立或更新容器登錄的權杖。 |
> | ContainerRegistry/registry/token/delete | 從容器登錄中刪除權杖。 |
> | ContainerRegistry/registry/token/operationStatuses/read | 取得權杖非同步作業狀態。 |
...
> | Microsoft.containerservice/managedClusters/privateEndpointConnectionsApproval/action | 決定是否允許使用者核准私用端點連接 |
...
> | Microsoft.containerservice/managedClusters/agentPools/write | 建立新的代理程式組件區，或更新現有的 |
...
> | Microsoft.containerservice/managedClusters/availableAgentPoolVersions/read | 取得叢集的可用代理程式組件區版本 |
...
> | Microsoft.containerservice/managedClusters/privateEndpointConnections/read | 取得私人端點連接 |
> | Microsoft.containerservice/managedClusters/privateEndpointConnections/write | 核准或拒絕私人端點連接 |
> | Microsoft.containerservice/managedClusters/privateEndpointConnections/delete | 刪除私人端點連接 |
> | Microsoft.containerservice/managedClusters/upgradeProfiles/read | 取得叢集的升級設定檔 |
> | Microsoft.ContainerService/openShiftClusters/read | 取得開啟的轉移叢集 |
> | Microsoft.ContainerService/openShiftClusters/write | 建立新的或更新現有的 Open Shift 叢集 |
> | Microsoft.ContainerService/openShiftClusters/delete | 刪除開啟的轉移叢集 |
> | Microsoft.ContainerService/openShiftManagedClusters/read | 取得 Open Shift 受控叢集 |
...
> | Microsoft.containerservice/managedClusters/api/讀取 | 讀取 api |
...
> | Microsoft.containerservice/managedClusters/api/admissionregistration. io/v1/read | 讀取 admissionregistration.k8s.io/v1 |
...
> | Microsoft.containerservice/managedClusters/api/apiextensions. io/v1/read | 讀取 apiextensions.k8s.io/v1 |
...
> | Microsoft.containerservice/managedClusters/api/apiregistration. io/v1/read | 讀取 apiregistration.k8s.io/v1 |
> | Microsoft.containerservice/managedClusters/api/apiregistration. k8s io/v1Beta1/read | 讀取 apiregistration.k8s.io/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/應用程式/讀取 | 讀取應用程式 |
...
> | Microsoft.containerservice/managedClusters/api/authentication。 k8s/v1/read | 讀取 authentication.k8s.io/v1 |
...
> | Microsoft.containerservice/managedClusters/api/自動調整/v1/讀取 | 讀取自動調整/v1 |
> | Microsoft.containerservice/managedClusters/api/自動調整/v2Beta1/讀取 | 讀取自動調整/v2Beta1 |
> | Microsoft.containerservice/managedClusters/api/自動調整/v2Beta2/讀取 | 讀取自動調整/v2Beta2 |
> | Microsoft.containerservice/managedClusters/api/批次/讀取 | 讀取批次 |
> | Microsoft.containerservice/managedClusters/api/批次/v1/讀取 | 讀取批次/v1 |
...
> | Microsoft.containerservice/managedClusters/api/協調 k8s。 io/v1/讀取 | 讀取協調/v1 |
...
> | Microsoft.containerservice/managedClusters/api/k8s. io/v1Beta1/read | 讀取 events.k8s.io/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/擴充功能/讀取 | 讀取延伸模組 |
> | Microsoft.containerservice/managedClusters/api/extensions/v1Beta1/read | 讀取延伸模組/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/計量 k8s。 io/read | 讀取 metrics.k8s.io |
> | Microsoft.containerservice/managedClusters/api/k8s. io/v1Beta1/read | 讀取 metrics.k8s.io/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/網路 k8s。 io/read | 讀取 networking.k8s.io |
> | Microsoft.containerservice/managedClusters/api/網路 k8s。 io/v1/讀取 | 讀取網路/v1 |
> | Microsoft.containerservice/managedClusters/api/網路 k8s。 io/v1Beta1/read | 讀取 networking.k8s.io/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/node k8s。 io/read | 讀取 node.k8s.io |
> | Microsoft.containerservice/managedClusters/api/k8s. io/v1Beta1/read | 讀取 node.k8s.io/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/原則/讀取 | 讀取原則 |
> | Microsoft.containerservice/managedClusters/api/原則/v1Beta1/read | 讀取原則/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/rbac k8s. io/read | 讀取 rbac.authorization.k8s.io |
> | Microsoft.containerservice/managedClusters/api/rbac. k8s. io/v1/read | 讀取 rbac. authorization/v1 |
> | Microsoft.containerservice/managedClusters/api/rbac k8s. io/v1Beta1/read | 讀取 rbac.authorization.k8s.io/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/排程. k8s io/read | 讀取 scheduling.k8s.io |
> | Microsoft.containerservice/managedClusters/api/排程。 k8s/v1/讀取 | 讀取排程/v1 |
> | Microsoft.containerservice/managedClusters/api/排程. k8s io/v1Beta1/read | 讀取 scheduling.k8s.io/v1Beta1 |
> | Microsoft.containerservice/managedClusters/api/k8s. io/read | 讀取 storage.k8s.io |
> | Microsoft.containerservice/managedClusters/api/k8s. io/v1/read | 讀取儲存體/v1 |
> | Microsoft.containerservice/managedClusters/api/k8s. io/v1Beta1/read | 讀取 storage.k8s.io/v1Beta1 |
...
> | Microsoft.containerservice/managedClusters/apps/replicasets/read | 讀取 replicasets |
> | Microsoft.containerservice/managedClusters/apps/replicasets/write | 寫入 replicasets |
> | Microsoft.containerservice/managedClusters/apps/replicasets/delete | 刪除 replicasets |
...
> | Microsoft.containerservice/managedClusters/authentication. k8s. io/userextras/模擬/動作 | 模擬 userextras |
...
> | Microsoft.containerservice/managedClusters/自動調整/horizontalpodautoscalers/讀取 | 讀取 horizontalpodautoscalers |
> | Microsoft.containerservice/managedClusters/自動調整/horizontalpodautoscalers/寫入 | 寫入 horizontalpodautoscalers |
...
> | Microsoft.containerservice/managedClusters/批次/作業/讀取 | 讀取作業 |
> | Microsoft.containerservice/managedClusters/批次/作業/寫入 | 寫入作業 |
> | Microsoft.containerservice/managedClusters/批次/作業/刪除 | 刪除作業 |
...
> | Microsoft.containerservice/managedClusters/k8s io/租用/讀取 | 讀取租用 |
> | Microsoft.containerservice/managedClusters/k8s io/租用/寫入 | 寫入租用 |
> | Microsoft.containerservice/managedClusters/k8s io/租用/刪除 | 刪除租用 |
...
> | Microsoft.containerservice/managedClusters/k8s。 io/events/read | 讀取事件 |
> | Microsoft.containerservice/managedClusters/k8s。 io/events/write | 寫入事件 |
> | Microsoft.containerservice/managedClusters/k8s io/events/delete | 刪除事件 |
...
> | Microsoft.containerservice/managedClusters/extensions/會輸入/read | 讀取會輸入 |
> | Microsoft.containerservice/managedClusters/extensions/會輸入/write | 寫入會輸入 |
> | Microsoft.containerservice/managedClusters/extensions/會輸入/delete | 刪除會輸入 |
...
> | Microsoft.containerservice/managedClusters/extensions/replicasets/read | 讀取 replicasets |
> | Microsoft.containerservice/managedClusters/extensions/replicasets/write | 寫入 replicasets |
> | Microsoft.containerservice/managedClusters/extensions/replicasets/delete | 刪除 replicasets |
...
> | Microsoft.containerservice/managedClusters/healthz/poststarthook/apiservice-註冊-控制器/讀取 | 讀取 apiservice-註冊控制器 |
> | Microsoft.containerservice/managedClusters/healthz/poststarthook/apiservice-status-可用-控制器/讀取 | 讀取 apiservice-狀態-可用-控制器 |
...
> | Microsoft.containerservice/managedClusters/healthz/poststarthook/.crd-informer-已同步/已讀取 | 讀取 .crd-informer-已同步 |
> | Microsoft.containerservice/managedClusters/healthz/poststarthook/generic-kube-apiserver-start-洩密者/read | 讀取一般-kube-apiserver-start-洩密者 |
> | Microsoft.containerservice/managedClusters/healthz/poststarthook/kube-kube-apiserver-自動註冊/read | 讀取 kube-kube-apiserver-自動註冊 |
> | Microsoft.containerservice/managedClusters/healthz/poststarthook/rbac/啟動程式-角色/讀取 | 讀取啟動程式-角色 |
> | Microsoft.containerservice/managedClusters/healthz/poststarthook/排程/啟動程式-系統優先順序-類別/讀取 | 讀取啟動程式-系統優先順序類別 |
...
> | Microsoft.containerservice/managedClusters/healthz/poststarthook/start-kube-kube-apiserver-「許可-初始化運算式/讀取」 | 讀取開始-kube-kube-apiserver-型式-初始化運算式 |
...
> | Microsoft.containerservice/managedClusters/livez/poststarthook/apiservice-註冊-控制器/讀取 | 讀取 apiservice-註冊控制器 |
> | Microsoft.containerservice/managedClusters/livez/poststarthook/apiservice-status-可用-控制器/讀取 | 讀取 apiservice-狀態-可用-控制器 |
...
> | Microsoft.containerservice/managedClusters/livez/poststarthook/.crd-informer-已同步/已讀取 | 讀取 .crd-informer-已同步 |
> | Microsoft.containerservice/managedClusters/livez/poststarthook/generic-kube-apiserver-start-洩密者/read | 讀取一般-kube-apiserver-start-洩密者 |
> | Microsoft.containerservice/managedClusters/livez/poststarthook/kube-kube-apiserver-自動註冊/read | 讀取 kube-kube-apiserver-自動註冊 |
> | Microsoft.containerservice/managedClusters/livez/poststarthook/rbac/啟動程式-角色/讀取 | 讀取啟動程式-角色 |
> | Microsoft.containerservice/managedClusters/livez/poststarthook/排程/啟動程式-系統優先順序-類別/讀取 | 讀取啟動程式-系統優先順序類別 |
...
> | Microsoft.containerservice/managedClusters/livez/poststarthook/start-kube-kube-apiserver-「許可-初始化運算式/讀取」 | 讀取開始-kube-kube-apiserver-型式-初始化運算式 |
> | Microsoft.containerservice/managedClusters/logs/read | 讀取記錄 |
> | Microsoft.containerservice/managedClusters/計量/讀取 | 讀取計量 |
> | Microsoft.containerservice/managedClusters/計量 k8s。 io/節點/讀取 | 讀取節點 |
> | Microsoft.containerservice/managedClusters/計量 k8s。 io/pod/讀取 | 讀取 pod |
...
> | Microsoft.containerservice/managedClusters/網路 k8s。 io/會輸入/read | 讀取會輸入 |
> | Microsoft.containerservice/managedClusters/網路 k8s。 io/會輸入/write | 寫入會輸入 |
> | Microsoft.containerservice/managedClusters/網路 k8s。 io/會輸入/delete | 刪除會輸入 |
...
> | Microsoft.containerservice/managedClusters/pod/讀取 | 讀取 pod |
...
> | Microsoft.containerservice/managedClusters/policy/podsecuritypolicies/use/action | 在 podsecuritypolicies 上使用動作 |
...
> | Microsoft.containerservice/managedClusters/rbac k8s。 io/clusterroles/呈報/動作 | 呈報 |
...
> | Microsoft.containerservice/managedClusters/rbac/k8s. io/roles/read | 讀取角色 |
> | Microsoft.containerservice/managedClusters/rbac/k8s. io/roles/write | 寫入角色 |
> | Microsoft.containerservice/managedClusters/rbac/k8s. io/roles/delete | 刪除角色 |
> | Microsoft.containerservice/managedClusters/rbac/k8s. io/roles/bind/action | 系結角色 |
...
> | Microsoft.containerservice/managedClusters/readyz/poststarthook/apiservice-註冊-控制器/讀取 | 讀取 apiservice-註冊控制器 |
> | Microsoft.containerservice/managedClusters/readyz/poststarthook/apiservice-status-可用-控制器/讀取 | 讀取 apiservice-狀態-可用-控制器 |
...
> | Microsoft.containerservice/managedClusters/readyz/poststarthook/.crd-informer-已同步/已讀取 | 讀取 .crd-informer-已同步 |
> | Microsoft.containerservice/managedClusters/readyz/poststarthook/generic-kube-apiserver-start-洩密者/read | 讀取一般-kube-apiserver-start-洩密者 |
> | Microsoft.containerservice/managedClusters/readyz/poststarthook/kube-kube-apiserver-自動註冊/read | 讀取 kube-kube-apiserver-自動註冊 |
> | Microsoft.containerservice/managedClusters/readyz/poststarthook/rbac/啟動程式-角色/讀取 | 讀取啟動程式-角色 |
> | Microsoft.containerservice/managedClusters/readyz/poststarthook/排程/啟動程式-系統優先順序-類別/讀取 | 讀取啟動程式-系統優先順序類別 |
...
> | Microsoft.containerservice/managedClusters/readyz/poststarthook/start-kube-kube-apiserver-「許可-初始化運算式/讀取」 | 讀取開始-kube-kube-apiserver-型式-初始化運算式 |
> | Microsoft.containerservice/managedClusters/readyz/shutdown/read | 讀取關閉 |
...
> | Microsoft.containerservice/managedClusters/swagger-api/讀取 | 讀取 swagger-api |
> | Microsoft.containerservice/managedClusters/swagger-ui/讀取 | 讀取 swagger-ui |
> | Microsoft.containerservice/managedClusters/ui/read | 讀取 ui |
...
> | DevSpaces/位置/checkContainerHostMapping/動作 | 檢查容器主機的現有控制器對應 |
> | DevSpaces/位置/checkContainerHostMapping/讀取 | 檢查容器主機的現有控制器對應 |
> | DevSpaces/位置/operationresults/讀取 | 讀取非同步作業的結果 |
> | DevSpaces/作業/讀取 | 列出 Microsoft Dev Spaces 資源提供者的所有支援作業 |
...
> | Microsoft. Cache/位置/asyncOperations/讀取 | 列出 'Microsoft.Cache' 提供者支援的作業。 |
...
> | Redis/eventGridFilters/read | 取得 Redis 快取事件方格篩選 |
> | Redis/eventGridFilters/write | 更新 Redis 快取事件方格篩選 |
> | Redis/eventGridFilters/delete | 刪除 Redis 快取事件方格篩選 |
...
> | Redis/privateEndpointConnectionProxies/validate/action | 驗證私用端點連接 proxy |
> | Redis/privateEndpointConnectionProxies/read | 取得私人端點連接 proxy |
> | Redis/privateEndpointConnectionProxies/write | 建立私用端點連接 proxy |
> | Redis/privateEndpointConnectionProxies/delete | 刪除私人端點連接 proxy |
> | Redis/privateEndpointConnections/read | 讀取私人端點連接 |
> | Redis/privateEndpointConnections/write | 撰寫私人端點連接 |
> | Redis/privateEndpointConnections/delete | 刪除私人端點連接 |
> | Redis/privateLinkResources/read | 讀取私人連結可連接的 redis subresource 的 ' groupId ' |
> | RedisEnterprise/provider/Microsoft. Insights/Metricdefinitions.listasync/read | 取得 Redis Enterprise 快取的可用計量 |
...
> | DataFactory/factory/createdataflowdebugsession/action | 建立資料流程的「資料流程」（debug）會話。 |
> | DataFactory/factory/startdataflowdebugsession/action | 啟動資料流程的「資料流程」（debug）會話。 |
> | DataFactory/factory/addDataFlowToDebugSession/action | 將資料流程新增至用於預覽的 debug 會話。 |
> | DataFactory/factory/executeDataFlowDebugCommand/action | 執行資料流程的調試命令。 |
> | DataFactory/factory/deletedataflowdebugsession/action | 刪除資料流程的「資料流程」（debug）會話。 |
> | DataFactory/factory/querydataflowdebugsessions/action | 查詢資料流程的「資料流程」（debug）會話。 |
> | Microsoft.DataFactory/factories/cancelpipelinerun/action | 取消執行識別碼所指定的管線執行。 |
> | DataFactory/factory/cancelSandboxPipelineRun/action | 取消管線的偵錯工具執行。 |
> | DataFactory/factory/sandboxpipelineruns/action | 查詢偵錯管線執行。 |
> | DataFactory/factory/querytriggers/action | 查詢觸發程式。 |
> | DataFactory/factory/getFeatureValue/action | 取得特定位置的暴露風險控制特徵值。 |
> | DataFactory/factory/getDataPlaneAccess/action | 取得 ADF DataPlane 服務的存取權。 |
...
> | DataFactory/factory/debugpipelineruns/取消/動作 | 取消管線的偵錯工具執行。 |
...
> | Microsoft.DataFactory/factories/integrationruntimes/getconnectioninfo/read | 讀取 Integration Runtime 連線資訊。 |
> | Microsoft.DataFactory/factories/integrationruntimes/getstatus/read | 讀取 Integration Runtime 狀態。 |
> | Microsoft.DataFactory/factories/integrationruntimes/listauthkeys/read | 列出任何 Integration Runtime 的驗證金鑰。 |
...
> | DataFactory/factory/管線/沙箱/動作 | 建立管線的「偵錯工具」執行環境。 |
...
> | DataFactory/factory/管線/沙箱/建立/動作 | 建立管線的「偵錯工具」執行環境。 |
> | DataFactory/factory/管線/沙箱/執行/動作 | 建立管線的偵錯工具執行。 |
> | DataFactory/factory/privateEndpointConnectionProxies/read | 讀取私人端點連接 Proxy。 |
> | DataFactory/factory/privateEndpointConnectionProxies/write | 建立或更新私人端點連接 Proxy。 |
> | DataFactory/factory/privateEndpointConnectionProxies/delete | 刪除私人端點連接 Proxy。 |
> | DataFactory/factory/privateEndpointConnectionProxies/驗證/動作 | 驗證私用端點連接 Proxy。 |
> | DataFactory/factory/privateEndpointConnectionProxies/operationresults/read | 讀取建立私用端點連接 Proxy 的結果。 |
> | DataFactory/factory/privateEndpointConnectionProxies/operationstatuses/read | 讀取建立私人端點連接 Proxy 的狀態。 |
...
> | DataFactory/factory/觸發程式/subscribetoevents/action | 訂閱事件。 |
> | DataFactory/factory/觸發程式/geteventsubscriptionstatus/action | 事件訂閱狀態。 |
> | DataFactory/factory/觸發程式/unsubscribefromevents/action | 取消訂閱事件。 |
...
> | Microsoft.datamigration/services/addWorker/action | 將 DMS 背景工作角色新增至服務的可用背景工作角色 |
...
> | Microsoft.datamigration/services/getHybridDownloadLink/action | 從 RP Blob 儲存體取得 DMS 背景工作角色套件下載連結。 |
...
> | Microsoft.datamigration/services/serviceTasks/取消/動作 | 取消目前正在執行的工作 |
...
> | 動作 | 描述 |
> | --- | --- |
> | DBforMariaDB/register/action | 註冊適用于 mariadb 資源提供者 |
...
> | DBforMariaDB/位置/operationResults/讀取 | 傳回以 ResourceGroup 為基礎的適用于 mariadb 伺服器作業結果 |
...
> | DBforMariaDB/位置/privateEndpointConnectionAzureAsyncOperation/讀取 | 取得私用端點連接作業的結果 |
> | DBforMariaDB/位置/privateEndpointConnectionOperationResults/讀取 | 取得私用端點連接作業的結果 |
> | DBforMariaDB/位置/privateEndpointConnectionProxyAzureAsyncOperation/讀取 | 取得私用端點連接 proxy 作業的結果 |
> | DBforMariaDB/位置/privateEndpointConnectionProxyOperationResults/讀取 | 取得私用端點連接 proxy 作業的結果 |
...
> | DBforMariaDB/作業/讀取 | 傳回適用于 mariadb 作業的清單。 |
...
> | DBforMariaDB/servers/顧問/recommendedActions/read | 傳回建議的動作清單 |
> | DBforMariaDB/servers/顧問/recommendedActions/read | 傳回建議的動作 |
...
> | DBforMariaDB/servers/資料庫/讀取 | 傳回適用于 mariadb 資料庫的清單，或取得指定之資料庫的屬性。 |
> | DBforMariaDB/servers/資料庫/寫入 | 使用指定的參數建立適用于 mariadb 資料庫，或更新指定之資料庫的屬性。 |
> | DBforMariaDB/伺服器/資料庫/刪除 | 刪除現有的適用于 mariadb 資料庫。 |
...
> | DBforMariaDB/servers/privateEndpointConnectionProxies/validate/action | 驗證從 NRP 端的私用端點連接建立呼叫 |
> | DBforMariaDB/servers/privateEndpointConnectionProxies/read | 傳回私用端點連接 proxy 的清單，或取得指定之私用端點連接 proxy 的屬性。 |
> | DBforMariaDB/servers/privateEndpointConnectionProxies/write | 使用指定的參數建立私用端點連接 proxy，或更新指定之私用端點連接 proxy 的屬性或標記。 |
> | DBforMariaDB/servers/privateEndpointConnectionProxies/delete | 刪除現有的私用端點連接 proxy |
> | DBforMariaDB/servers/privateEndpointConnections/read | 傳回私用端點連接的清單，或取得指定之私用端點連接的屬性。 |
> | DBforMariaDB/servers/privateEndpointConnections/delete | 刪除現有的私用端點連接 |
> | DBforMariaDB/servers/privateEndpointConnections/write | 核准或拒絕現有的私用端點連接 |
...
> | DBforMariaDB/servers/複本/讀取 | 取得適用于 mariadb 伺服器的讀取複本 |
...
> | Microsoft.DBforMariaDB/servers/securityAlertPolicies/read | 抓取為指定伺服器設定的伺服器威脅偵測原則清單 |
...
> | 動作 | 描述 |
> | --- | --- |
> | Microsoft.dbformysql/register/action | 註冊 MySQL 資源提供者 |
> | Microsoft.dbformysql/checkNameAvailability/action | 確認指定的伺服器名稱是否可用來針對指定的訂用帳戶進行全球佈建。 |
> | Microsoft.dbformysql/位置/administratorAzureAsyncOperation/讀取 | 取得 MySQL server 系統管理員的進行中作業 |
> | Microsoft.dbformysql/位置/administratorOperationResults/讀取 | 傳回 MySQL Server 系統管理員操作結果 |
...
> | Microsoft.dbformysql/位置/privateEndpointConnectionAzureAsyncOperation/讀取 | 取得私用端點連接作業的結果 |
> | Microsoft.dbformysql/位置/privateEndpointConnectionOperationResults/讀取 | 取得私用端點連接作業的結果 |
> | Microsoft.dbformysql/位置/privateEndpointConnectionProxyAzureAsyncOperation/讀取 | 取得私用端點連接 proxy 作業的結果 |
> | Microsoft.dbformysql/位置/privateEndpointConnectionProxyOperationResults/讀取 | 取得私用端點連接 proxy 作業的結果 |
...
> | Microsoft.dbformysql/伺服器/重新開機/動作 | 重新開機特定的伺服器。 |
> | Microsoft.DBforMySQL/servers/updateConfigurations/action | 更新指定伺服器的組態 |
> | Microsoft.dbformysql/伺服器/系統管理員/讀取 | 取得 MySQL server 系統管理員的清單。 |
> | Microsoft.dbformysql/servers/administrator/write | 使用指定的參數建立或更新 MySQL server 系統管理員。 |
> | Microsoft.dbformysql/伺服器/系統管理員/刪除 | 刪除現有的 MySQL server 系統管理員。 |
> | Microsoft.dbformysql/servers/顧問/read | 傳回建議程式清單 |
> | Microsoft.dbformysql/servers/顧問/read | 傳回 advisor |
...
> | Microsoft.dbformysql/servers/顧問/recommendedActions/read | 傳回建議的動作清單 |
> | Microsoft.dbformysql/servers/顧問/recommendedActions/read | 傳回建議的動作 |
...
> | Microsoft.dbformysql/servers/資料庫/讀取 | 傳回 MySQL 資料庫的清單，或取得指定之資料庫的屬性。 |
> | Microsoft.dbformysql/servers/資料庫/寫入 | 使用指定的參數建立 MySQL 資料庫，或更新指定之資料庫的屬性。 |
> | Microsoft.dbformysql/伺服器/資料庫/刪除 | 刪除現有的 MySQL 資料庫。 |
...
> | Microsoft.dbformysql/servers/記錄檔/讀取 | 傳回 MySQL 記錄檔的清單。 |
> | Microsoft.dbformysql/servers/privateEndpointConnectionProxies/validate/action | 驗證從 NRP 端的私用端點連接建立呼叫 |
> | Microsoft.dbformysql/servers/privateEndpointConnectionProxies/read | 傳回私用端點連接 proxy 的清單，或取得指定之私用端點連接 proxy 的屬性。 |
> | Microsoft.dbformysql/servers/privateEndpointConnectionProxies/write | 使用指定的參數建立私用端點連接 proxy，或更新指定之私用端點連接 proxy 的屬性或標記。 |
> | Microsoft.dbformysql/servers/privateEndpointConnectionProxies/delete | 刪除現有的私用端點連接 proxy |
> | Microsoft.dbformysql/servers/privateEndpointConnections/read | 傳回私用端點連接的清單，或取得指定之私用端點連接的屬性。 |
> | Microsoft.dbformysql/servers/privateEndpointConnections/delete | 刪除現有的私用端點連接 |
> | Microsoft.dbformysql/servers/privateEndpointConnections/write | 核准或拒絕現有的私用端點連接 |
...
> | Microsoft.dbformysql/servers/複本/讀取 | 取得 MySQL 伺服器的讀取複本 |
...
> | Microsoft.DBforMySQL/servers/securityAlertPolicies/read | 抓取為指定伺服器設定的伺服器威脅偵測原則清單 |
...
> | 動作 | 描述 |
> | --- | --- |
> | DBforPostgreSQL/register/action | 註冊于 postgresql 資源提供者 |
...
> | DBforPostgreSQL/位置/operationResults/讀取 | 傳回以 ResourceGroup 為基礎的于 postgresql 伺服器作業結果 |
...
> | DBforPostgreSQL/位置/privateEndpointConnectionAzureAsyncOperation/讀取 | 取得私用端點連接作業的結果 |
> | DBforPostgreSQL/位置/privateEndpointConnectionOperationResults/讀取 | 取得私用端點連接作業的結果 |
> | DBforPostgreSQL/位置/privateEndpointConnectionProxyAzureAsyncOperation/讀取 | 取得私用端點連接 proxy 作業的結果 |
> | DBforPostgreSQL/位置/privateEndpointConnectionProxyOperationResults/讀取 | 取得私用端點連接 proxy 作業的結果 |
...
> | DBforPostgreSQL/作業/讀取 | 傳回于 postgresql 作業的清單。 |
...
> | DBforPostgreSQL/servers/資料庫/讀取 | 傳回于 postgresql 資料庫的清單，或取得指定之資料庫的屬性。 |
> | DBforPostgreSQL/servers/資料庫/寫入 | 使用指定的參數建立于 postgresql 資料庫，或更新指定之資料庫的屬性。 |
> | DBforPostgreSQL/伺服器/資料庫/刪除 | 刪除現有的于 postgresql 資料庫。 |
...
> | DBforPostgreSQL/servers/privateEndpointConnectionProxies/validate/action | 驗證從 NRP 端的私用端點連接建立呼叫 |
> | DBforPostgreSQL/servers/privateEndpointConnectionProxies/read | 傳回私用端點連接 proxy 的清單，或取得指定之私用端點連接 proxy 的屬性。 |
> | DBforPostgreSQL/servers/privateEndpointConnectionProxies/write | 使用指定的參數建立私用端點連接 proxy，或更新指定之私用端點連接 proxy 的屬性或標記。 |
> | DBforPostgreSQL/servers/privateEndpointConnectionProxies/delete | 刪除現有的私用端點連接 proxy |
> | DBforPostgreSQL/servers/privateEndpointConnections/read | 傳回私用端點連接的清單，或取得指定之私用端點連接的屬性。 |
> | DBforPostgreSQL/servers/privateEndpointConnections/delete | 刪除現有的私用端點連接 |
> | DBforPostgreSQL/servers/privateEndpointConnections/write | 核准或拒絕現有的私用端點連接 |
...
> | DBforPostgreSQL/servers/複本/讀取 | 取得于 postgresql 伺服器的讀取複本 |
...
> | DBforPostgreSQL/serversv2/provider/Microsoft Insights/diagnosticSettings/read | 取得資源的診斷設定 |
> | DBforPostgreSQL/serversv2/provider/Microsoft Insights/diagnosticSettings/write | 建立或更新資源的診斷設定 |
> | DBforPostgreSQL/serversv2/provider/Microsoft Insights/logDefinitions/read | 取得于 postgresql 伺服器的可用記錄 |
> | DBforPostgreSQL/serversv2/provider/Microsoft Insights/Metricdefinitions.listasync/read | 傳回可供資料庫使用之計量的類型 |
...
> | DBforPostgreSQL/singleservers/provider/Microsoft Insights/diagnosticSettings/read | 取得資源的診斷設定 |
> | DBforPostgreSQL/singleservers/provider/Microsoft Insights/diagnosticSettings/write | 建立或更新資源的診斷設定 |
> | DBforPostgreSQL/singleservers/provider/Microsoft Insights/logDefinitions/read | 取得于 postgresql 伺服器的可用記錄 |
> | DBforPostgreSQL/singleservers/provider/Microsoft Insights/Metricdefinitions.listasync/read | 傳回可供資料庫使用之計量的類型 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/集合/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' mongodb '。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/集合/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新集合輸送量。 僅適用于 API 類型： ' mongodb '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/集合/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取集合輸送量。 僅適用于 API 類型： ' mongodb '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/集合/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' mongodb '。 僅適用于設定類型： [輸送量]。 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/容器/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' sql '。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/容器/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新容器輸送量。 僅適用于 API 類型： ' sql '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/容器/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取容器輸送量。 僅適用于 API 類型： ' sql '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/容器/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' sql '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/圖形/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立或更新圖形。 僅適用于 API 類型： ' gremlin'。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/圖表/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取圖形或列出所有圖表。 僅適用于 API 類型： ' gremlin'。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/圖形/刪除 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除圖形。 僅適用于 API 類型： ' gremlin'。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/圖形/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' gremlin'。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/圖形/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新圖形輸送量。 僅適用于 API 類型： ' gremlin'。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/圖形/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取圖形輸送量。 僅適用于 API 類型： ' gremlin'。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/圖形/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' gremlin'。 僅適用于設定類型： [輸送量]。 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新資料庫輸送量。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 僅適用于設定類型： [輸送量]。 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/資料庫/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' sql '、' mongodb '、' gremlin'。 僅適用于設定類型： [輸送量]。 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/keyspace/settings/write | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新 keyspace 輸送量。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/keyspace/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取 keyspace 輸送量。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/keyspace/tables/write | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）建立或更新資料表。 僅適用于 API 類型： ' cassandra '。 |
> | Microsoft.DocumentDB/databaseAccounts/api/keyspace/資料表/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取資料表或列出所有資料表。 僅適用于 API 類型： ' cassandra '。 |
> | Microsoft.DocumentDB/databaseAccounts/api/keyspace/tables/delete | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）刪除資料表。 僅適用于 API 類型： ' cassandra '。 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/keyspace/資料表/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新資料表輸送量。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/keyspace/資料表/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑，以讀取資料表輸送量。 僅適用于 API 類型： ' cassandra '。 僅適用于設定類型： [輸送量]。 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/資料表/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取資料表或列出所有資料表。 僅適用于 API 類型： ' table '。 |
...
> | Microsoft.DocumentDB/databaseAccounts/api/資料表/設定/寫入 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）來更新資料表輸送量。 僅適用于 API 類型： ' table '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料表/設定/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑，以讀取資料表輸送量。 僅適用于 API 類型： ' table '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/api/資料表/設定/operationResults/讀取 | (已淘汰。 請使用不含 '/apis/' 區段的資源路徑）讀取非同步作業的狀態。 僅適用于 API 類型： ' table '。 僅適用于設定類型： [輸送量]。 |
> | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/write | 建立 Cassandra keyspace。 |
> | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/read | 閱讀 Cassandra keyspace 或列出所有 Cassandra keyspace。 |
...
> | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings/migrateToManualThroughput/action | 將 Cassandra 資料表的供應專案遷移至以進行手動輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/read | 閱讀 Cassandra keyspace 輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/migrateToManualThroughput/action | 將 Cassandra keyspace 供應專案遷移至以進行手動輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/read | 讀取 Gremlin 資料庫或列出所有的 Gremlin 資料庫。 |
...
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/圖形/讀取 | 讀取 Gremlin 圖形或列出所有 Gremlin 圖形。 |
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/圖形/刪除 | 刪除 Gremlin 圖形。 |
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/圖形/operationResults/讀取 | 讀取非同步作業的狀態。 |
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/圖形/throughputSettings/write | 更新 Gremlin 圖形輸送量。 |
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/圖形/throughputSettings/讀取 | 讀取 Gremlin 圖形輸送量。 |
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/圖形/throughputSettings/migrateToAutoscale/action | 將 Gremlin 圖形供應專案遷移至自動調整。 |
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/圖形/throughputSettings/migrateToManualThroughput/action | 將 Gremlin graph 供應專案遷移至以手動輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/migrateToManualThroughput/action | 將 Gremlin 資料庫供應專案遷移至以手動輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/read | 讀取 MongoDB 資料庫或列出所有 MongoDB 資料庫。 |
> | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/delete | 刪除 MongoDB 資料庫。 |
> | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/集合/寫入 | 建立或更新 MongoDB 集合。 |
> | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/集合/讀取 | 讀取 MongoDB 集合或列出所有 MongoDB 集合。 |
...
> | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/collection/throughputSettings/migrateToManualThroughput/action | 將 MongoDB 集合供應專案遷移至以手動輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/write | 更新 MongoDB 資料庫輸送量。 |
> | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/read | 讀取 MongoDB 資料庫輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/migrateToManualThroughput/action | 將 MongoDB 資料庫供應專案遷移至以進行手動輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/notebookWorkspaces/listConnectionInfo/action | 列出筆記本工作區的連線資訊 |
...
> | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/validate/action | 驗證資料庫帳戶的私用端點連接 proxy |
> | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/operationResults/read | 讀取私人端點連接 proxy 非同步作業的狀態 |
...
> | Microsoft.DocumentDB/databaseAccounts/privateLinkResources/read | 讀取私人連結資源，或列出資料庫帳戶的所有私人連結資源 |
...
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/寫入 | 建立或更新 SQL 容器。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/讀取 | 讀取 SQL 容器或列出所有 SQL 容器。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/刪除 | 刪除 SQL 容器。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/operationResults/讀取 | 讀取非同步作業的狀態。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/storedProcedures/寫入 | 建立或更新 SQL 預存程式。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/storedProcedures/讀取 | 讀取 SQL 預存程式或列出所有 SQL 預存程式。 |
...
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/throughputSettings/寫入 | 更新 SQL 容器輸送量。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/throughputSettings/讀取 | 讀取 SQL 容器輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/觸發程式/operationResults/讀取 | 讀取非同步作業的狀態。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/userDefinedFunctions/寫入 | 建立或更新 SQL 使用者定義函數。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/容器/userDefinedFunctions/讀取 | 讀取 SQL 使用者定義函數，或列出所有 SQL 使用者定義函數。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/container/userDefinedFunctions/delete | 刪除 SQL 使用者定義函數。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/container/userDefinedFunctions/operationResults/read | 讀取非同步作業的狀態。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/operationResults/read | 讀取非同步作業的狀態。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/write | 更新 SQL database 輸送量。 |
> | Microsoft.DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/read | 讀取 SQL database 輸送量。 |
...
> | Microsoft.DocumentDB/databaseAccounts/tables/delete | 刪除資料表。 |
...
> | Microsoft.DocumentDB/databaseAccounts/tables/throughputSettings/migrateToManualThroughput/action | 將資料表供應專案遷移至以手動輸送量。 |
...
Azure 服務： [Azure SQL Database](../azure-sql/database/index.yml)、 [azure SQL 受控執行個體](../azure-sql/managed-instance/index.yml)、 [SQL 資料倉儲](../sql-data-warehouse/index.yml)
...
> | Microsoft .Sql/privateEndpointConnectionsApproval/action | 決定是否允許使用者核准私用端點連接 |
...
> | Microsoft .Sql/instancePools/使用方式/讀取 | 取得實例集區的使用方式資訊 |
...
> | Microsoft.Sql/locations/instanceFailoverGroups/write | 建立具有指定參數的實例容錯移轉群組，或更新指定之實例容錯移轉群組的屬性或標記。 |
...
> | Microsoft .Sql/位置/managedInstanceLongTermRetentionPolicyAzureAsyncOperation/讀取 | 取得受管理資料庫長期保留原則作業的狀態 |
> | Microsoft .Sql/位置/managedInstanceLongTermRetentionPolicyOperationResults/讀取 | 取得受管理資料庫長期保留原則作業的狀態 |
> | Microsoft .Sql/位置/managedInstancePrivateEndpointConnectionAzureAsyncOperation/讀取 | 取得私用端點連接作業的結果 |
> | Microsoft .Sql/位置/managedInstancePrivateEndpointConnectionOperationResults/讀取 | 取得私用端點連接作業的結果 |
> | Microsoft .Sql/位置/managedInstancePrivateEndpointConnectionProxyAzureAsyncOperation/讀取 | 取得私用端點連接 proxy 作業的結果 |
> | Microsoft .Sql/位置/managedInstancePrivateEndpointConnectionProxyOperationResults/讀取 | 取得私用端點連接 proxy 作業的結果 |
> | Microsoft .Sql/位置/managedShortTermRetentionPolicyOperationResults/讀取 | 取得短期保留原則操作的狀態 |
...
> | Microsoft .Sql/位置/privateEndpointConnectionAzureAsyncOperation/讀取 | 取得私用端點連接作業的結果 |
> | Microsoft .Sql/位置/privateEndpointConnectionOperationResults/讀取 | 取得私用端點連接作業的結果 |
> | Microsoft .Sql/位置/privateEndpointConnectionProxyAzureAsyncOperation/讀取 | 取得私用端點連接 proxy 作業的結果 |
> | Microsoft .Sql/位置/privateEndpointConnectionProxyOperationResults/讀取 | 取得私用端點連接 proxy 作業的結果 |
...
> | Microsoft .Sql/位置/shortTermRetentionPolicyOperationResults/讀取 | 取得短期保留原則操作的狀態 |
...
> | Microsoft .Sql/位置/時區/讀取 | 依位置傳回受管理的實例時區清單。 |
...
> | Microsoft .Sql/managedInstances/匯出/動作 | 匯出系統資料庫和 SMK 索引鍵 |
...
> | Microsoft .Sql/managedInstances/容錯移轉/動作 | 客戶已起始受控實例容錯移轉。 |
...
> | Microsoft .Sql/managedInstances/資料庫/資料行/讀取 | 傳回受控資料庫的資料行清單 |
...
> | Microsoft .Sql/managedInstances/資料庫/restoreDetails/read | 還原進行時傳回受控資料庫還原詳細資料。 |
...
> | Microsoft .Sql/managedInstances/資料庫/架構/資料表/資料行/sensitivityLabels/啟用/動作 | 在指定的資料行上啟用敏感性建議 |
> | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/write | 變更指定受控資料庫的資料庫威脅偵測原則 |
> | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/read | 抓取為給定伺服器設定的受控資料庫威脅偵測原則清單 |
...
> | Microsoft .Sql/managedInstances/作業/讀取 | 取得受控實例作業 |
> | Microsoft .Sql/managedInstances/作業/取消/動作 | 取消尚未完成的 Azure SQL 受控執行個體暫止非同步作業。 |
> | ManagedInstances/privateEndpointConnectionProxies/read | 傳回私用端點連接 proxy 的清單，或取得指定之私用端點連接 proxy 的屬性。 |
> | ManagedInstances/privateEndpointConnectionProxies/write | 使用指定的參數建立私用端點連接 proxy，或更新指定之私用端點連接 proxy 的屬性或標記。 |
> | Microsoft Sql/managedInstances/privateEndpointConnectionProxies/delete | 刪除現有的私用端點連接 proxy |
> | Microsoft .Sql/managedInstances/privateEndpointConnectionProxies/validate/action | 驗證從 NRP 端的私用端點連接建立呼叫 |
> | ManagedInstances/privateEndpointConnections/read | 傳回私用端點連接的清單，或取得指定之私用端點連接的屬性。 |
> | Microsoft Sql/managedInstances/privateEndpointConnections/delete | 刪除現有的私用端點連接 |
> | ManagedInstances/privateEndpointConnections/write | 核准或拒絕現有的私用端點連接 |
> | ManagedInstances/privateLinkResources/read | 取得對應 sql server 的私用連結資源 |
...
> | Microsoft.Sql/managedInstances/securityAlertPolicies/read | 抓取為給定伺服器設定的受管理伺服器威脅偵測原則清單 |
> | ManagedInstances/topqueries/read | 取得受控實例的熱門資源取用查詢 |
...
> | Microsoft .Sql/servers/enableAzureADOnlyAuthentication/action | 啟用僅 Azure Active Directory 邏輯伺服器上的驗證 |
> | Microsoft .Sql/servers/disableAzureADOnlyAuthentication/action | 停用只 Azure Active Directory 邏輯伺服器上的驗證 |
...
> | Microsoft .Sql/servers/privateEndpointConnectionsApproval/action | 決定是否允許使用者核准私用端點連接 |
> | Microsoft.Sql/servers/import/action | 在伺服器上建立新的資料庫，並部署來自 DacPac 套件的結構描述和資料 |
> | Microsoft.Sql/servers/administratorOperationResults/read | 取得關於伺服器系統管理員的進行中作業 |
> | Microsoft.Sql/servers/administrators/read | 取得特定 Azure Active Directory 系統管理員物件 |
...
> | Microsoft.Sql/servers/auditingPolicies/read | 擷取給定伺服器上所設定之預設伺服器資料表稽核原則的詳細資料 |
> | Microsoft.Sql/servers/auditingPolicies/write | 變更給定伺服器的預設伺服器資料表稽核 |
...
> | Microsoft.Sql/servers/connectionPolicies/read | 傳回指定伺服器的伺服器連線原則清單。 |
> | Microsoft.Sql/servers/connectionPolicies/write | 建立或更新伺服器連線原則。 |
...
> | Microsoft .Sql/伺服器/資料庫/容錯移轉/動作 | 客戶起始的資料庫容錯移轉。 |
...
> | Microsoft.Sql/servers/databases/auditingPolicies/read | 擷取給定資料庫上所設定之資料表稽核原則的詳細資料 |
> | Microsoft.Sql/servers/databases/auditingPolicies/write | 變更給定資料庫的資料表稽核原則 |
...
> | Microsoft .Sql/伺服器/資料庫/資料行/讀取 | 傳回資料庫的資料行清單 |
> | Microsoft.Sql/servers/databases/connectionPolicies/read | 擷取給定資料庫上所設定的連線原則詳細資料 |
> | Microsoft.Sql/servers/databases/connectionPolicies/write | 變更給定資料庫的連線原則 |
...
> | Microsoft .Sql/伺服器/資料庫/擴充功能/importExtensionOperationResults/讀取 | 取得進行中的匯入作業 |
...
> | Microsoft .Sql/servers/資料庫/架構/資料表/資料行/sensitivityLabels/啟用/動作 | 在指定的資料行上啟用敏感性建議 |
...
> | Microsoft.Sql/servers/databases/securityAlertPolicies/read | 抓取為給定伺服器設定的資料庫威脅偵測原則清單 |
...
> | Microsoft.Sql/servers/databases/transparentDataEncryption/read | 在指定的受控資料庫上，取得邏輯資料庫透明資料加密的詳細資料 |
...
> | Microsoft .Sql/servers/資料庫/workloadGroups/workloadClassifiers/read | 列出所選取資料庫的工作負載分類器。 |
> | Microsoft .Sql/servers/資料庫/workloadGroups/workloadClassifiers/write | 設定特定工作負載分類器的屬性。 |
> | Microsoft .Sql/servers/資料庫/workloadGroups/workloadClassifiers/delete | 卸載特定的工作負載分類器。 |
...
> | Microsoft .Sql/servers/elasticPools/容錯移轉/動作 | 客戶已起始彈性集區容錯移轉。 |
...
> | Microsoft .Sql/伺服器/encryptionProtector/重新驗證/動作 | 更新指定伺服器加密保護裝置的屬性。 |
...
> | Microsoft .Sql/servers/inaccessibleDatabases/read | 傳回邏輯伺服器中無法存取的資料庫清單。 |
...
> | Microsoft .Sql/伺服器/作業/讀取 | 傳回伺服器上執行的作業清單 |
> | Microsoft .Sql/servers/privateEndpointConnectionProxies/updatePrivateEndpointProperties/action | 由 NRP 用來將屬性回填至私用端點連接 |
> | Microsoft .Sql/伺服器/privateEndpointConnectionProxies/驗證/動作 | 驗證從 NRP 端的私用端點連接建立呼叫 |
> | Microsoft .Sql/servers/privateEndpointConnectionProxies/read | 傳回私用端點連接 proxy 的清單，或取得指定之私用端點連接 proxy 的屬性。 |
> | Microsoft .Sql/servers/privateEndpointConnectionProxies/write | 使用指定的參數建立私用端點連接 proxy，或更新指定之私用端點連接 proxy 的屬性或標記。 |
> | Microsoft .Sql/servers/privateEndpointConnectionProxies/delete | 刪除現有的私用端點連接 proxy |
> | Microsoft .Sql/servers/privateEndpointConnections/read | 傳回私用端點連接的清單，或取得指定之私用端點連接的屬性。 |
> | Microsoft .Sql/servers/privateEndpointConnections/delete | 刪除現有的私用端點連接 |
> | Microsoft .Sql/servers/privateEndpointConnections/write | 核准或拒絕現有的私用端點連接 |
> | Microsoft .Sql/servers/privateLinkResources/read | 取得對應 sql server 的私用連結資源 |
...
> | Microsoft.Sql/servers/securityAlertPolicies/read | 抓取為指定伺服器設定的伺服器威脅偵測原則清單 |
...
Azure 服務： [azure 上的 SQL Server 虛擬機器](../azure-sql/virtual-machines/windows/sql-server-on-azure-vm-iaas-what-is-overview.md)

> [!div class="mx-tableFixed"]
> | 動作 | 描述 |
> | --- | --- |
> | Microsoft.sqlvirtualmachine/register/action | 向 Microsoft.sqlvirtualmachine 資源提供者註冊訂用帳戶 |
> | Microsoft.sqlvirtualmachine/取消註冊/動作 | 向 Microsoft.sqlvirtualmachine 資源提供者取消註冊訂用帳戶 |
> | Microsoft.sqlvirtualmachine/位置/registerSqlVmCandidate/動作 | 註冊 SQL Vm 候選 |
> | Microsoft.sqlvirtualmachine/位置/availabilityGroupListenerOperationResults/讀取 | 取得可用性群組接聽程式作業的結果 |
> | Microsoft.sqlvirtualmachine/位置/sqlVirtualMachineGroupOperationResults/讀取 | 取得 SQL 虛擬機器群組作業的結果 |
> | Microsoft.sqlvirtualmachine/位置/sqlVirtualMachineOperationResults/讀取 | 取得 SQL 虛擬機器作業的結果 |
> | Microsoft.sqlvirtualmachine/作業/讀取 |  |
> | Microsoft.sqlvirtualmachine/sqlVirtualMachineGroups/read | 檢索 SQL 虛擬機器群組的詳細資料 |
...
> | Microsoft.sqlvirtualmachine/sqlVirtualMachineGroups/availabilityGroupListeners/read | 在指定的 SQL 虛擬機器群組上，取得 SQL 可用性群組接聽程式的詳細資料 |
> | Microsoft.sqlvirtualmachine/sqlVirtualMachineGroups/availabilityGroupListeners/write | 建立新的或變更現有 SQL 可用性群組接聽程式的屬性 |
> | Microsoft.sqlvirtualmachine/sqlVirtualMachineGroups/availabilityGroupListeners/delete | 刪除現有的可用性群組接聽程式 |
> | Microsoft.sqlvirtualmachine/sqlVirtualMachineGroups/sqlVirtualMachines/read | 依特定 sql 虛擬機器群組列出 Sql 虛擬機器 |
...
> | Databricks/位置/getNetworkPolicies/動作 | 根據 NRP 所使用的位置，取得子網的網路意圖原則 |
> | Databricks/位置/operationstatuses/讀取 | 讀取資源的作業狀態。 |
> | Databricks/作業/讀取 | 取得作業的清單。 |
...
> | Databricks/workspace/storageEncryption/write | 在 Databricks 工作區的受控儲存體帳戶上啟用客戶管理的金鑰加密 |
> | Databricks/workspace/storageEncryption/delete | 在 Databricks 工作區的受控儲存體帳戶上停用客戶管理的金鑰加密 |
...
> | DataLakeAnalytics/accounts/dataLakeStoreGen2Accounts/delete | 取消 DataLakeStoreGen2 帳戶與 DataLakeAnalytics 帳戶的連結。 |
...
> | DataLakeStore/accounts/共用/讀取 | 取得共用的相關資訊。 |
> | DataLakeStore/accounts/共用/寫入 | 建立或更新共用。 |
> | DataLakeStore/accounts/共用/刪除 | 刪除共用。 |
...
> | Microsoft EventHub/叢集/命名空間/讀取 | 列出叢集中的命名空間 Azure Resource Manager 識別碼。 |
...
> | Microsoft. EventHub/命名空間/privateEndpointConnectionProxies/驗證/動作 | 驗證私用端點連接 Proxy |
> | Microsoft. EventHub/命名空間/privateEndpointConnectionProxies/read | 取得私人端點連接 Proxy |
> | Microsoft. EventHub/命名空間/privateEndpointConnectionProxies/write | 建立私用端點連接 Proxy |
> | Microsoft. EventHub/命名空間/privateEndpointConnectionProxies/delete | 刪除私人端點連接 Proxy |
...
> | Microsoft. EventHub/命名空間/架構/寫入 | 撰寫架構 |
...
> | Microsoft HDInsight/叢集/擴充功能/寫入 | 建立適用于 HDInsight 叢集的叢集擴充功能 |
...
> | 動作 | 描述 |
> | --- | --- |
> | Kusto/register/action | 訂用帳戶註冊動作 |
> | Kusto/Register/action | 向 Kusto 資源提供者註冊訂用帳戶。 |
...
> | Kusto/叢集/DetachFollowerDatabases/action | 卸離進行中的資料庫。 |
> | Kusto/叢集/ListFollowerDatabases/action | 列出進行中的資料庫。 |
> | Kusto/叢集/DiagnoseVirtualNetwork/action | 針對服務所依存的外部資源，診斷其網路線上狀態。 |
> | Kusto/叢集/ListLanguageExtensions/action | 列出語言延伸模組。 |
> | Kusto/叢集/AddLanguageExtensions/action | 新增語言擴充功能。 |
> | Kusto/叢集/RemoveLanguageExtensions/action | 移除語言延伸模組。 |
...
> | Kusto/叢集/資料庫/ListPrincipals/action | 列出資料庫主體。 |
> | Kusto/叢集/資料庫/AddPrincipals/action | 加入資料庫主體。 |
> | Kusto/叢集/資料庫/RemovePrincipals/action | 移除資料庫主體。 |
> | Kusto/叢集/資料庫/DataConnectionValidation/action | 驗證資料庫資料連線。 |
> | Kusto/叢集/資料庫/CheckNameAvailability/action | 檢查給定類型的名稱可用性。 |
> | Kusto/叢集/資料庫/EventHubConnectionValidation/action | 驗證資料庫事件中樞連接。 |
...
> | Microsoft.Kusto/Clusters/Databases/EventHubConnections/read | 讀取事件中樞連接資源。 |
> | Microsoft.Kusto/Clusters/Databases/EventHubConnections/write | 寫入事件中樞連接資源。 |
> | Microsoft.Kusto/Clusters/Databases/EventHubConnections/delete | 刪除事件中樞連接資源。 |
...
> | Kusto/叢集/DataConnections/read | 讀取叢集的資料連線資源。 |
> | Kusto/叢集/DataConnections/write | 寫入叢集的資料連線資源。 |
> | Kusto/叢集/DataConnections/delete | 刪除叢集的資料連線資源。 |
...
> | Kusto/位置/CheckNameAvailability/動作 | 檢查資源名稱可用性。 |
...
> | Mslearn-streamanalytics/streamingjobs/PublishEdgePackage/action | 發佈串流分析作業的 edge 套件 |
> | Microsoft.StreamAnalytics/streamingjobs/Read | 讀取串流分析作業 |
> | Mslearn-streamanalytics/streamingjobs/調整/動作 | 調整串流分析作業 |
...
> | 動作 | 描述 |
> | --- | --- |
> | 區塊鏈/register/action | 為區塊鏈資源提供者註冊訂用帳戶。 |
> | 區塊鏈/blockchainMembers/read | 取得或列出現有的區塊鏈成員。 |
...
> | 區塊鏈/cordaMembers/read | 取得或列出現有的區塊鏈 Corda 成員。 |
...
> | Microsoft.BotService/botServices/channels/read | 讀取 Bot 服務通道 |
...
> | CognitiveServices/accounts/privateEndpointConnectionProxies/write | 寫入私用端點連接。 |
> | CognitiveServices/accounts/privateEndpointConnectionProxies/delete | 刪除私人端點連接。 |
> | CognitiveServices/accounts/privateEndpointConnectionProxies/validate/action | 驗證私用端點連接。 |
> | CognitiveServices/accounts/privateEndpointConnections/read | 讀取私人端點連接。 |
> | CognitiveServices/accounts/privateEndpointConnections/write | 寫入私用端點連接。 |
...
> | CognitiveServices/位置/deleteVirtualNetworkOrSubnets/動作 | 來自 Microsoft 的通知正在刪除 VirtualNetworks 或子網。 |
> | Microsoft.CognitiveServices/locations/checkSkuAvailability/action | 讀取訂用帳戶的可用 Sku。 |
...
> | CognitiveServices/accounts/ComputerVision/說明/動作 | 這項作業會使用完整的句子，以人類看得懂的語言來產生影像的描述。<br> 這項描述是以內容標記的集合為基礎，這也會由作業傳回。<br>可以為每個影像產生一個以上的描述。<br> 描述會依其信賴分數排序。<br>所有描述都是英文。 |
> | CognitiveServices/accounts/ComputerVision/generatethumbnail/action | 此作業會產生具有使用者指定寬度和高度的縮圖影像。<br> 根據預設，此服務會分析影像、識別相關區域 (ROI)，並根據 ROI 產生智慧裁剪的座標。<br> 當您指定與輸入影像不同的外觀比例時，智慧型裁剪會有所説明 |
> | CognitiveServices/accounts/ComputerVision/ocr/action | 光學字元辨識（OCR）會偵測影像中的文字，並將已辨識的字元解壓縮至電腦可用的字元資料流。    |
> | CognitiveServices/accounts/ComputerVision/recognizetext/action | 使用此介面來取得辨識文字作業的結果。 當您使用辨識文字介面時，回應會包含名為 "Operation-Location" 的欄位。 [作業-位置] 欄位包含您必須用於「取得辨識文字」作業結果作業的 URL。 |
> | CognitiveServices/accounts/ComputerVision/tag/action | 這項作業會產生與所提供影像內容相關的單字或標籤清單。<br>電腦視覺 API 可以根據在影像中找到的物件、景象或動作傳回標記。<br>不同于類別，標記不會根據階層式分類系統來組織，而是對應至影像內容。<br>標記可能包含避免不明確或提供內容的提示，例如，標記 "cello" 可能會伴隨提示 "樂器"。<br>所有標記都是英文。 |
> | CognitiveServices/accounts/ComputerVision/areaofinterest/action | 這項作業會傳回影像中最重要區域周圍的周框方塊。 |
> | CognitiveServices/accounts/ComputerVision/偵測/action | 此作業會在指定的映射上執行物件偵測。  |
> | CognitiveServices/accounts/ComputerVision/型號/read | 這項作業會傳回電腦視覺 API 支援的特定領域模型清單。  目前，此 API 支援下列特定領域模型：名人辨識器、地標辨識器。 |
> | CognitiveServices/accounts/ComputerVision/模型/分析/動作 | 這項作業會藉由套用特定領域模型來辨識影像中的內容。<br> 您可以使用/models GET 要求來抓取電腦視覺 API 所支援的特定領域模型清單。<br> 目前，API 提供下列特定領域模型：名人、地標。 |
> | CognitiveServices/accounts/ComputerVision/讀取/分析/動作 | 使用此介面來執行讀取作業，並採用針對大量文字檔優化的最先進光學字元辨識（OCR）演算法。<br>它可以處理右手寫、列印或混合檔。<br>當您使用讀取介面時，回應會包含名為「作業-位置」的標頭。<br>「作業-位置」標頭包含您必須用於「取得讀取結果」作業以存取 OCR 結果的 URL。 |
> | CognitiveServices/accounts/ComputerVision/read/analyzeresults/read | 使用此介面來取出讀取作業的狀態和 OCR 結果。  在讀取作業的「作業-位置」回應標頭中，會傳回包含 ' operationId ' 的 URL。 |
> | CognitiveServices/accounts/ComputerVision/讀取/核心/asyncbatchanalyze/動作 | 使用此介面來取得批次讀取檔案作業的結果，並採用最先進的光學字元 |
> | CognitiveServices/accounts/ComputerVision/讀取/作業/讀取 | 這個介面是用來取得讀取作業的 OCR 結果。 應從批次讀取檔案介面傳回的「作業<b>-位置</b>」欄位，抓取此介面的 URL。 |
> | CognitiveServices/accounts/ComputerVision/textoperations/read | 這個介面是用來取得辨識文字作業結果。 應從辨識文字介面傳回的「作業<b>-位置</b>」欄位，抓取此介面的 URL。 |
> | CognitiveServices/accounts/ContentModerator/imagelists/action | 建立影像清單。 |
> | CognitiveServices/accounts/ContentModerator/termlists、program/action | 建立字詞清單。 |
> | CognitiveServices/accounts/ContentModerator/imagelists/read | 影像清單-取得詳細資料-影像清單-全部取得 |
...
> | CognitiveServices/accounts/ContentModerator/imagelists/images/write | 將影像新增至您的影像清單。 使用影像/比對 API 時，影像清單可以用來對其他映射執行模糊比對。 |
> | CognitiveServices/accounts/ContentModerator/imagelists/images/delete | 刪除影像清單中的影像。 使用影像/比對 API 時，影像清單可以用來對其他映射執行模糊比對。 刪除清單中的所有映射。 使用影像/比對 API 時，影像清單可以用來對其他映射執行模糊比對。 * |
> | CognitiveServices/accounts/ContentModerator/imagelists/images/read | 影像-取得所有映射識別碼 |
> | CognitiveServices/accounts/ContentModerator/processimage/評估/動作 | 傳回包含猥褻或成人內容之影像的機率。 |
> | CognitiveServices/accounts/ContentModerator/processimage/findfaces/action | 尋找影像中的臉部。 |
> | CognitiveServices/accounts/ContentModerator/processimage/match/action | Fuzzily 會比對影像與您的其中一個自訂影像清單。 您可以使用此 API 來建立及管理您的自訂映射清單。  |
> | CognitiveServices/accounts/ContentModerator/processimage/ocr/action | 針對指定的語言，傳回在影像中找到的任何文字。 如果輸入中未指定任何語言，則偵測會預設為英文。 |
> | CognitiveServices/accounts/ContentModerator/processtext/detectlanguage/action | 這項作業會偵測指定輸入內容的語言。 傳回組成提交文字之主要語言的 ISO 639-3 代碼。 支援110以上的語言。 |
> | CognitiveServices/accounts/ContentModerator/processtext/螢幕/動作 | 作業會偵測超過100語言的不雅內容，並符合自訂和共用的黑名單。 |
> | CognitiveServices/accounts/ContentModerator/小組/作業/動作 | 將會針對在此端點上公佈的影像內容傳回作業識別碼。  |
> | CognitiveServices/accounts/ContentModerator/小組/評論/動作 | 所建立的審查會針對小組中的審核者顯示。 當審核者完成審核時，會在指定的 CallBackEndpoint 上張貼評論的結果（亦即 HTTP POST）。 |
> | CognitiveServices/accounts/ContentModerator/小組/工作/讀取 | 取得作業識別碼的作業詳細資料。 |
> | CognitiveServices/accounts/ContentModerator/小組/評論/閱讀 | 傳回通過審查識別碼的審查詳細資料。 |
> | CognitiveServices/accounts/ContentModerator/小組/評論/發行/動作 | 影片評論最初是以未發行的狀態建立，這表示您的小組的審核者無法進行審核。 |
> | CognitiveServices/accounts/ContentModerator/小組/評論/文字記錄/動作 | 此 API 會將文字記錄檔案（影片中所說的所有單字的文字版本）新增至影片審核。 檔案必須是有效的 WebVTT 格式。 |
> | CognitiveServices/accounts/ContentModerator/小組/評論/transcriptmoderationresult/動作 | 此 API 會新增影片評論的文字記錄螢幕文字結果檔案。 文字記錄螢幕文字結果檔案是螢幕文字 API 的結果。 若要產生文字記錄畫面文字結果檔案，必須使用螢幕文字 API，將文字記錄檔篩選成不雅內容。 |
> | CognitiveServices/accounts/ContentModerator/小組/評論/accesskey/讀取 | 取得小組的審查內容存取金鑰。 |
> | CognitiveServices/accounts/ContentModerator/小組/評論/框架/寫入 | 使用此方法來新增影片審核畫面。 |
> | CognitiveServices/accounts/ContentModerator/小組/評論/畫面/讀取 | *NotDefined* |
> | CognitiveServices/accounts/ContentModerator/小組/設定/範本/寫入 | 建立或更新指定的範本 |
> | CognitiveServices/accounts/ContentModerator/小組/設定/範本/刪除 | 刪除小組中的範本 |
> | CognitiveServices/accounts/ContentModerator/小組/設定/範本/讀取 | 傳回此小組所布建的審查範本陣列。 |
> | CognitiveServices/accounts/ContentModerator/小組/工作流程/寫入 | 建立新的工作流程，或更新現有的。 |
> | CognitiveServices/accounts/ContentModerator/小組/工作流程/讀取 | 取得小組中特定工作流程的詳細資料取得您的小組所提供的所有工作流程 * |
> | CognitiveServices/accounts/ContentModerator/termlists、program/bulkupdate/action | 詞彙清單-大量更新 |
> | CognitiveServices/accounts/ContentModerator/termlists、program/delete | 詞彙清單-刪除 |
> | CognitiveServices/accounts/ContentModerator/termlists、program/read | 詞彙清單-取得所有詞彙清單-取得詳細資料 |
> | CognitiveServices/accounts/ContentModerator/termlists、program/refreshindex/action | 詞彙清單-重新整理搜尋索引 |
> | CognitiveServices/accounts/ContentModerator/termlists、program/write | 詞彙清單-更新詳細資料 |
> | CognitiveServices/accounts/ContentModerator/termlists、program/詞彙/寫入 | 詞彙-新增詞彙 |
> | CognitiveServices/accounts/ContentModerator/termlists、program/詞彙/刪除 | 詞彙-刪除詞彙-刪除所有詞彙 |
> | CognitiveServices/accounts/ContentModerator/termlists、program/條款/讀取 | 詞彙-取得所有詞彙 |
> | CognitiveServices/accounts/CustomVision/projects/action | 建立專案。 |
> | CognitiveServices/accounts/CustomVision/使用者/動作 | *NotDefined* |
> | CognitiveServices/accounts/CustomVision/配額/動作 | *NotDefined* |
...
> | CognitiveServices/accounts/CustomVision。預測/分類/反復專案/影像/動作 | 將影像分類並儲存結果。 |
> | CognitiveServices/accounts/CustomVision。預測/分類/反復專案/url/動作 | 將影像 url 分類並儲存結果。 |
> | CognitiveServices/accounts/CustomVision。預測/分類/反復專案/影像/nostore/動作 | 分類映射而不儲存結果。 |
> | CognitiveServices/accounts/CustomVision。預測/分類/反復專案/url/nostore/動作 | 分類影像 url，而不儲存結果。 |
> | CognitiveServices/accounts/CustomVision。預測/偵測/反復專案/影像/動作 | 偵測影像中的物件並儲存結果。 |
> | CognitiveServices/accounts/CustomVision。預測/偵測/反復專案/url/動作 | 偵測影像 url 中的物件並儲存結果。 |
> | CognitiveServices/accounts/CustomVision。預測/偵測/反復專案/影像/nostore/動作 | 在不儲存結果的情況下，偵測影像中的物件。 |
> | CognitiveServices/accounts/CustomVision。預測/偵測/反覆運算/url/nostore/動作 | 偵測影像 url 中的物件，而不儲存結果。 |
...
> | CognitiveServices/accounts/CustomVision。預測/labelproposals/設定/讀取 | 取得此專案的標籤的集區大小建議。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/遷移/動作 | *NotDefined* |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/動作 | 此 API 會以多部分/表單資料和應用程式/八位串流的形式接受本文內容。 使用多部分時 |
> | CognitiveServices/accounts/CustomVision。預測/專案/標記/動作 | 建立專案的標記。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/刪除 | 刪除特定專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/讀取 | 取得特定專案。 取得您的專案。 * |
> | CognitiveServices/accounts/CustomVision。預測/專案/訓練/動作 | 將專案排入佇列以進行定型。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/寫入 | 更新特定專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/匯入/動作 | 匯入專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/匯出/讀取 | 匯出專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/區域/動作 | 此 API 會接受一批影像區域和選擇性標記，以使用區域資訊來更新現有的映射。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/檔案/動作 | 此 API 會接受一批檔案和選擇性標記，以建立映射。 其限制為 64 個影像和 20 個標記。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/預測/動作 | 此 API 會從指定的預測影像建立一批映射。 其限制為 64 個影像和 20 個標記。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/url/動作 | 此 API 會接受一批 url，並選擇性地使用標記來建立映射。 其限制為 64 個影像和 20 個標記。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/標記/動作 | 將一組影像與一組標記產生關聯。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/刪除 | 從一組定型影像中刪除影像。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/regionproposals/動作 | 此 API 會針對該地區的 confidences 取得影像的區域提案。 如果找不到任何提案，它會傳回空陣列。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/建議/動作 | 此 API 會提取依建議的標記識別項篩選的未標記影像。 如果找不到任何影像，則會傳回空陣列。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/識別碼/讀取 | 這個 API 會針對指定的標記和選擇性的反復專案傳回一組影像。 如果未指定反復專案， |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/區域/刪除 | 刪除一組影像區域。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/建議/計數/動作 | 此 API 會採用 Tagid 來取得每個建議標籤的未標記影像計數，以取得指定的閾值。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/標記/讀取 | 此 API 支援批次處理和範圍選取。 根據預設，它只會傳回符合映射的前50個影像。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/標記/計數/讀取 | 篩選是在和/或關聯性上。 例如，如果提供的標記識別項適用于 "Dog"，而 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/標記/刪除 | 從一組影像中移除一組標記。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/未標記/已讀取 | 此 API 支援批次處理和範圍選取。 根據預設，它只會傳回符合映射的前50個影像。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/影像/未標記/計數/讀取 | 此 API 會傳回沒有指定專案標記的影像，以及選擇性地反復專案。 如果未指定反復專案， |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/刪除 | 刪除專案的特定反復專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/匯出/動作 | 匯出定型的反復專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/讀取 | 取得特定的反復專案。 取得專案的反覆運算。 * |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/發行/動作 | 發行特定的反復專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/寫入 | 更新特定的反復專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/匯出/讀取 | 取得特定反復專案的匯出清單。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/效能/讀取 | 取得反復專案的詳細效能資訊。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/效能/影像/讀取 | 此 API 支援批次處理和範圍選取。 根據預設，它只會傳回符合映射的前50個影像。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/效能/影像/計數/讀取 | 篩選是在和/或關聯性上。 例如，如果提供的標記識別項適用于 "Dog"，而 |
> | CognitiveServices/accounts/CustomVision。預測/專案/反覆運算/發行/刪除 | 解除發佈特定的反復專案。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/預測/刪除 | 刪除一組預測的影像及其相關聯的預測結果。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/預測/查詢/動作 | 取得已傳送至預測端點的影像。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/quicktest/影像/動作 | 快速測試影像。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/quicktest/url/動作 | 快速測試影像 url。 |
...
> | CognitiveServices/accounts/CustomVision/的預測/專案/標記/寫入 | 更新標記。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/tagsandregions/建議/動作 | 此 API 會針對未標記影像的陣列/批次取得建議的標籤和區域，以及 confidences 標籤。 如果找不到標記，則會傳回空陣列。 |
> | CognitiveServices/accounts/CustomVision。預測/專案/訓練/高級/動作 | 將專案排入佇列，以使用 PipelineConfiguration 和定型類型進行定型。 |
...
> | CognitiveServices/accounts/CustomVision。預測/使用量/訓練/資源/層/讀取 | 取得 Azure 使用者訓練資源的使用量 |
...
> | CognitiveServices/accounts/CustomVision。預測/使用者/層級/寫入 | *NotDefined* |
> | CognitiveServices/accounts/CustomVision。預測/使用者/讀取 | *NotDefined* |
> | CognitiveServices/accounts/CustomVision。預測/帳戶白名單/刪除 | 刪除具有特定功能的白名單使用者 |
> | CognitiveServices/accounts/CustomVision。預測/帳戶白名單/讀取 | 取得具有特定功能的白名單使用者清單 |
> | CognitiveServices/accounts/CustomVision。預測/列入允許清單/寫入 | 在具有特定功能的白名單中更新或建立使用者 |
> | CognitiveServices/accounts/CustomVision/分類/反復專案/影像/動作 | 將影像分類並儲存結果。 |
> | CognitiveServices/accounts/CustomVision/分類/反復專案/url/動作 | 將影像 url 分類並儲存結果。 |
> | CognitiveServices/accounts/CustomVision/分類/反復專案/影像/nostore/動作 | 分類映射而不儲存結果。 |
> | CognitiveServices/accounts/CustomVision/分類/反復專案/url/nostore/action | 分類影像 url，而不儲存結果。 |
> | CognitiveServices/accounts/CustomVision/偵測/反復專案/影像/動作 | 偵測影像中的物件並儲存結果。 |
> | CognitiveServices/accounts/CustomVision/偵測/反復專案/url/動作 | 偵測影像 url 中的物件並儲存結果。 |
> | CognitiveServices/accounts/CustomVision/偵測/反復專案/影像/nostore/動作 | 在不儲存結果的情況下，偵測影像中的物件。 |
...
> | CognitiveServices/accounts/CustomVision/labelproposals/設定/讀取 | 取得此專案的標籤的集區大小建議。 |
> | CognitiveServices/accounts/CustomVision/project/遷移/動作 | *NotDefined* |
> | CognitiveServices/accounts/CustomVision/projects/images/action | 此 API 會以多部分/表單資料和應用程式/八位串流的形式接受本文內容。 使用多部分時 |
> | CognitiveServices/accounts/CustomVision/projects/tags/action | 建立專案的標記。 |
> | CognitiveServices/accounts/CustomVision/projects/delete | 刪除特定專案。 |
> | CognitiveServices/accounts/CustomVision/projects/read | 取得特定專案。 取得您的專案。 * |
> | CognitiveServices/accounts/CustomVision/projects/定型/動作 | 將專案排入佇列以進行定型。 |
> | CognitiveServices/accounts/CustomVision/projects/write | 更新特定專案。 |
> | CognitiveServices/帳戶/CustomVision/專案/匯入/動作 | 匯入專案。 |
> | CognitiveServices/accounts/CustomVision/projects/成品/讀取 | 根據 blob 中的成品相對路徑，從 blob 儲存體取得成品內容。 |
> | CognitiveServices/accounts/CustomVision/projects/export/read | 匯出專案。 |
> | CognitiveServices/accounts/CustomVision/projects/images/region/action | 此 API 會接受一批影像區域和選擇性標記，以使用區域資訊來更新現有的映射。 |
> | CognitiveServices/accounts/CustomVision/projects/images/files/action | 此 API 會接受一批檔案和選擇性標記，以建立映射。 其限制為 64 個影像和 20 個標記。 |
> | CognitiveServices/accounts/CustomVision/projects/images/預測/動作 | 此 API 會從指定的預測影像建立一批映射。 其限制為 64 個影像和 20 個標記。 |
> | CognitiveServices/accounts/CustomVision/projects/images/url/action | 此 API 會接受一批 url，並選擇性地使用標記來建立映射。 其限制為 64 個影像和 20 個標記。 |
> | CognitiveServices/accounts/CustomVision/projects/images/tags/action | 將一組影像與一組標記產生關聯。 |
> | CognitiveServices/accounts/CustomVision/projects/images/delete | 從一組定型影像中刪除影像。 |
> | CognitiveServices/accounts/CustomVision/projects/images/regionproposals/action | 此 API 會針對該地區的 confidences 取得影像的區域提案。 如果找不到任何提案，它會傳回空陣列。 |
> | CognitiveServices/accounts/CustomVision/projects/images/建議/動作 | 此 API 會提取依建議的標記識別項篩選的未標記影像。 如果找不到任何影像，則會傳回空陣列。 |
> | CognitiveServices/accounts/CustomVision/projects/images/read | 此 API 支援批次處理和範圍選取。 根據預設，它只會傳回符合映射的前50個影像。 |
> | CognitiveServices/accounts/CustomVision/projects/images/metadata/action | 此 API 會接受一批映射識別碼和中繼資料，以更新映射。 有64個影像的限制。 |
> | CognitiveServices/accounts/CustomVision/projects/images/count/read | 篩選是在和/或關聯性上。 例如，如果提供的標記識別項適用于 "Dog"，而 |
> | CognitiveServices/accounts/CustomVision/projects/images/id/read | 這個 API 會針對指定的標記和選擇性的反復專案傳回一組影像。 如果未指定反復專案， |
> | CognitiveServices/accounts/CustomVision/projects/images/region/delete | 刪除一組影像區域。 |
> | CognitiveServices/accounts/CustomVision/projects/images/建議/計數/動作 | 此 API 會採用 Tagid 來取得每個建議標籤的未標記影像計數，以取得指定的閾值。 |
> | CognitiveServices/accounts/CustomVision/projects/images/已標記/已讀取 | 此 API 支援批次處理和範圍選取。 根據預設，它只會傳回符合映射的前50個影像。 |
> | CognitiveServices/accounts/CustomVision/projects/images/已標記/計數/讀取 | 篩選是在和/或關聯性上。 例如，如果提供的標記識別項適用于 "Dog"，而 |
> | CognitiveServices/accounts/CustomVision/projects/images/tags/delete | 從一組影像中移除一組標記。 |
> | CognitiveServices/accounts/CustomVision/projects/images/未標記/已讀取 | 此 API 支援批次處理和範圍選取。 根據預設，它只會傳回符合映射的前50個影像。 |
> | CognitiveServices/accounts/CustomVision/projects/images/未標記/計數/讀取 | 此 API 會傳回沒有指定專案標記的影像，以及選擇性地反復專案。 如果未指定反復專案， |
> | CognitiveServices/accounts/CustomVision/projects/反復專案/刪除 | 刪除專案的特定反復專案。 |
> | CognitiveServices/accounts/CustomVision/projects/反復專案/匯出/動作 | 匯出定型的反復專案。 |
> | CognitiveServices/accounts/CustomVision/projects/反復專案/讀取 | 取得特定的反復專案。 取得專案的反覆運算。 * |
...
> | CognitiveServices/accounts/CustomVision/projects/反復專案/匯出/讀取 | 取得特定反復專案的匯出清單。 |
> | CognitiveServices/accounts/CustomVision/projects/反覆運算/效能/讀取 | 取得反復專案的詳細效能資訊。 |
> | CognitiveServices/accounts/CustomVision/projects/反覆運算/效能/影像/讀取 | 此 API 支援批次處理和範圍選取。 根據預設，它只會傳回符合映射的前50個影像。 |
> | CognitiveServices/accounts/CustomVision/projects/反覆運算/效能/影像/計數/讀取 | 篩選是在和/或關聯性上。 例如，如果提供的標記識別項適用于 "Dog"，而 |
> | CognitiveServices/accounts/CustomVision/projects/反復專案/發行/刪除 | 解除發佈特定的反復專案。 |
> | CognitiveServices/accounts/CustomVision/projects/預測/刪除 | 刪除一組預測的影像及其相關聯的預測結果。 |
> | CognitiveServices/accounts/CustomVision/projects/預測/查詢/動作 | 取得已傳送至預測端點的影像。 |
> | CognitiveServices/accounts/CustomVision/projects/quicktest/image/action | 快速測試影像。 |
> | CognitiveServices/accounts/CustomVision/projects/quicktest/url/action | 快速測試影像 url。 |
> | CognitiveServices/accounts/CustomVision/projects/tags/delete | 從專案中刪除標記。 |
> | CognitiveServices/accounts/CustomVision/projects/tags/read | 取得特定標記的相關資訊。 取得指定專案和反復專案的標記。 * |
> | CognitiveServices/accounts/CustomVision/projects/tags/write | 更新標記。 |
> | CognitiveServices/accounts/CustomVision/projects/tagsandregions/建議/動作 | 此 API 會針對未標記影像的陣列/批次取得建議的標籤和區域，以及 confidences 標籤。 如果找不到標記，則會傳回空陣列。 |
> | CognitiveServices/accounts/CustomVision/projects/訓練/advanced/action | 將專案排入佇列，以使用 PipelineConfiguration 和定型類型進行定型。 |
> | CognitiveServices/accounts/CustomVision/配額/刪除 | *NotDefined* |
...
> | CognitiveServices/accounts/CustomVision/使用量/訓練/資源/層/讀取 | 取得 Azure 使用者訓練資源的使用量 |
> | CognitiveServices/accounts/CustomVision/使用量/訓練/使用者/讀取 | 取得 Oxford 使用者訓練資源的使用方式 |
> | CognitiveServices/帳戶/CustomVision/使用者/刪除 | *NotDefined* |
> | CognitiveServices/accounts/CustomVision/使用者/狀態/寫入 | 更新使用者狀態 |
> | CognitiveServices/accounts/CustomVision/使用者/層/寫入 | *NotDefined* |
> | CognitiveServices/accounts/CustomVision/users/read | *NotDefined* |
> | CognitiveServices/accounts/CustomVision/白名單/刪除 | 刪除具有特定功能的白名單使用者 |
> | CognitiveServices/accounts/CustomVision/白名單/讀取 | 取得具有特定功能的白名單使用者清單 |
> | CognitiveServices/accounts/CustomVision/白名單/寫入 | 在具有特定功能的白名單中更新或建立使用者 |
> | CognitiveServices/帳戶/EntitySearch/搜尋/動作 | 取得給定查詢的實體和位置結果。 |
> | CognitiveServices/帳戶/臉部/偵測/動作 | 偵測影像中的人臉、傳回臉部矩形，並選擇性地使用 faceIds、地標和屬性。 |
> | CognitiveServices/accounts/臉部/findsimilars/action | 指定查詢臉部的 faceId，以便從 faceId 陣列、臉部清單或大型臉部清單中搜尋外觀相似的臉部。 faceId |
> | CognitiveServices/accounts/臉部/群組/動作 | 根據臉部相似性將候選臉部分割成群組。 |
> | CognitiveServices/accounts/臉部/識別/動作 | 1對多的識別，以尋找與人員群組或大型人員群組中的特定查詢人臉最接近的相符專案。 |
> | CognitiveServices/帳戶/臉部/驗證/動作 | 確認兩個臉部是否屬於同一人，或某個臉部是否屬於某個人。 |
> | CognitiveServices/accounts/臉部/facelist/write | 使用使用者指定的 faceListId、名稱和選擇性的 userData 來建立空白的臉部清單。 最多64個臉部清單可更新臉部清單的資訊，包括 name 和 userData。 |
> | CognitiveServices/accounts/臉部/facelist/delete | 刪除指定的臉部清單。 臉部清單中的相關臉部影像也會一併刪除。 |
> | CognitiveServices/accounts/臉部/facelist/read | 在臉部清單中取出臉部清單的 faceListId、姓名、userData 和臉部。 列出臉部清單的 faceListId、name 和 userData。 |
> | CognitiveServices/accounts/臉部/facelist/persistedfaces/write | 將臉部新增至指定的臉部清單，最多可達1000人臉。 |
> | CognitiveServices/accounts/臉部/facelist/persistedfaces/delete | 藉由指定的 faceListId 和 persisitedFaceId，從臉部清單中刪除臉部。 也會刪除相關的臉部影像。 |
> | CognitiveServices/accounts/臉部/largefacelists/write | 使用使用者指定的 largeFaceListId、名稱和選擇性的 userData 來建立空白的大型臉部清單。 更新大型臉部清單的資訊，包括 name 和 userData。 |
> | CognitiveServices/accounts/臉部/largefacelists/delete | 刪除指定的大型臉部清單。 也會刪除大型臉部清單中的相關臉部影像。 |
> | CognitiveServices/accounts/臉部/largefacelists/read | 取出大型臉部清單的 largeFaceListId、name、userData。 列出 largeFaceListId、name 和 userData 等大型臉部清單的資訊。 |
> | CognitiveServices/accounts/臉部/largefacelists/訓練/動作 | 提交大型的臉部清單定型工作。 定型是只有經過訓練的大型臉部清單可以使用的重要步驟。 |
> | CognitiveServices/accounts/臉部/largefacelists/persistedfaces/write | 將臉部新增到指定的大型臉部清單中，最多可達1000000人臉。 依 persistedFaceId，更新大型臉部清單中指定臉部的 userData 欄位。 |
...
> | CognitiveServices/accounts/臉部/largefacelists/訓練/閱讀 | 檢查大型臉部清單定型狀態是否已完成或仍在進行中。 LargeFaceList 訓練是非同步作業 |
> | CognitiveServices/accounts/臉部/largepersongroups/write | 使用使用者指定的 largePersonGroupId、名稱和選擇性的 userData，建立新的大型人員群組。 更新現有的大型人員群組名稱和 userData。 如果內容不在要求本文中，屬性會保持不變。 |
> | CognitiveServices/accounts/臉部/largepersongroups/delete | 使用指定的 personGroupId 刪除現有的大型人員群組。 將會刪除此大型人員群組中的保存資料。 |
> | CognitiveServices/accounts/臉部/largepersongroups/read | 取出大型人員群組的資訊，包括其名稱和 userData。 此 API 會傳回大型人員群組資訊清單，列出所有現有的大型人員群組的 largePesonGroupId、name 和 userData。 |
> | CognitiveServices/accounts/臉部/largepersongroups/訓練/動作 | 提交大型人員群組訓練工作。 定型是只有經過訓練的大型人員群組可以使用的重要步驟。 |
> | CognitiveServices/accounts/臉部/largepersongroups/人員/動作 | 在指定的大型人員群組中建立新的人員。 若要將臉部加入此人員，請致電 |
> | CognitiveServices/accounts/臉部/largepersongroups/人員/刪除 | 從大型人員群組中刪除現有的人員。 所有儲存的人員資料和 person 專案中的臉部影像都會被刪除。 |
> | CognitiveServices/accounts/臉部/largepersongroups/人員/閱讀 | 抓取人員的名稱和 userData，而保存的 faceIds 則代表已註冊的人員臉部影像。 列出指定的大型人員群組中的所有人員資訊，包括 personId、name、userData 和 persistedFaceIds。 |
> | CognitiveServices/accounts/臉部/largepersongroups/人員/寫入 | 更新個人的姓名或 userData。 |
> | CognitiveServices/accounts/臉部/largepersongroups/人員/persistedfaces/寫入 | 針對臉部識別或驗證，將臉部影像新增到大型人員群組中。 若要處理更新人員保存臉部的 userData 欄位的影像。 |
> | CognitiveServices/accounts/臉部/largepersongroups/人員/persistedfaces/刪除 | 從大型人員群組中的人員刪除臉部。 臉部資料和與此臉部專案相關的影像也會一併刪除。 |
> | CognitiveServices/accounts/臉部/largepersongroups/人員/persistedfaces/閱讀 | 取出人員臉部資訊。 保存的人臉是由其 largePersonGroupId、personId 和 persistedFaceId 所指定。 |
> | CognitiveServices/accounts/臉部/largepersongroups/訓練/閱讀 | 檢查大型人員群組訓練狀態已完成或仍在進行中。 LargePersonGroup 訓練是非同步作業 |
> | CognitiveServices/accounts/臉部/persongroup/write | 使用指定的 personGroupId、名稱和使用者提供的 userData，建立新的人員群組。 更新現有人員群組的名稱和 userData。 如果內容不在要求本文中，屬性會保持不變。 |
> | CognitiveServices/accounts/臉部/persongroup/delete | 使用指定的 personGroupId 刪除現有的人員群組。 將會刪除此 person 群組中的保存資料。 |
> | CognitiveServices/accounts/臉部/persongroup/read | 取出人員組名和 userData。 若要取得此 personGroup 下的人員資訊，請使用 List person 群組的 pesonGroupId、name 及 userData。 |
> | CognitiveServices/accounts/臉部/persongroup/訓練/動作 | 提交人員群組訓練工作。 定型是只有定型的人員群組可以使用的重要步驟。 |
> | CognitiveServices/accounts/臉部/persongroup/人員/動作 | 在指定的人員群組中建立新的人員。 若要將臉部加入此人員，請致電 |
> | CognitiveServices/accounts/臉部/persongroup/人員/刪除 | 刪除人員群組中的現有人員。 所有儲存的人員資料和 person 專案中的臉部影像都會被刪除。 |
> | CognitiveServices/accounts/臉部/persongroup/人員/閱讀 | 抓取人員的名稱和 userData，而保存的 faceIds 則代表已註冊的人員臉部影像。 列出指定之 person 群組中的所有人員資訊，包括已註冊的 personId、name、userData 和 persistedFaceIds。 |
> | CognitiveServices/accounts/臉部/persongroup/人員/寫入 | 更新個人的姓名或 userData。 |
> | CognitiveServices/accounts/臉部/persongroup/人員/persistedfaces/寫入 | 將臉部影像新增至人員群組以進行臉部識別或驗證。 若要處理多個更新的影像，個人會保存臉部的 userData 欄位。 |
> | CognitiveServices/accounts/臉部/persongroup/人員/persistedfaces/刪除 | 刪除人員群組中的人臉。 臉部資料和與此臉部專案相關的影像也會一併刪除。 |
> | CognitiveServices/accounts/臉部/persongroup/人員/persistedfaces/閱讀 | 取出人員臉部資訊。 保存的人臉是由其 personGroupId、personId 和 persistedFaceId 所指定。 |
> | CognitiveServices/accounts/臉部/persongroup/訓練/閱讀 | 檢查人員群組訓練狀態已完成或仍在進行中。 PersonGroup 訓練是觸發的非同步作業 |
> | CognitiveServices/accounts/臉部/快照/採取動作 | 取得物件的快照集。 |
> | CognitiveServices/帳戶/臉部/快照/讀取 | 取得快照集作業的狀態。 |
> | CognitiveServices/帳戶/臉部/快照/套用/動作 | 套用快照集，並提供使用者指定的物件識別碼。 |
> | CognitiveServices/accounts/臉部/快照/刪除 | 刪除快照集。 |
> | CognitiveServices/帳戶/臉部/快照/寫入 | 更新快照集的屬性。 |
> | CognitiveServices/帳戶/臉部/快照/讀取 | 列出所有使用者可存取的快照集，並提供資訊。 * |
> | CognitiveServices/accounts/FormRecognizer/custom/訓練/action | 建立和定型自訂模型。<br>定型要求必須包含來源參數，這是可從外部存取的 Azure 儲存體 blob 容器 Uri （最好是共用存取簽章 Uri），或是在本機掛接的磁片磁碟機中，指向資料檔案夾的有效路徑。<br>指定本機路徑時，它們必須遵循 Linux/Unix 路徑格式，而且必須是根目錄為輸入裝載設定的絕對路徑 |
> | CognitiveServices/accounts/FormRecognizer/自訂/模型/分析/動作 | 從指定的檔中解壓縮索引鍵/值組。 輸入檔必須是其中一種支援的內容類型-「應用程式/pdf」、「影像/jpeg」或「影像/png」。 成功的回應會以 JSON 的形式傳回。 |
> | CognitiveServices/accounts/FormRecognizer/custom/型號/delete | 刪除模型成品。 |
> | CognitiveServices/accounts/FormRecognizer/自訂/模型/讀取 | 取得模型的相關資訊。 取得所有定型自訂模型的相關資訊 * |
> | CognitiveServices/accounts/FormRecognizer/自訂/模型/金鑰/讀取 | 取得模型的索引鍵。 |
> | CognitiveServices/accounts/FormRecognizer/預建/接收/asyncbatchanalyze/動作 | 從指定的收據檔中，將欄位文字和語義值解壓縮。 輸入影像檔必須是其中一種支援的內容類型： JPEG、PNG、BMP、PDF 或 TIFF。 成功回應是包含稱為「作業-位置」之欄位的 JSON，其中包含取得接收結果作業的 URL 以非同步方式抓取結果。 |
> | CognitiveServices/accounts/FormRecognizer/預先建立/接收/作業/動作 | 查詢狀態，並取出分析回條作業的結果。 此介面的 URL 可以從「分析回條」回應中的「作業-位置」標頭取得。 |
> | CognitiveServices/accounts/ImageSearch/details/action | 傳回影像的相關見解，例如包含影像的網頁。 |
> | CognitiveServices/帳戶/ImageSearch/搜尋/動作 | 取得給定查詢的相關影像。 |
> | CognitiveServices/accounts/ImageSearch/趨勢/動作 | 取得目前的趨勢影像。 |
> | CognitiveServices/accounts/ImmersiveReader/getcontentmodelforreader/action | 建立沉浸式讀取器會話 |
> | CognitiveServices/accounts/InkRecognizer/辨識/動作 | 假設有一組筆劃資料會分析內容，並產生可辨識的實體清單，包括已辨識的文字。 |
> | CognitiveServices/accounts/LUIS/predict/action | 取得給定查詢的已發行端點預測。 |
> | CognitiveServices/accounts/NewsSearch/categorysearch/action | 傳回所提供分類的新聞。 |
> | CognitiveServices/帳戶/NewsSearch/搜尋/動作 | 取得與給定查詢相關的新聞文章。 |
> | CognitiveServices/accounts/NewsSearch/trendingtopics/action | 取得 Bing 所識別的趨勢主題。 這些是 Bing 首頁底部橫幅中所顯示的相同主題。 |
...
> | CognitiveServices/accounts/QnAMaker. v2/更改/寫入 | 取代變更資料。 |
...
> | CognitiveServices/accounts/QnAMaker。 v2/知識庫/read | 取得特定 knowledgebaser 的知識庫或詳細資料清單。 |
> | CognitiveServices/accounts/QnAMaker。 v2/知識庫/write | 修改知識庫或取代知識庫內容的非同步作業。 |
> | CognitiveServices/accounts/QnAMaker。 v2/知識庫/generateanswer/action | GenerateAnswer 呼叫來查詢知識庫。 |
> | CognitiveServices/accounts/QnAMaker. v2/知識庫/訓練/動作 | 訓練呼叫以將建議新增至知識庫。 |
> | CognitiveServices/accounts/QnAMaker。 v2/知識庫/create/write | 非同步作業以建立新的知識庫。 |
...
> | CognitiveServices/帳戶/QnAMaker/變更/讀取 | 從執行時間下載變更。 |
> | CognitiveServices/accounts/QnAMaker/更改/寫入 | 取代變更資料。 |
...
> | CognitiveServices/accounts/QnAMaker/知識庫/read | 取得特定 knowledgebaser 的知識庫或詳細資料清單。 |
> | CognitiveServices/accounts/QnAMaker/知識庫/write | 修改知識庫或取代知識庫內容的非同步作業。 |
> | CognitiveServices/accounts/QnAMaker/知識庫/generateanswer/action | GenerateAnswer 呼叫來查詢知識庫。 |
> | CognitiveServices/accounts/QnAMaker/知識庫/訓練/動作 | 訓練呼叫以將建議新增至知識庫。 |
> | CognitiveServices/accounts/QnAMaker/知識庫/create/write | 非同步作業以建立新的知識庫。 |
...
> | CognitiveServices/accounts/Microsoft.azure.cognitiveservices.language.textanalytics/語言/動作 | 此 API 會傳回偵測到的語言，以及介於0和1之間的數值分數。 接近 1 的分數表示 100% 確定已識別的語言為真實。 總共支援 120 種語言。 |
> | CognitiveServices/accounts/Microsoft.azure.cognitiveservices.language.textanalytics/實體/動作 | 此 API 會傳回給定檔中已知實體和一般命名實體（ \" 人員 \" 、 \" 位置 \" 、 \" 組織 \" 等等）的清單。 |
...
> | CognitiveServices/accounts/Microsoft.azure.cognitiveservices.language.textanalytics/情感/action | 此 API 會傳回 0 到 1 之間的數值分數。<br>接近 1 的分數表示正面的情感，而接近 0 的分數則表示負面的情感。<br>分數0.5 表示缺少情感（例如<br>模擬語句）。 |
> | CognitiveServices/accounts/VideoSearch/趨勢/動作 | 取得目前的發燒影片。 |
> | CognitiveServices/accounts/VideoSearch/details/action | 取得影片的深入解析，例如相關影片。 |
> | CognitiveServices/帳戶/VideoSearch/搜尋/動作 | 取得與指定查詢相關的影片。 |
> | CognitiveServices/帳戶/VisualSearch/搜尋/動作 | 傳回與所提供影像相關的標記清單 |
> | CognitiveServices/帳戶/WebSearch/搜尋/動作 | 取得給定查詢的 web、影像、新聞、& 影片結果。 |
...
> | Microsoft.machinelearningservices/作業/讀取 | 取得 Machine Learning Services 資源提供者的所有作業 |
...
> | Microsoft.machinelearningservices/workspace/resynckeys/action | 重新同步處理 Machine Learning Services 工作區的秘密 |
...
> | Microsoft.machinelearningservices/工作區/計算/開始/動作 | 在 Machine Learning 服務工作區中啟動計算資源 |
> | Microsoft.machinelearningservices/工作區/計算/停止/動作 | 停止 Machine Learning 服務工作區中的計算資源 |
> | Microsoft.machinelearningservices/工作區/計算/重新開機/動作 | 重新開機 Machine Learning Services 工作區中的計算資源 |
> | Microsoft.machinelearningservices/workspace/計算/applicationaccess/action | 存取 Machine Learning Services 工作區中的計算資源 |
> | Microsoft.machinelearningservices/工作區/連接/讀取 | 取得 Machine Learning Services 工作區連接 |
> | Microsoft.machinelearningservices/工作區/連接/寫入 | 建立或更新 Machine Learning 服務連接 |
> | Microsoft.machinelearningservices/工作區/連接/刪除 | 刪除 Machine Learning 服務連接 |
> | Microsoft.machinelearningservices/workspace/datadriftdetectors/read | 取得 Machine Learning Services 工作區中的資料漂移偵測器 |
> | Microsoft.machinelearningservices/workspace/datadriftdetectors/write | 在 Machine Learning Services 工作區中建立或更新資料漂移偵測器 |
> | Microsoft.machinelearningservices/workspace/datadriftdetectors/delete | 刪除 Machine Learning Services 工作區中的資料漂移偵測器 |
> | Microsoft.machinelearningservices/工作區/資料集/已註冊/已讀取 | 在 Machine Learning Services 工作區中取得已註冊的資料集 |
> | Microsoft.machinelearningservices/工作區/資料集/已註冊/寫入 | 在 Machine Learning Services 工作區中建立或更新已註冊的資料集 |
> | Microsoft.machinelearningservices/工作區/資料集/已註冊/刪除 | 刪除 Machine Learning Services 工作區中已註冊的資料集 |
> | Microsoft.machinelearningservices/工作區/資料集/已註冊/預覽/已讀取 | 取得 Machine Learning Services 工作區中已註冊資料集的資料集預覽 |
> | Microsoft.machinelearningservices/工作區/資料集/已註冊/設定檔/讀取 | 取得 Machine Learning Services 工作區中已註冊資料集的資料集設定檔 |
> | Microsoft.machinelearningservices/工作區/資料集/已註冊/設定檔/寫入 | 在 Machine Learning Services 工作區中，建立或更新已註冊資料集的資料集設定檔 |
> | Microsoft.machinelearningservices/工作區/資料集/已註冊/架構/讀取 | 取得 Machine Learning Services 工作區中已註冊之資料集的資料集架構 |
> | Microsoft.machinelearningservices/工作區/資料集/未註冊/已讀取 | 在 Machine Learning Services 工作區中取得未註冊的資料集 |
> | Microsoft.machinelearningservices/工作區/資料集/未註冊/寫入 | 在 Machine Learning Services 工作區中建立或更新未註冊的資料集 |
> | Microsoft.machinelearningservices/工作區/資料集/未註冊/刪除 | 在 Machine Learning Services 工作區中刪除未註冊的資料集 |
> | Microsoft.machinelearningservices/工作區/資料集/未註冊/預覽/讀取 | 取得 Machine Learning Services 工作區中未註冊資料集的資料集預覽 |
> | Microsoft.machinelearningservices/工作區/資料集/未註冊/設定檔/讀取 | 取得 Machine Learning Services 工作區中未註冊資料集的資料集設定檔 |
> | Microsoft.machinelearningservices/工作區/資料集/未註冊/設定檔/寫入 | 在 Machine Learning Services 工作區中，建立或更新未註冊資料集的資料集設定檔 |
> | Microsoft.machinelearningservices/工作區/資料集/未註冊/架構/讀取 | 在 Machine Learning Services 工作區中，取得未註冊資料集的資料集架構 |
> | Microsoft.machinelearningservices/workspace/資料存放區/read | 取得 Machine Learning Services 工作區中的資料存放區 |
> | Microsoft.machinelearningservices/workspace/資料存放區/write | 在 Machine Learning Services 工作區中建立或更新資料存放區 |
> | Microsoft.machinelearningservices/workspace/資料存放區/delete | 刪除 Machine Learning Services 工作區中的資料存放區 |
> | Microsoft.machinelearningservices/工作區/端點/管線/讀取 | 取得 Machine Learning 服務工作區中的已發佈管線和管線端點 |
> | Microsoft.machinelearningservices/工作區/端點/管線/寫入 | 在 Machine Learning Services 工作區中建立或更新已發佈的管線和管線端點 |
> | Microsoft.machinelearningservices/工作區/環境/讀取 | 取得 Machine Learning Services 工作區中的環境 |
> | Microsoft.machinelearningservices/工作區/環境/readSecrets/action | 在 Machine Learning Services 工作區中取得具有秘密的環境 |
> | Microsoft.machinelearningservices/工作區/環境/寫入 | 在 Machine Learning Services 工作區中建立或更新環境 |
> | Microsoft.machinelearningservices/工作區/環境/組建/動作 | 在 Machine Learning Services 工作區中建立環境 |
> | Microsoft.machinelearningservices/workspace/eventGridFilters/read | 取得特定工作區的事件方格篩選 |
> | Microsoft.machinelearningservices/工作區/實驗/讀取 | 取得 Machine Learning Services 工作區中的實驗 |
> | Microsoft.machinelearningservices/工作區/實驗/寫入 | 在 Machine Learning Services 工作區中建立或更新實驗 |
> | Microsoft.machinelearningservices/工作區/實驗/刪除 | 刪除 Machine Learning Services 工作區中的實驗 |
> | Microsoft.machinelearningservices/工作區/實驗/執行/提交/動作 | 在 Machine Learning Services 工作區中建立或更新腳本執行 |
> | Microsoft.machinelearningservices/工作區/實驗/執行/讀取 | 取得在 Machine Learning Services 工作區中執行 |
> | Microsoft.machinelearningservices/工作區/實驗/執行/寫入 | 在 Machine Learning Services 工作區中建立或更新執行 |
> | Microsoft.machinelearningservices/工作區/功能/讀取 | 取得 Machine Learning 服務工作區的所有已啟用功能 |
> | Microsoft.machinelearningservices/工作區/標記/匯出/動作 | 在 Machine Learning Services 工作區中匯出標記專案的標籤 |
> | Microsoft.machinelearningservices/工作區/標記/標籤/讀取 | 取得 Machine Learning Services 工作區中標記專案的標籤 |
> | Microsoft.machinelearningservices/工作區/標記/標籤/寫入 | 在 Machine Learning Services 工作區中建立標記專案的標籤 |
> | Microsoft.machinelearningservices/工作區/標記/標籤/拒絕/動作 | 拒絕 Machine Learning Services 工作區中標記專案的標籤 |
> | Microsoft.machinelearningservices/工作區/標籤/專案/讀取 | 在 Machine Learning Services 工作區中取得標籤專案 |
> | Microsoft.machinelearningservices/工作區/標籤/專案/寫入 | 在 Machine Learning Services 工作區中建立或更新標籤專案 |
> | Microsoft.machinelearningservices/工作區/標籤/專案/刪除 | 刪除 Machine Learning Services 工作區中的標籤專案 |
> | Microsoft.machinelearningservices/工作區/標記/專案/摘要/讀取 | 在 Machine Learning Services 工作區中取得標籤專案摘要 |
> | Microsoft.machinelearningservices/工作區/中繼資料/構件/讀取 | 取得 Machine Learning Services 工作區中的成品 |
> | Microsoft.machinelearningservices/工作區/中繼資料/構件/寫入 | 在 Machine Learning Services 工作區中建立或更新構件 |
> | Microsoft.machinelearningservices/工作區/中繼資料/構件/delete | 刪除 Machine Learning Services 工作區中的成品 |
> | Microsoft.machinelearningservices/工作區/中繼資料/秘密/讀取 | 取得 Machine Learning Services 工作區中的秘密 |
> | Microsoft.machinelearningservices/工作區/中繼資料/秘密/寫入 | 在 Machine Learning Services 工作區中建立或更新秘密 |
> | Microsoft.machinelearningservices/工作區/中繼資料/秘密/刪除 | 刪除 Machine Learning Services 工作區中的秘密 |
> | Microsoft.machinelearningservices/工作區/中繼資料/快照/讀取 | 取得 Machine Learning Services 工作區中的快照集 |
> | Microsoft.machinelearningservices/工作區/中繼資料/快照/寫入 | 在 Machine Learning Services 工作區中建立或更新快照集 |
> | Microsoft.machinelearningservices/工作區/中繼資料/快照/刪除 | 刪除 Machine Learning Services 工作區中的快照集 |
> | Microsoft.machinelearningservices/工作區/模型/讀取 | 取得 Machine Learning Services 工作區中的模型 |
> | Microsoft.machinelearningservices/工作區/模型/寫入 | 在 Machine Learning Services 工作區中建立或更新模型 |
> | Microsoft.machinelearningservices/工作區/模型/刪除 | 刪除 Machine Learning Services 工作區中的模型 |
> | Microsoft.machinelearningservices/工作區/模型/套件/動作 | 封裝 Machine Learning Services 工作區中的模型 |
> | Microsoft.machinelearningservices/工作區/模組/讀取 | 取得 Machine Learning Services 工作區中的模組 |
> | Microsoft.machinelearningservices/工作區/模組/寫入 | 在 Machine Learning Services 工作區中建立或更新模組 |
> | Microsoft.machinelearningservices/工作區/筆記本/範例/讀取 | 取得範例筆記本 |
> | Microsoft.machinelearningservices/工作區/筆記本/儲存體/讀取 | 取得工作區的筆記本檔案 |
> | Microsoft.machinelearningservices/工作區/筆記本/儲存體/寫入 | 將檔案寫入工作區儲存體 |
> | Microsoft.machinelearningservices/工作區/筆記本/儲存體/刪除 | 從工作區儲存體中刪除檔案 |
> | Microsoft.machinelearningservices/工作區/筆記本/vm/讀取 | 取得特定工作區的筆記本 Vm |
> | Microsoft.machinelearningservices/工作區/筆記本/vm/寫入 | 變更筆記本 VM 的狀態 |
> | Microsoft.machinelearningservices/工作區/筆記本/vm/刪除 | 刪除筆記本 VM |
> | Microsoft.machinelearningservices/workspace/pipelinedrafts/read | 取得 Machine Learning Services 工作區中的管線草稿 |
> | Microsoft.machinelearningservices/workspace/pipelinedrafts/write | 在 Machine Learning Services 工作區中建立或更新管線草稿 |
> | Microsoft.machinelearningservices/workspace/pipelinedrafts/delete | 刪除 Machine Learning Services 工作區中的管線草稿 |
> | Microsoft.machinelearningservices/工作區/服務/讀取 | 取得 Machine Learning Services 工作區中的服務 |
> | Microsoft.machinelearningservices/工作區/服務/aci/寫入 | 建立或更新 Machine Learning Services 工作區中的 ACI 服務 |
> | Microsoft.machinelearningservices/workspace/services/aci/listkeys/action | 列出 Machine Learning Services 工作區中 ACI 服務的索引鍵 |
> | Microsoft.machinelearningservices/工作區/服務/aci/刪除 | 刪除 Machine Learning Services 工作區中的 ACI 服務 |
> | Microsoft.machinelearningservices/工作區/服務/aks/write | 在 Machine Learning Services 工作區中建立或更新 AKS 服務 |
> | Microsoft.machinelearningservices/workspace/services/aks/listkeys/action | 列出 Machine Learning Services 工作區中 AKS 服務的金鑰 |
> | Microsoft.machinelearningservices/workspace/services/aks/delete | 刪除 Machine Learning Services 工作區中的 AKS 服務 |
> | Microsoft.machinelearningservices/工作區/服務/aks/分數/動作 | Machine Learning 服務工作區中的分數 AKS services |
...
> | Microsoft. 裝置/帳戶/Metricdefinitions.listasync/讀取 | 取得 IotHub 服務的可用計量 |
> | Microsoft. Devices/選取/Read | 取得與訂用帳戶相關聯的數位 Twins 帳戶清單 |
> | Microsoft. Devices/選取/Write | 建立新的 Digitial Twins 帳戶 |
> | Microsoft. Devices/選取/Delete | 刪除現有的數位 Twins 帳戶及其所有子系 |
> | Microsoft. Devices/選取/operationresults/Read | 針對數位 Twins 帳戶取得操作的狀態 |
> | Microsoft. Devices/選取/sku/Read | 取得數位 Twins 帳戶的有效 Sku 清單 |
...
> | Microsoft. Devices/elasticPools/iotHubTenants/securitySettings/operationResults/Read | 取得 Iot 租使用者中樞 SecuritySettings 的非同步 Put 作業結果 |
...
> | Microsoft. Devices/iotHubs/privateEndpointConnectionsApproval/Action | 核准或拒絕私人端點連接 |
...
> | Microsoft. Devices/iotHubs/digitalTwinsLinks/Write | 使用數位 Twins 服務 IotHub 的連結 |
> | Microsoft. Devices/iotHubs/digitalTwinsLinks/Read | 取得目前連結數位 Twins 服務的相關資訊 |
...
> | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/validate/Action | 在建立期間驗證私用端點連接 proxy 輸入 |
> | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/Read | 取得指定之私用端點連接 proxy 的屬性 |
> | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/Write | 建立或更新私用端點連接 proxy |
> | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/Delete | 刪除現有的私用端點連接 proxy |
> | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/operationResults/Read | 取得私用端點連接 proxy 上非同步作業的結果 |
> | Microsoft. Devices/iotHubs/privateEndpointConnections/Read | 取得指定的 iot 中樞的所有私人端點連線 |
> | Microsoft. Devices/iotHubs/privateEndpointConnections/Delete | 刪除現有的私用端點連接 |
> | Microsoft. Devices/iotHubs/privateEndpointConnections/Write | 建立或更新私用端點連接 |
> | Microsoft. Devices/iotHubs/privateEndpointConnections/operationResults/Read | 取得私用端點連接上非同步作業的結果 |
...
> | Microsoft. Devices/iotHubs/securitySettings/operationResults/Read | 取得 Iot 中樞 SecuritySettings 的非同步 Put 作業結果 |
...
> | Microsoft. Devices/provisioningServices/privateEndpointConnectionsApproval/Action | 核准或拒絕私人端點連接 |
...
> | Microsoft. Devices/provisioningServices/privateEndpointConnectionProxies/validate/Action | 在建立期間驗證私用端點連接 proxy 輸入 |
> | Microsoft. Devices/provisioningServices/privateEndpointConnectionProxies/Read | 取得指定之私用端點連接 proxy 的屬性 |
> | Microsoft. Devices/provisioningServices/privateEndpointConnectionProxies/Write | 建立或更新私用端點連接 proxy |
> | Microsoft. Devices/provisioningServices/privateEndpointConnectionProxies/Delete | 刪除現有的私用端點連接 proxy |
> | Microsoft. Devices/provisioningServices/privateEndpointConnectionProxies/operationResults/Read | 取得私用端點連接 proxy 上非同步作業的結果 |
> | Microsoft. Devices/provisioningServices/privateEndpointConnections/Read | 取得指定的 iot 中樞的所有私人端點連線 |
> | Microsoft. Devices/provisioningServices/privateEndpointConnections/Delete | 刪除現有的私用端點連接 |
> | Microsoft. Devices/provisioningServices/privateEndpointConnections/Write | 建立或更新私用端點連接 |
> | Microsoft. Devices/provisioningServices/privateEndpointConnections/operationResults/Read | 取得私用端點連接上非同步作業的結果 |
...
> | IoTCentral/appTemplates/action | 取得 Azure 上所有可用的應用程式範本 IoT Central |
...
> | 動作 | 描述 |
> | --- | --- |
> | MixedReality/register/action | 為混合現實資源提供者註冊訂用帳戶。 |
> | MixedReality/remoteRenderingAccounts/provider/Microsoft Insights/Metricdefinitions.listasync/read | 取得 MixedReality/remoteRenderingAccounts 的可用計量 |
...
> | MixedReality/RemoteRenderingAccounts/managesessions/action | 啟動會話 |
> | MixedReality/RemoteRenderingAccounts/convert/read | 取得資產轉換屬性 |
> | MixedReality/RemoteRenderingAccounts/convert/delete | 停止資產轉換 |
> | MixedReality/RemoteRenderingAccounts/診斷/讀取 | 連接到遠端轉譯檢查器 |
...
> | MixedReality/RemoteRenderingAccounts/render/read | 連接到會話 |
...
> | ApiManagement/服務/閘道/動作 | 抓取閘道設定。 或更新閘道的心跳。 |
> | Microsoft.ApiManagement/service/apis/read | 列出 API 管理服務實例的所有 Api。 或取得其識別碼所指定之 API 的詳細資料。 |
> | Microsoft.ApiManagement/service/apis/write | 建立新的或更新 API 管理服務實例的現有指定 API。 或會更新 API 管理服務實例的指定 API。 |
...
> | Microsoft.ApiManagement/service/apis/diagnostics/write | 為 API 建立新的診斷，或更新現有的診斷。 或更新其識別碼所指定之 API 的診斷詳細資料。 |
> | Microsoft.ApiManagement/service/apis/diagnostics/delete | 從 API 刪除指定的診斷。 |
> | Microsoft.ApiManagement/service/apis/issues/read | 列出與指定之 API 相關聯的所有問題。 或取得其識別碼所指定之 API 的問題詳細資料。 |
> | Microsoft.ApiManagement/service/apis/issues/write | 為 API 建立新的問題，或更新現有的問題。 或更新 API 的現有問題。 |
> | Microsoft.ApiManagement/service/apis/issues/delete | 從 API 刪除指定的問題。 |
> | Microsoft.ApiManagement/service/apis/issues/attachments/read | 列出與指定之 API 相關聯之問題的所有附件。 或取得其識別碼所指定之 API 的問題附件詳細資料。 |
> | Microsoft.ApiManagement/service/apis/issues/attachments/write | 為 API 中的問題建立新的附件，或更新現有的附加檔案。 |
> | Microsoft.ApiManagement/service/apis/issues/attachments/delete | 從問題中刪除指定的批註。 |
> | Microsoft.ApiManagement/service/apis/issues/comments/read | 列出與指定之 API 相關聯之問題的所有批註。 或取得其識別碼所指定之 API 的問題批註詳細資料。 |
> | Microsoft.ApiManagement/service/apis/issues/comments/write | 為 API 中的問題建立新的批註，或更新現有的批註。 |
...
> | Microsoft.ApiManagement/service/apis/operations/write | 在 API 中建立新的作業，或更新現有的作業。 或會更新其識別碼所指定之 API 中的作業詳細資料。 |
> | Microsoft.ApiManagement/service/apis/operations/delete | 在 API 中刪除指定的作業。 |
...
> | Microsoft.ApiManagement/service/apis/operations/tags/delete | 卸離作業的標記。 |
...
> | Microsoft.ApiManagement/service/apis/policies/delete | 刪除 Api 的原則設定。 |
...
> | Microsoft.ApiManagement/service/apis/releases/read | 列出 API 的所有版本。<br>API 版本會在建立 API 的最新版本時建立。<br>發行也用來回複先前的修訂版本。<br>結果將會分頁，並可由 $top 和 $skip 參數加以限制。<br>或傳回 API 版本的詳細資料。 |
> | Microsoft.ApiManagement/service/apis/releases/delete | 移除 API 的所有版本，或刪除 API 中的指定版本。 |
> | Microsoft.ApiManagement/service/apis/releases/write | 為 API 建立新的版本。 或會更新其識別碼所指定之 API 版本的詳細資料。 |
...
> | Microsoft.ApiManagement/service/apis/schemas/delete | 刪除 Api 的架構設定。 |
> | Microsoft.ApiManagement/service/apis/tagDescriptions/read | 列出 API 範圍內的所有標記描述。 類似于 swagger-tagDescription 的模型是在 API 層級上定義，但是標籤可能會指派給作業，或在 API 範圍中取得標記描述 |
> | Microsoft.ApiManagement/service/apis/tagDescriptions/write | 建立/更新 Api 範圍內的標記描述。 |
...
> | Microsoft.ApiManagement/service/apiVersionSets/read | 列出指定之服務實例中的 API 版本集集合。 或取得其識別碼所指定之 Api 版本集的詳細資料。 |
> | Microsoft.ApiManagement/service/apiVersionSets/write | 建立或更新 Api 版本集。 或會更新其識別碼所指定之 Api VersionSet 的詳細資料。 |
> | Microsoft.ApiManagement/service/apiVersionSets/delete | 刪除特定的 Api 版本集。 |
> | Microsoft.ApiManagement/service/apiVersionSets/versions/read | 取得版本實體的清單 |
> | Microsoft.ApiManagement/service/authorizationServers/read | 列出在服務實例內定義的授權伺服器集合。 或取得沒有密碼之授權伺服器的詳細資料。 |
> | Microsoft.ApiManagement/service/authorizationServers/write | 建立新的授權伺服器，或更新現有的授權伺服器。 或會更新其識別碼所指定之授權伺服器的詳細資料。 |
> | Microsoft.ApiManagement/service/authorizationServers/delete | 刪除特定的授權伺服器實例。 |
...
> | Microsoft.ApiManagement/service/backends/reconnect/action | 通知 APIM proxy 在指定的超時時間之後，建立與後端的新連接。 如果沒有指定 timeout，則會使用2分鐘的 timeout。 |
> | ApiManagement/服務/快取/讀取 | 列出指定服務實例中所有外部快取的集合。 或取得其識別碼所指定之快取的詳細資料。 |
> | ApiManagement/service/cache/write | 建立或更新要在 Api 管理實例中使用的外部快取。 或會更新其識別碼所指定之快取的詳細資料。 |
> | ApiManagement/service/cache/delete | 刪除特定的快取。 |
> | Microsoft.ApiManagement/service/certificates/read | 列出指定服務實例中所有憑證的集合。 或取得其識別碼所指定之憑證的詳細資料。 |
> | Microsoft.ApiManagement/service/certificates/write | 建立或更新用來向後端驗證的憑證。 |
...
> | Microsoft.ApiManagement/service/diagnostics/read | 列出 API 管理服務實例的所有診斷。 或取得其識別碼所指定之診斷的詳細資料。 |
> | Microsoft.ApiManagement/service/diagnostics/write | 建立新的診斷，或更新現有的診斷。 或會更新其識別碼所指定之診斷的詳細資料。 |
> | Microsoft.ApiManagement/service/diagnostics/delete | 刪除指定的診斷。 |
> | ApiManagement/服務/閘道/讀取 | 列出已向服務實例註冊的閘道集合。 或取得其識別碼所指定之閘道的詳細資料。 |
> | ApiManagement/服務/閘道/寫入 | 建立或更新要在 Api 管理實例中使用的閘道。 或會更新其識別碼所指定之閘道的詳細資料。 |
...
> | ApiManagement/服務/閘道/hostnameConfigurations/讀取 | 列出指定之閘道的主機名稱設定集合。 |
> | Microsoft.ApiManagement/service/groups/read | 列出服務實例中定義的群組集合。 或取得其識別碼所指定之群組的詳細資料。 |
> | Microsoft.ApiManagement/service/groups/write | 建立或更新群組。 或會更新其識別碼所指定之群組的詳細資料。 |
> | Microsoft.ApiManagement/service/groups/delete | 刪除 API 管理服務實例的特定群組。 |
> | Microsoft.ApiManagement/service/groups/users/read | 列出與群組相關聯之使用者實體的集合。 |
> | Microsoft.ApiManagement/service/groups/users/write | 將現有使用者新增至現有群組 |
> | Microsoft.ApiManagement/service/groups/users/delete | 從現有的群組移除現有的使用者。 |
> | Microsoft.ApiManagement/service/identityProviders/read | 列出在指定的服務實例中設定的識別提供者集合。 或取得身分識別提供者的設定詳細資料，而不需要秘密。 |
> | Microsoft.ApiManagement/service/identityProviders/write | 建立或更新 IdentityProvider 設定。 或更新現有的 IdentityProvider 設定。 |
> | Microsoft.ApiManagement/service/identityProviders/delete | 刪除指定的識別提供者設定。 |
> | ApiManagement/service/identityProviders/listSecrets/action | 取得識別提供者密碼。 |
> | ApiManagement/service/問題/讀取 | 列出指定的服務實例中的問題集合。 或取得 API 管理問題詳細資料 |
> | Microsoft.ApiManagement/service/locations/networkstatus/read | 取得位置中服務相依資源的網路存取狀態。 |
> | Microsoft.ApiManagement/service/loggers/read | 列出指定之服務實例中的記錄器集合。 或取得其識別碼所指定之記錄器的詳細資料。 |
> | Microsoft.ApiManagement/service/loggers/write | 建立或更新記錄器。 或更新現有的記錄器。 |
> | Microsoft.ApiManagement/service/loggers/delete | 刪除指定的記錄器。 |
> | ApiManagement/service/namedValues/read | 列出在服務實例內定義的已命名值集合。 或取得其識別碼所指定之已命名值的詳細資料。 |
> | ApiManagement/service/namedValues/write | 建立或更新名為的值。 或會更新特定的已命名值。 |
> | ApiManagement/service/namedValues/delete | 從 API 管理服務實例中刪除特定的已命名值。 |
> | ApiManagement/service/namedValues/listValue/action | 取得其識別碼所指定之已命名值的密碼。 |
> | Microsoft.ApiManagement/service/networkstatus/read | 取得服務相依資源的網路存取狀態。 |
> | Microsoft.ApiManagement/service/notifications/read | 列出服務實例中定義的屬性集合。 或取得其識別碼所指定之通知的詳細資料。 |
...
> | Microsoft.ApiManagement/service/notifications/recipientEmails/write | 將電子郵件地址新增至通知的收件者清單。 |
> | Microsoft.ApiManagement/service/notifications/recipientEmails/delete | 從通知清單中移除電子郵件。 |
> | Microsoft.ApiManagement/service/notifications/recipientUsers/read | 取得訂閱通知的通知收件者使用者清單。 |
> | Microsoft.ApiManagement/service/notifications/recipientUsers/write | 將 [API 管理] 使用者新增至通知的收件者清單。 |
> | Microsoft.ApiManagement/service/notifications/recipientUsers/delete | 從通知清單中移除 [API 管理] 使用者。 |
> | Microsoft.ApiManagement/service/openidConnectProviders/read | 所有 OpenId Connect 提供者的清單。 或取得沒有秘密的特定 OpenID Connect 提供者。 |
> | Microsoft.ApiManagement/service/openidConnectProviders/write | 建立或更新 OpenID Connect 提供者。 或會更新特定的 OpenID Connect 提供者。 |
> | Microsoft.ApiManagement/service/openidConnectProviders/delete | 刪除 API 管理服務實例的特定 OpenID Connect 提供者。 |
> | ApiManagement/service/openidConnectProviders/listSecrets/action | 取得特定的 OpenID Connect 提供者密碼。 |
...
> | ApiManagement/服務/原則/讀取 | 取得租使用者層級的原則設定 |
> | ApiManagement/服務/原則/寫入 | 在租使用者層級建立原則設定 |
> | ApiManagement/服務/原則/刪除 | 刪除租使用者層級的原則設定 |
> | ApiManagement/service/policyDescriptions/read | 列出所有原則描述。 |
> | Microsoft.ApiManagement/service/policySnippets/read | 列出所有原則程式碼片段。 |
> | Microsoft.ApiManagement/service/portalsettings/read | 列出入口網站設定的集合。 或取得入口網站的登入設定，或取得入口網站的 [註冊設定] 或 [取得入口網站的委派設定]。 |
> | Microsoft.ApiManagement/service/portalsettings/write | 更新登入設定。 或建立或更新登入設定。 或更新 [註冊設定] 或 [更新註冊設定] 或 [更新委派設定]。 或建立或更新委派設定。 |
> | ApiManagement/service/portalsettings/listSecrets/action | 取得入口網站委派設定的驗證金鑰。 |
> | Microsoft.ApiManagement/service/products/read | 列出指定之服務實例中的產品集合。 或取得其識別碼所指定之產品的詳細資料。 |
...
> | Microsoft.ApiManagement/service/products/apis/delete | 從指定的產品刪除指定的 API。 |
> | Microsoft.ApiManagement/service/products/groups/read | 列出與指定之產品相關聯的開發人員群組集合。 |
> | Microsoft.ApiManagement/service/products/groups/write | 在指定的開發人員群組與指定的產品之間加入關聯。 |
> | Microsoft.ApiManagement/service/products/groups/delete | 刪除指定之群組和產品之間的關聯。 |
...
> | Microsoft.ApiManagement/service/products/subscriptions/read | 列出指定之產品的訂閱集合。 |
...
> | Microsoft.ApiManagement/service/products/tags/delete | 卸離產品的標記。 |
> | Microsoft.ApiManagement/service/productsByTags/read | 列出與標記相關聯的產品集合。 |
> | Microsoft.ApiManagement/service/properties/read | 列出服務實例中定義的屬性集合。 或取得其識別碼所指定之屬性的詳細資料。 |
> | Microsoft.ApiManagement/service/properties/write | 建立或更新屬性。 或會更新特定屬性。 |
> | Microsoft.ApiManagement/service/properties/delete | 從 API 管理服務實例中刪除特定屬性。 |
...
> | Microsoft.ApiManagement/service/subscriptions/read | 列出 API 管理服務實例的所有訂用帳戶。 或取得指定的訂用帳戶實體（不含索引鍵）。 |
> | Microsoft.ApiManagement/service/subscriptions/write | 建立或更新指定產品的指定使用者訂閱。 或會更新其識別碼所指定之訂用帳戶的詳細資料。 |
> | Microsoft.ApiManagement/service/subscriptions/delete | 刪除指定的訂用帳戶。 |
> | Microsoft.ApiManagement/service/subscriptions/regeneratePrimaryKey/action | 重新產生 API 管理服務實例現有訂用帳戶的主要金鑰。 |
> | Microsoft.ApiManagement/service/subscriptions/regenerateSecondaryKey/action | 重新產生 API 管理服務實例之現有訂用帳戶的次要金鑰。 |
> | ApiManagement/service/訂用帳戶/listSecrets/動作 | 取得指定的訂用帳戶金鑰。 |
> | Microsoft.ApiManagement/service/tagResources/read | 列出與標記相關聯的資源集合。 |
> | Microsoft.ApiManagement/service/tags/read | 列出服務實例中定義的標記集合。 或取得其識別碼所指定之標記的詳細資料。 |
> | Microsoft.ApiManagement/service/tags/write | 建立標記。 或會更新其識別碼所指定之標記的詳細資料。 |
...
> | Microsoft.ApiManagement/service/tenant/read | 取得 Api 管理服務的全域原則定義。 或取得租使用者存取訊號詳細資料 |
> | Microsoft.ApiManagement/service/tenant/write | 設定租用戶的原則設定，或更新租用戶存取資訊詳細資料 |
> | Microsoft.ApiManagement/service/tenant/delete | 移除租用戶的原則組態 |
> | ApiManagement/服務/租使用者/listSecrets/動作 | 取得租用戶存取資訊的詳細資料 |
...
> | Microsoft.ApiManagement/service/users/read | 列出指定的服務實例中已註冊的使用者集合。 或取得其識別碼所指定之使用者的詳細資料。 |
> | Microsoft.ApiManagement/service/users/write | 建立或更新使用者。 或會更新其識別碼所指定之使用者的詳細資料。 |
> | Microsoft.ApiManagement/service/users/delete | 刪除特定的使用者。 |
> | Microsoft.ApiManagement/service/users/generateSsoUrl/action | 抓取包含驗證權杖的重新導向 URL，以便將指定的使用者簽署到開發人員入口網站。 |
> | Microsoft.ApiManagement/service/users/token/action | 取得使用者的共用存取授權 Token。 |
...
> | 動作 | 描述 |
> | --- | --- |
> | AppConfiguration/register/action | 註冊訂用帳戶以使用 Microsoft 應用程式組態。 |
> | AppConfiguration/取消註冊/動作 | 使用 Microsoft 應用程式組態取消註冊訂用帳戶。 |
> | AppConfiguration/checkNameAvailability/read | 檢查資源名稱是否可供使用。 |
> | AppConfiguration/configurationStores/read | 取得指定之設定存放區的屬性，或列出指定的資源群組或訂用帳戶下的所有設定存放區。 |
...
> | AppConfiguration/configurationStores/PrivateEndpointConnectionsApproval/action | 自動核准指定之設定存放區下的私人端點連線。 |
> | AppConfiguration/configurationStores/eventGridFilters/read | 取得指定設定存放區事件方格篩選器的屬性，或列出指定之設定存放區下的所有設定存放區事件方格篩選器。 |
> | AppConfiguration/configurationStores/eventGridFilters/write | 使用指定的參數，建立或更新設定存放區事件方格篩選準則。 |
> | AppConfiguration/configurationStores/eventGridFilters/delete | 刪除設定存放區事件方格篩選。 |
> | AppConfiguration/configurationStores/privateEndpointConnectionProxies/validate/action | 驗證指定之設定存放區下的私用端點連接 proxy。 |
> | AppConfiguration/configurationStores/privateEndpointConnectionProxies/read | 取得指定設定存放區下的私人端點連線 proxy。 |
> | AppConfiguration/configurationStores/privateEndpointConnectionProxies/write | 建立或更新指定之設定存放區下的私人端點連接 proxy。 |
> | AppConfiguration/configurationStores/privateEndpointConnectionProxies/delete | 刪除指定之設定存放區下的私人端點連線 proxy。 |
> | AppConfiguration/configurationStores/privateEndpointConnections/read | 取得私人端點連線，或列出指定之設定存放區下的私人端點連線。 |
> | AppConfiguration/configurationStores/privateEndpointConnections/write | 核准或拒絕指定之設定存放區下的私人端點連線。 |
> | AppConfiguration/configurationStores/privateEndpointConnections/delete | 刪除指定之設定存放區下的私人端點連線。 |
> | AppConfiguration/configurationStores/privateLinkResources/read | 列出指定之設定存放區下的所有私人連結資源。 |
> | AppConfiguration/configurationStores/provider/Microsoft Insights/diagnosticSettings/read | 讀取設定存放區的所有診斷設定值。 |
> | AppConfiguration/configurationStores/provider/Microsoft Insights/diagnosticSettings/write | 適用于 Microsoft 應用程式組態的寫入/覆寫診斷設定。 |
...
> | AzureStack/cloudManifestFiles/read | 取得雲端資訊清單檔案 |
...
> | AzureStack/註冊/產品/uploadProductLog/動作 | 記錄 Azure Stack Marketplace 產品作業狀態和時間戳記 |
...
> | 動作 | 描述 |
> | --- | --- |
> | DataBoxEdge/availableSkus/read | 列出或取得 ArmApiRes_availableSkus |
...
> | Microsoft.DataBoxEdge/dataBoxEdgeDevices/read | 列出或取得 Data Box Edge 裝置 |
> | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | 建立或更新 Data Box Edge 裝置 |
> | DataBoxEdge/dataBoxEdgeDevices/getExtendedInformation/action | 擷取資源延伸資訊 |
...
> | DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules/operationResults/read | 列出或取得作業結果 |
...
> | DataBoxEdge/dataBoxEdgeDevices/節點/讀取 | 列出或取得節點 |
> | DataBoxEdge/dataBoxEdgeDevices/operationResults/read | 列出或取得作業結果 |
> | DataBoxEdge/dataBoxEdgeDevices/operationsStatus/read | 列出或取得作業狀態 |
> | DataBoxEdge/dataBoxEdgeDevices/orders/read | 列出或取得訂單 |
> | DataBoxEdge/dataBoxEdgeDevices/orders/read | 列出或取得訂單 |
> | DataBoxEdge/dataBoxEdgeDevices/orders/write | 建立或更新訂單 |
> | DataBoxEdge/dataBoxEdgeDevices/orders/delete | 刪除訂單 |
> | DataBoxEdge/dataBoxEdgeDevices/orders/operationResults/read | 列出或取得作業結果 |
...
> | DataBoxEdge/dataBoxEdgeDevices/roles/operationResults/read | 列出或取得作業結果 |
> | Microsoft.DataBoxEdge/dataBoxEdgeDevices/securitySettings/update/action | 更新安全性設定 |
> | DataBoxEdge/dataBoxEdgeDevices/securitySettings/operationResults/read | 列出或取得作業結果 |
...
> | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/refresh/action | 以雲端中的資料重新整理共用中繼資料 |
> | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/delete | 刪除共用 |
> | DataBoxEdge/dataBoxEdgeDevices/共用/operationResults/read | 列出或取得作業結果 |
...
> | DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/operationResults/read | 列出或取得作業結果 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/read | 列出或取得儲存體帳戶 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/read | 列出或取得儲存體帳戶 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/write | 建立或更新儲存體帳戶 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/delete | 刪除儲存體帳戶 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/容器/讀取 | 列出或取得容器 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/容器/讀取 | 列出或取得容器 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/容器/寫入 | 建立或更新容器 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/容器/刪除 | 刪除容器 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/容器/重新整理/動作 | 以雲端中的資料重新整理容器中繼資料 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/container/operationResults/read | 列出或取得作業結果 |
> | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/operationResults/read | 列出或取得作業結果 |
> | DataBoxEdge/dataBoxEdgeDevices/觸發程式/讀取 | 列出或取得觸發程式 |
> | DataBoxEdge/dataBoxEdgeDevices/觸發程式/讀取 | 列出或取得觸發程式 |
> | DataBoxEdge/dataBoxEdgeDevices/觸發程式/寫入 | 建立或更新觸發程式 |
> | DataBoxEdge/dataBoxEdgeDevices/trigger/delete | 刪除觸發程式 |
> | DataBoxEdge/dataBoxEdgeDevices/trigger/operationResults/read | 列出或取得作業結果 |
...
> | DataBoxEdge/dataBoxEdgeDevices/users/operationResults/read | 列出或取得作業結果 |
> | DataBoxEdge/作業/讀取 | 列出或取得作業 |
> | DataBoxEdge/sku/讀取 | 列出或取得 Sku |
...
> | EventGrid/網域/privateEndpointConnectionProxies/read | 讀取網域的 PrivateEndpointConnectionProxies |
> | EventGrid/網域/privateEndpointConnectionProxies/write | 寫入網域的 PrivateEndpointConnectionProxies |
> | EventGrid/網域/privateEndpointConnectionProxies/delete | 刪除網域的 PrivateEndpointConnectionProxies |
> | EventGrid/網域/privateEndpointConnections/read | 讀取網域的 PrivateEndpointConnections |
> | EventGrid/網域/privateEndpointConnections/write | 寫入網域的 PrivateEndpointConnections |
> | EventGrid/網域/privateEndpointConnections/delete | 刪除網域的 PrivateEndpointConnections |
> | EventGrid/網域/privateLinkResources/read | 取得或列出網域的 PrivateLinkResources |
...
> | EventGrid/網域/主題/寫入 | 建立或更新網域主題 |
> | EventGrid/網域/主題/delete | 刪除網域主題 |
...
> | EventGrid/partnerTopics/provider/Microsoft Insights/Metricdefinitions.listasync/read | 取得合作夥伴主題的可用計量 |
> | EventGrid/sku/讀取 | 讀取事件方格資源的可用 Sku 定義 |
> | EventGrid/systemTopics/provider/Microsoft Insights/diagnosticSettings/read | 取得系統主題的診斷設定 |
> | EventGrid/systemTopics/provider/Microsoft Insights/diagnosticSettings/write | 建立或更新系統主題的診斷設定 |
> | EventGrid/systemTopics/provider/Microsoft Insights/logDefinitions/read | 允許存取診斷記錄 |
> | EventGrid/systemTopics/provider/Microsoft Insights/Metricdefinitions.listasync/read | 取得系統主題的可用計量 |
...
> | Microsoft. 邏輯/integrationAccounts/群組/讀取 | 讀取整合帳戶中的群組。 |
> | Microsoft. 邏輯/integrationAccounts/群組/寫入 | 建立或更新整合帳戶中的群組。 |
> | Microsoft. 邏輯/integrationAccounts/群組/刪除 | 刪除整合帳戶中的群組。 |
...
> | Microsoft. 邏輯/integrationAccounts/rosettaNetProcessConfigurations/read | 讀取整合帳戶中的 RosettaNet 進程設定。 |
> | Microsoft. 邏輯/integrationAccounts/rosettaNetProcessConfigurations/write | 建立或更新整合帳戶中的 RosettaNet 進程設定。 |
> | Microsoft. 邏輯/integrationAccounts/rosettaNetProcessConfigurations/delete | 刪除整合帳戶中的 RosettaNet 進程設定。 |
...
> | Microsoft. 邏輯/integrationServiceEnvironments/managedApis/operationStatuses/read | 讀取整合服務環境受控 API 作業狀態。 |
...
> | Microsoft 轉送/命名空間/networkrulesets/讀取 | 取得 NetworkRuleSet 資源 |
> | Microsoft 轉送/命名空間/networkrulesets/寫入 | 建立 VNET 規則資源 |
> | Microsoft 轉送/命名空間/networkrulesets/delete | 刪除 VNET 規則資源 |
> | Microsoft.Relay/namespaces/operationresults/read | 取得命名空間作業的狀態 |
> | Microsoft 轉送/命名空間/privateEndpointConnectionProxies/驗證/動作 | 驗證私用端點連接 Proxy |
> | Microsoft 轉送/命名空間/privateEndpointConnectionProxies/讀取 | 取得私人端點連接 Proxy |
> | Microsoft 轉送/命名空間/privateEndpointConnectionProxies/寫入 | 建立私用端點連接 Proxy |
> | Microsoft 轉送/命名空間/privateEndpointConnectionProxies/delete | 刪除私人端點連接 Proxy |
...
> | Microsoft. 匯流排/命名空間/networkruleset/read | 取得 NetworkRuleSet 資源 |
> | Microsoft. 匯流排/命名空間/networkruleset/write | 建立 VNET 規則資源 |
> | Microsoft. 匯流排/命名空間/networkruleset/delete | 刪除 VNET 規則資源 |
> | Microsoft. 匯流排/命名空間/networkrulesets/read | 取得 NetworkRuleSet 資源 |
> | Microsoft. 匯流排/命名空間/networkrulesets/write | 建立 VNET 規則資源 |
> | Microsoft. 匯流排/命名空間/networkrulesets/delete | 刪除 VNET 規則資源 |
> | Microsoft.ServiceBus/namespaces/operationresults/read | 取得命名空間作業的狀態 |
> | Microsoft。執行匯流排/命名空間/privateEndpointConnectionProxies/驗證/動作 | 驗證私用端點連接 Proxy |
> | Microsoft. 匯流排/命名空間/privateEndpointConnectionProxies/read | 取得私人端點連接 Proxy |
> | Microsoft. 匯流排/命名空間/privateEndpointConnectionProxies/write | 建立私用端點連接 Proxy |
> | Microsoft. 匯流排/命名空間/privateEndpointConnectionProxies/delete | 刪除私人端點連接 Proxy |
...
> | Microsoft. 匯流排/命名空間/sku/讀取 | 列出命名空間的支援 Sku |
...
> | aadiam/Metricdefinitions.listasync/read | 讀取租使用者層級的度量定義 |
> | aadiam/計量/讀取 | 讀取租使用者層級計量 |
> | aadiam/privateLinkForAzureAD/read | 讀取私人連結原則定義 |
> | aadiam/privateLinkForAzureAD/write | 建立和更新私人連結原則定義 |
> | aadiam/privateLinkForAzureAD/delete | 刪除私人連結原則定義 |
> | aadiam/privateLinkForAzureAD/privateEndpointConnectionProxies/read | 讀取私人連結 proxy |
> | aadiam/privateLinkForAzureAD/privateEndpointConnectionProxies/write | 建立和更新私人連結 proxy |
> | aadiam/privateLinkForAzureAD/privateEndpointConnectionProxies/delete | 刪除私人連結 proxy |
> | aadiam/privateLinkForAzureAD/privateEndpointConnectionProxies/validate/action | 驗證私人連結 proxy |
> | aadiam/privateLinkForAzureAD/privateEndpointConnections/read | 閱讀 PrivateEndpointConnections |
...
> | aadiam/privateLinkForAzureAD/privateLinkResources/read | 閱讀 PrivateLinkResources |
...
> | ADHybridHealthService/services/reports/blobUris/read | 取得過去7天內所有具風險的 IP 報告 Uri。 |
...
> | ADHybridHealthService/services/servicemembers/計量/讀取 | 取得連接器的清單，以及指定服務和服務成員的執行設定檔名稱。 |
...
> | Microsoft.ADHybridHealthService/services/tenantwhitelisting/read | 取得指定租用戶的功能允許清單狀態。 |
...
> | Microsoft.managedidentity/身分識別/讀取 | 取得現有系統指派的身分識別 |
> | Microsoft.managedidentity/作業/讀取 | 列出 Microsoft.managedidentity 資源提供者上可用的作業 |
...
> | KeyVault/vault/eventGridFilters/read | 通知 KeyVault，正在查看 Key Vault 的 EventGrid 訂用帳戶 |
> | KeyVault/vault/eventGridFilters/write | 通知 KeyVault，正在建立 Key Vault 的新 EventGrid 訂用帳戶 |
...
> | KeyVault/vault/certificatecontacts/write | 管理憑證連絡人 |
> | KeyVault/保存庫/憑證/刪除 | 刪除憑證。 |
> | KeyVault/保存庫/憑證/讀取 | 列出指定金鑰保存庫中的憑證，或取得憑證的相關資訊。 |
> | KeyVault/保存庫/憑證/備份/動作 | 建立憑證的備份檔案。 檔案可以用來還原相同訂用帳戶 Key Vault 中的憑證。 可能適用限制。 |
> | KeyVault/保存庫/憑證/清除/動作 | 清除憑證，使其無法復原。 |
> | KeyVault/保存庫/憑證/更新/動作 | 更新與給定憑證相關聯的指定屬性。 |
> | KeyVault/保存庫/憑證/建立/動作 | 建立新的憑證。 |
> | KeyVault/保存庫/憑證/匯入/動作 | 將現有的有效憑證（包含私密金鑰）匯入 Azure Key Vault。 要匯入的憑證可以是 PFX 或 PEM 格式。 |
> | KeyVault/保存庫/憑證/復原/動作 | 復原已刪除的憑證。 作業會執行刪除作業的反轉。 此作業適用于已啟用虛刪除的保存庫，而且必須在保留間隔期間發出。 |
> | KeyVault/保存庫/憑證/還原/動作 | 將備份的憑證及其所有版本還原到保存庫。 |
> | KeyVault/保存庫/金鑰/讀取 | 列出指定之保存庫中的金鑰，或讀取索引鍵的屬性和公開材料。<br>對於非對稱金鑰，這項作業會公開公開金鑰，並包含執行公開金鑰演算法的能力，例如加密和驗證簽章。<br>私密金鑰和對稱金鑰永遠不會公開。 |
> | KeyVault/保存庫/金鑰/更新/動作 | 更新與指定索引鍵相關聯的指定屬性。 |
> | KeyVault/保存庫/金鑰/建立/動作 | 建立新的金鑰。 |
> | KeyVault/保存庫/金鑰/匯入/動作 | 匯出外部建立的金鑰、加以儲存，然後將金鑰參數和屬性傳回至用戶端。 |
> | KeyVault/保存庫/金鑰/復原/動作 | 復原已刪除的金鑰。 作業會執行刪除作業的反轉。 此作業適用于已啟用虛刪除的保存庫，而且必須在保留間隔期間發出。 |
> | KeyVault/保存庫/金鑰/還原/動作 | 將備份的金鑰及其所有版本還原到保存庫。 |
...
> | KeyVault/保存庫/金鑰/加密/動作 | 使用金鑰加密純文字。 請注意，如果金鑰是非對稱的，這項作業可以由具有讀取權限的主體來執行。 |
> | KeyVault/保存庫/金鑰/解密/動作 | 使用金鑰將加密文字解密。 |
> | KeyVault/保存庫/金鑰/包裝/動作 | 包裝具有 Key Vault 金鑰的對稱金鑰。 請注意，如果 Key Vault 金鑰是非對稱的，則可以使用讀取權限來執行此作業。 |
> | KeyVault/保存庫/金鑰/解除包裝/動作 | 使用 Key Vault 金鑰將對稱金鑰解除包裝。 |
> | KeyVault/保存庫/金鑰/正負號/動作 | 使用金鑰簽署雜湊。 |
> | KeyVault/保存庫/金鑰/驗證/動作 | 驗證雜湊。 請注意，如果金鑰是非對稱的，這項作業可以由具有讀取權限的主體來執行。 |
> | KeyVault/保存庫/秘密/刪除 | 刪除秘密。 |
> | KeyVault/保存庫/秘密/備份/動作 | 建立密碼的備份檔案。 檔案可以用來還原相同訂用帳戶 Key Vault 中的密碼。 可能適用限制。 |
> | KeyVault/保存庫/秘密/清除/動作 | 清除秘密，使其無法復原。 |
> | KeyVault/保存庫/秘密/更新/動作 | 更新與指定的密碼相關聯的指定屬性。 |
> | KeyVault/保存庫/秘密/復原/動作 | 復原已刪除的秘密。 作業會執行刪除作業的反轉。 此作業適用于已啟用虛刪除的保存庫，而且必須在保留間隔期間發出。 |
> | KeyVault/保存庫/秘密/還原/動作 | 將備份的密碼及其所有版本還原到保存庫。 |
> | KeyVault/保存庫/秘密/readMetadata/action | 列出或查看秘密的內容，而不是其值。 |
> | KeyVault/保存庫/秘密/getSecret/action | 取得密碼的值。 |
> | KeyVault/保存庫/秘密/setSecret/action | 建立新的秘密。 |
> | KeyVault/vault/storageaccounts/read | 讀取受控儲存體帳戶和 SAS 的定義。 |
> | KeyVault/保存庫/storageaccounts/設定/動作 | 建立或更新受控儲存體帳戶的定義。 |
> | KeyVault/vault/storageaccounts/delete | 刪除受控儲存體帳戶的定義。 |
> | KeyVault/vault/storageaccounts/備份/動作 | 建立受控儲存體帳戶的定義及其 SAS （共用存取簽章）的備份。 |
> | KeyVault/vault/storageaccounts/清除/動作 | 清除已虛刪除的受控儲存體帳戶定義或 SAS （共用存取簽章）。 |
> | KeyVault/vault/storageaccounts/regeneratekey/action | 重新產生受控儲存體帳戶的存取金鑰。 |
> | KeyVault/vault/storageaccounts/復原/動作 | 復原受控儲存體帳戶或 SAS 的虛刪除定義（共用存取簽章）。 |
> | KeyVault/保存庫/storageaccounts/還原/動作 | 還原受控儲存體帳戶及其 SAS 的定義（共用存取簽章）。 |
> | KeyVault/vault/storageaccounts/sas/設定/動作 | 建立或更新受控儲存體帳戶的 SAS （共用存取簽章）定義。 |
> | KeyVault/vault/storageaccounts/sas/刪除 | 刪除受控儲存體帳戶的 SAS （共用存取簽章）定義。 |
...
> | Microsoft. Security/adaptiveNetworkHardenings/強制執行/動作 | 藉由在指定的網路安全性群組上建立相符的安全性規則，強制執行指定的流量強化規則 |
...
> | Microsoft.Security/applicationWhitelistings/write | 建立新的應用程式允許清單，或更新現有的應用程式允許清單 |
> | Microsoft. Security/assessmentMetadata/read | 取得您訂用帳戶的可用安全性評量中繼資料 |
> | Microsoft. Security/assessmentMetadata/write | 建立或更新安全性評量中繼資料 |
...
> | Microsoft. Security/iotSecuritySolutions/analyticsModels/aggregatedAlerts/關閉/動作 | 關閉 IoT 匯總警示 |
...
> | 動作 | 描述 |
> | --- | --- |
> | SecurityInsights/register/action | 註冊訂用帳戶以 Azure Sentinel |
...
> | SecurityInsights/書簽/展開/動作 | 依特定的擴充取得實體的相關實體 |
> | SecurityInsights/書簽/關係/讀取 | 取得書簽關聯 |
> | SecurityInsights/書簽/關聯/寫入 | 更新書簽關聯性 |
...
> | SecurityInsights/案例/留言/寫入 | 建立案例批註 |
> | SecurityInsights/案例/調查/讀取 | 取得案例調查 |
> | SecurityInsights/案例/調查/寫入 | 更新案例的中繼資料 |
...
> | SecurityInsights/實體/讀取 | 取得 sentinel 實體圖表 |
...
> | SecurityInsights/事件/留言/寫入 | 在事件上建立批註 |
...
> | SecurityInsights/officeConsents/delete | 從 Microsoft Office 刪除同意 |
> | SecurityInsights/作業/讀取 | 取得作業 |
> | SecurityInsights/設定/讀取 | 取得設定 |
> | SecurityInsights/settings/write | 更新設定 |
> | SecurityInsights/settings/delete | 刪除設定 |
...
> | SecurityInsights/threatintelligence/查詢/動作 | 查詢威脅情報 |
...
> | Microsoft.DevTestLab/labs/artifactSources/artifacts/GenerateArmTemplate/action | 為指定的成品產生 Azure Resource Manager 範本、將所需的檔案上傳至儲存體帳戶，並驗證產生的成品。 |
...
> | Microsoft.devtestlab/labs/共用資源庫/delete | 刪除共用的資源庫。 |
> | Microsoft.devtestlab/labs/共用資源庫/read | 讀取共用的資源庫。 |
...
> | Microsoft.devtestlab/labs/virtualNetworks/bastionHosts/read | 閱讀 bastionhosts。 |
...
> | LabServices/labAccounts/labs/GetLabPricingAndAvailability/action | 取得此實驗室的每個實驗室單位定價，以及指出此實驗室是否可以相應增加的可用性。 |
...
> | LabServices/users/UserSettings/action | 更新並傳回個人使用者設定。 |
...
> | Microsoft. 遷移/assessmentprojects/寫入 | 建立新的評估專案，或更新現有的評估專案 |
> | Microsoft. 遷移/assessmentprojects/刪除 | 刪除評估專案 |
> | Microsoft. 遷移/assessmentprojects/assessmentOptions/讀取 | 取得可在指定位置使用的評定選項 |
...
> | Microsoft. 遷移/assessmentprojects/群組/updateMachines/動作 | 藉由新增或移除電腦來更新群組 |
...
> | Microsoft. 遷移/assessmentprojects/hypervcollectors/讀取 | 取得 HyperV 收集器的屬性 |
> | Microsoft. 遷移/assessmentprojects/hypervcollectors/寫入 | 建立新的 HyperV 收集器，或更新現有的 HyperV 收集器 |
> | Microsoft. 遷移/assessmentprojects/hypervcollectors/刪除 | 刪除 HyperV 收集器 |
> | Microsoft. 遷移/assessmentprojects/importcollectors/讀取 | 取得匯入收集器的屬性 |
> | Microsoft. 遷移/assessmentprojects/importcollectors/寫入 | 建立新的匯入收集器，或更新現有的匯入收集器 |
> | Microsoft. 遷移/assessmentprojects/importcollectors/刪除 | 刪除匯入收集器 |
> | Microsoft. 遷移/assessmentprojects/機器/讀取 | 取得電腦的屬性 |
> | Microsoft. 遷移/assessmentprojects/servercollectors/讀取 | 取得伺服器收集器的屬性 |
> | Microsoft. 遷移/assessmentprojects/servercollectors/寫入 | 建立新的伺服器收集器，或更新現有的伺服器收集器 |
> | Microsoft. 遷移/assessmentprojects/vmwarecollectors/讀取 | 取得 VMware 收集器的屬性 |
> | Microsoft. 遷移/assessmentprojects/vmwarecollectors/寫入 | 建立新的 VMware 收集器，或更新現有的 VMware 收集器 |
> | Microsoft. 遷移/assessmentprojects/vmwarecollectors/刪除 | 刪除 VMware 收集器 |
...
> | Microsoft. 遷移/migrateprojects/寫入 | 建立新的遷移專案，或更新現有的遷移專案 |
> | Microsoft. 遷移/migrateprojects/刪除 | 刪除遷移專案 |
> | Microsoft. 遷移/migrateprojects/registerTool/動作 | 將工具註冊到遷移專案 |
> | Microsoft. 遷移/migrateprojects/RefreshSummary/動作 | 重新整理遷移專案摘要 |
> | Microsoft. 遷移/migrateprojects/DatabaseInstances/讀取 | 取得資料庫實例的屬性。 |
> | Microsoft. 遷移/migrateprojects/資料庫/讀取 | 取得資料庫的屬性 |
> | Microsoft. 遷移/migrateprojects/機器/讀取 | 取得電腦的屬性 |
> | Microsoft. 遷移/migrateprojects/MigrateEvents/讀取 | 取得遷移事件的屬性。 |
> | Microsoft. 遷移/migrateprojects/MigrateEvents/刪除 | 刪除遷移事件 |
> | Microsoft.Migrate/migrateprojects/solutions/read | 取得遷移專案方案的屬性 |
> | Microsoft. 遷移/migrateprojects/解決方案/寫入 | 建立新的遷移專案解決方案，或更新現有的遷移專案解決方案 |
> | Microsoft. 遷移/migrateprojects/解決方案/刪除 | 刪除遷移專案解決方案 |
...
> | OffAzure/HyperVSites/updateProperties/action | 更新網站中電腦的屬性 |
> | Microsoft.OffAzure/HyperVSites/read | 取得 Hyper-V 站台的屬性 |
> | Microsoft.OffAzure/HyperVSites/write | 建立或更新 Hyper-V 站台 |
> | Microsoft.OffAzure/HyperVSites/delete | 刪除 Hyper-V 站台 |
> | Microsoft.OffAzure/HyperVSites/refresh/action | 重新整理 Hyper-V 站台內的物件 |
...
> | Microsoft.OffAzure/HyperVSites/clusters/read | 取得 Hyper-V 叢集的屬性 |
> | Microsoft.OffAzure/HyperVSites/clusters/write | 建立或更新 Hyper-V 叢集 |
> | OffAzure/HyperVSites/healthsummary/read | 取得 Hyper-v 資源的健全狀況摘要 |
> | OffAzure/HyperVSites/healthsummary/read | 取得 Hyper-v 資源的健全狀況摘要 |
> | OffAzure/HyperVSites/healthsummary/read | 取得 Hyper-v 資源的健全狀況摘要 |
> | OffAzure/HyperVSites/healthsummary/read | 取得 Hyper-v 資源的健全狀況摘要 |
...
> | Microsoft.OffAzure/HyperVSites/runasaccounts/read | 取得 Hyper-V 執行身分帳戶的屬性 |
> | Microsoft.OffAzure/HyperVSites/runasaccounts/read | 取得 Hyper-V 執行身分帳戶的屬性 |
> | OffAzure/HyperVSites/summary/read | 取得 Hyper-v 網站的摘要 |
> | OffAzure/HyperVSites/summary/read | 取得 Hyper-v 網站的摘要 |
> | OffAzure/HyperVSites/summary/read | 取得 Hyper-v 網站的摘要 |
> | OffAzure/HyperVSites/summary/read | 取得 Hyper-v 網站的摘要 |
...
> | Microsoft.OffAzure/HyperVSites/usage/read | 取得 Hyper-V 站台的使用情形 |
> | Microsoft.OffAzure/HyperVSites/usage/read | 取得 Hyper-V 站台的使用情形 |
> | OffAzure/ImportSites/read | 取得匯入網站的屬性 |
> | OffAzure/ImportSites/write | 建立或更新匯入網站 |
> | OffAzure/ImportSites/delete | 刪除匯入網站 |
> | OffAzure/ImportSites/importuri/action | 取得用於匯入電腦 CSV 檔案的 SAS uri。 |
> | OffAzure/ImportSites/exporturi/action | 取得用於匯出電腦 CSV 檔案的 SAS uri。 |
> | OffAzure/ImportSites/read | 取得匯入網站的屬性 |
> | OffAzure/ImportSites/write | 建立或更新匯入網站 |
> | OffAzure/ImportSites/delete | 刪除匯入網站 |
> | OffAzure/ImportSites/importuri/action | 取得用於匯入電腦 CSV 檔案的 SAS uri。 |
...
> | OffAzure/ImportSites/importuri/action | 取得用於匯入電腦 CSV 檔案的 SAS uri。 |
> | OffAzure/ImportSites/exporturi/action | 取得用於匯出電腦 CSV 檔案的 SAS uri。 |
> | OffAzure/ImportSites/作業/讀取 | 取得匯入作業的屬性 |
> | OffAzure/ImportSites/作業/讀取 | 取得匯入作業的屬性 |
> | OffAzure/ImportSites/作業/讀取 | 取得匯入作業的屬性 |
> | OffAzure/ImportSites/作業/讀取 | 取得匯入作業的屬性 |
> | OffAzure/ImportSites/機器/讀取 | 取得匯入電腦的屬性 |
> | OffAzure/ImportSites/機器/刪除 | 刪除匯入電腦 |
> | OffAzure/ImportSites/機器/讀取 | 取得匯入電腦的屬性 |
> | OffAzure/ImportSites/機器/刪除 | 刪除匯入電腦 |
> | OffAzure/ImportSites/機器/讀取 | 取得匯入電腦的屬性 |
> | OffAzure/ImportSites/機器/刪除 | 刪除匯入電腦 |
...
> | OffAzure/ServerSites/read | 取得伺服器網站的屬性 |
> | OffAzure/ServerSites/write | 建立或補救伺服器網站 |
> | OffAzure/ServerSites/delete | 刪除伺服器網站 |
> | OffAzure/ServerSites/refresh/action | 重新整理伺服器網站內的物件 |
> | OffAzure/ServerSites/updateProperties/action | 更新網站中電腦的屬性 |
> | OffAzure/ServerSites/read | 取得伺服器網站的屬性 |
> | OffAzure/ServerSites/write | 建立或補救伺服器網站 |
> | OffAzure/ServerSites/delete | 刪除伺服器網站 |
> | OffAzure/ServerSites/refresh/action | 重新整理伺服器網站內的物件 |
...
> | OffAzure/ServerSites/refresh/action | 重新整理伺服器網站內的物件 |
> | OffAzure/ServerSites/updateProperties/action | 更新網站中電腦的屬性 |
> | OffAzure/ServerSites/作業/讀取 | 取得伺服器作業的屬性 |
> | OffAzure/ServerSites/作業/讀取 | 取得伺服器作業的屬性 |
> | OffAzure/ServerSites/作業/讀取 | 取得伺服器作業的屬性 |
> | OffAzure/ServerSites/作業/讀取 | 取得伺服器作業的屬性 |
> | OffAzure/ServerSites/機器/讀取 | 取得伺服器電腦的屬性 |
> | OffAzure/ServerSites/機器/寫入 | 寫入伺服器電腦的屬性 |
> | OffAzure/ServerSites/機器/讀取 | 取得伺服器電腦的屬性 |
> | OffAzure/ServerSites/機器/寫入 | 寫入伺服器電腦的屬性 |
> | OffAzure/ServerSites/機器/讀取 | 取得伺服器電腦的屬性 |
> | OffAzure/ServerSites/機器/寫入 | 寫入伺服器電腦的屬性 |
> | OffAzure/ServerSites/機器/讀取 | 取得伺服器電腦的屬性 |
> | OffAzure/ServerSites/機器/寫入 | 寫入伺服器電腦的屬性 |
> | OffAzure/ServerSites/operationsstatus/read | 取得伺服器作業狀態的屬性 |
> | OffAzure/ServerSites/operationsstatus/read | 取得伺服器作業狀態的屬性 |
> | OffAzure/ServerSites/operationsstatus/read | 取得伺服器作業狀態的屬性 |
> | OffAzure/ServerSites/operationsstatus/read | 取得伺服器作業狀態的屬性 |
> | OffAzure/ServerSites/執行身分帳戶/read | 取得伺服器執行身分帳戶的屬性 |
> | OffAzure/ServerSites/執行身分帳戶/read | 取得伺服器執行身分帳戶的屬性 |
> | OffAzure/ServerSites/執行身分帳戶/read | 取得伺服器執行身分帳戶的屬性 |
> | OffAzure/ServerSites/執行身分帳戶/read | 取得伺服器執行身分帳戶的屬性 |
> | OffAzure/ServerSites/summary/read | 取得伺服器網站的摘要 |
> | OffAzure/ServerSites/summary/read | 取得伺服器網站的摘要 |
> | OffAzure/ServerSites/summary/read | 取得伺服器網站的摘要 |
> | OffAzure/ServerSites/summary/read | 取得伺服器網站的摘要 |
> | OffAzure/ServerSites/使用量/讀取 | 取得伺服器網站的使用方式 |
> | OffAzure/ServerSites/使用量/讀取 | 取得伺服器網站的使用方式 |
> | OffAzure/ServerSites/使用量/讀取 | 取得伺服器網站的使用方式 |
> | OffAzure/ServerSites/使用量/讀取 | 取得伺服器網站的使用方式 |
...
> | OffAzure/VMwareSites/exportapplications/action | 將 VMware 應用程式和角色資料匯出至 xls |
> | OffAzure/VMwareSites/updateProperties/action | 更新網站中電腦的屬性 |
> | OffAzure/VMwareSites/generateCoarseMap/action | 產生電腦清單的粗略對應 |
> | OffAzure/VMwareSites/generateDetailedMap/action | 產生詳細的 VMware 粗略地圖 |
> | OffAzure/VMwareSites/clientGroupMembers/action | 列出所選取用戶端群組的用戶端群組成員。 |
> | OffAzure/VMwareSites/serverGroupMembers/action | 列出所選伺服器群組的伺服器群組成員。 |
> | OffAzure/VMwareSites/getApplications/action | 取得所選電腦的清單應用程式資訊 |
> | OffAzure/VMwareSites/exportDependencies/action | 匯出所選電腦的相依性資訊 |
> | Microsoft.OffAzure/VMwareSites/read | 取得 VMware 站台的屬性 |
> | Microsoft.OffAzure/VMwareSites/write | 建立或更新 VMware 站台 |
> | Microsoft.OffAzure/VMwareSites/delete | 刪除 VMware 站台 |
> | Microsoft.OffAzure/VMwareSites/refresh/action | 重新整理 VMware 站台內的物件 |
...
> | OffAzure/VMwareSites/getApplications/action | 取得所選電腦的清單應用程式資訊 |
> | OffAzure/VMwareSites/exportDependencies/action | 匯出所選電腦的相依性資訊 |
> | OffAzure/VMwareSites/healthsummary/read | 取得 VMware 資源的健全狀況摘要 |
> | OffAzure/VMwareSites/healthsummary/read | 取得 VMware 資源的健全狀況摘要 |
> | OffAzure/VMwareSites/healthsummary/read | 取得 VMware 資源的健全狀況摘要 |
> | OffAzure/VMwareSites/healthsummary/read | 取得 VMware 資源的健全狀況摘要 |
...
> | Microsoft.OffAzure/VMwareSites/machines/stop/action | 停止 VMware 機器 |
> | Microsoft.OffAzure/VMwareSites/machines/start/action | 啟動 VMware 機器 |
> | OffAzure/VMwareSites/機器/應用程式/讀取 | 取得 VMware 機器應用程式的屬性 |
> | OffAzure/VMwareSites/機器/應用程式/讀取 | 取得 VMware 機器應用程式的屬性 |
> | OffAzure/VMwareSites/機器/應用程式/讀取 | 取得 VMware 機器應用程式的屬性 |
> | OffAzure/VMwareSites/機器/應用程式/讀取 | 取得 VMware 機器應用程式的屬性 |
...
> | Microsoft.OffAzure/VMwareSites/runasaccounts/read | 取得 VMware 執行身分帳戶的屬性 |
> | Microsoft.OffAzure/VMwareSites/runasaccounts/read | 取得 VMware 執行身分帳戶的屬性 |
> | OffAzure/VMwareSites/summary/read | 取得 VMware 網站的摘要 |
> | OffAzure/VMwareSites/summary/read | 取得 VMware 網站的摘要 |
> | OffAzure/VMwareSites/summary/read | 取得 VMware 網站的摘要 |
> | OffAzure/VMwareSites/summary/read | 取得 VMware 網站的摘要 |
...
> | Microsoft.alertsmanagement/smartDetectorAlertRules/write | 在指定的訂用帳戶中建立或更新智慧偵測器警示規則 |
> | Microsoft.alertsmanagement/smartDetectorAlertRules/read | 取得輸入篩選的所有智慧偵測器警示規則 |
...
> | Microsoft Insights/基準/讀取 | 讀取度量基準（預覽） |
...
> | Microsoft Insights/Components/DailyCapReached/Action | 已達到 Application Insights 元件的每日上限 |
> | Microsoft Insights/Components/DailyCapWarningThresholdReached/Action | 已達到 Application Insights 元件的每日上限警告閾值 |
...
> | Microsoft Insights/Components/provider/Microsoft Insights/diagnosticSettings/Read | 讀取資源診斷設定 |
> | Microsoft Insights/Components/provider/Microsoft Insights/diagnosticSettings/Write | 建立或更新資源診斷設定 |
> | Microsoft Insights/Components/provider/Microsoft Insights/logDefinitions/Read | 讀取記錄定義 |
...
> | Microsoft Insights/Logs/Tables。自訂/讀取 | 從任何自訂記錄檔讀取資料 |
...
> | Microsoft Insights/MetricBaselines/Read | 讀取度量基準 |
...
> | Microsoft Insights/計量/Microsoft Insights/讀取 | 讀取計量 |
> | Microsoft.Insights/Metrics/providers/Metrics/Read | 讀取計量 |
> | Microsoft Insights/myWorkbooks/Write | 建立或更新私用活頁簿 |
...
> | Microsoft Insights/PrivateLinkScopeOperationStatuses/Read | 讀取已設定範圍的私人連結操作狀態 |
...
> | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Read | 讀取私人端點連接 proxy |
> | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Write | 建立或更新私人端點連接 proxy |
> | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Delete | 刪除私人端點連接 proxy |
> | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Validate/Action | 驗證私用端點連接 proxy |
> | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnections/Read | 讀取私人端點連接 |
> | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnections/Write | 建立或更新私人端點連接 |
> | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnections/Delete | 刪除私人端點連接 |
> | Microsoft Insights/PrivateLinkScopes/PrivateLinkResources/Read | 讀取私人連結資源 |
> | Microsoft Insights/PrivateLinkScopes/ScopedResources/Read | 讀取已設定範圍的私人連結資源 |
> | Microsoft Insights/PrivateLinkScopes/ScopedResources/Write | 建立或更新已設定範圍的私人連結資源 |
> | Microsoft Insights/PrivateLinkScopes/ScopedResources/Delete | 刪除已設定範圍的私人連結資源 |
...
> | microsoft.operationalinsights/register/action | Rergisters 訂用帳戶。 |
> | microsoft.operationalinsights/取消註冊/動作 | 取消註冊訂用帳戶。 |
> | microsoft.operationalinsights/availableservicetiers/read | 取得可用的服務層級。 |
> | Microsoft.operationalinsights/叢集/讀取 | 取得叢集 |
> | Microsoft.operationalinsights/叢集/寫入 | 建立或更新叢集 |
> | Microsoft.operationalinsights/叢集/刪除 | 刪除叢集 |
> | Microsoft.operationalinsights/deletedWorkspaces/read | 列出虛刪除期間的工作區。 |
> | Microsoft.OperationalInsights/linkTargets/read | 列出虛刪除期間的工作區。 |
> | microsoft.operationalinsights/位置/operationStatuses/讀取 | 取得 Log Analytics Azure 非同步作業狀態。 |
...
> | Microsoft.operationalinsights/workspace/availableservicetiers/read | 工作區的所有可用服務層級清單。 |
...
> | microsoft.operationalinsights/workspace/dataExports/read | 取得特定的資料匯出。 |
> | microsoft.operationalinsights/workspace/dataExports/write | 建立或更新資料匯出。 |
> | microsoft.operationalinsights/workspace/dataExports/delete | 刪除特定的資料匯出。 |
...
> | microsoft.operationalinsights/工作區/作業/讀取 | 取得 Microsoft.operationalinsights 工作區作業的狀態。 |
> | Microsoft.OperationalInsights/workspaces/query/read | 針對工作區中的資料執行查詢 |
> | Microsoft.operationalinsights/工作區/查詢/AADDomainServicesAccountLogon/讀取 | 讀取來自 AADDomainServicesAccountLogon 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AADDomainServicesAccountManagement/讀取 | 讀取來自 AADDomainServicesAccountManagement 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AADDomainServicesDirectoryServiceAccess/讀取 | 讀取來自 AADDomainServicesDirectoryServiceAccess 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AADDomainServicesLogonLogoff/讀取 | 讀取來自 AADDomainServicesLogonLogoff 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/AddonAzureBackupPolicy/讀取 | 讀取來自 AddonAzureBackupPolicy 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AddonAzureBackupProtectedInstance/讀取 | 讀取來自 AddonAzureBackupProtectedInstance 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AddonAzureBackupStorage/讀取 | 讀取來自 AddonAzureBackupStorage 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFActivityRun/讀取 | 讀取來自 ADFActivityRun 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFPipelineRun/讀取 | 讀取來自 ADFPipelineRun 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFSSISIntegrationRuntimeLogs/讀取 | 讀取來自 ADFSSISIntegrationRuntimeLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFSSISPackageEventMessageCoNtext/讀取 | 讀取來自 ADFSSISPackageEventMessageCoNtext 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFSSISPackageEventMessages/讀取 | 讀取來自 ADFSSISPackageEventMessages 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFSSISPackageExecutableStatistics/讀取 | 讀取來自 ADFSSISPackageExecutableStatistics 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFSSISPackageExecutionComponentPhases/讀取 | 讀取來自 ADFSSISPackageExecutionComponentPhases 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFSSISPackageExecutionDataStatistics/讀取 | 讀取來自 ADFSSISPackageExecutionDataStatistics 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADFTriggerRun/讀取 | 讀取來自 ADFTriggerRun 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/ADTDigitalTwinsOperation/讀取 | 讀取來自 ADTDigitalTwinsOperation 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADTEventRoutesOperation/讀取 | 讀取來自 ADTEventRoutesOperation 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADTModelsOperation/讀取 | 讀取來自 ADTModelsOperation 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ADTQueryOperation/讀取 | 讀取來自 ADTQueryOperation 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AegDeliveryFailureLogs/讀取 | 讀取來自 AegDeliveryFailureLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AegPublishFailureLogs/讀取 | 讀取來自 AegPublishFailureLogs 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/AmlComputeClusterEvent/讀取 | 讀取來自 AmlComputeClusterEvent 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AmlComputeClusterNodeEvent/讀取 | 讀取來自 AmlComputeClusterNodeEvent 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AmlComputeCpuGpuUtilization/讀取 | 讀取來自 AmlComputeCpuGpuUtilization 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AmlComputeJobEvent/讀取 | 讀取來自 AmlComputeJobEvent 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AmlRunStatusChangedEvent/讀取 | 讀取來自 AmlRunStatusChangedEvent 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ApiManagementGatewayLogs/讀取 | 讀取來自 ApiManagementGatewayLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppAvailabilityResults/讀取 | 讀取來自 AppAvailabilityResults 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppBrowserTimings/讀取 | 讀取來自 AppBrowserTimings 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/AppCenterError/read | 從 AppCenterError 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppDependencies/讀取 | 讀取來自 AppDependencies 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppEvents/讀取 | 讀取來自 AppEvents 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppExceptions/讀取 | 讀取來自 AppExceptions 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/ApplicationInsights/read | 從 ApplicationInsights 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppMetrics/讀取 | 讀取來自 AppMetrics 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppPageViews/讀取 | 讀取來自 AppPageViews 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppPerformanceCounters/讀取 | 讀取來自 AppPerformanceCounters 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppPlatformLogsforSpring/讀取 | 讀取來自 AppPlatformLogsforSpring 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppPlatformSystemLogs/讀取 | 讀取來自 AppPlatformSystemLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppRequests/讀取 | 讀取來自 AppRequests 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppServiceAppLogs/讀取 | 讀取來自 AppServiceAppLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppServiceAuditLogs/讀取 | 讀取來自 AppServiceAuditLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppServiceConsoleLogs/讀取 | 讀取來自 AppServiceConsoleLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppServiceEnvironmentPlatformLogs/讀取 | 讀取來自 AppServiceEnvironmentPlatformLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppServiceFileAuditLogs/讀取 | 讀取來自 AppServiceFileAuditLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppServiceHTTPLogs/讀取 | 讀取來自 AppServiceHTTPLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppServicePlatformLogs/讀取 | 讀取來自 AppServicePlatformLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppSystemEvents/讀取 | 讀取來自 AppSystemEvents 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AppTraces/讀取 | 讀取來自 AppTraces 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/AuditLogs/read | 從 AuditLogs 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/AutoscaleEvaluationsLog/讀取 | 讀取來自 AutoscaleEvaluationsLog 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AutoscaleScaleActionsLog/讀取 | 讀取來自 AutoscaleScaleActionsLog 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AWSCloudTrail/讀取 | 讀取來自 AWSCloudTrail 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/AzureActivity/read | 從 AzureActivity 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/AzureAssessmentRecommendation/讀取 | 讀取來自 AzureAssessmentRecommendation 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AzureDevOpsAuditing/讀取 | 讀取來自 AzureDevOpsAuditing 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AzureDiagnostics/讀取 | 讀取來自 AzureDiagnostics 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/AzureDiagnostics/讀取 | 讀取來自 AzureDiagnostics 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/AzureMetrics/read | 從 AzureMetrics 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/BaiClusterEvent/讀取 | 讀取來自 BaiClusterEvent 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/BaiClusterNodeEvent/讀取 | 讀取來自 BaiClusterNodeEvent 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/BaiJobEvent/讀取 | 讀取來自 BaiJobEvent 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/BehaviorAnalytics/讀取 | 讀取來自 BehaviorAnalytics 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/BlockchainApplicationLog/讀取 | 讀取來自 BlockchainApplicationLog 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/BlockchainProxyLog/讀取 | 讀取來自 BlockchainProxyLog 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/ContainerNodeInventory/讀取 | 讀取來自 ContainerNodeInventory 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ContainerRegistryLoginEvents/讀取 | 讀取來自 ContainerRegistryLoginEvents 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/ContainerRegistryRepositoryEvents/讀取 | 讀取來自 ContainerRegistryRepositoryEvents 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/ContainerServiceLog/read | 從 ContainerServiceLog 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/CoreAzureBackup/讀取 | 讀取來自 CoreAzureBackup 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksAccounts/讀取 | 讀取來自 DatabricksAccounts 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksClusters/讀取 | 讀取來自 DatabricksClusters 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksDBFS/讀取 | 讀取來自 DatabricksDBFS 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksInstancePools/讀取 | 讀取來自 DatabricksInstancePools 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksJobs/讀取 | 讀取來自 DatabricksJobs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksNotebook/讀取 | 讀取來自 DatabricksNotebook 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksSecrets/讀取 | 讀取來自 DatabricksSecrets 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksSQLPermissions/讀取 | 讀取來自 DatabricksSQLPermissions 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksSSH/讀取 | 讀取來自 DatabricksSSH 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksTables/讀取 | 讀取來自 DatabricksTables 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/DatabricksWorkspace/讀取 | 讀取來自 DatabricksWorkspace 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/相依性/讀取 | 從相依性資料表讀取資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/DHCPActivity/讀取 | 讀取來自 DHCPActivity 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/Dynamics365Activity/讀取 | 讀取來自 Dynamics365Activity 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/FailedIngestion/讀取 | 讀取來自 FailedIngestion 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/FunctionAppLogs/讀取 | 讀取來自 FunctionAppLogs 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/Heartbeat/read | 從 Heartbeat 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/HuntingBookmark/讀取 | 讀取來自 HuntingBookmark 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/InsightsMetrics/讀取 | 讀取來自 InsightsMetrics 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/IntuneAuditLogs/read | 從 IntuneAuditLogs 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/IntuneDeviceComplianceOrg/讀取 | 讀取來自 IntuneDeviceComplianceOrg 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/IntuneOperationalLogs/read | 從 IntuneOperationalLogs 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/IoTHubDistributedTracing/讀取 | 讀取來自 IoTHubDistributedTracing 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/KubeEvents/read | 從 KubeEvents 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/KubeHealth/讀取 | 讀取來自 KubeHealth 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/KubeMonAgentEvents/讀取 | 讀取來自 KubeMonAgentEvents 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/MADeviceNRT/讀取 | 讀取來自 MADeviceNRT 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/MAOfficeAddinEntityHealth/讀取 | 讀取來自 MAOfficeAddinEntityHealth 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/MAOfficeAddinHealth/read | 從 MAOfficeAddinHealth 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/MAOfficeAddinHealthEventNRT/讀取 | 讀取來自 MAOfficeAddinHealthEventNRT 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/MAOfficeAppCrashesNRT/讀取 | 讀取來自 MAOfficeAppCrashesNRT 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/MAOfficeAppInstanceHealth/讀取 | 讀取來自 MAOfficeAppInstanceHealth 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppReadiness/read | 從 MAOfficeAppReadiness 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/MAOfficeAppSessionsNRT/讀取 | 讀取來自 MAOfficeAppSessionsNRT 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/MAOfficeDeploymentStatusNRT/讀取 | 讀取來自 MAOfficeDeploymentStatusNRT 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MAOfficeMacroErrorNRT/讀取 | 讀取來自 MAOfficeMacroErrorNRT 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MAOfficeMacroGlobalHealth/讀取 | 讀取來自 MAOfficeMacroGlobalHealth 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/MAWindowsDeploymentStatusNRT/讀取 | 讀取來自 MAWindowsDeploymentStatusNRT 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/McasShadowItReporting/讀取 | 讀取來自 McasShadowItReporting 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MicrosoftAzureBastionAuditLogs/讀取 | 讀取來自 MicrosoftAzureBastionAuditLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MicrosoftDataShareReceivedSnapshotLog/讀取 | 讀取來自 MicrosoftDataShareReceivedSnapshotLog 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MicrosoftDataShareSentSnapshotLog/讀取 | 讀取來自 MicrosoftDataShareSentSnapshotLog 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MicrosoftDataShareShareLog/讀取 | 讀取來自 MicrosoftDataShareShareLog 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MicrosoftDynamicsTelemetryPerformanceLogs/讀取 | 讀取來自 MicrosoftDynamicsTelemetryPerformanceLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MicrosoftDynamicsTelemetrySystemMetricsLogs/讀取 | 讀取來自 MicrosoftDynamicsTelemetrySystemMetricsLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/MicrosoftHealthcareApisAuditLogs/讀取 | 讀取來自 MicrosoftHealthcareApisAuditLogs 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/要求/讀取 | 從要求資料表讀取資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/SecurityIncident/讀取 | 讀取來自 SecurityIncident 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/SecurityIoTRawEvent/讀取 | 讀取來自 SecurityIoTRawEvent 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/SecurityNestedRecommendation/讀取 | 讀取來自 SecurityNestedRecommendation 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/SecurityRecommendation/讀取 | 讀取來自 SecurityRecommendation 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/SignalRServiceDiagnosticLogs/讀取 | 讀取來自 SignalRServiceDiagnosticLogs 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/SqlDataClassification/讀取 | 讀取來自 SqlDataClassification 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/SQLQueryPerformance/read | 從 SQLQueryPerformance 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/SqlVulnerabilityAssessmentResult/讀取 | 讀取來自 SqlVulnerabilityAssessmentResult 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/StorageBlobLogs/讀取 | 讀取來自 StorageBlobLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/StorageFileLogs/讀取 | 讀取來自 StorageFileLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/StorageQueueLogs/讀取 | 讀取來自 StorageQueueLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/StorageTableLogs/讀取 | 讀取來自 StorageTableLogs 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/SucceededIngestion/讀取 | 讀取來自 SucceededIngestion 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/ThreatIntelligenceIndicator/讀取 | 讀取來自 ThreatIntelligenceIndicator 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/TSIIngress/讀取 | 讀取來自 TSIIngress 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/VMComputer/讀取 | 讀取來自 VMComputer 資料表的資料 |
> | Microsoft.OperationalInsights/workspaces/query/VMConnection/read | 從 VMConnection 資料表讀取資料 |
> | Microsoft.operationalinsights/工作區/查詢/VMProcess/讀取 | 讀取來自 VMProcess 資料表的資料 |
...
> | Microsoft.operationalinsights/工作區/查詢/WVDCheckpoints/讀取 | 讀取來自 WVDCheckpoints 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/WVDConnections/讀取 | 讀取來自 WVDConnections 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/WVDErrors/讀取 | 讀取來自 WVDErrors 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/WVDFeeds/讀取 | 讀取來自 WVDFeeds 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/WVDHostRegistrations/讀取 | 讀取來自 WVDHostRegistrations 資料表的資料 |
> | Microsoft.operationalinsights/工作區/查詢/WVDManagement/讀取 | 讀取來自 WVDManagement 資料表的資料 |
...
> | 動作 | 描述 |
> | --- | --- |
> | Microsoft.WorkloadMonitor/components/read | 取得資源的元件 |
> | Microsoft.WorkloadMonitor/componentsSummary/read | 取得元件的摘要 |
> | Microsoft.WorkloadMonitor/monitorInstances/read | 取得資源的監視器執行個體 |
> | Microsoft.WorkloadMonitor/monitorInstancesSummary/read | 取得監視器執行個體的摘要 |
> | Microsoft.WorkloadMonitor/monitors/read | 取得資源的監視器 |
> | Microsoft.WorkloadMonitor/monitors/write | 設定資源的監視器 |
> | Microsoft.WorkloadMonitor/notificationSettings/read | 取得資源的通知設定 |
> | Microsoft.WorkloadMonitor/notificationSettings/write | 設定資源的通知設定 |
> | Microsoft.WorkloadMonitor/operations/read | 取得支援的作業 |
...
> | Microsoft。授權/原則/audit/action | 以 ' audit ' 效果評估 Azure 原則的結果所採取的動作 |
> | Microsoft. Authorization/原則/auditIfNotExists/action | 以 ' auditIfNotExists ' 效果評估 Azure 原則的結果所採取的動作 |
> | Microsoft。授權/原則/拒絕/動作 | 以 ' deny ' 效果評估 Azure 原則的結果所採取的動作 |
> | Microsoft. Authorization/原則/deployIfNotExists/action | 以 ' deployIfNotExists ' 效果評估 Azure 原則的結果所採取的動作 |
...
> | Microsoft 授權/policyAssignments/privateLinkAssociations/read | 取得私人連結關聯的相關資訊。 |
> | Microsoft 授權/policyAssignments/privateLinkAssociations/write | 建立或更新私用連結關聯。 |
> | Microsoft 授權/policyAssignments/privateLinkAssociations/delete | 刪除私人連結關聯。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/read | 取得資源管理私人連結的相關資訊。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/write | 建立或更新資源管理私人連結。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/delete | 刪除資源管理私人連結。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/privateEndpointConnectionProxies/read | 取得私人端點連接 proxy 的相關資訊。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/privateEndpointConnectionProxies/write | 建立或更新私用端點連接 proxy。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/privateEndpointConnectionProxies/delete | 刪除私用端點連接 proxy。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/privateEndpointConnectionProxies/validate/action | 驗證私用端點連接 proxy。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/privateEndpointConnections/read | 取得私人端點連接的相關資訊。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/privateEndpointConnections/write | 建立或更新私用端點連接。 |
> | Microsoft 授權/policyAssignments/resourceManagementPrivateLinks/privateEndpointConnections/delete | 刪除私用端點連接。 |
...
> | Microsoft. Automation/automationAccounts/privateEndpointConnectionProxies/read | 讀取 Azure 自動化私用端點連接 Proxy |
> | AutomationAccounts/privateEndpointConnectionProxies/write | 建立 Azure 自動化私用端點連接 Proxy |
> | Microsoft. Automation/automationAccounts/privateEndpointConnectionProxies/validate/action | 驗證私用端點連接要求（groupId 驗證） |
> | AutomationAccounts/privateEndpointConnectionProxies/delete | 刪除 Azure 自動化私用端點連接 Proxy |
> | Microsoft. Automation/automationAccounts/privateEndpointConnectionProxies/operationResults/read | 取得 Azure 自動化私用端點 proxy 操作結果。 |
> | Microsoft. Automation/automationAccounts/privateEndpointConnections/read | 取得 Azure 自動化私人端點線上狀態 |
> | AutomationAccounts/privateEndpointConnections/write | 核准或拒絕 Azure 自動化的私用端點連接 |
...
> | Microsoft. Automation/automationAccounts/softwareUpdateConfigurationMachineRuns/read | 取得 Azure 自動化軟體更新設定機器執行 |
> | Microsoft. Automation/automationAccounts/softwareUpdateConfigurationRuns/read | 取得 Azure 自動化軟體更新設定執行 |
...
> | Microsoft.Batch/batchAccounts/privateEndpointConnectionResults/read | 取得長時間執行的 Batch 帳戶私用端點連接作業的結果 |
> | Microsoft.Batch/batchAccounts/privateEndpointConnections/write | 更新 Batch 帳戶上的現有私用端點連線 |
> | Microsoft.Batch/batchAccounts/privateEndpointConnections/read | 取得私人端點連線，或列出 Batch 帳戶上的私用端點連接 |
> | Microsoft.Batch/batchAccounts/privateLinkResources/read | 取得私人連結資源的屬性，或列出 Batch 帳戶上的私用連結資源 |
...
> | 動作 | 描述 |
> | --- | --- |
> | Microsoft 帳單/validateAddress/動作 |  |
> | Microsoft.Billing/register/action |  |
> | Microsoft.Billing/billingAccounts/read |  |
> | Microsoft 帳單/billingAccounts/listInvoiceSectionsWithCreateSubscriptionPermission/動作 |  |
> | Microsoft 帳單/billingAccounts/寫入 |  |
...
> | Microsoft 帳單/billingAccounts/billingProfiles/客戶/讀取 |  |
> | Microsoft 帳單/billingAccounts/billingProfiles/invoiceSections/read |  |
> | Microsoft 帳單/billingAccounts/billingProfiles/invoiceSections/write |  |
...
> | Microsoft 帳單/billingAccounts/billingSubscriptions/移動/動作 |  |
> | Microsoft 帳單/billingAccounts/billingSubscriptions/validateMoveEligibility/action |  |
> | Microsoft 帳單/billingAccounts/客戶/讀取 |  |
> | Microsoft 帳單/billingAccounts/customers/billingPermissions/read |  |
> | Microsoft.Billing/billingAccounts/departments/read |  |
> | Microsoft 帳單/billingAccounts/部門/billingPermissions/閱讀 |  |
...
> | Microsoft 帳單/billingAccounts/產品/移動/動作 |  |
> | Microsoft 帳單/billingAccounts/產品/validateMoveEligibility/動作 |  |
> | Microsoft.Billing/departments/read |  |
> | Microsoft 帳單/發票/下載/動作 | 使用來自清單的下載連結來下載發票 |
> | Microsoft 帳單/作業/讀取 |  |
...
> | Microsoft。容量/calculateexchange/動作 | 計算新購買的交換金額和價格，並傳回原則錯誤。 |
...
> | 動作 | 描述 |
> | --- | --- |
> | Microsoft Commerce/註冊/動作 | 註冊 Microsoft Commerce UsageAggregate 的訂用帳戶 |
...
> | CostManagement/register/action | 為訂用帳戶 CostManagement 的範圍註冊動作。 |
> | CostManagement/views/action | 建立 view。 |
> | CostManagement/預測/動作 | 依範圍預測使用量資料。 |
> | CostManagement/警示/寫入 | 更新警示。 |
> | CostManagement/警示/讀取 | 列出警示。 |
> | CostManagement/cloudConnectors/read | 列出已驗證之使用者的 cloudConnectors。 |
> | CostManagement/cloudConnectors/write | 建立或更新指定的 Cloudconnector 為必要。 |
> | CostManagement/cloudConnectors/delete | 刪除指定的 Cloudconnector 為必要。 |
...
> | CostManagement/externalBillingAccounts/read | 列出已驗證之使用者的 externalBillingAccounts。 |
> | CostManagement/externalBillingAccounts/查詢/動作 | 查詢外部 BillingAccounts 的使用量資料。 |
> | CostManagement/externalBillingAccounts/預測/動作 | 預測外部 BillingAccounts 的使用量資料。 |
> | CostManagement/externalBillingAccounts/dimension/read | 列出外部 BillingAccounts 的所有支援維度。 |
> | CostManagement/externalBillingAccounts/externalSubscriptions/read | 列出已驗證使用者的 externalBillingAccount 內的 externalSubscriptions。 |
> | CostManagement/externalBillingAccounts/預測/讀取 | 預測外部 BillingAccounts 的使用量資料。 |
> | CostManagement/externalBillingAccounts/查詢/讀取 | 查詢外部 BillingAccounts 的使用量資料。 |
> | CostManagement/externalSubscriptions/read | 列出已驗證之使用者的 externalSubscriptions。 |
> | CostManagement/externalSubscriptions/write | 更新 externalSubscription 的相關管理群組 |
> | CostManagement/externalSubscriptions/查詢/動作 | 查詢外部訂用帳戶的使用量資料。 |
> | CostManagement/externalSubscriptions/預測/動作 | 預測外部 BillingAccounts 的使用量資料。 |
> | CostManagement/externalSubscriptions/dimension/read | 列出外部訂用帳戶的所有支援維度。 |
> | CostManagement/externalSubscriptions/預測/讀取 | 預測外部 BillingAccounts 的使用量資料。 |
> | CostManagement/externalSubscriptions/查詢/讀取 | 查詢外部訂用帳戶的使用量資料。 |
> | CostManagement/預測/讀取 | 依範圍預測使用量資料。 |
> | CostManagement/作業/讀取 | 列出 CostManagement 資源提供者所支援的所有作業。 |
> | Microsoft.CostManagement/query/read | 依範圍查使用狀況資料。 |
> | Microsoft.CostManagement/reports/read | 依範圍排定使用狀況資料報告。 |
> | CostManagement/tenant/register/action | 向租使用者註冊 CostManagement 範圍的動作。 |
> | CostManagement/views/read | 列出所有已儲存的視圖。 |
> | CostManagement/views/delete | 刪除已儲存的視圖。 |
> | CostManagement/views/write | 更新 view。 |
...
> | 動作 | 描述 |
> | --- | --- |
> | GuestConfiguration/register/action | 為 GuestConfiguration 資源提供者註冊訂用帳戶。 |
...
> | GuestConfiguration/guestConfigurationAssignments/delete | 刪除來賓設定指派。 |
> | Microsoft.GuestConfiguration/guestConfigurationAssignments/reports/read | 取得來賓組態指派報告。 |
> | GuestConfiguration/作業/讀取 | 取得 GuestConfiguration 資源提供者的作業 |
...
> | 動作 | 描述 |
> | --- | --- |
> | HybridCompute/register/action | 為 HybridCompute 資源提供者註冊訂用帳戶 |
...
> | Microsoft.HybridCompute/machines/reconnect/action | 重新連接 Azure Arc 機器 |
> | HybridCompute/電腦/擴充功能/讀取 | 讀取任何 Azure Arc 延伸模組 |
...
> | 動作 | 描述 |
> | --- | --- |
> | ManagedServices/register/action | 註冊至受管理的服務。 |
> | ManagedServices/取消註冊/動作 | 從受管理的服務取消註冊。 |
> | ManagedServices/marketplaceRegistrationDefinitions/read | 抓取受控服務註冊定義的清單。 |
> | ManagedServices/作業/讀取 | 抓取受控服務作業的清單。 |
...
> | ManagedServices/registrationAssignments/write | 新增或修改受控服務註冊指派。 |
> | Microsoft.ManagedServices/registrationAssignments/delete | 移除受控服務註冊指派。 |
> | ManagedServices/registrationDefinitions/read | 抓取受控服務註冊定義的清單。 |
> | ManagedServices/registrationDefinitions/write | 新增或修改受控服務註冊定義。 |
> | ManagedServices/registrationDefinitions/delete | 移除受控服務註冊定義。 |
...
> | Microsoft 管理/managementGroups/下階/讀取 | 取得管理群組的所有子系（管理群組、訂閱）。 |
> | Microsoft 管理/managementGroups/設定/讀取 | 列出現有的管理群組階層設定。 |
...
> | Microsoft 管理/managementGroups/訂用帳戶/讀取 | 列出指定之管理群組下的訂用帳戶。 |
...
> | Microsoft.policyinsights/作業/讀取 | 取得 Microsoft.policyinsights 命名空間上支援的作業 |
...
> | Microsoft.PolicyInsights/remediations/write | 建立或更新 Microsoft Policy 補救。 |
...
> | azurerm.recoveryservices/位置/backupPreValidateProtection/動作 |  |
> | azurerm.recoveryservices/位置/backupStatus/動作 | 檢查復原服務保存庫的備份狀態 |
> | azurerm.recoveryservices/位置/backupValidateFeatures/動作 | 驗證功能 |
...
> | azurerm.recoveryservices/位置/backupProtectedItem/寫入 | 建立備用的受保護項目 |
> | azurerm.recoveryservices/位置/backupProtectedItems/讀取 | 傳回所有受保護項目的清單。 |
...
> | azurerm.recoveryservices/vault/backupJobsExport/action | 匯出作業 |
> | azurerm.recoveryservices/vault/backupSecurityPIN/action | 傳回復原服務保存庫的安全性 PIN 碼資訊。 |
> | azurerm.recoveryservices/vault/backupValidateOperation/action | 驗證受保護項目上的作業 |
...
> | azurerm.recoveryservices/vault/backupconfig/read | 傳回復原服務保存庫的組態。 |
> | azurerm.recoveryservices/vault/backupconfig/write | 更新復原服務保存庫的組態。 |
> | azurerm.recoveryservices/vault/backupEncryptionConfigs/read | 取得備份資源加密設定。 |
> | azurerm.recoveryservices/vault/backupEncryptionConfigs/write | 更新備份資源加密設定 |
> | azurerm.recoveryservices/vault/backupEngines/read | 傳回已向保存庫註冊的所有備份管理伺服器。 |
> | azurerm.recoveryservices/vault/backupFabrics/refreshContainers/action | 重新整理容器清單 |
> | azurerm.recoveryservices/vault/backupFabrics/backupProtectionIntent/delete | 刪除備份保護用途 |
> | azurerm.recoveryservices/vault/backupFabrics/backupProtectionIntent/read | 取得備份保護用途 |
> | azurerm.recoveryservices/vault/backupFabrics/backupProtectionIntent/write | 建立備份保護用途 |
> | azurerm.recoveryservices/vault/backupFabrics/operationResults/read | 傳回作業的狀態 |
> | azurerm.recoveryservices/vault/backupFabrics/operationsStatus/read | 傳回作業的狀態 |
> | azurerm.recoveryservices/vault/backupFabrics/protectableContainers/read | 取得所有可保護的容器 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/delete | 刪除已註冊的容器 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/inquire/action | 執行容器內工作負載的查詢 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/read | 傳回所有已註冊的容器 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/write | 建立已註冊的容器 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/items/read | 取得容器中的所有項目 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/operationResults/read | 取得對保護容器執行之作業的結果。 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/operationsStatus/read | 取得保護容器上執行之作業的狀態。 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/backup/action | 對受保護的項目執行備份。 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/delete | 刪除受保護的項目 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/read | 傳回受保護項目的物件詳細資料 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/write | 建立備用的受保護項目 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/operationResults/read | 取得對受保護項目執行之作業的結果。 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/operationsStatus/read | 傳回對受保護項目執行之作業的狀態。 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/recoveryPoints/provisionInstantItemRecovery/action | 為受保護的項目佈建即時項目復原 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/recoveryPoints/read | 取得受保護項目的復原點。 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/recoveryPoints/restore/action | 還原受保護項目的復原點。 |
> | azurerm.recoveryservices/vault/backupFabrics/protectionContainers/protectedItems/recoveryPoints/revokeInstantItemRecovery/action | 為受保護的項目撤銷即時項目復原 |
> | azurerm.recoveryservices/保存庫/backupJobs/取消/動作 | 取消作業 |
> | azurerm.recoveryservices/vault/backupJobs/read | 傳回所有作業物件 |
> | azurerm.recoveryservices/vault/backupJobs/operationResults/read | 傳回作業的作業結果。 |
> | azurerm.recoveryservices/vault/backupJobs/operationsStatus/read | 傳回作業操作的狀態。 |
> | azurerm.recoveryservices/vault/backupOperationResults/read | 傳回復原服務保存庫的備份作業結果。 |
> | azurerm.recoveryservices/vault/backupOperations/read | 傳回復原服務保存庫的備份作業狀態。 |
> | azurerm.recoveryservices/vault/backupPolicies/delete | 刪除保護原則 |
> | azurerm.recoveryservices/vault/backupPolicies/read | 傳回所有保護原則 |
> | azurerm.recoveryservices/vault/backupPolicies/write | 建立保護原則 |
> | azurerm.recoveryservices/vault/backupPolicies/operationResults/read | 取得原則作業的結果。 |
> | azurerm.recoveryservices/vault/backupPolicies/作業/讀取 | 取得原則作業的狀態。 |
> | azurerm.recoveryservices/vault/backupProtectableItems/read | 傳回所有可保護項目的清單。 |
> | azurerm.recoveryservices/vault/backupProtectedItems/read | 傳回所有受保護項目的清單。 |
> | azurerm.recoveryservices/vault/backupProtectionContainers/read | 傳回屬於訂用帳戶的所有容器 |
> | azurerm.recoveryservices/vault/backupProtectionIntents/read | 列出所有的備份保護用途 |
> | azurerm.recoveryservices/vault/backupstorageconfig/read | 傳回復原服務保存庫的儲存體組態。 |
> | azurerm.recoveryservices/vault/backupstorageconfig/write | 更新復原服務保存庫的儲存體組態。 |
> | azurerm.recoveryservices/vault/backupUsageSummaries/read | 傳回復原服務之受保護項目和受保護伺服器的摘要。 |
...
> | azurerm.recoveryservices/vault/privateEndpointConnectionProxies/delete | 等候幾分鐘的時間，然後再次嘗試操作。 如果問題持續發生， 請連絡 Microsoft 支援服務。 |
> | azurerm.recoveryservices/vault/privateEndpointConnectionProxies/read | 取得所有可保護的容器 |
> | azurerm.recoveryservices/保存庫/privateEndpointConnectionProxies/驗證/動作 | 取得所有可保護的容器 |
> | azurerm.recoveryservices/vault/privateEndpointConnectionProxies/write | 取得所有可保護的容器 |
> | azurerm.recoveryservices/vault/privateEndpointConnectionProxies/operationsStatus/read | 取得所有可保護的容器 |
> | azurerm.recoveryservices/vault/privateEndpointConnections/delete | 刪除私人端點要求。 此呼叫是由備份管理員進行。 |
> | azurerm.recoveryservices/vault/privateEndpointConnections/write | 核准或拒絕私用端點要求。 此呼叫是由備份管理員進行。 |
> | azurerm.recoveryservices/vault/privateEndpointConnections/operationsStatus/read | 傳回私用端點連接的作業狀態。 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/operationresults/read | 在資源網狀架構上追蹤非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/operationresults/read | 追蹤資源保護容器上非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/resync/action | 重新同步處理 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/operationresults/read | 追蹤資源遷移專案上非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/addDisks/action | 新增磁碟 |
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/removeDisks/action | 移除磁片 |
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/ResolveHealthErrors/action |  |
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/operationresults/read | 在受資源保護的專案上追蹤非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings/operationresults/read | 在資源保護容器對應上追蹤非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationRecoveryServicesProviders/operationresults/read | 在資源復原服務提供者上追蹤非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings/operationresults/read | 在資源儲存體分類對應上追蹤非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationFabrics/replicationvCenters/operationresults/read | 在資源 vCenters 上追蹤非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationJobs/operationresults/read | 在資源工作上追蹤非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationPolicies/operationresults/read | 追蹤對資源原則進行非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationRecoveryPlans/operationresults/read | 在資源復原計畫上追蹤非同步作業的結果 |
...
> | Azurerm.recoveryservices/vault/replicationVaultHealth/operationresults/read | 追蹤資源保存庫複寫健全狀況上非同步作業的結果 |
> | Azurerm.recoveryservices/vault/replicationVaultSettings/read | 讀取任何  |
> | Azurerm.recoveryservices/vault/replicationVaultSettings/write | 建立或更新任何  |
> | Microsoft.RecoveryServices/vaults/replicationvCenters/read | 讀取任何 vCenter |
> | azurerm.recoveryservices/保存庫/使用方式/讀取 | 傳回復原服務保存庫的使用量詳細資料。 |
...
> | Microsoft .Resources/calculateTemplateHash/action | 計算提供的範本雜湊。 |
...
> | Microsoft .Resources/部署/exportTemplate/動作 | 匯出部署的範本 |
> | Microsoft.Resources/deployments/operations/read | 取得或列出部署作業。 |
> | Microsoft .Resources/部署/operationstatuses/讀取 | 取得或列出部署作業狀態。 |
...
> | Microsoft .Resources/標記/讀取 | 取得資源上的所有標記。 |
> | Microsoft .Resources/tags/write | 藉由以一組新的標記取代或合併現有標記，或移除現有的標記，更新資源上的標記。 |
> | Microsoft .Resources/tags/delete | 移除資源上的所有標記。 |
...
> | Microsoft. 解決方案/取消註冊/動作 | 從解決方案中取消註冊。 |
...
> | Microsoft 解決方案/applicationDefinitions/applicationArtifacts/read | 列出應用程式定義的應用程式構件。 |
...
> | Microsoft. 解決方案/應用程式/refreshPermissions/動作 | 重新整理應用程式許可權。 |
> | Microsoft. 解決方案/應用程式/updateAccess/動作 | 更新應用程式存取。 |
> | Microsoft. 解決方案/應用程式/applicationArtifacts/讀取 | 列出應用程式成品。 |
...
> | Microsoft.BingMaps/mapApis/regenerateKey/action | 重新產生 BingMaps/mapApis 的金鑰 |
