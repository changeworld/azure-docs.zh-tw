...
> | 動作 | 微軟.計算/位置/專用端點連接代理Azure同步操作/讀取 | 取得非同步的專屬的動作的狀態 |
> |  | **位置/專用端接連線操作結果** |  |
> | 動作 | 微軟.計算/位置/私人端接代理操作結果/讀取 | 取得專用終結點連線代理操作的結果 |
> |  | **位置/發行者** |  |
...
> |  | **共用 VM 延伸** |  |
> | 動作 | 微軟.計算/共用VM擴展/讀取 | 取得分享 VM 擴充的屬性 |
> | 動作 | 微軟.計算/共用VM擴展/寫入 | 建立新的分享 VM 延伸或更新現有擴充 |
> | 動作 | 微軟.計算/共用VM擴展/刪除 | 移除分享 VM 擴充 |
> |  | **共用VM延伸/版本** |  |
> | 動作 | 微軟.計算/共用VM擴展/版本/讀取 | 取得分享 VM 擴充版本屬性 |
> | 動作 | 微軟.計算/共用VM擴展/版本/寫入 | 建立新的分享 VM 延伸版本或更新現有延伸版本 |
> | 動作 | 微軟.計算/共用VM擴展/版本/刪除 | 移除分享 VM 延伸版本 |
> |  | **共用VM圖像** |  |
...
> |  | **sshPublicKeys** |  |
> | 動作 | 微軟.計算/sshPublicKeys/讀取 | 取得 SSH 公開金鑰屬性 |
> | 動作 | 微軟.計算/sshPublicKeys/寫入 | 建立新的 SSH 公開金鑰或更新現有的 SSH 公開金鑰 |
> | 動作 | 微軟.計算/sshPublicKeys/刪除 | 移除 SSH 公開金鑰 |
> |  | **虛擬機器** |  |
...
> |  | **資料庫帳戶/api/資料庫** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑創建資料庫。 僅適用於 API 類型:「sql」,「蒙戈布」,「格林林」。。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取資料庫或列出所有資料庫。 僅適用於 API 類型:「sql」,「蒙戈布」,「格林林」。。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/刪除 | (已淘汰。 請使用沒有"/api/" 段的資源路徑刪除資料庫。 僅適用於 API 類型:「sql」,「蒙戈布」,「格林林」。。 |
> |  | **資料庫帳戶/apis/資料庫/集合** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/集合/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑創建或更新集合。 僅適用於 API 類型:「蒙戈布」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/集合/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取集合或列出所有集合。 僅適用於 API 類型:「蒙戈布」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/集合/刪除 | (已淘汰。 請使用沒有"/api/" 段的資源路徑刪除集合。 僅適用於 API 類型:「蒙戈布」。 |
> |  | **資料庫帳戶/apis/資料庫/集合/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/集合/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「蒙戈布」。 |
> |  | **資料庫帳戶/apis/資料庫/集合/設定** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/集合/設置/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑更新集合輸送量。 僅適用於 API 類型:「蒙戈布」。 僅適用於設置類型:「輸送量」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/集合/設置/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取集合輸送量。 僅適用於 API 類型:「蒙戈布」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳號/apis/資料庫/集合/設定/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/集合/設置/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「蒙戈布」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳戶/apis/資料庫/容器** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/容器/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑創建或更新容器。 僅適用於 API 類型:「sql」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/容器/讀取 | (已淘汰。 請使用沒有「/api/」 段的資源路徑讀取容器或列出所有容器。 僅適用於 API 類型:「sql」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/容器/刪除 | (已淘汰。 請使用沒有"/api/" 段的資源路徑刪除容器。 僅適用於 API 類型:「sql」。 |
> |  | **資料庫帳號/apis/資料庫/容器/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/容器/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「sql」。 |
> |  | **資料庫帳戶/apis/資料庫/容器/設定** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/容器/設置/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑更新容器輸送量。 僅適用於 API 類型:「sql」。 僅適用於設置類型:「輸送量」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/容器/設置/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取容器輸送量。 僅適用於 API 類型:「sql」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳號/apis/資料庫/容器/設定/操作結果** |  |
> | 動作 | 微軟.DocumentDB/資料庫帳戶/apis/資料庫/容器/設置/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「sql」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳戶/apis/資料庫/圖形** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/圖形/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑創建或更新圖形。 僅適用於 API 類型:「格林林」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/圖形/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取圖形或列出所有圖形。 僅適用於 API 類型:「格林林」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/圖形/刪除 | (已淘汰。 請使用沒有"/api/" 段的資源路徑刪除圖形。 僅適用於 API 類型:「格林林」。 |
> |  | **資料庫帳號/apis/資料庫/圖形/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/圖形/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「格林林」。 |
> |  | **資料庫帳號/apis/資料庫/圖形/設定** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/圖形/設置/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑更新圖形輸送量。 僅適用於 API 類型:「格林林」。 僅適用於設置類型:「輸送量」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/圖形/設置/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取圖形輸送量。 僅適用於 API 類型:「格林林」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳號/apis/資料庫/圖形/設定/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/圖形/設置/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「格林林」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳號/apis/資料庫/動作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「sql」,「蒙戈布」,「格林林」。。 |
> |  | **資料庫帳戶/apis/資料庫/設定** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/設置/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑更新資料庫輸送量。 僅適用於 API 類型:「sql」,「蒙戈布」,「格林林」。。 僅適用於設置類型:「輸送量」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/設置/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取資料庫輸送量。 僅適用於 API 類型:「sql」,「蒙戈布」,「格林林」。。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳號/apis/資料庫/設定/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/資料庫/設置/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「sql」,「蒙戈布」,「格林林」。。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳戶/api/鍵空間** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑創建鍵空間。 僅適用於 API 類型:「卡桑德拉」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取鍵空間或列出所有鍵空間。 僅適用於 API 類型:「卡桑德拉」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/刪除 | (已淘汰。 請使用沒有"/api/" 段的資源路徑刪除鍵空間。 僅適用於 API 類型:「卡桑德拉」。 |
> |  | **資料庫帳戶/apis/鍵空間/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「卡桑德拉」。 |
> |  | **資料庫帳戶/apis/鍵空間/設定** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/設置/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑更新密鑰空間輸送量。 僅適用於 API 類型:「卡桑德拉」。 僅適用於設置類型:「輸送量」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/設置/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取密鑰空間輸送量。 僅適用於 API 類型:「卡桑德拉」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳戶/apis/鍵空間/設定/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/設置/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「卡桑德拉」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳戶/api/鍵空間/表** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/表/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑創建或更新表。 僅適用於 API 類型:「卡桑德拉」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/表/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取表或列出所有表。 僅適用於 API 類型:「卡桑德拉」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/表/刪除 | (已淘汰。 請使用沒有"/api/" 段的資源路徑刪除表。 僅適用於 API 類型:「卡桑德拉」。 |
> |  | **資料庫帳戶/api/鍵空間/表/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/表/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「卡桑德拉」。 |
> |  | **資料庫帳戶/apis/鍵空間/表/設定** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/表/設置/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑更新表輸送量。 僅適用於 API 類型:「卡桑德拉」。 僅適用於設置類型:「輸送量」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/表/設置/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取表輸送量。 僅適用於 API 類型:「卡桑德拉」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳戶/apis/鍵空間/表/設定/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/鍵空間/表/設置/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「卡桑德拉」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳戶/api/表** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/表/寫 | (已淘汰。 請使用沒有"/api/" 段的資源路徑創建或更新表。 僅適用於 API 類型:「表」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/表/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取表或列出所有表。 僅適用於 API 類型:「表」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/表/刪除 | (已淘汰。 請使用沒有"/api/" 段的資源路徑刪除表。 僅適用於 API 類型:「表」。 |
> |  | **資料庫帳戶/api/表/動作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/表/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「表」。 |
> |  | **資料庫帳戶/api/表/設定** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/表/設置/寫入 | (已淘汰。 請使用沒有"/api/" 段的資源路徑更新表輸送量。 僅適用於 API 類型:「表」。 僅適用於設置類型:「輸送量」。 |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/表/設置/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取表輸送量。 僅適用於 API 類型:「表」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳號/api/表/設定/操作結果** |  |
> | 動作 | 微軟.文件資料庫/資料庫帳戶/apis/表/設置/操作結果/讀取 | (已淘汰。 請使用沒有"/api/" 段的資源路徑讀取非同步操作的狀態。 僅適用於 API 類型:「表」。 僅適用於設置類型:「輸送量」。 |
> |  | **資料庫帳戶/卡桑德拉關鍵空間** |  |
...
> | 動作 | 微軟.機器學習服務/工作區/專用端點連接審批/操作 | 批准或拒絕與 Microsoft.網路供應商的專用終結點資源的連接 |
> |  | **workspaces/computes** |  |
...
> |  | **工作空間/資料漂移探測器** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據漂移探測器/讀取 | 在機器學習服務工作區中取得資料漂移檢測器 |
> | 動作 | 微軟.機器學習服務/工作空間/數據漂移探測器/寫入 | 在機器學習服務工作區中建立或更新資料漂移檢測器 |
> | 動作 | 微軟.機器學習服務/工作空間/數據漂移探測器/刪除 | 移除機器學習服務工作區中的資料漂移測器 |
> |  | **工作區/資料集/已註冊** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/註冊/讀取 | 在機器學習服務工作區中獲取已註冊的數據集 |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/註冊/寫入 | 在機器學習服務工作區中建立或更新已註冊的資料集 |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/註冊/刪除 | 移除機器學習服務工作區中的已註冊資料集 |
> |  | **工作區/資料集/註冊/預覽** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/註冊/預覽/讀取 | 取得機器學習服務工作區中已註冊資料集的資料集預覽 |
> |  | **工作區/資料集/註冊/設定檔** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/註冊/配置檔/讀取 | 取得機器學習服務工作區中已註冊資料集的資料集設定檔 |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/註冊/配置檔/寫入 | 在機器學習服務工作區中建立或更新已註冊資料集的資料集設定檔 |
> |  | **工作區/資料集/註冊/架構** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/註冊/架構/讀取 | 取得機器學習服務工作區中已註冊資料集的資料集架構 |
> |  | **工作區/資料集/未註冊** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/未註冊/讀取 | 在機器學習服務工作區中獲取未註冊的數據集 |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/未註冊/寫入 | 在機器學習服務工作區中建立或更新未註冊的資料集 |
> | 動作 | 微軟.機器學習服務/工作區/數據集/未註冊/刪除 | 刪除機器學習服務工作區中未註冊的資料集 |
> |  | **工作區/資料集/未註冊/預覽** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/未註冊/預覽/讀取 | 取得機器學習服務工作區中未註冊資料集的資料集預覽 |
> |  | **工作區/資料集/未註冊/設定檔** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/未註冊/配置檔/讀取 | 取得機器學習服務工作區中未註冊資料集的資料集設定檔 |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/未註冊/配置檔/寫入 | 在機器學習服務工作區中為未註冊的資料集建立或更新資料集設定檔 |
> |  | **工作區/資料集/未註冊/架構** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據集/未註冊/架構/讀取 | 取得機器學習服務工作區中未註冊資料集的資料集架構 |
> |  | **工作區/資料儲存** |  |
> | 動作 | 微軟.機器學習服務/工作空間/數據存儲/讀取 | 取得機器學習服務工作區中的資料儲存 |
> | 動作 | 微軟.機器學習服務/工作空間/數據存儲/寫入 | 在機器學習服務工作區中建立或更新資料儲存 |
> | 動作 | 微軟.機器學習服務/工作區/資料存儲/刪除 | 移除機器學習服務工作區中的資料儲存 |
> |  | **工作區/終結點/管道** |  |
> | 動作 | 微軟.機器學習服務/工作區/終結點/管道/讀取 | 在機器學習服務工作區中獲取已發布的管道和管道終結點 |
> | 動作 | 微軟.機器學習服務/工作區/終結點/管道/寫入 | 在機器學習服務工作區中建立或更新已發布的管道和管道終結點 |
> |  | **工作區/環境** |  |
> | 動作 | 微軟.機器學習服務/工作空間/環境/讀取 | 取得機器學習服務工作區中的環境 |
> | 動作 | 微軟.機器學習服務/工作空間/環境/讀取秘密/操作 | 取得機器學習服務工作區中具有機密的環境 |
> | 動作 | 微軟.機器學習服務/工作空間/環境/寫入 | 在機器學習服務工作區中建立或更新環境 |
> | 動作 | 微軟.機器學習服務/工作空間/環境/構建/操作 | 在機器學習服務工作區中建構環境 |
> |  | **工作區/事件網格篩選器** |  |
> | 動作 | 微軟.機器學習服務/工作區/事件網格篩選器/讀取 | 取得特定工作區的事件網格篩選器 |
> |  | **workspaces/experiments** |  |
> | 動作 | 微軟.機器學習服務/工作空間/實驗/閱讀 | 取得機器學習服務工作區中的實驗 |
> | 動作 | 微軟.機器學習服務/工作空間/實驗/寫入 | 在機器學習服務工作區中建立或更新實驗 |
> | 動作 | 微軟.機器學習服務/工作空間/實驗/刪除 | 移除機器學習服務工作區中的實驗 |
> |  | **工作區/實驗/執行** |  |
> | 動作 | 微軟.機器學習服務/工作空間/實驗/運行/提交/操作 | 在機器學習服務工作區中建立或更新文稿執行 |
> | 動作 | 微軟.機器學習服務/工作空間/實驗/運行/讀取 | 取得機器學習服務工作區執行 |
> | 動作 | 微軟.機器學習服務/工作空間/實驗/運行/寫入 | 在機器學習服務工作區中建立或更新 |
> |  | **工作區/標籤** |  |
> | 動作 | 微軟.機器學習服務/工作空間/標籤/匯出/操作 | 機器學習服務工作區中分頁項目的匯出標籤 |
> |  | **工作區/標籤/標籤** |  |
> | 動作 | 微軟.機器學習服務/工作空間/標籤/標籤/讀取 | 取得機器學習服務工作區中標記項目的標籤 |
> | 動作 | 微軟.機器學習服務/工作空間/標籤/標籤/寫入 | 在機器學習服務工作區中建立標記項目的標籤 |
> | 動作 | 微軟.機器學習服務/工作空間/標籤/標籤/拒絕/操作 | 拒絕機器學習服務工作區中標記項目的標籤 |
> |  | **工作區/標籤/專案** |  |
> | 動作 | 微軟.機器學習服務/工作空間/標籤/專案/讀取 | 取得機器學習服務工作區中的分頁項目 |
> | 動作 | 微軟.機器學習服務/工作空間/標籤/專案/寫入 | 在機器學習服務工作區中建立或更新標記專案 |
> | 動作 | 微軟.機器學習服務/工作空間/標籤/專案/刪除 | 移除機器學習服務工作區中的分頁項目 |
> |  | **工作區/標籤/專案/摘要** |  |
> | 動作 | 微軟.機器學習服務/工作空間/標籤/專案/摘要/閱讀 | 取得機器學習服務工作區中的標籤專案摘要 |
> |  | **工作區/中繼資料/專案** |  |
> | 動作 | 微軟.機器學習服務/工作空間/元數據/專案/讀取 | 取得機器學習服務工作區中的工件 |
> | 動作 | 微軟.機器學習服務/工作空間/元數據/專案/寫入 | 在機器學習服務工作區中建立或更新專案 |
> | 動作 | 微軟.機器學習服務/工作區/元數據/專案/刪除 | 移除機器學習服務工作區中的項目 |
> |  | **工作區/中繼資料/機密** |  |
> | 動作 | 微軟.機器學習服務/工作空間/元數據/機密/讀取 | 取得機器學習服務工作區中的秘密 |
> | 動作 | 微軟.機器學習服務/工作空間/元數據/機密/寫入 | 在機器學習服務工作區中建立或更新機密 |
> | 動作 | 微軟.機器學習服務/工作區/元數據/機密/刪除 | 移除機器學習服務工作區中的秘密 |
> |  | **工作區/中繼資料/快照** |  |
> | 動作 | 微軟.機器學習服務/工作區/元數據/快照/讀取 | 抓取機器學習服務工作區中的快照 |
> | 動作 | 微軟.機器學習服務/工作區/元數據/快照/寫入 | 在機器學習服務工作區中建立或更新快照 |
> | 動作 | 微軟.機器學習服務/工作區/元數據/快照/刪除 | 移除機器學習服務工作區中的快照 |
> |  | **工作區/模型** |  |
> | 動作 | 微軟.機器學習服務/工作空間/模型/讀取 | 取得機器學習服務工作區中的模型 |
> | 動作 | 微軟.機器學習服務/工作空間/模型/寫入 | 在機器學習服務工作區中建立或更新模型 |
> | 動作 | 微軟.機器學習服務/工作空間/模型/刪除 | 移除機器學習服務工作區中的模型 |
> | 動作 | 微軟.機器學習服務/工作空間/模型/包/操作 | 機器學習服務工作區中的套件模型 |
> |  | **工作區/模組** |  |
> | 動作 | 微軟.機器學習服務/工作空間/模組/讀取 | 取得機器學習服務工作區中的模組 |
> | 動作 | 微軟.機器學習服務/工作空間/模組/寫入 | 在機器學習服務工作區中建立或更新模組 |
> |  | **工作區/導管草稿** |  |
> | 動作 | 微軟.機器學習服務/工作空間/管道草稿/讀取 | 在機器學習服務工作區中獲取管道草稿 |
> | 動作 | 微軟.機器學習服務/工作空間/管道草稿/寫入 | 在機器學習服務工作區中建立或更新管道草稿 |
> | 動作 | 微軟.機器學習服務/工作區/管道草稿/刪除 | 移除機器學習服務工作區中的導管草稿 |
> |  | **工作區/專用端接連線 Proxies** |  |
...
> |  | **工作空間/服務** |  |
> | 動作 | 微軟.機器學習服務/工作空間/服務/讀取 | 取得機器學習服務工作區中的服務 |
> |  | **工作空間/服務/服務** |  |
> | 動作 | 微軟.機器學習服務/工作空間/服務/aci/寫入 | 在機器學習服務工作區中建立或更新 ACI 服務 |
> | 動作 | 微軟.機器學習服務/工作空間/服務/aci/清單鍵/操作 | 在機器學習服務工作區中列出 ACI 服務的鍵 |
> | 動作 | 微軟.機器學習服務/工作空間/服務/aci/刪除 | 移除機器學習服務工作區中的 ACI 服務 |
> |  | **工作空間/服務/aks** |  |
> | 動作 | 微軟.機器學習服務/工作空間/服務/aks/寫入 | 在機器學習服務工作區中建立或更新 AKS 服務 |
> | 動作 | 微軟.機器學習服務/工作空間/服務/aks/清單鍵/操作 | 在機器學習服務工作區中列出 AKS 服務的鍵 |
> | 動作 | 微軟.機器學習服務/工作空間/服務/aks/刪除 | 移除機器學習服務工作區中的 AKS 服務 |
> | 動作 | 微軟.機器學習服務/工作空間/服務/aks/分數/操作 | 在機器學習服務工作區中對 AKS 服務進行評分 |
...
> |  | **帳號/私人地圖集** |  |
> | 動作 | 微軟.地圖/帳戶/私人地圖集/刪除 | 移除私人地圖集 |
> | 動作 | 微軟.地圖/帳戶/私人地圖集/閱讀 | 取得私人地圖集 |
> | 動作 | 微軟.地圖/帳戶/私人地圖集/寫入 | 建立或更新專用地圖集 |
> |  | **操作** |  |
...
> |  | **物件理解帳戶** |  |
> | DataAction | 微軟.混合現實/物件理解帳戶/攝錄/行動 | 建立模型引入工作 |
> |  | **物件理解帳戶/攝錄** |  |
> | DataAction | 微軟.混合現實/物件理解帳戶/攝錄/閱讀 | 取得模型引入作業狀態 |
> |  | **遠端成像帳戶** |  |
...
> |  | **淨應用帳戶/容量池/卷/裝入目標** |  |
> | 動作 | 微軟.NetApp/NetApp帳戶/容量池/卷/安裝目標/讀取 | 讀取掛接目標資源。 |
> |  | **淨應用帳戶/容量池/卷/複製狀態** |  |
> | 動作 | 微軟.NetApp/NetApp 帳戶/容量池/卷/複製狀態/讀取 | 讀取卷複製的狀態。 |
> |  | **淨應用帳戶/容量池/卷/快照** |  |
...
> | 動作 | 微軟.網路/負載平衡器/後端位址池/寫入 | 建立負載均衡器後端位址池或更新現有負載均衡器後端位址池 |
> | 動作 | 微軟.網路/負載平衡器/後端位址池/刪除 | 刪除負載均衡器後端位址池 |
...
> |  | **私有終結點** |  |
> | 動作 | 微軟.網路/私人終結點/推送屬性到資源/操作 | 操作從 NRP 用戶端推送專用終結點屬性更新 |
...
> |  | **安全合作夥伴供應商** |  |
> | 動作 | 微軟.網路/安全合作夥伴供應商/讀取 | 取得安全合作夥伴供應商 |
> | 動作 | 微軟.網路/安全合作夥伴供應商/寫入 | 建立安全合作夥伴供應商或更新現有安全合作夥伴供應商 |
> | 動作 | 微軟.網路/安全合作夥伴供應商/驗證/操作 | 驗證安全合作夥伴供應商 |
> | 動作 | 微軟.網路/安全合作夥伴供應商/更新參考/操作 | 更新安全夥伴提供者中的引用 |
> | 動作 | 微軟.網路/安全合作夥伴供應商/加入/行動 | 加入安全合作夥伴供應商。 不可報警。 |
> | 動作 | 微軟.網路/安全合作夥伴供應商/刪除 | 移除安全合作夥伴供應商 |
...
> | 動作 | 微軟.網路/虛擬網路/加入負載平衡器/操作 | 將負載均衡器連接到虛擬網路 |
...
> |  | **工作區/查詢/應用程式例外** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/應用程式例外/閱讀 | 從應用程式異常的資料讀取資料 |
> |  | **工作區/查詢/應用程式見解** |  |
...
> |  | **工作區/查詢/WVD檢查點** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/WVD檢查點/讀取 | 從 WVD 檢查點表中讀取資料 |
> |  | **工作區/查詢/WVD連接** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/WVD連接/讀取 | 從 WVDConnections 表中讀取資料 |
> |  | **工作區/查詢/WVD錯誤** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/WVD錯誤/讀取 | 從 WVDErrors 表中讀取資料 |
> |  | **工作區/查詢/WVD源** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/WVDFeed/讀取 | 從 WVD 源表中讀取資料 |
> |  | **工作區/查詢/WVDHost註冊** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/WVDHost註冊/讀取 | 從 WVDHost 註冊的資料 |
> |  | **工作區/查詢/WVD管理** |  |
> | 動作 | 微軟.操作見解/工作空間/查詢/WVD管理/閱讀 | 從 WVD 管理表中讀取資料 |
> |  | **工作區/規則** |  |
...
> | 動作 | 微軟.安全洞察/數據連接器檢查要求/操作 | 檢查使用者授權與授權 |
> |  | **聚合** |  |
...
Azure 服務[:Azure SQL 資料庫](../sql-database/index.yml)[、SQL 資料倉儲](../sql-data-warehouse/index.yml)
...
> |  | **動作結果** |  |
> | 動作 | 微軟.支援/操作結果/閱讀 | 取得非同步操作的結果 |
> |  | **操作** |  |
> | 動作 | 微軟支援/操作/讀取 | 列出 Microsoft. 支援資源提供者上可用的所有操作 |
> |  | **操作狀態** |  |
> | 動作 | 微軟.支援/操作狀態/讀取 | 取得非同步作業的狀態 |
> |  | **services** |  |
> | 動作 | 微軟.支援/服務/閱讀 | 列出一個或所有可用的 Azure 服務,供支援 |
> |  | **服務/問題分類** |  |
> | 動作 | 微軟.支援/服務/問題分類/閱讀 | 列出 Azure 服務的一個或多個問題分類 |
> |  | **支援門票** |  |
> | 動作 | Microsoft.Support/supportTickets/read | 列出一個或多個支援票證 |
> | 動作 | Microsoft.Support/supportTickets/write | 允許建立及更新支援票證 |
> |  | **支援門票/通訊** |  |
> | 動作 | 微軟.支援/支持門票/通信/閱讀 | 列出一個或多個支援票證通信 |
> | 動作 | 微軟.支援/支援門票/通信/寫入 | 新增通訊 |
...
- [雲採用框架:Azure 中的資源存取管理](/azure/cloud-adoption-framework/govern/resource-consistency/resource-access-management)
