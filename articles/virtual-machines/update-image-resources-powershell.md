---
title: 使用 PowerShell 來列出、更新和刪除映射資源
description: 使用 Azure PowerShell，列出、更新及刪除共用映射資源庫中的映射資源。
author: cynthn
...
ms.locfileid: "82797002"
---
# <a name="list-update-and-delete-image-resources-using-powershell"></a>使用 PowerShell 來列出、更新和刪除映射資源 

您可以使用 Azure PowerShell 來管理共用映射庫資源。
