---
title: 使用 Azure CLI 列出、更新和刪除影像資源
description: 使用 Azure CLI，列出、更新及刪除共用映射資源庫中的映射資源。
author: cynthn
...
ms.locfileid: "82797093"
---
# <a name="list-update-and-delete-image-resources"></a>列出、更新和刪除影像資源 
