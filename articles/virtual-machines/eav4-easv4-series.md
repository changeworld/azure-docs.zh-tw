---
title: Eav4 系列與 Easv4 系列 - Azure 虛擬機器
...
Eav4 系列和 Easv4 系列採用 AMD 的 2.35Ghz EPYC<sup>TM</sup> 7452 處理器,採用多線程配置,具有高達 256MB L3 緩存,增加了運行大多數記憶體優化工作負載的選項。 Eav4 系列和 Easv4 系列與 Ev3 & Esv3 系列具有相同的記憶體和磁碟配置。
...
Eav4 系列尺寸基於 2.35Ghz AMD EPYC<sup>TM</sup> 7452 處理器,可實現 3.35GHz 的提升最大頻率並使用高級 SSD。 Eav4 系列尺寸非常適合記憶體密集型企業應用。 資料磁碟儲存體與虛擬機器分開計費。 要使用先進 SSD,請使用 Easv4 系列尺寸。 Easv4 尺寸的定價和計費表與 Eav3 系列相同。
