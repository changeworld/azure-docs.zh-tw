...
description: 使用 Windows 範例，為 Azure 虛擬機器和虛擬機器擴展集 Bi-Directional 序列主控台。
...
某些鍵盤輸入會產生奇怪的 SAC 輸出 (例如 **[A**、 **[3~** )。 | SAC 提示字元不支援 [VT100](/windows/console/console-virtual-terminal-sequences) 逸出序列。
