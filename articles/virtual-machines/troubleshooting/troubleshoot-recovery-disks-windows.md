...
您可以使用 VM 修復命令自動執行步驟 1、2、3、4、6 和 7。 有關更多文檔和說明，請參閱[使用 Azure 虛擬機器修復命令修復 Windows VM。](repair-windows-vm-using-azure-virtual-machine-repair-commands.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
