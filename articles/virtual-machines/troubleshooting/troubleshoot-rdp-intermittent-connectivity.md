...
在按照這些步驟之前，先將受影響 VM 的[OS 磁片快照](../windows/snapshot-copy-managed-disk.md)作為備份。 
...
5. 選取 [HKEY_LOCAL_MACHINE]**** 機碼。 在功能表上，選擇**檔** > **載入蜂巢**：
6. 流覽到您連接的作業系統磁片上的 **[windows_system32_config_SYSTEM] 系統**資料夾。 針對 Hive 的名稱，輸入 **BROKENSYSTEM**。 新的 Hive 會顯示在 [HKEY_LOCAL_MACHINE]**** 機碼下方。 載入 **HKEY_LOCAL_MACHINE** 機碼下的軟體 hive **\windows\system32\config\SOFTWARE**。 針對 Hive 軟體的名稱，輸入 **BROKENSOFTWARE**。 
