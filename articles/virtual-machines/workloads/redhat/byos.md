...
>[!NOTE]
>在 RHEL 8 上，`dnf` 和 `yum` 是可互換的。 如需詳細資訊，請參閱[RHEL 8 系統管理指南](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/configuring_basic_system_settings/installing-software-with-yum_configuring-basic-system-settings)。
