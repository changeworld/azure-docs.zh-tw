...
- [ASYSCO AMT COBOL](https://www.asysco.com/cobol/)開發環境（UNISYS、IBM 大型主機和其他 COBOL 方言，例如微焦點 COBOL）。
- [ASYSCO AMT](https://www.asysco.com/amt-go/)採用以雲端為基礎的部署架構，適用于高階工作負載。
...
- [ASYSCO AMT GO](https://www.asysco.com/amt-go/)部署架構支援 CICS、IMS、TIP、HVTIP 和其他常見的大型主機環境。
- [微焦點企業伺服器](https://www.microfocus.com/products/enterprise-suite/enterprise-server/)大型主機整合平臺。
...
- [Asysco](https://www.asysco.com/azure-cloud/)系統轉換技術，涵蓋原始程式碼、資料、批次、排程、TP 監視器、介面、安全性、管理等。
- [ASYSCO AMT 服務](https://www.asysco.com/migration-services/)的端對端服務可用於遷移專案，包括清查和分析、設計訓練、裝飾 rehearsals、上線和後置遷移支援。
