...
[dbms-guide]:dbms-guide.md (用於 SAP 的 Azure 虛擬機器 DBMS 部署)
[dbms-guide-2.1]:dbms-guide.md#c7abf1f0-c927-4a7c-9c1d-c7b5b3b7212f (緩存 VM 和 VHD)
[dbms-guide-2.2]:dbms-guide.md#c8e566f9-21b7-4457-9f7f-126036971a91 (軟體 RAID)
[dbms-guide-2.3]:dbms-guide.md#10b041ef-c177-498a-93ed-44b3441ab152 (微軟 Azure 存儲)
[dbms-guide-2]:dbms-guide.md#65fa79d6-a85f-47ee-890b-22e794f51a64 (RDBMS 部署的結構)
[dbms-guide-3]:dbms-guide.md#871dfc27-e509-4222-9370-ab1de77021c3 (使用 Azure VM 的高可用性和災害復原)
[dbms-guide-5.5.1]:dbms-guide.md#0fef0e79-d3fe-4ae2-85af-73666a6f7268 (SQL 伺服器 2012 SP1 CU4 及更高版本)
[dbms-guide-5.5.2]:dbms-guide.md#f9071eff-9d72-4f47-9da4-1852d782087b (SQL 伺服器 2012 SP1 CU3 及早期版本)
...
[dbms-guide-8.4.1]:dbms-guide.md#b48cfe3b-48e9-4f5b-a783-1d29155bd573 (存儲配置)
[dbms-guide-8.4.2]:dbms-guide.md#23c78d3b-ca5a-4e72-8a24-645d141a3f5d (備份和還原)
[dbms-guide-8.4.3]:dbms-guide.md#77cd2fbb-307e-4cbf-a65f-745553f72d2c (備份和還原的性能注意事項)
...
[deployment-guide]:deployment-guide.md (用於 SAP 的 Azure 虛擬機器部署)
...
[deployment-guide-3.3]:deployment-guide.md#54a1fc6d-24fd-4feb-9c57-ac588a55dff2 (方案 2：使用 SAP 的自訂映射部署 VM)
[deployment-guide-3.4]:deployment-guide.md#a9a60133-a763-4de8-8986-ac0fa33aa8c1 (方案 3：使用具有 SAP 的非通用 Azure VHD 將 VM 從本地移動)
[deployment-guide-3]:deployment-guide.md#b3253ee3-d63b-4d74-a49b-185e76c4088e (在 Microsoft Azure 上為 SAP 部署 VM 的 VM)
[deployment-guide-4.1]:deployment-guide.md#604bcec2-8b6e-48d2-a944-61b0f5dee2f7 (部署 Azure 電源外殼 Cmdlet)
...
[deployment-guide-4.4]:deployment-guide.md#c7cbb0dc-52a4-49db-8e03-83e7edc2927d (下載、安裝和啟用 Azure VM 代理)
[deployment-guide-4.5.1]:deployment-guide.md#987cf279-d713-4b4c-8143-6b11589bb9d4 (Azure 電源外殼)
[deployment-guide-4.5.2]:deployment-guide.md#408f3779-f422-4413-82f8-c57a23b4fc2f (Azure CLI)
[deployment-guide-4.5]:deployment-guide.md#d98edcd3-f2a1-49f7-b26a-07448ceb60ca (配置 SAP 的 Azure 擴展)
[deployment-guide-5.1]:deployment-guide.md#bb61ce92-8c5c-461f-8c53-39f5e5ed91f2 (SAP Azure 擴展的準備情況檢查)
[deployment-guide-5.2]:deployment-guide.md#e2d592ff-b4ea-4a53-a91a-e5521edb6cd1 (SAP 配置的 Azure 擴展的運行狀況檢查)
[deployment-guide-5.3]:deployment-guide.md#fe25a7da-4e4e-4388-8907-8abc2d33cfd8 (對 SAP 的 Azure 擴展進行故障排除)

[deployment-guide-configure-monitoring-scenario-1]:deployment-guide.md#ec323ac3-1de9-4c3a-b770-4ff701def65b (配置 VM 擴展)
...
[deployment-guide-troubleshooting-chapter]:deployment-guide.md#564adb4f-5c95-4041-9616-6635e83a810b (為 SAP 主機代理檢查和故障排除端到端資料收集)
...
[planning-guide]:planning-guide.md (Azure 虛擬機器規劃和實現 SAP)
...
[planning-guide-11.5]:planning-guide.md#4e165b58-74ca-474f-a7f4-5e695a93204f (對 SAP 實例使用自動啟動)
...
[planning-guide-3.2.1]:planning-guide.md#df49dc09-141b-4f34-a4a2-990913b30358 (故障域)
...
[planning-guide-3.3.2]:planning-guide.md#ff5ad0f9-f7f4-4022-9102-af07aef3bc92 (Azure 高級存儲)
[planning-guide-5.1.1]:planning-guide.md#4d175f1b-7353-4137-9d2f-817683c26e53 (使用非通用磁片將 VM 從本地移動到 Azure)
...
[planning-guide-5.2.2]:planning-guide.md#57f32b1c-0cba-4e57-ab6e-c39fe22b6ec3 (準備部署具有 SAP 客戶特定映射的 VM)
...
[planning-guide-5.3.2]:planning-guide.md#a43e40e6-1acc-4633-9816-8f095d5a7b6a (將 VHD 從本地上載到 Azure)
[planning-guide-5.4.2]:planning-guide.md#9789b076-2011-4afa-b2fe-b07a8aba58a1 (在 Azure 儲存體帳戶之間複製磁碟)
[planning-guide-5.5.1]:planning-guide.md#4efec401-91e0-40c0-8e64-f2dceadff646 (用於 SAP 部署的 VM/VHD 結構)
[planning-guide-5.5.3]:planning-guide.md#17e0d543-7e8c-4160-a7da-dd7117a1ad9d (為連接的磁片設置自動安裝)
[planning-guide-7.1]:planning-guide.md#3e9c3690-da67-421a-bc3f-12c520d99a30 (具有 SAP NetWeaver 演示/培訓方案的單一 VM)
[planning-guide-7]:planning-guide.md#96a77628-a05e-475d-9df3-fb82217e8f14 (SAP 實例的僅雲部署概念)
[planning-guide-9.1]:planning-guide.md#6f0a47f3-a289-4090-a053-2521618a28c3 (SAP 的 Azure 監視解決方案)
[planning-guide-azure-premium-storage]:planning-guide.md#ff5ad0f9-f7f4-4022-9102-af07aef3bc92 (Azure 高級存儲)
[planning-guide-managed-disks]:planning-guide.md#c55b2c6e-3ca1-4476-be16-16c81927550f (託管磁片)
...
[virtual-machines-linux-cli-deploy-templates]:../../linux/cli-deploy-templates.md (使用 Azure 資源管理器範本和 Azure CLI 部署和管理虛擬機器)
...
若要下載並執行 SAP 軟體部署所需的工具和指令碼，您必須連線到網際網路。 運行 SAP Azure 擴展的 Azure VM 也需要訪問 Internet。 如果 Azure VM 是 Azure 虛擬網路或內部部署網域的一部分，請務必如[設定 Proxy][deployment-guide-configure-proxy] 所述，設定相關的 Proxy 設定。
...
在 Azure Resource Manager 中，您可以使用資源群組來管理 Azure 訂用帳戶中的所有應用程式資源。 有關詳細資訊，請參閱[Azure 資源管理器概述][resource-group-overview]。
...
1. **設置**：
   ...
   * **擴充功能**：您可以將虛擬機器擴充功能新增至部署中，藉此安裝安裝。 您不需要在此步驟新增擴充功能。 稍後會安裝 SAP 支援所需的擴充功能。 請參閱本指南[中為 SAP 配置 Azure 擴展][deployment-guide-4.5]章。
...
1. **設置**：
   ...
   * **儲存體類型**：(僅限兩層範本) 要使用的儲存體類型。
      ...
      * [高級存儲：適用于 Azure 虛擬機器工作負載的高性能存儲][storage-premium-storage-preview-portal]
      * [微軟 Azure 存儲簡介][storage-introduction]
   * **管理員使用者名稱**和**管理員密碼**：使用者名稱和密碼。
     建立新的使用者，以便登入虛擬機器。
   * **新建或現有子網**：確定是創建新的虛擬網路和子網還是使用現有子網。 如果您已經有連線到內部部署網路的虛擬網路，請選取 [現有]****。
   * **子網 ID**：如果要將 VM 部署到已定義子網的現有 VNet 中，應為其分配 VM，則命名該特定子網的 ID。 識別碼通常如下所示：/subscriptions/&lt;訂用帳戶識別碼>/resourceGroups/&lt;資源群組名稱>/providers/Microsoft.Network/virtualNetworks/&lt;虛擬網路名稱>/subnets/&lt;子網路名稱>
...
根據內部部署網路的設定方式，您可能需要在您的 VM 上設定 Proxy。 如果您的 VM 通過 VPN 或 ExpressRoute 連接到本地網路，則 VM 可能無法訪問 Internet，並且無法通過 SAP 擴展下載所需的 VM 擴展或為 SAP 主機代理收集 Azure 基礎結構資訊對於 Azure。 如需詳細資訊，請參閱[設定 Proxy][deployment-guide-configure-proxy]。
...
#### <a name="configure-vm-extension"></a><a name="ec323ac3-1de9-4c3a-b770-4ff701def65b"></a>配置 VM 擴展

為了確保 SAP 支援您的環境，請按照配置 SAP 的 Azure[擴展][deployment-guide-4.5]中所述為 SAP 設置 Azure 擴展。 在[SAP 資源][deployment-guide-2.2]中列出的資源中檢查 SAP 的先決條件以及 SAP 內核和 SAP 主機代理所需的最小版本。

#### <a name="vm-extension-for-sap-check"></a>用於 SAP 檢查的 VM 擴展

檢查 SAP 的 VM 擴展是否正常工作，如[SAP 主機代理的端到端資料收集檢查和故障排除][deployment-guide-troubleshooting-chapter]中所述。
...
### <a name="scenario-2-deploying-a-vm-with-a-custom-image-for-sap"></a><a name="54a1fc6d-24fd-4feb-9c57-ac588a55dff2"></a>方案 2：使用 SAP 的自訂映射部署 VM
...
根據內部部署網路的設定方式，您可能需要在您的 VM 上設定 Proxy。 如果您的 VM 通過 VPN 或 ExpressRoute 連接到本地網路，則 VM 可能無法訪問 Internet，並且無法通過 Azure 的 SAP 擴展為 SAP 主機代理下載所需的 VM 擴展或收集 Azure 基礎結構資訊，請參閱[配置代理][deployment-guide-configure-proxy]。

#### <a name="configure-azure-vm-extension-for-sap"></a>為 SAP 配置 Azure VM 擴展

為了確保 SAP 支援您的環境，請按照配置 SAP 的 Azure[擴展][deployment-guide-4.5]中所述為 SAP 設置 Azure 擴展。 在[SAP 資源][deployment-guide-2.2]中列出的資源中檢查 SAP 的先決條件以及 SAP 內核和 SAP 主機代理所需的最小版本。

#### <a name="sap-vm-extension-check"></a>SAP VM 擴展檢查
...
在此案例中，**不會**在部署期間自動安裝 VM 代理程式。 由於需要 SAP 的 VM 代理和 Azure 擴展才能在 Azure 上運行 SAP NetWeaver，因此需要在創建虛擬機器後手動下載、安裝和啟用這兩個元件。
...
## <a name="update-the-configuration-of-azure-extension-for-sap"></a>更新 SAP 的 Azure 擴展配置

在以下任一方案中更新 SAP 的 Azure 擴展配置：
* 聯合 Microsoft/SAP 團隊擴展了 VM 擴展的功能，並請求更多或更少的計數器。
* Microsoft 引入了提供資料的基礎 Azure 基礎結構的新版本，SAP 的 Azure 擴展需要適應這些更改。
* 您將額外的資料磁碟掛接到 Azure VM 或是移除資料磁碟。 在此案例中，更新儲存體相關資料的集合。 通過添加或刪除終結點或將 IP 位址分配給 VM 來更改配置不會影響擴展配置。
* 您可變更 Azure VM 的大小 (例如從大小 A5 變更成任何其他 VM 大小)。
* 您可以在 Azure VM 中新增網路介面。

要更新設置，請按照[SAP 配置 Azure 擴展][deployment-guide-4.5]中的步驟更新 SAP 的 Azure 擴展配置。
...
1. 選擇**電腦配置** > **管理範本** > **Windows 元件** > **Internet 資源管理器**。 請確定 [為每台電腦建立 Proxy 設定 - 而不是每個使用者]**** 設定已停用或未設定。
...
### <a name="configure-the-azure-extension-for-sap"></a><a name="d98edcd3-f2a1-49f7-b26a-07448ceb60ca"></a>配置 SAP 的 Azure 擴展

在您如 [SAP on Azure 的 VM 部署案例][deployment-guide-3]所述準備好 VM 之後，Azure VM 代理程式就會安裝於虛擬機器上。 下一步是部署 SAP 的 Azure 擴展，這在全域 Azure 資料中心中的 Azure 擴展存儲庫中可用。 如需詳細資訊，請參閱 [Azure 虛擬機器 (VM) 上的 SAP NetWeaver - 規劃和實作指南][planning-guide-9.1]。

可以使用 PowerShell 或 Azure CLI 安裝和配置 SAP 的 Azure 擴展。 若要使用 Windows 電腦在 Windows 或 Linux VM 上安裝該擴充功能，請參閱 [Azure PowerShell][deployment-guide-4.5.1]。 若要使用 Linux 桌上型電腦在 Linux VM 上安裝該擴充功能，請參閱 [Azure CLI][deployment-guide-4.5.2]。
...
要使用 PowerShell 安裝 SAP 的 Azure 擴展：

1. 確定您已安裝最新版的 Azure PowerShell Cmdlet。 如需詳細資訊，請參閱[部署 Azure PowerShell Cmdlet][deployment-guide-4.1]。  
1. 執行下列 PowerShell Cmdlet。
    如需可用環境的清單，請執行 `commandlet Get-AzEnvironment`。 如果您想要使用全域 Azure，則您的環境是 **AzureCloud**。 對於中國的 Azure，請選擇**Azure 中國雲**。
...
有關 的詳細資訊`Set-AzVMAEMExtension`，請參閱[設置-AzVMAEM 擴展][msdn-set-Azvmaemextension]。

![成功執行特定于 SAP 的 Azure Cmdlet 集-AzVMAEM 擴展][deployment-guide-figure-900]

配置`Set-AzVMAEMExtension`執行為 SAP 配置主機資料收集的所有步驟。

指令碼輸出包含下列資訊︰

* 確認已配置作業系統磁片和所有其他資料磁片的資料收集。
* 接下來的兩則訊息會確認特定儲存體帳戶的儲存體計量組態。
* 一行輸出提供 SAP 配置 VM 擴展的實際更新狀態。
* 另一行輸出會確認已部署或已更新組態。
* 輸出的最後一行是參考資訊。 它顯示了用於測試 SAP 配置的 VM 擴展的選項。
* 要檢查 AZURE VM 擴展用於 SAP 配置的所有步驟是否已成功執行，以及 Azure 基礎結構是否提供了必要的資料，請繼續對 SAP 的 Azure 擴展進行就緒檢查，如[SAP Azure 擴展的就緒檢查][deployment-guide-5.1]中所述。
...
要使用 Azure CLI 安裝 SAP 的 Azure 擴展：
...
1. 驗證 SAP 的 Azure 擴展是否在 Azure Linux VM 上處於活動狀態。 檢查 \\var\\lib\\AzureEnhancedMonitor\\PerfCounters 檔案是否存在。 如果存在，在命令提示符處，運行此命令以顯示 Azure 擴展為 SAP 收集的資訊：
...
## <a name="checks-and-troubleshooting-for-end-to-end-data-collection-for-sap-host-agent"></a><a name="564adb4f-5c95-4041-9616-6635e83a810b"></a>為 SAP 主機代理檢查和故障排除端到端資料收集

部署 Azure VM 並設置 SAP 的相關 Azure 擴展後，請檢查擴展的所有元件是否按預期工作。

運行 SAP Azure 擴展的準備狀態檢查，如[SAP Azure 擴展的就緒檢查][deployment-guide-5.1]中所述。 如果所有就緒檢查結果都為正，並且所有相關效能計數器都顯示正常，則 SAP 的 Azure 擴展已成功設置。 您可以繼續安裝 SAP Host Agent (如 [SAP 資源][deployment-guide-2.2]中的 SAP Note 所述)。 如果就緒檢查指示計數器丟失，請運行 SAP Azure 擴展的運行狀況檢查，如 SAP 配置[Azure 擴展的運行狀況檢查][deployment-guide-5.2]中所述。 有關更多故障排除選項，請參閱[對 SAP 的 Azure 擴展進行故障排除][deployment-guide-5.3]。

### <a name="readiness-check-for-the-azure-extension-for-sap"></a><a name="bb61ce92-8c5c-461f-8c53-39f5e5ed91f2"></a>SAP 的 Azure 擴展的準備狀態檢查

此檢查可確保 SAP 應用程式內出現的所有性能指標都由 SAP 的基礎 Azure 擴展提供。

#### <a name="run-the-readiness-check-on-a-windows-vm"></a>在 Windows VM 上執行整備檢查

1. 登入 Azure 虛擬機器 (不一定要使用管理帳戶)。
1. 開啟命令提示字元視窗。
1. 在命令提示符處，將目錄更改為 SAP Azure 擴展的安裝資料夾：C：\\包\\外掛程式\\Microsoft.AzureCAT.Azure 增強監視.AzureCAT 擴展\\&lt;處理常式版本\\>刪除

   擴展路徑中*的版本*可能會有所不同。 如果在安裝資料夾中看到多個版本的擴展的資料夾，請檢查 Azure 增強監視 Windows 服務的配置，然後切換到指示為*可執行路徑*的資料夾。

   ![運行 SAP Azure 擴展的服務屬性][deployment-guide-figure-1000]
...
如果未安裝 SAP 的 Azure 擴展，或者 Azure 增強監視服務未運行，則未正確配置擴展。 有關如何部署擴展的詳細資訊，請參閱[對 SAP 的 Azure 擴展進行故障排除][deployment-guide-5.3]。

> [!NOTE]
> Azperflib.exe 為不能用於個人用途的元件。 它是一個元件，它為 SAP 主機代理提供與 VM 相關的 Azure 基礎結構資料。
> 

##### <a name="check-the-output-of-azperflibexe"></a>檢查 azperflib.exe 的輸出

Azperflib.exe 輸出會顯示適用於 SAP 的所有已填入 Azure 效能計數器。 在收集的計數器清單的底部，摘要和運行狀況指示器顯示 SAP 的 Azure 擴展狀態。
...
| Azperflib.exe 結果值 | SAP 運行狀況的 Azure 擴展 |
| --- | --- |
...
| **健康情況** |僅當返回狀態顯示 **"確定"** 時，才行。 |
| **診斷** |健康狀態的相關詳細資訊。 |

如果**運行狀況狀態**值**不正常**，請按照[SAP 配置的 Azure 擴展的運行狀況檢查][deployment-guide-5.2]中的說明進行操作。

#### <a name="run-the-readiness-check-on-a-linux-vm"></a>在 Linux VM 上執行整備檢查

1. 使用 SSH 來連線到 Azure 虛擬機器。

1. 檢查 SAP 的 Azure 擴展的輸出。
...
1. 確保安裝並運行 SAP 的 Azure 擴展。

   a.  執行 

   **預期結果**：列出 SAP 目錄的 Azure 擴展的內容。
...
如果其中任何一個檢查失敗，有關如何重新部署擴展的詳細資訊，請參閱對 SAP 的[Azure 擴展進行故障排除][deployment-guide-5.3]。

### <a name="health-check-for-the-azure-extension-for-sap-configuration"></a><a name="e2d592ff-b4ea-4a53-a91a-e5521edb6cd1"></a>SAP 配置的 Azure 擴展的運行狀況檢查

如果某些基礎結構資料未如[SAP Azure 擴展的"就緒"檢查][deployment-guide-5.1]中描述的測試所述正確交付，請運行`Test-AzVMAEMExtension`Cmdlet 以檢查 Azure 基礎結構和 SAP 的 Azure 擴展是否配置正確。

1. 確定您已安裝最新版的 Azure PowerShell Cmdlet (如[部署 Azure PowerShell Cmdlet][deployment-guide-4.1]所述)。
1. 執行下列 PowerShell Cmdlet。 如需可用環境的清單，請執行 `Get-AzEnvironment` Cmdlet。 若要使用公用 Azure，請選取 **AzureCloud** 環境。 對於中國的 Azure，請選擇**Azure 中國雲**。
...
1. 指令碼會測試您所選虛擬機器的組態。
   ...
   ![成功測試 SAP Azure 擴展的輸出][deployment-guide-figure-1300]

確定每個健康狀態檢查的結果都 [OK]****。 如果某些檢查不顯示 **"確定"，** 請運行更新 Cmdlet，如[配置 SAP 的 Azure 擴展][deployment-guide-4.5]中所述。 等待 15 分鐘，並重複 SAP [Azure 擴展的就緒檢查][deployment-guide-5.1]中描述的檢查，[以及 SAP 配置的 Azure 擴展][deployment-guide-5.2]。 如果檢查仍指示某些或所有計數器有問題，請參閱對 SAP[的 Azure 擴展進行故障排除][deployment-guide-5.3]。

> [!Note]
> 在使用受控標準 Azure 磁碟的情況下，您可能會遇到一些警告。 測試將不會傳回「確定」，而會顯示警告。 這對於該磁碟類型而言為正常且預期中的情況。 另請參閱[對 SAP 的 Azure 擴展進行故障排除][deployment-guide-5.3]
> 

### <a name="troubleshooting-azure-extension-for-sap"></a><a name="fe25a7da-4e4e-4388-8907-8abc2d33cfd8"></a>對 SAP 的 Azure 擴展進行故障排除
...
##### <a name="the-installation-directory-of-the-azure-extension-for-sap-is-empty"></a>SAP Azure 擴展的安裝目錄為空
...
##### <a name="service-for-azure-extension-for-sap-does-not-exist"></a>SAP 的 Azure 擴展服務不存在
...
![執行 azperflib.exe 表示 SAP Azure 擴展的服務未運行][deployment-guide-figure-1400]
<a name="figure-14"></a>

###### <a name="solution"></a>解決方法

如果服務不存在，則未正確安裝 SAP 的 Azure 擴展。 請使用 [Azure 中適用於 SAP 的 VM 部署案例][deployment-guide-3]中針對您的部署案例所述的步驟，重新部署此擴充功能。

部署此擴充功能之後，請在一小時後再度檢查 Azure VM 中是否提供 Azure 效能計數器。

##### <a name="service-for-azure-extension-for-sap-exists-but-fails-to-start"></a>SAP 的 Azure 擴展服務存在，但無法啟動
...
組態不正確。 重新開機 VM 中 SAP 的 Azure 擴展，如[為 SAP 配置 Azure 擴展][deployment-guide-4.5]中所述。
...
目錄\\var\\\\lib\\ waagent 沒有用於 SAP 的 Azure 擴展的子目錄。

###### <a name="solution"></a>解決方法

未安裝此擴充功能。 判斷這是否為 Proxy 問題 (如先前所述)。 您可能需要重新啟動電腦及/或重新執行 `Set-AzVMAEMExtension` 組態指令碼。

##### <a name="the-execution-of-set-azvmaemextension-and-test-azvmaemextension-show-warning-messages-stating-that-standard-managed-disks-are-not-supported"></a>Set-AzVMAEM 擴展和測試-AzVMAEM 擴展的執行顯示警告訊息，指出不支援標準託管磁片

###### <a name="issue"></a>問題

在執行集-AzVMAEM 擴展或測試-AzVMAEM 擴展消息時，將顯示這些消息：
...
這些消息是由標準託管磁片未交付 SAP 擴展用於檢查標準 Azure 存儲帳戶統計資訊的 API 引起的。 使用者並不需要在意此問題。 為標準磁片存儲帳戶引入收集資料的原因是限制頻繁發生的 I/O。 受控磁碟將會透過限制儲存體帳戶中的磁碟數量來避免此類節流。 因此，沒有該資料類型並不重要。
...
有關已知問題的完整和最新清單，請參閱 SAP 注釋[1999351，]該清單具有用於 SAP 的 Azure 擴展的其他故障排除資訊。

如果使用 SAP Note [1999351]進行故障排除不能解決問題，請重新運行`Set-AzVMAEMExtension`配置腳本，如配置[SAP 的 Azure 擴展][deployment-guide-4.5]中所述。 因為儲存體分析或診斷計數器在啟用後可能未立即建立，所以您可能必須等待一個小時的時間。 如果問題仍然存在，請在元件 BC-OP-NT-AZR (適用於 Windows) 或 BC-OP-LNX-AZR (適用於 Linux 虛擬機器) 上開啟 SAP 客戶支援訊息。
