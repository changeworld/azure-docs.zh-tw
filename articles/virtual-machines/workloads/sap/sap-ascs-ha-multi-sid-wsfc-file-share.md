...
_**圖1：** 在兩個叢集中部署 SAP ASCS/SCS 實例和 SOFS_
...
您可以設定第二個 SOFS (例如，第二個 SOFS 叢集角色 **\<SAPGlobalHost2>** 以及第二個) 的不同 **Volume2** **\<SID2>** 。

![圖 4：多重 SID SOFS 與 SAP GLOBAL 主機名稱 2 相同][sap-ha-guide-figure-8015]

_**圖 4：** 多重 SID SOFS 與 SAP GLOBAL 主機名稱 2 相同_

若要建立第二個 SOFS 角色 \<SAPGlobalHost2> ，請執行下列 PowerShell 腳本：
...
![圖 5：「容錯移轉叢集管理員」中的第二個 Volume2][sap-ha-guide-figure-8016]

_**圖 5：**「容錯移轉叢集管理員」中的第二個 Volume2_

建立第二個的 SAP Global 資料夾 \<SID2> ，並設定檔案安全性。
