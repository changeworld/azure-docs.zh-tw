...
- [在 Azure VM 上手動安裝單實例 SAP HANA](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/hana-get-started)
...
- [常見問題解答：SAP HANA 的高可用性](https://archive.sap.com/documents/docs/DOC-66702)
...
- [SAP HANA 系統複製的網路建議](https://www.sap.com/documents/2016/06/18079a1c-767c-0010-82c7-eda71af511fa.html)
- [SAP HANA 系統複製](https://help.sap.com/viewer/6b94445c94ae495c83a19646e7c3fd56/2.0.01/en-US/b74e16a9e09541749a745f41246a065e.html)
...
[虛擬機器的 SLA](https://azure.microsoft.com/support/legal/sla/virtual-machines/v1_8/)描述了三種不同的 SLA，適用于三種不同的配置：
...
- 在[Availablity 區域](https://docs.microsoft.com/azure/availability-zones/az-overview)中組織的多個（至少兩個）VM。 此選項提供 99.99% 的每月停機時間。
