...
- **[輸出規則](../load-balancer/load-balancer-outbound-rules-overview.md)** - 輸出規則會設定輸出網路位址轉譯 (NAT)，以便讓標準 Load Balancer 後端集區所識別的所有虛擬機器或執行個體轉譯至前端。
