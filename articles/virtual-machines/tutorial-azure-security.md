---
title: 教學課程 - 針對 Azure 中的 VM 使用 Azure 資訊安全中心
description: 在本教學課程中，您將了解如何利用 Azure 資訊安全中心功能保護 Azure 中的虛擬機器。
author: cynthn
manager: gwallace
...
ms.locfileid: "94594774"
---
# <a name="tutorial-use-azure-security-center-to-monitor-virtual-machines"></a>教學課程：使用 Azure 資訊安全中心來監視虛擬機器
