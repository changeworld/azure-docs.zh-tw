...
description: Azure 命令列介面 (CLI) 用來管理資源的命令。
author: cynthn
...
本文提供 Azure 傳統命令列介面的語法和選項， (CLI) 您常用來建立和管理 Azure 資源的命令。 這不是完整的參考，您的 CLI 版本可能會顯示稍微不同的命令或參數。 
...
## <a name="active-directory-objects"></a>Active Directory 物件
...
## <a name="account-features"></a>帳戶功能
**列出您訂用帳戶可用的所有功能**
...
## <a name="hdinsight-clusters"></a>HDInsight 叢集
**用來建立或新增至叢集組態檔的命令**
