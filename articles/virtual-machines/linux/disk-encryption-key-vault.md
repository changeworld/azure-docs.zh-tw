...
當門戶可透過瀏覽器訪問時,Azure CLI 和 Azure PowerShell 需要本地安裝;但是,Azure CLI 和 Azure PowerShell 需要本地安裝。請參閱[Linux 的 Azure 磁碟加密:安裝工具](disk-encryption-linux.md#install-tools-and-connect-to-azure)的詳細資訊。
