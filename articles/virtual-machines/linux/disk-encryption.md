...
- [在主機上啟用加密](disks-enable-host-based-encryption-cli.md)
- [Azure CLI-啟用靜態加密-受控磁片](disks-enable-double-encryption-at-rest-cli.md)
...
- [為受控磁片啟用客戶管理的金鑰-PowerShell](../windows/disks-enable-customer-managed-keys-powershell.md)
