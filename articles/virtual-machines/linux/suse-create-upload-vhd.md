...
除了建立您自己的 VHD 之外，SUSE 還發佈了 BYOS (將您自己的訂用帳戶提供給 SLES 的 [虛擬機器](https://www.microsoft.com/research/wp-content/uploads/2016/04/using-and-contributing-vms-to-vm-depot.pdf)，) 映射。
