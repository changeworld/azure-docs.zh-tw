...
（2019/3/15 12：06：55 AM pbi 3897709）

| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | StdDev | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
...
注意：Av2 系列 VM 可以部署在各種硬體類型和處理器上（如上圖所示）。 Av2 系列 VM 具有 CPU 性能和記憶體配置，最適合入門級工作負載，如開發和測試。 無論部署在哪個硬體上，都會限制大小，以為正在運行的實例提供相對一致的處理器性能;但是，利用特定較新的處理器優化的軟體可能會看到處理器類型之間的更多顯著變化。

## <a name="b---burstable"></a>B - 可爆裂
（2019/3/15 12：27：08 AM pbi 3897709）
...
注意：B 系列 VM 適用于具有可突發性能要求的工作負載。 當使用少於其基線時，VM 實例會累積積分。 當 VM 累積了信用時，VM 可以使用高達 100% 的時間在基線上方突發，以滿足簡短的 CPU 突發要求。 突發時間取決於可用積分，這是 VM 大小和時間的函數。  

CoreMark 是一個短運行測試，通常在可用的突發積分內完成。  因此，上述數位通常表示 VM 的突發性能，反映了短、突髮式工作負載（典型的 B 系列）性能通常看到的情況。

## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - 一般計算 + 進階儲存體
（2019/3/12 下午 6：52：03 下午 pbi 3897709）
...
（2019/3/12 下午 6：54：27 下午 pbi 3897709）
...
（2019/3/15 12：53：13 上午 pbi 3897709）
...
（2019/3/12 下午 6：53：48 下午 pbi 3897709）
...
（2019/3/12 下午 7：17：33 下午 pbi 3897709）
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - 記憶體選擇 + 高級存儲（隔離）
（2019/4/11 10：07：29 下午 pbi 3897709）
...
（2019/3/12 下午 6：52：13 下午 pbi 3897709）
...
## <a name="eiv3---memory-optimized-isolated"></a>Eiv3 - 記憶體優化（隔離）
（2019/3/12 下午 6：57：51 下午 pbi 3897709）
...
（2019/3/12 下午 6：51：35 下午 pbi 3897709）
...
（2019/3/15 12：12：51 上午 pbi 3897709）
...
（2019/3/12 下午 6：53：59 下午 pbi 3897709）
...
## <a name="lv2---storage-optimized"></a>Lv2 - 存儲優化
（2019/3/14 下午 5：49：04 下午 pbi 3897709）

| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | StdDev | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32 核處理器 | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32 核處理器 | 16 | 2 | 125.9 | 154,829 | 3,708 | 2.40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32 核處理器 | 32 | 4 | 251.9 | 310,811 | 7,751 | 2.49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32 核處理器 | 64 | 8 | 503.9 | 595,140 | 14,572 | 2.45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32 核處理器 | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |
...
（2019/4/11 7：30：39 下午 pbi 3897709）
...
## <a name="ncsv3---gpu-enabled"></a>NCSv3 - 啟用 GPU
（2019/3/21 下午 5：48：37 下午 pbi 3897709）

| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | StdDev | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v3 | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 6 | 1 | 110.2 | 106,929 | 353 | 0.33% | 49 |
| Standard_NC12s_v3 | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 12 | 1 | 220.4 | 213,585 | 875 | 0.41% | 42 |
| Standard_NC24rs_v3 | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 24 | 2 | 440.9 | 403,554 | 6,705 | 1.66% | 42 |
| Standard_NC24s_v3 | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 24 | 2 | 440.9 | 403,874 | 7,603 | 1.88% | 42 |

## <a name="ncsv2---gpu-enabled"></a>NCSv2 - 啟用 GPU
（2019/3/12 11：19：19 下午 pbi 3897709）

| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | StdDev | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v2 | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 6 | 1 | 110.2 | 107,115 | 321 | 0.30% | 63 |
| Standard_NC12s_v2 | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 12 | 1 | 220.4 | 213,814 | 656 | 0.31% | 63 |
| Standard_NC24rs_v2 | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 24 | 2 | 440.9 | 401,728 | 6,995 | 1.74% | 63 |
| Standard_NC24s_v2 | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 24 | 2 | 440.9 | 402,808 | 7,923 | 1.97% | 63 |

## <a name="nc---gpu-enabled"></a>NC - 啟用 GPU
（2019/3/12 11：08：03 PM pbi 3897709）

| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | StdDev | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6 | 英特爾（R） Xeon（R） CPU E5-2690 v3 = 2.60GHz | 6 | 1 | 55.0 | 102,211 | 658 | 0.64% | 259 |
| Standard_NC12 | 英特爾（R） Xeon（R） CPU E5-2690 v3 = 2.60GHz | 12 | 1 | 110.2 | 203,523 | 2,293 | 1.13% | 259 |
| Standard_NC24 | 英特爾（R） Xeon（R） CPU E5-2690 v3 = 2.60GHz | 24 | 2 | 220.4 | 382,897 | 8,712 | 2.28% | 259 |
| Standard_NC24r | 英特爾（R） Xeon（R） CPU E5-2690 v3 = 2.60GHz | 24 | 2 | 220.4 | 383,171 | 9,166 | 2.39% | 259 |

## <a name="nds--gpu-enabled"></a>已啟用 ND- GPU
（2019/3/12 11：19：10 下午 pbi 3897709）

| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | StdDev | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_ND6s | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 6 | 1 | 110.2 | 107,095 | 353 | 0.33% | 63 |
| Standard_ND12s | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 12 | 1 | 220.4 | 212,298 | 3,457 | 1.63% | 63 |
| Standard_ND24rs | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 24 | 2 | 440.9 | 402,749 | 7,838 | 1.95% | 56 |
| Standard_ND24s | 英特爾（R） Xeon（R） CPU E5-2690 v4 = 2.60GHz | 24 | 2 | 440.9 | 401,822 | 7,776 | 1.94% | 63 |

## <a name="nv---gpu-enabled"></a>NV - 啟用 GPU
（2019/3/12 11：08：13 下午 pbi 3897709）

| VM 大小 | CPU | vCPU | NUMA 節點 | 記憶體(GiB) | 平均分數 | StdDev | 標準差% | 執行數 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NV6 | 英特爾（R） Xeon（R） CPU E5-2690 v3 = 2.60GHz | 6 | 1 | 55.0 | 101,728 | 2,094 | 2.06% | 259 |
| Standard_NV12 | 英特爾（R） Xeon（R） CPU E5-2690 v3 = 2.60GHz | 12 | 1 | 110.2 | 203,903 | 1,724 | 0.85% | 252 |
| Standard_NV24 | 英特爾（R） Xeon（R） CPU E5-2690 v3 = 2.60GHz | 24 | 2 | 220.4 | 379,879 | 8,737 | 2.30% | 259 |
