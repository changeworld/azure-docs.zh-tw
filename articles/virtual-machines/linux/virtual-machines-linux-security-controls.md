---
title: 適用于 Azure Linux 虛擬機器-Linux 的安全性控制
description: 用來評估 Azure Linux 虛擬機器的安全性控制檢查清單
...
---
# <a name="security-controls-for-linux-virtual-machines"></a>Linux 虛擬機器的安全性控制

本文記錄 Linux 虛擬機器內建的安全性控制項。
...
| 安全性控制 | 是/否 | 注意 |
|---|---|--|
| 靜止的伺服器端加密： Microsoft 管理的金鑰 | 是 | 請參閱 [Linux vm 的 Azure 磁碟加密](disk-encryption-overview.md)。 |
