...
Oracle 的策略是為公共雲和私有雲端提供廣泛的解決方案組合。 策略可讓客戶在 Oracle 雲端和其他雲端中部署 Oracle 軟體時能有所選擇且更有彈性。 Oracle 與 Microsoft 的合作使客戶能夠放心地獲得 Oracle 的認證和支援,在 Microsoft 公共雲端和私有雲端中部署 Oracle 軟體。  甲骨文對甲骨文公共和私有雲解決方案的承諾和投資沒有改變。
