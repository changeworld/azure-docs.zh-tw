---
title: 使用 Azure CLI 向 Linux VM 添加資料磁片
...
>
> 如果修改 fstab 導致啟動失敗，則 Azure VM 串列主控台可用於主控台訪問 VM。 更多詳細資訊請參閱[串列主控台文檔](https://docs.microsoft.com/azure/virtual-machines/troubleshooting/serial-console-linux)。
