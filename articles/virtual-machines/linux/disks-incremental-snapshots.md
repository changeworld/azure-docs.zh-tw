---
title: 受控磁片的增量快照集
description: 瞭解受控磁片的增量快照集，包括如何使用 CLI 和 Azure Resource Manager 來建立它們。
author: roygara
...
ms.locfileid: "84658845"
---
# <a name="create-an-incremental-snapshot-for-managed-disks---cli"></a>建立受控磁片的增量快照集-CLI
