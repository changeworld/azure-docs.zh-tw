...
| `/metadata/versions` | 查看 [版本](#versions) | N/A
...
| `zone` | 您虛擬機器的[可用性區域](../../availability-zones/az-overview.md) | 2017-12-01
...
1. 傾印您的本機路由表，並尋找 IMDS 專案。 例如：         
    ```console
      ...
      ... (continues) ...
    ```
1. 確認有路由存在 `169.254.169.254` ，並記下對應的網路介面 (範例 `172.16.69.7`) 。
