...
## <a name="set-key-vault-advanced-access-policies"></a><a name="bkmk_KVper"></a>設置金鑰保存庫高級訪問策略
...
## <a name="set-up-a-key-encryption-key-optional"></a><a name="bkmk_KEK"></a>設置金鑰加密金鑰（可選）
