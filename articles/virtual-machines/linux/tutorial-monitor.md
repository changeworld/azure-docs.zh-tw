...
現在，使用 [az vm create](/cli/azure/vm#az_vm_create) 建立 VM。 下列範例會建立名為 myVM 的 VM，並產生 SSH 金鑰 (如果 ~/.ssh/ 中沒有這些金鑰的話)︰
...
現在，使用 [az vm start](/cli/azure/vm#az_vm_start) 命令啟動 VM，如下所示：
