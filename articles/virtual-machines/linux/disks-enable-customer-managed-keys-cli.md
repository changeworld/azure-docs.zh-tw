---
title: Azure CLI-使用 SSE 受控磁片啟用客戶管理的金鑰
...
ms.locfileid: "86235882"
---
# <a name="azure-cli---enable-customer-managed-keys-with-server-side-encryption---managed-disks"></a>Azure CLI-使用伺服器端加密管理的磁片來啟用客戶管理的金鑰
