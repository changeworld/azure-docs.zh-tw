---
title: 使用 PowerShell 設定 Key Vault
description: 如何使用 PowerShell 設定與虛擬機器搭配使用的 Key Vault。
author: mimckitt
manager: vashan
...
ms.locfileid: "92678316"
---
# <a name="set-up-key-vault-for-virtual-machines-using-azure-powershell"></a>使用 Azure PowerShell 來設定虛擬機器的 Key Vault
...
然後，若要啟用與範本部署搭配使用 Key Vault，請執行下列命令：
...
如需使用範本來建立金鑰保存庫時可以設定的其他選項，請參閱 [建立金鑰保存庫](https://azure.microsoft.com/documentation/templates/101-key-vault-create/)。
