---
title: PowerShell-如何使用 Packer 建立 VM 映射
description: 瞭解如何使用 Packer 和 PowerShell 在 Azure 中建立虛擬機器的映射
author: cynthn
...
| client_secret                     | 使用 `$plainPassword` 檢視自動產生的密碼 |
