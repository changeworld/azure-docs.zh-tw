---
title: 為 Azure VM 設置 WinRM 存取權限
...
> [!NOTE]
> 密碼的 URL 也必須包含版本。 示例 URL 如下所示 HTTPs：\//contosovault.vault.azure.net:443/secrets/contososecret/01h9db0df2cd4300a20ence585a6s7ve
