...
>[!NOTE]
>
>如需有關建立新虛擬機器的詳細指示，請參閱[使用 Azure PowerShell 模組建立和管理 Windows VM](./tutorial-manage-vm.md)
...
如需如何啟用客體 VM 與 Azure VM 之間透明連線的指示，請參閱[此文件](/virtualization/hyper-v-on-windows/user-guide/nested-virtualization)。
