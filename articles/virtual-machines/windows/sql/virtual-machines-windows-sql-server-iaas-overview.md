...
[Azure 虛擬機器上的 SQL Server](https://azure.microsoft.com/services/virtual-machines/sql-server/)可讓您在雲端中使用完整版的 SQL Server，而不需要管理任何內部部署硬體。 當您使用隨用隨付方案時，SQL Server VM 也會簡化授權成本。
...
### <a name="pay-as-you-go"></a><a id="payasyougo"></a>隨用隨付
