---
title: 使用 Azure 網站恢復將 Windows VM 遷移到 Azure 高級存儲
...
2. 選擇 **"創建資源** > **管理** > **備份和網站恢復 （OMS）"。** 或者，您可以選擇**流覽** > **恢復服務保存庫** > **添加**。
   >[!NOTE]
...
* [創建 Windows 伺服器 VHD 並將其上載到 Azure](upload-generalized-managed.md)
