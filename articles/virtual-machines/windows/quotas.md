...
description: 了解 Azure 虛擬機器的 vCPU 配額。
author: cynthn
...
ms.locfileid: "88950284"
---
# <a name="check-vcpu-quotas-using-azure-powershell"></a>使用 Azure PowerShell 檢查 vCPU 配額
...
您可以使用 [Get-AzVMUsage](/powershell/module/az.compute/get-azvmusage) Cmdlet 來檢查您的配額使用量。
