...
使用 [disconnect-azaccount](/powershell/module/az.accounts/connect-azaccount) 和 [disconnect-azaccount](/powershell/module/az.accounts/set-azcontext)連接到您想要的 Azure 帳戶。
