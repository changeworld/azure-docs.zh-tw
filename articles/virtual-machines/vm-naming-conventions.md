...
| 附加功能 | 一或多個小寫字母表示附加功能，例如： <br> a = 以 AMD 為基礎的處理器 <br> d = 磁片 (本機暫存磁片出現) ;這適用于較新的 Azure Vm，請參閱[Ddv4 和 Ddsv4 系列](./ddv4-ddsv4-series.md) <br> h = 休眠功能 <br> i = 隔離大小 <br> l = 記憶體不足;記憶體數量較低，而不是記憶體密集型大小 <br> m = 記憶體密集;特定大小的最大記憶體數量 <br> t = 小型記憶體;特定大小的最小記憶體數量 <br> r = 支援 RDMA <br> s = 進階儲存體能力，包括可能使用的[ULTRA SSD](./windows/disks-types.md#ultra-disk) (注意：某些較新的大小若沒有 s 的屬性，仍然可以支援進階儲存體例如 M128、M64 等等 ) <br> |
