...
| [azure vm extension set](/cli/azure/vm/extension) | 對虛擬機器執行 VM 擴充功能。 此案例會使用 Azure 監視器代理程式擴充功能來安裝 Log Analytics 代理程式，並在 Log Analytics 工作區中註冊 VM。 |
