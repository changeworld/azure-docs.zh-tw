---
title: 從快照集建立受控磁碟 (Windows) - PowerShell 範例
...
ms.locfileid: "87088609"
---
# <a name="create-a-managed-disk-from-a-snapshot-with-powershell-windows"></a>使用 PowerShell 從快照集建立受控磁碟 (Windows)
