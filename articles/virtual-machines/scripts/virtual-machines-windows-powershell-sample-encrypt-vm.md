...
| [New-AzKeyVault](/powershell/module/az.keyvault/new-azkeyvault) | 建立 Azure Key Vault 來儲存安全資料，例如加密金鑰。 |
| [Add-AzKeyVaultKey](/powershell/module/az.keyvault/add-azkeyvaultkey) | 在 Key Vault 中建立加密金鑰。 |
| [New-AzADServicePrincipal](/powershell/module/az.resources/new-azadserviceprincipal) | 建立 Azure Active Directory 服務主體，以安全地進行驗證及控制對加密金鑰的存取。 |
...
| [Get-AzKeyVault](/powershell/module/az.keyvault/get-azkeyvault) | 取得 Key Vault 的必要資訊 |
| [Set-AzVMDiskEncryptionExtension](/powershell/module/az.compute/set-azvmdiskencryptionextension) | 使用服務主體認證和加密金鑰在 VM 上啟用加密。 |
| [Get-AzVmDiskEncryptionStatus](/powershell/module/az.compute/get-azvmdiskencryptionstatus) | 顯示 VM 加密程序的狀態。 |
