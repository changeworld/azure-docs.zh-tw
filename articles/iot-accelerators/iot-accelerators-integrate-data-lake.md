...
1. 在 [資料總管] 中，向下切入至 **/streaming** 資料夾。 您會看到以 YYYY/MM/DD 格式建立的資料夾。

    ![顯示/streaming/YYYY/MM/DD/HH 資料夾路徑的螢幕擷取畫面。](./media/iot-accelerators-integrate-data-lake/data-lake-store-data-explorer.png)
