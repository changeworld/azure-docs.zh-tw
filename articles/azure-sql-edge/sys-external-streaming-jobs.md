---
title: sys.external_streaming_jobs (Transact-SQL) - Azure SQL Edge (預覽)
description: 了解如何在 Azure SQL Edge (預覽) 中使用 sys.external_streaming_jobs
