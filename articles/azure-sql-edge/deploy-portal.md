...
您可以從支援 SQL 連線的任何外部 Linux、Windows 或 macOS 工具，連接到您的 Azure SQL Edge 實例，並執行 SQL 查詢。 如需從外部連線到 SQL Edge 容器的詳細資訊，請參閱[連線及查詢 Azure SQL Edge](./connect.md)。
