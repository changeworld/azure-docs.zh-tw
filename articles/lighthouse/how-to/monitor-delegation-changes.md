...
- [使用憑證對其進行身份驗證](../../active-directory/develop/howto-create-service-principal-portal.md#certificates-and-secrets)[並將其安全地儲存在 Azure 金鑰保管庫中](../../key-vault/general/best-practices.md)。
- 限制有權訪問代表服務主體行事的使用者。
