...
* [如何設定 Azure 認知服務虛擬網路](./cognitive-services-virtual-networks.md?tabs=portal)
...
* [瞭解 Azure 認知服務容器安全性](./cognitive-services-container-support.md#azure-cognitive-services-container-security)
...
* [應用程式安全性群組](../virtual-network/network-security-groups-overview.md#application-security-groups)
...
* [使用 Azure 認知服務的診斷設定](./diagnostic-logging.md)
...
* [如何重新產生 Azure Cache for Redis 存取金鑰](../azure-cache-for-redis/cache-configure.md#settings)
...
* [瞭解 Azure 認知服務 REST API](/rest/api/cognitiveservices/)
...
* [如何驗證認知服務的要求](./authentication.md#authenticate-with-azure-active-directory)
...
* [如何在 Azure API 管理中管理使用者帳戶](../api-management/api-management-howto-create-or-invite-developers.md)
...
* [瞭解 Azure 認知服務的傳輸層安全性](./cognitive-services-security.md)
...
* [加密待用資訊的服務清單](./encryption/cognitive-services-encryption-keys-portal.md)
...
* [如何使用 Azure Resource Manager 範本建立認知服務資源](./create-account-resource-manager-template.md?tabs=portal)
...
**指導** 方針：使用 Azure DevOps 安全地儲存和管理您的 Azure Resource Manager 範本。 若要保護您在 Azure DevOps 中管理的資源，您可以授與或拒絕特定使用者、內建安全性群組或 Azure Active Directory (Azure AD) （如果與 Azure DevOps 整合）中定義的群組，或與 TFS 整合的 Active Directory。  使用 Azure 角色型存取控制來保護客戶管理的金鑰。 在 Key Vault 中啟用 Soft-Delete 和清除保護，以防止金鑰遭到意外或惡意刪除。 
