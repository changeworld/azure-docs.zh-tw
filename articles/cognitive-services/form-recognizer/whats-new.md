...
* 客戶管理的金鑰現在可供 FormRecognizer。 如需詳細資訊，請參閱 [表單辨識器的待用資料加密](./form-recognizer-encryption-of-data-at-rest.md)。
