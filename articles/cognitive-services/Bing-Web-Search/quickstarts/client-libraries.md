---
title: 快速入門：使用 Bing Web 搜尋用戶端程式庫
titleSuffix: Azure Cognitive Services
description: Bing Web 搜尋 API 提供用戶端程式庫，可讓您輕鬆地將搜尋功能整合到您的應用程式中。 使用本快速入門，開始傳送搜尋要求並取得結果。
...
ms.locfileid: "96350648"
---
# <a name="quickstart-use-a-bing-web-search-client-library"></a>快速入門：使用 Bing Web 搜尋用戶端程式庫
