...
您可以使用 `cc` 查詢參數指定國家/地區。 指定國家或地區時，您必須指定一或多個具有[ `Accept-Language` 標頭](/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-reference#headers)的語言代碼。 使用[市場資料表](#markets)取得每個市場所支援的語言清單。
