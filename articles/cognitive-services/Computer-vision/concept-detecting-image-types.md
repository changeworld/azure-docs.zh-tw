...
ms.locfileid: "96532596"
---
# <a name="detecting-image-types-with-computer-vision"></a>使用電腦視覺偵測影像類型

使用 [分析影像](https://westcentralus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-ga/operations/56f91f2e778daf14a499f21b) API，電腦視覺可以分析影像的內容類型，指出影像為美工圖案或線條繪圖。
...
影像類型偵測功能是「 [分析影像](https://westcentralus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-ga/operations/56f91f2e778daf14a499f21b) API」的一部分。 您可以透過原生 SDK 或 REST 呼叫來呼叫此 API。 包含 `ImageType` 在 **visualFeatures** 查詢參數中。 然後，當您取得完整 JSON 回應時，只要剖析該區段內容的字串即可 `"imageType"` 。
