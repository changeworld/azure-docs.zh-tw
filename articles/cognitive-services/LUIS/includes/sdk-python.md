...
使用應用程式識別碼、版本識別碼和範例呼叫 [examples.add](/python/api/azure-cognitiveservices-language-luis/azure.cognitiveservices.language.luis.authoring.operations.examplesoperations?view=azure-python)。
