...
1. 為名為 `LUIS_APP_ID` 的應用程式識別碼建立變數。 將設定為公用 IoT 應用程式， **`df67dcdb-c37d-46af-88e1-8b97951ca1c2`** 。 建立變數以設定 `production` 發佈的位置。
