...
* **設定 LUIS 資源** -在 Azure 中建立將由持續整合工作流程使用的 [LUIS 撰寫和預測資源](https://docs.microsoft.com/azure/cognitive-services/luis/luis-how-to-azure-subscription#create-resources-in-azure-cli) 。
