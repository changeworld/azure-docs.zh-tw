...
在[REST API](https://westus.dev.cognitive.microsoft.com/docs/services/luis-programmatic-apis-v3-0-preview/operations/58b6f32139e2bb139ce823c9)中，版本名稱是必要的，而且必須存在於應用程式中，但不會在該驗證之外使用。 審核語句適用于整個應用程式。 如果您從某個_版本_移除語句，所有版本都會受到影響。
