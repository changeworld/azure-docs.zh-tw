---
title: 語言檢測庫伯內斯配置和部署步驟
titleSuffix: Azure Cognitive Services
description: 語言檢測庫伯內斯配置和部署步驟
...
---
### <a name="deploy-the-language-detection-container-to-an-aks-cluster"></a>將語言檢測容器部署到 AKS 群集
...
1. 在文字編輯器中，創建名為 *"語言.yaml"* 的新檔，並將下面的 YAML 粘貼到其中。 請務必替換`billing/value`並`apikey/value`使用您自己的資訊。
...
1. 保存檔，然後關閉文字編輯器。
1. 以*語言.yaml* `apply`檔為目標運行 Kubernetes 命令：
