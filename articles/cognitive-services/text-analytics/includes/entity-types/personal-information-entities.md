...
|--------------|-----------------------------------------------------------|----------------------------------------|
| N/A          | 識別的名稱 `Bill Gates` ，例如`Marie Curie` | `2020-02-01`                           |
...
| 子類型名稱 | Description                                                                                       | 從模型版本開始提供|
|--------------|---------------------------------------------------------------------------------------------------|--------------|
| N/A          | 組織 `Microsoft` ，例如， `NASA``National Oceanic and Atmospheric Administration` | `2020-02-01` |
