...
| 子類型名稱 | 描述                                                                                       | 從模型版本開始提供|
|--------------|---------------------------------------------------------------------------------------------------|--------------|
| N/A          | 例如 `Microsoft`、`NASA``National Oceanic and Atmospheric Administration` 的組織 | `2020-02-01` |
...
| 子類型名稱 | 描述                                          | 從模型版本開始提供 |
|--------------|------------------------------------------------------|----------------------------------------|
| N/A          | 網站的 Url，例如 `https://www.bing.com` | `2020-02-01`                           |
...
| 子類型名稱 | 描述                              | 從模型版本開始提供 |
|--------------|------------------------------------------|----------------------------------------|
| N/A          | 例如 `10.0.0.101` 的網路位址 | `2020-02-01`                           |
