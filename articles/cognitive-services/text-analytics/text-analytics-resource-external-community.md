...
description: 合作夥伴的 blog、YouTube 影片、Azure 認知服務的訓練文字分析 API。
...
+ [Text Analytics API original announcement (Azure blog)](https://azure.microsoft.com/blog/using-text-analytics-in-call-centers/) (文字分析 API 原始宣告 (Azure 部落格))
