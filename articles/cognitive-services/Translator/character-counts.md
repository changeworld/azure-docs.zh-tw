---
title: 字元計數-Translator
titleSuffix: Azure Cognitive Services
description: 本文說明 Azure 認知服務 Translator 如何計算字元，讓您可以瞭解它如何內嵌內容。
...
ms.locfileid: "83587318"
---
# <a name="how-the-translator-counts-characters"></a>翻譯工具如何計算字元

翻譯工具會將輸入文字的每個 unicode 程式碼點計算為一個字元。 語言文字的每一個翻譯都會計算為不同的翻譯，即使您是在單一 API 呼叫中發出轉譯為多種語言的要求亦然。 回應的長度無關緊要。
...
針對以表意文字（例如中文和日文漢字）為基礎的腳本，Translator 服務仍然會計算 Unicode 程式碼點的數目，每個 ideogram 一個字元。 例外狀況： Unicode 代理的計數為兩個字元。
...
如需有關字元計數的詳細資訊，請閱讀[翻譯工具常見問題](https://www.microsoft.com/en-us/translator/faq.aspx)。
