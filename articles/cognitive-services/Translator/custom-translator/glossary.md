...
| **單字或片語**       | **定義**                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 來源語言          | 來源語言是您開始使用的語言，而且想要轉換成另一種語言（「目標」）。                                                                                                                                                                                                                                                                                                                                                         |
...
| 測試檔案            | 這些檔案通常是從定型集中隨機選取的衍生檔案 (如果您未選取任何測試集)。 這些句子的目的是要評估轉譯模型的精確度。 您會利用這些句子來確保系統翻譯的正確性。 因此，您可能會想要建立測試集，並將它上傳至翻譯工具，以確保這些句子會用於系統的評估（產生 BLEU 分數）。   |
| 組合檔案               | 將來源和翻譯的句子包含在相同檔案中的檔案類型。 支援的檔案格式 (".tmx"、".xliff"、".xlf"、".lcl"、".xlsx")。                                                                                                                                                                                                                                                                                                                       |
| 封存檔             | 包含其他檔案的檔案。 支援的檔案格式 (zip、gz、tgz)。                                                                                                                                                                                                                                                                                                                                                                                                |
| BLEU 分數               | [BLEU](what-is-bleu-score.md)是一種業界標準方法，可用於評估轉譯模型的「精確度」或準確度。 雖然還有其他評估方法可供使用，但 Microsoft Translator 會採用 BLEU 方法將精確度報告給專案擁有者。
