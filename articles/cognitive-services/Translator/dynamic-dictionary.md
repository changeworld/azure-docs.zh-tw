...
請謹慎使用此功能。 自訂翻譯的更好方法是使用自訂翻譯。 Custom Translator 會完全利用內容和統計機率。 如果您已有或能夠建立定型資料，以便在上下文中顯示您的單字或片語，則會得到更好的結果。 您可以在找到有關自訂翻譯的[https://aka.ms/CustomTranslator](https://aka.ms/CustomTranslator)詳細資訊。
