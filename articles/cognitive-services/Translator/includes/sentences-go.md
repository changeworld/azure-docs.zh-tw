...
讓我們來建立可判斷句子長度的函式。 此函式將會採用單一引數：您的翻譯工具訂用帳戶金鑰。
...
>[!NOTE]
> 如需關於端點、路由和要求參數的詳細資訊，請參閱[翻譯工具 3.0：BreakSentence](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-break-sentence)。
