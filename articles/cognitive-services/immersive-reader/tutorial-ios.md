...
ms.locfileid: "86049305"
---
# <a name="tutorial-launch-the-immersive-reader-using-the-swift-ios-code-sample"></a>教學課程：使用 Swift iOS 程式碼範例啟動沈浸式閱讀程式
...
2. 在頂端功能表中，按一下 [產品] > [配置] > [編輯配置...]
3. 在 [執行] 檢視中，按一下 [引數] 索引標籤。
4. 在 [環境變數] 區段中，新增下列名稱和值，並使用您在建立沈浸式閱讀程式資源時提供的值。
