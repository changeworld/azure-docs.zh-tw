...
* **連接字串** ：如需如何從 Azure 資料表儲存體取得連接字串的詳細資訊，請參閱 [View 和 copy 連接字串](../../storage/common/storage-account-keys-manage.md?tabs=azure-portal&toc=%252fazure%252fstorage%252ftables%252ftoc.json#view-account-access-keys) 。
...
## <a name="span-idmongodbmongodbspan"></a><span id="mongodb">MongoDB</span> \(英文\)
