...
* **金融**：貸款、金融和保險產品的個人化優惠，其中風險因素基於個人不知道、無法獲得或無法爭議的資料。 
* **教育**：學校課程和教育機構的個人化排名，建議可能會傳播偏見，降低使用者對其他選擇的認識。
* **民主與公民參與**：以影響意見為目標的使用者個人化內容是間接的和操縱性的。
* **協力廠商獎勵評估**：根據後三方對使用者的評價，而不是由使用者自己的行為產生獎勵的個人化專案。
...
* 考慮您的用例是否構成自動處理，這嚴重影響受[GDPR](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32016R0679)第 22 條或其他法律規範的資料主體的影響。
...
* **區域資訊**：在世界許多地方，位置資訊（如郵遞區號、郵遞區號或鄰里名稱）可能與收入、種族和宗教高度相關。
...
* 問問自己：如果我使用這些資訊來個人化他們的內容，我的使用者會關心並高興嗎？ 我是否能坦然向使用者說明醒目提示或隱藏某些項目的決策是如何制定的？
