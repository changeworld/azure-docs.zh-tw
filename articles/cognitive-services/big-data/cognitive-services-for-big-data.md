...
[Azure Databricks](https://docs.microsoft.com/azure/azure-databricks/what-is-azure-databricks) 是一個針對 Microsoft Azure 雲端服務平台進行最佳化的 Apache Spark 分析平台。 其提供了單鍵設定、簡化的工作流程和互動式工作區，可支援資料科學家、資料工程師和商務分析師之間的共同作業。
