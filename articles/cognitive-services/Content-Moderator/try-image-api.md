...
使用 Azure Content Moderator 中的[影像審核 API](https://westus.dev.cognitive.microsoft.com/docs/services/57cf753a3f9b070c105bd2c1/operations/57cf753a3f9b070868a1f66c) 來起始影像內容的掃描與檢閱審核工作流程。 審核作業會掃描內容的褻瀆行為，並將其與自訂和共用阻止清單進行比較。
...
4. 選擇 **"發送**"。 在此範例中，API 會尋找兩個臉部，並傳回其在影像中的座標。
...
5. 選擇 **"發送**"。 所擷取的文字會以 JSON 顯示：

   ![[影像 - OCR] 回應內容方塊範例](images/try-image-api-ocr.PNG)

## <a name="next-steps"></a>後續步驟

在代碼中使用 REST API，或按照[.NET SDK 快速入門](dotnet-sdk-quickstart.md)向應用程式添加映射審核。
