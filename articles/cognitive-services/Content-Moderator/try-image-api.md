...
在您的程式碼中使用 REST API，或遵循 [.NET SDK 快速入門](./client-libraries.md?pivots=programming-language-csharp%253fpivots%253dprogramming-language-csharp) ，將影像仲裁新增至您的應用程式。