...
description: 針對可能不想要的文字、個人資料和自訂字詞清單使用文字仲裁。
...
您可以根據您的原則和閾值來封鎖、核准或審核內容 (請參閱 [評論、工作流程和工作](./review-api.md) ，以瞭解如何設定人工審核) 。 使用「文字仲裁」模型，以增強夥伴、員工和取用者產生文字內容之環境的人力審核。 這些環境包括聊天室、討論區、聊天機器人、電子商務目錄和文件。
...
假設輸入文字是 (' lzay '，而 ' f0x ' 是刻意) ：

> Qu！ ck 棕色 f0x 會跳到 lzay 狗。
