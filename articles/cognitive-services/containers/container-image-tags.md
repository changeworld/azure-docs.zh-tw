...
| `2.1.1-amd64-pl-pl-preview` | 具有 `pl-PL` 地區設定的容器映射。 |
...
| `2.1.0-amd64-nb-no-preview` | 具有 `nb-NO` 地區設定的容器映射。 |
...
| `2.0.2-amd64-ja-jp-preview` | 具有 `ja-JP` 地區設定的容器映射。 |
...
| `2.0.1-amd64-hi-in-preview` | 具有 `hi-IN` 地區設定的容器映射。 |
