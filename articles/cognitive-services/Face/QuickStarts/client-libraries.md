---
title: 快速入門：使用臉部用戶端程式庫
titleSuffix: Azure Cognitive Services
description: 臉部 API 提供用戶端程式庫，讓您輕鬆地偵測、尋找相似項目、識別、驗證等等。
...
ms.locfileid: "84610921"
---
# <a name="quickstart-use-the-face-client-library"></a>快速入門：使用臉部用戶端程式庫
