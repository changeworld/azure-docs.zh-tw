...
若要依照本教學課程，您需要 Bing 拼字檢查 API 的訂用帳戶金鑰。 如果您沒有金鑰，請在 Azure 入口網站中[建立 Bing 拼字檢查資源](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7)。 您也可以使用[試用版金鑰](https://azure.microsoft.com/try/cognitive-services/?api=spellcheck-api)。
