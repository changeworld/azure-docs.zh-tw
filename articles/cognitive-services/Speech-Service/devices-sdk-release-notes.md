...
- 已將 [語音 SDK](./speech-sdk.md) 元件更新為版本1.11.0。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。
...
- 已將 [語音 SDK](./speech-sdk.md) 元件更新為版本1.9.0。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。
...
- 已將 [語音 SDK](./speech-sdk.md) 元件更新為版本1.7.0。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。

## <a name="speech-devices-sdk-160"></a>語音裝置 SDK 1.6.0：

- 使用常見的[範例應用程式](./speech-devices-sdk.md)支援 Windows 和 Linux 上的[Azure Kinect DK](https://azure.microsoft.com/services/kinect-dk/)
- 已將 [語音 SDK](./speech-sdk.md) 元件更新為版本1.6.0。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。

## <a name="speech-devices-sdk-151"></a>語音裝置 SDK 1.5.1：

- 在範例應用程式中包含 [對話](./conversation-transcription.md) 轉譯。
- 已將 [語音 SDK](./speech-sdk.md) 元件更新為版本1.5.1。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。

## <a name="speech-devices-sdk-150-2019-may-release"></a>語音裝置 SDK 1.5.0： 2019-可能版本

- 語音裝置 SDK 現已正式推出，不再是閘道預覽。
- 已將 [語音 SDK](./speech-sdk.md) 元件更新為1.5.0 版。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。
...
- 已將 [語音 SDK](./speech-sdk.md) 元件更新為版本1.4.0。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。

## <a name="speech-devices-sdk-131-2019-mar-release"></a>語音裝置 SDK 1.3.1： 2019-Mar 版

- 已將 [語音 SDK](./speech-sdk.md) 元件更新為版本1.3.1。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。
- 更新關鍵字處理，請參閱重大變更。
- 範例應用程式會新增語音辨識和轉譯的語言選擇。

**重大變更**

- [安裝關鍵字](./custom-keyword-basics.md) 已簡化，它現在是應用程式的一部分，不需要在裝置上進行個別安裝。
- 關鍵字辨識已變更，且支援兩個事件。
...
- 已將[語音 SDK](./speech-sdk.md) 元件版本更新至 1.1.0。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。
- 遠場語音辨識精確度已藉由增強的音訊處理演算法獲得提升。
- 範例應用程式新增了中文語音辨識支援。

## <a name="speech-devices-sdk-101-2018-oct-release"></a>語音裝置 SDK 1.0.1： 2018-十月版本

- 已將[語音 SDK](./speech-sdk.md) 元件版本更新至 1.0.1。 如需詳細資訊，請參閱其[版本資訊](./releasenotes.md)。
...
- 將[語音 SDK](./speech-sdk.md) 元件版本更新至 0.5.0。 如需詳細資訊，請參閱其[版本資訊](releasenotes.md#cognitive-services-speech-sdk-050-2018-july-release)。
