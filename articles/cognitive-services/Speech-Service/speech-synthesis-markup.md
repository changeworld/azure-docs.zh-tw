...
ms.locfileid: "81399828"
---
# <a name="improve-synthesis-with-speech-synthesis-markup-language-ssml"></a>使用語音合成標記語言 (SSML) 改進合成

語音合成標記語言 (SSML) 是一種基於 XML 的標記語言,它允許開發人員使用文本到語音服務指定輸入文本如何轉換為合成語音。 與純文本相比,SSML 允許開發人員微調音高、發音、說話速率、音量以及更多文本到語音輸出。 正常的標點符號,如句后暫停,或在句子以問號結尾時使用正確的語調。
...
從標準和神經語音中進行選擇,或創建自己的自定義語音,這些語音是您的產品或品牌獨有的。 75+ 標準語音提供超過 45 種語言和區域設置,5 個神經語音提供四種語言和區域設置。 如需支援的語言、地區設定和語音 (神經和標準) 的完整清單，請參閱[語言支援](language-support.md)。

要瞭解有關標準語音、神經網路和自訂語音的詳細資訊,請參閱[文字到語音概述](text-to-speech.md)。
...
每個 SSML 文件都是使用 SSML 元素(或標記)創建的。 這些元素用於調整音高、原聲、體積等。 以下各節詳細介紹了如何使用每個元素,以及何時需要元素或可選元素。  

> [!IMPORTANT]
> 不要忘記在屬性值周圍使用雙引號。 格式良好、有效的 XML 標準要求屬性值以雙引弧括起來。 例如,`<prosody volume="90">`是格式良好的有效元素,但`<prosody volume=90>`不是 。 SSML 可能無法識別不在引號中的屬性值。

## <a name="create-an-ssml-document"></a>建立 SSML 文件

`speak`是根元素,是所有 SSML 文件**所必需的**。 該`speak`元素包含重要資訊,如版本、語言和標記詞彙定義。
...
| 屬性 | 描述 | 必要/選用 |
|-----------|-------------|---------------------|
| `version` | 指示用於解釋文件標記的 SSML 規範的版本。 當前版本為1.0。 | 必要 |
| `xml:lang` | 指定根文件的語言。 該值可能包含小寫、雙字母語言代碼(例如`en`),或者語言代碼和大寫國家/區域(例如`en-US`。 | 必要 |
| `xmlns` | 指定定義 SSML 文件的標記字彙(元素類型和屬性名稱)的文件的 URI。 目前http://www.w3.org/2001/10/synthesisURI 為 。 | 必要 |

## <a name="choose-a-voice-for-text-to-speech"></a>為文字到語音選擇語音

該`voice`元素是必需的。 它用於指定用於文字到語音的語音。
...
> [!NOTE]
> 此範例使用語音`en-US-AriaRUS`。 有關支援語音的完整清單,請參閱[語言支援](language-support.md#text-to-speech)。
...
### <a name="disable-word-boundary"></a>關閉單字邊界

根據語音 SDK 語言,`"SpeechServiceResponse_Synthesis_WordBoundaryEnabled"``false``SpeechConfig`您將在 物件的實例上將屬性設置為。
...
默認情況下,文本到語音服務使用中性語音樣式為標準語音和神經語音合成文本。 通過神經語音,您可以調整說話風格,以表達快樂、同情或情緒元素`<mstts:express-as>`。 這是語音服務獨有的可選元素。

目前,支持這些神經語音的說話風格調整:
* `en-US-AriaNeural`
* `zh-CN-XiaoxiaoNeural`

更改在句子級別應用,樣式因語音而異。 如果不支持樣式,服務將以預設中性發言樣式返回語音。
...
| 屬性 | 描述 | 必要/選用 |
|-----------|-------------|---------------------|
| `style` | 指定說話樣式。 目前,說話風格是特定於語音的。 | 如果調整神經語音的說話風格,則需要。 如果使用`mstts:express-as`,則必須提供樣式。 如果提供了無效值,則將忽略此元素。 |
...
此 SSML`<mstts:express-as>`碼段 表示您可以使用元素會改變`cheerful`。
...
> [!NOTE]
> 如果單詞或短語的合成語音聽起來不自然,則使用此元素可以覆蓋單詞或短語的文本到語音 (TTS) 的默認行為。 設置為`strength``none`防止由文本到語音轉換服務自動插入的正體中斷。
...
| `time` | 指定暫停的絕對持續時間(以秒或毫秒為單位)。 合法值的範例為`2s`與`500` | 選用 |
...
`p`元素`s`分別用於表示段落和句子。 如果沒有這些元素,文本到語音轉換服務會自動確定 SSML 文件的結構。

這個`p`元素可能`audio`包含 文字和以下`break`元素: `phoneme` `prosody` `say-as` `sub`、 `mstts:express-as` `s`、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、

此`s``audio`元素可能包含文字與以下元素: `break`、 `phoneme` `prosody` `say-as` `mstts:express-as`、 `sub`、 、 、 、 、 、 、 、 、 與 , 與 。
...
該`ph`元素用於 SSML 文件中的語音發音。 元素`ph`只能包含文本,不包含其他元素。 始終提供人類可讀的語音作為回退。
...
## <a name="use-custom-lexicon-to-improve-pronunciation"></a>使用自訂詞典提高發音

有時 TTS 不能準確發音一個單詞,例如,公司或外國名稱。 開發人員可以使用`phoneme`和`sub`標記在 SSML 中定義這些實體的讀取,或者`lexicon`透過使用標記引用自訂詞典檔的讀取來定義多個實體的讀取。
...
您可以按自訂詞典項列表定義實體的讀取,這些自定義詞典項存儲為 .xml 或 .pls 檔案。
...
每個`lexeme`元素都是一個詞典項。 `grapheme`引入描述的`lexeme`正交器的文字。 讀出表單可以作為`alias`提供。 電話字串可以在元素中`phoneme`提供。

該`lexicon`元素至少包含一`lexeme`個元素。 每個`lexeme`元素至少包含`grapheme`一個元素和一個或`grapheme`多個`alais`,`phoneme`以及元素。 元素`grapheme`包含描述<a href="https://www.w3.org/TR/pronunciation-lexicon/#term-Orthography" target="_blank">地勢<span class="docon docon-navigate-external x-hidden-focus"></span></a>的文本。 元素`alias`用於表示首字母縮略詞或縮寫詞的發音。 該`phoneme`元素提供描述`lexeme`如何 發音的文本。

有關自定義詞典檔的詳細資訊,請參閱 W3C 網站上的[發音詞典規範 (PLS) 版本 1.0。](https://www.w3.org/TR/pronunciation-lexicon/)

步驟 2:上傳在步驟 1 建立的自訂詞典檔連線,您可以將儲存在任何位置,我們建議您將其儲存在 Microsoft Azure 中,例如[Azure Blob 儲存](https://docs.microsoft.com/azure/storage/blobs/storage-quickstart-blobs-portal)。

第三步:請參考 SSML 中的自訂詞典檔
...
**限制**
- 檔大小:自定義詞典檔大小最大限制為 100KB,如果超出此大小,合成請求將失敗。
- Lexicon 快取刷新:自訂詞典將在首次載入時以 URI 作為 TTS 服務上的金鑰進行緩存。 具有相同URI的詞典不會在15分鐘內重新載入,因此自定義詞典更改最多需要等待15分鐘才能生效。

**語音服務語音集**

在上面的示例中,我們使用的是國際拼音字母表,也稱為 IPA 電話組。 我們建議開發人員使用IPA,因為它是國際標準。 考慮到 IPA 不容易記住,語音服務為七種語言`en-US``fr-FR``de-DE``es-ES``ja-JP``zh-CN`(、、、、、、、、、、 和`zh-TW`)定義了拼音集。

您可以使用`sapi``alphabet`作為 屬性的 vale,具有自訂詞典,如下所示:
...
該`prosody`元素用於指定文本到語音輸出的間距、輪廓、範圍、速率、持續時間和音量的更改。 這個`prosody`元素可能`audio`包含 文字和以下`break`元素: `p` `phoneme` `prosody` `say-as`、 `sub` `s`、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、

由於原體屬性值可能因範圍而異,因此語音辨識器將分配的值解釋為所選語音的實際原體值應是什麼的建議。 文字到語音轉換服務限制或替換不支援的值。 不支援的值的範例包括 1 MHz 的間距或 120 的音量。
...
| `volume` | 指示說話語音的音量級別。 您可以表示音量為:<ul><li>絕對值,以 0.0 到 100.0 的範圍的數位表示,從*最安靜*到*最響亮*。 例如,75。 默認值為 100.0。</li><li>一個相對值,以數位表示,前面是"+"或"-",指定要更改卷的金額。 例如,+10 或 -5.5。</li><li>常量值:<ul><li>silent</li><li>x 軟</li><li>軟</li><li>中</li><li>大聲</li><li>X-大聲</li><li>default</li></ul></li></ul> | 選用 |
...
| `format` | 提供有關元素文本的精確格式設定(可能具有不明確格式的內容類型)的其他資訊。 SSML 為使用它們的內容類型定義格式(請參見下表)。 | 選用 |
| `detail` | 指示要說出的細節級別。 例如,此屬性可能要求語音合成引擎發音標點符號。 沒有為`detail`定義標準值。 | 選用 |

<!-- I don't understand the last sentence. Don't we know which one Cortana uses? -->

以下是`interpret-as`和`format`屬性的支持內容類型。 僅當設置為`format`日期和時間`interpret-as`時 ,才包括該屬性。
...
| `digits`, `number_digit` | | 文本以單數位序列表示。 語音合成引擎為:<br /><br />`<say-as interpret-as="number_digit">123456789</say-as>`<br /><br />如"1 2 3 4 5 6 7 8 9"。 |
...
| `telephone` | | 文本以電話號碼表示。 該`format`屬性可能包含表示國家/地區代碼的數位。 例如,美國的「1」或義大利的「39」。。 語音合成引擎可以使用此資訊來指導其電話號碼的發音。 電話號碼還可以包括國家/地區代碼,如果是,則優先於中的`format`國家/地區代碼。 語音合成引擎為:<br /><br />`The number is <say-as interpret-as="telephone" format="1">(888) 555-1212</say-as>`<br /><br />作為"我的號碼是區號八八八五五五一二一二。 |
...
`audio`是允許您將 MP3 音訊插入到 SSML 文件中的可選元素。 如果音訊檔不可用或無法播放,音訊元素的正文可能包含純文本或 SSML 標記。 此外,這個`audio`元素可以包含文本`audio`和以下元素: `break` `p`、 `s` `phoneme` `prosody` `say-as`、 `sub`、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、 、

SSML 文件中包含的任何音效都必須符合以下要求:
...
| 屬性 | 描述                                   | 必要/選用                                        |
|-----------|-----------------------------------------------|------------------------------------------------------------|
| `src`     | 指定音訊檔案的位置/URL。 | 如果在 SSML 文件中使用音訊元素,則需要。 |
...
該`mstts:backgroundaudio`元素允許您向 SSML 文件添加背景音訊(或將音訊檔與文字到語音混合)。 使用`mstts:backgroundaudio`可以在後台迴圈音訊檔,在文本到語音的開頭淡入,在文本到語音的末尾淡出。

如果提供的背景音訊短於文本到語音轉換或淡出,它將迴圈。 如果時間比文本到語音轉換長,則淡出完成後將停止。

每個 SSML 文件只允許一個後台音訊檔。 但是,您可以在元素中穿插`audio`標記`voice`, 以便向 SSML 文件添加其他音訊。
...
| 屬性 | 描述 | 必要/選用 |
|-----------|-------------|---------------------|
| `src` | 指定背景音訊檔的位置/URL。 | 如果在 SSML 文件中使用背景音訊,則需要。 |
| `volume` | 指定背景音訊檔的音量。 **接受的值**`0``100`: 到包容性。 預設值是 `1`。 | 選用 |
| `fadein` | 指定背景音訊「淡入」的持續時間為毫秒。 默認值為`0`,這相當於不淡入。 **接受的值**`0``10000`: 到包容性。  | 選用 |
| `fadeout` | 指定背景音訊淡出(以毫秒為單位)的持續時間。 默認值為`0`,這相當於不淡出。**接受的值**`0``10000`: 到包容性。  | 選用 |
