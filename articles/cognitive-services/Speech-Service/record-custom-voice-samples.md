...
您的配音員可能會詢問您在一個語句中想要強調哪個詞 (也就是「關鍵詞」)。 告訴他們，你想要一個沒有特別強調的自然閱讀。 合成語音時可以加入強調，但這不應該是原始錄音的一部分。
...
> [!TIP]
> 如果您使用大量語句，單一語句可能不會對所產生的自訂語音產生明顯的影響。 只需記下任何帶有問題的話語，將它們從資料集中排除，並查看自訂語音的結果如何，可能更適宜。您始終可以返回工作室，並在以後錄製丟失的樣品。

請記下腳本上每個語句的錄音段落編號或時間代碼。 要求工程師也在錄音的中繼資料或提示表中標記每個語句。

定期休息，提供飲料，以説明您的語音天賦保持他們的聲音保持良好狀態。
