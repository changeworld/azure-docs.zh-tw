...
最後，建立與每個 WAV 檔案相關聯的「文字記錄」，其中包含對應語句的文字版本。 [建立自訂聲音音調](./how-to-custom-voice-create-voice.md)包含所需格式的詳細資料。 您可以直接從腳本複製文字。 然後建立 WAV 檔案和文字記錄的 Zip 檔案。
