...
description: 當您建立與語音服務整合的應用程式時，如何取得問題的協助和支援
...
認知服務的相關消息會收集在[認知服務部落格](https://azure.microsoft.com/blog/topics/cognitive-services/)中。 如需有關語音服務的最新資訊，請追蹤 [語音服務的 blog](https://azure.microsoft.com/blog/tag/speech-service/)。

## <a name="release-notes"></a>版本資訊

當有新版本可用時，就會立即更新 [版本](https://aka.ms/csspeech/whatsnew) 資訊。 附注包含新功能、增強功能和 bug 修正的相關資訊。
...
您可以建立 bug 報告、功能要求，或提出一般問題並分享最佳作法。 針對 Bug 報告，請依照所提供的範本進行操作：
...
**額外內容**
 ...
 - 錯誤訊息、記錄資訊、堆疊追蹤...
 - 如果您針對特定的服務互動回報錯誤，請報告 [SessionId] 和 [時間] (報告事件的時區) 。 在您收到的所有回呼/事件中都會回報 SessionId。
 - 任何其他額外資訊
...
> * [如何? 詢問一個不錯的問題嗎？](https://stackoverflow.com/help/how-to-ask)
> * [如何建立基本、完整且可驗證的範例](https://stackoverflow.com/help/mcve)
