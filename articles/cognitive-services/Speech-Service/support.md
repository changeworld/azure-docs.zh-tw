...
如果您無法透過搜尋找到問題的解答，請使用[ \[ \] \[microsoft 認知語音\]](https://stackoverflow.com/questions/tagged/microsoft-cognitive+speech)的標記將新問題提交至 Stack Overflow。
...
> * [如何建立最小、完整且可驗證的範例](https://stackoverflow.com/help/mcve)
