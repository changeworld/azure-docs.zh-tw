...
請參閱開始使用文字轉換語音的[快速入門](get-started-text-to-speech.md)。 文字轉換語音服務可透過[語音 SDK](speech-sdk.md)、 [REST API](rest-text-to-speech.md)和[語音 CLI](spx-overview.md)取得
