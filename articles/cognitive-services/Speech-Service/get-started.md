...
1. 前往 [試用認知服務](https://azure.microsoft.com/free/cognitive-services)。
1. 選取 [語音識別 API]**** 索引標籤。
1. 選擇 [ **取得 API 金鑰**]。

您會看到帳單選擇。 選擇 [免費] 選項，然後閱讀並核准使用者合約。 您會看到可用來免費試用語音服務30天的金鑰。

## <a name="try-the-speech-service-by-creating-an-azure-resource"></a><a id="new-resource"></a>藉由建立 Azure 資源來試用語音服務
