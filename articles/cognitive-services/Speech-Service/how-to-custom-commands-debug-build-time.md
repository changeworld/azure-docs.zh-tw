...
如果 LUIS 應用程式刪除失敗，請前往您的[LUIS](https://www.luis.ai/)帳戶手動將它們刪除。

### <a name="toomanyrequests"></a>TooManyRequests
當您嘗試同時刪除大量應用程式時，您可能會看到「TooManyRequests」錯誤。 這表示您的刪除要求會受到 Azure 的節流。 
...
當您使用參數時，不允許將它刪除。 請在任何語音回應、範例句子、條件、動作中移除參數的任何參考，然後再試一次。
