...
ms.locfileid: "81399836"
---
# <a name="guidelines-for-creating-an-effective-keyword"></a>建立有效關鍵字的指南

創建有效的關鍵字對於確保您的設備能夠持續、準確地回應至關重要。 自定義關鍵字是區分您的設備並增強品牌的有效方法。 在本文中,您將學習創建有效關鍵字的一些指導原則。

## <a name="choose-an-effective-keyword"></a>選擇關鍵字
...
> * 您的關鍵字應為英語單詞或短語。
> * 說出喚醒字所需的時間不應超過兩秒。
> * 由 4 到 7 個音節所構成的單字，是效果最佳的喚醒字。 例如,"嘿,計算機"是一個很好的關鍵字。 只有 "Hey" 則不好。
> * 關鍵字應遵循常見的英語發音規則。
> * 遵循一般英文發音規則的獨特或甚至虛構的單字可減少誤判的情況。 例如,「計算機」可能是一個很好的關鍵字。
...
瞭解如何[使用語音工作室建立自訂關鍵字](speech-devices-sdk-create-kws.md)。
