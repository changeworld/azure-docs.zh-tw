...
|--|--|--|
| C# | [轉換到說話者][1-speaker] | [.NET Framework][dotnet]、[.NET Core][netcore]、[UWP][uwp]、[Unity][unity]、[Xamarin][xamarin] |
| C++ | [轉換到說話者][2-speaker] | [Windows][cpp-windows]、[Linux][cpp-linux]、[macOS][cpp-mac] |
| Java | [轉換到說話者][3-speaker] | [Android][java-android]、[JRE][java-jre] |
| JavaScript | [Node.js 轉換到音訊檔案][js-node] | [Windows、Linux、macOS][js-code] |
| Objective-C | [iOS 轉換到喇叭][obj-iOS-qck]，[macOS 轉換到喇叭][obj-macOS-qck] | [iOS][obj-iOS]、[macOS][obj-macOS] |
| Python | [轉換到說話者][4-speaker] | [Windows、Linux、macOS][python] |
| Swift | [iOS 轉換到喇叭][swift-iOS-qck]，[macOS 轉換到喇叭][swift-macOS-qck] | [iOS][swift-iOS]、[macOS][swift-macOS] |
