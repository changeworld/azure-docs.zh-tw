...
|--|--|--|
| C# | [從麥克風][1-mic]，[從 Blob ][1-blob] | [.NET Framework][dotnet]、[.NET Core][netcore]、[UWP][uwp]、[Unity][unity]、[Xamarin][xamarin] |
| C++ | [從麥克風][2-mic]，[從 Blob ][2-blob] | [Windows][cpp-windows]、[Linux][cpp-linux]、[macOS][cpp-mac] |
| Java | [從麥克風][3-mic]，[從 Blob ][3-blob] | [Android][java-android]、[JRE][java-jre] |
| JavaScript | [從麥克風 (瀏覽器)][js-browser]，[從檔案 (Node.js)][js-node] | [Windows、Linux、macOS][js-code] |
| Objective-C | [從麥克風 (iOS)][obj-iOS-qck]，[從麥克風 (macOS)][obj-macOS-qck] | [iOS][obj-iOS]、[macOS][obj-macOS] |
| Python | [從麥克風][4-mic]，[從 Blob ][4-blob] | [Windows、Linux、macOS][python] |
| Swift | [從麥克風 (iOS)][swift-iOS-qck]，[從麥克風 (macOS)][swift-macOS-qck] | [iOS][swift-iOS]、[macOS][swift-macOS] |
