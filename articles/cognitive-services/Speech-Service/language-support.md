...
自訂語音適用于標準和類神經層。 這兩個層級支援的語言不同。 

| 語言 | Locale | 標準 | 類神經 |
|--|--|--|--|
| 中文 (中文，簡化)  | `zh-CN` | 是 | 是 |
| 中文 (中文，簡化) ，英文雙語 | `zh-CN` 雙語 | 是 | 是 |
| 英文 (澳大利亞) | `en-AU` | 否 | 是 |
| 英文 (印度) | `en-IN` | 是 | 是 |
| 英文 (英國) | `en-GB` | 是 | 是 |
| 英文 (美國) | `en-US` | 是 | 是 |
...
選取適當的地區設定，以符合您必須訓練自訂語音模型的訓練資料。 例如，如果您擁有的錄音資料是英式英文，請選取 [`en-GB`]。

> [!NOTE]
> 除了中文-英文雙語之外，我們不支援自訂語音中的雙語模型訓練。 如果您想要訓練中文語音 (也可以說英文)，請選取 [中文-英文雙語]。 使用標準方法 Chinese-English 的雙語模型定型僅適用于北歐和美國中北部。 自訂神經語音訓練適用于英國南部和美國東部。 
