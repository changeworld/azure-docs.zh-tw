...
| 語言                 | 地區設定 (BCP-47)  | 自訂  | [語言偵測](how-to-automatic-language-detection.md) |
|------------------------------------|--------|---------------------------------------------------|-------------------------------|
| 阿拉伯文 (巴林)，現代標準  | `ar-BH` | 語言模型                                   | Yes                           | 
| 阿拉伯文 (埃及)                     | `ar-EG` | 語言模型                                   | Yes                          |
| 阿拉伯文 (伊拉克)                      | `ar-IQ` | 語言模型                                   |                           |
| 阿拉伯文 (以色列)                    | `ar-IL` | 語言模型                                   |                           |
| 阿拉伯文 (約旦)                    | `ar-JO` | 語言模型                                   |                           |
| 阿拉伯文 (科威特)                    | `ar-KW` | 語言模型                                   |                           |
...
| 阿拉伯文 (阿曼)                      | `ar-OM` | 語言模型                                   |                           |
| 阿拉伯文 (卡達)                     | `ar-QA` | 語言模型                                   |                           |
| 阿拉伯文 (沙烏地阿拉伯)              | `ar-SA` | 語言模型                                   | Yes                          |
| 巴勒斯坦) 的阿拉伯文 (狀態        | `ar-PS` | 語言模型                                   |                           |
| 阿拉伯文 (敘利亞)                     | `ar-SY` | 語言模型                                   | Yes                          |
| 阿拉伯文 (阿拉伯酋長國)       | `ar-AE` | 語言模型                                   |                           |
| 保加利亞文 (保加利亞)               | `bg-BG` | 語言模型                                   |                           |
| 加泰蘭文 (西班牙)                    | `ca-ES` | 語言模型                                   | Yes                          |
| 中文 (廣東話，繁體)   | `zh-HK` | 原音模型<br>語言模型                 |        Yes                   |
| 中文 (中文，簡化)      | `zh-CN` | 原音模型<br>語言模型                 |     Yes                      |
| 中文 (繁體，國語)       | `zh-TW` | 原音模型<br>語言模型                 |           Yes                |
| 克羅埃西亞文 (克羅埃西亞)                 | `hr-HR` | 語言模型                                   |                           |
| 捷克文 (捷克共和國)             | `cs-CZ` | 語言模型                                   |                           |
| 丹麥文 (丹麥)                   | `da-DK` | 語言模型                                   | Yes                          |
| 荷蘭文 (荷蘭)                | `nl-NL` | 語言模型                                   |    Yes                       |
| 英文 (澳大利亞)                | `en-AU` | 原音模型<br>語言模型                 | Yes                          |
| 英文 (加拿大)                   | `en-CA` | 原音模型<br>語言模型                 | Yes                          |
| 英文 (香港特別行政區)                 | `en-HK` | 語言模型                                   |                           |
| 英文 (印度)                    | `en-IN` | 原音模型<br>語言模型                 | Yes                          |
| 英文 (愛爾蘭)                  | `en-IE` | 語言模型                                   |                           |
| 英文 (紐西蘭)              | `en-NZ` | 原音模型<br>語言模型                 |  Yes                         |
| 英文 (奈及利亞)                   | `en-NG` | 語言模型                                   |                           |
| 英文 (菲律賓)              | `en-PH` | 語言模型                                   |                           |
| 英文 (新加坡)                | `en-SG` | 語言模型                                   |                           |
| 英文 (南非)             | `en-ZA` | 語言模型                                   |                           |
| 英文 (英國)           | `en-GB` | 原音模型<br>語言模型<br>發音| Yes                          |
| 英文 (美國)            | `en-US` | 原音模型<br>語言模型<br>發音| Yes                          |
| 愛沙尼亞 (愛沙尼亞)                   | `et-EE` | 語言模型                                   |                           |
| 芬蘭文 (芬蘭)                  | `fi-FI` | 語言模型                                   |     Yes                      |
| 法文 (加拿大)                    | `fr-CA` | 原音模型<br>語言模型                 |     Yes                      |
| 法文 (法國)                    | `fr-FR` | 原音模型<br>語言模型<br>發音|      Yes                     |
| 德文 (德國)                   | `de-DE` | 原音模型<br>語言模型<br>發音|  Yes                         |
| 希臘文 (希臘)                     | `el-GR` | 語言模型                                   |                           |
| 古吉拉特文 (印度)                  | `gu-IN` | 語言模型                                   |                           |
| 印度文 (印度)                      | `hi-IN` | 原音模型<br>語言模型                 |     Yes                      |
| 匈牙利文 (匈牙利)                | `hu-HU` | 語言模型                                   |                           |
| 愛爾蘭 (愛爾蘭)                      | `ga-IE` | 語言模型                                   |                           |
| 義大利文 (義大利)                    | `it-IT` | 原音模型<br>語言模型<br>發音|      Yes                     |
| 日文 (日本)                   | `ja-JP` | 原音模型<br>語言模型                 |      Yes                     |
| 韓文 (韓國)                     | `ko-KR` | 原音模型<br>語言模型                 |      Yes                     |
| 拉脫維亞文 (拉脫維亞)                   | `lv-LV` | 語言模型                                   |                           |
| 立陶宛文 (立陶宛)             | `lt-LT` | 語言模型                                   |                           |
| 馬爾他 (馬爾他)                      | `mt-MT` | 語言模型                                   |                           |
| 馬拉提文 (印度)                    | `mr-IN` | 語言模型                                   |                           |
| 挪威文 (巴克摩，挪威)         | `nb-NO` | 語言模型                                   |     Yes                      |
| 波蘭文 (波蘭)                    | `pl-PL` | 語言模型                                   |       Yes                    |
| 葡萄牙文 (巴西)                | `pt-BR` | 原音模型<br>語言模型<br>發音|          Yes                 |
| 葡萄牙文 (葡萄牙)              | `pt-PT` | 語言模型                                   |             Yes              |
| 羅馬尼亞文 (羅馬尼亞)                 | `ro-RO` | 語言模型                                   |                           |
| 俄文 (俄羅斯)                   | `ru-RU` | 原音模型<br>語言模型                 |                Yes           |
...
| 西班牙文 (墨西哥)                   | `es-MX` | 原音模型<br>語言模型                 |    Yes                       |
| 西班牙文 (尼加拉瓜)                | `es-NI` | 語言模型                                   |                           |
| 西班牙文 (巴拿馬)                   | `es-PA` | 語言模型                                   |                           |
| 西班牙文 (巴拉圭)                 | `es-PY` | 語言模型                                   |                           |
| 西班牙文 (秘魯)                     | `es-PE` | 語言模型                                   |                           |
| 西班牙文 (波多黎各)              | `es-PR` | 語言模型                                   |                           |
| 西班牙文 (西班牙)                    | `es-ES` | 原音模型<br>語言模型                 |  Yes                         |
| 西班牙文 (烏拉圭)                  | `es-UY` | 語言模型                                   |                           |
| 美國西班牙文 (USA)                       | `es-US` | 語言模型                                   |                           |
| 西班牙文 (委內瑞拉)                | `es-VE` | 語言模型                                   |                           |
| 瑞典文 (瑞典)                   | `sv-SE` | 語言模型                                   |   Yes                        |
| 坦米爾文 (印度)                      | `ta-IN` | 語言模型                                   |                           |
| 特拉古文 (印度)                     | `te-IN` | 語言模型                                   |                           |
| 泰文 (泰國)                    | `th-TH` | 語言模型                                   |      Yes                     |
| 土耳其文 (土耳其)                   | `tr-TR` | 語言模型                                   |                           |
