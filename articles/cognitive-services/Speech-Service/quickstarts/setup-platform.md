...
description: 在本快速入門中，您將了解如何安裝適用於您慣用平台和程式設計語言組合的語音 SDK。
...
ms.locfileid: "88926629"
---
# <a name="quickstart-setup-development-environment"></a>快速入門：設定開發環境
...
#### <a name="browser-based"></a>[以瀏覽器為基礎](#tab/browser)
