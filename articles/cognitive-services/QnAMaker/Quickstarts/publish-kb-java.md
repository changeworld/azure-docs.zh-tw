...
> [!NOTE]
> 您可以從[ **Azure 範例/認知服務-qnamaker-java** GitHub 存放庫](https://github.com/Azure-Samples/cognitive-services-qnamaker-java/tree/master/documentation-samples/quickstarts/publish-knowledge-base)取得完整的解決方案檔 (s) 。
