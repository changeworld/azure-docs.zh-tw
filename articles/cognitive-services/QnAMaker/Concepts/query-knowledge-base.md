...
經過定型和 [發佈](../quickstarts/create-publish-knowledge-base.md#publish-the-knowledge-base) 的 QnA Maker 知識庫會從 bot 或其他用戶端應用程式的 [GenerateAnswer API](../how-to/metadata-generateanswer-usage.md)接收使用者查詢。 下圖說明收到使用者查詢的進程。
...
|步驟|目的|
|--|--|
|1|用戶端應用程式會將使用者查詢傳送至 [GENERATEANSWER API](../how-to/metadata-generateanswer-usage.md)。|
