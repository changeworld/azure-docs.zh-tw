...
1. 建立新的認知搜尋資源， (資料) 設定為 _私_用端點連線能力。 在與步驟1中建立的 QnA Maker 資源相同的區域中建立資源。 深入瞭解如何 [建立認知搜尋資源](../../../search/search-create-service-portal.md)，然後使用此連結直接移至資源的 [ [建立] 頁面](https://ms.portal.azure.com/#create/Microsoft.Search)。
