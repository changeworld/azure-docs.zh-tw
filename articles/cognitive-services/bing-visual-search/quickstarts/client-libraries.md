---
title: 快速入門：使用 Bing 圖像式搜尋用戶端程式庫
titleSuffix: Azure Cognitive Services
description: Bing 圖像式搜尋 API 提供用戶端程式庫，可讓您輕鬆地將搜尋功能整合到您的應用程式中。 使用本快速入門，開始傳送搜尋要求並取得結果。
...
ms.locfileid: "80573300"
---
# <a name="quickstart-use-the-bing-visual-search-client-library"></a>快速入門：使用 Bing 圖像式搜尋用戶端程式庫
