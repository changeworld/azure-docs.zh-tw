...
下列函式可顯示不同動作的見解。 這些函式會提供可點選的影像或可點選的連結，帶您前往內含更多影像相關資訊的網頁。 此頁面裝載於 Bing.com 或影像的原始網站。 並非所有見解資料都會顯示在此應用程式中。 若要查看所有可用於見解的欄位，請參閱[影像 - 圖像式搜尋](/rest/api/cognitiveservices/bingvisualsearch/images/visualsearch)參考。
