...
>[!NOTE]
>從2020年8月1日起，RHEL (7.4、7.6、7.7 & 8.1) 的 SAP Hana 備份已正式推出。
...
同樣地，您也可以建立 Azure 儲存體和 Azure AD 的 NSG 輸出安全性規則。 如需服務標記的詳細資訊，請參閱[這篇文章](../virtual-network/service-tags-overview.md)。
