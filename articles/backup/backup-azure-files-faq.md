...
本文提供有關備份 Azure 檔案服務的常見問題解答。 在某些答案中，有具有完整資訊的文章連結。 您也可以在 [Microsoft 問與答頁面](https://docs.microsoft.com/answers/topics/azure-backup.html)中張貼有關 Azure 備份服務的問題，以供討論。
