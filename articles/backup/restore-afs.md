...
1. 選取 [**還原共用**] 之後，[**還原**] 窗格隨即開啟，其中會顯示 [**還原點**] 功能表，其中會顯示所選檔案共用可用的還原點清單。

1. 選取您想要用來執行還原作業的還原點，然後選取 **[確定]** 。

    ![選取還原點](./media/restore-afs/restore-point.png)

1. 選取 **[確定]** 之後，[**還原**] 窗格功能表會切換到 [**還原位置**]。 在 [**還原位置**] 中，指定還原資料的位置或方式。 選取下列兩個選項的其中一個：
...
1. 選取 [**原始位置**] 作為復原**目的地**，然後選取是否要在發生衝突時略過或覆寫。 做出適當的選擇之後，請選取 **[確定]** 。

    ![選取原始位置](./media/restore-afs/original-location.png)
...
1. 在您選取 [檔案**復原**] 之後，[還原] 窗格會開啟 [**還原點**]**功能表，其中**會顯示所選檔案共用可用的還原點清單。
...
1. 選取 [**原始位置**] 作為復原**目的地**，然後選取是否要在發生衝突時略過或覆寫。
...
1. 選擇 [**選取**檔案] 之後，[檔案共用] 窗格會顯示您選取要還原之檔案共用復原點的內容。
...
1. 選取您想要還原的所有專案之後，請選取 **[確定]** 。

    ![選取要還原的所有專案之後，請選取 [確定]](./media/restore-afs/after-selecting-items.png)
...
1. 當您選擇 [**選取**檔案] 時，[檔案共用] 窗格會顯示您選取要還原之檔案共用復原點的內容。
1. 選取對應至您要還原之檔案或資料夾的核取方塊，然後選擇 [**選取**]。
