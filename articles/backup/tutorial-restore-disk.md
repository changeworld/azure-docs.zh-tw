...
此查詢的輸出會提供所有詳細資料，但我們只對儲存體帳戶內容感興趣。 我們可以使用 Azure CLI 的[查詢功能](/cli/azure/query-azure-cli)來提取相關的詳細資料
...
若要確認已從復原的磁碟建立 VM，請使用 [az vm list](/cli/azure/vm#az-vm-list) 列出資源群組中的 VM，如下所示：
