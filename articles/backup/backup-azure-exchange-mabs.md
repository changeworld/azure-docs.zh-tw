...
2. 在 MABS 系統管理員主控台中選取 [ **管理 > 代理程式] > 安裝** ，以在 Exchange 伺服器上安裝代理程式。 如需詳細步驟，請參閱[安裝 MABS 保護代理程式](/system-center/dpm/deploy-dpm-protection-agent?view=sc-dpm-2019) 。
