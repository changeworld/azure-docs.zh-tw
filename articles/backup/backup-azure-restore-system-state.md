...
2. 遵循[此處](https://docs.microsoft.com/windows-server/identity/ad-ds/manage/ad-forest-recovery-nonauthoritative-restore)的步驟，以使用 Windows Server Backup Cmdlet 來復原 AD DS。
