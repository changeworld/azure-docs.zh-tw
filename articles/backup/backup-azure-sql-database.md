...
針對所有其他版本，請依照下列步驟修正權限：
  ...
  3. 以滑鼠右鍵按一下 **[** 登入] 資料夾，然後選取 [ **新增登**入]。 在 [登入 - 新增]**** 中，選取 [搜尋]****。
