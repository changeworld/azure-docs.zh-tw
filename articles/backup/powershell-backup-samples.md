...
| [針對儲存體帳戶中的檔案共用停用虛刪除](./scripts/disable-soft-delete-for-file-shares.md) | 針對儲存體帳戶中的檔案共用停用虛刪除|
| [取消刪除意外刪除的檔案共用](./scripts/backup-powershell-script-undelete-file-share.md) | 取消刪除意外刪除的檔案共用 |
