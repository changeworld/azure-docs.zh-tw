...
| Backup | 存取檔案/共用資料夾時發生錯誤 | 請嘗試修改[DPM 服務器上執行防毒軟體](https://docs.microsoft.com/previous-versions/system-center/system-center-2012-R2/hh757911(v=sc.12))一文中建議的防毒程式設定。|
