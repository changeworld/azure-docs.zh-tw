...
description: Azure Kinect 感應器軟體發展工具組（SDK）、其功能及工具的總覽。
author: tesych
ms.author: tesych
ms.prod: kinect-dk
ms.date: 06/26/2019
ms.topic: article
keywords: azure，kinect，rgb，IR，錄音，感應器，sdk，存取，深度，影片，攝影機，imu，動作，感應器，音訊，麥克風，matroska，感應器 sdk，下載
...
本文提供 Azure Kinect 感應器軟體發展工具組（SDK）、其功能及工具的總覽。

## <a name="features"></a>特性

Azure Kinect 感應器 SDK 提供適用于 Azure Kinect 裝置設定和硬體感應器串流的跨平臺低層級存取，包括：
...
- [Azure Kinect 檢視器](azure-kinect-viewer.md)，用來監視裝置資料流程和設定不同的模式。
- 使用[Matroska 容器格式](record-file-format.md)的[Azure Kinect 錄製](azure-kinect-recorder.md)程式和播放讀取器 API。
