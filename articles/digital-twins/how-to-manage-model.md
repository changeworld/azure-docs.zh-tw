...
ms.locfileid: "88509989"
---
# <a name="manage-azure-digital-twins-models"></a>管理 Azure 數位 Twins 模型

您可以使用[**DigitalTwinsModels api**](how-to-use-apis-sdks.md)、 [.Net (c # ) SDK](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/digitaltwins/Azure.DigitalTwins.Core)或[azure 數位 Twins CLI](how-to-use-cli.md)來管理 azure 數位 Twins 實例所知道的[模型](concepts-models.md)。 
