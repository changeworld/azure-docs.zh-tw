...
接下來，**將兩個相依性新增至您的專案**，以使用 Azure Digital Twins。 第一個是[適用於 .NET 的 Azure Digital Twins SDK](/dotnet/api/overview/azure/digitaltwins/client?view=azure-dotnet&preserve-view=true) 的套件，第二個則會提供協助驗證 Azure 的工具。
