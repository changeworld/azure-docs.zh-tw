...
* 數位版權管理 (DRM)
* [Azure 媒體服務 (AMS) v3](https://docs.microsoft.com/azure/media-services/latest/media-services-overview)
...
* [Microsoft 身分識別平台](https://docs.microsoft.com/azure/active-directory/develop/)上的 Azure AD v2 端點
* 新式雲端驗證，例如 [OAuth 2.0 和 OpenID Connect](https://docs.microsoft.com/azure/active-directory/develop/active-directory-v2-protocols)
  * [OAuth 2.0 中的授權碼流程](https://docs.microsoft.com/azure/active-directory/develop/v2-oauth2-auth-code-flow)以及為何需要 PKCE
  * [委派權限與應用程式權限](https://docs.microsoft.com/azure/active-directory/develop/developer-glossary#permissions)
* [JWT 權杖](https://docs.microsoft.com/azure/active-directory/develop/access-tokens)、其宣告和簽署金鑰變換 (包含在範例中)。
...
* Azure 媒體服務 (AMS) 帳戶。
* @azure/msal-browser v2.0，[Microsoft 驗證程式庫 (MSAL)](https://docs.microsoft.com/azure/active-directory/develop/msal-overview) SDK 系列中適用於不同用戶端平台的其中一個成員
...
如需子系統的詳細資訊，請參閱[設計具有存取控制的多重 DRM 內容保護系統](https://docs.microsoft.com/azure/media-services/latest/design-multi-drm-system-with-access-control)。
...
*groups* 宣告是 Azure AD 中[受限制的宣告集](https://docs.microsoft.com/azure/active-directory/develop/active-directory-claims-mapping#claim-sets)的成員。
