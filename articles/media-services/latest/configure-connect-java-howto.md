...
1. 新增所需的相依性。
   ...
   請參閱[影片編碼](https://github.com/Azure-Samples/media-services-v3-java/blob/master/VideoEncoding/EncodingWithMESCustomPreset/pom.xml)範例中的 `pom.xml`。
