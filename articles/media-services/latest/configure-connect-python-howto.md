...
* `azure-mgmt-media`包含媒體服務實體的模組。
    ...
    請務必取得 [適用于 Python 的最新版本媒體服務 SDK](https://pypi.org/project/azure-mgmt-media/)。
...
- 檢閱媒體服務 [Python 參考](/python/api/overview/azure/mediaservices/management)文件。
