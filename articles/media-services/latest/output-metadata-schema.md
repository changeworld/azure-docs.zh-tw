...
本文討論) 所依據之輸出中繼資料 (source_file_name_manifest.js的 JSON 架構元素和 &lt; 類型 &gt; 。 <!--For information about the file that contains metadata about the input asset, see [Input metadata](input-metadata-schema.md).  -->
