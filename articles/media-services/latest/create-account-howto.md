...
1. 在 [**建立媒體服務帳戶**] 區段中，輸入必要的值。
    ...
    |**資源群組**|選取新的或現有的資源。 資源群組是共用生命週期、權限及原則的資源集合。 [在這裡](../../azure-resource-manager/management/overview.md#resource-groups)深入瞭解。|
...
* [將次要儲存體附加至媒體服務帳戶](https://docs.microsoft.com/cli/azure/ams/account/storage?view=azure-cli-latest#az-ams-account-storage-add)
