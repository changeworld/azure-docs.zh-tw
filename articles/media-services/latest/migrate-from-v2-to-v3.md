...
>將此 URL 複製並貼`https://docs.microsoft.com/api/search/rss?search=%22Migrate+from+Azure+Media+Services+v2+to+v3%22&locale=en-us`到您的 RSS 摘要讀取器，以取得有關何時要重新流覽此頁面以取得更新的通知。

本文提供從媒體服務 v2 到 v3 的遷移指引。
...
* 檢查[媒體服務 v2 與 v3](media-services-v2-vs-v3.md)
...
* [內容保護](content-key-policy-concept.md)支援多金鑰功能。
...
*  目前，您可以使用[Azure 入口網站](https://portal.azure.com/)來執行下列動作：
    ...
    * [取得存取 api 的相關資訊](access-api-portal.md)。 
    ...
    針對所有其他管理工作（例如，[轉換和作業](transforms-jobs-concept.md)和[內容保護](content-protection-overview.md)），請使用[REST API](https://docs.microsoft.com/rest/api/media/)、 [CLI](https://aka.ms/ams-v3-cli-ref)或其中一個支援的[sdk](media-services-apis-overview.md#sdks)。
