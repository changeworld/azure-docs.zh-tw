...
Azure 媒體服務可讓您藉由管理媒體保留單元 (MRU)，在帳戶中調整媒體處理方式。 MRUS 確定處理媒體處理任務的速度。 您可以選擇下列的保留單元類型：**S1**、**S2** 或 **S3**。 例如，在執行相同編碼作業的前提下，使用 **S2** 保留單元類型的速度會比 **S1** 類型快。 
...
本文的其餘部分演示如何使用[媒體服務 v3 CLI](https://aka.ms/ams-v3-cli-ref)來擴展 MRUS。
...
將根據媒體保留單位在您的帳戶中預配的分鐘數向您收費。 這與您的帳戶中是否有任何作業運行無關。 如需詳細說明，請參閱[媒體服務定價](https://azure.microsoft.com/pricing/details/media-services/)頁面的＜常見問題集＞一節。   
