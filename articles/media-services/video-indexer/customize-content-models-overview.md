...
description: 本文提供概念文章的連結，說明每種自訂類型的優點。 本文也會連結至說明如何執行每個模型自訂的操作指南。
...
影片索引器可讓您自訂其部分模型，以套用到您的特定使用案例。 這些模型包含 [品牌](customize-brands-model-overview.md)、 [語言](customize-language-model-overview.md)和 [人員](customize-person-model-overview.md)。 您可以使用影片索引器網站或 API，輕鬆地自訂這些模型。

本文提供文章的連結，說明每種自訂類型的優點。 本文也會連結至說明如何執行每個模型自訂的操作指南。
