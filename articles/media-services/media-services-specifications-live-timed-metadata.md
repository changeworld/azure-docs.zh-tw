...
| 欄位名稱 | 欄位類型 | 必要？ | 說明                                                                                                                                                                                                                                                                        |
| ---------- | ---------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 類型       | 字串     | 必要  | 事件訊息。  應該是 "SpliceOut" 以指定簡單模式拼接。                                                                                                                                                                                                         |
...
| 類型       | 字串     | 必要  | 可識別訊息配置的 URN 或 URL。 對於 [SCTE-35] 訊息，這**應該**是 **"scte35"** ，以便將訊息傳送至 HLS、平滑和虛線用戶端，以符合 [Adobe-Primetime]。 （選擇性） URN "urn： scte： scte35：2013： bin" 也可以用來表示 [SCTE-35] 訊息。                                                                                                        |
