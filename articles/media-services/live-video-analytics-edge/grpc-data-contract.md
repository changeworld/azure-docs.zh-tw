---
title: gRPC 擴充資料合約 - Azure
description: 在本文中，您將了解如何使用 gRPC 通訊協定在即時影片分析模組與 AI 或 CV 自訂擴充之間傳送訊息。
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88687120"
---
# <a name="grpc-extension-data-contract"></a>gRPC 擴充資料合約

在本文中，您將了解如何使用 gRPC 通訊協定在即時影片分析模組與 AI 或 CV 自訂擴充之間傳送訊息。
...
在單一工作階段中：用戶端會透過 gRPC 串流工作階段，將媒體串流描述項 (後面接著影片畫面) 傳送到伺服器作為 [protobuf](https://developers.google.com/protocol-buffers) 訊息。 伺服器會驗證串流描述項、分析影片畫面，並以 protobuf 訊息的形式傳回推斷結果。

![gRPC 擴充合約](./media/data-contracts/grpc.png)
...
![通訊協定訊息](./media/data-contracts/grpc2.png)
