---
title: HTTP 擴充資料合約 - Azure
description: 在本文中，您將了解如何使用 HTTP 通訊協定在即時影片分析模組與 AI 或 CV 模組之間傳送訊息。
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88701897"
---
# <a name="http-extension-data-contract"></a>HTTP 擴充資料合約

在本文中，您將了解如何使用 HTTP 通訊協定在即時影片分析模組與 AI 或 CV 模組之間傳送訊息。
...
![類別階層](./media/http-data-contract/class-hierarchy.png)
