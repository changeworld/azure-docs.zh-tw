...
若要執行本文中描述的動作，您應該使用 [Azure Resource Manager API](/rest/api/media/operations/azure-media-services-rest-api-reference) 和 [Powershell](https://docs.microsoft.com/powershell/module/az.media)。  有關詳細資訊，請參閱如何使用[PowerShell 和資源管理器管理 Azure 資源](../../azure-resource-manager/management/manage-resource-groups-powershell.md)。
...
## <a name="steps-to-rotate-storage-keys"></a>更換儲存體金鑰的步驟 
 ...
 2. 使用適當的參數調用同步-AzMediaService 存儲金鑰 Cmdlet，以強制媒體帳戶獲取存儲帳戶金鑰
 ...
 5. 使用適當的參數調用同步-AzMediaService 存儲金鑰電源外殼，以強制媒體帳戶獲取新的存儲帳戶金鑰。 
