...
權杖限制原則必須伴隨 Security Token Service (STS) 所發出的權杖。 媒體服務支援簡單 web 權杖中的權杖 ([SWT](/previous-versions/azure/azure-services/gg185950(v=azure.100)#BKMK_2)) 和 JSON web 權杖 (JWT) 格式。 如需詳細資訊，請參閱 [JWT 驗證](http://www.gtrifonov.com/2015/01/03/jwt-token-authentication-in-azure-media-services-and-dynamic-encryption/)。
