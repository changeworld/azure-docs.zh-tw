...
* 某些內容提供者可能會禁止將 DRM 許可證交付到國家/地區邊界以外。 如果使用者想要在需要出國旅行時仍能觀賞內容，就需要離線下載。
...
* 播放就緒LA_URL（在前位）：[https://willzhan12.cloudapp.net/playready/rightsmanager.asmx](https://willzhan12.cloudapp.net/playready/rightsmanager.asmx)
