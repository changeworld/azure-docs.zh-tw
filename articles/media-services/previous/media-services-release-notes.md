...
* [使用 Azure 佇列儲存體監視媒體服務工作通知](media-services-dotnet-check-job-progress-with-queues.md)
...
[Media Services SDK for .NET 中的重試邏輯]: ./media-services-retry-logic-in-dotnet-sdk.md
