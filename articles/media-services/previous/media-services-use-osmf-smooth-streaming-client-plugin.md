...
本文檔假定讀者具有 OSMF 和 OSMF 外掛程式的一般工作知識。有關 OSMF 的更多資訊,請參閱[官方 OSMF 網站上的](http://osmf.org/)文檔。
...
2. 將 src 設定為平滑流源(例如\/http: /devplatem.vo.msecnd.net/Sintel/Sintel_H264.ism/manifest) 
