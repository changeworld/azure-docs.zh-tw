...
1. 請確定每個小組成員都有[適當的許可權可以存取 Azure Dev Spaces 控制器](../troubleshooting.md#incorrect-rbac-permissions-for-calling-dev-spaces-controller-and-apis)。 例如，您可以設定 Azure 開發人員空間的**資源群組**，為每個小組成員[授與參與者存取權](../../role-based-access-control/role-assignments-portal.md)。 您可以執行此命令來檢查開發人員空間的資源群組：`azds show-context`
