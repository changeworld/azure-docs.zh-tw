...
## <a name="can-i-use-azure-dev-spaces-on-rbac-enabled-aks-clusters"></a>我可以在啟用 RBAC 的 AKS 叢集上使用 Azure Dev Spaces 嗎？

是的，您可以在 AKS 叢集上使用 Azure Dev Spaces，不論是否已啟用 RBAC。
