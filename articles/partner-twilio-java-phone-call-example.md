...
2. 取得 Twilio JAR。 在 [https://github.com/twilio/twilio-java][twilio_java_github] 中，您可以下載 GitHub 來源並建立您自己的 jar，或下載預先建立的 jar (，而不需要相依性) 。
