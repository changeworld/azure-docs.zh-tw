...
1. 從 Azure Explorer，流覽至**HDInsight** > \<您的叢集> > **作業**。
...
3. 從主視窗中，選取 [ **`Remotely Run in Cluster`** ] 索引標籤。
...
1. 若為透過 IntelliJ 概念建立的現有 Spark Scala 應用程式，請開啟相關`.iml`聯的檔案。
