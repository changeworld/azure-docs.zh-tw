...
6. 針對 [金鑰]**** 和 [值]**** 欄位使用下列值：
    ...
    **金鑰**： `fs.azure.sas.YOURCONTAINER.YOURACCOUNT.blob.core.windows.net` **值**：從上述步驟4中的 Python 應用程式傳回的 SAS 金鑰。
...
- [區域冗余儲存體（ZRS）](../../storage/common/storage-redundancy-zrs.md)
- [異地備援儲存體 (GRS)](../../storage/common/storage-redundancy-grs.md)
- [讀取權限異地多餘儲存體（RA-GRS）](../../storage/common/storage-redundancy.md)
