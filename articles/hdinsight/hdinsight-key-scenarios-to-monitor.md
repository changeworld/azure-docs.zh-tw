...
如果您使用 Azure 儲存體，如需監視儲存體相關問題的詳細資訊（包括節流），請參閱 [監視、診斷和疑難排解 Microsoft Azure 儲存體](https://docs.microsoft.com/azure/storage/storage-monitoring-diagnosing-troubleshooting)。
