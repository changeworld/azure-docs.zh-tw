...
開啟 [Apache Ambari Web UI](hdinsight-hadoop-manage-ambari.md) 以確認已新增新的 Azure AD 使用者。 藉由流覽至來**`https://CLUSTERNAME.azurehdinsight.net`** 存取 AMBARI Web UI。 輸入叢集系統管理員使用者名稱和密碼。
