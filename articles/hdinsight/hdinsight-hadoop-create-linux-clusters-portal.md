...
> [!WARNING] 
> 自2020年6月15日起，客戶將無法使用 HDInsight 建立新的服務主體。 請參閱使用 Azure Active Directory [建立服務主體和憑證](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal) 。
