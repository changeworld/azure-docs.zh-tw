...
* 與 HDInsight 叢集相關聯的 __Azure Data Lake Storage 帳戶__。 如需搭配 HDInsight 使用 Azure Data Lake Storage 的詳細資訊，請參閱 [快速入門：在 hdinsight 中設定](../storage/data-lake-storage/quickstart-create-connect-hdi-cluster.md)叢集。
