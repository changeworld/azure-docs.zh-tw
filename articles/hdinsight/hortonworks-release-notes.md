...
## <a name="current-versions"></a>目前的版本

* HDInsight 叢集版本4.0 使用以 [Hortonworks Data Platform 3.0](https://docs.hortonworks.com/HDPDocuments/HDP3/HDP-3.0.0/release-notes/content/relnotes.html)為基礎的 Hadoop 散發套件。
