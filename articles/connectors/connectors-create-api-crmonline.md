...
> [!IMPORTANT]
> [Dynamics 365 連接器](https://docs.microsoft.com/connectors/dynamicscrmonline/)已淘汰，但會繼續運作，直到移除為止。 請勿將 Dynamics 365 連接器用於新的邏輯應用程式。 尚未宣佈移除 Dynamics 365 連接器的時程表。 您不需要將現有的邏輯應用程式轉換為 Common Data Service 連接器或其他計畫的新連接器，但您必須在移除連接器時轉換邏輯應用程式。 如需詳細資訊，請參閱[Dynamics 365 Connector 已淘汰](https://docs.microsoft.com/power-platform/important-changes-coming)。
>
> [Common Data Service 連接器](https://docs.microsoft.com/connectors/commondataservice/)提供與已淘汰的 Dynamics 365 連接器相同的功能，但包含提升可靠性的改善。 如需在邏輯應用程式中使用 Common Data Service 連接器的詳細資訊，請參閱[使用 Azure Logic Apps 來建立和管理 Common Data Service 記錄](../connectors/connect-common-data-service.md)。
