...
存放庫中包含此範本的資料夾有一個子資料夾， `nestedtemplates` 其中的檔案**NestOne.js開啟**，而**NestOne.parameters.js**。 在的**azuredeploy.js**中，會使用成品位置、嵌套範本資料夾、嵌套範本檔案名來建立範本的 URI。 同樣地，使用嵌套範本的成品位置、嵌套範本資料夾和參數檔案，即可建立參數的 URI。 
