...
[Azure 中的 Windows 虛擬機器概觀](../virtual-machines/windows/overview.md)提供您在建立 VM 之前應該考慮的事項、建立方式及管理方式的相關資訊。
...
在研發/測試實驗室中，環境是指實驗室中 Azure 資源的集合。 [此部落格文章](./devtest-lab-faq.md#blog-post)討論如何從 Azure Resource Manager 範本建立多個 VM 環境。
...
[了解 Azure Resource Manager 範本的結構和語法](../azure-resource-manager/templates/template-syntax.md#template-format)描述 Azure Resource Manager 範本的結構，以及範本的各區段中可用的屬性。
