---
title: PowerShell 腳本：接受來自 Azure Data Share 的邀請 |Microsoft Docs
...
| [新 AzDataShareSubscription](/powershell/module/az.datashare/get-azdatasharesubscription?view=azps-2.6.0) | 建立資料共用訂用帳戶。 |
|||
