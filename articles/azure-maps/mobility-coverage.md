...
Azure 地圖服務[行動服務](https://aka.ms/AzureMapsMobilityService)可改善具有公開傳輸功能之應用程式的開發時間，例如傳輸路由和搜尋附近的公用傳輸。 使用者可以取得有關傳輸停止、行和排程的詳細資訊。 行動服務也可讓使用者抓取停止和線條的幾何、停止、行和服務區域的警示，以及即時的公開傳輸抵達和服務警示。 此外，行動服務會提供具有限時行程規劃選項的路由功能。 多模行程規劃包括流覽、腳踏車和公用傳輸選項，全都放在一趟旅程。 使用者也可以存取詳細的多重步驟路線。 

Azure 地圖服務不會針對所有城市和國家/地區提供相同層級的資訊和精確度。 呼叫公開傳輸資料的能力取決於 metro 區域。 此外，地圖資料可能不會包含所有公開運輸選項和提供 metro 區域的機構。
...
| 墨西哥 | Aguascalientes、墨西哥城、Guadalajara、Lion、Merida、蒙特雷、Puebla、Querétaro、San Luis Potosi、Torreon|
| 尼加拉瓜 | 馬納瓜 |
| 巴拿馬 | 巴拿馬|
| 秘魯 | Cusco，利馬 |
| 波多黎各 | San Juan |
...
| 澳門特別行政區 | 澳門特別行政區 *|
| 馬爾地夫 | Male |
| 印度 | Ahmedabad、Bengaluru、新德里、Hyderabad、孟買、Mysuru、Pune|
...
| 法國    | <p>Amberieu-Bugey、Amiens、Angers、Annecy、Annonay、Arras、Aubenas、Bayonne、Besançon、Blois、Bordeaux、Boulogne sur、Brest、Briançon、cannes、Châlons-en-Champagne、Chartres、Clermont-Ferrand、Colmar、象牙海岸 d'Azur、Dax、Dijon、Grenoble、Haguenau、La Rochelle、Le 黑心遊記，透鏡，Lille，Lorient，Lyon，MAC，馬賽 & Provence，Metz，Millau，Mont-Marsan，Montpellier，Mulhouse，南，Nantes，Nice，Nimes，Normandy，Nyons，巴黎，Poitiers，Privas，Quimper，Rennes，聖 Malo，聖-Étienne，聖 Nazaire，Saintes，Sarrebourg，Sete，Strasbourg，Tarbes，Toulouse，演講</P> |
| + 法文蓋亞納 | 開雲 |
| + 新赫里多尼亞群島 | Nouméa  |
| 喬治亞 | 第比利斯 |
...
| 匈牙利 | 布達佩斯、Gyor、Miskolc、Nograd 縣、Pesc、Szeged、Székesfehérvár |
| 冰島 | Ísland-冰島 * |
| 愛爾蘭 | 設立 |
...
| 俄羅斯  | 卡里加卡裡，Rostov，伏爾加格勒，Kazan，Kirov，Krasnodar，莫斯科，Nalchik，Nizhny Novgorod，新西伯利亞，Noyabrsk，鄂木斯克，Oryol，永久，St 聖彼德堡，Tver，托木斯克 |
