---
title: Azure 雲端服務 (延伸支援) Def NetworkTrafficRules 架構 |Microsoft Docs
description: '與雲端服務相關聯之網路流量規則的相關資訊 (延伸支援) '
ms.topic: article
...
ms.locfileid: "98744347"
---
# <a name="azure-cloud-services-extended-support-definition-networktrafficrules-schema"></a>Azure 雲端服務 (延伸支援) 定義 NetworkTrafficRules 架構
...
##  <a name="destinations-element"></a><a name="Destinations"></a> 目的地元素
