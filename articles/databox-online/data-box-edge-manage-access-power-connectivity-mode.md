...
若要建立您的 Data Box Edge/Data Box Gateway、IoT 中樞和 Azure 儲存體資源，您需要在資源群組層級以參與者或更高的許可權來進行。 您也需要註冊對應的資源提供者。 對於涉及啟用金鑰和認證的任何作業，也需要 Microsoft Graph API 的許可權。 下列各節將說明這些情況。
