...
ms.locfileid: "98626292"
---
# <a name="azure-policy-built-in-definitions-for-azure-stack-edge"></a>Azure 原則 Azure Stack Edge 的內建定義

此頁面是 Azure Stack Edge [Azure 原則](../governance/policy/overview.md) 內建原則定義的索引。 如需其他服務的其他內建 Azure 原則，請參閱 [Azure 原則內建定義](../governance/policy/samples/built-in-policies.md)。
