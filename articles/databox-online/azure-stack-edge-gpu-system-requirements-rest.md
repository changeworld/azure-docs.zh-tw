...
|    區塊 Blob 大小上限                              |    4.75 TB (100 MB X 50,000 個區塊)                   |    4.75 TB (100 MB x 50000 區塊) 適用于 Azure Stack Edge v 2.1.1377.2170|
...
針對 Azure Stack Edge Blob 儲存體，有特定的用戶端程式庫和特定的端點尾碼需求。 Azure Stack Edge Blob 儲存體端點與最新版的 Azure Blob 儲存體 REST API 沒有完全相同的相同;請參閱 [Azure Stack Edge 2.1.1377.2170 所支援的 API 版本](#supported-api-versions)。 對於儲存體用戶端程式庫，您需要知道與 REST API 相容的版本。
