...
5. 您的本機 web UI 的 [ **裝置** ] 頁面中有 Kubernetes API 端點。 如需詳細資訊，請參閱[Get KUBERNETES API 端點](azure-stack-edge-gpu-deploy-configure-compute.md#get-kubernetes-endpoints)中的指示。
