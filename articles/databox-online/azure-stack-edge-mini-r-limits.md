---
title: Azure Stack Edge 迷你 R 限制 |Microsoft Docs
description: 描述 Azure Stack Edge 迷你 R 的系統限制和建議大小。
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "96466390"
---
# <a name="azure-stack-edge-mini-r-limits"></a>Azure Stack Edge 迷你 R 限制


當您部署及操作您的 Azure Stack Edge 迷你 R 解決方案時，請考慮這些限制。
...
## <a name="azure-stack-edge-mini-r-device-limits"></a>Azure Stack Edge 迷你 R 裝置限制

下表說明 Azure Stack Edge 迷你 R 裝置的限制。

| 描述 | 限制|
|---|---:|
|否。 (每個裝置的檔案) | 1 億 <!--check with devs-->|
|否。 共用數 | 1|
...
- [準備部署 Azure Stack Edge](azure-stack-edge-gpu-deploy-prep.md)
