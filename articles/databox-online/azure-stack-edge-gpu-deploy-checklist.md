...
| 階段                             | 參數                                                                                                                                                                                                                           | 詳細資料                                                                                                           |
|-----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| 裝置管理               | <li>Microsoft Azure 訂用帳戶</li><li>Azure Active Directory 圖形 API</li><li>Microsoft Azure 儲存體帳戶</li>|<li>啟用 Azure Stack Edge Pro/Data Box Gateway，參與者許可權</li><li>確定系統管理員或使用者存取權</li><li>需要存取認證</li> |
...
| 計算網路設定     | <li>Kubernetes 節點需要2個靜態公用 ip，而且至少要有1個靜態 IP，Azure Stack Edge Pro Hub 服務才能存取計算模組。</li><li>針對需要從 Kubernetes 叢集外部存取的每個額外服務或容器，各需要一個 IP。</li>                                                                                                                       | 僅支援靜態 IPv4 設定。                                                                      |
