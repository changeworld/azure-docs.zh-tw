...
此 **Azure Stack Edge 2008** 版本對應到下列軟體版本：
...
|**10.**|Kubernetes |埠31000已保留供 Kubernetes 儀表板之用。 同樣地，在預設設定中，IP 位址10.96.0.1 和10.96.0.10 會分別保留給 Kubernetes 服務和核心 DNS 服務。|請勿使用保留的 Ip。|
