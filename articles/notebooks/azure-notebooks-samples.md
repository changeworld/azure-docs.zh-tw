---
title: 適用於 Azure Notebooks 預覽的範例 Jupyter Notebook
...
- [Azure Notebooks 入門集](https://notebooks.azure.com/#sample-redirect)包含 Python、R 和 F# 的簡介，以及示範資料存取、Azure Machine Learning 和幾項資料科學練習的 Notebook。
