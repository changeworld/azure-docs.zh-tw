...
若要建立新的 DSVM 執行個體，請依照[建立 Ubuntu 資料科學 VM](/azure/machine-learning/data-science-virtual-machine/dsvm-ubuntu-intro) 中的指示執行。 如需詳細資訊（包括定價詳細資料），請參閱 [資料科學虛擬機器](https://azure.microsoft.com/services/virtual-machines/data-science-virtual-machines/)。
...
深入瞭解 [Azure 資料科學虛擬機器的簡介](/azure/machine-learning/data-science-virtual-machine/overview)dsvm。
