---
title: 使用視覺化工作室 （ASP.NET） 開始使用 Azure 佇列存儲
...
1. 在 **CreateQueue** 方法內，取得 **CloudStorageAccount** 物件，其代表您的儲存體帳戶資訊。 使用以下代碼從 Azure 服務配置獲取存儲連接字串和存儲帳戶資訊：（將*&lt;存儲帳戶名稱>* 更改為要訪問的 Azure 存儲帳戶的名稱。
...
1. 運行應用程式，然後選擇 **"創建佇列"** 以查看類似于以下螢幕截圖的結果：
...
1. 在 **AddMessage** 方法內，取得 **CloudStorageAccount** 物件，其代表您的儲存體帳戶資訊。 使用以下代碼從 Azure 服務配置獲取存儲連接字串和存儲帳戶資訊：（將*&lt;存儲帳戶名稱>* 更改為要訪問的 Azure 存儲帳戶的名稱。
...
1. 運行應用程式，並選擇 **"添加消息**"以查看類似于以下螢幕截圖的結果：
...
1. 在 **PeekMessage** 方法內，取得 **CloudStorageAccount** 物件，其代表您的儲存體帳戶資訊。 使用以下代碼從 Azure 服務配置獲取存儲連接字串和存儲帳戶資訊：（將*&lt;存儲帳戶名稱>* 更改為要訪問的 Azure 存儲帳戶的名稱。
...
1. 運行應用程式，並選擇**Peek 消息**以查看類似于以下螢幕截圖的結果：
...
1. 在 **ReadMessage** 方法內，取得 **CloudStorageAccount** 物件，其代表您的儲存體帳戶資訊。 使用以下代碼從 Azure 服務配置獲取存儲連接字串和存儲帳戶資訊：（將*&lt;存儲帳戶名稱>* 更改為要訪問的 Azure 存儲帳戶的名稱。
...
1. 運行應用程式，並選擇 **"讀取/刪除"消息**以查看類似于以下螢幕截圖的結果：
...
1. 運行應用程式，然後選擇 **"獲取佇列長度**以查看類似于以下螢幕截圖的結果：
...
1. 在 **DeleteQueue**方法內，取得 **CloudStorageAccount** 物件，其代表您的儲存體帳戶資訊。 使用以下代碼從 Azure 服務配置獲取存儲連接字串和存儲帳戶資訊：（將*&lt;存儲帳戶名稱>* 更改為要訪問的 Azure 存儲帳戶的名稱。
