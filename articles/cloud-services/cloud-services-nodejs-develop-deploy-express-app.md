...
description: 使用此教學課程來建立使用 Express 模組的新應用程式，它會提供建立 Node.js web 應用程式的 MVC 架構。
...
如需詳細資訊，請參閱 [Node.js 開發人員中心](https://docs.microsoft.com/azure/developer/javascript/)。
