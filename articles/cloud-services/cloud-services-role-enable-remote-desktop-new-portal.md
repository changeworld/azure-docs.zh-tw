...
1. 按一下 [雲端服務]  ，然後依序選取雲端服務的名稱及 [遠端桌面]  。
    ...
    ![醒目顯示 [遠端桌面] 選項的螢幕擷取畫面。](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop.png)
...
3. 按一下 [連接]  下載 RDP 檔案的角色執行個體。
    ...
    ![醒目提示 [連線] 按鈕的螢幕擷取畫面。](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop_Connect.png)
