...
您可從[程式碼範例庫](/samples/browse/?term=mxchip)尋找所有 DevKit 教學課程的原始程式碼。
...
1. 在 Azure Cloud Shell 中執行下列命令，以針對您剛註冊的裝置取得 _裝置連接字串_ ：
...
1. 然後選取或建立新的[資源群組](../azure-resource-manager/management/overview.md#terminology)。
