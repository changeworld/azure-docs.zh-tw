...
- [設定 Azure IoT 記錄](iot-hub-monitor-resource-health.md)
...
**指導**方針：啟用 azure 資源上的 azure IoT 診斷設定，以存取 audit、security 和診斷記錄。 活動記錄 (自動提供) 包含事件來源、日期、使用者、時間戳記、來源位址、目的地位址，以及其他有用的項目。

- [設定 Azure IoT 中樞記錄](iot-hub-monitor-resource-health.md)
...
- [監視 Azure IoT 健康情況](iot-hub-monitor-resource-health.md)
- [如何使 Azure Sentinel 上線](../sentinel/quickstart-onboard.md)
