...
若要深入了解「Azure 監視器」所監視的特定計量和事件，請參閱 [Azure 監視器支援的計量](../azure-monitor/platform/metrics-supported.md)和[Azure 診斷記錄支援的服務、結構描述和類別](../azure-monitor/platform/resource-logs-schema.md)。
