...
IoT 中心提供了一種強大的類似 SQL 的語言來檢索有關[設備孿生](iot-hub-devguide-device-twins.md)、[模組孿生](iot-hub-devguide-module-twins.md)、[作業](iot-hub-devguide-jobs.md)和[消息路由](iot-hub-devguide-messages-d2c.md)的資訊。 本文提供︰
