...
| 設計師中 | 雙向。 裝置應用程式可以立即回應方法。 解決方案後端會接收到根據要求上下文的結果。 | 單向。 裝置應用程式會收到屬性變更的通知。 | 單向。 裝置應用程式接收訊息
...
| 大小 | 直接方法承載的大小上限為 128 KB。 | 所需的最大屬性大小為 32 KB。 | 上限為 64 KB 訊息。 |
...
* [使用所需屬性配置設備](tutorial-device-twins.md) 
