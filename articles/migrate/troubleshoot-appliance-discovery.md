...
錯誤60025：「Azure AD 操作失敗。 當用來起始探索的 Azure 使用者帳戶不同于用來註冊應用裝置的帳戶時，建立或更新 Azure AD 應用程式時發生錯誤。 請執行下列其中一項動作：
...
1. 在 [伺服器**Azure Migrate Server 評估**] 中，選取 **[總覽**]。 **Servers**  > 
