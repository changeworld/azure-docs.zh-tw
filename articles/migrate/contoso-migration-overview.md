...
[文章 9：在 Azure Web 應用程式和 Azure SQL Database 中重構應用程式](https://docs.microsoft.com/azure/architecture/cloud-adoption/migrate/azure-best-practices/contoso-migration-refactor-web-app-sql) | Contoso 會使用 Azure 資料庫移轉服務，將其 SmartHotel360 應用程式遷移至 Azure web 應用程式，並將應用程式資料庫移轉至 Azure SQL Database。
