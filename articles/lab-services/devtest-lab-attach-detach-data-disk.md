...
- VM 的大小會控制您可以連結的資料磁碟數目。 有關詳細資訊，請參閱[虛擬機器的大小](https://docs.microsoft.com/azure/virtual-machines/windows/sizes)。
...
幾分鐘後，將創建新的資料磁片並附加到 VM，並顯示在該 VM**的資料磁片**清單中。
...
幾分鐘後，資料磁片將附加到 VM，並顯示在該 VM**的資料磁片**清單中。
