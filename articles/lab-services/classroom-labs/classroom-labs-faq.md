---
title: Azure 實驗室服務中的教室實驗室 - 常見問題集 | Microsoft Docs
description: 本文提供有關 Azure 實驗室服務中教室實驗室的常見問題 (FAQ) 解答。
...
ms.locfileid: "83592605"
---
# <a name="classroom-labs-in-azure-lab-services--frequently-asked-questions-faq"></a>Azure 實驗室服務中的教室實驗室 - 常見問題集 (FAQ)
針對 Azure 實驗室服務中的教室實驗室，取得一些最常見問題的解答。 
...
教室實驗室可以在您於 Azure 入口網站中建立實驗室帳戶時所指定的 IP 位址範圍內建立實驗室 VM。 提供了位址範圍時，之後所建立的每個實驗室會為實驗室 VM 配置 512 個 IP 位址。 實驗室帳戶的位址範圍必須夠大，才能容納您想要在實驗室帳戶下建立的所有實驗室。 
...
這些連接埠如下：49152–65535。 教室實驗室會位於負載平衡器後方。 每個實驗室都有一個公用 IP 位址，而實驗室中的每部虛擬機器都有一個唯一的連接埠。 
