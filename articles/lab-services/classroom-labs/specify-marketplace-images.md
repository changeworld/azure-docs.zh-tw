...
選取左側功能表上的 [Marketplace 映像]****。 根據預設，您會看到映像 (包括已啟用和停用) 的完整清單。 您可以從頂端的下拉式清單中**選取 [**/僅限已**停用**] 選項，以篩選清單以查看已啟用/已停用的映射。 
...
4. 依照上一節中的指示，啟用您所選取的影像。 
5. 您可能需要關閉新的**實驗室**視窗並重新開啟，才能看到您在上一個步驟中選取的影像。 
