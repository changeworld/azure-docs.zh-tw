...
6. 選取頁面底部的 **[下一步：** 標籤]，切換至 [**標記**] 索引標籤。新增您想要與實驗室帳戶建立關聯的任何標籤。 標籤是成對的名稱/值，可讓您將相同的標籤套用至多個資源和資源群組，藉此將資源分類及查看合併計費。 如需詳細資訊，請參閱[使用標記來組織您的 Azure 資源](../../azure-resource-manager/management/tag-resources.md)。
