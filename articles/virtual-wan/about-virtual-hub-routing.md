...
### <a name="association"></a><a name="association"></a>關聯
...
:::image type="content" source="./media/about-virtual-hub-routing/concepts-association.png" alt-text="關聯":::
...
> [!NOTE]
> 某些在虛擬網路連線中的關聯、傳播和靜態路由的新概念，可能仍在推出，預計會在8月3日的第一周完成。
>
