---
title: Azure Data Factory 中的複製活動支援的檔案格式
description: 本主題說明 Azure Data Factory 中複製活動所支援的檔案格式和壓縮代碼。
author: linda33wj
manager: shwang
ms.reviewer: craigg
...
---
# <a name="supported-file-formats-and-compression-codecs-by-copy-activity-in-azure-data-factory"></a>Azure Data Factory 中的複製活動支援的檔案格式和壓縮編解碼器
...
您可以使用 [複製活動](copy-activity-overview.md) ，在兩個以檔案為基礎的資料存放區之間依原樣複製檔案，在這種情況下，資料會在沒有任何序列化或還原序列化的情況下有效率地複製。 

此外，您也可以剖析或產生特定格式的檔案。 例如，您可以執行下列動作：
