...
>[!TIP]
>您也可以使用此連接器從 **Dynamics 365 Finance and Operations** 複製資料。 請參閱 Dynamics 365 的 [OData 支援](/dynamics365/unified-operations/dev-itpro/data-entities/odata) \(英文\) 和[驗證方法](/dynamics365/unified-operations/dev-itpro/data-entities/services-home-page#authentication) \(英文\)。
