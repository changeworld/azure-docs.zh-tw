---
title: 映射資料傳輸到軸
description: Azure 資料工廠映射資料串流取消透視轉換
author: kromerm
ms.author: makromer
...
ms.locfileid: "81417754"
---
# <a name="azure-data-factory-unpivot-transformation"></a>Azure 資料工廠取消透視轉換

[!INCLUDE[appliesto-adf-xxx-md](includes/appliesto-adf-xxx-md.md)]

在 ADF 映射資料流中使用 Unpivot,通過將單個記錄中的多個列的值擴展到單列中具有相同值的多個記錄,將未規範化資料集轉換為更規範化的版本。

![取消樞紐轉換](media/data-flow/unpivot1.png "取消透視選項 1")

## <a name="ungroup-by"></a>取消分組依據

![取消樞紐轉換](media/data-flow/unpivot5.png "取消透視選項 2")

首先，設定您想要對於樞紐彙總分組所依據的資料行。 使用資料行清單旁邊的 [+] 號，設定要取消群組的一或多個資料行。

## <a name="unpivot-key"></a>取消樞紐索引鍵

![取消樞紐轉換](media/data-flow/unpivot6.png "取消透視選項 3")
...
![取消樞紐轉換](media/data-flow//unpivot7.png "取消透視選項 4")
...
![取消樞紐轉換](media/data-flow//unpivot7.png "取消透視選項 5")
