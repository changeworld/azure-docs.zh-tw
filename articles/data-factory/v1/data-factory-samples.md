...
| [在 HDInsight Hadoop 叢集上叫用 Spark 作業](../tutorial-transform-data-spark-portal.md) |此範例示範如何使用 MapReduce 活動來叫用 Spark 程式。 Spark 程式只是將資料從一個 Azure Blob 容器複製到另一個。 |
