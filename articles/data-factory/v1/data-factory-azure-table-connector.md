...
將資料移入及移出 Azure 資料表時，從 Azure 資料表 OData 類型到 .NET 類型的對應會使用下列 [Azure 資料表服務定義的對應](/rest/api/storageservices/Understanding-the-Table-Service-Data-Model)，反向對應亦適用。
