...
#### <a name="resolution"></a>解決方案
卸載電腦上的現有閘道，然後**再次直接按一下此電腦鏈路上的安裝**。
...
#### <a name="cause"></a>原因
TLS/SSL 憑證可能在閘道電腦上丟失。 閘道電腦無法載入當前用於 TLS 加密的證書。 您也可能會看到類似下列訊息的事件記錄檔錯誤訊息。
