...
按一下 [檔案或資料夾]**** 的 [瀏覽]**** 按鈕、瀏覽至其中一個資料夾 (例如 2016->03->01->02)，然後按一下 [選擇]****。 您應該會在文字方塊中看到 `2016/03/01/02`。 現在，將**2016**替換為 **{year}，03**替換為 **{month}，01**替換為 **{day}，02**替換為 **{小時}，** 然後按 Tab。 **03** **01** **02**您應該會看到下拉清單，以選擇以下四個變數的格式：
