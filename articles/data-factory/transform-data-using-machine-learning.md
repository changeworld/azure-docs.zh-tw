...
您可建立 **Azure Machine Learning** 連結服務，以將 Azure Machine Learning Web 服務連結至 Azure Data Factory。 連結服務由 Azure 機器學習批次處理執行活動和[更新資源活動](update-machine-learning-models.md)使用。
