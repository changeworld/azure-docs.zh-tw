...
description: 切換活動可讓您根據條件來控制處理流程。
...
案例 | 包含值的一組案例，以及當值符合運算式評估時要執行的一組活動。 至少必須提供一種案例。 最大限制為25個案例。 | Case 物件陣列 | 是
...
### <a name="pipeline-with-switch-activity-adfv2quickstartpipelinejson"></a>) 上具有切換活動的管線 ( # B0
