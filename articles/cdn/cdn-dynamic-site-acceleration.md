...
**Akamai 中的 Azure CDN** 和 **Verizon 中的 Azure CDN** 都會在端點建立期間透過 [最佳化] 功能表來提供 DSA 最佳化。 Microsoft 提供的動態網站加速是透過 [Azure Front Door 服務](../frontdoor/front-door-overview.md)提供。
