...
ms.locfileid: "92778175"
---
# <a name="monitor-the-health-of-azure-cdn-resources"></a>監視 Azure CDN 資源的健康狀態
  
Azure CDN 資源健康狀態是 [Azure 資源健康狀態](../service-health/resource-health-overview.md)的子集。  您可以使用 Azure 資源健康狀態來監視 CDN 資源的健康狀態，以及接收可行的指引來進行問題的疑難排解。
...
>[!TIP] 
>您也可以尋找 [說明 + 支援]  刀鋒視窗的 [資源健康狀態]  圖格中所列出的 CDN 資源。  您可以在入口網站的右上角，按一下圓框  。
>
...
- [閱讀 Azure 資源健康狀態的概觀](../service-health/resource-health-overview.md)
