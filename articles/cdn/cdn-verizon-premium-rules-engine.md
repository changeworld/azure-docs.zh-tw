---
title: 使用 Azure CDN 覆寫 HTTP 行為 - Verizon Premium 規則引擎
description: 規則引擎可供自訂 Verizon Premium Azure CDN 處理 HTTP 要求的方式，例如封鎖傳遞特定類型的內容、定義快取原則及修改 HTTP 標頭。
services: cdn
author: asudbring
...
- [Azure Fridays:Azure CDN's powerful new premium features](https://azure.microsoft.com/documentation/videos/azure-cdns-powerful-new-premium-features/) (Azure 星期五：Azure CDN 強大的新進階功能) (影片)