...
- 針對某些 Azure CDN 功能 (例如  按鈕使用 Verizon 入口網站。
...
- [規則引擎](./cdn-verizon-premium-rules-engine.md)：允許您自訂 HTTP 要求的處理方式。
- 進階分析工具：
...
若要深入了解規則引擎，請參閱 [Azure CDN 規則引擎參考](./cdn-verizon-premium-rules-engine-reference.md)。