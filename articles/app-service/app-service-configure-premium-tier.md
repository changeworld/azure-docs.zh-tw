...
下列命令會在 P1V2__ 建立 App Service 方案。 您可以在 Cloud Shell 中執行該命令。 的選項為 `--sku` P1V3、 _P2V3_和 _P3V3_。
...
下列命令會在 _P1V3_中建立 App Service 方案。 `-WorkerSize` 選項包括 [小型]__、[中型]__ 和 [大型]__。
