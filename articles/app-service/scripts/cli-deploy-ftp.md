...
| [`az webapp deployment list-publishing-profiles`](/cli/azure/webapp/deployment#az-webapp-deployment-list-publishing-profiles) | 取得可用應用程式部署設定檔的詳細資料。 |
