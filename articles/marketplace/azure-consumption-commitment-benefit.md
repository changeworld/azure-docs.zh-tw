...
- 若要深入瞭解您的組織可以如何運用 Azure Marketplace，請完成我們的 Microsoft Learn 課程模組： [利用 Azure Marketplace 簡化雲端採購和治理](https://aka.ms/cm.marketplaceprocurement)。
