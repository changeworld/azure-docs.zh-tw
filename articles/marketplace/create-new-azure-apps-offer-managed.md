...
- 在 **完整** 模式中，客戶重新部署應用程式將會導致移除受控資源群組中的資源（如果 [mainTemplate.js](../azure-resource-manager/managed-applications/publish-service-catalog-app.md?tabs=azure-powershell#create-the-arm-template)中未定義資源）。
