...
在 [ **供應專案設定** ] 索引標籤的 [ **設定詳細資料**] 底下，您將選擇是要透過 Microsoft 銷售您的供應專案，或個別管理您的交易。 透過 Microsoft 銷售的供應專案稱為 _可交易_供應專案，這表示 Microsoft 會代表發行者促進軟體授權的金錢交換。 如需這些選項的詳細資訊，請參閱 [列出選項](plan-saas-offer.md#listing-options) 和 [判斷您的發行選項](determine-your-listing-type.md)。
