...
* 針對 **windows**，您可以使用來一般化 windows 映射 `sysreptool` 。
  ...
  如需此工具的詳細資訊 `sysreptool` ，請參閱 [系統準備 (Sysprep) 總覽](https://docs.microsoft.com/windows-hardware/manufacture/desktop/sysprep--system-preparation--overview)。
