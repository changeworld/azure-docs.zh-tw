---
title: 如何在 Microsoft 合作夥伴中心中行銷 SaaS 供應專案
...
本文說明您可以選擇的其他行銷選項，如果您是透過 Microsoft 銷售軟體即服務 (SaaS) 供應專案。 您可以與 Microsoft 共同銷售您的供應專案，並透過 [雲端解決方案提供者 (CSP) 方案](cloud-solution-providers.md)或兩者來轉售。
