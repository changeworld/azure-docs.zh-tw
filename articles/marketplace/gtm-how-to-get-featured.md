---
title: 上市服務-如何在 marketplace 中取得精選 |Azure Marketplace
...
* 首先，如果您有試用或交易供應專案，您可以透過[商業 marketplace 權益](gtm-your-marketplace-benefits.md)來使用「類別促銷」權益。
...
>[!Note]
>如果您的解決方案未在搜尋結果中正確顯示，請透過[合作夥伴中心](https://partner.microsoft.com/)的 [說明] 功能表來提出支援票證。
