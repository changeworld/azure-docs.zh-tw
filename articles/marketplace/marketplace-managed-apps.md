---
title: Azure 應用程式託管應用程式提供發佈指南 |Azure 應用商店
description: 本文介紹在 Azure 應用商店中發佈託管應用程式的要求。
author: dsindona
...
---
# <a name="azure-applications-managed-application-offer-publishing-requirements"></a>Azure 應用程式:託管應用程式提供發佈要求

本文介紹託管應用程式產品/服務類型的要求,這是在 Azure 應用商店中發佈 Azure 應用程式產品/服務的一種方式。 託管應用程式是通過 Azure 應用商店部署和計費的代理服務。 使用者會看到的呼籲行動是「立即取得」。

當需要以下條件時,請使用託管應用程式產品/服務類型:

- 您可以使用 VM 或基於 IaaS 的整個解決方案為客戶部署基於訂閱的解決方案。
- 您或您的客戶要求由合作夥伴管理解決方案。
...
>[!Note]
>雲端解決方案供應商 (CSP) 合作夥伴通路選擇加入現已可用。 有關透過 Microsoft CSP 合作夥伴通路行銷產品/服務的詳細資訊,請參閱[雲端解決方案供應商](./cloud-solution-providers.md)。
