...
> [!TIP]
> 並非所有的帳戶角色都能存取支出資訊。 如需詳細資訊，請參閱[存取支出報表的角色和許可權](./payout-summary.md)。
...
| 客戶會收到週期性電子郵件，以提高緊急程度 | 12/7/2020 –1/31/2020 | 無 |
| 發行者可能會收到寫勾的通知 | 1/7/2020 | 傳送給發行者的電子郵件通知，其客戶尚未傳送付款。 包含交易識別碼和金額。 |
| 客戶收到終止通知 | 2/1/2020 | 無 |
| 收集程式結束/資金已寫掉 | 2/15/2020 | 傳送給發行者的電子郵件通知，表示已將資金寫掉。 包含交易識別碼和金額。 |
| 支出已扣除 | 3/1/2020 | 發行者會在合作夥伴中心的支出聲明中看到負面交易 |
| 支出已被扣 | 3/15/2020 | 未來的支出將會顯示在合作夥伴中心的支出聲明中。 在餘額不再為負數之前，發行者不會收到付款。  |
|||
