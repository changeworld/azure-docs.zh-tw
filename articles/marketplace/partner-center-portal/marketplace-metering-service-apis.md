...
如需有關使用受管理的應用程式方案為 Azure 應用程式供應專案建立自訂計量維度的詳細資訊，請參閱 [設定您的 Azure 應用程式供應專案設定詳細資料](../create-new-azure-apps-offer.md#configure-your-azure-application-offer-setup-details)。
