...
ms.locfileid: "89378333"
---
# <a name="tax-details-for-commercial-marketplace-publishers"></a>商業市集發行者的稅務詳細資料

若要瞭解您的價格選擇，以及 [Microsoft Azure Marketplace 發行者合約](https://go.microsoft.com/fwlink/p/?LinkID=699560) 或新式發行者合約下的稅務責任，請參閱下表中的國家/地區散發。
...
| 澳大利亞                        | 選取的價格不包括任何適用的稅金。 *        | 價格減去商店費用 *        | Microsoft          |
...
| 北馬其頓                | 選取的價格即為最終銷售價格，內含任何適用稅金。                                                                   | 價格減去 Store 費用                 | 發行者          |
...
\* 適用于所有客戶購買案例的購買，但 Enterprise 合約除外。
