...
如需有關 Azure AD (Active Directory) 的詳細資訊，請參閱 [什麼是驗證](../../active-directory/develop/authentication-scenarios.md)？
...
4. 在 [建立] 頁面中，輸入您的應用程式\'註冊資訊：
    ...
    -   **應用程式類型**：  
        ...
        選取[用戶端應用程式](../../active-directory/develop/active-directory-dev-glossary.md#client-application)的**Web 應用程式/api**) 以及安裝在安全伺服器上) 的[資源/api 應用程式](../../active-directory/develop/active-directory-dev-glossary.md#resource-server)。 這項設定適用于 OAuth 機密 [web 用戶端](../../active-directory/develop/active-directory-dev-glossary.md#web-client)) 和公用 [使用者代理程式用戶端](../../active-directory/develop/active-directory-dev-glossary.md#user-agent-based-client)) 。
