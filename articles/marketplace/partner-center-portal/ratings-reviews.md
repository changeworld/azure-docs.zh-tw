...
在合作夥伴中心的 [[商業 Marketplace] 儀表板](https://partner.microsoft.com/dashboard/commercial-marketplace/overview)中，展開 [**[分析](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/summary)**] 區段，然後選取 [**分級] & 評論**。
...
評論會依時間先後順序顯示。 預設的 view 會顯示所有評論，而您可以使用下拉式功能表中的 [評等]**篩選**條件，透過星級評等來篩選評論。 此外，您可以依審查中出現的關鍵字進行搜尋。  
