...
ms.locfileid: "97028439"
---
# <a name="create-a-commercial-marketplace-account-in-partner-center"></a>在合作夥伴中心中建立商業 marketplace 帳戶

若要將您的供應專案發佈至 [Microsoft AppSource](https://appsource.microsoft.com/) 或 [Azure Marketplace](https://azuremarketplace.microsoft.com/)，您必須在合作夥伴中心的商用 Marketplace 方案中建立帳戶。 本文涵蓋如何建立合作夥伴中心帳戶，以及如何將新的發行者新增至商用 marketplace 方案。

>[!NOTE]
>如果您在 Cloud Partner 入口網站 (CPP) 中有帳戶，我們會將它移至合作夥伴中心。 您不需要建立新的帳戶。 如需詳細資訊，請參閱 [從 Cloud Partner 入口網站移動的發行者](#publishers-who-moved-from-the-cloud-partner-portal)。

## <a name="before-you-begin"></a>開始之前

若要在合作夥伴中心中建立帳戶，請確定您符合下列必要條件。 我們將會在帳戶建立程序期間驗證這項資訊。

- 您必須使用與公司或組織相關聯的工作帳戶。 不支援個人帳戶。 如需詳細資訊，請參閱 [公司工作帳戶和合作夥伴中心](company-work-accounts.md)。
- 瞭解貴公司的合法商務名稱、位址和主要連絡人。 這位人員可以是您。
- 您必須擁有授權，才能代表貴公司簽署法律合約。

有兩種方式可以建立帳戶：

- 如果您不熟悉合作夥伴中心且沒有 Microsoft 合作夥伴網路 (MPN) 帳戶，請繼續 [使用合作夥伴中心註冊頁面建立帳戶](#create-an-account-using-the-partner-center-enrollment-page)。
- 如果您已經註冊 Microsoft 合作夥伴網路或開發人員計畫，請直接從合作夥伴中心建立帳戶。 移至 [使用現有的合作夥伴中心註冊建立帳戶](#create-an-account-using-existing-partner-center-enrollments)。

## <a name="create-an-account-using-the-partner-center-enrollment-page"></a>使用合作夥伴中心註冊頁面建立帳戶

如果您不熟悉合作夥伴中心且未在 Microsoft 合作夥伴網路註冊，請使用這個方法。 完成本節中的步驟，以建立新的合作夥伴中心帳戶和發行者設定檔。
...
>[!NOTE]
>若要查看您的公司是否已有公司帳戶，請瞭解如何建立新的工作帳戶，或學習如何設定多個工作帳戶以搭配合作夥伴中心使用，請參閱 [公司工作帳戶和合作夥伴中心](company-work-accounts.md)。
...
## <a name="create-an-account-using-existing-partner-center-enrollments"></a>使用現有的合作夥伴中心註冊建立帳戶

如果您已經在 Microsoft 合作夥伴中心中註冊，請使用此區段來建立商業 marketplace 帳戶。 您可以使用兩種類型的現有註冊來設定您的商業 marketplace 帳戶。 選擇適用于您的案例：

*如果我已在 Microsoft 合作夥伴網路註冊，該怎麼辦？*
- [使用現有的 Microsoft 合作夥伴網路註冊](#use-a-microsoft-partner-network-enrollment) 來建立您的帳戶。

*如果我已經註冊開發人員計畫，該怎麼辦？*
- [使用現有的開發人員計畫註冊](#use-a-developer-program-enrollment) 來建立您的帳戶。

針對這兩種註冊類型，您可以使用現有的認證登入合作夥伴中心。 請務必讓您的帳戶和發行者設定檔資訊可供使用。

### <a name="use-a-microsoft-partner-network-enrollment"></a>使用 Microsoft 合作夥伴網路註冊

當您使用 Microsoft 合作夥伴網路帳戶時，它會將您公司的工作電子郵件帳戶域連結至新的合作夥伴中心帳戶。 當您建立這兩個帳戶的關聯之後，公司的員工可以使用其工作帳戶的使用者名稱和密碼登入合作夥伴中心。 
...
### <a name="use-a-developer-program-enrollment"></a>使用開發人員方案註冊
...
## <a name="publishers-who-moved-from-the-cloud-partner-portal"></a>從 Cloud Partner 入口網站移動的發行者
