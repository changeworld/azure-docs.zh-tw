...
1. 選取您想要更新的供應專案名稱。 供應專案的狀態可能會列為**預覽**、**即時**、**發行進行中**、**草稿**、**需要注意**或**無法使用**（如果您之前已選擇停止銷售供應專案）。 選取之後，即會開啟該供應專案的**供應專案總覽**頁面。
...
1. 選取 [方案**名稱**]、[**計價模式**] 或 [**可用性**]。 *目前，方案僅適用于英文（美國）*。
