---
title: 創建 Azure 容器產品/服務 |Azure 應用商店
...
登錄到[雲合作夥伴門戶](https://cloudpartner.azure.com/)，然後在左側功能表列中選擇 **"新產品/服務**"。 在 [新增供應項目] 功能表中，選取 [容器]**** 以顯示 [新增供應項目]**** 表單，並開始定義新容器供應項目資產的程序。
