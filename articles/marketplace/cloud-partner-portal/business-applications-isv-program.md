...
若要設定及管理您的 ISV Connect 方案帳戶，請完成下列文章中的步驟： [在合作夥伴中心中建立商業 marketplace 帳戶](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account)。 本文提供建立新帳戶的所有步驟，以及將新的發行者新增至商用 marketplace 方案的相關資訊。
...
- [適用于 Dynamics 365 Customer Engagement](https://docs.microsoft.com/powerapps/developer/common-data-service/publish-app-appsource) 
