...
ms.locfileid: "82147697"
---
# <a name="power-bi-app-offer-prerequisites"></a>Power BI 應用程式供應項目必要條件

>[!Important]
>自 13 2020 年4月起，我們會開始將您 Power BI 應用程式供應專案的管理移至合作夥伴中心。 在遷移之後，您將在合作夥伴中心建立和管理您的供應專案。 依照[Power BI 應用程式建立總覽](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-power-bi-app-offer)中的指示，管理您遷移的供應專案。
...
- 成為已註冊的雲端 marketplace 發行者。 如果您未註冊，請依照[成為雲端 Marketplace 發行者](https://docs.microsoft.com/azure/marketplace/become-publisher)中的步驟進行。
    ...
    > [!NOTE] 
    > 使用相同的 Microsoft 開發人員中心註冊帳戶來登入[Cloud Partner 入口網站](https://cloudpartner.azure.com)。 您的 AppSource 供應項目應該只會共有一個 Microsoft 帳戶。 帳戶不應該適用於個別服務或供應項目。
