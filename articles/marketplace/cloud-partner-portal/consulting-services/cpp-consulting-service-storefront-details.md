...
-   **提供摘要**:創建工業連接的產品試驗,將現場設備安全地連接到具有儀錶板、報表和通知的 Azure IoT 中心解決方案。

*範例 3*

-   **報價名稱**: 專業服務: 1-Hr 簡報
-   **提供摘要**:預先配置的擴展 Dynamics 365 用於營運解決方案的概述和演示,該解決方案為專業服務提供專案、計費和資源的增強管理。

*範例 4*

-   **報價名稱**: 電源 BI 在你的世界: 4-Hr 研討會
-   **提供摘要**:使用第一個儀錶板啟動並運行,並學習最佳實踐。 最多 12 個學生 (現場指導)。
...
-   **研討會**:在客戶場所進行的互動互動互動,包括培訓課程、簡報、評估或基於客戶數據或環境的演示。
