---
title: 為 Azure 應用商店創建與 Azure 相容的 VHD
...
7. 在 [設定]**** 刀鋒視窗中，將 [使用受控資料箱磁碟]**** 選項設定為 [否]****。  這可讓您以手動方式管理新的 VHD。 （"**設置"** 邊欄選項卡還允許您更改存儲和網路選項的其他更改，例如，在**磁片類型**中選擇**高級 （SSD）。** 按一下 **"確定"** 以繼續。
