...
>[!Note]
>若要放棄 $99 開發人員中心註冊費用，請完成[marketplace 註冊表單](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv)，您會收到包含促銷代碼的電子郵件。 如需詳細資訊，請參閱如何[建立合作夥伴中心帳戶](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account)。
...
*    [決定解決方案的清單類型](https://docs.microsoft.com/azure/marketplace/determine-your-listing-type)。
