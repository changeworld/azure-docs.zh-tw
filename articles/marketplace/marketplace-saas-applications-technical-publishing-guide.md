---
title: Azure Marketplace SaaS 應用程式發佈指南
...
SaaS 應用程式可在 Microsoft AppSource 和 Azure Marketplace 中取得。  店面支援清單、試用版和交易供應專案。
...
* 如需詳細資訊，請參閱[建立 SaaS 應用程式供應](./partner-center-portal/create-new-saas-offer.md)專案。
