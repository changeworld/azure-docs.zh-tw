...
2. 輸入 `SignalRServiceDiagnosticLogs` 並選取時間範圍，以查詢資源記錄。 如需 advanced query，請參閱 [Azure 監視器中的開始使用 Log Analytics](../azure-monitor/log-query/log-analytics-tutorial.md)
