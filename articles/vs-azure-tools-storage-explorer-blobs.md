...
ms.locfileid: "95531962"
---
# <a name="manage-azure-blob-storage-resources-with-storage-explorer"></a>使用儲存體總管來管理 Azure Blob 儲存體資源

## <a name="overview"></a>概觀

[Azure Blob 儲存體](./storage/blobs/storage-quickstart-blobs-dotnet.md) 是用來儲存大量非結構化資料（例如文字或二進位資料）的服務，可透過 HTTP 或 HTTPS 從世界各地存取。
...
[ (SAS) 的共用存取](./storage/common/storage-sas-overview.md)簽章可提供您儲存體帳戶中資源的委派存取權。
