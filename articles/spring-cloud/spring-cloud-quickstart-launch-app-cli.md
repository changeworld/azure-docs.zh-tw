...
ms.locfileid: "89269602"
---
# <a name="quickstart-launch-a-java-spring-application-using-the-azure-cli"></a>快速入門：使用 Azure CLI 來啟動 Java Spring 應用程式

Azure Spring Cloud 可讓您輕鬆地在 Azure 上執行以 Spring Boot 為基礎的微服務應用程式。  執行此範例之前，您可以嘗試[基本快速入門](spring-cloud-quickstart.md)。
...
3. 瀏覽至由上一個命令所提供的 URL，以執行 PiggyMetrics 應用程式。
    ![PiggyMetrics 執行中](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. 選取**閘道**
    ...
    ![PiggyMetrics 導覽](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. 在 [閘道概觀] 頁面上尋找 URL ![PiggyMetrics 導覽 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
