...
1. 開啟 [Azure Cloud Shell](../app-service/quickstart-java.md#use-azure-cloud-shell)。
...
> [安裝並設定 Terraform 以佈建 Azure 資源](/azure/developer/terraform/getting-started-cloud-shell)。