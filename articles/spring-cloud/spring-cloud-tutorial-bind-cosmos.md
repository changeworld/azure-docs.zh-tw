...
* 已部署的 Azure Spring Cloud 執行個體。 請遵循[關於如何透過 Azure CLI 來部署的快速入門](spring-cloud-quickstart.md)來開始使用。
...
1. 建立 Azure Cosmos DB 資料庫。 請參閱關於如何[建立資料庫](../cosmos-db/create-cosmosdb-resources-portal.md)的快速入門以取得說明。 
