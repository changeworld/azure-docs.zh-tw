---
title: 使用 Azure PowerShell 建立私人端點
description: 使用 Azure PowerShell 建立 Azure 證明的私人端點
...
* 了解 [Azure Private Link](/azure/private-link/private-link-overview)
* [使用 Azure PowerShell 設定 Azure 證明](/azure/attestation/quickstart-powershell)
...
3. 選取 [CreateAttestationPrivateLinkTutorial-rg]。
...
9. 輸入 `nslookup <provider-name>.attest.azure.net`。 將 **\<provider-name>** 取代為您在先前步驟中建立的證明提供者執行個體。 您會收到類似下面所顯示的訊息：
