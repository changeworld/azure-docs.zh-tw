---
title: Azure 證明原則簽署者憑證的範例
description: Azure 證明原則簽署者憑證內容的範例。
...
## <a name="policy-signer-certificate-content"></a>原則簽署者憑證內容
...
## <a name="policy-signer-certificates-file-content"></a>原則簽署者憑證檔案內容
