...
若要在訂用帳戶層級部署範本，請使用 Azure CLI、PowerShell 或 REST API。
...
* [建立資源群組、將其鎖定並為其提供權限](https://github.com/Azure/azure-quickstart-templates/tree/master/subscription-deployments/create-rg-lock-role-assignment)。
