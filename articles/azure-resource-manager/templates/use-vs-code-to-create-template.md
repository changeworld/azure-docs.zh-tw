...
您可以使用**Ctrl + 按一下**，或使用內容功能表（如螢幕擷取畫面： ![Visual Studio Code Resource Manager 工具延伸模組移至定義）來跳至定義](./media/use-vs-code-to-create-template/resource-manager-tools-extension-context-menu.png)
