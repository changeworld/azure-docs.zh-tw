...
| [指派 Azure 訂用帳戶的角色](https://github.com/Azure/azure-quickstart-templates/tree/master/subscription-deployments/subscription-role-assignment)| 將角色指派給 Azure 訂用帳戶的使用者。 |
|**角色定義**||
| [建立自訂角色定義](https://github.com/Azure/azure-quickstart-templates/tree/master/subscription-deployments/create-role-def)| 在 Azure 訂用帳戶中建立新的角色定義。 |
|**資源鎖定**||
| [鎖定資源群組](https://github.com/Azure/azure-quickstart-templates/tree/master/subscription-deployments/create-rg-lock-role-assignment)| 建立資源群組，並將 **DoNotDelete** 鎖定套用到資源群組。 將參與者角色指派給使用者。 |
| | |
