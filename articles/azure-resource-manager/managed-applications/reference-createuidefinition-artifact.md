...
description: 說明如何建立 Azure 受控應用程式的 createUiDefinition 成品。 檔案的名稱為 createUiDefinition.js。
ms.topic: conceptual
ms.author: lazinnat
author: lazinnat
ms.date: 07/11/2019
...
本文是 Azure 受控應用程式之成品的 *createUiDefinition.js* 參考。 如需撰寫使用者介面專案的詳細資訊，請參閱 [建立使用者介面元素](create-uidefinition-elements.md)。

## <a name="user-interface-elements"></a>使用者介面元素

下列 JSON 顯示 Azure 受控應用程式檔案的 *createUiDefinition.js* 範例：
