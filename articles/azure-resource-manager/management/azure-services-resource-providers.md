---
title: 依 Azure 服務進行的資源提供者
description: 列出 Azure 資源管理器的所有資源提供程式命名空間,並顯示該命名空間的 Azure 服務。
ms.topic: conceptual
ms.date: 03/17/2020
...
| Microsoft.CertificateRegistration | [套用服務憑證](../../app-service/configure-ssl-certificate.md#import-an-app-service-certificate) |
...
| Microsoft.ClassicStorage | 傳統部署模型儲存 |
| 微軟.經典訂閱 | 傳統部署模型 |
...
| 微軟客戶鎖定箱 | 適用於 Microsoft Azure 的客戶密碼箱 |
| 微軟.自訂提供者 | [Azure 自訂提供者](../custom-providers/overview.md) |
...
| 微軟.資料共享 | [Azure Data Share](/azure/data-share/) |
...
| 微軟.數字雙胞胎 | [Azure Digital Twins](../../digital-twins/about-digital-twins.md) |
...
| 微軟.庫伯內斯 | [Azure Kubernetes Service (AKS)](/azure/aks/) |
...
| 微軟.混合實境 | [Azure Spatial Anchors](/azure/spatial-anchors/) |
...
| 微軟.安全洞察 | [Azure Sentinel](/azure/sentinel/) |
| 微軟.串列主控台 | [適用於 Windows 的 Azure 串列主控台](../../virtual-machines/troubleshooting/serial-console-windows.md) |
...
| 微軟儲存快取 | [Azure HPC Cache](/azure/hpc-cache/) |
...
有關資源提供程式的詳細資訊,請參閱 Azure[資源提供者和類型](resource-providers-and-types.md)
