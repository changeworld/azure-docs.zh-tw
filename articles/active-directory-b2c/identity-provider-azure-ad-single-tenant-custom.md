---
title: 使用自訂原則來設定以 Azure AD 帳戶登入
...
本文說明如何使用 Azure Active Directory B2C (Azure AD B2C) 中的 [自訂原則](custom-policy-overview.md) ，讓 Azure Active Directory (Azure AD) 組織的使用者登入。
