...
| 將現有的應用程式遷移至 b2clogin.com | Login.microsoftonline.com 的淘汰會在2020年12月4日針對所有 Azure AD B2C 租使用者生效。 [詳細資訊](b2clogin.md)。 |
...
| 節流 |  如果在短時間內從相同來源傳送太多要求，Azure AD B2C 會節流流量。 在負載測試時使用數個流量來源，並在您的應用程式中適當地處理 `AADB2C90229` 錯誤碼。 |
