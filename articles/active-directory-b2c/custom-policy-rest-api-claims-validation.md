...
您也可以將互動設計為協調流程步驟。 如需詳細資訊，請參閱[逐步解說︰將 REST API 宣告交換整合到 Azure AD B2C 使用者旅程圖中以作為協調流程步驟](custom-policy-rest-api-claims-exchange.md)。
...
- 如[開始使用](custom-policy-get-started.md)所述，設定為完成本機帳戶註冊/登入的 Azure AD B2C 租用戶。
...
[修改設定檔編輯和使用者註冊以從使用者收集其他資訊](custom-policy-custom-attributes.md)
