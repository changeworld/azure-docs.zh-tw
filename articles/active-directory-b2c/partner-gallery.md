...
ms.locfileid: "85385889"
---
# <a name="azure-active-directory-b2c-partners"></a>Azure Active Directory B2C 合作夥伴

我們的合作夥伴網路延伸了我們的解決方案功能，協助您建立順暢的使用者體驗。 透過 Azure AD B2C，您可以與合作夥伴整合以啟用多重要素驗證方法、啟用安全客戶驗證（SCA）、執行以角色為基礎的存取控制，以及藉由身分識別驗證和校對來對抗詐騙。 使用我們的詳細逐步解說，瞭解如何整合應用程式與下列合作夥伴。
