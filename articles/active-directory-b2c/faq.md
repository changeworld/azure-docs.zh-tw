...
請參閱 [Azure AD 中的比較 B2B 共同作業和 B2C](../active-directory/b2b/compare-with-b2c.md) ，以深入瞭解如何將適當的功能套用至您的外部身分識別案例。
...
您可以使用新的統一 **應用程式註冊** 體驗或舊版  **應用程式， (舊版) ** 體驗。 [深入了解新的體驗](https://aka.ms/b2cappregtraining)。
