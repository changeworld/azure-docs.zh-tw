...
搭配[最新 Azure AD B2C 價格](https://azure.microsoft.com/pricing/details/active-directory-b2c/)，您可以評估每日、每週、每月的 Azure 耗用量。  當您規劃的租用戶行為變更可能會影響整體成本時，評估特別實用。 您可以在[連結的 Azure 訂用帳戶](billing.md)中檢閱實際成本。
