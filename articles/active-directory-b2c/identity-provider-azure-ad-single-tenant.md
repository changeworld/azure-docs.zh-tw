...
1. 在 [**中繼資料 url**] 中，輸入下列 url，並將取代 `{tenant}` 為您 Azure AD 租使用者的功能變數名稱：
...
1. 選擇性針對 [**網域提示**]，輸入 `contoso.com` 。 如需詳細資訊，請參閱[使用 Azure Active Directory B2C 設定直接登入](direct-signin.md#redirect-sign-in-to-a-social-provider)。
