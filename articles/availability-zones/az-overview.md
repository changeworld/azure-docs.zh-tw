...
- **分割區服務**- 將資源固定到特定區域(例如,虛擬機器、託管磁碟、標準 IP 位址)或
...
> [!IMPORTANT]
> 可用性區域識別碼(上圖中的數位 1、2 和 3)以邏輯方式映射到每個訂閱的實際物理區域。 這意味著給定訂閱中的可用性區域 1 可能引用與不同訂閱中的可用性區域 1 不同的物理區域。 因此,建議不要依賴不同訂閱中的可用區域ID進行虛擬機器放置。

## <a name="services-support-by-region"></a>依區域提供的服務支援
...
|                                 |美洲 |              |           |           | 歐洲 |              |          |              | 亞太地區 |                 |                |
|----------------------------|----------|----------|---------|---------|--------------|------------|--------|----------|----------|-------------|-------------|
|          |美國中部|美國東部|美國東部 2|美國西部 2|法國中部|北歐|英國南部|西歐|日本東部|東南亞|澳大利亞東部|
| **計算**                         |            |              |           |           |                |              |          |             |            |                |                |
| Linux 虛擬機器          | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003;   | &#10003;       |                |
| Windows 虛擬機器        | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003;   | &#10003;       |                |
| 虛擬機器擴展集      | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003;   | &#10003;       |                |
...
- [為 Azure 宇宙資料庫新增區域冗餘區域](../cosmos-db/high-availability.md#availability-zone-support)
...
- [建立可用性區域的 Azure 庫伯奈斯服務 (AKS) 叢集](../aks/availability-zones.md)
