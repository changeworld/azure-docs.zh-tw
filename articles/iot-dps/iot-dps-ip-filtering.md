...
您可以使用 Azure 資源提供者的 REST 端點來抓取及修改 DPS IP 篩選器。 請參閱 [createorupdate 方法](https://docs.microsoft.com/rest/api/iot-dps/iotdpsresource/createorupdate)中的 `properties.ipFilterRules`。
...
| **動作**               | 接受的值為 IP 篩選規則的 [**接受** ] 或 [ **拒絕** ] 做為動作。 |
