---
title: 存取安全性 & 建議資料
description: 瞭解如何在使用適用於 IoT 的 Azure 資訊安全中心時存取您的安全性警示和建議資料。
...
ms.locfileid: "89504888"
---
# <a name="access-your-security-data"></a>存取您的安全性資料

如果您) 選擇將安全性警示、建議和原始的安全性資料儲存在 Log Analytics 工作區中，適用於 IoT 的 Azure 資訊安全中心儲存 (。
...
1. 選擇適用於 IoT 的 Azure 資訊安全中心中的警示或建議。
...
安全性警示會儲存在針對適用於 IoT 的 Azure 資訊安全中心解決方案所設定之 Log Analytics 工作區的 _AzureSecurityOfThings. SecurityAlert_ 資料表中。
...
安全性建議儲存在針對適用於 IoT 的 Azure 資訊安全中心解決方案設定的 Log Analytics 工作區中的 _AzureSecurityOfThings. SecurityRecommendation_ 資料表。
...
- 閱讀適用於 IoT 的 Azure 資訊安全中心 [總覽](overview.md)
- 瞭解適用於 IoT 的 Azure 資訊安全中心 [架構](architecture.md)
- 瞭解並探索 [適用於 IoT 的 Azure 資訊安全中心警示](concept-security-alerts.md)
- 瞭解並探索 [適用於 IoT 的 Azure 資訊安全中心建議](concept-recommendations.md)
