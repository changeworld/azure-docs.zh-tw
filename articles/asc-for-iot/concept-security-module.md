...
適用於 IoT 的 Azure 資訊安全中心可與您現有的 IoT 裝置管理平台完全整合，讓您能夠管理裝置的安全性狀態，以及利用現有的裝置控制功能。 集成是通過利用IoT中心孿生機制實現的。

詳細瞭解 Azure IoT 中心中的[裝置孿生概念](https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twins)。
...
請參閱[創建安全模組孿生](quickstart-create-security-twin.md)和[配置安全代理](how-to-agent-configuration.md),瞭解如何創建、自定義和配置孿生。 [請參閱瞭解模組孿生](https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-module-twins),瞭解有關 IoT 中心中模組孿生概念的更多資訊。
