...
- **Azure 備份**： [Azure 備份](https://docs.microsoft.com/azure/backup/backup-architecture) 支援 Azure vm 的內部部署和雲端備份。
...
- [Azure IoT 中樞高可用性嚴重損壞修復](https://docs.microsoft.com/azure/iot-hub/iot-hub-ha-dr)，其中包括內部區域內的冗余
...
1. 在第二個區域中建立環境。 如需詳細資訊，請參閱 [Azure 入口網站中的建立新的 Azure 時間序列深入解析環境](https://docs.microsoft.com/azure/time-series-insights/time-series-insights-get-started)。
...
> 
> 如需詳細資訊，請參閱 [Azure 時間序列深入解析中的緩和延遲](https://docs.microsoft.com/azure/time-series-insights/time-series-insights-environment-mitigate-latency)。
