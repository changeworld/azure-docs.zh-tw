...
> [!NOTE]
> 語音 SDK 支援所有 Intel 相容處理器，但**只有 x64**版本的 ARM 處理器。
...
1. 從功能表列中，選擇 [檔案] [儲存 **] [**  >  **package.appxmanifest.xml** ] 以儲存變更。

### <a name="install-the-speech-sdk"></a>安裝語音 SDK

最後，安裝[語音 SDK NuGet 套件](https://aka.ms/csspeech/nuget) \(英文\)，並在您的專案中參考語音 SDK：

1. 在**方案總管**中，以滑鼠右鍵按一下您的方案，然後選擇 [**管理方案的 NuGet 套件**] 以移至 [ **NuGet-解決方案**] 視窗。
