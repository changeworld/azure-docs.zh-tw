...
| **基本以外的所有 Generation1 和 Generation2 SKU** | **路由式 VPN**：最多 30 個通道 ( * )，P2S、BGP、主動-主動、自訂 IPsec/IKE 原則、ExpressRoute/VPN 共存 |
|        |             |
...
| **[工作負載]**                       | **SKU**               |
| ---                                | ---                    |
| **生產、重要工作負載** | 基本以外的所有 Generation1 和 Generation2 SKU |
| **開發測試或概念證明**   | 基本 (\*\*)                 |
|                                    |                        |
