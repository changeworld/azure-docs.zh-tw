...
* [從 GitHub 克隆或下載示例專案](https://github.com/Azure/azure-functions-durable-extension/tree/master/samples/precompiled)

# <a name="javascript"></a>[JAVAscript](#tab/javascript)

* [完成快速入門文章](../articles/azure-functions/durable/quickstart-js-vscode.md)
* [從 GitHub 克隆或下載示例專案](https://github.com/Azure/azure-functions-durable-extension/tree/master/samples/javascript)
