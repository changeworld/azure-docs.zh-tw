...
> [!NOTE]
> 如需 Azure 接聽程式的疑難排解秘訣，請參閱 AlwaysOn 支援小組[blog](https://blogs.msdn.com/b/alwaysonpro/)中的針對 azure 中的[可用性群組接聽程式進行疑難排解](https://blogs.msdn.microsoft.com/alwaysonpro/2017/02/22/troubleshooting-internal-load-balancer-listener-connectivity-in-azure)。
> 
> 
