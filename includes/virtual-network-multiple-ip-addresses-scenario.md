...
> [!NOTE]
> 雖然本文中的步驟會將所有 IP 組態指派給單一 NIC，您也可以指派多個 IP 組態給多個 NIC VM 中的任何 NIC。 要瞭解如何創建具有多個 NIC 的 VM，請閱讀"[創建具有多個 NIC 的 VM"](../articles/virtual-machines/windows/multiple-nics.md)一文。