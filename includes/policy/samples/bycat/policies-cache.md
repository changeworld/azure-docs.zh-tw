...
ms.locfileid: "84233730"
---
|名稱 |描述 |效果 |版本 |GitHub |
|---|---|---|---|---|
|[Azure Cache for Redis 應位於虛擬網路內](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F7d092e0a-7acd-40d2-a975-dca21cae48c4) |此原則會部署到虛擬網路，以稽核 Azure Cache for Redis 資源是否具有非公用端點。 |Audit, Deny, Disabled |1.0.0 |[連結](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Cache/RedisCache_CacheInVnet_Audit.json) |
