...
> [!IMPORTANT]
> 對於這個大小的系列，一開始會在您的訂用帳戶中，將每個區域中的 vCPU (核心) 配額設為 0。 在[可用區域](../articles/azure-portal/supportability/resource-manager-core-quotas-request.md)中，針對這個系列[要求增加 vCPU 配額](https://azure.microsoft.com/regions/services/)。
>
