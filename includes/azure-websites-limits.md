...
| [擴充](../articles/app-service/manage-scale-up.md) (執行個體數目上限) |1 個共用 |1 個共用 |3 個專用<sup>3</sup> |10 個專用<sup>3</sup> | 適用於 v1 和 v2 的 20 個專用；適用於 v3 的 30 個專用。<sup>3</sup>|100 個專用<sup>4</sup>|
