...
#### <a name="limits-that-are-the-same-for-standard-and-dedicated-tiers"></a>標準和專用層的限制相同 
| 功能 | 限制 | 
|---|---|
| 結構描述群組名稱的長度上限 | 50 |  
| 結構描述名稱的長度上限 | 100 |    
...
#### <a name="limits-that-are-different-for-standard-and-dedicated-tiers"></a>標準和專用層的限制不同 
