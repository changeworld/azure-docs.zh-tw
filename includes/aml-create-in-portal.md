...
ms.locfileid: "91841831"
---
1. 使用您 Azure 訂閱的認證來登入 [Azure 入口網站](https://portal.azure.com/)。

1. 在 Azure 入口網站的左上角，選取 [+ 建立資源]****。

    ![顯示 [建立資源] 選項的螢幕擷取畫面。](media/aml-create-in-portal/create-workspace.gif)
...
1. 提供下列資訊來設定新的工作區：
   ...
   工作區版本 | 選取 [基本]  作為此教學課程的工作區類型。 工作區類型會決定您可以存取的功能和定價。 此教學課程中的所有內容都可以使用基本或企業工作區來執行。
