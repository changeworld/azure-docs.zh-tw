...
增量快照集只會以使用的大小計費。 您可以查看 [Azure 使用量報表](https://docs.microsoft.com/azure/billing/billing-understand-your-bill)，以找出已使用的快照大小。 例如，如果快照集的已使用資料大小為 10 GiB，則**每日**使用量報表會顯示已使用數量為 10 GiB/(31 天) = 0.3226。
