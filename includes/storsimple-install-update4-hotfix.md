...
8. 重複步驟 3-5 來安裝第二級更新。 **針對第二個訂單更新，只要執行 `Start-HcsHotfix cmdlet` 並指向第二個訂單更新所在的資料夾，即可安裝多個更新。此 Cmdlet 會執行資料夾中所有可用的更新。** 如果有已安裝的更新，更新邏輯會偵測到，而不套用該更新。 
