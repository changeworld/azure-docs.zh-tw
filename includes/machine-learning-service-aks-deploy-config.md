...
---
`deploymentconfig.json` 文件中的專案會對應至 [AksWebservice.deploy_configuration](https://docs.microsoft.com/python/api/azureml-core/azureml.core.webservice.aks.aksservicedeploymentconfiguration?view=azure-ml-py) 的參數。 下表描述 JSON 文件中的實體之間的對應以及方法的參數：
