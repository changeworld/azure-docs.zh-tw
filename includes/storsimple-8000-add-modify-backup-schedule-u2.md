...
3. 在 [新增排程] 刀鋒視窗中，修改快照集類型、備份頻率、保留期，以及開始日期和時間。 按一下 [新增]  。
    ...
    ![管理排程2](./media/storsimple-8000-add-modify-backup-schedule-u2/addschedule5.png)

4. 備份原則建立完成時，您會收到通知。 備份原則清單也會加以更新。

    ![管理排程3](./media/storsimple-8000-add-modify-backup-schedule-u2/addschedule4.png)
