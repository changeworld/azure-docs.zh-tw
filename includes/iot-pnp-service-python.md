...
> [!NOTE]
> 這些服務範例會使用 **IoT 中樞服務用戶端** 中的 **IoTHubRegistryManager** 類別。 若要深入了解 API (包括數位對應項 API)，請參閱[服務開發人員指南](../articles/iot-pnp/concepts-developer-guide-service.md)。
