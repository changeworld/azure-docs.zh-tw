...
---
若要檢查您是否已成功設定角色指派，其中一種方式是在[Azure 入口網站](https://portal.azure.com)中，查看 Azure 數位 Twins 實例的角色指派。 移至入口網站的[Azure 數位 Twins 實例](https://portal.azure.com/#blade/HubsExtension/BrowseResource/resourceType/Microsoft.DigitalTwins%2FdigitalTwinsInstances)頁面 (您可以使用此連結，或在入口網站搜尋列中搜尋) ，然後選取您想要檢查的實例名稱。 
