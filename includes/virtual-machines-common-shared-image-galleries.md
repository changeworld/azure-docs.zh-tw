...
建議您在資源庫層級共用，以獲得最佳體驗。 我們不建議您共用個別的映像版本。 如需 RBAC 的詳細資訊，請參閱[使用 RBAC 管理對 Azure 資源的存取](../articles/role-based-access-control/role-assignments-portal.md)。
