...
:::image type="content" source="../articles/digital-twins/media/includes/copy-config.png" alt-text="Visual Studio 視窗的摘要，顯示 [方案總管] 窗格，其中醒目提示 appsettings.json，而且 [屬性] 窗格的 [複製到輸出目錄] 屬性設為 [有更新時才複製]" border="false" lightbox="../articles/digital-twins/media/includes/copy-config.png":::
