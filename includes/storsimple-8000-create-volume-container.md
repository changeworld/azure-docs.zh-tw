...
2. 在裝置儀表板中，按一下 [+ 新增磁碟區容器]
    ...
    ![磁片區容器 blade 2](./media/storsimple-8000-create-volume-container/createvolumecontainer2.png)
...
3. 在 [新增磁碟區容器] 刀鋒視窗中：
   ...
   6. 如果您要取用所有的可用頻寬，請在 [指定頻寬] 下拉式清單中選取 [無限制]。 您也可以將這個選項設為 [自訂] 來使用頻寬控制項，並指定介於 1 Mbps 到 1000 Mbps 之間的值。
      ...
      ![磁片區容器分頁3](./media/storsimple-8000-create-volume-container/createvolumecontainer6b.png)
   7. 按一下頁面底部的 [新增]  。

        ![磁片區容器 blade 4](./media/storsimple-8000-create-volume-container/createvolumecontainer6.png)
