...
* 您必須安裝最新版的 Azure Resource Manager PowerShell Cmdlet。 有關詳細資訊，請參閱[如何安裝和配置 Azure PowerShell](/powershell/azureps-cmdlets-docs)。
...
開啟 PowerShell 主控台並連接到您的帳戶。 有關詳細資訊，請參閱使用[AzureRM 登錄](/powershell/azure/azurerm/authenticate-azureps)。
